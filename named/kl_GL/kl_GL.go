...
// DateFullLayout returns the full date layout for 'kl_GL'
func (kl *kl_GL) DateFullLayout() string {
	return kl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kl_GL'
func (kl *kl_GL) DateLongLayout() string {
	return kl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kl_GL'
func (kl *kl_GL) DateMediumLayout() string {
	return kl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kl_GL'
func (kl *kl_GL) DateShortLayout() string {
	return kl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kl_GL'
func (kl *kl_GL) TimeFullLayout() string {
	return kl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kl_GL'
func (kl *kl_GL) TimeLongLayout() string {
	return kl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kl_GL'
func (kl *kl_GL) TimeMediumLayout() string {
	return kl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kl_GL'
func (kl *kl_GL) TimeShortLayout() string {
	return kl.timeShortLayout
}

func (kl *kl_GL) ListPatterns() *locales.ListPatterns {
	return kl.listPatterns
}

func (kl *kl_GL) GetDurationSpec() *locales.DurationSpec {
	return kl.DurationSpec
}

func (kl *kl_GL) GetMiscPatterns() *locales.MiscPatterns {
