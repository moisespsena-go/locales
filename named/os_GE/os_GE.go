...
// DateFullLayout returns the full date layout for 'os_GE'
func (os *os_GE) DateFullLayout() string {
	return os.dateFullLayout
}

// DateLongLayout returns the long date layout for 'os_GE'
func (os *os_GE) DateLongLayout() string {
	return os.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'os_GE'
func (os *os_GE) DateMediumLayout() string {
	return os.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'os_GE'
func (os *os_GE) DateShortLayout() string {
	return os.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'os_GE'
func (os *os_GE) TimeFullLayout() string {
	return os.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'os_GE'
func (os *os_GE) TimeLongLayout() string {
	return os.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'os_GE'
func (os *os_GE) TimeMediumLayout() string {
	return os.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'os_GE'
func (os *os_GE) TimeShortLayout() string {
	return os.timeShortLayout
}

func (os *os_GE) ListPatterns() *locales.ListPatterns {
	return os.listPatterns
}

func (os *os_GE) GetDurationSpec() *locales.DurationSpec {
	return os.DurationSpec
}

func (os *os_GE) GetMiscPatterns() *locales.MiscPatterns {
