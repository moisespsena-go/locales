...
// DateFullLayout returns the full date layout for 'ff_Latn_GW'
func (ff *ff_Latn_GW) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff_Latn_GW'
func (ff *ff_Latn_GW) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff_Latn_GW'
func (ff *ff_Latn_GW) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff_Latn_GW'
func (ff *ff_Latn_GW) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff_Latn_GW'
func (ff *ff_Latn_GW) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff_Latn_GW'
func (ff *ff_Latn_GW) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff_Latn_GW'
func (ff *ff_Latn_GW) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff_Latn_GW'
func (ff *ff_Latn_GW) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff_Latn_GW) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff_Latn_GW) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff_Latn_GW) GetMiscPatterns() *locales.MiscPatterns {
