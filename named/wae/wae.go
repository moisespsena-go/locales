...
func New() locales.Translator {
	return &wae{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jen", "Hor", "Mär", "Abr", "Mei", "Brá", "Hei", "Öig", "Her", "Wím", "Win", "Chr"},
			MonthsNarrowValue:        []string{"", "J", "H", "M", "A", "M", "B", "H", "Ö", "H", "W", "W", "C"},
			MonthsWideValue:          []string{"", "Jenner", "Hornig", "Märze", "Abrille", "Meije", "Bráčet", "Heiwet", "Öigšte", "Herbštmánet", "Wímánet", "Wintermánet", "Chrištmánet"},
			WeekdaysAbbreviatedValue: []string{"Sun", "Män", "Ziš", "Mit", "Fró", "Fri", "Sam"},
			WeekdaysNarrowValue:      []string{"S", "M", "Z", "M", "F", "F", "S"},
			WeekdaysWideValue:        []string{"Sunntag", "Mäntag", "Zištag", "Mittwuč", "Fróntag", "Fritag", "Samštag"},
			ErasAbbreviatedValue:     []string{"v. Chr.", "n. Chr"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"", ""},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "Atlantiši Summerzit", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "Atlantiši Standardzit", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "CAT", "CCT": "CCT", "CDT": "CDT", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "CST", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "EAT", "ECT": "ECT", "EDT": "EDT", "EGDT": "EGDT", "EGST": "EGST", "EST": "EST", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "GMT", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "Mitteleuropäiši Summerzit", "MEZ": "Mitteleuropäiši Standardzit", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "Ošteuropäiši Summerzit", "OEZ": "Ošteuropäiši Standardzit", "PDT": "PDT", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "PST", "PYST": "PYST", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "Wešteuropäiši Summerzit", "WEZ": "Wešteuropäiši Standardzit", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		timeMediumLayout: "",
		timeShortLayout:  "",
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} und {1}", "", "", "{0} und {1}"}, []string(nil)}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"jár", "%v jár", "%v jár", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"mánet", "%v mánet", "%v mánet", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"wučä", "%v wuča", "%v wučä", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"täg", "%v täg", "%v täg", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"stunde", "%v stund", "%v stunde", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"minüte", "%v minüta", "%v minüte", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"sekunde", "%v sekund", "%v sekunde", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
...
func (wae *wae) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(wae, wae.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'wae'
func (wae *wae) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(wae, wae.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'wae'
func (wae *wae) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(wae, wae.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'wae'
func (wae *wae) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(wae, wae.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'wae'
func (wae *wae) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(wae, wae.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'wae'
func (wae *wae) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(wae, wae.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'wae'
func (wae *wae) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(wae, wae.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'wae'
func (wae *wae) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(wae, wae.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'wae'
func (wae *wae) DateFullLayout() string {
	return wae.dateFullLayout
}

// DateLongLayout returns the long date layout for 'wae'
func (wae *wae) DateLongLayout() string {
	return wae.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'wae'
func (wae *wae) DateMediumLayout() string {
	return wae.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'wae'
func (wae *wae) DateShortLayout() string {
	return wae.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'wae'
func (wae *wae) TimeFullLayout() string {
	return wae.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'wae'
func (wae *wae) TimeLongLayout() string {
	return wae.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'wae'
func (wae *wae) TimeMediumLayout() string {
	return wae.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'wae'
func (wae *wae) TimeShortLayout() string {
	return wae.timeShortLayout
}

func (wae *wae) ListPatterns() *locales.ListPatterns {
	return wae.listPatterns
}

func (wae *wae) GetDurationSpec() *locales.DurationSpec {
	return wae.DurationSpec
}

func (wae *wae) GetMiscPatterns() *locales.MiscPatterns {
	return &wae.miscPatterns
}
