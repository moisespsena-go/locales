...
func New() locales.Translator {
	return &ceb{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Ene", "Peb", "Mar", "Abr", "May", "Hun", "Hul", "Ago", "Set", "Okt", "Nob", "Dis"},
			MonthsNarrowValue:        []string{"", "E", "P", "M", "A", "M", "H", "H", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Enero", "Pebrero", "Marso", "Abril", "Mayo", "Hunyo", "Hulyo", "Agosto", "Setyembre", "Oktubre", "Nobyembre", "Disyembre"},
			WeekdaysAbbreviatedValue: []string{"Dom", "Lun", "Mar", "Miy", "Huw", "Biy", "Sab"},
			WeekdaysNarrowValue:      []string{"D", "L", "M", "M", "H", "B", "S"},
			WeekdaysShortValue:       []string{"Dom", "Lun", "Mar", "Miy", "Huw", "Biy", "Sab"},
			WeekdaysWideValue:        []string{"Domingo", "Lunes", "Martes", "Miyerkules", "Huwebes", "Biyernes", "Sabado"},
			PeriodsNarrowValue:       []string{"a", "p"},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"BC", "AD"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Sa Wala Pa Si Kristo", "Anno Domini"},
			TimezonesValue:           map[string]string{"": "Tamdanang Oras sa Paraguay", "ACDT": "Oras sa Tag-init sa Central Australia", "ACST": "Tamdanang Oras sa Central Australia", "ACT": "ACT", "ACWDT": "Oras sa Tag-init sa Central Western Australia", "ACWST": "Tamdanang Oras sa Central Western Australia", "ADT": "Oras sa Tag-init sa Atlantiko", "AEDT": "Oras sa Tag-init sa Eastern Australia", "AEST": "Tamdanang Oras sa Eastern Australia", "AFT": "Oras sa Afghanistan", "AKDT": "Oras sa Tag-init sa Alaska", "AKST": "Tamdanang Oras sa Alaska", "AMST": "Oras sa Tag-init sa Amazon", "AMT": "Tamdanang Oras sa Amazon", "ARST": "Oras sa Tag-init sa Argentina", "ART": "Tamdanang Oras sa Argentina", "AST": "Tamdanang Oras sa Atlantiko", "AWDT": "Oras sa Tag-init sa Western Australia", "AWST": "Tamdanang Oras sa Western Australia", "BNT": "Oras sa Brunei Darussalam", "BOT": "Oras sa Bolivia", "BRST": "Oras sa Tag-init sa Brasilia", "BRT": "Tamdanang Oras sa Brasilia", "BST": "Oras sa Tag-init sa Bangladesh", "BTT": "Oras sa Bhutan", "CAT": "Oras sa Central Africa", "CCT": "Oras sa Cocos Islands", "CDT": "Sentrong Oras sa Tag-init", "CDT (Kuba)": "Oras sa Tag-init sa Cuba", "CHADT": "Oras sa Tag-init sa Chatham", "CHAST": "Tamdanang Oras sa Chatham", "CLST": "Oras sa Tag-init sa Chile", "CLT": "Tamdanang Oras sa Chile", "COST": "Oras sa Tag-init sa Colombia", "COT": "Tamdanang Oras sa Colombia", "CST": "Sentong Tamdanan nga Oras", "CST (Kuba)": "Tamdanang Oras sa Cuba", "CXT": "Oras sa Christmas Island", "ChST": "Tamdanang Oras sa Chamorro", "EASST": "Oras sa Tag-init sa Easter Island", "EAST": "Tamdanang Oras sa Easter Island", "EAT": "Oras sa East Africa", "ECT": "Oras sa Ecuador", "EDT": "Oras sa Tag-init sa Sidlakan", "EGDT": "Oras sa Tag-init sa East Greenland", "EGST": "Tamdanang Oras sa East Greenland", "EST": "Tamdanan nga Oras sa Sidlakan", "FKST": "Oras sa Tag-init sa Falkland Islands", "GALT": "Oras sa Galapagos", "GFT": "Oras sa French Guiana", "GMT": "Oras sa Greenwich Mean", "GST": "Tamdanang Oras sa Gulf", "GYT": "Oras sa Guyana", "HADT": "Oras sa Tag-init sa Hawaii-Aleutian", "HAST": "Tamdanang Oras sa Hawaii-Aleutian", "HENOMX": "Oras sa Tag-init sa Northwest Mexico", "HEOG": "Oras sa Tag-init sa West Greenland", "HEPMX": "Oras sa Tag-init sa Mexican Pacific", "HKST": "Oras sa Tag-init sa Hong Kong", "HKT": "Tamdanang Oras sa Hong Kong", "HNNOMX": "Tamdanang Oras sa Northwest Mexico", "HNOG": "Tamdanang Oras sa West Greenland", "HNPMX": "Tamdanang Oras sa Mexican Pacific", "ICT": "Oras sa Indochina", "IRDT": "Oras sa Tag-init sa Iran", "IRST": "Tamdanang Oras sa Iran", "IST": "Tamdanang Oras sa India", "JDT": "Oras sa Adlawan sa Japan", "JST": "Tamdanang Oras sa Japan", "LHDT": "Oras sa Tag-init sa Lord Howe", "LHST": "Tamdanang Oras sa Lord Howe", "MDT": "Oras sa Tag-init sa Kabukiran", "MESZ": "Oras sa Tag-init sa Central Europe", "MEZ": "Tamdanang Oras sa Central Europe", "MST": "Tamdanang Oras sa Kabukiran", "MVT": "Oras sa Maldives", "MYT": "Oras sa Malaysia", "NDT": "Oras sa Tag-init sa Newfoundland", "NPT": "Oras sa Nepal", "NST": "Tamdanang Oras sa Newfoundland", "NZDT": "Oras sa Tag-init sa New Zealand", "NZST": "Tamdanang Oras sa New Zealand", "OESZ": "Oras sa Tag-init sa Eastern Europe", "OEZ": "Tamdanang Oras sa Eastern Europe", "PDT": "Oras sa Tag-init sa Pasipiko", "PKT": "Oras sa Tag-init sa Pakistan", "PMDT": "Oras sa Tag-init sa St.Pierre & Miquelon", "PMST": "Tamdanang Oras sa St. Pierre & Miquelon", "PST": "Tamdanang Oras sa Pasipiko", "PYST": "Oras sa Tag-init sa Paraguay", "SAST": "Tamdanang Oras sa South Africa", "SGT": "Tamdanang Oras sa Singapore", "SRT": "Oras sa Suriname", "TLT": "Oras sa East Timor", "TMST": "Oras sa Tag-init sa Turkmenistan", "TMT": "Tamdanang Oras sa Turkmenistan", "UYST": "Oras sa Tag-init sa Uruguay", "UYT": "Tamdanang Oras sa Uruguay", "VET": "Oras sa Venezuela", "WARST": "Oras sa Tag-init sa Western Argentina", "WART": "Tamdanang Oras sa Western Argentina", "WAST": "Oras sa Tag-init sa West Africa", "WAT": "Tamdanang Oras sa West Africa", "WESZ": "Oras sa Tag-init sa Western Europe", "WEZ": "Tamdanang Oras sa Western Europe", "WIB": "Oras sa Western Indonesia", "WIT": "Oras sa Eastern Indonesia", "WITA": "Oras sa Central Indonesia", "∅∅∅": "Oras sa Tag-init sa Peru"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} ug {1}", "{0}, {1}", "{0}, {1}", "{0}, ug {1}"}, {"{0} o {1}", "{0}, {1}", "{0}, {1}", "{0}, o {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"mga siglo", "%v ka siglo", "%v ka mga siglo", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"mga dekada", "%v ka dekada", "%v ka mga dekada", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"tuig", "%v ka tuig", "%v ka tuig", ""},
				Long:   &locales.CounterFormat{"mga tuig", "%v ka tuig", "%v ka mga tuig", "%v kada tuig"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"buwan", "%v buwan", "%v buwan", ""},
				Long:   &locales.CounterFormat{"mga buwan", "%v ka buwan", "%v ka mga buwan", "%v kada buwan"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"semana", "%v semana", "%vw", ""},
				Long:   &locales.CounterFormat{"mga semana", "%v ka semana", "%v ka mga semana", "%v kada semana"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"adlaw", "%v adlaw", "%v adlaw", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"oras", "%v ka oras", "%v ka oras", ""},
				Long:   &locales.CounterFormat{"mga oras", "%v ka oras", "%v ka mga oras", "%v kada oras"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"minuto", "%v minuto", "%v minuto", ""},
				Long:   &locales.CounterFormat{"mga minuto", "%v ka minuto", "%v ka mga minuto", "%v kada minuto"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"segundo", "%vsegundo", "%vsegundo", ""},
				Long:   &locales.CounterFormat{"mga segundo", "%v ka segundo", "%v ka mga segundo", "%v kada segundo"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"msec", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"mga millisecond", "%v ka millisecond", "%v ka mga millisecond", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"mga microsecond", "%v ka microsecond", "%v ka mga microsecond", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"mga nanosecond", "%v ka nanosecond", "%v ka mga nanosecond", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"",
			"%[1]v+",
...
func (ceb *ceb) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ceb, ceb.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ceb'
func (ceb *ceb) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ceb, ceb.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ceb'
func (ceb *ceb) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ceb, ceb.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ceb'
func (ceb *ceb) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ceb, ceb.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ceb'
func (ceb *ceb) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ceb, ceb.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ceb'
func (ceb *ceb) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ceb, ceb.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ceb'
func (ceb *ceb) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ceb, ceb.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ceb'
func (ceb *ceb) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ceb, ceb.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ceb'
func (ceb *ceb) DateFullLayout() string {
	return ceb.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ceb'
func (ceb *ceb) DateLongLayout() string {
	return ceb.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ceb'
func (ceb *ceb) DateMediumLayout() string {
	return ceb.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ceb'
func (ceb *ceb) DateShortLayout() string {
	return ceb.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ceb'
func (ceb *ceb) TimeFullLayout() string {
	return ceb.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ceb'
func (ceb *ceb) TimeLongLayout() string {
	return ceb.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ceb'
func (ceb *ceb) TimeMediumLayout() string {
	return ceb.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ceb'
func (ceb *ceb) TimeShortLayout() string {
	return ceb.timeShortLayout
}

func (ceb *ceb) ListPatterns() *locales.ListPatterns {
	return ceb.listPatterns
}

func (ceb *ceb) GetDurationSpec() *locales.DurationSpec {
	return ceb.DurationSpec
}

func (ceb *ceb) GetMiscPatterns() *locales.MiscPatterns {
	return &ceb.miscPatterns
}
