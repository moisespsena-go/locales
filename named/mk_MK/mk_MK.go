...
// DateFullLayout returns the full date layout for 'mk_MK'
func (mk *mk_MK) DateFullLayout() string {
	return mk.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mk_MK'
func (mk *mk_MK) DateLongLayout() string {
	return mk.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mk_MK'
func (mk *mk_MK) DateMediumLayout() string {
	return mk.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mk_MK'
func (mk *mk_MK) DateShortLayout() string {
	return mk.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mk_MK'
func (mk *mk_MK) TimeFullLayout() string {
	return mk.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mk_MK'
func (mk *mk_MK) TimeLongLayout() string {
	return mk.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mk_MK'
func (mk *mk_MK) TimeMediumLayout() string {
	return mk.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mk_MK'
func (mk *mk_MK) TimeShortLayout() string {
	return mk.timeShortLayout
}

func (mk *mk_MK) ListPatterns() *locales.ListPatterns {
	return mk.listPatterns
}

func (mk *mk_MK) GetDurationSpec() *locales.DurationSpec {
	return mk.DurationSpec
}

func (mk *mk_MK) GetMiscPatterns() *locales.MiscPatterns {
