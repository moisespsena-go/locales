...
// DateFullLayout returns the full date layout for 'yrl_BR'
func (yrl *yrl_BR) DateFullLayout() string {
	return yrl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'yrl_BR'
func (yrl *yrl_BR) DateLongLayout() string {
	return yrl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'yrl_BR'
func (yrl *yrl_BR) DateMediumLayout() string {
	return yrl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'yrl_BR'
func (yrl *yrl_BR) DateShortLayout() string {
	return yrl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'yrl_BR'
func (yrl *yrl_BR) TimeFullLayout() string {
	return yrl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'yrl_BR'
func (yrl *yrl_BR) TimeLongLayout() string {
	return yrl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'yrl_BR'
func (yrl *yrl_BR) TimeMediumLayout() string {
	return yrl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'yrl_BR'
func (yrl *yrl_BR) TimeShortLayout() string {
	return yrl.timeShortLayout
}

func (yrl *yrl_BR) ListPatterns() *locales.ListPatterns {
	return yrl.listPatterns
}

func (yrl *yrl_BR) GetDurationSpec() *locales.DurationSpec {
	return yrl.DurationSpec
}

func (yrl *yrl_BR) GetMiscPatterns() *locales.MiscPatterns {
