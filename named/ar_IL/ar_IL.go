...
// DateFullLayout returns the full date layout for 'ar_IL'
func (ar *ar_IL) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_IL'
func (ar *ar_IL) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_IL'
func (ar *ar_IL) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_IL'
func (ar *ar_IL) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_IL'
func (ar *ar_IL) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_IL'
func (ar *ar_IL) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_IL'
func (ar *ar_IL) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_IL'
func (ar *ar_IL) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_IL) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_IL) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_IL) GetMiscPatterns() *locales.MiscPatterns {
