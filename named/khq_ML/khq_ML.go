...
func New() locales.Translator {
	return &khq_ML{
		...
		TimeSpec: &locales.TimeSpec{
			...
			WeekdaysAbbreviatedValue: []string{"Alh", "Ati", "Ata", "Ala", "Alm", "Alj", "Ass"},
			WeekdaysNarrowValue:      []string{"H", "T", "T", "L", "L", "L", "S"},
			WeekdaysWideValue:        []string{"Alhadi", "Atini", "Atalata", "Alarba", "Alhamiisa", "Aljuma", "Assabdu"},
			...
			ErasWideValue:            []string{"Isaa jine", "Isaa jamanoo"},
...
func (khq *khq_ML) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(khq, khq.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'khq_ML'
func (khq *khq_ML) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(khq, khq.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'khq_ML'
func (khq *khq_ML) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(khq, khq.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'khq_ML'
func (khq *khq_ML) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(khq, khq.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'khq_ML'
func (khq *khq_ML) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(khq, khq.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'khq_ML'
func (khq *khq_ML) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(khq, khq.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'khq_ML'
func (khq *khq_ML) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(khq, khq.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'khq_ML'
func (khq *khq_ML) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(khq, khq.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'khq_ML'
func (khq *khq_ML) DateFullLayout() string {
	return khq.dateFullLayout
}

// DateLongLayout returns the long date layout for 'khq_ML'
func (khq *khq_ML) DateLongLayout() string {
	return khq.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'khq_ML'
func (khq *khq_ML) DateMediumLayout() string {
	return khq.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'khq_ML'
func (khq *khq_ML) DateShortLayout() string {
	return khq.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'khq_ML'
func (khq *khq_ML) TimeFullLayout() string {
	return khq.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'khq_ML'
func (khq *khq_ML) TimeLongLayout() string {
	return khq.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'khq_ML'
func (khq *khq_ML) TimeMediumLayout() string {
	return khq.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'khq_ML'
func (khq *khq_ML) TimeShortLayout() string {
	return khq.timeShortLayout
}

func (khq *khq_ML) ListPatterns() *locales.ListPatterns {
	return khq.listPatterns
}

func (khq *khq_ML) GetDurationSpec() *locales.DurationSpec {
	return khq.DurationSpec
}

func (khq *khq_ML) GetMiscPatterns() *locales.MiscPatterns {
	return &khq.miscPatterns
}
