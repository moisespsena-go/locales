...
func New() locales.Translator {
	return &bez_TZ{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Hut", "Vil", "Dat", "Tai", "Han", "Sit", "Sab", "Nan", "Tis", "Kum", "Kmj", "Kmb"},
			MonthsNarrowValue:        []string{"", "H", "V", "D", "T", "H", "S", "S", "N", "T", "K", "K", "K"},
			MonthsWideValue:          []string{"", "pa mwedzi gwa hutala", "pa mwedzi gwa wuvili", "pa mwedzi gwa wudatu", "pa mwedzi gwa wutai", "pa mwedzi gwa wuhanu", "pa mwedzi gwa sita", "pa mwedzi gwa saba", "pa mwedzi gwa nane", "pa mwedzi gwa tisa", "pa mwedzi gwa kumi", "pa mwedzi gwa kumi na moja", "pa mwedzi gwa kumi na mbili"},
			WeekdaysAbbreviatedValue: []string{"Mul", "Vil", "Hiv", "Hid", "Hit", "Hih", "Lem"},
			WeekdaysNarrowValue:      []string{"M", "J", "H", "H", "H", "W", "J"},
			WeekdaysWideValue:        []string{"pa mulungu", "pa shahuviluha", "pa hivili", "pa hidatu", "pa hitayi", "pa hihanu", "pa shahulembela"},
			PeriodsAbbreviatedValue:  []string{"pamilau", "pamunyi"},
			PeriodsWideValue:         []string{"pamilau", "pamunyi"},
			ErasAbbreviatedValue:     []string{"KM", "BM"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Kabla ya Mtwaa", "Baada ya Mtwaa"},
...
func (bez *bez_TZ) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(bez, bez.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'bez_TZ'
func (bez *bez_TZ) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(bez, bez.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'bez_TZ'
func (bez *bez_TZ) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(bez, bez.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'bez_TZ'
func (bez *bez_TZ) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(bez, bez.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'bez_TZ'
func (bez *bez_TZ) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(bez, bez.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'bez_TZ'
func (bez *bez_TZ) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(bez, bez.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'bez_TZ'
func (bez *bez_TZ) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(bez, bez.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'bez_TZ'
func (bez *bez_TZ) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(bez, bez.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'bez_TZ'
func (bez *bez_TZ) DateFullLayout() string {
	return bez.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bez_TZ'
func (bez *bez_TZ) DateLongLayout() string {
	return bez.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bez_TZ'
func (bez *bez_TZ) DateMediumLayout() string {
	return bez.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bez_TZ'
func (bez *bez_TZ) DateShortLayout() string {
	return bez.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bez_TZ'
func (bez *bez_TZ) TimeFullLayout() string {
	return bez.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bez_TZ'
func (bez *bez_TZ) TimeLongLayout() string {
	return bez.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bez_TZ'
func (bez *bez_TZ) TimeMediumLayout() string {
	return bez.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bez_TZ'
func (bez *bez_TZ) TimeShortLayout() string {
	return bez.timeShortLayout
}

func (bez *bez_TZ) ListPatterns() *locales.ListPatterns {
	return bez.listPatterns
}

func (bez *bez_TZ) GetDurationSpec() *locales.DurationSpec {
	return bez.DurationSpec
}

func (bez *bez_TZ) GetMiscPatterns() *locales.MiscPatterns {
	return &bez.miscPatterns
}
