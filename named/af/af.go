...
func New() locales.Translator {
	return &af{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						...
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0 mjd"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 mjd"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00 mjd"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 mjd"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000 mjd"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000 mjd"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan.", "Feb.", "Mrt.", "Apr.", "Mei", "Jun.", "Jul.", "Aug.", "Sep.", "Okt.", "Nov.", "Des."},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Januarie", "Februarie", "Maart", "April", "Mei", "Junie", "Julie", "Augustus", "September", "Oktober", "November", "Desember"},
			WeekdaysAbbreviatedValue: []string{"So.", "Ma.", "Di.", "Wo.", "Do.", "Vr.", "Sa."},
			WeekdaysNarrowValue:      []string{"S", "M", "D", "W", "D", "V", "S"},
			WeekdaysShortValue:       []string{"So.", "Ma.", "Di.", "Wo.", "Do.", "Vr.", "Sa."},
			WeekdaysWideValue:        []string{"Sondag", "Maandag", "Dinsdag", "Woensdag", "Donderdag", "Vrydag", "Saterdag"},
			PeriodsAbbreviatedValue:  []string{"vm.", "nm."},
			PeriodsNarrowValue:       []string{"v", "n"},
			PeriodsWideValue:         []string{"vm.", "nm."},
			ErasAbbreviatedValue:     []string{"v.C.", "n.C."},
			ErasNarrowValue:          []string{"v.C.", "n.C."},
			ErasWideValue:            []string{"voor Christus", "na Christus"},
			TimezonesValue:           map[string]string{"": "Falklandeilande-standaardtyd", "ACDT": "Sentraal-Australiese dagligtyd", "ACST": "Sentraal-Australiese standaardtyd", "ACT": "ACT", "ACWDT": "Sentraal-westelike Australiese dagligtyd", "ACWST": "Sentraal-westelike Australiese standaard-tyd", "ADT": "Atlantiese dagligtyd", "AEDT": "Oostelike Australiese dagligtyd", "AEST": "Oostelike Australiese standaardtyd", "AFT": "Afganistan-tyd", "AKDT": "Alaska-dagligtyd", "AKST": "Alaska-standaardtyd", "AMST": "Amasone-somertyd", "AMT": "Amasone-standaardtyd", "ARST": "Argentinië-somertyd", "ART": "Argentinië-standaardtyd", "AST": "Atlantiese standaardtyd", "AWDT": "Westelike Australiese dagligtyd", "AWST": "Westelike Australiese standaardtyd", "BNT": "Broenei Darussalam-tyd", "BOT": "Bolivië-tyd", "BRST": "Brasilia-somertyd", "BRT": "Brasilia-standaardtyd", "BST": "Bangladesj-somertyd", "BTT": "Bhoetan-tyd", "CAT": "Sentraal-Afrika-tyd", "CCT": "Kokoseilande-tyd", "CDT": "Noord-Amerikaanse sentrale dagligtyd", "CDT (Kuba)": "Kuba-dagligtyd", "CHADT": "Chatham-dagligtyd", "CHAST": "Chatham-standaardtyd", "CLST": "Chili-somertyd", "CLT": "Chili-standaardtyd", "COST": "Colombia-somertyd", "COT": "Colombië-standaardtyd", "CST": "Noord-Amerikaanse sentrale standaardtyd", "CST (Kuba)": "Kuba-standaardtyd", "CXT": "Christmaseiland-tyd", "ChST": "Chamorro-standaardtyd", "EASST": "Paaseiland-somertyd", "EAST": "Paaseiland-standaardtyd", "EAT": "Oos-Afrika-tyd", "ECT": "Ecuador-tyd", "EDT": "Noord-Amerikaanse oostelike dagligtyd", "EGDT": "Oos-Groenland-somertyd", "EGST": "Oos-Groenland-standaardtyd", "EST": "Noord-Amerikaanse oostelike standaardtyd", "FKST": "Falklandeilande-somertyd", "GALT": "Galapagos-tyd", "GFT": "Frans-Guiana-tyd", "GMT": "Greenwich-tyd", "GST": "Persiese Golf-standaardtyd", "GYT": "Guiana-tyd", "HADT": "Hawaii-Aleoete-dagligtyd", "HAST": "Hawaii-Aleoete-standaardtyd", "HENOMX": "Noordwes-Meksiko-dagligtyd", "HEOG": "Wes-Groenland-somertyd", "HEPMX": "Meksikaanse Pasifiese dagligtyd", "HKST": "Hongkong-somertyd", "HKT": "Hongkong-standaardtyd", "HNNOMX": "Noordwes-Meksiko-standaardtyd", "HNOG": "Wes-Groenland-standaardtyd", "HNPMX": "Meksikaanse Pasifiese standaardtyd", "ICT": "Indosjina-tyd", "IRDT": "Iran-dagligtyd", "IRST": "Iran-standaardtyd", "IST": "Indië-standaardtyd", "JDT": "Japan-dagligtyd", "JST": "Japan-standaardtyd", "LHDT": "Lord Howe-dagligtyd", "LHST": "Lord Howe-standaardtyd", "MDT": "MDT", "MESZ": "Sentraal-Europese somertyd", "MEZ": "Sentraal-Europese standaardtyd", "MST": "MST", "MVT": "Maledive-tyd", "MYT": "Maleisië-tyd", "NDT": "Newfoundland-dagligtyd", "NPT": "Nepal-tyd", "NST": "Newfoundland-standaardtyd", "NZDT": "Nieu-Seeland-dagligtyd", "NZST": "Nieu-Seeland-standaardtyd", "OESZ": "Oos-Europese somertyd", "OEZ": "Oos-Europese standaardtyd", "PDT": "Pasifiese dagligtyd", "PKT": "Pakistan-somertyd", "PMDT": "Sint-Pierre en Miquelon-dagligtyd", "PMST": "Sint-Pierre en Miquelon-standaardtyd", "PST": "Pasifiese standaardtyd", "PYST": "Paraguay-somertyd", "SAST": "Suid-Afrika-standaardtyd", "SGT": "Singapoer-standaardtyd", "SRT": "Suriname-tyd", "TLT": "Oos-Timor-tyd", "TMST": "Turkmenistan-somertyd", "TMT": "Turkmenistan-standaardtyd", "UYST": "Uruguay-somertyd", "UYT": "Uruguay-standaardtyd", "VET": "Venezuela-tyd", "WARST": "Wes-Argentinië-somertyd", "WART": "Wes-Argentinië-standaardtyd", "WAST": "Wes-Afrika-somertyd", "WAT": "Wes-Afrika-standaardtyd", "WESZ": "Wes-Europese somertyd", "WEZ": "Wes-Europese standaardtyd", "WIB": "Wes-Indonesië-tyd", "WIT": "Oos-Indonesië-tyd", "WITA": "Sentraal-Indonesiese tyd", "∅∅∅": "Peru-somertyd"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} en {1}", "{0}, {1}", "{0}, {1}", "{0} en {1}"}, {"{0} of {1}", "{0}, {1}", "{0}, {1}", "{0} of {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%ve.", "%ve.", ""},
				Long:   &locales.CounterFormat{"eeu", "%v eeu", "%v eeue", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vdek.", "%vdek.", ""},
				Long:   &locales.CounterFormat{"dekades", "%v dekade", "%v dekades", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"j.", "%v j.", "%v j.", ""},
				Long:   &locales.CounterFormat{"jaar", "%v jaar", "%v jaar", "%v per jaar"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"maand", "%v md.", "%v md.", ""},
				Long:   &locales.CounterFormat{"maande", "%v maand", "%v maande", "%v/maand"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"w.", "%v w.", "%v w.", ""},
				Long:   &locales.CounterFormat{"weke", "%v week", "%v weke", "%v per week"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dag", "%v d.", "%v d.", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"uur", "%v u.", "%v u.", ""},
				Long:   &locales.CounterFormat{"uur", "%v uur", "%v uur", "%v per uur"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min.", "%v min.", "%v min.", ""},
				Long:   &locales.CounterFormat{"minute", "%v minuut", "%v minute", "%v per minuut"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s.", "%v s.", "%v s.", ""},
				Long:   &locales.CounterFormat{"sekondes", "%v sekonde", "%v sekondes", "%v per sekonde"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms.", "%v ms.", "%v ms.", ""},
				Long:   &locales.CounterFormat{"millisekondes", "%v millisekonde", "%v millisekondes", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vμs.", "%vμs.", ""},
				Long:   &locales.CounterFormat{"mikrosekondes", "%v mikrosekonde", "%v mikrosekondes", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vns.", "%vns.", ""},
				Long:   &locales.CounterFormat{"nanosekondes", "%v nanosekonde", "%v nanosekondes", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (af *af) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(af, af.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'af'
func (af *af) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(af, af.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'af'
func (af *af) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(af, af.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'af'
func (af *af) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(af, af.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'af'
func (af *af) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(af, af.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'af'
func (af *af) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(af, af.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'af'
func (af *af) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(af, af.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'af'
func (af *af) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(af, af.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'af'
func (af *af) DateFullLayout() string {
	return af.dateFullLayout
}

// DateLongLayout returns the long date layout for 'af'
func (af *af) DateLongLayout() string {
	return af.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'af'
func (af *af) DateMediumLayout() string {
	return af.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'af'
func (af *af) DateShortLayout() string {
	return af.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'af'
func (af *af) TimeFullLayout() string {
	return af.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'af'
func (af *af) TimeLongLayout() string {
	return af.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'af'
func (af *af) TimeMediumLayout() string {
	return af.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'af'
func (af *af) TimeShortLayout() string {
	return af.timeShortLayout
}

func (af *af) ListPatterns() *locales.ListPatterns {
	return af.listPatterns
}

func (af *af) GetDurationSpec() *locales.DurationSpec {
	return af.DurationSpec
}

func (af *af) GetMiscPatterns() *locales.MiscPatterns {
	return &af.miscPatterns
}
