...
func New() locales.Translator {
	return &es_PA{
		...
		dateMediumLayout: "MM/dd/y",
		dateShortLayout:  "MM/dd/yy",
...
// DateFullLayout returns the full date layout for 'es_PA'
func (es *es_PA) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_PA'
func (es *es_PA) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_PA'
func (es *es_PA) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_PA'
func (es *es_PA) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_PA'
func (es *es_PA) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_PA'
func (es *es_PA) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_PA'
func (es *es_PA) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_PA'
func (es *es_PA) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_PA) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_PA) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_PA) GetMiscPatterns() *locales.MiscPatterns {
