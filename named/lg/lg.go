...
// DateFullLayout returns the full date layout for 'lg'
func (lg *lg) DateFullLayout() string {
	return lg.dateFullLayout
}

// DateLongLayout returns the long date layout for 'lg'
func (lg *lg) DateLongLayout() string {
	return lg.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'lg'
func (lg *lg) DateMediumLayout() string {
	return lg.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'lg'
func (lg *lg) DateShortLayout() string {
	return lg.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'lg'
func (lg *lg) TimeFullLayout() string {
	return lg.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'lg'
func (lg *lg) TimeLongLayout() string {
	return lg.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'lg'
func (lg *lg) TimeMediumLayout() string {
	return lg.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'lg'
func (lg *lg) TimeShortLayout() string {
	return lg.timeShortLayout
}

func (lg *lg) ListPatterns() *locales.ListPatterns {
	return lg.listPatterns
}

func (lg *lg) GetDurationSpec() *locales.DurationSpec {
	return lg.DurationSpec
}

func (lg *lg) GetMiscPatterns() *locales.MiscPatterns {
