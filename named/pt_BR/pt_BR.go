...
// DateFullLayout returns the full date layout for 'pt_BR'
func (pt *pt_BR) DateFullLayout() string {
	return pt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pt_BR'
func (pt *pt_BR) DateLongLayout() string {
	return pt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pt_BR'
func (pt *pt_BR) DateMediumLayout() string {
	return pt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pt_BR'
func (pt *pt_BR) DateShortLayout() string {
	return pt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pt_BR'
func (pt *pt_BR) TimeFullLayout() string {
	return pt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pt_BR'
func (pt *pt_BR) TimeLongLayout() string {
	return pt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pt_BR'
func (pt *pt_BR) TimeMediumLayout() string {
	return pt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pt_BR'
func (pt *pt_BR) TimeShortLayout() string {
	return pt.timeShortLayout
}

func (pt *pt_BR) ListPatterns() *locales.ListPatterns {
	return pt.listPatterns
}

func (pt *pt_BR) GetDurationSpec() *locales.DurationSpec {
	return pt.DurationSpec
}

func (pt *pt_BR) GetMiscPatterns() *locales.MiscPatterns {
