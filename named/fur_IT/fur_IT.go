...
// DateFullLayout returns the full date layout for 'fur_IT'
func (fur *fur_IT) DateFullLayout() string {
	return fur.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fur_IT'
func (fur *fur_IT) DateLongLayout() string {
	return fur.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fur_IT'
func (fur *fur_IT) DateMediumLayout() string {
	return fur.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fur_IT'
func (fur *fur_IT) DateShortLayout() string {
	return fur.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fur_IT'
func (fur *fur_IT) TimeFullLayout() string {
	return fur.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fur_IT'
func (fur *fur_IT) TimeLongLayout() string {
	return fur.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fur_IT'
func (fur *fur_IT) TimeMediumLayout() string {
	return fur.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fur_IT'
func (fur *fur_IT) TimeShortLayout() string {
	return fur.timeShortLayout
}

func (fur *fur_IT) ListPatterns() *locales.ListPatterns {
	return fur.listPatterns
}

func (fur *fur_IT) GetDurationSpec() *locales.DurationSpec {
	return fur.DurationSpec
}

func (fur *fur_IT) GetMiscPatterns() *locales.MiscPatterns {
