...
// DateFullLayout returns the full date layout for 'en_US'
func (en *en_US) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_US'
func (en *en_US) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_US'
func (en *en_US) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_US'
func (en *en_US) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_US'
func (en *en_US) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_US'
func (en *en_US) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_US'
func (en *en_US) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_US'
func (en *en_US) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_US) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_US) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_US) GetMiscPatterns() *locales.MiscPatterns {
