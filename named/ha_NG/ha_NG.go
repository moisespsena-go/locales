...
// DateFullLayout returns the full date layout for 'ha_NG'
func (ha *ha_NG) DateFullLayout() string {
	return ha.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ha_NG'
func (ha *ha_NG) DateLongLayout() string {
	return ha.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ha_NG'
func (ha *ha_NG) DateMediumLayout() string {
	return ha.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ha_NG'
func (ha *ha_NG) DateShortLayout() string {
	return ha.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ha_NG'
func (ha *ha_NG) TimeFullLayout() string {
	return ha.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ha_NG'
func (ha *ha_NG) TimeLongLayout() string {
	return ha.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ha_NG'
func (ha *ha_NG) TimeMediumLayout() string {
	return ha.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ha_NG'
func (ha *ha_NG) TimeShortLayout() string {
	return ha.timeShortLayout
}

func (ha *ha_NG) ListPatterns() *locales.ListPatterns {
	return ha.listPatterns
}

func (ha *ha_NG) GetDurationSpec() *locales.DurationSpec {
	return ha.DurationSpec
}

func (ha *ha_NG) GetMiscPatterns() *locales.MiscPatterns {
