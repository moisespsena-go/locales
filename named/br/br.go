...
func New() locales.Translator {
	return &br{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Gen.", "Cʼhwe.", "Meur.", "Ebr.", "Mae", "Mezh.", "Goue.", "Eost", "Gwen.", "Here", "Du", "Kzu."},
			MonthsNarrowValue:        []string{"", "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"},
			MonthsWideValue:          []string{"", "Genver", "Cʼhwevrer", "Meurzh", "Ebrel", "Mae", "Mezheven", "Gouere", "Eost", "Gwengolo", "Here", "Du", "Kerzu"},
			WeekdaysAbbreviatedValue: []string{"Sul", "Lun", "Meu.", "Mer.", "Yaou", "Gwe.", "Sad."},
			WeekdaysNarrowValue:      []string{"Su", "L", "Mz", "Mc", "Y", "G", "Sa"},
			WeekdaysShortValue:       []string{"Sul", "Lun", "Meu.", "Mer.", "Yaou", "Gwe.", "Sad."},
			WeekdaysWideValue:        []string{"Sul", "Lun", "Meurzh", "Mercʼher", "Yaou", "Gwener", "Sadorn"},
			PeriodsAbbreviatedValue:  []string{"A.M.", "G.M."},
			PeriodsNarrowValue:       []string{"am", "gm"},
			PeriodsWideValue:         []string{"A.M.", "G.M."},
			ErasAbbreviatedValue:     []string{"a-raok J.K.", "goude J.K."},
			ErasNarrowValue:          []string{"a-raok J.K.", "goude J.K."},
			ErasWideValue:            []string{"a-raok Jezuz-Krist", "goude Jezuz-Krist"},
			TimezonesValue:           map[string]string{"": "eur cʼhoañv Inizi Falkland", "ACDT": "eur hañv Kreizaostralia", "ACST": "ACST", "ACT": "ACT", "ACWDT": "eur hañv Kreizaostralia ar Cʼhornôg", "ACWST": "eur cʼhoañv Kreizaostralia ar Cʼhornôg", "ADT": "eur hañv an Atlantel", "AEDT": "eur hañv Aostralia ar Reter", "AEST": "eur cʼhoañv Aostralia ar Reter", "AFT": "eur Afghanistan", "AKDT": "eur hañv Alaska", "AKST": "eur cʼhoañv Alaska", "AMST": "eur hañv an Amazon", "AMT": "eur cʼhoañv an Amazon", "ARST": "eur hañv Arcʼhantina", "ART": "eur cʼhoañv Arcʼhantina", "AST": "eur cʼhoañv an Atlantel", "AWDT": "eur hañv Aostralia ar Cʼhornôg", "AWST": "eur cʼhoañv Aostralia ar Cʼhornôg", "BNT": "eur Brunei Darussalam", "BOT": "eur Bolivia", "BRST": "eur hañv Brasília", "BRT": "eur cʼhoañv Brasília", "BST": "eur hañv Bangladesh", "BTT": "eur Bhoutan", "CAT": "eur Kreizafrika", "CCT": "eur Inizi Kokoz", "CDT": "eur hañv ar Cʼhreiz", "CDT (Kuba)": "eur hañv Kuba", "CHADT": "eur hañv Chatham", "CHAST": "eur cʼhoañv Chatham", "CLST": "eur hañv Chile", "CLT": "eur cʼhoañv Chile", "COST": "eur hañv Kolombia", "COT": "eur cʼhoañv Kolombia", "CST": "eur cʼhoañv ar Cʼhreiz", "CST (Kuba)": "eur cʼhoañv Kuba", "CXT": "eur Enez Christmas", "ChST": "eur Chamorro", "EASST": "eur hañv Enez Pask", "EAST": "eur cʼhoañv Enez Pask", "EAT": "eur Afrika ar Reter", "ECT": "eur Ecuador", "EDT": "eur hañv ar Reter", "EGDT": "eur hañv Greunland ar Reter", "EGST": "eur cʼhoañv Greunland ar Reter", "EST": "eur cʼhoañv ar Reter", "FKST": "eur hañv Inizi Falkland", "GALT": "eur Inizi Galápagos", "GFT": "eur Gwiana cʼhall", "GMT": "Amzer keitat Greenwich (AKG)", "GST": "eur cʼhoañv ar Pleg-mor Arab-ha-Pers", "GYT": "eur Guyana", "HADT": "eur hañv Hawaii hag an Aleouted", "HAST": "eur cʼhoañv Hawaii hag an Aleouted", "HENOMX": "eur hañv Gwalarn Mecʼhiko", "HEOG": "eur hañv Greunland ar Cʼhornôg", "HEPMX": "eur hañv an Habask mecʼhikan", "HKST": "eur hañv Hong Kong", "HKT": "eur cʼhoañv Hong Kong", "HNNOMX": "eur cʼhoañv Gwalarn Mecʼhiko", "HNOG": "eur cʼhoañv Greunland ar Cʼhornôg", "HNPMX": "eur cʼhoañv an Habask mecʼhikan", "ICT": "eur Indez-Sina", "IRDT": "eur hañv Iran", "IRST": "eur cʼhoañv Iran", "IST": "eur cʼhoañv India", "JDT": "eur hañv Japan", "JST": "eur cʼhoañv Japan", "LHDT": "eur hañv Lord Howe", "LHST": "eur cʼhoañv Lord Howe", "MDT": "eur hañv Macau", "MESZ": "eur hañv Kreizeuropa", "MEZ": "eur cʼhoañv Kreizeuropa", "MST": "eur cʼhoañv Macau", "MVT": "eur ar Maldivez", "MYT": "eur Malaysia", "NDT": "eur hañv Newfoundland", "NPT": "eur Nepal", "NST": "eur cʼhoañv Newfoundland", "NZDT": "eur hañv Zeland-Nevez", "NZST": "eur cʼhoañv Zeland-Nevez", "OESZ": "eur hañv Europa ar Reter", "OEZ": "eur cʼhoañv Europa ar Reter", "PDT": "eur hañv an Habask", "PKT": "eur hañv Pakistan", "PMDT": "eur hañv Sant-Pêr-ha-Mikelon", "PMST": "eur cʼhoañv Sant-Pêr-ha-Mikelon", "PST": "eur cʼhoañv an Habask", "PYST": "eur hañv Paraguay", "SAST": "eur cʼhoañv Suafrika", "SGT": "eur cʼhoañv Singapour", "SRT": "eur Surinam", "TLT": "eur Timor ar Reter", "TMST": "eur hañv Turkmenistan", "TMT": "eur cʼhoañv Turkmenistan", "UYST": "eur hañv Uruguay", "UYT": "eur cʼhoañv Uruguay", "VET": "eur Venezuela", "WARST": "eur hañv Arcʼhantina ar Cʼhornôg", "WART": "eur cʼhoañv Arcʼhantina ar Cʼhornôg", "WAST": "eur hañv Afrika ar Cʼhornôg", "WAT": "eur cʼhoañv Afrika ar Cʼhornôg", "WESZ": "eur hañv Europa ar Cʼhornôg", "WEZ": "eur cʼhoañv Europa ar Cʼhornôg", "WIB": "eur Indonezia ar Cʼhornôg", "WIT": "eur Indonezia ar Reter", "WITA": "eur Kreiz Indonezia", "∅∅∅": "eur hañv Perou"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} ha {1}", "{0}, {1}", "{0}, {1}", "{0} ha {1}"}, {"{0} pe {1}", "{0}, {1}", "{0}, {1}", "{0} pe {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vkved", "%vkved", ""},
				Long:   &locales.CounterFormat{"kantvedoù", "%v c'hantved", "%v kantved", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dek", "%vdek", "%vdek", ""},
				Long:   &locales.CounterFormat{"dekvloavezhiadoù", "%v dekvloavezhiad", "%v dekvloavezhiad", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"b", "%vb", "%vb", "%v/b"},
				Long:   &locales.CounterFormat{"bloazioù", "%v bloaz", "%v vloaz", "%v dre vloaz"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m", "%vm", "%vm", "%v/m"},
				Long:   &locales.CounterFormat{"mizioù", "%v miz", "%v miz", "%v dre viz"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sizh.", "%vsizh.", "%vsizh.", "%v/sizh."},
				Long:   &locales.CounterFormat{"sizhunioù", "%v sizhun", "%v sizhun", "%v dre sizhun"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vd", "%vd", "%v/d"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"h", "%vh", "%vh", "%v/h"},
				Long:   &locales.CounterFormat{"eurioù", "%v eur", "%v eur", "%v dre eur"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vmin", "%vmin", "%v/min"},
				Long:   &locales.CounterFormat{"munutoù", "%v munut", "%v munut", "%v dre vunut"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vs", "%vs", ""},
				Long:   &locales.CounterFormat{"eilennoù", "%v eilenn", "%v eilenn", "%v dre eilenn"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"milieilennoù", "%v milieilenn", "%v milieilenn", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vμs", "%vμs", ""},
				Long:   &locales.CounterFormat{"mikroeilennoù", "%v mikroeilenn", "%v mikroeilenn", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vns", "%vns", ""},
				Long:   &locales.CounterFormat{"nanoeilennoù", "%v nanoeilenn", "%v nanoeilenn", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"",
			"≥%[1]v",
...
func (br *br) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(br, br.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'br'
func (br *br) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(br, br.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'br'
func (br *br) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(br, br.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'br'
func (br *br) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(br, br.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'br'
func (br *br) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(br, br.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'br'
func (br *br) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(br, br.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'br'
func (br *br) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(br, br.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'br'
func (br *br) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(br, br.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'br'
func (br *br) DateFullLayout() string {
	return br.dateFullLayout
}

// DateLongLayout returns the long date layout for 'br'
func (br *br) DateLongLayout() string {
	return br.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'br'
func (br *br) DateMediumLayout() string {
	return br.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'br'
func (br *br) DateShortLayout() string {
	return br.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'br'
func (br *br) TimeFullLayout() string {
	return br.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'br'
func (br *br) TimeLongLayout() string {
	return br.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'br'
func (br *br) TimeMediumLayout() string {
	return br.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'br'
func (br *br) TimeShortLayout() string {
	return br.timeShortLayout
}

func (br *br) ListPatterns() *locales.ListPatterns {
	return br.listPatterns
}

func (br *br) GetDurationSpec() *locales.DurationSpec {
	return br.DurationSpec
}

func (br *br) GetMiscPatterns() *locales.MiscPatterns {
	return &br.miscPatterns
}
