...
// DateFullLayout returns the full date layout for 'shi_Tfng'
func (shi *shi_Tfng) DateFullLayout() string {
	return shi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'shi_Tfng'
func (shi *shi_Tfng) DateLongLayout() string {
	return shi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'shi_Tfng'
func (shi *shi_Tfng) DateMediumLayout() string {
	return shi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'shi_Tfng'
func (shi *shi_Tfng) DateShortLayout() string {
	return shi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'shi_Tfng'
func (shi *shi_Tfng) TimeFullLayout() string {
	return shi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'shi_Tfng'
func (shi *shi_Tfng) TimeLongLayout() string {
	return shi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'shi_Tfng'
func (shi *shi_Tfng) TimeMediumLayout() string {
	return shi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'shi_Tfng'
func (shi *shi_Tfng) TimeShortLayout() string {
	return shi.timeShortLayout
}

func (shi *shi_Tfng) ListPatterns() *locales.ListPatterns {
	return shi.listPatterns
}

func (shi *shi_Tfng) GetDurationSpec() *locales.DurationSpec {
	return shi.DurationSpec
}

func (shi *shi_Tfng) GetMiscPatterns() *locales.MiscPatterns {
