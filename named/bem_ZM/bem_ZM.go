...
func New() locales.Translator {
	return &bem_ZM{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:               ":",
			MonthsAbbreviatedValue:  []string{"", "Jan", "Feb", "Mac", "Epr", "Mei", "Jun", "Jul", "Oga", "Sep", "Okt", "Nov", "Dis"},
			MonthsNarrowValue:       []string{"", "J", "F", "M", "E", "M", "J", "J", "O", "S", "O", "N", "D"},
			MonthsWideValue:         []string{"", "Januari", "Februari", "Machi", "Epreo", "Mei", "Juni", "Julai", "Ogasti", "Septemba", "Oktoba", "Novemba", "Disemba"},
			WeekdaysWideValue:       []string{"Pa Mulungu", "Palichimo", "Palichibuli", "Palichitatu", "Palichine", "Palichisano", "Pachibelushi"},
			PeriodsAbbreviatedValue: []string{"uluchelo", "akasuba"},
			PeriodsWideValue:        []string{"uluchelo", "akasuba"},
			ErasAbbreviatedValue:    []string{"BC", "AD"},
			ErasNarrowValue:         []string{"", ""},
			ErasWideValue:           []string{"Before Yesu", "After Yesu"},
...
func (bem *bem_ZM) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(bem, bem.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'bem_ZM'
func (bem *bem_ZM) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(bem, bem.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'bem_ZM'
func (bem *bem_ZM) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(bem, bem.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'bem_ZM'
func (bem *bem_ZM) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(bem, bem.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'bem_ZM'
func (bem *bem_ZM) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(bem, bem.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'bem_ZM'
func (bem *bem_ZM) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(bem, bem.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'bem_ZM'
func (bem *bem_ZM) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(bem, bem.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'bem_ZM'
func (bem *bem_ZM) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(bem, bem.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'bem_ZM'
func (bem *bem_ZM) DateFullLayout() string {
	return bem.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bem_ZM'
func (bem *bem_ZM) DateLongLayout() string {
	return bem.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bem_ZM'
func (bem *bem_ZM) DateMediumLayout() string {
	return bem.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bem_ZM'
func (bem *bem_ZM) DateShortLayout() string {
	return bem.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bem_ZM'
func (bem *bem_ZM) TimeFullLayout() string {
	return bem.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bem_ZM'
func (bem *bem_ZM) TimeLongLayout() string {
	return bem.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bem_ZM'
func (bem *bem_ZM) TimeMediumLayout() string {
	return bem.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bem_ZM'
func (bem *bem_ZM) TimeShortLayout() string {
	return bem.timeShortLayout
}

func (bem *bem_ZM) ListPatterns() *locales.ListPatterns {
	return bem.listPatterns
}

func (bem *bem_ZM) GetDurationSpec() *locales.DurationSpec {
	return bem.DurationSpec
}

func (bem *bem_ZM) GetMiscPatterns() *locales.MiscPatterns {
	return &bem.miscPatterns
}
