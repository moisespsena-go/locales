...
// DateFullLayout returns the full date layout for 'nl_BE'
func (nl *nl_BE) DateFullLayout() string {
	return nl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nl_BE'
func (nl *nl_BE) DateLongLayout() string {
	return nl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nl_BE'
func (nl *nl_BE) DateMediumLayout() string {
	return nl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nl_BE'
func (nl *nl_BE) DateShortLayout() string {
	return nl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nl_BE'
func (nl *nl_BE) TimeFullLayout() string {
	return nl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nl_BE'
func (nl *nl_BE) TimeLongLayout() string {
	return nl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nl_BE'
func (nl *nl_BE) TimeMediumLayout() string {
	return nl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nl_BE'
func (nl *nl_BE) TimeShortLayout() string {
	return nl.timeShortLayout
}

func (nl *nl_BE) ListPatterns() *locales.ListPatterns {
	return nl.listPatterns
}

func (nl *nl_BE) GetDurationSpec() *locales.DurationSpec {
	return nl.DurationSpec
}

func (nl *nl_BE) GetMiscPatterns() *locales.MiscPatterns {
