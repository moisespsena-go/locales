...
// DateFullLayout returns the full date layout for 'os_RU'
func (os *os_RU) DateFullLayout() string {
	return os.dateFullLayout
}

// DateLongLayout returns the long date layout for 'os_RU'
func (os *os_RU) DateLongLayout() string {
	return os.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'os_RU'
func (os *os_RU) DateMediumLayout() string {
	return os.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'os_RU'
func (os *os_RU) DateShortLayout() string {
	return os.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'os_RU'
func (os *os_RU) TimeFullLayout() string {
	return os.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'os_RU'
func (os *os_RU) TimeLongLayout() string {
	return os.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'os_RU'
func (os *os_RU) TimeMediumLayout() string {
	return os.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'os_RU'
func (os *os_RU) TimeShortLayout() string {
	return os.timeShortLayout
}

func (os *os_RU) ListPatterns() *locales.ListPatterns {
	return os.listPatterns
}

func (os *os_RU) GetDurationSpec() *locales.DurationSpec {
	return os.DurationSpec
}

func (os *os_RU) GetMiscPatterns() *locales.MiscPatterns {
