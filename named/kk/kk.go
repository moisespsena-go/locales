	...
	return &kk{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"ғ.", "%v ғ.", "%v ғ.", ""},
				Long:   &locales.CounterFormat{"ғасыр", "%v ғасыр", "%v ғасыр", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"декада", "%v декада", "%v декада", ""},
				Long:   &locales.CounterFormat{"декада", "%v декада", "%v декада", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ж.", "%v ж.", "%v ж.", ""},
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ап.", "%v ап.", "%v ап.", ""},
				Long:   &locales.CounterFormat{"апта", "%v апта", "%v апта", "аптасына %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"күн", "%v к.", "%v к.", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"сағ", "%v сағ", "%v сағ", ""},
				Long:   &locales.CounterFormat{"сағат", "%v сағат", "%v сағат", "сағатына %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мин", "%v мин", "%v мин", ""},
				Long:   &locales.CounterFormat{"минут", "%v минут", "%v минут", "минутына %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"с", "%v с", "%v с", ""},
				Long:   &locales.CounterFormat{"секунд", "%v секунд", "%v секунд", "секундына %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
...
// DateFullLayout returns the full date layout for 'kk'
func (kk *kk) DateFullLayout() string {
	return kk.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kk'
func (kk *kk) DateLongLayout() string {
	return kk.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kk'
func (kk *kk) DateMediumLayout() string {
	return kk.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kk'
func (kk *kk) DateShortLayout() string {
	return kk.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kk'
func (kk *kk) TimeFullLayout() string {
	return kk.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kk'
func (kk *kk) TimeLongLayout() string {
	return kk.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kk'
func (kk *kk) TimeMediumLayout() string {
	return kk.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kk'
func (kk *kk) TimeShortLayout() string {
	return kk.timeShortLayout
}

func (kk *kk) ListPatterns() *locales.ListPatterns {
	return kk.listPatterns
}

func (kk *kk) GetDurationSpec() *locales.DurationSpec {
	return kk.DurationSpec
}

func (kk *kk) GetMiscPatterns() *locales.MiscPatterns {
