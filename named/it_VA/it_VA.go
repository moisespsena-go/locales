...
// DateFullLayout returns the full date layout for 'it_VA'
func (it *it_VA) DateFullLayout() string {
	return it.dateFullLayout
}

// DateLongLayout returns the long date layout for 'it_VA'
func (it *it_VA) DateLongLayout() string {
	return it.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'it_VA'
func (it *it_VA) DateMediumLayout() string {
	return it.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'it_VA'
func (it *it_VA) DateShortLayout() string {
	return it.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'it_VA'
func (it *it_VA) TimeFullLayout() string {
	return it.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'it_VA'
func (it *it_VA) TimeLongLayout() string {
	return it.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'it_VA'
func (it *it_VA) TimeMediumLayout() string {
	return it.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'it_VA'
func (it *it_VA) TimeShortLayout() string {
	return it.timeShortLayout
}

func (it *it_VA) ListPatterns() *locales.ListPatterns {
	return it.listPatterns
}

func (it *it_VA) GetDurationSpec() *locales.DurationSpec {
	return it.DurationSpec
}

func (it *it_VA) GetMiscPatterns() *locales.MiscPatterns {
