...
// DateFullLayout returns the full date layout for 'mt_MT'
func (mt *mt_MT) DateFullLayout() string {
	return mt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mt_MT'
func (mt *mt_MT) DateLongLayout() string {
	return mt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mt_MT'
func (mt *mt_MT) DateMediumLayout() string {
	return mt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mt_MT'
func (mt *mt_MT) DateShortLayout() string {
	return mt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mt_MT'
func (mt *mt_MT) TimeFullLayout() string {
	return mt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mt_MT'
func (mt *mt_MT) TimeLongLayout() string {
	return mt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mt_MT'
func (mt *mt_MT) TimeMediumLayout() string {
	return mt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mt_MT'
func (mt *mt_MT) TimeShortLayout() string {
	return mt.timeShortLayout
}

func (mt *mt_MT) ListPatterns() *locales.ListPatterns {
	return mt.listPatterns
}

func (mt *mt_MT) GetDurationSpec() *locales.DurationSpec {
	return mt.DurationSpec
}

func (mt *mt_MT) GetMiscPatterns() *locales.MiscPatterns {
