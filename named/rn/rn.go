...
// DateFullLayout returns the full date layout for 'rn'
func (rn *rn) DateFullLayout() string {
	return rn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'rn'
func (rn *rn) DateLongLayout() string {
	return rn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'rn'
func (rn *rn) DateMediumLayout() string {
	return rn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'rn'
func (rn *rn) DateShortLayout() string {
	return rn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'rn'
func (rn *rn) TimeFullLayout() string {
	return rn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'rn'
func (rn *rn) TimeLongLayout() string {
	return rn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'rn'
func (rn *rn) TimeMediumLayout() string {
	return rn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'rn'
func (rn *rn) TimeShortLayout() string {
	return rn.timeShortLayout
}

func (rn *rn) ListPatterns() *locales.ListPatterns {
	return rn.listPatterns
}

func (rn *rn) GetDurationSpec() *locales.DurationSpec {
	return rn.DurationSpec
}

func (rn *rn) GetMiscPatterns() *locales.MiscPatterns {
