...
// DateFullLayout returns the full date layout for 'eu_ES'
func (eu *eu_ES) DateFullLayout() string {
	return eu.dateFullLayout
}

// DateLongLayout returns the long date layout for 'eu_ES'
func (eu *eu_ES) DateLongLayout() string {
	return eu.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'eu_ES'
func (eu *eu_ES) DateMediumLayout() string {
	return eu.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'eu_ES'
func (eu *eu_ES) DateShortLayout() string {
	return eu.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'eu_ES'
func (eu *eu_ES) TimeFullLayout() string {
	return eu.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'eu_ES'
func (eu *eu_ES) TimeLongLayout() string {
	return eu.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'eu_ES'
func (eu *eu_ES) TimeMediumLayout() string {
	return eu.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'eu_ES'
func (eu *eu_ES) TimeShortLayout() string {
	return eu.timeShortLayout
}

func (eu *eu_ES) ListPatterns() *locales.ListPatterns {
	return eu.listPatterns
}

func (eu *eu_ES) GetDurationSpec() *locales.DurationSpec {
	return eu.DurationSpec
}

func (eu *eu_ES) GetMiscPatterns() *locales.MiscPatterns {
