...
func New() locales.Translator {
	return &es_DO{
		...
		TimeSpec: &locales.TimeSpec{
			...
			ErasWideValue:            []string{"antes de la Era Común", "Era Común"},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"seg.", "%v seg.", "%v seg.", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
...
// DateFullLayout returns the full date layout for 'es_DO'
func (es *es_DO) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_DO'
func (es *es_DO) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_DO'
func (es *es_DO) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_DO'
func (es *es_DO) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_DO'
func (es *es_DO) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_DO'
func (es *es_DO) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_DO'
func (es *es_DO) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_DO'
func (es *es_DO) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_DO) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_DO) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_DO) GetMiscPatterns() *locales.MiscPatterns {
