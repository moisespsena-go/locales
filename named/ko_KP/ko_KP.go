...
func New() locales.Translator {
	return &ko_KP{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0천"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0만"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00만"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000만"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0000만"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0억"),
						}},
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00억"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000억"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0000억"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0조"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00조"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000조"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"},
			MonthsNarrowValue:        []string{"", "1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"},
			MonthsWideValue:          []string{"", "1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"},
			WeekdaysAbbreviatedValue: []string{"일", "월", "화", "수", "목", "금", "토"},
			WeekdaysNarrowValue:      []string{"일", "월", "화", "수", "목", "금", "토"},
			WeekdaysShortValue:       []string{"일", "월", "화", "수", "목", "금", "토"},
			WeekdaysWideValue:        []string{"일요일", "월요일", "화요일", "수요일", "목요일", "금요일", "토요일"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsNarrowValue:       []string{"AM", "PM"},
			PeriodsWideValue:         []string{"오전", "오후"},
			ErasAbbreviatedValue:     []string{"BC", "AD"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"기원전", "서기"},
			TimezonesValue:           map[string]string{"": "파라과이 표준시", "ACDT": "오스트레일리아 중부 하계 표준시", "ACST": "오스트레일리아 중부 표준시", "ACT": "아크레 표준시", "ACWDT": "오스트레일리아 중서부 하계 표준시", "ACWST": "오스트레일리아 중서부 표준시", "ADT": "대서양 하계 표준시", "AEDT": "오스트레일리아 동부 하계 표준시", "AEST": "오스트레일리아 동부 표준시", "AFT": "아프가니스탄 시간", "AKDT": "알래스카 하계 표준시", "AKST": "알래스카 표준시", "AMST": "아마존 하계 표준시", "AMT": "아마존 표준시", "ARST": "아르헨티나 하계 표준시", "ART": "아르헨티나 표준시", "AST": "대서양 표준시", "AWDT": "오스트레일리아 서부 하계 표준시", "AWST": "오스트레일리아 서부 표준시", "BNT": "브루나이 시간", "BOT": "볼리비아 시간", "BRST": "브라질리아 하계 표준시", "BRT": "브라질리아 표준시", "BST": "방글라데시 하계 표준시", "BTT": "부탄 시간", "CAT": "중앙아프리카 시간", "CCT": "코코스 제도 시간", "CDT": "미 중부 하계 표준시", "CDT (Kuba)": "쿠바 하계 표준시", "CHADT": "채텀 하계 표준시", "CHAST": "채텀 표준시", "CLST": "칠레 하계 표준시", "CLT": "칠레 표준시", "COST": "콜롬비아 하계 표준시", "COT": "콜롬비아 표준시", "CST": "미 중부 표준시", "CST (Kuba)": "쿠바 표준시", "CXT": "크리스마스섬 시간", "ChST": "차모로 시간", "EASST": "이스터섬 하계 표준시", "EAST": "이스터섬 표준시", "EAT": "동아프리카 시간", "ECT": "에콰도르 시간", "EDT": "미 동부 하계 표준시", "EGDT": "그린란드 동부 하계 표준시", "EGST": "그린란드 동부 표준시", "EST": "미 동부 표준시", "FKST": "포클랜드 제도 하계 표준시", "GALT": "갈라파고스 시간", "GFT": "프랑스령 가이아나 시간", "GMT": "그리니치 표준시", "GST": "걸프만 표준시", "GYT": "가이아나 시간", "HADT": "하와이 알류샨 하계 표준시", "HAST": "하와이 알류샨 표준시", "HENOMX": "멕시코 북서부 하계 표준시", "HEOG": "그린란드 서부 하계 표준시", "HEPMX": "멕시코 태평양 하계 표준시", "HKST": "홍콩 하계 표준시", "HKT": "홍콩 표준시", "HNNOMX": "멕시코 북서부 표준시", "HNOG": "그린란드 서부 표준시", "HNPMX": "멕시코 태평양 표준시", "ICT": "인도차이나 시간", "IRDT": "이란 하계 표준시", "IRST": "이란 표준시", "IST": "인도 표준시", "JDT": "일본 하계 표준시", "JST": "일본 표준시", "LHDT": "로드 하우 하계 표준시", "LHST": "로드 하우 표준시", "MDT": "미 산지 하계 표준시", "MESZ": "중부유럽 하계 표준시", "MEZ": "중부유럽 표준시", "MST": "미 산악 표준시", "MVT": "몰디브 시간", "MYT": "말레이시아 시간", "NDT": "뉴펀들랜드 하계 표준시", "NPT": "네팔 시간", "NST": "뉴펀들랜드 표준시", "NZDT": "뉴질랜드 하계 표준시", "NZST": "뉴질랜드 표준시", "OESZ": "동유럽 하계 표준시", "OEZ": "동유럽 표준시", "PDT": "미 태평양 하계 표준시", "PKT": "파키스탄 하계 표준시", "PMDT": "세인트피에르 미클롱 하계 표준시", "PMST": "세인트피에르 미클롱 표준시", "PST": "미 태평양 표준시", "PYST": "파라과이 하계 표준시", "SAST": "남아프리카 시간", "SGT": "싱가포르 표준시", "SRT": "수리남 시간", "TLT": "동티모르 시간", "TMST": "투르크메니스탄 하계 표준시", "TMT": "투르크메니스탄 표준시", "UYST": "우루과이 하계 표준시", "UYT": "우루과이 표준시", "VET": "베네수엘라 시간", "WARST": "아르헨티나 서부 하계 표준시", "WART": "아르헨티나 서부 표준시", "WAST": "서아프리카 하계 표준시", "WAT": "서아프리카 표준시", "WESZ": "서유럽 하계 표준시", "WEZ": "서유럽 표준시", "WIB": "서부 인도네시아 시간", "WIT": "동부 인도네시아 시간", "WITA": "중부 인도네시아 시간", "∅∅∅": "페루 하계 표준시"},
		},
		...
		dateFullLayout:   "y년 M월 d일 EEEE",
		dateLongLayout:   "y년 M월 d일",
		dateMediumLayout: "y. M. d.",
		dateShortLayout:  "yy. M. d.",
		timeFullLayout:   "a h시 m분 s초 zzzz",
		timeLongLayout:   "a h시 m분 s초 z",
		timeMediumLayout: "a h:mm:ss",
		timeShortLayout:  "a h:mm",
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} 및 {1}", "{0}, {1}", "{0}, {1}", "{0} 및 {1}"}, {"{0} 또는 {1}", "{0}, {1}", "{0}, {1}", "{0} 또는 {1}"}}),
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
			"≤%[1]v",
...
func (ko *ko_KP) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ko, ko.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ko_KP'
func (ko *ko_KP) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ko, ko.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ko_KP'
func (ko *ko_KP) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ko, ko.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ko_KP'
func (ko *ko_KP) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ko, ko.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ko_KP'
func (ko *ko_KP) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ko, ko.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ko_KP'
func (ko *ko_KP) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ko, ko.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ko_KP'
func (ko *ko_KP) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ko, ko.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ko_KP'
func (ko *ko_KP) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ko, ko.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ko_KP'
func (ko *ko_KP) DateFullLayout() string {
	return ko.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ko_KP'
func (ko *ko_KP) DateLongLayout() string {
	return ko.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ko_KP'
func (ko *ko_KP) DateMediumLayout() string {
	return ko.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ko_KP'
func (ko *ko_KP) DateShortLayout() string {
	return ko.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ko_KP'
func (ko *ko_KP) TimeFullLayout() string {
	return ko.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ko_KP'
func (ko *ko_KP) TimeLongLayout() string {
	return ko.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ko_KP'
func (ko *ko_KP) TimeMediumLayout() string {
	return ko.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ko_KP'
func (ko *ko_KP) TimeShortLayout() string {
	return ko.timeShortLayout
}

func (ko *ko_KP) ListPatterns() *locales.ListPatterns {
	return ko.listPatterns
}

func (ko *ko_KP) GetDurationSpec() *locales.DurationSpec {
	return ko.DurationSpec
}

func (ko *ko_KP) GetMiscPatterns() *locales.MiscPatterns {
	return &ko.miscPatterns
}
