...
// DateFullLayout returns the full date layout for 'fr_DZ'
func (fr *fr_DZ) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_DZ'
func (fr *fr_DZ) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_DZ'
func (fr *fr_DZ) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_DZ'
func (fr *fr_DZ) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_DZ'
func (fr *fr_DZ) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_DZ'
func (fr *fr_DZ) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_DZ'
func (fr *fr_DZ) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_DZ'
func (fr *fr_DZ) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_DZ) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_DZ) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_DZ) GetMiscPatterns() *locales.MiscPatterns {
