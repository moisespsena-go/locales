...
// DateFullLayout returns the full date layout for 'se_NO'
func (se *se_NO) DateFullLayout() string {
	return se.dateFullLayout
}

// DateLongLayout returns the long date layout for 'se_NO'
func (se *se_NO) DateLongLayout() string {
	return se.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'se_NO'
func (se *se_NO) DateMediumLayout() string {
	return se.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'se_NO'
func (se *se_NO) DateShortLayout() string {
	return se.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'se_NO'
func (se *se_NO) TimeFullLayout() string {
	return se.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'se_NO'
func (se *se_NO) TimeLongLayout() string {
	return se.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'se_NO'
func (se *se_NO) TimeMediumLayout() string {
	return se.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'se_NO'
func (se *se_NO) TimeShortLayout() string {
	return se.timeShortLayout
}

func (se *se_NO) ListPatterns() *locales.ListPatterns {
	return se.listPatterns
}

func (se *se_NO) GetDurationSpec() *locales.DurationSpec {
	return se.DurationSpec
}

func (se *se_NO) GetMiscPatterns() *locales.MiscPatterns {
