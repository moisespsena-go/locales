...
// DateFullLayout returns the full date layout for 'en_BE'
func (en *en_BE) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_BE'
func (en *en_BE) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_BE'
func (en *en_BE) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_BE'
func (en *en_BE) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_BE'
func (en *en_BE) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_BE'
func (en *en_BE) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_BE'
func (en *en_BE) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_BE'
func (en *en_BE) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_BE) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_BE) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_BE) GetMiscPatterns() *locales.MiscPatterns {
