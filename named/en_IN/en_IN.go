...
func New() locales.Translator {
	return &en_IN{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						...
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0L"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0L"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00L"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00L"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0Cr"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0Cr"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00Cr"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00Cr"),
						}},
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000Cr"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000Cr"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0TCr"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0TCr"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00TCr"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00TCr"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0LCr"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0LCr"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00LCr"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00LCr"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000LCr"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000LCr"),
						}},
					},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"", "", "", "{0}, and {1}"}, []string(nil)}),
...
// DateFullLayout returns the full date layout for 'en_IN'
func (en *en_IN) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_IN'
func (en *en_IN) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_IN'
func (en *en_IN) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_IN'
func (en *en_IN) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_IN'
func (en *en_IN) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_IN'
func (en *en_IN) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_IN'
func (en *en_IN) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_IN'
func (en *en_IN) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_IN) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_IN) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_IN) GetMiscPatterns() *locales.MiscPatterns {
