...
// DateFullLayout returns the full date layout for 'ff_Latn'
func (ff *ff_Latn) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff_Latn'
func (ff *ff_Latn) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff_Latn'
func (ff *ff_Latn) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff_Latn'
func (ff *ff_Latn) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff_Latn'
func (ff *ff_Latn) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff_Latn'
func (ff *ff_Latn) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff_Latn'
func (ff *ff_Latn) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff_Latn'
func (ff *ff_Latn) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff_Latn) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff_Latn) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff_Latn) GetMiscPatterns() *locales.MiscPatterns {
