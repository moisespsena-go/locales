...
func New() locales.Translator {
	return &am{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0 ሺ"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 ሺ"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00 ሺ"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 ሺ"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000 ሺ"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000 ሺ"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0 ሚ"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 ሚ"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00 ሚ"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 ሚ"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000 ሚ"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000 ሚ"),
						}},
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0 ቢ"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 ቢ"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00 ቢ"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 ቢ"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000 ቢ"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000 ቢ"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0 ት"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 ት"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00 ት"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 ት"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000 ት"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000 ት"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ጃንዩ", "ፌብሩ", "ማርች", "ኤፕሪ", "ሜይ", "ጁን", "ጁላይ", "ኦገስ", "ሴፕቴ", "ኦክቶ", "ኖቬም", "ዲሴም"},
			MonthsNarrowValue:        []string{"", "ጃ", "ፌ", "ማ", "ኤ", "ሜ", "ጁ", "ጁ", "ኦ", "ሴ", "ኦ", "ኖ", "ዲ"},
			MonthsWideValue:          []string{"", "ጃንዩወሪ", "ፌብሩወሪ", "ማርች", "ኤፕሪል", "ሜይ", "ጁን", "ጁላይ", "ኦገስት", "ሴፕቴምበር", "ኦክቶበር", "ኖቬምበር", "ዲሴምበር"},
			WeekdaysAbbreviatedValue: []string{"እሑድ", "ሰኞ", "ማክሰ", "ረቡዕ", "ሐሙስ", "ዓርብ", "ቅዳሜ"},
			WeekdaysNarrowValue:      []string{"እ", "ሰ", "ማ", "ረ", "ሐ", "ዓ", "ቅ"},
			WeekdaysShortValue:       []string{"እ", "ሰ", "ማ", "ረ", "ሐ", "ዓ", "ቅ"},
			WeekdaysWideValue:        []string{"እሑድ", "ሰኞ", "ማክሰኞ", "ረቡዕ", "ሐሙስ", "ዓርብ", "ቅዳሜ"},
			PeriodsAbbreviatedValue:  []string{"ጥዋት", "ከሰዓት"},
			PeriodsNarrowValue:       []string{"ጠ", "ከ"},
			PeriodsWideValue:         []string{"ጥዋት", "ከሰዓት"},
			ErasAbbreviatedValue:     []string{"", ""},
			ErasNarrowValue:          []string{"ዓ/ዓ", "ዓ/ም"},
			ErasWideValue:            []string{"ዓመተ ዓለም", "ዓመተ ምሕረት"},
			TimezonesValue:           map[string]string{"": "የፓራጓይ መደበኛ ሰዓት", "ACDT": "የአውስትራሊያ መካከለኛ የቀን ሰዓት አቆጣጠር", "ACST": "የአውስትራሊያ መካከለኛ መደበኛ የሰዓት አቆጣጠር", "ACT": "ACT", "ACWDT": "የአውስትራሊያ መካከለኛው ምስራቅ የቀን ሰዓት አቆጣጠር", "ACWST": "የአውስትራሊያ መካከለኛ ምስራቃዊ መደበኛ ሰዓት አቆጣጠር", "ADT": "የአትላንቲክ የቀን ሰዓት አቆጣጠር", "AEDT": "የአውስትራሊያ ምዕራባዊ የቀን ሰዓት አቆጣጠር", "AEST": "የአውስትራሊያ ምዕራባዊ መደበኛ የሰዓት አቆጣጠር", "AFT": "የአፍጋኒስታን ሰዓት", "AKDT": "የአላስካ የቀን ሰዓት አቆጣጠር", "AKST": "የአላስካ መደበኛ የሰዓት አቆጣጠር", "AMST": "የአማዞን የቀን ሰዓት አቆጣጠር", "AMT": "የአማዞን መደበኛ ሰዓት አቆጣጠር", "ARST": "የአርጀንቲና የበጋ ሰዓት አቆጣጠር", "ART": "የአርጀንቲና መደበኛ ሰዓት አቆጣጠር", "AST": "የአትላንቲክ መደበኛ የሰዓት አቆጣጠር", "AWDT": "የአውስትራሊያ ምስራቃዊ የቀን ሰዓት አቆጣጠር", "AWST": "የአውስትራሊያ ምስራቃዊ መደበኛ ሰዓት አቆጣጠር", "BNT": "የብሩኔይ ዳሩሳላም ሰዓት", "BOT": "የቦሊቪያ ሰዓት", "BRST": "የብራዚላ የበጋ ሰዓት አቆጣጠር", "BRT": "የብራሲሊያ መደበኛ ሰዓት አቆጣጠር", "BST": "የባንግላዴሽ ክረምት ሰዓት", "BTT": "የቡታን ሰዓት", "CAT": "የመካከለኛው አፍሪካ ሰዓት", "CCT": "የኮኮስ ደሴቶች ሰዓት", "CDT": "የመካከለኛ የቀን ሰዓት አቆጣጠር", "CDT (Kuba)": "የኩባ የቀን ብርሃን ሰዓት", "CHADT": "የቻታም የቀን ብርሃን ሰዓት", "CHAST": "የቻታም መደበኛ ሰዓት", "CLST": "የቺሊ ክረምት ሰዓት", "CLT": "የቺሊ መደበኛ ሰዓት", "COST": "የኮሎምቢያ ክረምት ሰዓት", "COT": "የኮሎምቢያ መደበኛ ሰዓት", "CST": "የሰሜን አሜሪካ የመካከለኛ መደበኛ ሰዓት አቆጣጠር", "CST (Kuba)": "የኩባ መደበኛ ሰዓት", "CXT": "የገና ደሴት ሰዓት", "ChST": "የቻሞሮ መደበኛ ሰዓት", "EASST": "የኢስተር ደሴት ክረምት ሰዓት", "EAST": "የኢስተር ደሴት መደበኛ ሰዓት", "EAT": "የምስራቅ አፍሪካ ሰዓት", "ECT": "የኢኳዶር ሰዓት", "EDT": "ምስራቃዊ የቀን ሰዓት አቆጣጠር", "EGDT": "የምስራቅ ግሪንላንድ ክረምት ሰዓት", "EGST": "የምስራቅ ግሪንላንድ መደበኛ ሰዓት", "EST": "ምስራቃዊ መደበኛ ሰዓት አቆጣጠር", "FKST": "የፋልክላንድ ደሴቶች ክረምት ሰዓት", "GALT": "የጋላፓጎስ ሰዓት", "GFT": "የፈረንሳይ ጉያና ሰዓት", "GMT": "ግሪንዊች ማዕከላዊ ሰዓት", "GST": "የባህረሰላጤ መደበኛ ሰዓት", "GYT": "የጉያና ሰዓት", "HADT": "የሃዋይ አሌኡት የቀን ሰዓት አቆጣጠር", "HAST": "የሃዋይ አሌኡት መደበኛ ሰዓት አቆጣጠር", "HENOMX": "ሰሜናዊ ምእራብ የሜክሲኮ የቀን ሰዓት አቆጣጠር", "HEOG": "የምዕራብ ግሪንላንድ ክረምት ሰዓት", "HEPMX": "የሜክሲኮ ፓሲፊክ የቀን ሰዓት አቆጣጠር", "HKST": "የሆንግ ኮንግ ክረምት ሰዓት", "HKT": "የሆንግ ኮንግ መደበኛ ሰዓት", "HNNOMX": "ሰሜናዊ ምእራብ የሜክሲኮ መደበኛ ሰዓት አቆጣጠር", "HNOG": "የምዕራብ ግሪንላንድ መደበኛ ሰዓት", "HNPMX": "የሜክሲኮ ፓሲፊክ መደበኛ ሰዓት አቆጣጠር", "ICT": "የኢንዶቻይና ሰዓት", "IRDT": "የኢራን የቀን ብርሃን ሰዓት", "IRST": "የኢራን መደበኛ ሰዓት", "IST": "የህንድ መደበኛ ሰዓት", "JDT": "የጃፓን የቀን ብርሃን ሰዓት", "JST": "የጃፓን መደበኛ ሰዓት", "LHDT": "የሎርድ ሆዌ የቀን ሰዓት አቆጣጠር", "LHST": "የሎርድ ሆዌ መደበኛ የሰዓት አቆጣጠር", "MDT": "የተራራ የቀንሰዓት አቆጣጠር", "MESZ": "የመካከለኛው አውሮፓ ክረምት ሰዓት", "MEZ": "የመካከለኛው አውሮፓ መደበኛ ሰዓት", "MST": "የተራራ መደበኛ የሰዓት አቆጣጠር", "MVT": "የማልዲቭስ ሰዓት", "MYT": "የማሌይዢያ ሰዓት", "NDT": "የኒውፋውንድላንድ የቀን የሰዓት አቆጣጠር", "NPT": "የኔፓል ሰዓት", "NST": "የኒውፋውንድላንድ መደበኛ የሰዓት አቆጣጠር", "NZDT": "የኒው ዚላንድ የቀን ብርሃን ሰዓት", "NZST": "የኒው ዚላንድ መደበኛ ሰዓት", "OESZ": "የምስራቃዊ አውሮፓ ክረምት ሰዓት", "OEZ": "የምስራቃዊ አውሮፓ መደበኛ ሰዓት", "PDT": "የፓስፊክ የቀን ሰዓት አቆጣጠር", "PKT": "የፓኪስታን ክረምት ሰዓት", "PMDT": "ቅዱስ የፒዬር እና ሚኴሎን የቀን ብርሃን ሰዓት", "PMST": "ቅዱስ የፒዬር እና ሚኴሎን መደበኛ ሰዓት", "PST": "የፓስፊክ መደበኛ ሰዓት አቆጣጠር", "PYST": "የፓራጓይ ክረምት ሰዓት", "SAST": "የደቡብ አፍሪካ መደበኛ ሰዓት", "SGT": "የሲንጋፒር መደበኛ ሰዓት", "SRT": "የሱሪናም ሰዓት", "TLT": "የምስራቅ ቲሞር ሰዓት", "TMST": "የቱርክመኒስታን ክረምት ሰዓት", "TMT": "የቱርክመኒስታን መደበኛ ሰዓት", "UYST": "የኡራጓይ ክረምት ሰዓት", "UYT": "የኡራጓይ መደበኛ ሰዓት", "VET": "የቬኔዝዌላ ሰዓት", "WARST": "የአርጀንቲና ምስራቃዊ በጋ ሰዓት አቆጣጠር", "WART": "የምዕራባዊ አርጀንቲና መደበኛ ሰዓት አቆጣጠር", "WAST": "የምዕራብ አፍሪካ ክረምት ሰዓት", "WAT": "የምዕራብ አፍሪካ መደበኛ ሰዓት", "WESZ": "የምዕራባዊ አውሮፓ ክረምት ሰዓት", "WEZ": "የምዕራባዊ አውሮፓ መደበኛ ሰዓት", "WIB": "የምዕራባዊ ኢንዶኔዢያ ሰዓት", "WIT": "የምስራቃዊ ኢንዶኔዢያ ሰዓት", "WITA": "የመካከለኛው ኢንዶኔዢያ ሰዓት", "∅∅∅": "የፔሩ ክረምት ሰዓት"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} እና {1}", "{0}፣ {1}", "{0}፣ {1}", "{0}, እና {1}"}, {"{0} ወይም {1}\ufeff", "{0}፣ {1}", "{0}፣ {1}", "{0}፣ ወይም {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vም.ዓ", "%vም.ዓ", ""},
				Long:   &locales.CounterFormat{"ምዕተ ዓመት", "%v ምዕተ ዓመት", "%v ምዕተ ዓመት", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ዓሠርተ-ዓመት", "%v ዓሠ.ዓ", "%v ዓሠ.ዓ", ""},
				Long:   &locales.CounterFormat{"ዓሠርተ-ዓመት", "%v ዓሠርተ-ዓመት", "%v ዓሠርተ-ዓመታት", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ዓመታት", "%v ዓመት", "%v ዓ", ""},
				Long:   &locales.CounterFormat{"ዓመታት", "%v ዓመት", "%v ዓመታት", "%v/ዓ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ወራት", "%v ወር", "%v ወር", ""},
				Long:   &locales.CounterFormat{"ወራት", "%v ወር", "%v ወራት", "%v/ወ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ሳምንታት", "%v ሳምንት", "%v ሳምንት", ""},
				Long:   &locales.CounterFormat{"ሳምንታት", "%v ሳምንት", "%v ሳምንታት", "%v/ሳ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ቀናት", "%v ቀ", "%v ቀ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ሰዓቶች", "%v ሰ", "%v ሰ", ""},
				Long:   &locales.CounterFormat{"ሰዓቶች", "%v ሰዓት", "%v ሰዓቶች", "%v/ሰ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ደቂቃዎች", "%v ደ", "%v ደ", ""},
				Long:   &locales.CounterFormat{"ደቂቃዎች", "%v ደቂቃ", "%v ደቂቃዎች", "%v/ደ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ሰከንድ", "%v ሰ", "%v ሰ", ""},
				Long:   &locales.CounterFormat{"ሰከንዶች", "%v ሰከንድ", "%v ሰከንዶች", "%v/ሰከ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ሚሊሰከንድ", "%v ሚሴ", "%v ሚሴ", ""},
				Long:   &locales.CounterFormat{"ሚሊሰከንድ", "%v ሚሊሰከንድ", "%v ሚሊሰከንድ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ማይክሮሰከንድ", "%v ማሰ", "%v ማሰ", ""},
				Long:   &locales.CounterFormat{"ማይክሮሰከንድ", "%v ማይክሮሰከንድ", "%v ማይክሮሰከንድ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ናኖሰከንድ", "%v ናኖሰከንድ", "%v ናኖሰከንድ", ""},
				Long:   &locales.CounterFormat{"ናኖሰከንድ", "%v ናኖሰከንድ", "%v ናኖሰከንድ", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (am *am) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(am, am.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'am'
func (am *am) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(am, am.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'am'
func (am *am) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(am, am.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'am'
func (am *am) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(am, am.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'am'
func (am *am) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(am, am.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'am'
func (am *am) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(am, am.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'am'
func (am *am) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(am, am.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'am'
func (am *am) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(am, am.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'am'
func (am *am) DateFullLayout() string {
	return am.dateFullLayout
}

// DateLongLayout returns the long date layout for 'am'
func (am *am) DateLongLayout() string {
	return am.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'am'
func (am *am) DateMediumLayout() string {
	return am.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'am'
func (am *am) DateShortLayout() string {
	return am.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'am'
func (am *am) TimeFullLayout() string {
	return am.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'am'
func (am *am) TimeLongLayout() string {
	return am.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'am'
func (am *am) TimeMediumLayout() string {
	return am.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'am'
func (am *am) TimeShortLayout() string {
	return am.timeShortLayout
}

func (am *am) ListPatterns() *locales.ListPatterns {
	return am.listPatterns
}

func (am *am) GetDurationSpec() *locales.DurationSpec {
	return am.DurationSpec
}

func (am *am) GetMiscPatterns() *locales.MiscPatterns {
	return &am.miscPatterns
}
