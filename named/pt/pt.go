...
func New() locales.Translator {
	return &pt{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jan.", "fev.", "mar.", "abr.", "mai.", "jun.", "jul.", "ago.", "set.", "out.", "nov.", "dez."},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "janeiro", "fevereiro", "março", "abril", "maio", "junho", "julho", "agosto", "setembro", "outubro", "novembro", "dezembro"},
			WeekdaysAbbreviatedValue: []string{"dom.", "seg.", "ter.", "qua.", "qui.", "sex.", "sáb."},
			WeekdaysNarrowValue:      []string{"D", "S", "T", "Q", "Q", "S", "S"},
			WeekdaysWideValue:        []string{"domingo", "segunda-feira", "terça-feira", "quarta-feira", "quinta-feira", "sexta-feira", "sábado"},
			...
			ErasWideValue:            []string{"antes de Cristo", "depois de Cristo"},
			TimezonesValue:           map[string]string{"": "Horário Padrão das Ilhas Malvinas", "ACDT": "Horário de Verão da Austrália Central", "ACST": "Horário Padrão da Austrália Central", "ACT": "Horário Padrão do Acre", "ACWDT": "Horário de Verão da Austrália Centro-Ocidental", "ACWST": "Horário Padrão da Austrália Centro-Ocidental", "ADT": "Horário de Verão do Atlântico", "AEDT": "Horário de Verão da Austrália Oriental", "AEST": "Horário Padrão da Austrália Oriental", "AFT": "Horário do Afeganistão", "AKDT": "Horário de Verão do Alasca", "AKST": "Horário Padrão do Alasca", "AMST": "Horário de Verão do Amazonas", "AMT": "Horário Padrão do Amazonas", "ARST": "Horário de Verão da Argentina", "ART": "Horário Padrão da Argentina", "AST": "Horário Padrão do Atlântico", "AWDT": "Horário de Verão da Austrália Ocidental", "AWST": "Horário Padrão da Austrália Ocidental", "BNT": "Horário de Brunei Darussalam", "BOT": "Horário da Bolívia", "BRST": "Horário de Verão de Brasília", "BRT": "Horário Padrão de Brasília", "BST": "Horário de Verão de Bangladesh", "BTT": "Horário do Butão", "CAT": "Horário da África Central", "CCT": "Horário das Ilhas Coco", "CDT": "Horário de Verão Central", "CDT (Kuba)": "Horário de Verão de Cuba", "CHADT": "Horário de Verão de Chatham", "CHAST": "Horário Padrão de Chatham", "CLST": "Horário de Verão do Chile", "CLT": "Horário Padrão do Chile", "COST": "Horário de Verão da Colômbia", "COT": "Horário Padrão da Colômbia", "CST": "Horário Padrão Central", "CST (Kuba)": "Horário Padrão de Cuba", "CXT": "Horário da Ilha Christmas", "ChST": "Horário de Chamorro", "EASST": "Horário de Verão da Ilha de Páscoa", "EAST": "Horário Padrão da Ilha de Páscoa", "EAT": "Horário da África Oriental", "ECT": "Horário do Equador", "EDT": "Horário de Verão do Leste", "EGDT": "Horário de Verão da Groelândia Oriental", "EGST": "Horário Padrão da Groelândia Oriental", "EST": "Horário Padrão do Leste", "FKST": "Horário de Verão das Ilhas Malvinas", "GALT": "Horário de Galápagos", "GFT": "Horário da Guiana Francesa", "GMT": "Horário do Meridiano de Greenwich", "GST": "Horário do Golfo", "GYT": "Horário da Guiana", "HADT": "Horário de Verão do Havaí e Ilhas Aleutas", "HAST": "Horário Padrão do Havaí e Ilhas Aleutas", "HENOMX": "Horário de Verão do Noroeste do México", "HEOG": "Horário de Verão da Groenlândia Ocidental", "HEPMX": "Horário de Verão do Pacífico Mexicano", "HKST": "Horário de Verão de Hong Kong", "HKT": "Horário Padrão de Hong Kong", "HNNOMX": "Horário Padrão do Noroeste do México", "HNOG": "Horário Padrão da Groenlândia Ocidental", "HNPMX": "Horário Padrão do Pacífico Mexicano", "ICT": "Horário da Indochina", "IRDT": "Horário de Verão do Irã", "IRST": "Horário Padrão do Irã", "IST": "Horário Padrão da Índia", "JDT": "Horário de Verão do Japão", "JST": "Horário Padrão do Japão", "LHDT": "Horário de Verão de Lord Howe", "LHST": "Horário Padrão de Lord Howe", "MDT": "Horário de Verão de Macau", "MESZ": "Horário de Verão da Europa Central", "MEZ": "Horário Padrão da Europa Central", "MST": "Horário Padrão de Macau", "MVT": "Horário das Ilhas Maldivas", "MYT": "Horário da Malásia", "NDT": "Horário de Verão da Terra Nova", "NPT": "Horário do Nepal", "NST": "Horário Padrão da Terra Nova", "NZDT": "Horário de Verão da Nova Zelândia", "NZST": "Horário Padrão da Nova Zelândia", "OESZ": "Horário de Verão da Europa Oriental", "OEZ": "Horário Padrão da Europa Oriental", "PDT": "Horário de Verão do Pacífico", "PKT": "Horário de Verão do Paquistão", "PMDT": "Horário Verão de São Pedro e Miquelão", "PMST": "Horário Padrão de São Pedro e Miquelão", "PST": "Horário Padrão do Pacífico", "PYST": "Horário de Verão do Paraguai", "SAST": "Horário da África do Sul", "SGT": "Horário Padrão de Singapura", "SRT": "Horário do Suriname", "TLT": "Horário do Timor-Leste", "TMST": "Horário de Verão do Turcomenistão", "TMT": "Horário Padrão do Turcomenistão", "UYST": "Horário de Verão do Uruguai", "UYT": "Horário Padrão do Uruguai", "VET": "Horário da Venezuela", "WARST": "Horário de Verão da Argentina Ocidental", "WART": "Horário Padrão da Argentina Ocidental", "WAST": "Horário de Verão da África Ocidental", "WAT": "Horário Padrão da África Ocidental", "WESZ": "Horário de Verão da Europa Ocidental", "WEZ": "Horário Padrão da Europa Ocidental", "WIB": "Horário da Indonésia Ocidental", "WIT": "Horário da Indonésia Oriental", "WITA": "Horário da Indonésia Central", "∅∅∅": "Horário de Verão do Peru"},
		},
		...
		dateMediumLayout: "d 'de' MMM 'de' y",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} e {1}", "{0}, {1}", "{0}, {1}", "{0} e {1}"}, {"{0} ou {1}", "{0}, {1}", "{0}, {1}", "{0} ou {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"séc.", "%v séc.", "%v sécs.", ""},
				Long:   &locales.CounterFormat{"séculos", "%v século", "%v séculos", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"déc.", "%v déc.", "%v déc.", ""},
				Long:   &locales.CounterFormat{"décadas", "%v década", "%v décadas", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ano", "%v ano", "%v anos", "%v/ano"},
				Long:   &locales.CounterFormat{"anos", "%v ano", "%v anos", "%v por ano"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mês", "%v mês", "%v meses", "%v/mês"},
				Long:   &locales.CounterFormat{"meses", "%v mês", "%v meses", "%v por mês"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dia", "%v dia", "%v dias", "%v/dia"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"milissegundos", "%v milissegundo", "%v milissegundos", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"microssegundos", "%v microssegundo", "%v microssegundos", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"nanossegundos", "%v nanossegundo", "%v nanossegundos", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"+%[1]v",
...
func (pt *pt) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(pt, pt.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'pt'
func (pt *pt) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(pt, pt.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'pt'
func (pt *pt) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(pt, pt.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'pt'
func (pt *pt) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(pt, pt.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'pt'
func (pt *pt) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(pt, pt.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'pt'
func (pt *pt) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(pt, pt.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'pt'
func (pt *pt) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(pt, pt.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'pt'
func (pt *pt) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(pt, pt.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'pt'
func (pt *pt) DateFullLayout() string {
	return pt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pt'
func (pt *pt) DateLongLayout() string {
	return pt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pt'
func (pt *pt) DateMediumLayout() string {
	return pt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pt'
func (pt *pt) DateShortLayout() string {
	return pt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pt'
func (pt *pt) TimeFullLayout() string {
	return pt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pt'
func (pt *pt) TimeLongLayout() string {
	return pt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pt'
func (pt *pt) TimeMediumLayout() string {
	return pt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pt'
func (pt *pt) TimeShortLayout() string {
	return pt.timeShortLayout
}

func (pt *pt) ListPatterns() *locales.ListPatterns {
	return pt.listPatterns
}

func (pt *pt) GetDurationSpec() *locales.DurationSpec {
	return pt.DurationSpec
}

func (pt *pt) GetMiscPatterns() *locales.MiscPatterns {
	return &pt.miscPatterns
}
