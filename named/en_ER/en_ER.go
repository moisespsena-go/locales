...
// DateFullLayout returns the full date layout for 'en_ER'
func (en *en_ER) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_ER'
func (en *en_ER) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_ER'
func (en *en_ER) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_ER'
func (en *en_ER) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_ER'
func (en *en_ER) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_ER'
func (en *en_ER) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_ER'
func (en *en_ER) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_ER'
func (en *en_ER) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_ER) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_ER) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_ER) GetMiscPatterns() *locales.MiscPatterns {
