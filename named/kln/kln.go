...
// DateFullLayout returns the full date layout for 'kln'
func (kln *kln) DateFullLayout() string {
	return kln.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kln'
func (kln *kln) DateLongLayout() string {
	return kln.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kln'
func (kln *kln) DateMediumLayout() string {
	return kln.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kln'
func (kln *kln) DateShortLayout() string {
	return kln.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kln'
func (kln *kln) TimeFullLayout() string {
	return kln.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kln'
func (kln *kln) TimeLongLayout() string {
	return kln.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kln'
func (kln *kln) TimeMediumLayout() string {
	return kln.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kln'
func (kln *kln) TimeShortLayout() string {
	return kln.timeShortLayout
}

func (kln *kln) ListPatterns() *locales.ListPatterns {
	return kln.listPatterns
}

func (kln *kln) GetDurationSpec() *locales.DurationSpec {
	return kln.DurationSpec
}

func (kln *kln) GetMiscPatterns() *locales.MiscPatterns {
