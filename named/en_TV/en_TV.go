...
// DateFullLayout returns the full date layout for 'en_TV'
func (en *en_TV) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_TV'
func (en *en_TV) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_TV'
func (en *en_TV) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_TV'
func (en *en_TV) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_TV'
func (en *en_TV) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_TV'
func (en *en_TV) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_TV'
func (en *en_TV) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_TV'
func (en *en_TV) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_TV) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_TV) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_TV) GetMiscPatterns() *locales.MiscPatterns {
