...
// DateFullLayout returns the full date layout for 'nl_NL'
func (nl *nl_NL) DateFullLayout() string {
	return nl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nl_NL'
func (nl *nl_NL) DateLongLayout() string {
	return nl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nl_NL'
func (nl *nl_NL) DateMediumLayout() string {
	return nl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nl_NL'
func (nl *nl_NL) DateShortLayout() string {
	return nl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nl_NL'
func (nl *nl_NL) TimeFullLayout() string {
	return nl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nl_NL'
func (nl *nl_NL) TimeLongLayout() string {
	return nl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nl_NL'
func (nl *nl_NL) TimeMediumLayout() string {
	return nl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nl_NL'
func (nl *nl_NL) TimeShortLayout() string {
	return nl.timeShortLayout
}

func (nl *nl_NL) ListPatterns() *locales.ListPatterns {
	return nl.listPatterns
}

func (nl *nl_NL) GetDurationSpec() *locales.DurationSpec {
	return nl.DurationSpec
}

func (nl *nl_NL) GetMiscPatterns() *locales.MiscPatterns {
