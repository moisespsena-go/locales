...
// DateFullLayout returns the full date layout for 'en_VI'
func (en *en_VI) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_VI'
func (en *en_VI) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_VI'
func (en *en_VI) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_VI'
func (en *en_VI) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_VI'
func (en *en_VI) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_VI'
func (en *en_VI) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_VI'
func (en *en_VI) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_VI'
func (en *en_VI) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_VI) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_VI) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_VI) GetMiscPatterns() *locales.MiscPatterns {
