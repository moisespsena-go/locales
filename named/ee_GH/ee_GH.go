...
// DateFullLayout returns the full date layout for 'ee_GH'
func (ee *ee_GH) DateFullLayout() string {
	return ee.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ee_GH'
func (ee *ee_GH) DateLongLayout() string {
	return ee.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ee_GH'
func (ee *ee_GH) DateMediumLayout() string {
	return ee.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ee_GH'
func (ee *ee_GH) DateShortLayout() string {
	return ee.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ee_GH'
func (ee *ee_GH) TimeFullLayout() string {
	return ee.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ee_GH'
func (ee *ee_GH) TimeLongLayout() string {
	return ee.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ee_GH'
func (ee *ee_GH) TimeMediumLayout() string {
	return ee.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ee_GH'
func (ee *ee_GH) TimeShortLayout() string {
	return ee.timeShortLayout
}

func (ee *ee_GH) ListPatterns() *locales.ListPatterns {
	return ee.listPatterns
}

func (ee *ee_GH) GetDurationSpec() *locales.DurationSpec {
	return ee.DurationSpec
}

func (ee *ee_GH) GetMiscPatterns() *locales.MiscPatterns {
