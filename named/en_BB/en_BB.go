...
// DateFullLayout returns the full date layout for 'en_BB'
func (en *en_BB) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_BB'
func (en *en_BB) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_BB'
func (en *en_BB) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_BB'
func (en *en_BB) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_BB'
func (en *en_BB) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_BB'
func (en *en_BB) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_BB'
func (en *en_BB) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_BB'
func (en *en_BB) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_BB) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_BB) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_BB) GetMiscPatterns() *locales.MiscPatterns {
