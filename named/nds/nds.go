...
func New() locales.Translator {
	return &nds{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan.", "Feb.", "März", "Apr.", "Mai", "Juni", "Juli", "Aug.", "Sep.", "Okt.", "Nov.", "Dez."},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Januaar", "Februaar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktover", "November", "Dezember"},
			WeekdaysAbbreviatedValue: []string{"Sü.", "Ma.", "Di.", "Mi.", "Du.", "Fr.", "Sa."},
			WeekdaysNarrowValue:      []string{"S", "M", "D", "M", "D", "F", "S"},
			WeekdaysWideValue:        []string{"Sünndag", "Maandag", "Dingsdag", "Middeweken", "Dunnersdag", "Freedag", "Sünnavend"},
			...
			ErasWideValue:            []string{"vör Christus", "na Christus"},
			TimezonesValue:           map[string]string{"": "", "ACDT": "Zentraalaustraalsch Summertiet", "ACST": "Zentraalaustraalsch Standardtiet", "ACT": "ACT", "ACWDT": "Westzentraalaustraalsch Summertiet", "ACWST": "Westzentraalaustraalsch Standardtiet", "ADT": "Noordamerikaansch Atlantik-Summertiet", "AEDT": "Oostaustraalsch Summertiet", "AEST": "Oostaustraalsch Standardtiet", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "Noordamerikaansch Atlantik-Standardtiet", "AWDT": "Westaustraalsch Summertiet", "AWST": "Westaustraalsch Standardtiet", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "Zentraalafrikaansch Tiet", "CCT": "CCT", "CDT": "Noordamerikaansch zentraal Summertiet", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "Noordamerikaansch zentraal Standardtiet", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "Oostafrikaansch Tiet", "ECT": "ECT", "EDT": "Noordamerikaansch oosten Summertiet", "EGDT": "EGDT", "EGST": "EGST", "EST": "Noordamerikaansch oosten Standardtiet", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "Gröönwisch-Welttiet", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "Söödoostasiaatsch Tiet", "IRDT": "IRDT", "IRST": "IRST", "IST": "Indien-Tiet", "JDT": "Japaansch Summertiet", "JST": "Japaansch Standardtiet", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "Zentraaleuropääsch Summertiet", "MEZ": "Zentraaleuropääsch Standardtiet", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "Oosteuropääsch Summertiet", "OEZ": "Oosteuropääsch Standardtiet", "PDT": "Noordamerikaansch Pazifik-Summertiet", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "Noordamerikaansch Pazifik-Standardtiet", "PYST": "PYST", "SAST": "Söödafrikaansch Tiet", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "Westafrikaansch Summertiet", "WAT": "Westafrikaansch Standardtiet", "WESZ": "Westeuropääsch Summertiet", "WEZ": "Westeuropääsch Standardtiet", "WIB": "Westindoneesch Tiet", "WIT": "Oostindoneesch Tiet", "WITA": "Indoneesch Zentraaltiet", "∅∅∅": "∅∅∅"},
		},
		...
		dateFullLayout:   "EEEE, 'de' d. MMMM y",
		dateLongLayout:   "d. MMMM y",
		dateMediumLayout: "d. MMM y",
		dateShortLayout:  "d.MM.yy",
		timeFullLayout:   "'Klock' H.mm:ss (zzzz)",
		timeLongLayout:   "'Klock' H.mm:ss (z)",
		timeMediumLayout: "'Klock' H.mm:ss",
		timeShortLayout:  "'Kl'. H.mm",
...
func (nds *nds) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(nds, nds.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'nds'
func (nds *nds) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(nds, nds.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'nds'
func (nds *nds) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(nds, nds.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'nds'
func (nds *nds) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(nds, nds.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'nds'
func (nds *nds) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(nds, nds.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'nds'
func (nds *nds) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(nds, nds.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'nds'
func (nds *nds) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(nds, nds.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'nds'
func (nds *nds) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(nds, nds.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'nds'
func (nds *nds) DateFullLayout() string {
	return nds.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nds'
func (nds *nds) DateLongLayout() string {
	return nds.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nds'
func (nds *nds) DateMediumLayout() string {
	return nds.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nds'
func (nds *nds) DateShortLayout() string {
	return nds.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nds'
func (nds *nds) TimeFullLayout() string {
	return nds.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nds'
func (nds *nds) TimeLongLayout() string {
	return nds.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nds'
func (nds *nds) TimeMediumLayout() string {
	return nds.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nds'
func (nds *nds) TimeShortLayout() string {
	return nds.timeShortLayout
}

func (nds *nds) ListPatterns() *locales.ListPatterns {
	return nds.listPatterns
}

func (nds *nds) GetDurationSpec() *locales.DurationSpec {
	return nds.DurationSpec
}

func (nds *nds) GetMiscPatterns() *locales.MiscPatterns {
	return &nds.miscPatterns
}
