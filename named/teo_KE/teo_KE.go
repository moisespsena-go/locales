...
func New() locales.Translator {
	return &teo_KE{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Rar", "Muk", "Kwa", "Dun", "Mar", "Mod", "Jol", "Ped", "Sok", "Tib", "Lab", "Poo"},
			MonthsNarrowValue:        []string{"", "R", "M", "K", "D", "M", "M", "J", "P", "S", "T", "L", "P"},
			MonthsWideValue:          []string{"", "Orara", "Omuk", "Okwamg’", "Odung’el", "Omaruk", "Omodok’king’ol", "Ojola", "Opedel", "Osokosokoma", "Otibar", "Olabor", "Opoo"},
			WeekdaysAbbreviatedValue: []string{"Jum", "Bar", "Aar", "Uni", "Ung", "Kan", "Sab"},
			WeekdaysNarrowValue:      []string{"J", "B", "A", "U", "U", "K", "S"},
			WeekdaysWideValue:        []string{"Nakaejuma", "Nakaebarasa", "Nakaare", "Nakauni", "Nakaung’on", "Nakakany", "Nakasabiti"},
			PeriodsAbbreviatedValue:  []string{"Taparachu", "Ebongi"},
			PeriodsWideValue:         []string{"Taparachu", "Ebongi"},
...
func (teo *teo_KE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(teo, teo.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'teo_KE'
func (teo *teo_KE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(teo, teo.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'teo_KE'
func (teo *teo_KE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(teo, teo.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'teo_KE'
func (teo *teo_KE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(teo, teo.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'teo_KE'
func (teo *teo_KE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(teo, teo.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'teo_KE'
func (teo *teo_KE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(teo, teo.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'teo_KE'
func (teo *teo_KE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(teo, teo.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'teo_KE'
func (teo *teo_KE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(teo, teo.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'teo_KE'
func (teo *teo_KE) DateFullLayout() string {
	return teo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'teo_KE'
func (teo *teo_KE) DateLongLayout() string {
	return teo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'teo_KE'
func (teo *teo_KE) DateMediumLayout() string {
	return teo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'teo_KE'
func (teo *teo_KE) DateShortLayout() string {
	return teo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'teo_KE'
func (teo *teo_KE) TimeFullLayout() string {
	return teo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'teo_KE'
func (teo *teo_KE) TimeLongLayout() string {
	return teo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'teo_KE'
func (teo *teo_KE) TimeMediumLayout() string {
	return teo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'teo_KE'
func (teo *teo_KE) TimeShortLayout() string {
	return teo.timeShortLayout
}

func (teo *teo_KE) ListPatterns() *locales.ListPatterns {
	return teo.listPatterns
}

func (teo *teo_KE) GetDurationSpec() *locales.DurationSpec {
	return teo.DurationSpec
}

func (teo *teo_KE) GetMiscPatterns() *locales.MiscPatterns {
	return &teo.miscPatterns
}
