...
func New() locales.Translator {
	return &vai_Latn{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:               ":",
			MonthsAbbreviatedValue:  []string{"", "ꖨꖕꔞ", "ꕒꕡ", "ꕾꖺ", "ꖢꖕ", "ꖑꕱ", "ꖱꘋ", "ꖱꕞ", "ꗛꔕ", "ꕢꕌ", "ꕭꖃ", "ꔞꘋ", "ꖨꖕꗏ"},
			...
			WeekdaysWideValue:       []string{"lahadi", "tɛɛnɛɛ", "talata", "alaba", "aimisa", "aijima", "siɓiti"},
...
func (vai *vai_Latn) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(vai, vai.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'vai_Latn'
func (vai *vai_Latn) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(vai, vai.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'vai_Latn'
func (vai *vai_Latn) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(vai, vai.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'vai_Latn'
func (vai *vai_Latn) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(vai, vai.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'vai_Latn'
func (vai *vai_Latn) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(vai, vai.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'vai_Latn'
func (vai *vai_Latn) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(vai, vai.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'vai_Latn'
func (vai *vai_Latn) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(vai, vai.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'vai_Latn'
func (vai *vai_Latn) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(vai, vai.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'vai_Latn'
func (vai *vai_Latn) DateFullLayout() string {
	return vai.dateFullLayout
}

// DateLongLayout returns the long date layout for 'vai_Latn'
func (vai *vai_Latn) DateLongLayout() string {
	return vai.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'vai_Latn'
func (vai *vai_Latn) DateMediumLayout() string {
	return vai.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'vai_Latn'
func (vai *vai_Latn) DateShortLayout() string {
	return vai.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'vai_Latn'
func (vai *vai_Latn) TimeFullLayout() string {
	return vai.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'vai_Latn'
func (vai *vai_Latn) TimeLongLayout() string {
	return vai.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'vai_Latn'
func (vai *vai_Latn) TimeMediumLayout() string {
	return vai.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'vai_Latn'
func (vai *vai_Latn) TimeShortLayout() string {
	return vai.timeShortLayout
}

func (vai *vai_Latn) ListPatterns() *locales.ListPatterns {
	return vai.listPatterns
}

func (vai *vai_Latn) GetDurationSpec() *locales.DurationSpec {
	return vai.DurationSpec
}

func (vai *vai_Latn) GetMiscPatterns() *locales.MiscPatterns {
	return &vai.miscPatterns
}
