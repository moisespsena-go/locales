...
func New() locales.Translator {
	return &lg_UG{
		...
		TimeSpec: &locales.TimeSpec{
			...
			WeekdaysAbbreviatedValue: []string{"Sab", "Bal", "Lw2", "Lw3", "Lw4", "Lw5", "Lw6"},
			WeekdaysNarrowValue:      []string{"S", "B", "L", "L", "L", "L", "L"},
			WeekdaysWideValue:        []string{"Sabbiiti", "Balaza", "Lwakubiri", "Lwakusatu", "Lwakuna", "Lwakutaano", "Lwamukaaga"},
			ErasAbbreviatedValue:     []string{"BC", "AD"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Kulisito nga tannaza", "Bukya Kulisito Azaal"},
...
func (lg *lg_UG) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(lg, lg.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'lg_UG'
func (lg *lg_UG) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(lg, lg.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'lg_UG'
func (lg *lg_UG) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(lg, lg.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'lg_UG'
func (lg *lg_UG) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(lg, lg.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'lg_UG'
func (lg *lg_UG) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(lg, lg.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'lg_UG'
func (lg *lg_UG) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(lg, lg.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'lg_UG'
func (lg *lg_UG) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(lg, lg.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'lg_UG'
func (lg *lg_UG) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(lg, lg.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'lg_UG'
func (lg *lg_UG) DateFullLayout() string {
	return lg.dateFullLayout
}

// DateLongLayout returns the long date layout for 'lg_UG'
func (lg *lg_UG) DateLongLayout() string {
	return lg.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'lg_UG'
func (lg *lg_UG) DateMediumLayout() string {
	return lg.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'lg_UG'
func (lg *lg_UG) DateShortLayout() string {
	return lg.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'lg_UG'
func (lg *lg_UG) TimeFullLayout() string {
	return lg.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'lg_UG'
func (lg *lg_UG) TimeLongLayout() string {
	return lg.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'lg_UG'
func (lg *lg_UG) TimeMediumLayout() string {
	return lg.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'lg_UG'
func (lg *lg_UG) TimeShortLayout() string {
	return lg.timeShortLayout
}

func (lg *lg_UG) ListPatterns() *locales.ListPatterns {
	return lg.listPatterns
}

func (lg *lg_UG) GetDurationSpec() *locales.DurationSpec {
	return lg.DurationSpec
}

func (lg *lg_UG) GetMiscPatterns() *locales.MiscPatterns {
	return &lg.miscPatterns
}
