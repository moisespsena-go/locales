...
// DateFullLayout returns the full date layout for 'hsb_DE'
func (hsb *hsb_DE) DateFullLayout() string {
	return hsb.dateFullLayout
}

// DateLongLayout returns the long date layout for 'hsb_DE'
func (hsb *hsb_DE) DateLongLayout() string {
	return hsb.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'hsb_DE'
func (hsb *hsb_DE) DateMediumLayout() string {
	return hsb.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'hsb_DE'
func (hsb *hsb_DE) DateShortLayout() string {
	return hsb.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'hsb_DE'
func (hsb *hsb_DE) TimeFullLayout() string {
	return hsb.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'hsb_DE'
func (hsb *hsb_DE) TimeLongLayout() string {
	return hsb.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'hsb_DE'
func (hsb *hsb_DE) TimeMediumLayout() string {
	return hsb.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'hsb_DE'
func (hsb *hsb_DE) TimeShortLayout() string {
	return hsb.timeShortLayout
}

func (hsb *hsb_DE) ListPatterns() *locales.ListPatterns {
	return hsb.listPatterns
}

func (hsb *hsb_DE) GetDurationSpec() *locales.DurationSpec {
	return hsb.DurationSpec
}

func (hsb *hsb_DE) GetMiscPatterns() *locales.MiscPatterns {
