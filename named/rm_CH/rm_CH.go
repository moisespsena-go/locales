...
// DateFullLayout returns the full date layout for 'rm_CH'
func (rm *rm_CH) DateFullLayout() string {
	return rm.dateFullLayout
}

// DateLongLayout returns the long date layout for 'rm_CH'
func (rm *rm_CH) DateLongLayout() string {
	return rm.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'rm_CH'
func (rm *rm_CH) DateMediumLayout() string {
	return rm.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'rm_CH'
func (rm *rm_CH) DateShortLayout() string {
	return rm.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'rm_CH'
func (rm *rm_CH) TimeFullLayout() string {
	return rm.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'rm_CH'
func (rm *rm_CH) TimeLongLayout() string {
	return rm.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'rm_CH'
func (rm *rm_CH) TimeMediumLayout() string {
	return rm.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'rm_CH'
func (rm *rm_CH) TimeShortLayout() string {
	return rm.timeShortLayout
}

func (rm *rm_CH) ListPatterns() *locales.ListPatterns {
	return rm.listPatterns
}

func (rm *rm_CH) GetDurationSpec() *locales.DurationSpec {
	return rm.DurationSpec
}

func (rm *rm_CH) GetMiscPatterns() *locales.MiscPatterns {
