...
// DateFullLayout returns the full date layout for 'en_KN'
func (en *en_KN) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_KN'
func (en *en_KN) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_KN'
func (en *en_KN) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_KN'
func (en *en_KN) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_KN'
func (en *en_KN) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_KN'
func (en *en_KN) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_KN'
func (en *en_KN) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_KN'
func (en *en_KN) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_KN) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_KN) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_KN) GetMiscPatterns() *locales.MiscPatterns {
