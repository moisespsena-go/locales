...
// DateFullLayout returns the full date layout for 'it_SM'
func (it *it_SM) DateFullLayout() string {
	return it.dateFullLayout
}

// DateLongLayout returns the long date layout for 'it_SM'
func (it *it_SM) DateLongLayout() string {
	return it.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'it_SM'
func (it *it_SM) DateMediumLayout() string {
	return it.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'it_SM'
func (it *it_SM) DateShortLayout() string {
	return it.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'it_SM'
func (it *it_SM) TimeFullLayout() string {
	return it.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'it_SM'
func (it *it_SM) TimeLongLayout() string {
	return it.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'it_SM'
func (it *it_SM) TimeMediumLayout() string {
	return it.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'it_SM'
func (it *it_SM) TimeShortLayout() string {
	return it.timeShortLayout
}

func (it *it_SM) ListPatterns() *locales.ListPatterns {
	return it.listPatterns
}

func (it *it_SM) GetDurationSpec() *locales.DurationSpec {
	return it.DurationSpec
}

func (it *it_SM) GetMiscPatterns() *locales.MiscPatterns {
