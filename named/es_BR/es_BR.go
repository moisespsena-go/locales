...
// DateFullLayout returns the full date layout for 'es_BR'
func (es *es_BR) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_BR'
func (es *es_BR) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_BR'
func (es *es_BR) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_BR'
func (es *es_BR) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_BR'
func (es *es_BR) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_BR'
func (es *es_BR) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_BR'
func (es *es_BR) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_BR'
func (es *es_BR) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_BR) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_BR) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_BR) GetMiscPatterns() *locales.MiscPatterns {
