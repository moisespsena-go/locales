...
// DateFullLayout returns the full date layout for 'fr_BJ'
func (fr *fr_BJ) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_BJ'
func (fr *fr_BJ) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_BJ'
func (fr *fr_BJ) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_BJ'
func (fr *fr_BJ) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_BJ'
func (fr *fr_BJ) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_BJ'
func (fr *fr_BJ) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_BJ'
func (fr *fr_BJ) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_BJ'
func (fr *fr_BJ) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_BJ) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_BJ) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_BJ) GetMiscPatterns() *locales.MiscPatterns {
