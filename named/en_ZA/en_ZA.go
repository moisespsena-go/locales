...
// DateFullLayout returns the full date layout for 'en_ZA'
func (en *en_ZA) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_ZA'
func (en *en_ZA) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_ZA'
func (en *en_ZA) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_ZA'
func (en *en_ZA) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_ZA'
func (en *en_ZA) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_ZA'
func (en *en_ZA) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_ZA'
func (en *en_ZA) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_ZA'
func (en *en_ZA) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_ZA) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_ZA) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_ZA) GetMiscPatterns() *locales.MiscPatterns {
