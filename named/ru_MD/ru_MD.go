...
// DateFullLayout returns the full date layout for 'ru_MD'
func (ru *ru_MD) DateFullLayout() string {
	return ru.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ru_MD'
func (ru *ru_MD) DateLongLayout() string {
	return ru.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ru_MD'
func (ru *ru_MD) DateMediumLayout() string {
	return ru.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ru_MD'
func (ru *ru_MD) DateShortLayout() string {
	return ru.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ru_MD'
func (ru *ru_MD) TimeFullLayout() string {
	return ru.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ru_MD'
func (ru *ru_MD) TimeLongLayout() string {
	return ru.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ru_MD'
func (ru *ru_MD) TimeMediumLayout() string {
	return ru.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ru_MD'
func (ru *ru_MD) TimeShortLayout() string {
	return ru.timeShortLayout
}

func (ru *ru_MD) ListPatterns() *locales.ListPatterns {
	return ru.listPatterns
}

func (ru *ru_MD) GetDurationSpec() *locales.DurationSpec {
	return ru.DurationSpec
}

func (ru *ru_MD) GetMiscPatterns() *locales.MiscPatterns {
