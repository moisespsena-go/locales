...
// DateFullLayout returns the full date layout for 'rwk'
func (rwk *rwk) DateFullLayout() string {
	return rwk.dateFullLayout
}

// DateLongLayout returns the long date layout for 'rwk'
func (rwk *rwk) DateLongLayout() string {
	return rwk.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'rwk'
func (rwk *rwk) DateMediumLayout() string {
	return rwk.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'rwk'
func (rwk *rwk) DateShortLayout() string {
	return rwk.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'rwk'
func (rwk *rwk) TimeFullLayout() string {
	return rwk.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'rwk'
func (rwk *rwk) TimeLongLayout() string {
	return rwk.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'rwk'
func (rwk *rwk) TimeMediumLayout() string {
	return rwk.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'rwk'
func (rwk *rwk) TimeShortLayout() string {
	return rwk.timeShortLayout
}

func (rwk *rwk) ListPatterns() *locales.ListPatterns {
	return rwk.listPatterns
}

func (rwk *rwk) GetDurationSpec() *locales.DurationSpec {
	return rwk.DurationSpec
}

func (rwk *rwk) GetMiscPatterns() *locales.MiscPatterns {
