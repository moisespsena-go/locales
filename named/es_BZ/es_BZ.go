...
// DateFullLayout returns the full date layout for 'es_BZ'
func (es *es_BZ) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_BZ'
func (es *es_BZ) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_BZ'
func (es *es_BZ) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_BZ'
func (es *es_BZ) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_BZ'
func (es *es_BZ) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_BZ'
func (es *es_BZ) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_BZ'
func (es *es_BZ) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_BZ'
func (es *es_BZ) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_BZ) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_BZ) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_BZ) GetMiscPatterns() *locales.MiscPatterns {
