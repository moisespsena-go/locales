...
// DateFullLayout returns the full date layout for 'ta_IN'
func (ta *ta_IN) DateFullLayout() string {
	return ta.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ta_IN'
func (ta *ta_IN) DateLongLayout() string {
	return ta.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ta_IN'
func (ta *ta_IN) DateMediumLayout() string {
	return ta.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ta_IN'
func (ta *ta_IN) DateShortLayout() string {
	return ta.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ta_IN'
func (ta *ta_IN) TimeFullLayout() string {
	return ta.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ta_IN'
func (ta *ta_IN) TimeLongLayout() string {
	return ta.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ta_IN'
func (ta *ta_IN) TimeMediumLayout() string {
	return ta.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ta_IN'
func (ta *ta_IN) TimeShortLayout() string {
	return ta.timeShortLayout
}

func (ta *ta_IN) ListPatterns() *locales.ListPatterns {
	return ta.listPatterns
}

func (ta *ta_IN) GetDurationSpec() *locales.DurationSpec {
	return ta.DurationSpec
}

func (ta *ta_IN) GetMiscPatterns() *locales.MiscPatterns {
