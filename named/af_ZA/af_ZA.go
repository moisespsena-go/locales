...
// DateFullLayout returns the full date layout for 'af_ZA'
func (af *af_ZA) DateFullLayout() string {
	return af.dateFullLayout
}

// DateLongLayout returns the long date layout for 'af_ZA'
func (af *af_ZA) DateLongLayout() string {
	return af.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'af_ZA'
func (af *af_ZA) DateMediumLayout() string {
	return af.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'af_ZA'
func (af *af_ZA) DateShortLayout() string {
	return af.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'af_ZA'
func (af *af_ZA) TimeFullLayout() string {
	return af.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'af_ZA'
func (af *af_ZA) TimeLongLayout() string {
	return af.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'af_ZA'
func (af *af_ZA) TimeMediumLayout() string {
	return af.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'af_ZA'
func (af *af_ZA) TimeShortLayout() string {
	return af.timeShortLayout
}

func (af *af_ZA) ListPatterns() *locales.ListPatterns {
	return af.listPatterns
}

func (af *af_ZA) GetDurationSpec() *locales.DurationSpec {
	return af.DurationSpec
}

func (af *af_ZA) GetMiscPatterns() *locales.MiscPatterns {
