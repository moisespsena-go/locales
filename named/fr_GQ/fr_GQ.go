...
// DateFullLayout returns the full date layout for 'fr_GQ'
func (fr *fr_GQ) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_GQ'
func (fr *fr_GQ) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_GQ'
func (fr *fr_GQ) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_GQ'
func (fr *fr_GQ) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_GQ'
func (fr *fr_GQ) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_GQ'
func (fr *fr_GQ) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_GQ'
func (fr *fr_GQ) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_GQ'
func (fr *fr_GQ) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_GQ) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_GQ) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_GQ) GetMiscPatterns() *locales.MiscPatterns {
