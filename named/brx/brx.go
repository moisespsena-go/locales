...
func New() locales.Translator {
	return &brx{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "जान", "फेब", "मार्च", "एप्रि", "मे", "जुन", "जुल", "आग", "सेप", "अक्ट’", "नवे", "डिसे"},
			MonthsNarrowValue:        []string{"", "ज", "फ", "म", "ए", "म", "ज", "ज", "आ", "स", "अ", "न", "ड"},
			MonthsWideValue:          []string{"", "जानुवारी", "फेब्रूवारी", "मार्च", "एप्रिल", "मे", "जुन", "जुलाई", "आगष्ट", "सेप्थेम्बर", "अक्ट’बर", "नवेम्बर", "डिसेम्बर"},
			WeekdaysAbbreviatedValue: []string{"रबि", "सम", "मंगल", "बुध", "बिस्थि", "सुखुर", "सुनि"},
			WeekdaysNarrowValue:      []string{"र", "स", "मं", "बु", "बि", "सु", "सु"},
			WeekdaysWideValue:        []string{"रबिबार", "समबार", "मंगलबार", "बुधबार", "बिस्थिबार", "सुखुरबार", "सुनिबार"},
			PeriodsAbbreviatedValue:  []string{"फुं", "बेलासे"},
			PeriodsWideValue:         []string{"फुं", "बेलासे"},
			ErasAbbreviatedValue:     []string{"बि.सि.", "ए.दि"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"", ""},
			TimezonesValue:           map[string]string{"": "फ़ाल्कलैण्ड स्टैंडर्ड टाईम", "ACDT": "मध्य ओस्ट्रेलिया डेलाईट टाईम", "ACST": "आकर समर टाईम", "ACT": "आकर स्टैंडर्ड टाईम", "ACWDT": "मध्य-पश्चीम ओस्ट्रेलिया डेलाईट टाईम", "ACWST": "मध्य-पश्चीम ओस्ट्रेलिया स्टैंडर्ड टाईम", "ADT": "आटलान्टिक सानारि सम", "AEDT": "पूर्वी ओस्ट्रेलिया डेलाईट टाईम", "AEST": "पूर्वी ओस्ट्रेलिया स्टैंडर्ड टाईम", "AFT": "अफ़गानी स्टैंडर्ड टाईम", "AKDT": "अलास्का डेलाईट टाईम", "AKST": "अलास्का स्टैंडर्ड टाईम", "AMST": "अमाज़ोन समर टाईम", "AMT": "अमाज़ोन स्टैंडर्ड टाईम", "ARST": "अर्जण्टिना समर टाईम", "ART": "अर्जनटिना स्टैंडर्ड टाईम", "AST": "आटलान्टिक थाखोआरि सम", "AWDT": "दक्षिण ओस्ट्रेलिया डेलाईट टाईम", "AWST": "दक्षिण ओस्ट्रेलिया स्टैंडर्ड टाईम", "BNT": "ब्रुनेई दर उस सलाम स्टैंडर्ड टाईम", "BOT": "बोलिविया स्टैंडर्ड टाईम", "BRST": "ब्राज़ीलिया समर टाईम", "BRT": "ब्राज़ीलिया स्टैंडर्ड टाईम", "BST": "बांगलादेश समर टाईम", "BTT": "भुटान स्टैंडर्ड टाईम", "CAT": "मध्य अफ्रीका स्टैंडर्ड टाईम", "CCT": "कोको द्वीप स्टैंडर्ड टाईम", "CDT": "मिरु साननि सम", "CDT (Kuba)": "क्युबा डेलाईट टाईम", "CHADT": "चैथम डेलाईट टाईम", "CHAST": "चैथम स्टैंडर्ड टाईम", "CLST": "चीली समर टाईम", "CLT": "चीली स्टैंडर्ड टाईम", "COST": "कोलंबिया समर टाईम", "COT": "कोलंबिया स्टैंडर्ड टाईम", "CST": "मिरु आमेरिका थाखोआरि सम", "CST (Kuba)": "क्युबा स्टैंडर्ड टाईम", "CXT": "क्रीसमस स्टैंडर्ड टाईम", "ChST": "चामरो स्टैंडर्ड टाईम", "EASST": "ईस्टर आईलंड समर टाईम", "EAST": "ईस्टर आईलंड स्टैंडर्ड टाईम", "EAT": "पूर्वी अफ्रीका स्टैंडर्ड टाईम", "ECT": "एक्वाडौर स्टैंडर्ड टाईम", "EDT": "सानजायारि सान सम", "EGDT": "ग्रीनलैण्ड ईस्टर्न समर टाईम", "EGST": "ग्रीनलैण्ड ईस्टर्न स्टैंडर्ड टाईम", "EST": "सानजानि थाखोआरि सम", "FKST": "फ़ाल्कलैण्ड समर टाईम", "GALT": "गालापागोस स्टैंडर्ड टाईम", "GFT": "फ्रान्सीसी गुयाना स्टैंडर्ड टाईम", "GMT": "ग्रिनवीच गेजेरारि सम", "GST": "गल्फ़ स्टैंडर्ड टाईम", "GYT": "गुयाना स्टैंडर्ड टाईम", "HADT": "हवाई आलटन डेलाईट टाईम", "HAST": "हवाई आलटन स्टैंडर्ड टाईम", "HENOMX": "साहासोनाब मेक्सिक’ सान सम", "HEOG": "ग्रीनलैण्ड वेस्टर्न समर टाईम", "HEPMX": "मेक्सिक’आरि पेसिफिक सान सम", "HKST": "हाँगकॉंग समर टाईम", "HKT": "हाँगकॉंग स्टैंडर्ड टाईम", "HNNOMX": "साहासोनाब मेक्सिक’ थाखोआरि सम", "HNOG": "ग्रीनलैण्ड वेस्टर्न स्टैंडर्ड टाईम", "HNPMX": "मेक्सिक’आरि पेसिफिक थाखोआरि सम", "ICT": "ईंडो चइना स्टैंडर्ड टाईम", "IRDT": "ईरान डेलाईट टाईम", "IRST": "ईरान स्टैंडर्ड टाईम", "IST": "भारतीय स्टैंडर्ड टाईम", "JDT": "जपान डेलाईट टाईम", "JST": "जपान स्टैंडर्ड टाईम", "LHDT": "लार्ड़ होव डेलाईट टाईम", "LHST": "लार्ड़ होव स्टैंडर्ड टाईम", "MDT": "माकाऊ समर टाईम", "MESZ": "मिरु युरोपनि गोलोम बोथोरारि सम", "MEZ": "मिरु युरोपनि थाखोआरि सम", "MST": "माकाऊ स्टैंडर्ड टाईम", "MVT": "मालदीव स्टैंडर्ड टाईम", "MYT": "मलेशिया स्टैंडर्ड टाईम", "NDT": "न्युफाऊंडलैण्ड डेलाईट टाईम", "NPT": "नेपाल स्टैंडर्ड टाईम", "NST": "न्युफाऊंडलैण्ड स्टैंडर्ड टाईम", "NZDT": "न्युज़ीलैण्ड डेलाईट टाईम", "NZST": "न्युज़ीलैण्ड स्टैंडर्ड टाईम", "OESZ": "सानजा युरोपनि गोलोम बोथोरारि सम", "OEZ": "सानजा युरोपनि थाखोआरि सम", "PDT": "पोसिफिक सानारि सम", "PKT": "पाकिस्तान समर टाईम", "PMDT": "सेँ पीयॅर एवं मीकलों डेलाईट टाईम", "PMST": "सेँ पीयॅर एवं मीकलों स्टैंडर्ड टाईम", "PST": "पेसिफिकनि थाखोआरि सम", "PYST": "पारागुए समर टाईम", "SAST": "दक्षिण अफ्रीका स्टैंडर्ड टाईम", "SGT": "सींगापुर स्टैंडर्ड टाईम", "SRT": "सुरीनाम स्टैंडर्ड टाईम", "TLT": "ईस्ट टीमोर स्टैंडर्ड टाईम", "TMST": "तुर्कमेनीस्तान समर टाईम", "TMT": "तुर्कमेनीस्तान स्टैंडर्ड टाईम", "UYST": "ऊरुगुए समर टाईम", "UYT": "ऊरुगुए स्टैंडर्ड टाईम", "VET": "वेनेज़ुएला स्टैंडर्ड टाईम", "WARST": "पश्चीम अर्जण्टिना समर टाईम", "WART": "पश्चीम अर्जण्टिना स्टैंडर्ड टाईम", "WAST": "पश्चीम अफ्रीका समर टाईम", "WAT": "पश्चीम अफ्रीका स्टैंडर्ड टाईम", "WESZ": "सोनाब युरोपनि गोलोम बोथोरारि सम", "WEZ": "सोनाब युरोपनि थाखोआरि सम", "WIB": "वेस्टर्न ईंडोनीशिया स्टैंडर्ड टाईम", "WIT": "ईस्टर्न ईंडोनीशिया स्टैंडर्ड टाईम", "WITA": "ईंडोनीशिया स्टैंडर्ड टाईम", "∅∅∅": "पेरु समर टाईम"},
		},
		...
		timeShortLayout:  "a नि h:mm",
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} आरो {1}", "", "", "{0}, आरो {1}"}, []string(nil)}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"साल", "%v साल", "%v साल", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"महीने", "%v महीना", "%v महीने", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"सप्ताह", "%v सप्ताह", "%v सप्ताह", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"सान", "%v सान", "%v सान", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"घंटे", "%v रिंगा", "%v घंटे", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"मिन.", "%v मिन.", "%v मिन.", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"सेकं.", "%v सेकं.", "%v सेकं.", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
...
func (brx *brx) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(brx, brx.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'brx'
func (brx *brx) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(brx, brx.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'brx'
func (brx *brx) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(brx, brx.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'brx'
func (brx *brx) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(brx, brx.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'brx'
func (brx *brx) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(brx, brx.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'brx'
func (brx *brx) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(brx, brx.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'brx'
func (brx *brx) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(brx, brx.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'brx'
func (brx *brx) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(brx, brx.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'brx'
func (brx *brx) DateFullLayout() string {
	return brx.dateFullLayout
}

// DateLongLayout returns the long date layout for 'brx'
func (brx *brx) DateLongLayout() string {
	return brx.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'brx'
func (brx *brx) DateMediumLayout() string {
	return brx.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'brx'
func (brx *brx) DateShortLayout() string {
	return brx.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'brx'
func (brx *brx) TimeFullLayout() string {
	return brx.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'brx'
func (brx *brx) TimeLongLayout() string {
	return brx.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'brx'
func (brx *brx) TimeMediumLayout() string {
	return brx.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'brx'
func (brx *brx) TimeShortLayout() string {
	return brx.timeShortLayout
}

func (brx *brx) ListPatterns() *locales.ListPatterns {
	return brx.listPatterns
}

func (brx *brx) GetDurationSpec() *locales.DurationSpec {
	return brx.DurationSpec
}

func (brx *brx) GetMiscPatterns() *locales.MiscPatterns {
	return &brx.miscPatterns
}
