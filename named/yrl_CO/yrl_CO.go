...
// New returns a new instance of translator for the 'yrl_CO' locale
...
func (yrl *yrl_CO) Locale() string {
	return yrl.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'yrl_CO'
func (yrl *yrl_CO) PluralsCardinal() []locales.PluralRule {
	return yrl.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'yrl_CO'
func (yrl *yrl_CO) PluralsOrdinal() []locales.PluralRule {
	return yrl.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'yrl_CO'
func (yrl *yrl_CO) PluralsRange() []locales.PluralRule {
	return yrl.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'yrl_CO'
func (yrl *yrl_CO) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'yrl_CO'
func (yrl *yrl_CO) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'yrl_CO'
func (yrl *yrl_CO) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// FmtDateShort returns the short date representation of 't' for 'yrl_CO'
func (yrl *yrl_CO) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'yrl_CO'
func (yrl *yrl_CO) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'yrl_CO'
func (yrl *yrl_CO) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'yrl_CO'
func (yrl *yrl_CO) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'yrl_CO'
func (yrl *yrl_CO) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'yrl_CO'
func (yrl *yrl_CO) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'yrl_CO'
func (yrl *yrl_CO) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'yrl_CO'
func (yrl *yrl_CO) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'yrl_CO'
func (yrl *yrl_CO) DateFullLayout() string {
	return yrl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'yrl_CO'
func (yrl *yrl_CO) DateLongLayout() string {
	return yrl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'yrl_CO'
func (yrl *yrl_CO) DateMediumLayout() string {
	return yrl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'yrl_CO'
func (yrl *yrl_CO) DateShortLayout() string {
	return yrl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'yrl_CO'
func (yrl *yrl_CO) TimeFullLayout() string {
	return yrl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'yrl_CO'
func (yrl *yrl_CO) TimeLongLayout() string {
	return yrl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'yrl_CO'
func (yrl *yrl_CO) TimeMediumLayout() string {
	return yrl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'yrl_CO'
func (yrl *yrl_CO) TimeShortLayout() string {
	return yrl.timeShortLayout
}

func (yrl *yrl_CO) ListPatterns() *locales.ListPatterns {
	return yrl.listPatterns
}

func (yrl *yrl_CO) GetDurationSpec() *locales.DurationSpec {
	return yrl.DurationSpec
}

func (yrl *yrl_CO) GetMiscPatterns() *locales.MiscPatterns {
