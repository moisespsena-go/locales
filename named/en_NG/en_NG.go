...
// DateFullLayout returns the full date layout for 'en_NG'
func (en *en_NG) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_NG'
func (en *en_NG) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_NG'
func (en *en_NG) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_NG'
func (en *en_NG) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_NG'
func (en *en_NG) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_NG'
func (en *en_NG) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_NG'
func (en *en_NG) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_NG'
func (en *en_NG) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_NG) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_NG) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_NG) GetMiscPatterns() *locales.MiscPatterns {
