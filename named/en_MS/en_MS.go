...
// DateFullLayout returns the full date layout for 'en_MS'
func (en *en_MS) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_MS'
func (en *en_MS) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_MS'
func (en *en_MS) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_MS'
func (en *en_MS) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_MS'
func (en *en_MS) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_MS'
func (en *en_MS) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_MS'
func (en *en_MS) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_MS'
func (en *en_MS) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_MS) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_MS) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_MS) GetMiscPatterns() *locales.MiscPatterns {
