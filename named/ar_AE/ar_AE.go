...
// DateFullLayout returns the full date layout for 'ar_AE'
func (ar *ar_AE) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_AE'
func (ar *ar_AE) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_AE'
func (ar *ar_AE) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_AE'
func (ar *ar_AE) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_AE'
func (ar *ar_AE) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_AE'
func (ar *ar_AE) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_AE'
func (ar *ar_AE) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_AE'
func (ar *ar_AE) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_AE) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_AE) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_AE) GetMiscPatterns() *locales.MiscPatterns {
