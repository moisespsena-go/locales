...
// DateFullLayout returns the full date layout for 'tt'
func (tt *tt) DateFullLayout() string {
	return tt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'tt'
func (tt *tt) DateLongLayout() string {
	return tt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'tt'
func (tt *tt) DateMediumLayout() string {
	return tt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'tt'
func (tt *tt) DateShortLayout() string {
	return tt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'tt'
func (tt *tt) TimeFullLayout() string {
	return tt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'tt'
func (tt *tt) TimeLongLayout() string {
	return tt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'tt'
func (tt *tt) TimeMediumLayout() string {
	return tt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'tt'
func (tt *tt) TimeShortLayout() string {
	return tt.timeShortLayout
}

func (tt *tt) ListPatterns() *locales.ListPatterns {
	return tt.listPatterns
}

func (tt *tt) GetDurationSpec() *locales.DurationSpec {
	return tt.DurationSpec
}

func (tt *tt) GetMiscPatterns() *locales.MiscPatterns {
