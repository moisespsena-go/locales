...
// DateFullLayout returns the full date layout for 'zh_Hans_HK'
func (zh *zh_Hans_HK) DateFullLayout() string {
	return zh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'zh_Hans_HK'
func (zh *zh_Hans_HK) DateLongLayout() string {
	return zh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'zh_Hans_HK'
func (zh *zh_Hans_HK) DateMediumLayout() string {
	return zh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'zh_Hans_HK'
func (zh *zh_Hans_HK) DateShortLayout() string {
	return zh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'zh_Hans_HK'
func (zh *zh_Hans_HK) TimeFullLayout() string {
	return zh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'zh_Hans_HK'
func (zh *zh_Hans_HK) TimeLongLayout() string {
	return zh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'zh_Hans_HK'
func (zh *zh_Hans_HK) TimeMediumLayout() string {
	return zh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'zh_Hans_HK'
func (zh *zh_Hans_HK) TimeShortLayout() string {
	return zh.timeShortLayout
}

func (zh *zh_Hans_HK) ListPatterns() *locales.ListPatterns {
	return zh.listPatterns
}

func (zh *zh_Hans_HK) GetDurationSpec() *locales.DurationSpec {
	return zh.DurationSpec
}

func (zh *zh_Hans_HK) GetMiscPatterns() *locales.MiscPatterns {
