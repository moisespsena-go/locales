...
// DateFullLayout returns the full date layout for 'es_PR'
func (es *es_PR) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_PR'
func (es *es_PR) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_PR'
func (es *es_PR) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_PR'
func (es *es_PR) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_PR'
func (es *es_PR) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_PR'
func (es *es_PR) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_PR'
func (es *es_PR) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_PR'
func (es *es_PR) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_PR) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_PR) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_PR) GetMiscPatterns() *locales.MiscPatterns {
