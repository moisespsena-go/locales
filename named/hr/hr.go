	...
	return &hr{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"stoljeća", "%v stoljećem", "%v stoljeća", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"des.", "%v des.", "%v des.", ""},
				Long:   &locales.CounterFormat{"desetljeća", "%v desetljećem", "%v desetljeća", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mj.", "%v mj.", "%v mj.", ""},
				Long:   &locales.CounterFormat{"mjeseci", "%v mjesecom", "%v mjeseci", "%v mjesečno"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"tj.", "%v tj.", "%v tj.", ""},
				Long:   &locales.CounterFormat{"tjedni", "%v tjednom", "%v tjedana", "%v tjedno"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"sati", "%v satom", "%v sati", "%v/h"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%v m", "%v m", ""},
				Long:   &locales.CounterFormat{"minute", "%v minutom", "%v minuta", "%v/min"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%v s", "%v s", ""},
				Long:   &locales.CounterFormat{"sekunde", "%v sekundom", "%v sekundi", "%v/s"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
...
// DateFullLayout returns the full date layout for 'hr'
func (hr *hr) DateFullLayout() string {
	return hr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'hr'
func (hr *hr) DateLongLayout() string {
	return hr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'hr'
func (hr *hr) DateMediumLayout() string {
	return hr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'hr'
func (hr *hr) DateShortLayout() string {
	return hr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'hr'
func (hr *hr) TimeFullLayout() string {
	return hr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'hr'
func (hr *hr) TimeLongLayout() string {
	return hr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'hr'
func (hr *hr) TimeMediumLayout() string {
	return hr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'hr'
func (hr *hr) TimeShortLayout() string {
	return hr.timeShortLayout
}

func (hr *hr) ListPatterns() *locales.ListPatterns {
	return hr.listPatterns
}

func (hr *hr) GetDurationSpec() *locales.DurationSpec {
	return hr.DurationSpec
}

func (hr *hr) GetMiscPatterns() *locales.MiscPatterns {
