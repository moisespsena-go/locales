...
// DateFullLayout returns the full date layout for 'ff_Latn_MR'
func (ff *ff_Latn_MR) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff_Latn_MR'
func (ff *ff_Latn_MR) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff_Latn_MR'
func (ff *ff_Latn_MR) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff_Latn_MR'
func (ff *ff_Latn_MR) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff_Latn_MR'
func (ff *ff_Latn_MR) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff_Latn_MR'
func (ff *ff_Latn_MR) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff_Latn_MR'
func (ff *ff_Latn_MR) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff_Latn_MR'
func (ff *ff_Latn_MR) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff_Latn_MR) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff_Latn_MR) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff_Latn_MR) GetMiscPatterns() *locales.MiscPatterns {
