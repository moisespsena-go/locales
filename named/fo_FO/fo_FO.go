...
// DateFullLayout returns the full date layout for 'fo_FO'
func (fo *fo_FO) DateFullLayout() string {
	return fo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fo_FO'
func (fo *fo_FO) DateLongLayout() string {
	return fo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fo_FO'
func (fo *fo_FO) DateMediumLayout() string {
	return fo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fo_FO'
func (fo *fo_FO) DateShortLayout() string {
	return fo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fo_FO'
func (fo *fo_FO) TimeFullLayout() string {
	return fo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fo_FO'
func (fo *fo_FO) TimeLongLayout() string {
	return fo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fo_FO'
func (fo *fo_FO) TimeMediumLayout() string {
	return fo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fo_FO'
func (fo *fo_FO) TimeShortLayout() string {
	return fo.timeShortLayout
}

func (fo *fo_FO) ListPatterns() *locales.ListPatterns {
	return fo.listPatterns
}

func (fo *fo_FO) GetDurationSpec() *locales.DurationSpec {
	return fo.DurationSpec
}

func (fo *fo_FO) GetMiscPatterns() *locales.MiscPatterns {
