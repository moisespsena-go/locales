...
func New() locales.Translator {
	return &dje_NE{
		...
		TimeSpec: &locales.TimeSpec{
			...
			WeekdaysNarrowValue:      []string{"H", "T", "T", "L", "M", "Z", "S"},
			WeekdaysWideValue:        []string{"Alhadi", "Atinni", "Atalaata", "Alarba", "Alhamisi", "Alzuma", "Asibti"},
...
func (dje *dje_NE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(dje, dje.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'dje_NE'
func (dje *dje_NE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(dje, dje.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'dje_NE'
func (dje *dje_NE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(dje, dje.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'dje_NE'
func (dje *dje_NE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(dje, dje.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'dje_NE'
func (dje *dje_NE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(dje, dje.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'dje_NE'
func (dje *dje_NE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(dje, dje.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'dje_NE'
func (dje *dje_NE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(dje, dje.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'dje_NE'
func (dje *dje_NE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(dje, dje.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'dje_NE'
func (dje *dje_NE) DateFullLayout() string {
	return dje.dateFullLayout
}

// DateLongLayout returns the long date layout for 'dje_NE'
func (dje *dje_NE) DateLongLayout() string {
	return dje.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'dje_NE'
func (dje *dje_NE) DateMediumLayout() string {
	return dje.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'dje_NE'
func (dje *dje_NE) DateShortLayout() string {
	return dje.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'dje_NE'
func (dje *dje_NE) TimeFullLayout() string {
	return dje.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'dje_NE'
func (dje *dje_NE) TimeLongLayout() string {
	return dje.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'dje_NE'
func (dje *dje_NE) TimeMediumLayout() string {
	return dje.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'dje_NE'
func (dje *dje_NE) TimeShortLayout() string {
	return dje.timeShortLayout
}

func (dje *dje_NE) ListPatterns() *locales.ListPatterns {
	return dje.listPatterns
}

func (dje *dje_NE) GetDurationSpec() *locales.DurationSpec {
	return dje.DurationSpec
}

func (dje *dje_NE) GetMiscPatterns() *locales.MiscPatterns {
	return &dje.miscPatterns
}
