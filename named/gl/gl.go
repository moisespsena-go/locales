...
func New() locales.Translator {
	return &gl{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						...
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00000 M¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00000 M¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "xan.", "feb.", "mar.", "abr.", "maio", "xuño", "xul.", "ago.", "set.", "out.", "nov.", "dec."},
			MonthsNarrowValue:        []string{"", "x.", "f.", "m.", "a.", "m.", "x.", "x.", "a.", "s.", "o.", "n.", "d."},
			MonthsWideValue:          []string{"", "xaneiro", "febreiro", "marzo", "abril", "maio", "xuño", "xullo", "agosto", "setembro", "outubro", "novembro", "decembro"},
			WeekdaysAbbreviatedValue: []string{"dom.", "luns", "mar.", "mér.", "xov.", "ven.", "sáb."},
			WeekdaysNarrowValue:      []string{"d.", "l.", "m.", "m.", "x.", "v.", "s."},
			WeekdaysShortValue:       []string{"do.", "lu.", "ma.", "mé.", "xo.", "ve.", "sá."},
			WeekdaysWideValue:        []string{"domingo", "luns", "martes", "mércores", "xoves", "venres", "sábado"},
			...
			ErasWideValue:            []string{"antes de Cristo", "despois de Cristo"},
			TimezonesValue:           map[string]string{"": "Horario estándar do Paraguai", "ACDT": "Horario de verán de Australia Central", "ACST": "ACST", "ACT": "ACT", "ACWDT": "Horario de verán de Australia Occidental Central", "ACWST": "Horario estándar de Australia Occidental Central", "ADT": "Horario de verán do Atlántico", "AEDT": "Horario de verán de Australia Oriental", "AEST": "Horario estándar de Australia Oriental", "AFT": "Horario de Afganistán", "AKDT": "Horario de verán de Alasca", "AKST": "Horario estándar de Alasca", "AMST": "Horario de verán do Amazonas", "AMT": "Horario estándar do Amazonas", "ARST": "Horario de verán da Arxentina", "ART": "Horario estándar da Arxentina", "AST": "Horario estándar do Atlántico", "AWDT": "Horario de verán de Australia Occidental", "AWST": "Horario estándar de Australia Occidental", "BNT": "Horario de Brunei Darussalam", "BOT": "Horario de Bolivia", "BRST": "Horario de verán de Brasilia", "BRT": "Horario estándar de Brasilia", "BST": "Horario de verán de Bangladesh", "BTT": "Horario de Bután", "CAT": "Horario de África Central", "CCT": "Horario das Illas Cocos", "CDT": "Horario de verán central, Norteamérica", "CDT (Kuba)": "Horario de verán de Cuba", "CHADT": "Horario de verán de Chatham", "CHAST": "Horario estándar de Chatham", "CLST": "Horario de verán de Chile", "CLT": "Horario estándar de Chile", "COST": "Horario de verán de Colombia", "COT": "Horario estándar de Colombia", "CST": "Horario estándar central, Norteamérica", "CST (Kuba)": "Horario estándar de Cuba", "CXT": "Horario da Illa Christmas", "ChST": "Horario estándar chamorro", "EASST": "Horario de verán da Illa de Pascua", "EAST": "Horario estándar da Illa de Pascua", "EAT": "Horario de África Oriental", "ECT": "Horario de Ecuador", "EDT": "Horario de verán do leste, América do Norte", "EGDT": "Horario de verán de Groenlandia Oriental", "EGST": "Horario estándar de Groenlandia Oriental", "EST": "Horario estándar do leste, América do Norte", "FKST": "Horario de verán das Illas Malvinas", "GALT": "Horario das Galápagos", "GFT": "Horario da Güiana Francesa", "GMT": "Horario do meridiano de Greenwich", "GST": "Horario do Golfo", "GYT": "Horario da Güiana", "HADT": "Horario de verán de Hawai-illas Aleutianas", "HAST": "Horario estándar de Hawai-illas Aleutianas", "HENOMX": "Horario de verán do noroeste de México", "HEOG": "Horario de verán de Groenlandia Occidental", "HEPMX": "Horario de verán do Pacífico mexicano", "HKST": "Horario de verán de Hong Kong", "HKT": "Horario estándar de Hong Kong", "HNNOMX": "Horario estándar do noroeste de México", "HNOG": "Horario estándar de Groenlandia Occidental", "HNPMX": "Horario estándar do Pacífico mexicano", "ICT": "Horario de Indochina", "IRDT": "Horario de verán de Irán", "IRST": "Horario estándar de Irán", "IST": "Horario da India", "JDT": "Horario de verán do Xapón", "JST": "Horario estándar do Xapón", "LHDT": "Horario de verán de Lord Howe", "LHST": "Horario estándar de Lord Howe", "MDT": "MDT", "MESZ": "Horario de verán de Europa Central", "MEZ": "Horario estándar de Europa Central", "MST": "MST", "MVT": "Horario das Maldivas", "MYT": "Horario de Malaisia", "NDT": "Horario de verán de Terra Nova", "NPT": "Horario de Nepal", "NST": "Horario estándar de Terra Nova", "NZDT": "Horario de verán de Nova Zelandia", "NZST": "Horario estándar de Nova Zelandia", "OESZ": "Horario de verán de Europa Oriental", "OEZ": "Horario estándar de Europa Oriental", "PDT": "Horario de verán do Pacífico, América do Norte", "PKT": "Horario de verán de Paquistán", "PMDT": "Horario de verán de Saint Pierre et Miquelon", "PMST": "Horario estándar de Saint Pierre et Miquelon", "PST": "Horario estándar do Pacífico, América do Norte", "PYST": "Horario de verán do Paraguai", "SAST": "Horario de África Meridional", "SGT": "Horario de Singapur", "SRT": "Horario de Suriname", "TLT": "Horario de Timor Leste", "TMST": "Horario de verán de Turkmenistán", "TMT": "Horario estándar de Turkmenistán", "UYST": "Horario de verán do Uruguai", "UYT": "Horario estándar do Uruguai", "VET": "Horario de Venezuela", "WARST": "Horario de verán da Arxentina Occidental", "WART": "Horario estándar da Arxentina Occidental", "WAST": "Horario de verán de África Occidental", "WAT": "Horario estándar de África Occidental", "WESZ": "Horario de verán de Europa Occidental", "WEZ": "Horario estándar de Europa Occidental", "WIB": "Horario de Indonesia Occidental", "WIT": "Horario de Indonesia Oriental", "WITA": "Horario de Indonesia Central", "∅∅∅": "Horario de verán dos Azores"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"séc.", "%v séc.", "%v séc.", ""},
...
func (gl *gl) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(gl, gl.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'gl'
func (gl *gl) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(gl, gl.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'gl'
func (gl *gl) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(gl, gl.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'gl'
func (gl *gl) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(gl, gl.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'gl'
func (gl *gl) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(gl, gl.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'gl'
func (gl *gl) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(gl, gl.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'gl'
func (gl *gl) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(gl, gl.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'gl'
func (gl *gl) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(gl, gl.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'gl'
func (gl *gl) DateFullLayout() string {
	return gl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'gl'
func (gl *gl) DateLongLayout() string {
	return gl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'gl'
func (gl *gl) DateMediumLayout() string {
	return gl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'gl'
func (gl *gl) DateShortLayout() string {
	return gl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'gl'
func (gl *gl) TimeFullLayout() string {
	return gl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'gl'
func (gl *gl) TimeLongLayout() string {
	return gl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'gl'
func (gl *gl) TimeMediumLayout() string {
	return gl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'gl'
func (gl *gl) TimeShortLayout() string {
	return gl.timeShortLayout
}

func (gl *gl) ListPatterns() *locales.ListPatterns {
	return gl.listPatterns
}

func (gl *gl) GetDurationSpec() *locales.DurationSpec {
	return gl.DurationSpec
}

func (gl *gl) GetMiscPatterns() *locales.MiscPatterns {
	return &gl.miscPatterns
}
