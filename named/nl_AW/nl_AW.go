...
// DateFullLayout returns the full date layout for 'nl_AW'
func (nl *nl_AW) DateFullLayout() string {
	return nl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nl_AW'
func (nl *nl_AW) DateLongLayout() string {
	return nl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nl_AW'
func (nl *nl_AW) DateMediumLayout() string {
	return nl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nl_AW'
func (nl *nl_AW) DateShortLayout() string {
	return nl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nl_AW'
func (nl *nl_AW) TimeFullLayout() string {
	return nl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nl_AW'
func (nl *nl_AW) TimeLongLayout() string {
	return nl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nl_AW'
func (nl *nl_AW) TimeMediumLayout() string {
	return nl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nl_AW'
func (nl *nl_AW) TimeShortLayout() string {
	return nl.timeShortLayout
}

func (nl *nl_AW) ListPatterns() *locales.ListPatterns {
	return nl.listPatterns
}

func (nl *nl_AW) GetDurationSpec() *locales.DurationSpec {
	return nl.DurationSpec
}

func (nl *nl_AW) GetMiscPatterns() *locales.MiscPatterns {
