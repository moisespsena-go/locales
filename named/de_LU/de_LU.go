...
func New() locales.Translator {
	return &de_LU{
		...
		TimeSpec: &locales.TimeSpec{
			...
			PeriodsNarrowValue:       []string{"vorm.", "nachm."},
...
// DateFullLayout returns the full date layout for 'de_LU'
func (de *de_LU) DateFullLayout() string {
	return de.dateFullLayout
}

// DateLongLayout returns the long date layout for 'de_LU'
func (de *de_LU) DateLongLayout() string {
	return de.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'de_LU'
func (de *de_LU) DateMediumLayout() string {
	return de.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'de_LU'
func (de *de_LU) DateShortLayout() string {
	return de.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'de_LU'
func (de *de_LU) TimeFullLayout() string {
	return de.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'de_LU'
func (de *de_LU) TimeLongLayout() string {
	return de.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'de_LU'
func (de *de_LU) TimeMediumLayout() string {
	return de.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'de_LU'
func (de *de_LU) TimeShortLayout() string {
	return de.timeShortLayout
}

func (de *de_LU) ListPatterns() *locales.ListPatterns {
	return de.listPatterns
}

func (de *de_LU) GetDurationSpec() *locales.DurationSpec {
	return de.DurationSpec
}

func (de *de_LU) GetMiscPatterns() *locales.MiscPatterns {
