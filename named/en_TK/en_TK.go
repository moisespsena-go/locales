...
// DateFullLayout returns the full date layout for 'en_TK'
func (en *en_TK) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_TK'
func (en *en_TK) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_TK'
func (en *en_TK) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_TK'
func (en *en_TK) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_TK'
func (en *en_TK) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_TK'
func (en *en_TK) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_TK'
func (en *en_TK) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_TK'
func (en *en_TK) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_TK) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_TK) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_TK) GetMiscPatterns() *locales.MiscPatterns {
