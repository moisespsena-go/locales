...
// DateFullLayout returns the full date layout for 'en_GM'
func (en *en_GM) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_GM'
func (en *en_GM) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_GM'
func (en *en_GM) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_GM'
func (en *en_GM) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_GM'
func (en *en_GM) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_GM'
func (en *en_GM) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_GM'
func (en *en_GM) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_GM'
func (en *en_GM) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_GM) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_GM) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_GM) GetMiscPatterns() *locales.MiscPatterns {
