...
// DateFullLayout returns the full date layout for 'ckb'
func (ckb *ckb) DateFullLayout() string {
	return ckb.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ckb'
func (ckb *ckb) DateLongLayout() string {
	return ckb.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ckb'
func (ckb *ckb) DateMediumLayout() string {
	return ckb.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ckb'
func (ckb *ckb) DateShortLayout() string {
	return ckb.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ckb'
func (ckb *ckb) TimeFullLayout() string {
	return ckb.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ckb'
func (ckb *ckb) TimeLongLayout() string {
	return ckb.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ckb'
func (ckb *ckb) TimeMediumLayout() string {
	return ckb.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ckb'
func (ckb *ckb) TimeShortLayout() string {
	return ckb.timeShortLayout
}

func (ckb *ckb) ListPatterns() *locales.ListPatterns {
	return ckb.listPatterns
}

func (ckb *ckb) GetDurationSpec() *locales.DurationSpec {
	return ckb.DurationSpec
}

func (ckb *ckb) GetMiscPatterns() *locales.MiscPatterns {
