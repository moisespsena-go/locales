...
// DateFullLayout returns the full date layout for 'sat_Olck'
func (sat *sat_Olck) DateFullLayout() string {
	return sat.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sat_Olck'
func (sat *sat_Olck) DateLongLayout() string {
	return sat.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sat_Olck'
func (sat *sat_Olck) DateMediumLayout() string {
	return sat.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sat_Olck'
func (sat *sat_Olck) DateShortLayout() string {
	return sat.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sat_Olck'
func (sat *sat_Olck) TimeFullLayout() string {
	return sat.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sat_Olck'
func (sat *sat_Olck) TimeLongLayout() string {
	return sat.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sat_Olck'
func (sat *sat_Olck) TimeMediumLayout() string {
	return sat.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sat_Olck'
func (sat *sat_Olck) TimeShortLayout() string {
	return sat.timeShortLayout
}

func (sat *sat_Olck) ListPatterns() *locales.ListPatterns {
	return sat.listPatterns
}

func (sat *sat_Olck) GetDurationSpec() *locales.DurationSpec {
	return sat.DurationSpec
}

func (sat *sat_Olck) GetMiscPatterns() *locales.MiscPatterns {
