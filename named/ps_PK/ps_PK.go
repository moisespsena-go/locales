...
func New() locales.Translator {
	return &ps_PK{
		...
		TimeSpec: &locales.TimeSpec{
			...
			TimezonesValue:           map[string]string{"": "د فوکلنډ ټاپو معیاری وخت", "ACDT": "آسترالوي مرکزي د ورځې روښانه وخت", "ACST": "ACST", "ACT": "ACT", "ACWDT": "آسترالوي مرکزي لوېديځ د ورځې روښانه وخت", "ACWST": "آسترالوي مرکزي لوېديځ معياري وخت", "ADT": "اتلانتیک د رڼا ورځے وخت", "AEDT": "آسترالوي ختيځ د ورځې روښانه وخت", "AEST": "آسترالوي ختيځ معياري وخت", "AFT": "افغانستان وخت", "AKDT": "د الاسکا د ورځے روښانه کول", "AKST": "", "AMST": "ایمیزون اوړي وخت", "AMT": "ایمیزون معیاری وخت", "ARST": "ارجنټاین اوړي وخت", "ART": "ارجنټاین معیاری وخت", "AST": "", "AWDT": "د اسټرالیا لویدیځ د ورځے وخت", "AWST": "", "BNT": "برونايي دارالسلام وخت", "BOT": "بولیویا وخت", "BRST": "برسلیا اوړي وخت", "BRT": "برسلیا معیاری وخت", "BST": "بنګله ديش اوړي وخت", "BTT": "بهوټان وخت", "CAT": "منځنی افريقا وخت", "CCT": "کوکوز ټاپوګانو وخت", "CDT": "مرکزي رڼا ورځے وخت", "CDT (Kuba)": "کیوبا د رڼا ورځے وخت", "CHADT": "چاتام د ورځې روښانه وخت", "CHAST": "چاتام معياري وخت", "CLST": "چلی اوړي وخت", "CLT": "چلی معیاری وخت", "COST": "کولمبیا اوړي وخت", "COT": "کولمبیا معیاری وخت", "CST": "", "CST (Kuba)": "", "CXT": "کريسمس ټاپو وخت", "ChST": "چمارو معياري وخت", "EASST": "ايستر ټاپو اوړي وخت", "EAST": "ايستر ټاپو معياري وخت", "EAT": "ختيځ افريقا وخت", "ECT": "د اکوادور وخت", "EDT": "ختيځ د رڼا ورځے وخت", "EGDT": "د ختیځ ګرینلینډ اوړي وخت", "EGST": "د ختیځ ګرینلینډ معياري وخت", "EST": "", "FKST": "د فوکلنډ ټاپو اوړي وخت", "GALT": "ګالپګوس وخت", "GFT": "د فرانسوي ګانا وخت", "GMT": "ګرينويچ معياري وخت", "GST": "خلیج معياري وخت", "GYT": "د ګوانانا وخت", "HADT": "هوایی الیوتین رڼا ورځے وخت", "HAST": "", "HENOMX": "د شمال لویدیځ مکسیکو رڼا ورځے وخت", "HEOG": "لویدیځ ګرینلینډ اوړي وخت", "HEPMX": "مکسیکن پیسفک رڼا ورځے وخت", "HKST": "هانګ کانګ اوړي وخت", "HKT": "هانګ کانګ معياري وخت", "HNNOMX": "", "HNOG": "لویدیځ ګرینلینډ معياري وخت", "HNPMX": "", "ICT": "انډوچاینه وخت", "IRDT": "د ایران د ورځے وخت", "IRST": "", "IST": "هند معیاري وخت", "JDT": "جاپان د رڼا ورځے وخت", "JST": "", "LHDT": "رب هاو د ورځے د رڼا وخت", "LHST": "", "MDT": "MDT", "MESZ": "مرکزي اروپايياوړي وخت", "MEZ": "د مرکزي اروپا معیاري وخت", "MST": "MST", "MVT": "مالديپ وخت", "MYT": "ملائیشیا وخت", "NDT": "د نوي فیلډلینډ رڼا ورځے وخت", "NPT": "نیپال وخت", "NST": "", "NZDT": "د نیوزی لینڈ د ورځے د رڼا وخت", "NZST": "", "OESZ": "ختيځ اروپايي اوړي وخت", "OEZ": "ختيځ اروپايي معياري وخت", "PDT": "پیسفک د رڼا ورځے وخت", "PKT": "پاکستان اوړي وخت", "PMDT": "سینټ پییرا و ميکلين رڼا ورځے وخت", "PMST": "", "PST": "", "PYST": "پاراګوای اوړي وخت", "SAST": "جنوبي افريقا معياري وخت", "SGT": "سنګاپور معیاري وخت", "SRT": "سورینام وخت", "TLT": "ختيځ تيمور وخت", "TMST": "ترکمنستان اوړي وخت", "TMT": "ترکمنستان معياري وخت", "UYST": "یوروګوای اوړي وخت", "UYT": "یوروګوای معياري وخت", "VET": "وینزویلا وخت", "WARST": "لوېديځ ارجنټاين اوړي وخت", "WART": "لوېديځ ارجنټاين معياري وخت", "WAST": "د افریقا افریقا لویدیځ وخت", "WAT": "لویدیځ افریقایي معیاري وخت", "WESZ": "د لودیځے اورپا د اوړي وخت", "WEZ": "د لودیځے اروپا معیاري وخت", "WIB": "لویدیځ اندونیزیا وخت", "WIT": "اندونیزیا وخت", "WITA": "مرکزي ادونيزيا وخت", "∅∅∅": "پیرو اوړي وخت"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"مياشتے", "%v مياشت", "%v مياشتے", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ورځے", "%v ورځ", "%v ورځے", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
...
// DateFullLayout returns the full date layout for 'ps_PK'
func (ps *ps_PK) DateFullLayout() string {
	return ps.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ps_PK'
func (ps *ps_PK) DateLongLayout() string {
	return ps.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ps_PK'
func (ps *ps_PK) DateMediumLayout() string {
	return ps.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ps_PK'
func (ps *ps_PK) DateShortLayout() string {
	return ps.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ps_PK'
func (ps *ps_PK) TimeFullLayout() string {
	return ps.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ps_PK'
func (ps *ps_PK) TimeLongLayout() string {
	return ps.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ps_PK'
func (ps *ps_PK) TimeMediumLayout() string {
	return ps.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ps_PK'
func (ps *ps_PK) TimeShortLayout() string {
	return ps.timeShortLayout
}

func (ps *ps_PK) ListPatterns() *locales.ListPatterns {
	return ps.listPatterns
}

func (ps *ps_PK) GetDurationSpec() *locales.DurationSpec {
	return ps.DurationSpec
}

func (ps *ps_PK) GetMiscPatterns() *locales.MiscPatterns {
