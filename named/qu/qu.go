...
// DateFullLayout returns the full date layout for 'qu'
func (qu *qu) DateFullLayout() string {
	return qu.dateFullLayout
}

// DateLongLayout returns the long date layout for 'qu'
func (qu *qu) DateLongLayout() string {
	return qu.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'qu'
func (qu *qu) DateMediumLayout() string {
	return qu.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'qu'
func (qu *qu) DateShortLayout() string {
	return qu.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'qu'
func (qu *qu) TimeFullLayout() string {
	return qu.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'qu'
func (qu *qu) TimeLongLayout() string {
	return qu.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'qu'
func (qu *qu) TimeMediumLayout() string {
	return qu.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'qu'
func (qu *qu) TimeShortLayout() string {
	return qu.timeShortLayout
}

func (qu *qu) ListPatterns() *locales.ListPatterns {
	return qu.listPatterns
}

func (qu *qu) GetDurationSpec() *locales.DurationSpec {
	return qu.DurationSpec
}

func (qu *qu) GetMiscPatterns() *locales.MiscPatterns {
