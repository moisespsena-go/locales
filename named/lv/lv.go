...
func New() locales.Translator {
	return &lv{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						...
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 mljrd'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 mljrd'.' ¤"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 mljrd'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 mljrd'.' ¤"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 mljrd'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 mljrd'.' ¤"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 trilj'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 trilj'.' ¤"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 trilj'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 trilj'.' ¤"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 trilj'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 trilj'.' ¤"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "janv.", "febr.", "marts", "apr.", "maijs", "jūn.", "jūl.", "aug.", "sept.", "okt.", "nov.", "dec."},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "janvāris", "februāris", "marts", "aprīlis", "maijs", "jūnijs", "jūlijs", "augusts", "septembris", "oktobris", "novembris", "decembris"},
			WeekdaysAbbreviatedValue: []string{"svētd.", "pirmd.", "otrd.", "trešd.", "ceturtd.", "piektd.", "sestd."},
			WeekdaysNarrowValue:      []string{"S", "P", "O", "T", "C", "P", "S"},
			WeekdaysShortValue:       []string{"Sv", "Pr", "Ot", "Tr", "Ce", "Pk", "Se"},
			WeekdaysWideValue:        []string{"svētdiena", "pirmdiena", "otrdiena", "trešdiena", "ceturtdiena", "piektdiena", "sestdiena"},
			PeriodsAbbreviatedValue:  []string{"priekšp.", "pēcp."},
			PeriodsNarrowValue:       []string{"priekšp.", "pēcp."},
			PeriodsWideValue:         []string{"priekšpusdienā", "pēcpusdienā"},
			ErasAbbreviatedValue:     []string{"p.m.ē.", "m.ē."},
			ErasNarrowValue:          []string{"p.m.ē.", "m.ē."},
			ErasWideValue:            []string{"pirms mūsu ēras", "mūsu ērā"},
			TimezonesValue:           map[string]string{"": "Paragvajas ziemas laiks", "ACDT": "Austrālijas centrālais vasaras laiks", "ACST": "Austrālijas centrālais ziemas laiks", "ACT": "ACT", "ACWDT": "Austrālijas centrālais rietumu vasaras laiks", "ACWST": "Austrālijas centrālais rietumu ziemas laiks", "ADT": "Atlantijas vasaras laiks", "AEDT": "Austrālijas austrumu vasaras laiks", "AEST": "Austrālijas austrumu ziemas laiks", "AFT": "Afganistānas laiks", "AKDT": "Aļaskas vasaras laiks", "AKST": "Aļaskas ziemas laiks", "AMST": "Amazones vasaras laiks", "AMT": "Amazones ziemas laiks", "ARST": "Argentīnas vasaras laiks", "ART": "Argentīnas ziemas laiks", "AST": "Atlantijas ziemas laiks", "AWDT": "Austrālijas rietumu vasaras laiks", "AWST": "Austrālijas rietumu ziemas laiks", "BNT": "Brunejas Darusalamas laiks", "BOT": "Bolīvijas laiks", "BRST": "Brazīlijas vasaras laiks", "BRT": "Brazīlijas ziemas laiks", "BST": "Bangladešas vasaras laiks", "BTT": "Butānas laiks", "CAT": "Centrālāfrikas laiks", "CCT": "Kokosu (Kīlinga) salu laiks", "CDT": "Centrālais vasaras laiks", "CDT (Kuba)": "Kubas vasaras laiks", "CHADT": "Četemas vasaras laiks", "CHAST": "Četemas ziemas laiks", "CLST": "Čīles vasaras laiks", "CLT": "Čīles ziemas laiks", "COST": "Kolumbijas vasaras laiks", "COT": "Kolumbijas ziemas laiks", "CST": "Centrālais ziemas laiks", "CST (Kuba)": "Kubas ziemas laiks", "CXT": "Ziemsvētku salas laiks", "ChST": "Čamorra ziemas laiks", "EASST": "Lieldienu salas vasaras laiks", "EAST": "Lieldienu salas ziemas laiks", "EAT": "Austrumāfrikas laiks", "ECT": "Ekvadoras laiks", "EDT": "Austrumu vasaras laiks", "EGDT": "Austrumgrenlandes vasaras laiks", "EGST": "Austrumgrenlandes ziemas laiks", "EST": "Austrumu ziemas laiks", "FKST": "Folklenda (Malvinu) salu vasaras laiks", "GALT": "Galapagu laiks", "GFT": "Francijas Gviānas laiks", "GMT": "Griničas laiks", "GST": "Persijas līča laiks", "GYT": "Gajānas laiks", "HADT": "Havaju–Aleutu vasaras laiks", "HAST": "Havaju–Aleutu ziemas laiks", "HENOMX": "Ziemeļrietumu Meksikas vasaras laiks", "HEOG": "Rietumgrenlandes vasaras laiks", "HEPMX": "Meksikas Klusā okeāna piekrastes vasaras laiks", "HKST": "Honkongas vasaras laiks", "HKT": "Honkongas ziemas laiks", "HNNOMX": "Ziemeļrietumu Meksikas ziemas laiks", "HNOG": "Rietumgrenlandes ziemas laiks", "HNPMX": "Meksikas Klusā okeāna piekrastes ziemas laiks", "ICT": "Indoķīnas laiks", "IRDT": "Irānas vasaras laiks", "IRST": "Irānas ziemas laiks", "IST": "Indijas ziemas laiks", "JDT": "Japānas vasaras laiks", "JST": "Japānas ziemas laiks", "LHDT": "Lorda Hava salas vasaras laiks", "LHST": "Lorda Hava salas ziemas laiks", "MDT": "Kalnu vasaras laiks", "MESZ": "Centrāleiropas vasaras laiks", "MEZ": "Centrāleiropas ziemas laiks", "MST": "Kalnu ziemas laiks", "MVT": "Maldīvijas laiks", "MYT": "Malaizijas laiks", "NDT": "Ņūfaundlendas vasaras laiks", "NPT": "Nepālas laiks", "NST": "Ņūfaundlendas ziemas laiks", "NZDT": "Jaunzēlandes vasaras laiks", "NZST": "Jaunzēlandes ziemas laiks", "OESZ": "Austrumeiropas vasaras laiks", "OEZ": "Austrumeiropas ziemas laiks", "PDT": "Klusā okeāna vasaras laiks", "PKT": "Pakistānas vasaras laiks", "PMDT": "Senpjēras un Mikelonas vasaras laiks", "PMST": "Senpjēras un Mikelonas ziemas laiks", "PST": "Klusā okeāna ziemas laiks", "PYST": "Paragvajas vasaras laiks", "SAST": "Dienvidāfrikas ziemas laiks", "SGT": "Singapūras laiks", "SRT": "Surinamas laiks", "TLT": "Austrumtimoras laiks", "TMST": "Turkmenistānas vasaras laiks", "TMT": "Turkmenistānas ziemas laiks", "UYST": "Urugvajas vasaras laiks", "UYT": "Urugvajas ziemas laiks", "VET": "Venecuēlas laiks", "WARST": "Rietumargentīnas vasaras laiks", "WART": "Rietumargentīnas ziemas laiks", "WAST": "Rietumāfrikas vasaras laiks", "WAT": "Rietumāfrikas ziemas laiks", "WESZ": "Rietumeiropas vasaras laiks", "WEZ": "Rietumeiropas ziemas laiks", "WIB": "Rietumindonēzijas laiks", "WIT": "Austrumindonēzijas laiks", "WITA": "Centrālindonēzijas laiks", "∅∅∅": "Peru vasaras laiks"},
		},
		...
		dateFullLayout:   "EEEE, y. 'gada' d. MMMM",
		dateLongLayout:   "y. 'gada' d. MMMM",
		dateMediumLayout: "y. 'gada' d. MMM",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} un {1}", "{0}, {1}", "{0}, {1}", "{0} un {1}"}, {"{0} vai {1}", "{0}, {1}", "{0}, {1}", "{0} vai {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"gs.", "%v gs.", "%v gs.", ""},
				Long:   &locales.CounterFormat{"gadsimti", "%v gadsimtā", "%v gadsimtos", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v dek", "%v dek", ""},
				Long:   &locales.CounterFormat{"dekādes", "%v dekādē", "%v dekādēs", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"g.", "%v g.", "%v g.", "%v/g."},
				Long:   &locales.CounterFormat{"gadi", "%v gadā", "%v gados", "%v gadā"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mēn.", "%v m.", "%v m.", "%v/m."},
				Long:   &locales.CounterFormat{"mēneši", "%v mēnesī", "%v mēnešos", "%v mēnesī"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"n.", "%v n.", "%v n.", "%v/n."},
				Long:   &locales.CounterFormat{"nedēļas", "%v nedēļā", "%v nedēļās", "%v nedēļā"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"stundas", "%v stundā", "%v stundās", "%v stundā"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%v min", "%v min", "%v/min"},
				Long:   &locales.CounterFormat{"minūtes", "%v minūtē", "%v minūtēs", "%v minūtē"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%v s", "%v s", "%v/s"},
				Long:   &locales.CounterFormat{"sekundes", "%v sekundē", "%v sekundēs", "%v sekundē"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"milisekundes", "%v milisekundē", "%v milisekundēs", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"mikrosekundes", "%v mikrosekundē", "%v mikrosekundēs", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosekundes", "%v nanosekundē", "%v nanosekundēs", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"≥%[1]v",
...
func (lv *lv) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(lv, lv.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'lv'
func (lv *lv) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(lv, lv.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'lv'
func (lv *lv) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(lv, lv.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'lv'
func (lv *lv) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(lv, lv.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'lv'
func (lv *lv) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(lv, lv.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'lv'
func (lv *lv) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(lv, lv.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'lv'
func (lv *lv) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(lv, lv.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'lv'
func (lv *lv) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(lv, lv.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'lv'
func (lv *lv) DateFullLayout() string {
	return lv.dateFullLayout
}

// DateLongLayout returns the long date layout for 'lv'
func (lv *lv) DateLongLayout() string {
	return lv.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'lv'
func (lv *lv) DateMediumLayout() string {
	return lv.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'lv'
func (lv *lv) DateShortLayout() string {
	return lv.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'lv'
func (lv *lv) TimeFullLayout() string {
	return lv.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'lv'
func (lv *lv) TimeLongLayout() string {
	return lv.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'lv'
func (lv *lv) TimeMediumLayout() string {
	return lv.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'lv'
func (lv *lv) TimeShortLayout() string {
	return lv.timeShortLayout
}

func (lv *lv) ListPatterns() *locales.ListPatterns {
	return lv.listPatterns
}

func (lv *lv) GetDurationSpec() *locales.DurationSpec {
	return lv.DurationSpec
}

func (lv *lv) GetMiscPatterns() *locales.MiscPatterns {
	return &lv.miscPatterns
}
