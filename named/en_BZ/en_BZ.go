...
// DateFullLayout returns the full date layout for 'en_BZ'
func (en *en_BZ) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_BZ'
func (en *en_BZ) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_BZ'
func (en *en_BZ) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_BZ'
func (en *en_BZ) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_BZ'
func (en *en_BZ) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_BZ'
func (en *en_BZ) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_BZ'
func (en *en_BZ) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_BZ'
func (en *en_BZ) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_BZ) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_BZ) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_BZ) GetMiscPatterns() *locales.MiscPatterns {
