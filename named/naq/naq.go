...
// DateFullLayout returns the full date layout for 'naq'
func (naq *naq) DateFullLayout() string {
	return naq.dateFullLayout
}

// DateLongLayout returns the long date layout for 'naq'
func (naq *naq) DateLongLayout() string {
	return naq.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'naq'
func (naq *naq) DateMediumLayout() string {
	return naq.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'naq'
func (naq *naq) DateShortLayout() string {
	return naq.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'naq'
func (naq *naq) TimeFullLayout() string {
	return naq.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'naq'
func (naq *naq) TimeLongLayout() string {
	return naq.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'naq'
func (naq *naq) TimeMediumLayout() string {
	return naq.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'naq'
func (naq *naq) TimeShortLayout() string {
	return naq.timeShortLayout
}

func (naq *naq) ListPatterns() *locales.ListPatterns {
	return naq.listPatterns
}

func (naq *naq) GetDurationSpec() *locales.DurationSpec {
	return naq.DurationSpec
}

func (naq *naq) GetMiscPatterns() *locales.MiscPatterns {
