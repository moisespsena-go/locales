...
// DateFullLayout returns the full date layout for 'luo'
func (luo *luo) DateFullLayout() string {
	return luo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'luo'
func (luo *luo) DateLongLayout() string {
	return luo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'luo'
func (luo *luo) DateMediumLayout() string {
	return luo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'luo'
func (luo *luo) DateShortLayout() string {
	return luo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'luo'
func (luo *luo) TimeFullLayout() string {
	return luo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'luo'
func (luo *luo) TimeLongLayout() string {
	return luo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'luo'
func (luo *luo) TimeMediumLayout() string {
	return luo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'luo'
func (luo *luo) TimeShortLayout() string {
	return luo.timeShortLayout
}

func (luo *luo) ListPatterns() *locales.ListPatterns {
	return luo.listPatterns
}

func (luo *luo) GetDurationSpec() *locales.DurationSpec {
	return luo.DurationSpec
}

func (luo *luo) GetMiscPatterns() *locales.MiscPatterns {
