...
// DateFullLayout returns the full date layout for 'en_PW'
func (en *en_PW) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_PW'
func (en *en_PW) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_PW'
func (en *en_PW) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_PW'
func (en *en_PW) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_PW'
func (en *en_PW) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_PW'
func (en *en_PW) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_PW'
func (en *en_PW) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_PW'
func (en *en_PW) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_PW) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_PW) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_PW) GetMiscPatterns() *locales.MiscPatterns {
