...
// DateFullLayout returns the full date layout for 'wo'
func (wo *wo) DateFullLayout() string {
	return wo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'wo'
func (wo *wo) DateLongLayout() string {
	return wo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'wo'
func (wo *wo) DateMediumLayout() string {
	return wo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'wo'
func (wo *wo) DateShortLayout() string {
	return wo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'wo'
func (wo *wo) TimeFullLayout() string {
	return wo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'wo'
func (wo *wo) TimeLongLayout() string {
	return wo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'wo'
func (wo *wo) TimeMediumLayout() string {
	return wo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'wo'
func (wo *wo) TimeShortLayout() string {
	return wo.timeShortLayout
}

func (wo *wo) ListPatterns() *locales.ListPatterns {
	return wo.listPatterns
}

func (wo *wo) GetDurationSpec() *locales.DurationSpec {
	return wo.DurationSpec
}

func (wo *wo) GetMiscPatterns() *locales.MiscPatterns {
