	...
	return &kab{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"tasutin", "%v n tasut", "%v n tasutin", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mrw", "%v mrw", "%v mrw", ""},
				Long:   &locales.CounterFormat{"timerwatin", "%v n tmerwa", "%v n tmerwatin", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sg", "%vg", "%vg", ""},
				Long:   &locales.CounterFormat{"iseggasen", "%v n useggas", "%v n yiseggasen", "%v i useggas"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ayyur", "%vy", "%vy", ""},
				Long:   &locales.CounterFormat{"", "%v n wayyur", "%v n wayyuren", "%v i wayyur"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ml", "%vm", "%vm", ""},
				Long:   &locales.CounterFormat{"imalasen", "%v n yimalas", "%v n yimalasen", "%v i yimalas"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ass", "%vs", "%vs", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"asrag", "%vr", "%vr", ""},
				Long:   &locales.CounterFormat{"isragen", "%v n usrag", "%v n yisragen", "%v i usrag"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"tsd", "%vd", "%vd", ""},
				Long:   &locales.CounterFormat{"tisdatin", "%v n tesdat", "%v n tesdatin", "%v i tesdat"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"tsn", "%vn", "%vn", ""},
				Long:   &locales.CounterFormat{"tisinin", "%v n tsint", "%v n tsinin", "%v i tsint"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mtsn", "%v mn", "%v mn", ""},
				Long:   &locales.CounterFormat{"timilisinin", "%v n tmilisint", "%v n tmilisinin", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μtsn", "%v μn", "%v μn", ""},
				Long:   &locales.CounterFormat{"timikrusinin", "%v n tmikrusint", "%v n tmikrusinin", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"nanutsn", "%v nn", "%v nn", ""},
				Long:   &locales.CounterFormat{"tinanusinin", "%v n tnanusint", "%v n tnanusinin", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"",
			"%[1]v+",
...
// DateFullLayout returns the full date layout for 'kab'
func (kab *kab) DateFullLayout() string {
	return kab.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kab'
func (kab *kab) DateLongLayout() string {
	return kab.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kab'
func (kab *kab) DateMediumLayout() string {
	return kab.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kab'
func (kab *kab) DateShortLayout() string {
	return kab.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kab'
func (kab *kab) TimeFullLayout() string {
	return kab.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kab'
func (kab *kab) TimeLongLayout() string {
	return kab.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kab'
func (kab *kab) TimeMediumLayout() string {
	return kab.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kab'
func (kab *kab) TimeShortLayout() string {
	return kab.timeShortLayout
}

func (kab *kab) ListPatterns() *locales.ListPatterns {
	return kab.listPatterns
}

func (kab *kab) GetDurationSpec() *locales.DurationSpec {
	return kab.DurationSpec
}

func (kab *kab) GetMiscPatterns() *locales.MiscPatterns {
