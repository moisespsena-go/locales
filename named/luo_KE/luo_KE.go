...
func New() locales.Translator {
	return &luo_KE{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "DAC", "DAR", "DAD", "DAN", "DAH", "DAU", "DAO", "DAB", "DOC", "DAP", "DGI", "DAG"},
			MonthsNarrowValue:        []string{"", "C", "R", "D", "N", "B", "U", "B", "B", "C", "P", "C", "P"},
			MonthsWideValue:          []string{"", "Dwe mar Achiel", "Dwe mar Ariyo", "Dwe mar Adek", "Dwe mar Ang’wen", "Dwe mar Abich", "Dwe mar Auchiel", "Dwe mar Abiriyo", "Dwe mar Aboro", "Dwe mar Ochiko", "Dwe mar Apar", "Dwe mar gi achiel", "Dwe mar Apar gi ariyo"},
			WeekdaysAbbreviatedValue: []string{"JMP", "WUT", "TAR", "TAD", "TAN", "TAB", "NGS"},
			WeekdaysNarrowValue:      []string{"J", "W", "T", "T", "T", "T", "N"},
			WeekdaysWideValue:        []string{"Jumapil", "Wuok Tich", "Tich Ariyo", "Tich Adek", "Tich Ang’wen", "Tich Abich", "Ngeso"},
			PeriodsAbbreviatedValue:  []string{"OD", "OT"},
			PeriodsWideValue:         []string{"OD", "OT"},
			ErasAbbreviatedValue:     []string{"BC", "AD"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Kapok Kristo obiro", "Ka Kristo osebiro"},
...
func (luo *luo_KE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(luo, luo.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'luo_KE'
func (luo *luo_KE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(luo, luo.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'luo_KE'
func (luo *luo_KE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(luo, luo.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'luo_KE'
func (luo *luo_KE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(luo, luo.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'luo_KE'
func (luo *luo_KE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(luo, luo.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'luo_KE'
func (luo *luo_KE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(luo, luo.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'luo_KE'
func (luo *luo_KE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(luo, luo.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'luo_KE'
func (luo *luo_KE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(luo, luo.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'luo_KE'
func (luo *luo_KE) DateFullLayout() string {
	return luo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'luo_KE'
func (luo *luo_KE) DateLongLayout() string {
	return luo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'luo_KE'
func (luo *luo_KE) DateMediumLayout() string {
	return luo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'luo_KE'
func (luo *luo_KE) DateShortLayout() string {
	return luo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'luo_KE'
func (luo *luo_KE) TimeFullLayout() string {
	return luo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'luo_KE'
func (luo *luo_KE) TimeLongLayout() string {
	return luo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'luo_KE'
func (luo *luo_KE) TimeMediumLayout() string {
	return luo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'luo_KE'
func (luo *luo_KE) TimeShortLayout() string {
	return luo.timeShortLayout
}

func (luo *luo_KE) ListPatterns() *locales.ListPatterns {
	return luo.listPatterns
}

func (luo *luo_KE) GetDurationSpec() *locales.DurationSpec {
	return luo.DurationSpec
}

func (luo *luo_KE) GetMiscPatterns() *locales.MiscPatterns {
	return &luo.miscPatterns
}
