...
// DateFullLayout returns the full date layout for 'mfe'
func (mfe *mfe) DateFullLayout() string {
	return mfe.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mfe'
func (mfe *mfe) DateLongLayout() string {
	return mfe.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mfe'
func (mfe *mfe) DateMediumLayout() string {
	return mfe.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mfe'
func (mfe *mfe) DateShortLayout() string {
	return mfe.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mfe'
func (mfe *mfe) TimeFullLayout() string {
	return mfe.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mfe'
func (mfe *mfe) TimeLongLayout() string {
	return mfe.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mfe'
func (mfe *mfe) TimeMediumLayout() string {
	return mfe.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mfe'
func (mfe *mfe) TimeShortLayout() string {
	return mfe.timeShortLayout
}

func (mfe *mfe) ListPatterns() *locales.ListPatterns {
	return mfe.listPatterns
}

func (mfe *mfe) GetDurationSpec() *locales.DurationSpec {
	return mfe.DurationSpec
}

func (mfe *mfe) GetMiscPatterns() *locales.MiscPatterns {
