...
func New() locales.Translator {
	return &de_AT{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jän.", "Feb.", "März", "Apr.", "Mai", "Juni", "Juli", "Aug.", "Sep.", "Okt.", "Nov.", "Dez."},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Jänner", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"},
			...
			PeriodsNarrowValue:       []string{"vm.", "nm."},
...
// DateFullLayout returns the full date layout for 'de_AT'
func (de *de_AT) DateFullLayout() string {
	return de.dateFullLayout
}

// DateLongLayout returns the long date layout for 'de_AT'
func (de *de_AT) DateLongLayout() string {
	return de.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'de_AT'
func (de *de_AT) DateMediumLayout() string {
	return de.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'de_AT'
func (de *de_AT) DateShortLayout() string {
	return de.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'de_AT'
func (de *de_AT) TimeFullLayout() string {
	return de.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'de_AT'
func (de *de_AT) TimeLongLayout() string {
	return de.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'de_AT'
func (de *de_AT) TimeMediumLayout() string {
	return de.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'de_AT'
func (de *de_AT) TimeShortLayout() string {
	return de.timeShortLayout
}

func (de *de_AT) ListPatterns() *locales.ListPatterns {
	return de.listPatterns
}

func (de *de_AT) GetDurationSpec() *locales.DurationSpec {
	return de.DurationSpec
}

func (de *de_AT) GetMiscPatterns() *locales.MiscPatterns {
