...
// DateFullLayout returns the full date layout for 'ff_Latn_GM'
func (ff *ff_Latn_GM) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff_Latn_GM'
func (ff *ff_Latn_GM) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff_Latn_GM'
func (ff *ff_Latn_GM) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff_Latn_GM'
func (ff *ff_Latn_GM) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff_Latn_GM'
func (ff *ff_Latn_GM) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff_Latn_GM'
func (ff *ff_Latn_GM) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff_Latn_GM'
func (ff *ff_Latn_GM) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff_Latn_GM'
func (ff *ff_Latn_GM) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff_Latn_GM) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff_Latn_GM) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff_Latn_GM) GetMiscPatterns() *locales.MiscPatterns {
