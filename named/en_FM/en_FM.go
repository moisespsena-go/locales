...
// DateFullLayout returns the full date layout for 'en_FM'
func (en *en_FM) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_FM'
func (en *en_FM) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_FM'
func (en *en_FM) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_FM'
func (en *en_FM) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_FM'
func (en *en_FM) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_FM'
func (en *en_FM) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_FM'
func (en *en_FM) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_FM'
func (en *en_FM) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_FM) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_FM) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_FM) GetMiscPatterns() *locales.MiscPatterns {
