...
func New() locales.Translator {
	return &mgh_MZ{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Kwa", "Una", "Rar", "Che", "Tha", "Moc", "Sab", "Nan", "Tis", "Kum", "Moj", "Yel"},
			MonthsNarrowValue:        []string{"", "K", "U", "R", "C", "T", "M", "S", "N", "T", "K", "M", "Y"},
			MonthsWideValue:          []string{"", "Mweri wo kwanza", "Mweri wo unayeli", "Mweri wo uneraru", "Mweri wo unecheshe", "Mweri wo unethanu", "Mweri wo thanu na mocha", "Mweri wo saba", "Mweri wo nane", "Mweri wo tisa", "Mweri wo kumi", "Mweri wo kumi na moja", "Mweri wo kumi na yel’li"},
			WeekdaysAbbreviatedValue: []string{"Sab", "Jtt", "Jnn", "Jtn", "Ara", "Iju", "Jmo"},
			WeekdaysNarrowValue:      []string{"S", "J", "J", "J", "A", "I", "J"},
			WeekdaysWideValue:        []string{"Sabato", "Jumatatu", "Jumanne", "Jumatano", "Arahamisi", "Ijumaa", "Jumamosi"},
			PeriodsAbbreviatedValue:  []string{"wichishu", "mchochil’l"},
			PeriodsWideValue:         []string{"wichishu", "mchochil’l"},
			ErasAbbreviatedValue:     []string{"HY", "YY"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Hinapiya yesu", "Yopia yesu"},
...
func (mgh *mgh_MZ) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(mgh, mgh.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'mgh_MZ'
func (mgh *mgh_MZ) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(mgh, mgh.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'mgh_MZ'
func (mgh *mgh_MZ) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(mgh, mgh.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'mgh_MZ'
func (mgh *mgh_MZ) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(mgh, mgh.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'mgh_MZ'
func (mgh *mgh_MZ) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(mgh, mgh.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'mgh_MZ'
func (mgh *mgh_MZ) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(mgh, mgh.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'mgh_MZ'
func (mgh *mgh_MZ) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(mgh, mgh.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'mgh_MZ'
func (mgh *mgh_MZ) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(mgh, mgh.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'mgh_MZ'
func (mgh *mgh_MZ) DateFullLayout() string {
	return mgh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mgh_MZ'
func (mgh *mgh_MZ) DateLongLayout() string {
	return mgh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mgh_MZ'
func (mgh *mgh_MZ) DateMediumLayout() string {
	return mgh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mgh_MZ'
func (mgh *mgh_MZ) DateShortLayout() string {
	return mgh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mgh_MZ'
func (mgh *mgh_MZ) TimeFullLayout() string {
	return mgh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mgh_MZ'
func (mgh *mgh_MZ) TimeLongLayout() string {
	return mgh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mgh_MZ'
func (mgh *mgh_MZ) TimeMediumLayout() string {
	return mgh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mgh_MZ'
func (mgh *mgh_MZ) TimeShortLayout() string {
	return mgh.timeShortLayout
}

func (mgh *mgh_MZ) ListPatterns() *locales.ListPatterns {
	return mgh.listPatterns
}

func (mgh *mgh_MZ) GetDurationSpec() *locales.DurationSpec {
	return mgh.DurationSpec
}

func (mgh *mgh_MZ) GetMiscPatterns() *locales.MiscPatterns {
	return &mgh.miscPatterns
}
