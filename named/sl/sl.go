...
func New() locales.Translator {
	return &sl{
		...
		TimeSpec: &locales.TimeSpec{
			...
			MonthsWideValue:          []string{"", "januar", "februar", "marec", "april", "maj", "junij", "julij", "avgust", "september", "oktober", "november", "december"},
			WeekdaysAbbreviatedValue: []string{"ned.", "pon.", "tor.", "sre.", "čet.", "pet.", "sob."},
			WeekdaysNarrowValue:      []string{"n", "p", "t", "s", "č", "p", "s"},
			WeekdaysShortValue:       []string{"ned.", "pon.", "tor.", "sre.", "čet.", "pet.", "sob."},
			WeekdaysWideValue:        []string{"nedelja", "ponedeljek", "torek", "sreda", "četrtek", "petek", "sobota"},
			PeriodsAbbreviatedValue:  []string{"dop.", "pop."},
			PeriodsNarrowValue:       []string{"d", "p"},
			PeriodsWideValue:         []string{"dop.", "pop."},
			ErasAbbreviatedValue:     []string{"pr. Kr.", "po Kr."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"pred Kristusom", "po Kristusu"},
			TimezonesValue:           map[string]string{"": "Standardni čas: Falklandsko otočje", "ACDT": "Avstralski centralni poletni čas", "ACST": "ACST", "ACT": "ACT", "ACWDT": "Avstralski centralni zahodni poletni čas", "ACWST": "Avstralski centralni zahodni standardni čas", "ADT": "Atlantski poletni čas", "AEDT": "Avstralski vzhodni poletni čas", "AEST": "Avstralski vzhodni standardni čas", "AFT": "Afganistanski čas", "AKDT": "Aljaški poletni čas", "AKST": "Aljaški standardni čas", "AMST": "Amazonski poletni čas", "AMT": "Amazonski standardni čas", "ARST": "Argentinski poletni čas", "ART": "Argentinski standardni čas", "AST": "Atlantski standardni čas", "AWDT": "Avstralski zahodni poletni čas", "AWST": "Avstralski zahodni standardni čas", "BNT": "Brunejski čas", "BOT": "Bolivijski čas", "BRST": "Brasilski poletni čas", "BRT": "Brasilski standardni čas", "BST": "Bangladeški poletni čas", "BTT": "Butanski čas", "CAT": "Centralnoafriški čas", "CCT": "Čas: Kokosovi otoki", "CDT": "Centralni poletni čas", "CDT (Kuba)": "Kubanski poletni čas", "CHADT": "Čatamski poletni čas", "CHAST": "Čatamski standardni čas", "CLST": "Čilski poletni čas", "CLT": "Čilski standardni čas", "COST": "Kolumbijski poletni čas", "COT": "Kolumbijski standardni čas", "CST": "Centralni standardni čas", "CST (Kuba)": "Kubanski standardni čas", "CXT": "Božičnootoški čas", "ChST": "Čamorski standardni čas", "EASST": "Poletni čas: Velikonočni otok", "EAST": "Standardni čas: Velikonočni otok", "EAT": "Vzhodnoafriški čas", "ECT": "Ekvadorski čas", "EDT": "Vzhodni poletni čas", "EGDT": "Vzhodnogrenlandski poletni čas", "EGST": "Vzhodnogrenlandski standardni čas", "EST": "Vzhodni standardni čas", "FKST": "Poletni čas: Falklandsko otočje", "GALT": "Galapaški čas", "GFT": "Čas: Francoska Gvajana", "GMT": "Greenwiški srednji čas", "GST": "Zalivski standardni čas", "GYT": "Gvajanski čas", "HADT": "Havajski aleutski poletni čas", "HAST": "Havajski aleutski standardni čas", "HENOMX": "Mehiški severozahodni poletni čas", "HEOG": "Zahodnogrenlandski poletni čas", "HEPMX": "Mehiški pacifiški poletni čas", "HKST": "Hongkonški poletni čas", "HKT": "Hongkonški standardni čas", "HNNOMX": "Mehiški severozahodni standardni čas", "HNOG": "Zahodnogrenlandski standardni čas", "HNPMX": "Mehiški pacifiški standardni čas", "ICT": "Indokitajski čas", "IRDT": "Iranski poletni čas", "IRST": "Iranski standardni čas", "IST": "Indijski standardni čas", "JDT": "Japonski poletni čas", "JST": "Japonski standardni čas", "LHDT": "Poletni čas otoka Lord Howe", "LHST": "Standardni čas otoka Lord Howe", "MDT": "MDT", "MESZ": "Srednjeevropski poletni čas", "MEZ": "Srednjeevropski standardni čas", "MST": "MST", "MVT": "Maldivski čas", "MYT": "Malezijski čas", "NDT": "Novofundlandski poletni čas", "NPT": "Nepalski čas", "NST": "Novofundlandski standardni čas", "NZDT": "Novozelandski poletni čas", "NZST": "Novozelandski standardni čas", "OESZ": "Vzhodnoevropski poletni čas", "OEZ": "Vzhodnoevropski standardni čas", "PDT": "Pacifiški poletni čas", "PKT": "Pakistanski poletni čas", "PMDT": "Poletni čas: Saint Pierre in Miquelon", "PMST": "Standardni čas: Saint Pierre in Miquelon", "PST": "Pacifiški standardni čas", "PYST": "Paragvajski poletni čas", "SAST": "Južnoafriški čas", "SGT": "Singapurski standardni čas", "SRT": "Surinamski čas", "TLT": "Vzhodnotimorski čas", "TMST": "Turkmenistanski poletni čas", "TMT": "Turkmenistanski standardni čas", "UYST": "Urugvajski poletni čas", "UYT": "Urugvajski standardni čas", "VET": "Venezuelski čas", "WARST": "Argentinski zahodni poletni čas", "WART": "Argentinski zahodni standardni čas", "WAST": "Zahodnoafriški poletni čas", "WAT": "Zahodnoafriški standardni čas", "WESZ": "Zahodnoevropski poletni čas", "WEZ": "Zahodnoevropski standardni čas", "WIB": "Indonezijski zahodni čas", "WIT": "Indonezijski vzhodni čas", "WITA": "Indonezijski osrednji čas", "∅∅∅": "Perujski poletni čas"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} in {1}", "{0}, {1}", "{0}, {1}", "{0} in {1}"}, {"{0} ali {1}", "{0}, {1}", "{0}, {1}", "{0} ali {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"stoletja", "%v stoletju", "%v stoletjih", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dek.", "%v dek.", "%v dek.", ""},
				Long:   &locales.CounterFormat{"dekade", "%v dekadi", "%v dekadah", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"let", "%v l", "%v l", "%v/l"},
				Long:   &locales.CounterFormat{"leta", "%v letu", "%v letih", "%v na leto"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mesecev", "%v m", "%v m", ""},
				Long:   &locales.CounterFormat{"meseci", "%v mesecu", "%v mesecih", "%v na mesec"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"tednov", "%v t", "%v t", "%v/t"},
				Long:   &locales.CounterFormat{"tedni", "%v tednu", "%v tednih", "%v na teden"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dni", "%v d", "%v d", "%v/dan."}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ur", "%v h", "%v h", ""},
				Long:   &locales.CounterFormat{"", "%v uri", "%v urah", "%v na uro"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v min", "%v min", ""},
				Long:   &locales.CounterFormat{"minute", "%v minuti", "%v minutah", "%v na minuto"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%v s", "%v s", ""},
				Long:   &locales.CounterFormat{"sekunde", "%v sekundi", "%v sekundah", "%v na sekundo"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"milisekunde", "%v milisekundi", "%v milisekundah", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"mikrosekunde", "%v mikrosekundi", "%v mikrosekundah", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosekunde", "%v nanosekundi", "%v nanosekundah", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~ %[1]v",
			"≥ %[1]v",
...
func (sl *sl) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(sl, sl.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'sl'
func (sl *sl) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(sl, sl.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'sl'
func (sl *sl) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(sl, sl.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'sl'
func (sl *sl) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(sl, sl.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'sl'
func (sl *sl) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(sl, sl.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'sl'
func (sl *sl) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(sl, sl.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'sl'
func (sl *sl) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(sl, sl.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'sl'
func (sl *sl) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(sl, sl.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'sl'
func (sl *sl) DateFullLayout() string {
	return sl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sl'
func (sl *sl) DateLongLayout() string {
	return sl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sl'
func (sl *sl) DateMediumLayout() string {
	return sl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sl'
func (sl *sl) DateShortLayout() string {
	return sl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sl'
func (sl *sl) TimeFullLayout() string {
	return sl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sl'
func (sl *sl) TimeLongLayout() string {
	return sl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sl'
func (sl *sl) TimeMediumLayout() string {
	return sl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sl'
func (sl *sl) TimeShortLayout() string {
	return sl.timeShortLayout
}

func (sl *sl) ListPatterns() *locales.ListPatterns {
	return sl.listPatterns
}

func (sl *sl) GetDurationSpec() *locales.DurationSpec {
	return sl.DurationSpec
}

func (sl *sl) GetMiscPatterns() *locales.MiscPatterns {
	return &sl.miscPatterns
}
