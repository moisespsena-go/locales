...
// DateFullLayout returns the full date layout for 'es_GQ'
func (es *es_GQ) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_GQ'
func (es *es_GQ) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_GQ'
func (es *es_GQ) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_GQ'
func (es *es_GQ) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_GQ'
func (es *es_GQ) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_GQ'
func (es *es_GQ) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_GQ'
func (es *es_GQ) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_GQ'
func (es *es_GQ) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_GQ) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_GQ) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_GQ) GetMiscPatterns() *locales.MiscPatterns {
