...
// New returns a new instance of translator for the 'yrl' locale
func New() locales.Translator {
	return &yrl{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 0 miu"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 0 miu"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 00 miu"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 00 miu"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 000 miu"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 000 miu"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 0 mi"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 0 mi"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 00 mi"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 00 mi"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 000 mi"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 000 mi"),
						}},
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 0 bi"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 0 bi"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 00 bi"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 00 bi"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 000 bi"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 000 bi"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 0 tiri"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 0 tiri"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 00 tiri"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 00 tiri"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 000 tiri"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 000 tiri"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ye", "mk", "ms", "id", "pu", "py", "pm", "ps", "pi", "yp", "yy", "ym"},
			MonthsNarrowValue:        []string{"", "Y", "M", "M", "I", "P", "P", "P", "P", "P", "Y", "Y", "Y"},
			MonthsWideValue:          []string{"", "yepé", "mukũi", "musapíri", "irũdí", "pú", "pú-yepé", "pú-mukũi", "pú-musapíri", "pú-irũdí", "yepé-putimaã", "yepé-yepé", "yepé-mukũi"},
			WeekdaysAbbreviatedValue: []string{"mit", "mur", "mmk", "mms", "sup", "yuk", "sau"},
			WeekdaysNarrowValue:      []string{"M", "M", "M", "M", "S", "Y", "S"},
			WeekdaysWideValue:        []string{"mituú", "murakipí", "murakí-mukũi", "murakí-musapíri", "supapá", "yukuakú", "saurú"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsNarrowValue:       []string{"AM", "PM"},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"K.s.", "K.a."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Kiristu senũdé", "Kiristu ariré"},
			TimezonesValue:           map[string]string{"": "Kapuã-ita Mawina Hurariyu Retewa", "ACDT": "Ausitaraliya Piterawara Kurasí Ara Hurariyu", "ACST": "Ausitaraliya Piterawara Hurariyu Retewa", "ACT": "Hurariyu Retewa Acre yara", "ACWDT": "Ausitaraliya Piterawara-Usidẽtawara Kurasí Ara Hurariyu", "ACWST": "Ausitaraliya Piterawara-Usidẽtawara Hurariyu Retewa", "ADT": "Atalãtku Kurasí Ara Hurariyu", "AEDT": "Ausitaraliya Uriẽtawara Kurasí Ara Hurariyu", "AEST": "Ausitaraliya Uriẽtawara Hurariyu Retewa", "AFT": "Afegãniretãma Hurariyu", "AKDT": "Alasika Kurasí Ara Hurariyu", "AKST": "Alasika Hurariyu Eté", "AMST": "Amasuna Kurasí Ara Hurariyu", "AMT": "Amasuna Hurariyu Eté", "ARST": "Argẽtina Kurasí Ara Hurariyu", "ART": "Argẽtina Hurariyu Retewa", "AST": "Atalãtiku Hurariyu Retewa", "AWDT": "Ausitaraliya Usidẽtawara Kurasí Ara Hurariyu", "AWST": "Ausitaraliya Usidẽtawara Hurariyu Retewa", "BNT": "Burunei Darusaram Hurariyu", "BOT": "Buríwia Hurariyu", "BRST": "Rỹ Kã Óra Brasília tá", "BRT": "Óra Pã Brasília tá", "BST": "Bãkaradexi Kurasí Ara Horariyu", "BTT": "Butãu Hurariyu", "CAT": "Afirika Piterawara Hurariyu", "CCT": "Kapuã-ita Kuku-ita Hurariyu", "CDT": "Hurariyu Kurasí Ara Piterawara", "CDT (Kuba)": "Kuba Kurasí Ara Hurariyu", "CHADT": "Xatham Kurasí Ara Hurariyu", "CHAST": "Xatham Hurariyu Retewa", "CLST": "Xiri Kurasí Ara Hurariyu", "CLT": "Xiri Hurariyu Retewa", "COST": "Kurũbia Kurasí Ara Hurariyu", "COT": "Kurũbia Hurariyu Retewa", "CST": "Hurariyu Retewa Piterawara", "CST (Kuba)": "Kuba Hurariyu Retewa", "CXT": "KapuãmaKiritima Hurariyu", "ChST": "Xamoro Hurariyu", "EASST": "Pasikuwa Kapuãma Kurasí Ara Hurariyu", "EAST": "Pasikuwa Kapuãma Hurariyu Retewa", "EAT": "Afirika Uriẽtawara Hurariyu", "ECT": "Ekuadú Hurariyu", "EDT": "Hurariyu Kurasí Ara Lesiti", "EGDT": "Guruẽrãdiya Uriẽtawara Kurasí Ara Hurariyu", "EGST": "Guruẽrãdiya Uriẽtawara Hurariyu Retewa", "EST": "Hurariyu Retewa Lesiti yara", "FKST": "Kapuã-ita Mawina Kurasí Ara Hurariyu", "GALT": "Garapagu-ita Hurariyu", "GFT": "Giyana Frãsa yara Hurariyu", "GMT": "Greenwich Miridiyanu yara Hurariyu", "GST": "Golfo Hurariyu", "GYT": "Giyana Hurariyu", "HADT": "Hawaí asuí Kapuã-ita Areuta-ita Kurasí Ara Hurariyu", "HAST": "Hawaí asuí Kapuã-ita Areuta-ita Hurariyu Retewa", "HENOMX": "Mẽsiku Nutiwesiti Kurasí Ara Hurariyu", "HEOG": "Guruẽrãdiya Usidẽtawara Kurasí Ara Hurariyu", "HEPMX": "Pasifiku Mexikanu Kurasí Ara Hurariyu", "HKST": "Hũg Kũg Kurasí Ara Hurariyu", "HKT": "Hũg Kũg Hurariyu Retewa", "HNNOMX": "Mẽsiku Nutiwesiti Hurariyu Retewa", "HNOG": "Guruẽrãdiya Usidẽtawara Hurariyu Retewa", "HNPMX": "Pasifiku Mexikanu Hurariyu Retewa", "ICT": "Ĩdoxina Hurariyu", "IRDT": "Irã Kurasí Ara Hurariyu", "IRST": "Irã Hurariyu Retewa", "IST": "Ĩdia Hurariyu Retewa", "JDT": "Nipõ Kurasí Ara Hurariyu", "JST": "Nipõ Hurariyu Retewa", "LHDT": "Lurudi Howe Kurasí Ara Hurariyu", "LHST": "Lurudi Howe Hurariyu Retewa", "MDT": "Makau Kurasí Ara Hurariyu", "MESZ": "Eurupa Piterawara Kurasí Ara Hurariyu", "MEZ": "Eurupa Piterawara Hurariyu Retewa", "MST": "Makau Hurariyu Retewa", "MVT": "Kapuã-ita Maudiwa-ita Hurariyu", "MYT": "Malasiya Hurariyu", "NDT": "Iwí Pisasú Kurasí Ara Hurariyu", "NPT": "Nepau Hurariyu", "NST": "Iwí Pisasú Hurariyu Retewa", "NZDT": "Serãdiya Pisasú Kurasí Ara Hurariyu", "NZST": "Serãdiya Pisasú Hurariyu Retewa", "OESZ": "Eurupa Uriẽtawara Kurasí Ara Hurariyu", "OEZ": "Eurupa Uriẽtawara Hurariyu Retewa", "PDT": "Rỹ Kã Óra Pasifiku tá", "PKT": "Pakiretãma Kurasí Ara Hurariyu", "PMDT": "Sã Peduru asuí Mikirãu Kurasí Ara Hurariyu", "PMST": "Sã Peduru asuí Mikirãu Hurariyu Retewa", "PST": "Óra Pã Pasifiku tá", "PYST": "ParaguwaiKurasí Ara Hurariyu", "SAST": "Afirika Su suí Hurariyu", "SGT": "Sĩgapura Hurariyu Retewa", "SRT": "Suriname Hurariyu", "TLT": "Timu-Semusawa Hurariyu", "TMST": "Turkuranaretãma Kurasí Ara Hurariyu", "TMT": "Turkuranaretãma Hurariyu Retewa", "UYST": "Uruguwai Kurasí Ara Hurariyu", "UYT": "Uruguwai Hurariyu Retewa", "VET": "Wenẽsuera Hurariyu", "WARST": "Argẽtina Usidẽtawara Kurasí Ara Hurariyu", "WART": "Argẽtina Usidẽtawara Hurariyu Retewa", "WAST": "Afirika Usidẽtawara Kurasí Ara Hurariyu", "WAT": "Afirika Usidẽtawara Hurariyu Retewa", "WESZ": "Eurupa Usidẽtawara Kurasí Ara Hurariyu", "WEZ": "Eurupa Usidẽtawara Hurariyu Retewa", "WIB": "Ĩdonesiya Usidẽtawara Hurariyu", "WIT": "Ĩdonesiya Uriẽtawara Hurariyu", "WITA": "Ĩdonesiya Piterawara Hurariyu", "∅∅∅": "Peru Kurasí Ara Hurariyu"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} asuí {1}", "{0}, {1}", "{0}, {1}", "{0} asuí {1}"}, {"{0} u {1}", "{0}, {1}", "{0}, {1}", "{0} u {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sék.", "%v sék.", "%v sék", ""},
				Long:   &locales.CounterFormat{"sékuru-ita", "%v sékuru", "%v sékuru-ita", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dék.", "%v dék.", "%v dék", ""},
				Long:   &locales.CounterFormat{"dékada-ita", "%v dékada", "%v dékada-ita", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"akayú", "%v akayú", "%v akayú", "%v/akayú"},
				Long:   &locales.CounterFormat{"akayú-ita", "%v akayú", "%v akayú-ita", "%v akayú rupi"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"yasí", "%v yasí", "%v yasí", "%v/yasí"},
				Long:   &locales.CounterFormat{"yasí-ita", "%v yasí", "%v yasí-ita", "%v yasí rupi"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sem.", "%v sem.", "%v sem", "%v/sem."},
				Long:   &locales.CounterFormat{"sẽmãna-ita", "%v sẽmãna", "%v sẽmãna-ita", "%v sẽmãna rupi"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ara", "%v ara", "%v ara", "%v/ara"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"hura-ita", "%v hura", "%v hura-ita", "%v hura rupi"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"minutu-ita", "%v minutu", "%v minutu-ita", "%v minutu rupi"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"seg", "%v s", "%v s", "%v/seg"},
				Long:   &locales.CounterFormat{"segũdu-ita", "%v segũdu", "%v segũdu-ita", "%v segũdu rupi"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"mirisegũdu-ita", "%v mirisegũdu-ita", "%v mirisegũdu rupi", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"mikrusegũdu-ita", "%v mikrusegũdu", "%v mikrusegũdu-ita", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"nanusegũdu-ita", "%v nanusegũdu", "%v nanusegũdu-ita", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"+%[1]v",
...
func (yrl *yrl) Locale() string {
	return yrl.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'yrl'
func (yrl *yrl) PluralsCardinal() []locales.PluralRule {
	return yrl.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'yrl'
func (yrl *yrl) PluralsOrdinal() []locales.PluralRule {
	return yrl.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'yrl'
func (yrl *yrl) PluralsRange() []locales.PluralRule {
	return yrl.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'yrl'
func (yrl *yrl) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'yrl'
func (yrl *yrl) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'yrl'
func (yrl *yrl) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// FmtDateShort returns the short date representation of 't' for 'yrl'
func (yrl *yrl) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'yrl'
func (yrl *yrl) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'yrl'
func (yrl *yrl) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'yrl'
func (yrl *yrl) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'yrl'
func (yrl *yrl) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'yrl'
func (yrl *yrl) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'yrl'
func (yrl *yrl) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'yrl'
func (yrl *yrl) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(yrl, yrl.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'yrl'
func (yrl *yrl) DateFullLayout() string {
	return yrl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'yrl'
func (yrl *yrl) DateLongLayout() string {
	return yrl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'yrl'
func (yrl *yrl) DateMediumLayout() string {
	return yrl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'yrl'
func (yrl *yrl) DateShortLayout() string {
	return yrl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'yrl'
func (yrl *yrl) TimeFullLayout() string {
	return yrl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'yrl'
func (yrl *yrl) TimeLongLayout() string {
	return yrl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'yrl'
func (yrl *yrl) TimeMediumLayout() string {
	return yrl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'yrl'
func (yrl *yrl) TimeShortLayout() string {
	return yrl.timeShortLayout
}

func (yrl *yrl) ListPatterns() *locales.ListPatterns {
	return yrl.listPatterns
}

func (yrl *yrl) GetDurationSpec() *locales.DurationSpec {
	return yrl.DurationSpec
}

func (yrl *yrl) GetMiscPatterns() *locales.MiscPatterns {
	return &yrl.miscPatterns
}
