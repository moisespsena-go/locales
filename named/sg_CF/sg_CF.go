...
func New() locales.Translator {
	return &sg_CF{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Nye", "Ful", "Mbä", "Ngu", "Bêl", "Fön", "Len", "Kük", "Mvu", "Ngb", "Nab", "Kak"},
			MonthsNarrowValue:        []string{"", "N", "F", "M", "N", "B", "F", "L", "K", "M", "N", "N", "K"},
			MonthsWideValue:          []string{"", "Nyenye", "Fulundïgi", "Mbängü", "Ngubùe", "Bêläwü", "Föndo", "Lengua", "Kükürü", "Mvuka", "Ngberere", "Nabändüru", "Kakauka"},
			WeekdaysAbbreviatedValue: []string{"Bk1", "Bk2", "Bk3", "Bk4", "Bk5", "Lâp", "Lây"},
			WeekdaysNarrowValue:      []string{"K", "S", "T", "S", "K", "P", "Y"},
			WeekdaysWideValue:        []string{"Bikua-ôko", "Bïkua-ûse", "Bïkua-ptâ", "Bïkua-usïö", "Bïkua-okü", "Lâpôsö", "Lâyenga"},
			PeriodsAbbreviatedValue:  []string{"ND", "LK"},
			PeriodsWideValue:         []string{"ND", "LK"},
			ErasAbbreviatedValue:     []string{"KnK", "NpK"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Kôzo na Krîstu", "Na pekô tî Krîstu"},
...
func (sg *sg_CF) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(sg, sg.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'sg_CF'
func (sg *sg_CF) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(sg, sg.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'sg_CF'
func (sg *sg_CF) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(sg, sg.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'sg_CF'
func (sg *sg_CF) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(sg, sg.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'sg_CF'
func (sg *sg_CF) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(sg, sg.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'sg_CF'
func (sg *sg_CF) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(sg, sg.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'sg_CF'
func (sg *sg_CF) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(sg, sg.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'sg_CF'
func (sg *sg_CF) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(sg, sg.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'sg_CF'
func (sg *sg_CF) DateFullLayout() string {
	return sg.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sg_CF'
func (sg *sg_CF) DateLongLayout() string {
	return sg.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sg_CF'
func (sg *sg_CF) DateMediumLayout() string {
	return sg.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sg_CF'
func (sg *sg_CF) DateShortLayout() string {
	return sg.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sg_CF'
func (sg *sg_CF) TimeFullLayout() string {
	return sg.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sg_CF'
func (sg *sg_CF) TimeLongLayout() string {
	return sg.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sg_CF'
func (sg *sg_CF) TimeMediumLayout() string {
	return sg.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sg_CF'
func (sg *sg_CF) TimeShortLayout() string {
	return sg.timeShortLayout
}

func (sg *sg_CF) ListPatterns() *locales.ListPatterns {
	return sg.listPatterns
}

func (sg *sg_CF) GetDurationSpec() *locales.DurationSpec {
	return sg.DurationSpec
}

func (sg *sg_CF) GetMiscPatterns() *locales.MiscPatterns {
	return &sg.miscPatterns
}
