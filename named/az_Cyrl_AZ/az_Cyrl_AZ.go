...
// DateFullLayout returns the full date layout for 'az_Cyrl_AZ'
func (az *az_Cyrl_AZ) DateFullLayout() string {
	return az.dateFullLayout
}

// DateLongLayout returns the long date layout for 'az_Cyrl_AZ'
func (az *az_Cyrl_AZ) DateLongLayout() string {
	return az.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'az_Cyrl_AZ'
func (az *az_Cyrl_AZ) DateMediumLayout() string {
	return az.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'az_Cyrl_AZ'
func (az *az_Cyrl_AZ) DateShortLayout() string {
	return az.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'az_Cyrl_AZ'
func (az *az_Cyrl_AZ) TimeFullLayout() string {
	return az.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'az_Cyrl_AZ'
func (az *az_Cyrl_AZ) TimeLongLayout() string {
	return az.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'az_Cyrl_AZ'
func (az *az_Cyrl_AZ) TimeMediumLayout() string {
	return az.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'az_Cyrl_AZ'
func (az *az_Cyrl_AZ) TimeShortLayout() string {
	return az.timeShortLayout
}

func (az *az_Cyrl_AZ) ListPatterns() *locales.ListPatterns {
	return az.listPatterns
}

func (az *az_Cyrl_AZ) GetDurationSpec() *locales.DurationSpec {
	return az.DurationSpec
}

func (az *az_Cyrl_AZ) GetMiscPatterns() *locales.MiscPatterns {
