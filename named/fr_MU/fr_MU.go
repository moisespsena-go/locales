...
// DateFullLayout returns the full date layout for 'fr_MU'
func (fr *fr_MU) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_MU'
func (fr *fr_MU) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_MU'
func (fr *fr_MU) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_MU'
func (fr *fr_MU) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_MU'
func (fr *fr_MU) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_MU'
func (fr *fr_MU) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_MU'
func (fr *fr_MU) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_MU'
func (fr *fr_MU) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_MU) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_MU) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_MU) GetMiscPatterns() *locales.MiscPatterns {
