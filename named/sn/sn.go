...
// DateFullLayout returns the full date layout for 'sn'
func (sn *sn) DateFullLayout() string {
	return sn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sn'
func (sn *sn) DateLongLayout() string {
	return sn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sn'
func (sn *sn) DateMediumLayout() string {
	return sn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sn'
func (sn *sn) DateShortLayout() string {
	return sn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sn'
func (sn *sn) TimeFullLayout() string {
	return sn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sn'
func (sn *sn) TimeLongLayout() string {
	return sn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sn'
func (sn *sn) TimeMediumLayout() string {
	return sn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sn'
func (sn *sn) TimeShortLayout() string {
	return sn.timeShortLayout
}

func (sn *sn) ListPatterns() *locales.ListPatterns {
	return sn.listPatterns
}

func (sn *sn) GetDurationSpec() *locales.DurationSpec {
	return sn.DurationSpec
}

func (sn *sn) GetMiscPatterns() *locales.MiscPatterns {
