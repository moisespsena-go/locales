...
func New() locales.Translator {
	return &rw_RW{
		...
		TimeSpec: &locales.TimeSpec{
			...
			MonthsWideValue:          []string{"", "Mutarama", "Gashyantare", "Werurwe", "Mata", "Gicurasi", "Kamena", "Nyakanga", "Kanama", "Nzeli", "Ukwakira", "Ugushyingo", "Ukuboza"},
			WeekdaysAbbreviatedValue: []string{"cyu.", "mbe.", "kab.", "gtu.", "kan.", "gnu.", "gnd."},
			WeekdaysNarrowValue:      []string{"S", "M", "T", "W", "T", "F", "S"},
			WeekdaysShortValue:       []string{"cyu.", "mbe.", "kab.", "gtu.", "kan.", "gnu.", "gnd."},
			WeekdaysWideValue:        []string{"Ku cyumweru", "Kuwa mbere", "Kuwa kabiri", "Kuwa gatatu", "Kuwa kane", "Kuwa gatanu", "Kuwa gatandatu"},
...
func (rw *rw_RW) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(rw, rw.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'rw_RW'
func (rw *rw_RW) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(rw, rw.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'rw_RW'
func (rw *rw_RW) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(rw, rw.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'rw_RW'
func (rw *rw_RW) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(rw, rw.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'rw_RW'
func (rw *rw_RW) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(rw, rw.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'rw_RW'
func (rw *rw_RW) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(rw, rw.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'rw_RW'
func (rw *rw_RW) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(rw, rw.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'rw_RW'
func (rw *rw_RW) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(rw, rw.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'rw_RW'
func (rw *rw_RW) DateFullLayout() string {
	return rw.dateFullLayout
}

// DateLongLayout returns the long date layout for 'rw_RW'
func (rw *rw_RW) DateLongLayout() string {
	return rw.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'rw_RW'
func (rw *rw_RW) DateMediumLayout() string {
	return rw.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'rw_RW'
func (rw *rw_RW) DateShortLayout() string {
	return rw.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'rw_RW'
func (rw *rw_RW) TimeFullLayout() string {
	return rw.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'rw_RW'
func (rw *rw_RW) TimeLongLayout() string {
	return rw.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'rw_RW'
func (rw *rw_RW) TimeMediumLayout() string {
	return rw.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'rw_RW'
func (rw *rw_RW) TimeShortLayout() string {
	return rw.timeShortLayout
}

func (rw *rw_RW) ListPatterns() *locales.ListPatterns {
	return rw.listPatterns
}

func (rw *rw_RW) GetDurationSpec() *locales.DurationSpec {
	return rw.DurationSpec
}

func (rw *rw_RW) GetMiscPatterns() *locales.MiscPatterns {
	return &rw.miscPatterns
}
