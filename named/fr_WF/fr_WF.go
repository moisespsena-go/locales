...
// DateFullLayout returns the full date layout for 'fr_WF'
func (fr *fr_WF) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_WF'
func (fr *fr_WF) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_WF'
func (fr *fr_WF) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_WF'
func (fr *fr_WF) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_WF'
func (fr *fr_WF) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_WF'
func (fr *fr_WF) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_WF'
func (fr *fr_WF) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_WF'
func (fr *fr_WF) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_WF) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_WF) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_WF) GetMiscPatterns() *locales.MiscPatterns {
