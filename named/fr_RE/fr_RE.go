...
// DateFullLayout returns the full date layout for 'fr_RE'
func (fr *fr_RE) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_RE'
func (fr *fr_RE) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_RE'
func (fr *fr_RE) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_RE'
func (fr *fr_RE) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_RE'
func (fr *fr_RE) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_RE'
func (fr *fr_RE) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_RE'
func (fr *fr_RE) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_RE'
func (fr *fr_RE) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_RE) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_RE) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_RE) GetMiscPatterns() *locales.MiscPatterns {
