...
func New() locales.Translator {
	return &shi_Latn{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "inn", "bṛa", "maṛ", "ibr", "may", "yun", "yul", "ɣuc", "cut", "ktu", "nuw", "duj"},
			MonthsNarrowValue:        []string{"", "i", "b", "m", "i", "m", "y", "y", "ɣ", "c", "k", "n", "d"},
			MonthsWideValue:          []string{"", "innayr", "bṛayṛ", "maṛṣ", "ibrir", "mayyu", "yunyu", "yulyuz", "ɣuct", "cutanbir", "ktubr", "nuwanbir", "dujanbir"},
			WeekdaysAbbreviatedValue: []string{"asa", "ayn", "asi", "akṛ", "akw", "asim", "asiḍ"},
			WeekdaysNarrowValue:      []string{"S", "M", "T", "W", "T", "F", "S"},
			WeekdaysWideValue:        []string{"asamas", "aynas", "asinas", "akṛas", "akwas", "asimwas", "asiḍyas"},
			PeriodsAbbreviatedValue:  []string{"tifawt", "tadggʷat"},
			PeriodsNarrowValue:       []string{"", ""},
			PeriodsWideValue:         []string{"tifawt", "tadggʷat"},
			ErasAbbreviatedValue:     []string{"daɛ", "dfɛ"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"dat n ɛisa", "dffir n ɛisa"},
...
// DateFullLayout returns the full date layout for 'shi_Latn'
func (shi *shi_Latn) DateFullLayout() string {
	return shi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'shi_Latn'
func (shi *shi_Latn) DateLongLayout() string {
	return shi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'shi_Latn'
func (shi *shi_Latn) DateMediumLayout() string {
	return shi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'shi_Latn'
func (shi *shi_Latn) DateShortLayout() string {
	return shi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'shi_Latn'
func (shi *shi_Latn) TimeFullLayout() string {
	return shi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'shi_Latn'
func (shi *shi_Latn) TimeLongLayout() string {
	return shi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'shi_Latn'
func (shi *shi_Latn) TimeMediumLayout() string {
	return shi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'shi_Latn'
func (shi *shi_Latn) TimeShortLayout() string {
	return shi.timeShortLayout
}

func (shi *shi_Latn) ListPatterns() *locales.ListPatterns {
	return shi.listPatterns
}

func (shi *shi_Latn) GetDurationSpec() *locales.DurationSpec {
	return shi.DurationSpec
}

func (shi *shi_Latn) GetMiscPatterns() *locales.MiscPatterns {
