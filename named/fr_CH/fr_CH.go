...
func New() locales.Translator {
	return &fr_CH{
		...
		timeFullLayout:   "HH.mm:ss 'h' zzzz",
...
// DateFullLayout returns the full date layout for 'fr_CH'
func (fr *fr_CH) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_CH'
func (fr *fr_CH) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_CH'
func (fr *fr_CH) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_CH'
func (fr *fr_CH) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_CH'
func (fr *fr_CH) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_CH'
func (fr *fr_CH) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_CH'
func (fr *fr_CH) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_CH'
func (fr *fr_CH) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_CH) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_CH) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_CH) GetMiscPatterns() *locales.MiscPatterns {
