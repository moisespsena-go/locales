...
func New() locales.Translator {
	return &zgh_MA{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ⵉⵏⵏ", "ⴱⵕⴰ", "ⵎⴰⵕ", "ⵉⴱⵔ", "ⵎⴰⵢ", "ⵢⵓⵏ", "ⵢⵓⵍ", "ⵖⵓⵛ", "ⵛⵓⵜ", "ⴽⵜⵓ", "ⵏⵓⵡ", "ⴷⵓⵊ"},
			MonthsNarrowValue:        []string{"", "ⵉ", "ⴱ", "ⵎ", "ⵉ", "ⵎ", "ⵢ", "ⵢ", "ⵖ", "ⵛ", "ⴽ", "ⵏ", "ⴷ"},
			MonthsWideValue:          []string{"", "ⵉⵏⵏⴰⵢⵔ", "ⴱⵕⴰⵢⵕ", "ⵎⴰⵕⵚ", "ⵉⴱⵔⵉⵔ", "ⵎⴰⵢⵢⵓ", "ⵢⵓⵏⵢⵓ", "ⵢⵓⵍⵢⵓⵣ", "ⵖⵓⵛⵜ", "ⵛⵓⵜⴰⵏⴱⵉⵔ", "ⴽⵜⵓⴱⵔ", "ⵏⵓⵡⴰⵏⴱⵉⵔ", "ⴷⵓⵊⴰⵏⴱⵉⵔ"},
			WeekdaysAbbreviatedValue: []string{"ⴰⵙⴰ", "ⴰⵢⵏ", "ⴰⵙⵉ", "ⴰⴽⵕ", "ⴰⴽⵡ", "ⴰⵙⵉⵎ", "ⴰⵙⵉⴹ"},
			WeekdaysNarrowValue:      []string{"S", "M", "T", "W", "T", "F", "S"},
			WeekdaysShortValue:       []string{"ⴰⵙⴰ", "ⴰⵢⵏ", "ⴰⵙⵉ", "ⴰⴽⵕ", "ⴰⴽⵡ", "ⴰⵙⵉⵎ", "ⴰⵙⵉⴹ"},
			WeekdaysWideValue:        []string{"ⴰⵙⴰⵎⴰⵙ", "ⴰⵢⵏⴰⵙ", "ⴰⵙⵉⵏⴰⵙ", "ⴰⴽⵕⴰⵙ", "ⴰⴽⵡⴰⵙ", "ⴰⵙⵉⵎⵡⴰⵙ", "ⴰⵙⵉⴹⵢⴰⵙ"},
			PeriodsAbbreviatedValue:  []string{"ⵜⵉⴼⴰⵡⵜ", "ⵜⴰⴷⴳⴳⵯⴰⵜ"},
			PeriodsNarrowValue:       []string{"ⵜⵉⴼⴰⵡⵜ", "ⵜⴰⴷⴳⴳⵯⴰⵜ"},
			PeriodsWideValue:         []string{"ⵜⵉⴼⴰⵡⵜ", "ⵜⴰⴷⴳⴳⵯⴰⵜ"},
			ErasAbbreviatedValue:     []string{"ⴷⴰⵄ", "ⴷⴼⵄ"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"ⴷⴰⵜ ⵏ ⵄⵉⵙⴰ", "ⴷⴼⴼⵉⵔ ⵏ ⵄⵉⵙⴰ"},
...
func (zgh *zgh_MA) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(zgh, zgh.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'zgh_MA'
func (zgh *zgh_MA) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(zgh, zgh.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'zgh_MA'
func (zgh *zgh_MA) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(zgh, zgh.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'zgh_MA'
func (zgh *zgh_MA) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(zgh, zgh.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'zgh_MA'
func (zgh *zgh_MA) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(zgh, zgh.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'zgh_MA'
func (zgh *zgh_MA) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(zgh, zgh.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'zgh_MA'
func (zgh *zgh_MA) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(zgh, zgh.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'zgh_MA'
func (zgh *zgh_MA) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(zgh, zgh.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'zgh_MA'
func (zgh *zgh_MA) DateFullLayout() string {
	return zgh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'zgh_MA'
func (zgh *zgh_MA) DateLongLayout() string {
	return zgh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'zgh_MA'
func (zgh *zgh_MA) DateMediumLayout() string {
	return zgh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'zgh_MA'
func (zgh *zgh_MA) DateShortLayout() string {
	return zgh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'zgh_MA'
func (zgh *zgh_MA) TimeFullLayout() string {
	return zgh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'zgh_MA'
func (zgh *zgh_MA) TimeLongLayout() string {
	return zgh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'zgh_MA'
func (zgh *zgh_MA) TimeMediumLayout() string {
	return zgh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'zgh_MA'
func (zgh *zgh_MA) TimeShortLayout() string {
	return zgh.timeShortLayout
}

func (zgh *zgh_MA) ListPatterns() *locales.ListPatterns {
	return zgh.listPatterns
}

func (zgh *zgh_MA) GetDurationSpec() *locales.DurationSpec {
	return zgh.DurationSpec
}

func (zgh *zgh_MA) GetMiscPatterns() *locales.MiscPatterns {
	return &zgh.miscPatterns
}
