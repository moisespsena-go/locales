				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						...
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0000M"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0000M"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00MRD"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00MRD"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000MRD"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000MRD"),
						}},
					},
...
// DateFullLayout returns the full date layout for 'es_GT'
func (es *es_GT) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_GT'
func (es *es_GT) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_GT'
func (es *es_GT) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_GT'
func (es *es_GT) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_GT'
func (es *es_GT) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_GT'
func (es *es_GT) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_GT'
func (es *es_GT) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_GT'
func (es *es_GT) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_GT) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_GT) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_GT) GetMiscPatterns() *locales.MiscPatterns {
