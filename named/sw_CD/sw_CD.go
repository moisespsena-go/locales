...
// DateFullLayout returns the full date layout for 'sw_CD'
func (sw *sw_CD) DateFullLayout() string {
	return sw.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sw_CD'
func (sw *sw_CD) DateLongLayout() string {
	return sw.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sw_CD'
func (sw *sw_CD) DateMediumLayout() string {
	return sw.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sw_CD'
func (sw *sw_CD) DateShortLayout() string {
	return sw.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sw_CD'
func (sw *sw_CD) TimeFullLayout() string {
	return sw.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sw_CD'
func (sw *sw_CD) TimeLongLayout() string {
	return sw.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sw_CD'
func (sw *sw_CD) TimeMediumLayout() string {
	return sw.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sw_CD'
func (sw *sw_CD) TimeShortLayout() string {
	return sw.timeShortLayout
}

func (sw *sw_CD) ListPatterns() *locales.ListPatterns {
	return sw.listPatterns
}

func (sw *sw_CD) GetDurationSpec() *locales.DurationSpec {
	return sw.DurationSpec
}

func (sw *sw_CD) GetMiscPatterns() *locales.MiscPatterns {
