...
// DateFullLayout returns the full date layout for 'en_AG'
func (en *en_AG) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_AG'
func (en *en_AG) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_AG'
func (en *en_AG) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_AG'
func (en *en_AG) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_AG'
func (en *en_AG) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_AG'
func (en *en_AG) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_AG'
func (en *en_AG) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_AG'
func (en *en_AG) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_AG) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_AG) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_AG) GetMiscPatterns() *locales.MiscPatterns {
