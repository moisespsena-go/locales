...
// DateFullLayout returns the full date layout for 'fr_YT'
func (fr *fr_YT) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_YT'
func (fr *fr_YT) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_YT'
func (fr *fr_YT) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_YT'
func (fr *fr_YT) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_YT'
func (fr *fr_YT) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_YT'
func (fr *fr_YT) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_YT'
func (fr *fr_YT) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_YT'
func (fr *fr_YT) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_YT) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_YT) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_YT) GetMiscPatterns() *locales.MiscPatterns {
