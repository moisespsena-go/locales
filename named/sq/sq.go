	...
	return &sq{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"shek.", "%v shek.", "%v shek.", ""},
				Long:   &locales.CounterFormat{"shekuj", "%v shekull", "%v shekuj", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dek.", "%v dek.", "%v dek.", ""},
				Long:   &locales.CounterFormat{"dekada", "%v dekadë", "%v dekada", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"vjet", "%v vit", "%v vjet", ""},
				Long:   &locales.CounterFormat{"vjet", "%v vit", "%v vjet", "%v/vit"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"muaj", "%v muaj", "%v muaj", ""},
				Long:   &locales.CounterFormat{"muaj", "%v muaj", "%v muaj", "%v/muaj"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"javë", "%v javë", "%v javë", ""},
				Long:   &locales.CounterFormat{"javë", "%v javë", "%v javë", "%v/javë"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ditë", "%v ditë", "%v ditë", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"orë", "%v orë", "%v orë", ""},
				Long:   &locales.CounterFormat{"orë", "%v orë", "%v orë", "%v/orë"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min.", "%v min.", "%v min.", ""},
				Long:   &locales.CounterFormat{"minuta", "%v minutë", "%v minuta", "%v/minutë"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sek.", "%v sek.", "%v sek.", ""},
				Long:   &locales.CounterFormat{"sekonda", "%v sekondë", "%v sekonda", "%v/sekondë"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"milisekonda", "%v milisekondë", "%v milisekonda", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"mikrosekonda", "%v mikrosekondë", "%v mikrosekonda", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosekonda", "%v nanosekondë", "%v nanosekonda", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"≈%[1]v",
			"≥%[1]v",
...
// DateFullLayout returns the full date layout for 'sq'
func (sq *sq) DateFullLayout() string {
	return sq.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sq'
func (sq *sq) DateLongLayout() string {
	return sq.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sq'
func (sq *sq) DateMediumLayout() string {
	return sq.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sq'
func (sq *sq) DateShortLayout() string {
	return sq.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sq'
func (sq *sq) TimeFullLayout() string {
	return sq.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sq'
func (sq *sq) TimeLongLayout() string {
	return sq.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sq'
func (sq *sq) TimeMediumLayout() string {
	return sq.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sq'
func (sq *sq) TimeShortLayout() string {
	return sq.timeShortLayout
}

func (sq *sq) ListPatterns() *locales.ListPatterns {
	return sq.listPatterns
}

func (sq *sq) GetDurationSpec() *locales.DurationSpec {
	return sq.DurationSpec
}

func (sq *sq) GetMiscPatterns() *locales.MiscPatterns {
