...
func New() locales.Translator {
	return &sk{
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} a\u00a0{1}", "{0}, {1}", "{0}, {1}", "{0} a {1}"}, {"{0} alebo {1}", "{0}, {1}", "{0}, {1}", "{0} alebo {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"stor.", "%v stor.", "%v stor.", ""},
				Long:   &locales.CounterFormat{"storočia", "%v storočí", "%v storočiach", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"desaťr.", "%v desaťr.", "%v desaťr.", ""},
				Long:   &locales.CounterFormat{"desaťročia", "%v desaťročí", "%v desaťročiach", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"r.", "%v r.", "%v r.", "%v/r."},
				Long:   &locales.CounterFormat{"roky", "%v roku", "%v rokoch", "%v za rok"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m.", "%v m.", "%v m.", "%v/m."},
				Long:   &locales.CounterFormat{"mesiace", "%v mesiaci", "%v mesiacoch", "%v za mesiac"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"t.", "%v t.", "%v t.", "%v/t."},
				Long:   &locales.CounterFormat{"týždne", "%v týždni", "%v týždňoch", "%v za týždeň"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"d.", "%v d.", "%v d.", "%v/d."}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"h", "%v h", "%v h", "%v/h"},
				Long:   &locales.CounterFormat{"hodiny", "%v hodine", "%v hodinách", "%v za hodinu"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%v min", "%v min", "%v/min"},
				Long:   &locales.CounterFormat{"minúty", "%v minúte", "%v minútach", "%v za minútu"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%v s", "%v s", "%v/s"},
				Long:   &locales.CounterFormat{"sekundy", "%v sekunde", "%v sekundách", "%v za sekundu"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"milisekundy", "%v milisekunde", "%v milisekundách", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"mikrosekundy", "%v mikrosekunde", "%v mikrosekundách", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosekundy", "%v nanosekunde", "%v nanosekundách", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (sk *sk) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(sk, sk.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'sk'
func (sk *sk) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(sk, sk.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'sk'
func (sk *sk) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(sk, sk.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'sk'
func (sk *sk) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(sk, sk.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'sk'
func (sk *sk) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(sk, sk.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'sk'
func (sk *sk) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(sk, sk.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'sk'
func (sk *sk) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(sk, sk.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'sk'
func (sk *sk) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(sk, sk.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'sk'
func (sk *sk) DateFullLayout() string {
	return sk.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sk'
func (sk *sk) DateLongLayout() string {
	return sk.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sk'
func (sk *sk) DateMediumLayout() string {
	return sk.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sk'
func (sk *sk) DateShortLayout() string {
	return sk.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sk'
func (sk *sk) TimeFullLayout() string {
	return sk.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sk'
func (sk *sk) TimeLongLayout() string {
	return sk.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sk'
func (sk *sk) TimeMediumLayout() string {
	return sk.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sk'
func (sk *sk) TimeShortLayout() string {
	return sk.timeShortLayout
}

func (sk *sk) ListPatterns() *locales.ListPatterns {
	return sk.listPatterns
}

func (sk *sk) GetDurationSpec() *locales.DurationSpec {
	return sk.DurationSpec
}

func (sk *sk) GetMiscPatterns() *locales.MiscPatterns {
	return &sk.miscPatterns
}
