...
func New() locales.Translator {
	return &kam_KE{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Mbe", "Kel", "Ktũ", "Kan", "Ktn", "Tha", "Moo", "Nya", "Knd", "Ĩku", "Ĩkm", "Ĩkl"},
			MonthsNarrowValue:        []string{"", "M", "K", "K", "K", "K", "T", "M", "N", "K", "Ĩ", "Ĩ", "Ĩ"},
			MonthsWideValue:          []string{"", "Mwai wa mbee", "Mwai wa kelĩ", "Mwai wa katatũ", "Mwai wa kana", "Mwai wa katano", "Mwai wa thanthatũ", "Mwai wa muonza", "Mwai wa nyaanya", "Mwai wa kenda", "Mwai wa ĩkumi", "Mwai wa ĩkumi na ĩmwe", "Mwai wa ĩkumi na ilĩ"},
			WeekdaysAbbreviatedValue: []string{"Wky", "Wkw", "Wkl", "Wtũ", "Wkn", "Wtn", "Wth"},
			WeekdaysNarrowValue:      []string{"Y", "W", "E", "A", "A", "A", "A"},
			WeekdaysWideValue:        []string{"Wa kyumwa", "Wa kwambĩlĩlya", "Wa kelĩ", "Wa katatũ", "Wa kana", "Wa katano", "Wa thanthatũ"},
			PeriodsAbbreviatedValue:  []string{"Ĩyakwakya", "Ĩyawĩoo"},
			PeriodsWideValue:         []string{"Ĩyakwakya", "Ĩyawĩoo"},
			ErasAbbreviatedValue:     []string{"MY", "IY"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Mbee wa Yesũ", "Ĩtina wa Yesũ"},
...
func (kam *kam_KE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(kam, kam.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'kam_KE'
func (kam *kam_KE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(kam, kam.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'kam_KE'
func (kam *kam_KE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(kam, kam.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'kam_KE'
func (kam *kam_KE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(kam, kam.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'kam_KE'
func (kam *kam_KE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(kam, kam.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'kam_KE'
func (kam *kam_KE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(kam, kam.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'kam_KE'
func (kam *kam_KE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(kam, kam.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'kam_KE'
func (kam *kam_KE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(kam, kam.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'kam_KE'
func (kam *kam_KE) DateFullLayout() string {
	return kam.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kam_KE'
func (kam *kam_KE) DateLongLayout() string {
	return kam.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kam_KE'
func (kam *kam_KE) DateMediumLayout() string {
	return kam.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kam_KE'
func (kam *kam_KE) DateShortLayout() string {
	return kam.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kam_KE'
func (kam *kam_KE) TimeFullLayout() string {
	return kam.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kam_KE'
func (kam *kam_KE) TimeLongLayout() string {
	return kam.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kam_KE'
func (kam *kam_KE) TimeMediumLayout() string {
	return kam.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kam_KE'
func (kam *kam_KE) TimeShortLayout() string {
	return kam.timeShortLayout
}

func (kam *kam_KE) ListPatterns() *locales.ListPatterns {
	return kam.listPatterns
}

func (kam *kam_KE) GetDurationSpec() *locales.DurationSpec {
	return kam.DurationSpec
}

func (kam *kam_KE) GetMiscPatterns() *locales.MiscPatterns {
	return &kam.miscPatterns
}
