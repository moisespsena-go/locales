...
// DateFullLayout returns the full date layout for 'seh'
func (seh *seh) DateFullLayout() string {
	return seh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'seh'
func (seh *seh) DateLongLayout() string {
	return seh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'seh'
func (seh *seh) DateMediumLayout() string {
	return seh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'seh'
func (seh *seh) DateShortLayout() string {
	return seh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'seh'
func (seh *seh) TimeFullLayout() string {
	return seh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'seh'
func (seh *seh) TimeLongLayout() string {
	return seh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'seh'
func (seh *seh) TimeMediumLayout() string {
	return seh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'seh'
func (seh *seh) TimeShortLayout() string {
	return seh.timeShortLayout
}

func (seh *seh) ListPatterns() *locales.ListPatterns {
	return seh.listPatterns
}

func (seh *seh) GetDurationSpec() *locales.DurationSpec {
	return seh.DurationSpec
}

func (seh *seh) GetMiscPatterns() *locales.MiscPatterns {
