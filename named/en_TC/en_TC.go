...
// DateFullLayout returns the full date layout for 'en_TC'
func (en *en_TC) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_TC'
func (en *en_TC) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_TC'
func (en *en_TC) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_TC'
func (en *en_TC) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_TC'
func (en *en_TC) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_TC'
func (en *en_TC) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_TC'
func (en *en_TC) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_TC'
func (en *en_TC) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_TC) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_TC) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_TC) GetMiscPatterns() *locales.MiscPatterns {
