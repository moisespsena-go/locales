...
// DateFullLayout returns the full date layout for 'en_US_POSIX'
func (en *en_US_POSIX) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_US_POSIX'
func (en *en_US_POSIX) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_US_POSIX'
func (en *en_US_POSIX) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_US_POSIX'
func (en *en_US_POSIX) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_US_POSIX'
func (en *en_US_POSIX) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_US_POSIX'
func (en *en_US_POSIX) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_US_POSIX'
func (en *en_US_POSIX) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_US_POSIX'
func (en *en_US_POSIX) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_US_POSIX) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_US_POSIX) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_US_POSIX) GetMiscPatterns() *locales.MiscPatterns {
