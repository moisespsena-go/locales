...
// DateFullLayout returns the full date layout for 'fr_NC'
func (fr *fr_NC) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_NC'
func (fr *fr_NC) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_NC'
func (fr *fr_NC) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_NC'
func (fr *fr_NC) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_NC'
func (fr *fr_NC) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_NC'
func (fr *fr_NC) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_NC'
func (fr *fr_NC) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_NC'
func (fr *fr_NC) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_NC) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_NC) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_NC) GetMiscPatterns() *locales.MiscPatterns {
