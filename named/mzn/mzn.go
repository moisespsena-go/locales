...
func New() locales.Translator {
	return &mzn{
		...
		TimeSpec: &locales.TimeSpec{
			...
			MonthsWideValue:        []string{"", "ژانویه", "فوریه", "مارس", "آوریل", "مه", "ژوئن", "ژوئیه", "اوت", "سپتامبر", "اکتبر", "نوامبر", "دسامبر"},
			ErasAbbreviatedValue:   []string{"پ.م", "م."},
			ErasNarrowValue:        []string{"", ""},
			ErasWideValue:          []string{"قبل میلاد", "بعد میلاد"},
...
func (mzn *mzn) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(mzn, mzn.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'mzn'
func (mzn *mzn) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(mzn, mzn.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'mzn'
func (mzn *mzn) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(mzn, mzn.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'mzn'
func (mzn *mzn) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(mzn, mzn.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'mzn'
func (mzn *mzn) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(mzn, mzn.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'mzn'
func (mzn *mzn) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(mzn, mzn.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'mzn'
func (mzn *mzn) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(mzn, mzn.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'mzn'
func (mzn *mzn) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(mzn, mzn.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'mzn'
func (mzn *mzn) DateFullLayout() string {
	return mzn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mzn'
func (mzn *mzn) DateLongLayout() string {
	return mzn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mzn'
func (mzn *mzn) DateMediumLayout() string {
	return mzn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mzn'
func (mzn *mzn) DateShortLayout() string {
	return mzn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mzn'
func (mzn *mzn) TimeFullLayout() string {
	return mzn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mzn'
func (mzn *mzn) TimeLongLayout() string {
	return mzn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mzn'
func (mzn *mzn) TimeMediumLayout() string {
	return mzn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mzn'
func (mzn *mzn) TimeShortLayout() string {
	return mzn.timeShortLayout
}

func (mzn *mzn) ListPatterns() *locales.ListPatterns {
	return mzn.listPatterns
}

func (mzn *mzn) GetDurationSpec() *locales.DurationSpec {
	return mzn.DurationSpec
}

func (mzn *mzn) GetMiscPatterns() *locales.MiscPatterns {
	return &mzn.miscPatterns
}
