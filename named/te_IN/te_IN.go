...
// DateFullLayout returns the full date layout for 'te_IN'
func (te *te_IN) DateFullLayout() string {
	return te.dateFullLayout
}

// DateLongLayout returns the long date layout for 'te_IN'
func (te *te_IN) DateLongLayout() string {
	return te.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'te_IN'
func (te *te_IN) DateMediumLayout() string {
	return te.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'te_IN'
func (te *te_IN) DateShortLayout() string {
	return te.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'te_IN'
func (te *te_IN) TimeFullLayout() string {
	return te.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'te_IN'
func (te *te_IN) TimeLongLayout() string {
	return te.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'te_IN'
func (te *te_IN) TimeMediumLayout() string {
	return te.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'te_IN'
func (te *te_IN) TimeShortLayout() string {
	return te.timeShortLayout
}

func (te *te_IN) ListPatterns() *locales.ListPatterns {
	return te.listPatterns
}

func (te *te_IN) GetDurationSpec() *locales.DurationSpec {
	return te.DurationSpec
}

func (te *te_IN) GetMiscPatterns() *locales.MiscPatterns {
