...
func New() locales.Translator {
	return &mas_KE{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Dal", "Ará", "Ɔɛn", "Doy", "Lép", "Rok", "Sás", "Bɔ́r", "Kús", "Gís", "Shʉ́", "Ntʉ́"},
			MonthsWideValue:          []string{"", "Oladalʉ́", "Arát", "Ɔɛnɨ́ɔɨŋɔk", "Olodoyíóríê inkókúâ", "Oloilépūnyīē inkókúâ", "Kújúɔrɔk", "Mórusásin", "Ɔlɔ́ɨ́bɔ́rárɛ", "Kúshîn", "Olgísan", "Pʉshʉ́ka", "Ntʉ́ŋʉ́s"},
			WeekdaysAbbreviatedValue: []string{"Jpi", "Jtt", "Jnn", "Jtn", "Alh", "Iju", "Jmo"},
			WeekdaysNarrowValue:      []string{"2", "3", "4", "5", "6", "7", "1"},
			WeekdaysWideValue:        []string{"Jumapílí", "Jumatátu", "Jumane", "Jumatánɔ", "Alaámisi", "Jumáa", "Jumamósi"},
			PeriodsAbbreviatedValue:  []string{"Ɛnkakɛnyá", "Ɛndámâ"},
			PeriodsWideValue:         []string{"Ɛnkakɛnyá", "Ɛndámâ"},
			ErasAbbreviatedValue:     []string{"MY", "EY"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Meínō Yɛ́sʉ", "Eínō Yɛ́sʉ"},
...
func (mas *mas_KE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(mas, mas.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'mas_KE'
func (mas *mas_KE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(mas, mas.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'mas_KE'
func (mas *mas_KE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(mas, mas.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'mas_KE'
func (mas *mas_KE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(mas, mas.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'mas_KE'
func (mas *mas_KE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(mas, mas.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'mas_KE'
func (mas *mas_KE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(mas, mas.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'mas_KE'
func (mas *mas_KE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(mas, mas.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'mas_KE'
func (mas *mas_KE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(mas, mas.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'mas_KE'
func (mas *mas_KE) DateFullLayout() string {
	return mas.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mas_KE'
func (mas *mas_KE) DateLongLayout() string {
	return mas.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mas_KE'
func (mas *mas_KE) DateMediumLayout() string {
	return mas.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mas_KE'
func (mas *mas_KE) DateShortLayout() string {
	return mas.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mas_KE'
func (mas *mas_KE) TimeFullLayout() string {
	return mas.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mas_KE'
func (mas *mas_KE) TimeLongLayout() string {
	return mas.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mas_KE'
func (mas *mas_KE) TimeMediumLayout() string {
	return mas.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mas_KE'
func (mas *mas_KE) TimeShortLayout() string {
	return mas.timeShortLayout
}

func (mas *mas_KE) ListPatterns() *locales.ListPatterns {
	return mas.listPatterns
}

func (mas *mas_KE) GetDurationSpec() *locales.DurationSpec {
	return mas.DurationSpec
}

func (mas *mas_KE) GetMiscPatterns() *locales.MiscPatterns {
	return &mas.miscPatterns
}
