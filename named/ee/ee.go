...
func New() locales.Translator {
	return &ee{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "dzv", "dzd", "ted", "afɔ", "dam", "mas", "sia", "dea", "any", "kel", "ade", "dzm"},
			MonthsNarrowValue:        []string{"", "d", "d", "t", "a", "d", "m", "s", "d", "a", "k", "a", "d"},
			MonthsWideValue:          []string{"", "dzove", "dzodze", "tedoxe", "afɔfĩe", "dama", "masa", "siamlɔm", "deasiamime", "anyɔnyɔ", "kele", "adeɛmekpɔxe", "dzome"},
			WeekdaysAbbreviatedValue: []string{"kɔs", "dzo", "bla", "kuɖ", "yaw", "fiɖ", "mem"},
			WeekdaysNarrowValue:      []string{"k", "d", "b", "k", "y", "f", "m"},
			WeekdaysShortValue:       []string{"kɔs", "dzo", "bla", "kuɖ", "yaw", "fiɖ", "mem"},
			WeekdaysWideValue:        []string{"kɔsiɖa", "dzoɖa", "blaɖa", "kuɖa", "yawoɖa", "fiɖa", "memleɖa"},
			PeriodsAbbreviatedValue:  []string{"ŋdi", "ɣetrɔ"},
			PeriodsNarrowValue:       []string{"ŋ", "ɣ"},
			PeriodsWideValue:         []string{"ŋdi", "ɣetrɔ"},
			ErasAbbreviatedValue:     []string{"HYV", "Yŋ"},
			ErasNarrowValue:          []string{"hY", "Yŋ"},
			ErasWideValue:            []string{"", ""},
			TimezonesValue:           map[string]string{"": "Paraguay nutome gaƒoƒo me", "ACDT": "Australian Central dzomeli gaƒoƒo me", "ACST": "Australian Central nutome gaƒoƒo me", "ACT": "Eker gaƒoƒoɖoanyime", "ACWDT": "Australian Central Western kele gaƒoƒo me", "ACWST": "Australian Central Western nutome gaƒoƒo me", "ADT": "Atlantic kele gaƒoƒome", "AEDT": "Australian Eastern kele gaƒoƒo me", "AEST": "Australian Eastern nutome gaƒoƒo me", "AFT": "Afghanistan gaƒoƒo me", "AKDT": "Alaska kele gaƒoƒo me", "AKST": "Alaska nutome gaƒoƒo me", "AMST": "Amazon dzomeŋɔli gaƒoƒo me", "AMT": "Amazon nutome gaƒoƒo me", "ARST": "Argentina dzomeŋɔli gaƒoƒo me", "ART": "Argentina nutome gaƒoƒo me", "AST": "Atlantic nutome gaƒoƒome", "AWDT": "Australian Western kele gaƒoƒo me", "AWST": "Australian Western nutome gaƒoƒo me", "BNT": "Brunei Darussalam gaƒoƒo me", "BOT": "Bolivia gaƒoƒo me", "BRST": "Brasilia dzomeŋɔli gaƒoƒo me", "BRT": "Brasilia nutome gaƒoƒo me", "BST": "Bangladesh dzomeŋɔli gaƒoƒo me", "BTT": "Bhutan gaƒoƒo me", "CAT": "Central Africa gaƒoƒo me", "CCT": "Cocos Islands gaƒoƒo me", "CDT": "Titina America kele gaƒoƒo me", "CDT (Kuba)": "Cuba kele gaƒoƒome", "CHADT": "Chatham kele gaƒoƒo me", "CHAST": "Chatham nutome gaƒoƒo me", "CLST": "Chile dzomeŋɔli gaƒoƒo me", "CLT": "Chile nutome gaƒoƒo me", "COST": "Colombia dzomeŋɔli gaƒoƒo me", "COT": "Colombia nutome gaƒoƒo me", "CST": "Titina America nutome gaƒoƒo me", "CST (Kuba)": "Cuba nutome gaƒoƒome", "CXT": "Christmas Island gaƒoƒo me", "ChST": "Chamorro gaƒoƒo me", "EASST": "Easter Island dzomeŋɔli gaƒoƒo me", "EAST": "Easter Island nutome gaƒoƒo me", "EAT": "East Africa gaƒoƒo me", "ECT": "Ecuador gaƒoƒo me", "EDT": "Eastern America kele gaƒoƒo me", "EGDT": "East Greenland dzomeŋɔli gaƒoƒo me", "EGST": "East Greenland nutome gaƒoƒo me", "EST": "Eastern America nutome gaƒoƒo me", "FKST": "Falkland Islands dzomeŋɔli gaƒoƒo me", "GALT": "Galapagos gaƒoƒo me", "GFT": "French Guiana gaƒoƒo me", "GMT": "Greenwich gaƒoƒo me", "GST": "Gulf nutome gaƒoƒo me", "GYT": "Guyana gaƒoƒo me", "HADT": "Hawaii-Aleutia kele gaƒoƒo me", "HAST": "Hawaii-Aleutia nutome gaƒoƒo me", "HENOMX": "Northwest Mexico kele gaƒoƒo me", "HEOG": "West Greenland kele gaƒoƒo me", "HEPMX": "Mexican Pacific kele gaƒoƒome", "HKST": "Hong Kong dzomeŋɔli gaƒoƒo me", "HKT": "Hong Kong nutome gaƒoƒo me", "HNNOMX": "Northwest Mexico nutome gaƒoƒo me", "HNOG": "West Greenland nutome gaƒoƒo me", "HNPMX": "Mexican Pacific nutome gaƒoƒo me", "ICT": "Indonesia gaƒoƒo me", "IRDT": "Iran kele gaƒoƒo me", "IRST": "Iran nutome gaƒoƒo me", "IST": "India gaƒoƒo me", "JDT": "Japan dzomeŋɔli gaƒoƒo me", "JST": "Japan nutome gaƒoƒo me", "LHDT": "Lord Howe kele gaƒoƒo me", "LHST": "Lord Howe nutome gaƒoƒo me", "MDT": "Mountain kele gaƒoƒo me", "MESZ": "Central Europe dzomeŋɔli gaƒoƒo me", "MEZ": "Central Europe nutome gaƒoƒo me", "MST": "Mountain nutome gaƒoƒo me", "MVT": "Maldives gaƒoƒo me", "MYT": "Malaysia gaƒoƒo me", "NDT": "Newfoundland kele gaƒoƒome", "NPT": "Nepal gaƒoƒo me", "NST": "Newfoundland nutome gaƒoƒome", "NZDT": "New Zealand kele gaƒoƒo me", "NZST": "New Zealand nutome gaƒoƒo me", "OESZ": "Ɣedzeƒe Europe ŋkekeme gaƒoƒome", "OEZ": "Ɣedzeƒe Europe gaƒoƒoɖoanyime", "PDT": "Pacific kele gaƒoƒo me", "PKT": "Pakistan dzomeŋɔli gaƒoƒo me", "PMDT": "St. Pierre & Miquelon kele gaƒoƒome", "PMST": "St. Pierre & Miquelon nutome gaƒoƒome", "PST": "Pacific nutome gaƒoƒo me", "PYST": "Paraguay dzomeŋɔli gaƒoƒo me", "SAST": "South Africa nutome gaƒoƒo me", "SGT": "Singapore nutome gaƒoƒo me", "SRT": "Suriname gaƒoƒome", "TLT": "East Timor gaƒoƒo me", "TMST": "Turkmenistan dzomeŋɔli gaƒoƒo me", "TMT": "Turkmenistan nutome gaƒoƒo me", "UYST": "Uruguay dzomeŋɔli gaƒoƒo me", "UYT": "Uruguay nutome gaƒoƒo me", "VET": "Venezuela gaƒoƒo me", "WARST": "Ɣetoɖoƒe Argentina dzomeŋɔli gaƒoƒo me", "WART": "Ɣetoɖoƒe Argentina nutome gaƒoƒo me", "WAST": "West Africa dzomeŋɔli gaƒoƒo me", "WAT": "West Africa nutome gaƒoƒo me", "WESZ": "Western Europe dzomeŋɔli gaƒoƒo me", "WEZ": "Western Europe nutome gaƒoƒo me", "WIB": "Western Indonesia gaƒoƒo me", "WIT": "Eastern Indonesia gaƒoƒo me", "WITA": "Central Indonesia gaƒoƒo me", "∅∅∅": "Peru dzomeŋɔli gaƒoƒome"},
		},
		...
		dateFullLayout:   "EEEE, MMMM d 'lia' y",
		dateLongLayout:   "MMMM d 'lia' y",
		dateMediumLayout: "MMM d 'lia', y",
		dateShortLayout:  "M/d/yy",
		timeFullLayout:   "a 'ga' h:mm:ss zzzz",
		timeLongLayout:   "a 'ga' h:mm:ss z",
		timeMediumLayout: "a 'ga' h:mm:ss",
		timeShortLayout:  "a 'ga' h:mm",
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} kple {1}", "{0}, {1}", "{0}, {1}", "{0}, kple {1}"}, []string(nil)}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"ƒe", "ƒe %v", "ƒe %v", ""},
				Long:   &locales.CounterFormat{"ƒewo", "ƒe %v", "ƒe %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ɣletiwo", "ɣleti %v", "ɣleti %v", ""},
				Long:   &locales.CounterFormat{"ɣletiwo", "ɣleti %v", "ɣleti %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"kɔsiɖa", "kɔsiɖa %v", "kɔsiɖa %v", ""},
				Long:   &locales.CounterFormat{"kɔsiɖawo", "kɔsiɖa %v", "kɔsiɖa %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ŋkeke", "ŋkeke %v", "ŋkeke %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"gaƒoƒo", "gaƒoƒo %v", "gaƒoƒo %v", ""},
				Long:   &locales.CounterFormat{"gaƒoƒowo", "gaƒoƒo %v", "gaƒoƒo %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"aɖabaƒoƒo", "a %v", "a %v", ""},
				Long:   &locales.CounterFormat{"aɖabaƒoƒowo", "aɖabaƒoƒo %v", "aɖabaƒoƒo %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "s %v", "s %v", ""},
				Long:   &locales.CounterFormat{"sekend", "sekend %v wo", "sekend %v wo", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
...
func (ee *ee) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ee, ee.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ee'
func (ee *ee) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ee, ee.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ee'
func (ee *ee) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ee, ee.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ee'
func (ee *ee) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ee, ee.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ee'
func (ee *ee) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ee, ee.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ee'
func (ee *ee) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ee, ee.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ee'
func (ee *ee) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ee, ee.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ee'
func (ee *ee) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ee, ee.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ee'
func (ee *ee) DateFullLayout() string {
	return ee.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ee'
func (ee *ee) DateLongLayout() string {
	return ee.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ee'
func (ee *ee) DateMediumLayout() string {
	return ee.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ee'
func (ee *ee) DateShortLayout() string {
	return ee.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ee'
func (ee *ee) TimeFullLayout() string {
	return ee.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ee'
func (ee *ee) TimeLongLayout() string {
	return ee.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ee'
func (ee *ee) TimeMediumLayout() string {
	return ee.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ee'
func (ee *ee) TimeShortLayout() string {
	return ee.timeShortLayout
}

func (ee *ee) ListPatterns() *locales.ListPatterns {
	return ee.listPatterns
}

func (ee *ee) GetDurationSpec() *locales.DurationSpec {
	return ee.DurationSpec
}

func (ee *ee) GetMiscPatterns() *locales.MiscPatterns {
	return &ee.miscPatterns
}
