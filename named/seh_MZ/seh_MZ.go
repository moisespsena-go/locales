...
func New() locales.Translator {
	return &seh_MZ{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Aug", "Set", "Otu", "Nov", "Dec"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Janeiro", "Fevreiro", "Marco", "Abril", "Maio", "Junho", "Julho", "Augusto", "Setembro", "Otubro", "Novembro", "Decembro"},
			WeekdaysAbbreviatedValue: []string{"Dim", "Pos", "Pir", "Tat", "Nai", "Sha", "Sab"},
			WeekdaysNarrowValue:      []string{"D", "P", "C", "T", "N", "S", "S"},
			WeekdaysWideValue:        []string{"Dimingu", "Chiposi", "Chipiri", "Chitatu", "Chinai", "Chishanu", "Sabudu"},
			ErasAbbreviatedValue:     []string{"AC", "AD"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Antes de Cristo", "Anno Domini"},
...
func (seh *seh_MZ) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(seh, seh.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'seh_MZ'
func (seh *seh_MZ) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(seh, seh.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'seh_MZ'
func (seh *seh_MZ) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(seh, seh.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'seh_MZ'
func (seh *seh_MZ) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(seh, seh.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'seh_MZ'
func (seh *seh_MZ) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(seh, seh.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'seh_MZ'
func (seh *seh_MZ) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(seh, seh.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'seh_MZ'
func (seh *seh_MZ) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(seh, seh.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'seh_MZ'
func (seh *seh_MZ) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(seh, seh.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'seh_MZ'
func (seh *seh_MZ) DateFullLayout() string {
	return seh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'seh_MZ'
func (seh *seh_MZ) DateLongLayout() string {
	return seh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'seh_MZ'
func (seh *seh_MZ) DateMediumLayout() string {
	return seh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'seh_MZ'
func (seh *seh_MZ) DateShortLayout() string {
	return seh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'seh_MZ'
func (seh *seh_MZ) TimeFullLayout() string {
	return seh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'seh_MZ'
func (seh *seh_MZ) TimeLongLayout() string {
	return seh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'seh_MZ'
func (seh *seh_MZ) TimeMediumLayout() string {
	return seh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'seh_MZ'
func (seh *seh_MZ) TimeShortLayout() string {
	return seh.timeShortLayout
}

func (seh *seh_MZ) ListPatterns() *locales.ListPatterns {
	return seh.listPatterns
}

func (seh *seh_MZ) GetDurationSpec() *locales.DurationSpec {
	return seh.DurationSpec
}

func (seh *seh_MZ) GetMiscPatterns() *locales.MiscPatterns {
	return &seh.miscPatterns
}
