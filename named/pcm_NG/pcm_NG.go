...
// DateFullLayout returns the full date layout for 'pcm_NG'
func (pcm *pcm_NG) DateFullLayout() string {
	return pcm.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pcm_NG'
func (pcm *pcm_NG) DateLongLayout() string {
	return pcm.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pcm_NG'
func (pcm *pcm_NG) DateMediumLayout() string {
	return pcm.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pcm_NG'
func (pcm *pcm_NG) DateShortLayout() string {
	return pcm.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pcm_NG'
func (pcm *pcm_NG) TimeFullLayout() string {
	return pcm.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pcm_NG'
func (pcm *pcm_NG) TimeLongLayout() string {
	return pcm.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pcm_NG'
func (pcm *pcm_NG) TimeMediumLayout() string {
	return pcm.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pcm_NG'
func (pcm *pcm_NG) TimeShortLayout() string {
	return pcm.timeShortLayout
}

func (pcm *pcm_NG) ListPatterns() *locales.ListPatterns {
	return pcm.listPatterns
}

func (pcm *pcm_NG) GetDurationSpec() *locales.DurationSpec {
	return pcm.DurationSpec
}

func (pcm *pcm_NG) GetMiscPatterns() *locales.MiscPatterns {
