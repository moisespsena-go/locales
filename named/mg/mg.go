...
// DateFullLayout returns the full date layout for 'mg'
func (mg *mg) DateFullLayout() string {
	return mg.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mg'
func (mg *mg) DateLongLayout() string {
	return mg.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mg'
func (mg *mg) DateMediumLayout() string {
	return mg.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mg'
func (mg *mg) DateShortLayout() string {
	return mg.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mg'
func (mg *mg) TimeFullLayout() string {
	return mg.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mg'
func (mg *mg) TimeLongLayout() string {
	return mg.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mg'
func (mg *mg) TimeMediumLayout() string {
	return mg.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mg'
func (mg *mg) TimeShortLayout() string {
	return mg.timeShortLayout
}

func (mg *mg) ListPatterns() *locales.ListPatterns {
	return mg.listPatterns
}

func (mg *mg) GetDurationSpec() *locales.DurationSpec {
	return mg.DurationSpec
}

func (mg *mg) GetMiscPatterns() *locales.MiscPatterns {
