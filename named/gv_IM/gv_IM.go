...
func New() locales.Translator {
	return &gv_IM{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "J-guer", "T-arree", "Mayrnt", "Avrril", "Boaldyn", "M-souree", "J-souree", "Luanistyn", "M-fouyir", "J-fouyir", "M-Houney", "M-Nollick"},
			MonthsWideValue:          []string{"", "Jerrey-geuree", "Toshiaght-arree", "Mayrnt", "Averil", "Boaldyn", "Mean-souree", "Jerrey-souree", "Luanistyn", "Mean-fouyir", "Jerrey-fouyir", "Mee Houney", "Mee ny Nollick"},
			WeekdaysAbbreviatedValue: []string{"Jed", "Jel", "Jem", "Jerc", "Jerd", "Jeh", "Jes"},
			WeekdaysWideValue:        []string{"Jedoonee", "Jelhein", "Jemayrt", "Jercean", "Jerdein", "Jeheiney", "Jesarn"},
...
func (gv *gv_IM) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(gv, gv.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'gv_IM'
func (gv *gv_IM) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(gv, gv.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'gv_IM'
func (gv *gv_IM) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(gv, gv.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'gv_IM'
func (gv *gv_IM) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(gv, gv.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'gv_IM'
func (gv *gv_IM) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(gv, gv.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'gv_IM'
func (gv *gv_IM) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(gv, gv.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'gv_IM'
func (gv *gv_IM) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(gv, gv.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'gv_IM'
func (gv *gv_IM) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(gv, gv.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'gv_IM'
func (gv *gv_IM) DateFullLayout() string {
	return gv.dateFullLayout
}

// DateLongLayout returns the long date layout for 'gv_IM'
func (gv *gv_IM) DateLongLayout() string {
	return gv.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'gv_IM'
func (gv *gv_IM) DateMediumLayout() string {
	return gv.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'gv_IM'
func (gv *gv_IM) DateShortLayout() string {
	return gv.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'gv_IM'
func (gv *gv_IM) TimeFullLayout() string {
	return gv.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'gv_IM'
func (gv *gv_IM) TimeLongLayout() string {
	return gv.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'gv_IM'
func (gv *gv_IM) TimeMediumLayout() string {
	return gv.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'gv_IM'
func (gv *gv_IM) TimeShortLayout() string {
	return gv.timeShortLayout
}

func (gv *gv_IM) ListPatterns() *locales.ListPatterns {
	return gv.listPatterns
}

func (gv *gv_IM) GetDurationSpec() *locales.DurationSpec {
	return gv.DurationSpec
}

func (gv *gv_IM) GetMiscPatterns() *locales.MiscPatterns {
	return &gv.miscPatterns
}
