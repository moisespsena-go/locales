...
// DateFullLayout returns the full date layout for 'en_LR'
func (en *en_LR) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_LR'
func (en *en_LR) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_LR'
func (en *en_LR) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_LR'
func (en *en_LR) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_LR'
func (en *en_LR) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_LR'
func (en *en_LR) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_LR'
func (en *en_LR) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_LR'
func (en *en_LR) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_LR) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_LR) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_LR) GetMiscPatterns() *locales.MiscPatterns {
