	...
	return &pa{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"ਸਦੀ", "%v ਸਦੀ", "%v ਸਦੀ", ""},
				Long:   &locales.CounterFormat{"ਸਦੀਆਂ", "%v ਸਦੀ", "%v ਸਦੀਆਂ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ਦਹਾ", "%v ਦਹਾ", "%v ਦਹਾ", ""},
				Long:   &locales.CounterFormat{"ਦਹਾਕੇ", "%v ਦਹਾਕੇ", "%v ਦਹਾਕਿਆਂ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ਸਾਲ", "%v ਸਾਲ", "%v ਸਾਲ", ""},
				Long:   &locales.CounterFormat{"ਸਾਲ", "%v ਸਾਲ", "%v ਸਾਲਾਂ", "%v ਪ੍ਰਤੀ ਸਾਲ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ਮਹੀਨਾ", "%v ਮਹੀਨਾ", "%v ਮਹੀਨੇ", ""},
				Long:   &locales.CounterFormat{"ਮਹੀਨੇ", "%v ਮਹੀਨੇ", "%v ਮਹੀਨਿਆਂ", "%v ਪ੍ਰਤੀ ਮਹੀਨਾ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ਹਫ਼ਤਾ", "%v ਹਫ਼ਤਾ", "%v ਹਫ਼ਤੇ", ""},
				Long:   &locales.CounterFormat{"ਹਫ਼ਤੇ", "%v ਹਫ਼ਤੇ", "%v ਹਫ਼ਤਿਆਂ", "%v ਪ੍ਰਤੀ ਹਫ਼ਤਾ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ਦਿਨ", "%v ਦਿਨ", "%v ਦਿਨ", "%v/ਦਿਨ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ਘੰਟਾ", "%v ਘੰਟਾ", "%v ਘੰਟੇ", "%v/ਘੰ"},
				Long:   &locales.CounterFormat{"ਘੰਟੇ", "%v ਘੰਟੇ", "%v ਘੰਟਿਆਂ", "%v ਪ੍ਰਤੀ ਘੰਟਾ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ਮਿੰਟ", "%v ਮਿੰਟ", "%v ਮਿੰਟ", "%v/ਮਿੰਟ"},
				Long:   &locales.CounterFormat{"ਮਿੰਟ", "%v ਮਿੰਟ", "%v ਮਿੰਟਾਂ", "%v ਪ੍ਰਤੀ ਮਿੰਟ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ਸਕਿੰਟ", "%v ਸਕਿੰਟ", "%v ਸਕਿੰਟ", "%v/ਸਕਿੰ"},
				Long:   &locales.CounterFormat{"ਸਕਿੰਟ", "%v ਸਕਿੰਟ", "%v ਸਕਿੰਟਾਂ", "%v ਪ੍ਰਤੀ ਸਕਿੰਟ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ਮਿਲੀਸਕਿੰਟ", "%v ਮਿ.ਸ.", "%v ਮਿ.ਸ.", ""},
				Long:   &locales.CounterFormat{"ਮਿਲੀਸਕਿੰਟ", "%v ਮਿਲੀਸਕਿੰਟ", "%v ਮਿਲੀਸਕਿੰਟ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"ਮਾਈਕਰੋਸਕਿੰਟ", "%v ਮਾਈਕਰੋਸਕਿੰਟ", "%v ਮਾਈਕਰੋਸਕਿੰਟ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"ਨੈਨੋਸਕਿੰਟ", "%v ਨੈਨੋਸਕਿੰਟ", "%v ਨੈਨੋਸਕਿੰਟ", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
// DateFullLayout returns the full date layout for 'pa'
func (pa *pa) DateFullLayout() string {
	return pa.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pa'
func (pa *pa) DateLongLayout() string {
	return pa.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pa'
func (pa *pa) DateMediumLayout() string {
	return pa.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pa'
func (pa *pa) DateShortLayout() string {
	return pa.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pa'
func (pa *pa) TimeFullLayout() string {
	return pa.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pa'
func (pa *pa) TimeLongLayout() string {
	return pa.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pa'
func (pa *pa) TimeMediumLayout() string {
	return pa.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pa'
func (pa *pa) TimeShortLayout() string {
	return pa.timeShortLayout
}

func (pa *pa) ListPatterns() *locales.ListPatterns {
	return pa.listPatterns
}

func (pa *pa) GetDurationSpec() *locales.DurationSpec {
	return pa.DurationSpec
}

func (pa *pa) GetMiscPatterns() *locales.MiscPatterns {
