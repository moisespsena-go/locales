...
// DateFullLayout returns the full date layout for 'ms'
func (ms *ms) DateFullLayout() string {
	return ms.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ms'
func (ms *ms) DateLongLayout() string {
	return ms.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ms'
func (ms *ms) DateMediumLayout() string {
	return ms.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ms'
func (ms *ms) DateShortLayout() string {
	return ms.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ms'
func (ms *ms) TimeFullLayout() string {
	return ms.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ms'
func (ms *ms) TimeLongLayout() string {
	return ms.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ms'
func (ms *ms) TimeMediumLayout() string {
	return ms.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ms'
func (ms *ms) TimeShortLayout() string {
	return ms.timeShortLayout
}

func (ms *ms) ListPatterns() *locales.ListPatterns {
	return ms.listPatterns
}

func (ms *ms) GetDurationSpec() *locales.DurationSpec {
	return ms.DurationSpec
}

func (ms *ms) GetMiscPatterns() *locales.MiscPatterns {
