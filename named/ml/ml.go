	...
	return &ml{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"നൂ.", "%v നൂ.", "%v നൂ.", ""},
				Long:   &locales.CounterFormat{"നൂറ്റാണ്ടുകൾ", "%v നൂറ്റാണ്ടിനോട്", "%v നൂറ്റാണ്ടുകൾ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vദശാ.", "%vദശാ.", ""},
				Long:   &locales.CounterFormat{"ദശാബ്\u200cദം", "%v ദശാബ്\u200cദത്തിനോട്", "%v ദശാബ്\u200cദങ്ങളോട്", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"വ", "%v വ", "%v വ", "%v/വ."},
				Long:   &locales.CounterFormat{"വർഷം", "%v വർഷത്തിന്റെ", "%v വർഷം", "%v / വർഷം"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"മാസം", "%v മാ", "%v മാ", "%v/മാ."},
				Long:   &locales.CounterFormat{"മാസം", "%v മാസം", "%v മാസം", "%v / മാസം"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ആ", "%v ആ", "%v ആ", "%v/ആ."},
				Long:   &locales.CounterFormat{"ആഴ്ച", "%v ആഴ്ച", "%v ആഴ്ച", "%v / ആഴ്ച"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ദിവസം", "%v ദി", "%v ദി", "%v/ദി."}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"മണിക്കൂർ", "%v മ", "%v മ", "%v/മ."},
				Long:   &locales.CounterFormat{"മണിക്കൂർ", "%v മണിക്കൂർ", "%v മണിക്കൂർ", "%v / മണിക്കൂർ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"മി.", "%v മി.", "%v മി.", "%v/മി."},
				Long:   &locales.CounterFormat{"മിനിറ്റ്", "%v മിനിറ്റ്", "%v മിനിറ്റ്", "%v / മിനിറ്റ്"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"സെ.", "%v സെ.", "%v സെ.", "%v/സെ."},
				Long:   &locales.CounterFormat{"സെക്കൻഡ്", "%v സെക്കൻഡ്", "%v സെക്കൻഡ്", "%v / സെക്കൻഡ്"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"മി.സെ.", "%v മി.സെ.", "%v മി.സെ.", ""},
				Long:   &locales.CounterFormat{"മില്ലിസെക്കൻഡ്", "%v മില്ലിസെക്കൻഡ്", "%v മില്ലിസെക്കൻഡ്", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μ.സെ.", "%v μ.സെ.", "%v μ.സെ.", ""},
				Long:   &locales.CounterFormat{"മൈക്രോസെക്കൻഡ്", "%v മൈക്രോസെക്കൻഡ്", "%v മൈക്രോസെക്കൻഡ്", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"നാ.സെ.", "%v നാ.സെ.", "%v നാ.സെ.", ""},
				Long:   &locales.CounterFormat{"നാനോസെക്കൻഡ്", "%v നാനോസെക്കൻഡ്", "%v നാനോസെക്കൻഡ്", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
// DateFullLayout returns the full date layout for 'ml'
func (ml *ml) DateFullLayout() string {
	return ml.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ml'
func (ml *ml) DateLongLayout() string {
	return ml.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ml'
func (ml *ml) DateMediumLayout() string {
	return ml.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ml'
func (ml *ml) DateShortLayout() string {
	return ml.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ml'
func (ml *ml) TimeFullLayout() string {
	return ml.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ml'
func (ml *ml) TimeLongLayout() string {
	return ml.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ml'
func (ml *ml) TimeMediumLayout() string {
	return ml.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ml'
func (ml *ml) TimeShortLayout() string {
	return ml.timeShortLayout
}

func (ml *ml) ListPatterns() *locales.ListPatterns {
	return ml.listPatterns
}

func (ml *ml) GetDurationSpec() *locales.DurationSpec {
	return ml.DurationSpec
}

func (ml *ml) GetMiscPatterns() *locales.MiscPatterns {
