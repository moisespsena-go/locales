...
// DateFullLayout returns the full date layout for 'sv_SE'
func (sv *sv_SE) DateFullLayout() string {
	return sv.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sv_SE'
func (sv *sv_SE) DateLongLayout() string {
	return sv.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sv_SE'
func (sv *sv_SE) DateMediumLayout() string {
	return sv.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sv_SE'
func (sv *sv_SE) DateShortLayout() string {
	return sv.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sv_SE'
func (sv *sv_SE) TimeFullLayout() string {
	return sv.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sv_SE'
func (sv *sv_SE) TimeLongLayout() string {
	return sv.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sv_SE'
func (sv *sv_SE) TimeMediumLayout() string {
	return sv.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sv_SE'
func (sv *sv_SE) TimeShortLayout() string {
	return sv.timeShortLayout
}

func (sv *sv_SE) ListPatterns() *locales.ListPatterns {
	return sv.listPatterns
}

func (sv *sv_SE) GetDurationSpec() *locales.DurationSpec {
	return sv.DurationSpec
}

func (sv *sv_SE) GetMiscPatterns() *locales.MiscPatterns {
