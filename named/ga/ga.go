...
func New() locales.Translator {
	return &ga{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Ean", "Feabh", "Márta", "Aib", "Beal", "Meith", "Iúil", "Lún", "MFómh", "DFómh", "Samh", "Noll"},
			MonthsNarrowValue:        []string{"", "E", "F", "M", "A", "B", "M", "I", "L", "M", "D", "S", "N"},
			MonthsWideValue:          []string{"", "Eanáir", "Feabhra", "Márta", "Aibreán", "Bealtaine", "Meitheamh", "Iúil", "Lúnasa", "Meán Fómhair", "Deireadh Fómhair", "Samhain", "Nollaig"},
			WeekdaysAbbreviatedValue: []string{"Domh", "Luan", "Máirt", "Céad", "Déar", "Aoine", "Sath"},
			WeekdaysNarrowValue:      []string{"D", "L", "M", "C", "D", "A", "S"},
			WeekdaysShortValue:       []string{"Do", "Lu", "Má", "Cé", "Dé", "Ao", "Sa"},
			WeekdaysWideValue:        []string{"Dé Domhnaigh", "Dé Luain", "Dé Máirt", "Dé Céadaoin", "Déardaoin", "Dé hAoine", "Dé Sathairn"},
			PeriodsAbbreviatedValue:  []string{"r.n.", "i.n."},
			PeriodsNarrowValue:       []string{"r.n.", "i.n."},
			PeriodsWideValue:         []string{"r.n.", "i.n."},
			ErasAbbreviatedValue:     []string{"RC", "AD"},
			ErasNarrowValue:          []string{"RC", "AD"},
			ErasWideValue:            []string{"Roimh Chríost", "Anno Domini"},
			TimezonesValue:           map[string]string{"": "Am Caighdeánach Pharagua", "ACDT": "Am Samhraidh Lár na hAstráile", "ACST": "Am Caighdeánach Lár na hAstráile", "ACT": "Am Caighdeánach Acre", "ACWDT": "Am Samhraidh Mheániarthar na hAstráile", "ACWST": "Am Caighdeánach Mheániarthar na hAstráile", "ADT": "Am Samhraidh an Atlantaigh", "AEDT": "Am Samhraidh Oirthear na hAstráile", "AEST": "Am Caighdeánach Oirthear na hAstráile", "AFT": "Am na hAfganastáine", "AKDT": "Am Samhraidh Alasca", "AKST": "Am Caighdeánach Alasca", "AMST": "Am Samhraidh na hAmasóine", "AMT": "Am Caighdeánach na hAmasóine", "ARST": "Am Samhraidh na hAirgintíne", "ART": "Am Caighdeánach na hAirgintíne", "AST": "Am Caighdeánach an Atlantaigh", "AWDT": "Am Samhraidh Iarthar na hAstráile", "AWST": "Am Caighdeánach Iarthar na hAstráile", "BNT": "Am Bhrúiné Darasalám", "BOT": "Am na Bolaive", "BRST": "Am Samhraidh Bhrasília", "BRT": "Am Caighdeánach Bhrasília", "BST": "Am Samhraidh na Banglaidéise", "BTT": "Am na Bútáine", "CAT": "Am na hAfraice Láir", "CCT": "Am Oileáin Cocos", "CDT": "Am Samhraidh Lárnach Mheiriceá Thuaidh", "CDT (Kuba)": "Am Samhraidh Chúba", "CHADT": "Am Samhraidh Chatham", "CHAST": "Am Caighdeánach Chatham", "CLST": "Am Samhraidh na Sile", "CLT": "Am Caighdeánach na Sile", "COST": "Am Samhraidh na Colóime", "COT": "Am Caighdeánach na Colóime", "CST": "Am Caighdeánach Lárnach Mheiriceá Thuaidh", "CST (Kuba)": "Am Caighdeánach Chúba", "CXT": "Am Oileán na Nollag", "ChST": "Am Caighdeánach Seamórach", "EASST": "Am Samhraidh Oileán na Cásca", "EAST": "Am Caighdeánach Oileán na Cásca", "EAT": "Am Oirthear na hAfraice", "ECT": "Am Eacuadór", "EDT": "Am Samhraidh Oirthearach Mheiriceá Thuaidh", "EGDT": "Am Samhraidh Oirthear na Graonlainne", "EGST": "Am Caighdeánach Oirthear na Graonlainne", "EST": "Am Caighdeánach Oirthearach Mheiriceá Thuaidh", "FKST": "Am Samhraidh Oileáin Fháclainne", "GALT": "Am Oileáin Galápagos", "GFT": "Am Ghuáin na Fraince", "GMT": "Meán-Am Greenwich", "GST": "Am Caighdeánach na Murascaille", "GYT": "Am na Guáine", "HADT": "Am Samhraidh Haváí-Ailiúit", "HAST": "Am Caighdeánach Haváí-Ailiúit", "HENOMX": "Am Samhraidh Iarthuaisceart Mheicsiceo", "HEOG": "Am Samhraidh Iarthar na Graonlainne", "HEPMX": "Am Samhraidh Meicsiceach an Aigéin Chiúin", "HKST": "Am Samhraidh Hong Cong", "HKT": "Am Caighdeánach Hong Cong", "HNNOMX": "Am Caighdeánach Iarthuaisceart Mheicsiceo", "HNOG": "Am Caighdeánach Iarthar na Graonlainne", "HNPMX": "Am Caighdeánach Meicsiceach an Aigéin Chiúin", "ICT": "Am na hInd-Síne", "IRDT": "Am Samhraidh na hIaráine", "IRST": "Am Caighdeánach na hIaráine", "IST": "Am Caighdeánach na hIndia", "JDT": "Am Samhraidh na Seapáine", "JST": "Am Caighdeánach na Seapáine", "LHDT": "Am Samhraidh Lord Howe", "LHST": "Am Caighdeánach Lord Howe", "MDT": "Am Samhraidh Sléibhte Mheiriceá Thuaidh", "MESZ": "Am Samhraidh Lár na hEorpa", "MEZ": "Am Caighdeánach Lár na hEorpa", "MST": "Am Caighdeánach Sléibhte Mheiriceá Thuaidh", "MVT": "Am Oileáin Mhaildíve", "MYT": "Am na Malaeisia", "NDT": "Am Samhraidh Thalamh an Éisc", "NPT": "Am Neipeal", "NST": "Am Caighdeánach Thalamh an Éisc", "NZDT": "Am Samhraidh na Nua-Shéalainne", "NZST": "Am Caighdeánach na Nua-Shéalainne", "OESZ": "Am Samhraidh Oirthear na hEorpa", "OEZ": "Am Caighdeánach Oirthear na hEorpa", "PDT": "Am Samhraidh an Aigéin Chiúin", "PKT": "Am Samhraidh na Pacastáine", "PMDT": "Am Samhraidh Saint-Pierre-et-Miquelon", "PMST": "Am Caighdeánach Saint-Pierre-et-Miquelon", "PST": "Am Caighdeánach an Aigéin Chiúin", "PYST": "Am Samhraidh Pharagua", "SAST": "Am na hAfraice Theas", "SGT": "Am Caighdeánach Shingeapór", "SRT": "Am Shuranam", "TLT": "Am Thíomór Thoir", "TMST": "Am Samhraidh na Tuircméanastáine", "TMT": "Am Caighdeánach na Tuircméanastáine", "UYST": "Am Samhraidh Uragua", "UYT": "Am Caighdeánach Uragua", "VET": "Am Veiniséala", "WARST": "Am Samhraidh Iartharach na hAirgintíne", "WART": "Am Caighdeánach Iartharach na hAirgintíne", "WAST": "Am Samhraidh Iarthar na hAfraice", "WAT": "Am Caighdeánach Iarthar na hAfraice", "WESZ": "Am Samhraidh Iarthar na hEorpa", "WEZ": "Am Caighdeánach Iarthar na hEorpa", "WIB": "Am Iarthar na hIndinéise", "WIT": "Am Oirthear na hIndinéise", "WITA": "Am Lár na hIndinéise", "∅∅∅": "Am Samhraidh Pheiriú"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} agus {1}", "{0}, {1}", "{0}, {1}", "{0} agus {1}"}, {"{0} nó {1}", "{0}, {1}", "{0}, {1}", "{0}, nó {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"c", "%v c", "%v c", ""},
				Long:   &locales.CounterFormat{"céadta bliain", "%v chéad bliain", "%v céad bliain", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"deicheanna blianta", "%v deich mbliana", "%v deich mbliana", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"bl", "%vb", "%vb", "%v/bl"},
				Long:   &locales.CounterFormat{"blianta", "%v bhliain", "%v bliain", "%v sa bhliain"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mí", "%vm", "%vm", "%v/mí"},
				Long:   &locales.CounterFormat{"míonna", "%v mhí", "%v mí", "%v sa mhí"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"scht", "%vs", "%vs", "%v/scht"},
				Long:   &locales.CounterFormat{"seachtainí", "%v seachtain", "%v seachtain", "%v sa tseachtain"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"lá", "%vl", "%vl", "%v/lá"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"uair", "%vu", "%vu", "%v/u"},
				Long:   &locales.CounterFormat{"uaireanta", "%v uair", "%v uair", "%v san uair"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"nóim", "%vn", "%vn", "%v/nóim"},
				Long:   &locales.CounterFormat{"nóiméid", "%v nóiméad", "%v nóiméad", "%v sa nóiméad"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"soic", "%vs", "%vs", "%v/s"},
				Long:   &locales.CounterFormat{"soicindí", "%v soicind", "%v soicind", "%v sa soicind"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"milleasoicindí", "%v mhilleasoicind", "%v milleasoicind", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%vμs", "%vμs", ""},
				Long:   &locales.CounterFormat{"micreashoicindí", "%v mhicreashoicind", "%v micreashoicind", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%vns", "%vns", ""},
				Long:   &locales.CounterFormat{"nanashoicindí", "%v nanashoicind", "%v nanashoicind", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (ga *ga) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ga, ga.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ga'
func (ga *ga) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ga, ga.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ga'
func (ga *ga) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ga, ga.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ga'
func (ga *ga) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ga, ga.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ga'
func (ga *ga) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ga, ga.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ga'
func (ga *ga) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ga, ga.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ga'
func (ga *ga) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ga, ga.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ga'
func (ga *ga) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ga, ga.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ga'
func (ga *ga) DateFullLayout() string {
	return ga.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ga'
func (ga *ga) DateLongLayout() string {
	return ga.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ga'
func (ga *ga) DateMediumLayout() string {
	return ga.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ga'
func (ga *ga) DateShortLayout() string {
	return ga.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ga'
func (ga *ga) TimeFullLayout() string {
	return ga.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ga'
func (ga *ga) TimeLongLayout() string {
	return ga.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ga'
func (ga *ga) TimeMediumLayout() string {
	return ga.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ga'
func (ga *ga) TimeShortLayout() string {
	return ga.timeShortLayout
}

func (ga *ga) ListPatterns() *locales.ListPatterns {
	return ga.listPatterns
}

func (ga *ga) GetDurationSpec() *locales.DurationSpec {
	return ga.DurationSpec
}

func (ga *ga) GetMiscPatterns() *locales.MiscPatterns {
	return &ga.miscPatterns
}
