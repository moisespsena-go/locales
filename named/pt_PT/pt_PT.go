	...
	return &pt_PT{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"", "%v h", "%v h", "%v/h"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%v min", "%v min", ""},
				Long:   &locales.CounterFormat{"minutos", "%v min", "%v min", "%v/min"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"s", "%v s", "%v s", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"", "%v ms", "%v ms", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"μs", "%v μs", "%v μs", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"ns", "%v ns", "%v ns", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"+%[1]v",
...
// DateFullLayout returns the full date layout for 'pt_PT'
func (pt *pt_PT) DateFullLayout() string {
	return pt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pt_PT'
func (pt *pt_PT) DateLongLayout() string {
	return pt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pt_PT'
func (pt *pt_PT) DateMediumLayout() string {
	return pt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pt_PT'
func (pt *pt_PT) DateShortLayout() string {
	return pt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pt_PT'
func (pt *pt_PT) TimeFullLayout() string {
	return pt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pt_PT'
func (pt *pt_PT) TimeLongLayout() string {
	return pt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pt_PT'
func (pt *pt_PT) TimeMediumLayout() string {
	return pt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pt_PT'
func (pt *pt_PT) TimeShortLayout() string {
	return pt.timeShortLayout
}

func (pt *pt_PT) ListPatterns() *locales.ListPatterns {
	return pt.listPatterns
}

func (pt *pt_PT) GetDurationSpec() *locales.DurationSpec {
	return pt.DurationSpec
}

func (pt *pt_PT) GetMiscPatterns() *locales.MiscPatterns {
