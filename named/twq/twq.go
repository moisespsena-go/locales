...
// DateFullLayout returns the full date layout for 'twq'
func (twq *twq) DateFullLayout() string {
	return twq.dateFullLayout
}

// DateLongLayout returns the long date layout for 'twq'
func (twq *twq) DateLongLayout() string {
	return twq.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'twq'
func (twq *twq) DateMediumLayout() string {
	return twq.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'twq'
func (twq *twq) DateShortLayout() string {
	return twq.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'twq'
func (twq *twq) TimeFullLayout() string {
	return twq.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'twq'
func (twq *twq) TimeLongLayout() string {
	return twq.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'twq'
func (twq *twq) TimeMediumLayout() string {
	return twq.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'twq'
func (twq *twq) TimeShortLayout() string {
	return twq.timeShortLayout
}

func (twq *twq) ListPatterns() *locales.ListPatterns {
	return twq.listPatterns
}

func (twq *twq) GetDurationSpec() *locales.DurationSpec {
	return twq.DurationSpec
}

func (twq *twq) GetMiscPatterns() *locales.MiscPatterns {
