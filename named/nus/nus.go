...
// DateFullLayout returns the full date layout for 'nus'
func (nus *nus) DateFullLayout() string {
	return nus.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nus'
func (nus *nus) DateLongLayout() string {
	return nus.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nus'
func (nus *nus) DateMediumLayout() string {
	return nus.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nus'
func (nus *nus) DateShortLayout() string {
	return nus.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nus'
func (nus *nus) TimeFullLayout() string {
	return nus.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nus'
func (nus *nus) TimeLongLayout() string {
	return nus.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nus'
func (nus *nus) TimeMediumLayout() string {
	return nus.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nus'
func (nus *nus) TimeShortLayout() string {
	return nus.timeShortLayout
}

func (nus *nus) ListPatterns() *locales.ListPatterns {
	return nus.listPatterns
}

func (nus *nus) GetDurationSpec() *locales.DurationSpec {
	return nus.DurationSpec
}

func (nus *nus) GetMiscPatterns() *locales.MiscPatterns {
