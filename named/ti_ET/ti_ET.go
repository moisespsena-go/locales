...
// DateFullLayout returns the full date layout for 'ti_ET'
func (ti *ti_ET) DateFullLayout() string {
	return ti.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ti_ET'
func (ti *ti_ET) DateLongLayout() string {
	return ti.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ti_ET'
func (ti *ti_ET) DateMediumLayout() string {
	return ti.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ti_ET'
func (ti *ti_ET) DateShortLayout() string {
	return ti.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ti_ET'
func (ti *ti_ET) TimeFullLayout() string {
	return ti.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ti_ET'
func (ti *ti_ET) TimeLongLayout() string {
	return ti.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ti_ET'
func (ti *ti_ET) TimeMediumLayout() string {
	return ti.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ti_ET'
func (ti *ti_ET) TimeShortLayout() string {
	return ti.timeShortLayout
}

func (ti *ti_ET) ListPatterns() *locales.ListPatterns {
	return ti.listPatterns
}

func (ti *ti_ET) GetDurationSpec() *locales.DurationSpec {
	return ti.DurationSpec
}

func (ti *ti_ET) GetMiscPatterns() *locales.MiscPatterns {
