...
// DateFullLayout returns the full date layout for 'az_Latn'
func (az *az_Latn) DateFullLayout() string {
	return az.dateFullLayout
}

// DateLongLayout returns the long date layout for 'az_Latn'
func (az *az_Latn) DateLongLayout() string {
	return az.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'az_Latn'
func (az *az_Latn) DateMediumLayout() string {
	return az.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'az_Latn'
func (az *az_Latn) DateShortLayout() string {
	return az.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'az_Latn'
func (az *az_Latn) TimeFullLayout() string {
	return az.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'az_Latn'
func (az *az_Latn) TimeLongLayout() string {
	return az.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'az_Latn'
func (az *az_Latn) TimeMediumLayout() string {
	return az.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'az_Latn'
func (az *az_Latn) TimeShortLayout() string {
	return az.timeShortLayout
}

func (az *az_Latn) ListPatterns() *locales.ListPatterns {
	return az.listPatterns
}

func (az *az_Latn) GetDurationSpec() *locales.DurationSpec {
	return az.DurationSpec
}

func (az *az_Latn) GetMiscPatterns() *locales.MiscPatterns {
