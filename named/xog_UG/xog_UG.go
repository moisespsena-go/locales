...
func New() locales.Translator {
	return &xog_UG{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mar", "Apu", "Maa", "Juu", "Jul", "Agu", "Seb", "Oki", "Nov", "Des"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Janwaliyo", "Febwaliyo", "Marisi", "Apuli", "Maayi", "Juuni", "Julaayi", "Agusito", "Sebuttemba", "Okitobba", "Novemba", "Desemba"},
			WeekdaysAbbreviatedValue: []string{"Sabi", "Bala", "Kubi", "Kusa", "Kuna", "Kuta", "Muka"},
			WeekdaysNarrowValue:      []string{"S", "B", "B", "S", "K", "K", "M"},
			WeekdaysWideValue:        []string{"Sabiiti", "Balaza", "Owokubili", "Owokusatu", "Olokuna", "Olokutaanu", "Olomukaaga"},
			PeriodsAbbreviatedValue:  []string{"Munkyo", "Eigulo"},
			PeriodsWideValue:         []string{"Munkyo", "Eigulo"},
			ErasAbbreviatedValue:     []string{"AZ", "AF"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Kulisto nga azilawo", "Kulisto nga affile"},
...
func (xog *xog_UG) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(xog, xog.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'xog_UG'
func (xog *xog_UG) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(xog, xog.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'xog_UG'
func (xog *xog_UG) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(xog, xog.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'xog_UG'
func (xog *xog_UG) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(xog, xog.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'xog_UG'
func (xog *xog_UG) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(xog, xog.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'xog_UG'
func (xog *xog_UG) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(xog, xog.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'xog_UG'
func (xog *xog_UG) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(xog, xog.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'xog_UG'
func (xog *xog_UG) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(xog, xog.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'xog_UG'
func (xog *xog_UG) DateFullLayout() string {
	return xog.dateFullLayout
}

// DateLongLayout returns the long date layout for 'xog_UG'
func (xog *xog_UG) DateLongLayout() string {
	return xog.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'xog_UG'
func (xog *xog_UG) DateMediumLayout() string {
	return xog.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'xog_UG'
func (xog *xog_UG) DateShortLayout() string {
	return xog.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'xog_UG'
func (xog *xog_UG) TimeFullLayout() string {
	return xog.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'xog_UG'
func (xog *xog_UG) TimeLongLayout() string {
	return xog.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'xog_UG'
func (xog *xog_UG) TimeMediumLayout() string {
	return xog.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'xog_UG'
func (xog *xog_UG) TimeShortLayout() string {
	return xog.timeShortLayout
}

func (xog *xog_UG) ListPatterns() *locales.ListPatterns {
	return xog.listPatterns
}

func (xog *xog_UG) GetDurationSpec() *locales.DurationSpec {
	return xog.DurationSpec
}

func (xog *xog_UG) GetMiscPatterns() *locales.MiscPatterns {
	return &xog.miscPatterns
}
