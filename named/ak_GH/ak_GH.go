...
func New() locales.Translator {
	return &ak_GH{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "S-Ɔ", "K-Ɔ", "E-Ɔ", "E-O", "E-K", "O-A", "A-K", "D-Ɔ", "F-Ɛ", "Ɔ-A", "Ɔ-O", "M-Ɔ"},
			MonthsWideValue:          []string{"", "Sanda-Ɔpɛpɔn", "Kwakwar-Ɔgyefuo", "Ebɔw-Ɔbenem", "Ebɔbira-Oforisuo", "Esusow Aketseaba-Kɔtɔnimba", "Obirade-Ayɛwohomumu", "Ayɛwoho-Kitawonsa", "Difuu-Ɔsandaa", "Fankwa-Ɛbɔ", "Ɔbɛsɛ-Ahinime", "Ɔberɛfɛw-Obubuo", "Mumu-Ɔpɛnimba"},
			WeekdaysAbbreviatedValue: []string{"Kwe", "Dwo", "Ben", "Wuk", "Yaw", "Fia", "Mem"},
			WeekdaysNarrowValue:      []string{"K", "D", "B", "W", "Y", "F", "M"},
			WeekdaysWideValue:        []string{"Kwesida", "Dwowda", "Benada", "Wukuda", "Yawda", "Fida", "Memeneda"},
			PeriodsAbbreviatedValue:  []string{"AN", "EW"},
			PeriodsWideValue:         []string{"AN", "EW"},
			ErasAbbreviatedValue:     []string{"AK", "KE"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Ansa Kristo", "Kristo Ekyiri"},
...
func (ak *ak_GH) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ak, ak.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ak_GH'
func (ak *ak_GH) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ak, ak.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ak_GH'
func (ak *ak_GH) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ak, ak.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ak_GH'
func (ak *ak_GH) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ak, ak.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ak_GH'
func (ak *ak_GH) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ak, ak.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ak_GH'
func (ak *ak_GH) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ak, ak.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ak_GH'
func (ak *ak_GH) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ak, ak.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ak_GH'
func (ak *ak_GH) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ak, ak.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ak_GH'
func (ak *ak_GH) DateFullLayout() string {
	return ak.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ak_GH'
func (ak *ak_GH) DateLongLayout() string {
	return ak.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ak_GH'
func (ak *ak_GH) DateMediumLayout() string {
	return ak.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ak_GH'
func (ak *ak_GH) DateShortLayout() string {
	return ak.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ak_GH'
func (ak *ak_GH) TimeFullLayout() string {
	return ak.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ak_GH'
func (ak *ak_GH) TimeLongLayout() string {
	return ak.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ak_GH'
func (ak *ak_GH) TimeMediumLayout() string {
	return ak.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ak_GH'
func (ak *ak_GH) TimeShortLayout() string {
	return ak.timeShortLayout
}

func (ak *ak_GH) ListPatterns() *locales.ListPatterns {
	return ak.listPatterns
}

func (ak *ak_GH) GetDurationSpec() *locales.DurationSpec {
	return ak.DurationSpec
}

func (ak *ak_GH) GetMiscPatterns() *locales.MiscPatterns {
	return &ak.miscPatterns
}
