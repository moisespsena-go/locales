...
// DateFullLayout returns the full date layout for 'en_GU'
func (en *en_GU) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_GU'
func (en *en_GU) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_GU'
func (en *en_GU) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_GU'
func (en *en_GU) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_GU'
func (en *en_GU) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_GU'
func (en *en_GU) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_GU'
func (en *en_GU) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_GU'
func (en *en_GU) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_GU) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_GU) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_GU) GetMiscPatterns() *locales.MiscPatterns {
