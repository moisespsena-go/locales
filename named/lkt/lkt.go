...
// DateFullLayout returns the full date layout for 'lkt'
func (lkt *lkt) DateFullLayout() string {
	return lkt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'lkt'
func (lkt *lkt) DateLongLayout() string {
	return lkt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'lkt'
func (lkt *lkt) DateMediumLayout() string {
	return lkt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'lkt'
func (lkt *lkt) DateShortLayout() string {
	return lkt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'lkt'
func (lkt *lkt) TimeFullLayout() string {
	return lkt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'lkt'
func (lkt *lkt) TimeLongLayout() string {
	return lkt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'lkt'
func (lkt *lkt) TimeMediumLayout() string {
	return lkt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'lkt'
func (lkt *lkt) TimeShortLayout() string {
	return lkt.timeShortLayout
}

func (lkt *lkt) ListPatterns() *locales.ListPatterns {
	return lkt.listPatterns
}

func (lkt *lkt) GetDurationSpec() *locales.DurationSpec {
	return lkt.DurationSpec
}

func (lkt *lkt) GetMiscPatterns() *locales.MiscPatterns {
