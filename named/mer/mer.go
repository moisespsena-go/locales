...
// DateFullLayout returns the full date layout for 'mer'
func (mer *mer) DateFullLayout() string {
	return mer.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mer'
func (mer *mer) DateLongLayout() string {
	return mer.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mer'
func (mer *mer) DateMediumLayout() string {
	return mer.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mer'
func (mer *mer) DateShortLayout() string {
	return mer.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mer'
func (mer *mer) TimeFullLayout() string {
	return mer.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mer'
func (mer *mer) TimeLongLayout() string {
	return mer.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mer'
func (mer *mer) TimeMediumLayout() string {
	return mer.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mer'
func (mer *mer) TimeShortLayout() string {
	return mer.timeShortLayout
}

func (mer *mer) ListPatterns() *locales.ListPatterns {
	return mer.listPatterns
}

func (mer *mer) GetDurationSpec() *locales.DurationSpec {
	return mer.DurationSpec
}

func (mer *mer) GetMiscPatterns() *locales.MiscPatterns {
