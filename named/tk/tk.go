...
func New() locales.Translator {
	return &tk{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 müň ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 müň ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 müň ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 müň ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 müň ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 müň ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ýan", "few", "mart", "apr", "maý", "iýun", "iýul", "awg", "sen", "okt", "noý", "dek"},
			MonthsNarrowValue:        []string{"", "Ý", "F", "M", "A", "M", "I", "I", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "ýanwar", "fewral", "mart", "aprel", "maý", "iýun", "iýul", "awgust", "sentýabr", "oktýabr", "noýabr", "dekabr"},
			WeekdaysAbbreviatedValue: []string{"ýek", "duş", "siş", "çar", "pen", "ann", "şen"},
			WeekdaysNarrowValue:      []string{"Ý", "D", "S", "Ç", "P", "A", "Ş"},
			WeekdaysShortValue:       []string{"ýb", "db", "sb", "çb", "pb", "an", "şb"},
			WeekdaysWideValue:        []string{"ýekşenbe", "duşenbe", "sişenbe", "çarşenbe", "penşenbe", "anna", "şenbe"},
			PeriodsAbbreviatedValue:  []string{"go.öň", "go.soň"},
			PeriodsNarrowValue:       []string{"öň", "soň"},
			PeriodsWideValue:         []string{"günortadan öň", "günortadan soň"},
			ErasAbbreviatedValue:     []string{"B.e.öň", "B.e."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Isadan öň", "Isadan soň"},
			TimezonesValue:           map[string]string{"": "Paragwaý standart wagty", "ACDT": "Merkezi Awstraliýa tomusky wagty", "ACST": "Merkezi Awstraliýa standart wagty", "ACT": "ACT", "ACWDT": "Merkezi Awstraliýa günbatar tomusky wagty", "ACWST": "Merkezi Awstraliýa günbatar standart wagty", "ADT": "Atlantik tomusky wagty", "AEDT": "Gündogar Awstraliýa tomusky wagty", "AEST": "Gündogar Awstraliýa standart wagty", "AFT": "Owganystan wagty", "AKDT": "Alýaska tomusky wagty", "AKST": "Alýaska standart wagty", "AMST": "Amazon tomusky wagty", "AMT": "Amazon standart wagty", "ARST": "Argentina tomusky wagty", "ART": "Argentina standart wagty", "AST": "Atlantik standart wagty", "AWDT": "Günbatar Awstraliýa tomusky wagty", "AWST": "Günbatar Awstraliýa standart wagty", "BNT": "Bruneý-Darussalam wagty", "BOT": "Boliwiýa wagty", "BRST": "Braziliýa tomusky wagty", "BRT": "Braziliýa standart wagty", "BST": "Bangladeş tomusky wagty", "BTT": "Butan wagty", "CAT": "Merkezi Afrika wagty", "CCT": "Kokos adalary wagty", "CDT": "Merkezi Amerika tomusky wagty", "CDT (Kuba)": "Kuba tomusky wagty", "CHADT": "Çatem tomusky wagty", "CHAST": "Çatem standart wagty", "CLST": "Çili tomusky wagty", "CLT": "Çili standart wagty", "COST": "Kolumbiýa tomusky wagty", "COT": "Kolumbiýa standart wagty", "CST": "Merkezi Amerika standart wagty", "CST (Kuba)": "Kuba standart wagty", "CXT": "Roždestwo adasy wagty", "ChST": "Çamorro wagty", "EASST": "Pasha adasy tomusky wagty", "EAST": "Pasha adasy standart wagty", "EAT": "Gündogar Afrika wagty", "ECT": "Ekwador wagty", "EDT": "Demirgazyk Amerika gündogar tomusky wagty", "EGDT": "Gündogar Grenlandiýa tomusky wagty", "EGST": "Gündogar Grenlandiýa standart wagty", "EST": "Demirgazyk Amerika gündogar standart wagty", "FKST": "Folklend adalary tomusky wagty", "GALT": "Galapagos adalary wagty", "GFT": "Fransuz Gwianasy wagty", "GMT": "Grinwiç ortaça wagty", "GST": "Pars aýlagy standart wagty", "GYT": "Gaýana wagty", "HADT": "Gawaý-Aleut tomusky wagty", "HAST": "Gawaý-Aleut standart wagty", "HENOMX": "Demirgazyk-günbatar Meksika tomusky wagty", "HEOG": "Günbatar Grenlandiýa tomusky wagty", "HEPMX": "Meksikan Ýuwaş umman tomusky wagty", "HKST": "Gonkong tomusky wagty", "HKT": "Gonkong standart wagty", "HNNOMX": "Demirgazyk-günbatar Meksika standart wagty", "HNOG": "Günbatar Grenlandiýa standart wagty", "HNPMX": "Meksikan Ýuwaş umman standart wagty", "ICT": "Hindihytaý wagty", "IRDT": "Eýran tomusky wagty", "IRST": "Eýran standart wagty", "IST": "Hindistan standart wagty", "JDT": "Ýaponiýa tomusky wagty", "JST": "Ýaponiýa standart wagty", "LHDT": "Lord-Hau tomusky wagty", "LHST": "Lord-Hau standart wagty", "MDT": "Demirgazyk Amerika dag tomusky wagty", "MESZ": "Merkezi Ýewropa tomusky wagty", "MEZ": "Merkezi Ýewropa standart wagty", "MST": "Demirgazyk Amerika dag standart wagty", "MVT": "Maldiwler wagty", "MYT": "Malaýziýa wagty", "NDT": "Nýufaundlend tomusky wagty", "NPT": "Nepal wagty", "NST": "Nýufaundlend standart wagty", "NZDT": "Täze Zelandiýa tomusky wagty", "NZST": "Täze Zelandiýa standart wagty", "OESZ": "Gündogar Ýewropa tomusky wagty", "OEZ": "Gündogar Ýewropa standart wagty", "PDT": "Demirgazyk Amerika Ýuwaş umman tomusky wagty", "PKT": "Pakistan tomusky wagty", "PMDT": "Sen-Pýer we Mikelon tomusky wagty", "PMST": "Sen-Pýer we Mikelon standart wagty", "PST": "Demirgazyk Amerika Ýuwaş umman standart wagty", "PYST": "Paragwaý tomusky wagty", "SAST": "Günorta Afrika standart wagty", "SGT": "Singapur wagty", "SRT": "Surinam wagty", "TLT": "Gündogar Timor wagty", "TMST": "Türkmenistan tomusky wagty", "TMT": "Türkmenistan standart wagty", "UYST": "Urugwaý tomusky wagty", "UYT": "Urugwaý standart wagty", "VET": "Wenesuela wagty", "WARST": "Günbatar Argentina tomusky wagty", "WART": "Günbatar Argentina standart wagty", "WAST": "Günbatar Afrika tomusky wagty", "WAT": "Günbatar Afrika standart wagty", "WESZ": "Günbatar Ýewropa tomusky wagty", "WEZ": "Günbatar Ýewropa standart wagty", "WIB": "Günbatar Indoneziýa wagty", "WIT": "Gündogar Indoneziýa wagty", "WITA": "Merkezi Indoneziýa wagty", "∅∅∅": "Peru tomusky wagty"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} we {1}", "{0}, {1}", "{0}, {1}", "{0} we {1}"}, {"{0} ýa-da {1}", "{0}, {1}", "{0}, {1}", "{0} ýa-da {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"as", "%v as", "%v as", ""},
				Long:   &locales.CounterFormat{"asyr", "%v asyr", "%v asyr", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"oný", "%v oný", "%v oný", ""},
				Long:   &locales.CounterFormat{"onýyllyklar", "%v onýyllyk", "%v onýyllyk", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ý", "%vý", "%vý", ""},
				Long:   &locales.CounterFormat{"ýyl", "%v ýyl", "%v ýyl", "%v/ý"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"a", "%va", "%va", ""},
				Long:   &locales.CounterFormat{"aý", "%v aý", "%v aý", "%v/aý"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"h", "%vh", "%vh", ""},
				Long:   &locales.CounterFormat{"hepde", "%v hepde", "%v hepde", "%v/hepde"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"g", "%vg", "%vg", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sg", "%vsg", "%vsg", ""},
				Long:   &locales.CounterFormat{"sagat", "%v sagat", "%v sagat", "%v/sagat"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m", "%vm", "%vm", ""},
				Long:   &locales.CounterFormat{"minut", "%v minut", "%v minut", "%v/minut"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"se", "%vse", "%vse", ""},
				Long:   &locales.CounterFormat{"sekunt", "%v sekunt", "%v sekunt", "%v/sekunt"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"millisekunt", "%v millisekunt", "%v millisekunt", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mks", "%v mks", "%v mks", ""},
				Long:   &locales.CounterFormat{"mikrosekunt", "%v mikrosekunt", "%v mikrosekunt", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosekunt", "%v nanosekunt", "%v nanosekunt", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"≥%[1]v",
...
func (tk *tk) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(tk, tk.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'tk'
func (tk *tk) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(tk, tk.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'tk'
func (tk *tk) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(tk, tk.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'tk'
func (tk *tk) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(tk, tk.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'tk'
func (tk *tk) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(tk, tk.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'tk'
func (tk *tk) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(tk, tk.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'tk'
func (tk *tk) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(tk, tk.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'tk'
func (tk *tk) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(tk, tk.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'tk'
func (tk *tk) DateFullLayout() string {
	return tk.dateFullLayout
}

// DateLongLayout returns the long date layout for 'tk'
func (tk *tk) DateLongLayout() string {
	return tk.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'tk'
func (tk *tk) DateMediumLayout() string {
	return tk.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'tk'
func (tk *tk) DateShortLayout() string {
	return tk.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'tk'
func (tk *tk) TimeFullLayout() string {
	return tk.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'tk'
func (tk *tk) TimeLongLayout() string {
	return tk.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'tk'
func (tk *tk) TimeMediumLayout() string {
	return tk.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'tk'
func (tk *tk) TimeShortLayout() string {
	return tk.timeShortLayout
}

func (tk *tk) ListPatterns() *locales.ListPatterns {
	return tk.listPatterns
}

func (tk *tk) GetDurationSpec() *locales.DurationSpec {
	return tk.DurationSpec
}

func (tk *tk) GetMiscPatterns() *locales.MiscPatterns {
	return &tk.miscPatterns
}
