...
// DateFullLayout returns the full date layout for 'mgh'
func (mgh *mgh) DateFullLayout() string {
	return mgh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mgh'
func (mgh *mgh) DateLongLayout() string {
	return mgh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mgh'
func (mgh *mgh) DateMediumLayout() string {
	return mgh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mgh'
func (mgh *mgh) DateShortLayout() string {
	return mgh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mgh'
func (mgh *mgh) TimeFullLayout() string {
	return mgh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mgh'
func (mgh *mgh) TimeLongLayout() string {
	return mgh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mgh'
func (mgh *mgh) TimeMediumLayout() string {
	return mgh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mgh'
func (mgh *mgh) TimeShortLayout() string {
	return mgh.timeShortLayout
}

func (mgh *mgh) ListPatterns() *locales.ListPatterns {
	return mgh.listPatterns
}

func (mgh *mgh) GetDurationSpec() *locales.DurationSpec {
	return mgh.DurationSpec
}

func (mgh *mgh) GetMiscPatterns() *locales.MiscPatterns {
