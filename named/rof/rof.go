...
// DateFullLayout returns the full date layout for 'rof'
func (rof *rof) DateFullLayout() string {
	return rof.dateFullLayout
}

// DateLongLayout returns the long date layout for 'rof'
func (rof *rof) DateLongLayout() string {
	return rof.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'rof'
func (rof *rof) DateMediumLayout() string {
	return rof.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'rof'
func (rof *rof) DateShortLayout() string {
	return rof.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'rof'
func (rof *rof) TimeFullLayout() string {
	return rof.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'rof'
func (rof *rof) TimeLongLayout() string {
	return rof.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'rof'
func (rof *rof) TimeMediumLayout() string {
	return rof.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'rof'
func (rof *rof) TimeShortLayout() string {
	return rof.timeShortLayout
}

func (rof *rof) ListPatterns() *locales.ListPatterns {
	return rof.listPatterns
}

func (rof *rof) GetDurationSpec() *locales.DurationSpec {
	return rof.DurationSpec
}

func (rof *rof) GetMiscPatterns() *locales.MiscPatterns {
