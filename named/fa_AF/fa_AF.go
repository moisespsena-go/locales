...
func New() locales.Translator {
	return &fa_AF{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "جنو", "فبروری", "مارچ", "اپریل", "می", "جون", "جول", "اگست", "سپتمبر", "اکتوبر", "نومبر", "دسم"},
			MonthsNarrowValue:        []string{"", "ج", "ف", "م", "ا", "م", "ج", "ج", "ا", "س", "ا", "ن", "د"},
			MonthsWideValue:          []string{"", "جنوری", "فبروری", "مارچ", "اپریل", "می", "جون", "جولای", "اگست", "سپتمبر", "اکتوبر", "نومبر", "دسمبر"},
...
// DateFullLayout returns the full date layout for 'fa_AF'
func (fa *fa_AF) DateFullLayout() string {
	return fa.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fa_AF'
func (fa *fa_AF) DateLongLayout() string {
	return fa.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fa_AF'
func (fa *fa_AF) DateMediumLayout() string {
	return fa.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fa_AF'
func (fa *fa_AF) DateShortLayout() string {
	return fa.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fa_AF'
func (fa *fa_AF) TimeFullLayout() string {
	return fa.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fa_AF'
func (fa *fa_AF) TimeLongLayout() string {
	return fa.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fa_AF'
func (fa *fa_AF) TimeMediumLayout() string {
	return fa.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fa_AF'
func (fa *fa_AF) TimeShortLayout() string {
	return fa.timeShortLayout
}

func (fa *fa_AF) ListPatterns() *locales.ListPatterns {
	return fa.listPatterns
}

func (fa *fa_AF) GetDurationSpec() *locales.DurationSpec {
	return fa.DurationSpec
}

func (fa *fa_AF) GetMiscPatterns() *locales.MiscPatterns {
