...
// DateFullLayout returns the full date layout for 'ar_SS'
func (ar *ar_SS) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_SS'
func (ar *ar_SS) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_SS'
func (ar *ar_SS) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_SS'
func (ar *ar_SS) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_SS'
func (ar *ar_SS) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_SS'
func (ar *ar_SS) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_SS'
func (ar *ar_SS) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_SS'
func (ar *ar_SS) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_SS) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_SS) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_SS) GetMiscPatterns() *locales.MiscPatterns {
