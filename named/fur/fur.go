...
func New() locales.Translator {
	return &fur{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Zen", "Fev", "Mar", "Avr", "Mai", "Jug", "Lui", "Avo", "Set", "Otu", "Nov", "Dic"},
			MonthsNarrowValue:        []string{"", "Z", "F", "M", "A", "M", "J", "L", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Zenâr", "Fevrâr", "Març", "Avrîl", "Mai", "Jugn", "Lui", "Avost", "Setembar", "Otubar", "Novembar", "Dicembar"},
			WeekdaysAbbreviatedValue: []string{"dom", "lun", "mar", "mie", "joi", "vin", "sab"},
			WeekdaysNarrowValue:      []string{"D", "L", "M", "M", "J", "V", "S"},
			WeekdaysWideValue:        []string{"domenie", "lunis", "martars", "miercus", "joibe", "vinars", "sabide"},
			PeriodsAbbreviatedValue:  []string{"a.", "p."},
			PeriodsWideValue:         []string{"a.", "p."},
			ErasAbbreviatedValue:     []string{"pdC", "ddC"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"", ""},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "ADT", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "AST", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "CAT", "CCT": "CCT", "CDT": "CDT", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "CST", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "EAT", "ECT": "ECT", "EDT": "EDT", "EGDT": "EGDT", "EGST": "EGST", "EST": "EST", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "GMT", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "Ore estive de Europe centrâl", "MEZ": "Ore standard de Europe centrâl", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "Ore estive de Europe orientâl", "OEZ": "Ore standard de Europe orientâl", "PDT": "PDT", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "PST", "PYST": "PYST", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "Ore estive de Europe ocidentâl", "WEZ": "Ore standard de Europe ocidentâl", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		dateFullLayout:   "EEEE d 'di' MMMM 'dal' y",
		dateLongLayout:   "d 'di' MMMM 'dal' y",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} e {1}", "", "", "{0} e {1}"}, []string(nil)}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"agns", "%v an", "%v agns", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"mês", "%v mês", "%v mês", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"setemanis", "%v setemane", "%v setemanis", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"zornadis", "%v zornade", "%v zornadis", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"oris", "%v ore", "%v oris", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"minûts", "%v minût", "%v minûts", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"seconts", "%v secont", "%v seconts", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
...
func (fur *fur) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(fur, fur.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'fur'
func (fur *fur) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(fur, fur.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'fur'
func (fur *fur) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(fur, fur.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'fur'
func (fur *fur) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(fur, fur.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'fur'
func (fur *fur) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(fur, fur.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'fur'
func (fur *fur) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(fur, fur.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'fur'
func (fur *fur) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(fur, fur.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'fur'
func (fur *fur) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(fur, fur.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'fur'
func (fur *fur) DateFullLayout() string {
	return fur.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fur'
func (fur *fur) DateLongLayout() string {
	return fur.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fur'
func (fur *fur) DateMediumLayout() string {
	return fur.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fur'
func (fur *fur) DateShortLayout() string {
	return fur.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fur'
func (fur *fur) TimeFullLayout() string {
	return fur.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fur'
func (fur *fur) TimeLongLayout() string {
	return fur.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fur'
func (fur *fur) TimeMediumLayout() string {
	return fur.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fur'
func (fur *fur) TimeShortLayout() string {
	return fur.timeShortLayout
}

func (fur *fur) ListPatterns() *locales.ListPatterns {
	return fur.listPatterns
}

func (fur *fur) GetDurationSpec() *locales.DurationSpec {
	return fur.DurationSpec
}

func (fur *fur) GetMiscPatterns() *locales.MiscPatterns {
	return &fur.miscPatterns
}
