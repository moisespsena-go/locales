...
// DateFullLayout returns the full date layout for 'fr_DJ'
func (fr *fr_DJ) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_DJ'
func (fr *fr_DJ) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_DJ'
func (fr *fr_DJ) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_DJ'
func (fr *fr_DJ) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_DJ'
func (fr *fr_DJ) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_DJ'
func (fr *fr_DJ) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_DJ'
func (fr *fr_DJ) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_DJ'
func (fr *fr_DJ) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_DJ) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_DJ) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_DJ) GetMiscPatterns() *locales.MiscPatterns {
