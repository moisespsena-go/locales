...
// DateFullLayout returns the full date layout for 'en_BS'
func (en *en_BS) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_BS'
func (en *en_BS) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_BS'
func (en *en_BS) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_BS'
func (en *en_BS) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_BS'
func (en *en_BS) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_BS'
func (en *en_BS) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_BS'
func (en *en_BS) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_BS'
func (en *en_BS) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_BS) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_BS) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_BS) GetMiscPatterns() *locales.MiscPatterns {
