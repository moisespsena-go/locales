...
// DateFullLayout returns the full date layout for 'es_IC'
func (es *es_IC) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_IC'
func (es *es_IC) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_IC'
func (es *es_IC) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_IC'
func (es *es_IC) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_IC'
func (es *es_IC) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_IC'
func (es *es_IC) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_IC'
func (es *es_IC) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_IC'
func (es *es_IC) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_IC) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_IC) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_IC) GetMiscPatterns() *locales.MiscPatterns {
