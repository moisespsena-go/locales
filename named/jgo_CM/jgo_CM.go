...
// DateFullLayout returns the full date layout for 'jgo_CM'
func (jgo *jgo_CM) DateFullLayout() string {
	return jgo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'jgo_CM'
func (jgo *jgo_CM) DateLongLayout() string {
	return jgo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'jgo_CM'
func (jgo *jgo_CM) DateMediumLayout() string {
	return jgo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'jgo_CM'
func (jgo *jgo_CM) DateShortLayout() string {
	return jgo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'jgo_CM'
func (jgo *jgo_CM) TimeFullLayout() string {
	return jgo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'jgo_CM'
func (jgo *jgo_CM) TimeLongLayout() string {
	return jgo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'jgo_CM'
func (jgo *jgo_CM) TimeMediumLayout() string {
	return jgo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'jgo_CM'
func (jgo *jgo_CM) TimeShortLayout() string {
	return jgo.timeShortLayout
}

func (jgo *jgo_CM) ListPatterns() *locales.ListPatterns {
	return jgo.listPatterns
}

func (jgo *jgo_CM) GetDurationSpec() *locales.DurationSpec {
	return jgo.DurationSpec
}

func (jgo *jgo_CM) GetMiscPatterns() *locales.MiscPatterns {
