...
// DateFullLayout returns the full date layout for 'ug_CN'
func (ug *ug_CN) DateFullLayout() string {
	return ug.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ug_CN'
func (ug *ug_CN) DateLongLayout() string {
	return ug.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ug_CN'
func (ug *ug_CN) DateMediumLayout() string {
	return ug.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ug_CN'
func (ug *ug_CN) DateShortLayout() string {
	return ug.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ug_CN'
func (ug *ug_CN) TimeFullLayout() string {
	return ug.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ug_CN'
func (ug *ug_CN) TimeLongLayout() string {
	return ug.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ug_CN'
func (ug *ug_CN) TimeMediumLayout() string {
	return ug.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ug_CN'
func (ug *ug_CN) TimeShortLayout() string {
	return ug.timeShortLayout
}

func (ug *ug_CN) ListPatterns() *locales.ListPatterns {
	return ug.listPatterns
}

func (ug *ug_CN) GetDurationSpec() *locales.DurationSpec {
	return ug.DurationSpec
}

func (ug *ug_CN) GetMiscPatterns() *locales.MiscPatterns {
