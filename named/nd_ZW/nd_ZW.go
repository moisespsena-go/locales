...
func New() locales.Translator {
	return &nd_ZW{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Zib", "Nhlo", "Mbi", "Mab", "Nkw", "Nhla", "Ntu", "Ncw", "Mpan", "Mfu", "Lwe", "Mpal"},
			MonthsNarrowValue:        []string{"", "Z", "N", "M", "M", "N", "N", "N", "N", "M", "M", "L", "M"},
			MonthsWideValue:          []string{"", "Zibandlela", "Nhlolanja", "Mbimbitho", "Mabasa", "Nkwenkwezi", "Nhlangula", "Ntulikazi", "Ncwabakazi", "Mpandula", "Mfumfu", "Lwezi", "Mpalakazi"},
			WeekdaysAbbreviatedValue: []string{"Son", "Mvu", "Sib", "Sit", "Sin", "Sih", "Mgq"},
			WeekdaysNarrowValue:      []string{"S", "M", "S", "S", "S", "S", "M"},
			WeekdaysWideValue:        []string{"Sonto", "Mvulo", "Sibili", "Sithathu", "Sine", "Sihlanu", "Mgqibelo"},
			ErasAbbreviatedValue:     []string{"BC", "AD"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"UKristo angakabuyi", "Ukristo ebuyile"},
...
func (nd *nd_ZW) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(nd, nd.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'nd_ZW'
func (nd *nd_ZW) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(nd, nd.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'nd_ZW'
func (nd *nd_ZW) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(nd, nd.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'nd_ZW'
func (nd *nd_ZW) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(nd, nd.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'nd_ZW'
func (nd *nd_ZW) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(nd, nd.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'nd_ZW'
func (nd *nd_ZW) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(nd, nd.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'nd_ZW'
func (nd *nd_ZW) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(nd, nd.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'nd_ZW'
func (nd *nd_ZW) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(nd, nd.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'nd_ZW'
func (nd *nd_ZW) DateFullLayout() string {
	return nd.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nd_ZW'
func (nd *nd_ZW) DateLongLayout() string {
	return nd.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nd_ZW'
func (nd *nd_ZW) DateMediumLayout() string {
	return nd.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nd_ZW'
func (nd *nd_ZW) DateShortLayout() string {
	return nd.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nd_ZW'
func (nd *nd_ZW) TimeFullLayout() string {
	return nd.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nd_ZW'
func (nd *nd_ZW) TimeLongLayout() string {
	return nd.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nd_ZW'
func (nd *nd_ZW) TimeMediumLayout() string {
	return nd.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nd_ZW'
func (nd *nd_ZW) TimeShortLayout() string {
	return nd.timeShortLayout
}

func (nd *nd_ZW) ListPatterns() *locales.ListPatterns {
	return nd.listPatterns
}

func (nd *nd_ZW) GetDurationSpec() *locales.DurationSpec {
	return nd.DurationSpec
}

func (nd *nd_ZW) GetMiscPatterns() *locales.MiscPatterns {
	return &nd.miscPatterns
}
