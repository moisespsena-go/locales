...
func New() locales.Translator {
	return &om_KE{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Ama", "Gur", "Bit", "Elb", "Cam", "Wax", "Ado", "Hag", "Ful", "Onk", "Sad", "Mud"},
			MonthsNarrowValue:        []string{"", "A", "G", "B", "E", "C", "W", "A", "H", "F", "O", "S", "M"},
			MonthsWideValue:          []string{"", "Amajjii", "Guraandhala", "Bitooteessa", "Elba", "Caamsa", "Waxabajjii", "Adooleessa", "Hagayya", "Fuulbana", "Onkololeessa", "Sadaasa", "Muddee"},
			WeekdaysAbbreviatedValue: []string{"Dil", "Wix", "Qib", "Rob", "Kam", "Jim", "San"},
			WeekdaysNarrowValue:      []string{"D", "W", "Q", "R", "K", "J", "S"},
			WeekdaysShortValue:       []string{"Dil", "Wix", "Qib", "Rob", "Kam", "Jim", "San"},
			WeekdaysWideValue:        []string{"Dilbata", "Wiixata", "Qibxata", "Roobii", "Kamiisa", "Jimaata", "Sanbata"},
			PeriodsAbbreviatedValue:  []string{"WD", "WB"},
			PeriodsNarrowValue:       []string{"WD", "WB"},
			PeriodsWideValue:         []string{"WD", "WB"},
...
func (om *om_KE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(om, om.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'om_KE'
func (om *om_KE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(om, om.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'om_KE'
func (om *om_KE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(om, om.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'om_KE'
func (om *om_KE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(om, om.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'om_KE'
func (om *om_KE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(om, om.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'om_KE'
func (om *om_KE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(om, om.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'om_KE'
func (om *om_KE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(om, om.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'om_KE'
func (om *om_KE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(om, om.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'om_KE'
func (om *om_KE) DateFullLayout() string {
	return om.dateFullLayout
}

// DateLongLayout returns the long date layout for 'om_KE'
func (om *om_KE) DateLongLayout() string {
	return om.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'om_KE'
func (om *om_KE) DateMediumLayout() string {
	return om.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'om_KE'
func (om *om_KE) DateShortLayout() string {
	return om.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'om_KE'
func (om *om_KE) TimeFullLayout() string {
	return om.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'om_KE'
func (om *om_KE) TimeLongLayout() string {
	return om.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'om_KE'
func (om *om_KE) TimeMediumLayout() string {
	return om.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'om_KE'
func (om *om_KE) TimeShortLayout() string {
	return om.timeShortLayout
}

func (om *om_KE) ListPatterns() *locales.ListPatterns {
	return om.listPatterns
}

func (om *om_KE) GetDurationSpec() *locales.DurationSpec {
	return om.DurationSpec
}

func (om *om_KE) GetMiscPatterns() *locales.MiscPatterns {
	return &om.miscPatterns
}
