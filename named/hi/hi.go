...
func New() locales.Translator {
	return &hi{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "जन॰", "फ़र॰", "मार्च", "अप्रैल", "मई", "जून", "जुल॰", "अग॰", "सित॰", "अक्तू॰", "नव॰", "दिस॰"},
			MonthsNarrowValue:        []string{"", "ज", "फ़", "मा", "अ", "म", "जू", "जु", "अ", "सि", "अ", "न", "दि"},
			MonthsWideValue:          []string{"", "जनवरी", "फ़रवरी", "मार्च", "अप्रैल", "मई", "जून", "जुलाई", "अगस्त", "सितंबर", "अक्तूबर", "नवंबर", "दिसंबर"},
			WeekdaysAbbreviatedValue: []string{"रवि", "सोम", "मंगल", "बुध", "गुरु", "शुक्र", "शनि"},
			WeekdaysNarrowValue:      []string{"र", "सो", "मं", "बु", "गु", "शु", "श"},
			WeekdaysShortValue:       []string{"र", "सो", "मं", "बु", "गु", "शु", "श"},
			WeekdaysWideValue:        []string{"रविवार", "सोमवार", "मंगलवार", "बुधवार", "गुरुवार", "शुक्रवार", "शनिवार"},
			PeriodsAbbreviatedValue:  []string{"am", "pm"},
			PeriodsNarrowValue:       []string{"am", "pm"},
			PeriodsWideValue:         []string{"am", "pm"},
			ErasAbbreviatedValue:     []string{"ईसा-पूर्व", "ईस्वी"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"ईसा-पूर्व", "ईसवी सन"},
			TimezonesValue:           map[string]string{"": "पैराग्वे मानक समय", "ACDT": "ऑस्\u200dट्रेलियाई केंद्रीय डेलाइट समय", "ACST": "ऑस्\u200dट्रेलियाई केंद्रीय मानक समय", "ACT": "ACT", "ACWDT": "ऑस्\u200dट्रेलियाई केंद्रीय पश्चिमी डेलाइट समय", "ACWST": "ऑस्\u200dट्रेलियाई केंद्रीय पश्चिमी मानक समय", "ADT": "अटलांटिक डेलाइट समय", "AEDT": "ऑस्\u200dट्रेलियाई पूर्वी डेलाइट समय", "AEST": "ऑस्\u200dट्रेलियाई पूर्वी मानक समय", "AFT": "अफ़गानिस्तान समय", "AKDT": "अलास्\u200dका डेलाइट समय", "AKST": "अलास्\u200dका मानक समय", "AMST": "अमेज़न ग्रीष्मकालीन समय", "AMT": "अमेज़न मानक समय", "ARST": "अर्जेंटीना ग्रीष्मकालीन समय", "ART": "अर्जेंटीना मानक समय", "AST": "अटलांटिक मानक समय", "AWDT": "ऑस्ट्रेलियाई पश्चिमी डेलाइट समय", "AWST": "ऑस्ट्रेलियाई पश्चिमी मानक समय", "BNT": "ब्रूनेई दारूस्सलम समय", "BOT": "बोलीविया समय", "BRST": "ब्राज़ीलिया ग्रीष्मकालीन समय", "BRT": "ब्राज़ीलिया मानक समय", "BST": "बांग्लादेश ग्रीष्मकालीन समय", "BTT": "भूटान समय", "CAT": "मध्य अफ़्रीका समय", "CCT": "कोकोस द्वीपसमूह समय", "CDT": "उत्तरी अमेरिकी केंद्रीय डेलाइट समय", "CDT (Kuba)": "क्यूबा डेलाइट समय", "CHADT": "चैथम डेलाइट समय", "CHAST": "चैथम मानक समय", "CLST": "चिली ग्रीष्मकालीन समय", "CLT": "चिली मानक समय", "COST": "कोलंबिया ग्रीष्मकालीन समय", "COT": "कोलंबिया मानक समय", "CST": "उत्तरी अमेरिकी केंद्रीय मानक समय", "CST (Kuba)": "क्यूबा मानक समय", "CXT": "क्रिसमस द्वीप समय", "ChST": "चामोरो मानक समय", "EASST": "ईस्टर द्वीप ग्रीष्मकालीन समय", "EAST": "ईस्टर द्वीप मानक समय", "EAT": "पूर्वी अफ़्रीका समय", "ECT": "इक्वाडोर समय", "EDT": "उत्तरी अमेरिकी पूर्वी डेलाइट समय", "EGDT": "पूर्वी ग्रीनलैंड ग्रीष्मकालीन समय", "EGST": "पूर्वी ग्रीनलैंड मानक समय", "EST": "उत्तरी अमेरिकी पूर्वी मानक समय", "FKST": "फ़ॉकलैंड द्वीपसमूह ग्रीष्मकालीन समय", "GALT": "गैलापेगोस का समय", "GFT": "फ़्रेंच गुयाना समय", "GMT": "ग्रीनविच मीन टाइम", "GST": "खाड़ी मानक समय", "GYT": "गुयाना समय", "HADT": "हवाई–आल्यूशन डेलाइट समय", "HAST": "हवाई–आल्यूशन मानक समय", "HENOMX": "उत्तर पश्चिमी मेक्सिको डेलाइट समय", "HEOG": "पश्चिमी ग्रीनलैंड ग्रीष्मकालीन समय", "HEPMX": "मेक्सिकन प्रशांत डेलाइट समय", "HKST": "हाँग काँग ग्रीष्मकालीन समय", "HKT": "हाँग काँग मानक समय", "HNNOMX": "उत्तर पश्चिमी मेक्सिको मानक समय", "HNOG": "पश्चिमी ग्रीनलैंड मानक समय", "HNPMX": "मेक्सिकन प्रशांत मानक समय", "ICT": "इंडोचाइना समय", "IRDT": "ईरान डेलाइट समय", "IRST": "ईरान मानक समय", "IST": "भारतीय मानक समय", "JDT": "जापान डेलाइट समय", "JST": "जापान मानक समय", "LHDT": "लॉर्ड होवे डेलाइट समय", "LHST": "लॉर्ड होवे मानक समय", "MDT": "उत्तरी अमेरिकी माउंटेन डेलाइट समय", "MESZ": "मध्\u200dय यूरोपीय ग्रीष्\u200dमकालीन समय", "MEZ": "मध्य यूरोपीय मानक समय", "MST": "उत्तरी अमेरिकी माउंटेन मानक समय", "MVT": "मालदीव समय", "MYT": "मलेशिया समय", "NDT": "न्यूफ़ाउंडलैंड डेलाइट समय", "NPT": "नेपाल समय", "NST": "न्यूफ़ाउंडलैंड मानक समय", "NZDT": "न्यूज़ीलैंड डेलाइट समय", "NZST": "न्यूज़ीलैंड मानक समय", "OESZ": "पूर्वी यूरोपीय ग्रीष्मकालीन समय", "OEZ": "पूर्वी यूरोपीय मानक समय", "PDT": "उत्तरी अमेरिकी प्रशांत डेलाइट समय", "PKT": "पाकिस्तान ग्रीष्मकालीन समय", "PMDT": "सेंट पिएरे और मिक्वेलान डेलाइट समय", "PMST": "सेंट पिएरे और मिक्वेलान मानक समय", "PST": "उत्तरी अमेरिकी प्रशांत मानक समय", "PYST": "पैराग्वे ग्रीष्मकालीन समय", "SAST": "दक्षिण अफ़्रीका मानक समय", "SGT": "सिंगापुर समय", "SRT": "सूरीनाम समय", "TLT": "पूर्वी तिमोर समय", "TMST": "तुर्कमेनिस्तान ग्रीष्मकालीन समय", "TMT": "तुर्कमेनिस्तान मानक समय", "UYST": "उरुग्वे ग्रीष्मकालीन समय", "UYT": "उरुग्वे मानक समय", "VET": "वेनेज़ुएला समय", "WARST": "पश्चिमी अर्जेंटीना ग्रीष्मकालीन समय", "WART": "पश्चिमी अर्जेंटीना मानक समय", "WAST": "पश्चिम अफ़्रीका ग्रीष्मकालीन समय", "WAT": "पश्चिम अफ़्रीका मानक समय", "WESZ": "पश्चिमी यूरोपीय ग्रीष्\u200dमकालीन समय", "WEZ": "पश्चिमी यूरोपीय मानक समय", "WIB": "पश्चिमी इंडोनेशिया समय", "WIT": "पूर्वी इंडोनेशिया समय", "WITA": "मध्य इंडोनेशिया समय", "∅∅∅": "पेरू ग्रीष्मकालीन समय"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} और {1}", "{0}, {1}", "{0}, {1}", "{0}, और {1}"}, {"{0} या {1}", "{0}, {1}", "{0}, {1}", "{0} या {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"श", "%v श", "%v श", ""},
				Long:   &locales.CounterFormat{"शताब्दियाँ", "%v शताब्दी", "%v शताब्दियों", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"दश.", "%v दश.", "%v दश.", ""},
				Long:   &locales.CounterFormat{"दशकों", "%v दशक", "%v दशकों", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"वर्ष", "%vवर्ष", "%vवर्ष", "%v/व"},
				Long:   &locales.CounterFormat{"वर्ष", "%v वर्ष", "%v वर्ष", "%v प्रति वर्ष"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"माह", "%vमाह", "%vमाह", ""},
				Long:   &locales.CounterFormat{"महीना", "%v महीने", "%v महीनों", "%v प्रति महीना"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"सप्ताह", "%v सप्ताह", "%v सप्ताह", "%v/स"},
				Long:   &locales.CounterFormat{"सप्ताह", "%v सप्ताह", "%v सप्ताह", "%v प्रति सप्ताह"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"दिन", "%vदिन", "%vदिन", "%v/दि"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"घंटा", "%vघं॰", "%vघं॰", "%v/घं"},
				Long:   &locales.CounterFormat{"घंटे", "%v घंटे", "%v घंटों", "%v प्रति घंटा"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"मिनट", "%vमि॰", "%vमि॰", "%v/मि"},
				Long:   &locales.CounterFormat{"मिनट", "%v मिनट", "%v मिनट", "%v प्रति मिनट"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"सेकंड", "%vसे॰", "%vसे॰", "%v/से"},
				Long:   &locales.CounterFormat{"सेकंड", "%v सेकंड", "%v सेकंड", "%v प्रति सेकंड"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"मि॰से॰", "%v मि॰से॰", "%v मि॰से॰", ""},
				Long:   &locales.CounterFormat{"मिलीसेकंड", "%v मिलीसेकंड", "%v मिलीसेकंड", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"माइक्रोसेकंड", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"माइक्रोसेकंड", "%v माइक्रोसेकंड", "%v माइक्रोसेकंड", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"नैनो सेकंड", "%v नैनो सेकंड", "%v नैनो सेकंड", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (hi *hi) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(hi, hi.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'hi'
func (hi *hi) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(hi, hi.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'hi'
func (hi *hi) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(hi, hi.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'hi'
func (hi *hi) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(hi, hi.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'hi'
func (hi *hi) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(hi, hi.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'hi'
func (hi *hi) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(hi, hi.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'hi'
func (hi *hi) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(hi, hi.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'hi'
func (hi *hi) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(hi, hi.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'hi'
func (hi *hi) DateFullLayout() string {
	return hi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'hi'
func (hi *hi) DateLongLayout() string {
	return hi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'hi'
func (hi *hi) DateMediumLayout() string {
	return hi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'hi'
func (hi *hi) DateShortLayout() string {
	return hi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'hi'
func (hi *hi) TimeFullLayout() string {
	return hi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'hi'
func (hi *hi) TimeLongLayout() string {
	return hi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'hi'
func (hi *hi) TimeMediumLayout() string {
	return hi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'hi'
func (hi *hi) TimeShortLayout() string {
	return hi.timeShortLayout
}

func (hi *hi) ListPatterns() *locales.ListPatterns {
	return hi.listPatterns
}

func (hi *hi) GetDurationSpec() *locales.DurationSpec {
	return hi.DurationSpec
}

func (hi *hi) GetMiscPatterns() *locales.MiscPatterns {
	return &hi.miscPatterns
}
