...
// DateFullLayout returns the full date layout for 'bs_Latn_BA'
func (bs *bs_Latn_BA) DateFullLayout() string {
	return bs.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bs_Latn_BA'
func (bs *bs_Latn_BA) DateLongLayout() string {
	return bs.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bs_Latn_BA'
func (bs *bs_Latn_BA) DateMediumLayout() string {
	return bs.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bs_Latn_BA'
func (bs *bs_Latn_BA) DateShortLayout() string {
	return bs.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bs_Latn_BA'
func (bs *bs_Latn_BA) TimeFullLayout() string {
	return bs.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bs_Latn_BA'
func (bs *bs_Latn_BA) TimeLongLayout() string {
	return bs.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bs_Latn_BA'
func (bs *bs_Latn_BA) TimeMediumLayout() string {
	return bs.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bs_Latn_BA'
func (bs *bs_Latn_BA) TimeShortLayout() string {
	return bs.timeShortLayout
}

func (bs *bs_Latn_BA) ListPatterns() *locales.ListPatterns {
	return bs.listPatterns
}

func (bs *bs_Latn_BA) GetDurationSpec() *locales.DurationSpec {
	return bs.DurationSpec
}

func (bs *bs_Latn_BA) GetMiscPatterns() *locales.MiscPatterns {
