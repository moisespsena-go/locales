...
// DateFullLayout returns the full date layout for 'chr_US'
func (chr *chr_US) DateFullLayout() string {
	return chr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'chr_US'
func (chr *chr_US) DateLongLayout() string {
	return chr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'chr_US'
func (chr *chr_US) DateMediumLayout() string {
	return chr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'chr_US'
func (chr *chr_US) DateShortLayout() string {
	return chr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'chr_US'
func (chr *chr_US) TimeFullLayout() string {
	return chr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'chr_US'
func (chr *chr_US) TimeLongLayout() string {
	return chr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'chr_US'
func (chr *chr_US) TimeMediumLayout() string {
	return chr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'chr_US'
func (chr *chr_US) TimeShortLayout() string {
	return chr.timeShortLayout
}

func (chr *chr_US) ListPatterns() *locales.ListPatterns {
	return chr.listPatterns
}

func (chr *chr_US) GetDurationSpec() *locales.DurationSpec {
	return chr.DurationSpec
}

func (chr *chr_US) GetMiscPatterns() *locales.MiscPatterns {
