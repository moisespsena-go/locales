...
// DateFullLayout returns the full date layout for 'ewo'
func (ewo *ewo) DateFullLayout() string {
	return ewo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ewo'
func (ewo *ewo) DateLongLayout() string {
	return ewo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ewo'
func (ewo *ewo) DateMediumLayout() string {
	return ewo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ewo'
func (ewo *ewo) DateShortLayout() string {
	return ewo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ewo'
func (ewo *ewo) TimeFullLayout() string {
	return ewo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ewo'
func (ewo *ewo) TimeLongLayout() string {
	return ewo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ewo'
func (ewo *ewo) TimeMediumLayout() string {
	return ewo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ewo'
func (ewo *ewo) TimeShortLayout() string {
	return ewo.timeShortLayout
}

func (ewo *ewo) ListPatterns() *locales.ListPatterns {
	return ewo.listPatterns
}

func (ewo *ewo) GetDurationSpec() *locales.DurationSpec {
	return ewo.DurationSpec
}

func (ewo *ewo) GetMiscPatterns() *locales.MiscPatterns {
