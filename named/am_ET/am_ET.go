...
// DateFullLayout returns the full date layout for 'am_ET'
func (am *am_ET) DateFullLayout() string {
	return am.dateFullLayout
}

// DateLongLayout returns the long date layout for 'am_ET'
func (am *am_ET) DateLongLayout() string {
	return am.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'am_ET'
func (am *am_ET) DateMediumLayout() string {
	return am.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'am_ET'
func (am *am_ET) DateShortLayout() string {
	return am.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'am_ET'
func (am *am_ET) TimeFullLayout() string {
	return am.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'am_ET'
func (am *am_ET) TimeLongLayout() string {
	return am.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'am_ET'
func (am *am_ET) TimeMediumLayout() string {
	return am.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'am_ET'
func (am *am_ET) TimeShortLayout() string {
	return am.timeShortLayout
}

func (am *am_ET) ListPatterns() *locales.ListPatterns {
	return am.listPatterns
}

func (am *am_ET) GetDurationSpec() *locales.DurationSpec {
	return am.DurationSpec
}

func (am *am_ET) GetMiscPatterns() *locales.MiscPatterns {
