...
// DateFullLayout returns the full date layout for 'zu_ZA'
func (zu *zu_ZA) DateFullLayout() string {
	return zu.dateFullLayout
}

// DateLongLayout returns the long date layout for 'zu_ZA'
func (zu *zu_ZA) DateLongLayout() string {
	return zu.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'zu_ZA'
func (zu *zu_ZA) DateMediumLayout() string {
	return zu.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'zu_ZA'
func (zu *zu_ZA) DateShortLayout() string {
	return zu.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'zu_ZA'
func (zu *zu_ZA) TimeFullLayout() string {
	return zu.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'zu_ZA'
func (zu *zu_ZA) TimeLongLayout() string {
	return zu.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'zu_ZA'
func (zu *zu_ZA) TimeMediumLayout() string {
	return zu.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'zu_ZA'
func (zu *zu_ZA) TimeShortLayout() string {
	return zu.timeShortLayout
}

func (zu *zu_ZA) ListPatterns() *locales.ListPatterns {
	return zu.listPatterns
}

func (zu *zu_ZA) GetDurationSpec() *locales.DurationSpec {
	return zu.DurationSpec
}

func (zu *zu_ZA) GetMiscPatterns() *locales.MiscPatterns {
