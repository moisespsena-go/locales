...
func New() locales.Translator {
	return &es_CL{
		...
		TimeSpec: &locales.TimeSpec{
			...
			WeekdaysShortValue:       []string{"do", "lu", "ma", "mi", "ju", "vi", "sá"},
...
// DateFullLayout returns the full date layout for 'es_CL'
func (es *es_CL) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_CL'
func (es *es_CL) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_CL'
func (es *es_CL) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_CL'
func (es *es_CL) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_CL'
func (es *es_CL) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_CL'
func (es *es_CL) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_CL'
func (es *es_CL) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_CL'
func (es *es_CL) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_CL) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_CL) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_CL) GetMiscPatterns() *locales.MiscPatterns {
