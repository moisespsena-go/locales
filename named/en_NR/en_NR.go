...
// DateFullLayout returns the full date layout for 'en_NR'
func (en *en_NR) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_NR'
func (en *en_NR) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_NR'
func (en *en_NR) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_NR'
func (en *en_NR) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_NR'
func (en *en_NR) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_NR'
func (en *en_NR) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_NR'
func (en *en_NR) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_NR'
func (en *en_NR) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_NR) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_NR) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_NR) GetMiscPatterns() *locales.MiscPatterns {
