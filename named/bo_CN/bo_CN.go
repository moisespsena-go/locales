...
func New() locales.Translator {
	return &bo_CN{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ཟླ་༡", "ཟླ་༢", "ཟླ་༣", "ཟླ་༤", "ཟླ་༥", "ཟླ་༦", "ཟླ་༧", "ཟླ་༨", "ཟླ་༩", "ཟླ་༡༠", "ཟླ་༡༡", "ཟླ་༡༢"},
			MonthsWideValue:          []string{"", "ཟླ་བ་དང་པོ", "ཟླ་བ་གཉིས་པ", "ཟླ་བ་གསུམ་པ", "ཟླ་བ་བཞི་པ", "ཟླ་བ་ལྔ་པ", "ཟླ་བ་དྲུག་པ", "ཟླ་བ་བདུན་པ", "ཟླ་བ་བརྒྱད་པ", "ཟླ་བ་དགུ་པ", "ཟླ་བ་བཅུ་པ", "ཟླ་བ་བཅུ་གཅིག་པ", "ཟླ་བ་བཅུ་གཉིས་པ"},
			WeekdaysAbbreviatedValue: []string{"ཉི་མ་", "ཟླ་བ་", "མིག་དམར་", "ལྷག་པ་", "ཕུར་བུ་", "པ་སངས་", "སྤེན་པ་"},
			WeekdaysNarrowValue:      []string{"ཉི", "ཟླ", "མིག", "ལྷག", "ཕུར", "སངས", "སྤེན"},
			WeekdaysWideValue:        []string{"གཟའ་ཉི་མ་", "གཟའ་ཟླ་བ་", "གཟའ་མིག་དམར་", "གཟའ་ལྷག་པ་", "གཟའ་ཕུར་བུ་", "གཟའ་པ་སངས་", "གཟའ་སྤེན་པ་"},
			PeriodsAbbreviatedValue:  []string{"སྔ་དྲོ་", "ཕྱི་དྲོ་"},
			PeriodsWideValue:         []string{"སྔ་དྲོ་", "ཕྱི་དྲོ་"},
			ErasAbbreviatedValue:     []string{"སྤྱི་ལོ་སྔོན་", "སྤྱི་ལོ་"},
		...
		dateFullLayout:   "y MMMMའི་ཚེས་d, EEEE",
		dateLongLayout:   "སྤྱི་ལོ་y MMMMའི་ཚེས་d",
		dateMediumLayout: "y ལོའི་MMMཚེས་d",
...
func (bo *bo_CN) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(bo, bo.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'bo_CN'
func (bo *bo_CN) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(bo, bo.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'bo_CN'
func (bo *bo_CN) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(bo, bo.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'bo_CN'
func (bo *bo_CN) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(bo, bo.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'bo_CN'
func (bo *bo_CN) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(bo, bo.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'bo_CN'
func (bo *bo_CN) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(bo, bo.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'bo_CN'
func (bo *bo_CN) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(bo, bo.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'bo_CN'
func (bo *bo_CN) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(bo, bo.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'bo_CN'
func (bo *bo_CN) DateFullLayout() string {
	return bo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bo_CN'
func (bo *bo_CN) DateLongLayout() string {
	return bo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bo_CN'
func (bo *bo_CN) DateMediumLayout() string {
	return bo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bo_CN'
func (bo *bo_CN) DateShortLayout() string {
	return bo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bo_CN'
func (bo *bo_CN) TimeFullLayout() string {
	return bo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bo_CN'
func (bo *bo_CN) TimeLongLayout() string {
	return bo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bo_CN'
func (bo *bo_CN) TimeMediumLayout() string {
	return bo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bo_CN'
func (bo *bo_CN) TimeShortLayout() string {
	return bo.timeShortLayout
}

func (bo *bo_CN) ListPatterns() *locales.ListPatterns {
	return bo.listPatterns
}

func (bo *bo_CN) GetDurationSpec() *locales.DurationSpec {
	return bo.DurationSpec
}

func (bo *bo_CN) GetMiscPatterns() *locales.MiscPatterns {
	return &bo.miscPatterns
}
