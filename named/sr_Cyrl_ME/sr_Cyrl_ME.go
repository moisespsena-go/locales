...
func New() locales.Translator {
	return &sr_Cyrl_ME{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "јан", "феб", "март", "апр", "мај", "јун", "јул", "авг", "септ", "окт", "нов", "дец"},
			...
			WeekdaysWideValue:        []string{"недјеља", "понедељак", "уторак", "сриједа", "четвртак", "петак", "субота"},
...
// DateFullLayout returns the full date layout for 'sr_Cyrl_ME'
func (sr *sr_Cyrl_ME) DateFullLayout() string {
	return sr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sr_Cyrl_ME'
func (sr *sr_Cyrl_ME) DateLongLayout() string {
	return sr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sr_Cyrl_ME'
func (sr *sr_Cyrl_ME) DateMediumLayout() string {
	return sr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sr_Cyrl_ME'
func (sr *sr_Cyrl_ME) DateShortLayout() string {
	return sr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sr_Cyrl_ME'
func (sr *sr_Cyrl_ME) TimeFullLayout() string {
	return sr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sr_Cyrl_ME'
func (sr *sr_Cyrl_ME) TimeLongLayout() string {
	return sr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sr_Cyrl_ME'
func (sr *sr_Cyrl_ME) TimeMediumLayout() string {
	return sr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sr_Cyrl_ME'
func (sr *sr_Cyrl_ME) TimeShortLayout() string {
	return sr.timeShortLayout
}

func (sr *sr_Cyrl_ME) ListPatterns() *locales.ListPatterns {
	return sr.listPatterns
}

func (sr *sr_Cyrl_ME) GetDurationSpec() *locales.DurationSpec {
	return sr.DurationSpec
}

func (sr *sr_Cyrl_ME) GetMiscPatterns() *locales.MiscPatterns {
