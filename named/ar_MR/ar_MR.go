...
func New() locales.Translator {
	return &ar_MR{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "يناير", "فبراير", "مارس", "إبريل", "مايو", "يونيو", "يوليو", "أغشت", "شتمبر", "أكتوبر", "نوفمبر", "دجمبر"},
			MonthsNarrowValue:        []string{"", "ي", "ف", "م", "إ", "و", "ن", "ل", "غ", "ش", "ك", "ب", "د"},
			MonthsWideValue:          []string{"", "يناير", "فبراير", "مارس", "إبريل", "مايو", "يونيو", "يوليو", "أغشت", "شتمبر", "أكتوبر", "نوفمبر", "دجمبر"},
...
// DateFullLayout returns the full date layout for 'ar_MR'
func (ar *ar_MR) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_MR'
func (ar *ar_MR) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_MR'
func (ar *ar_MR) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_MR'
func (ar *ar_MR) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_MR'
func (ar *ar_MR) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_MR'
func (ar *ar_MR) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_MR'
func (ar *ar_MR) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_MR'
func (ar *ar_MR) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_MR) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_MR) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_MR) GetMiscPatterns() *locales.MiscPatterns {
