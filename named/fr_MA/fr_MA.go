...
func New() locales.Translator {
	return &fr_MA{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jan.", "fév.", "mar.", "avr.", "mai", "jui.", "juil.", "août", "sept.", "oct.", "nov.", "déc."},
...
// DateFullLayout returns the full date layout for 'fr_MA'
func (fr *fr_MA) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_MA'
func (fr *fr_MA) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_MA'
func (fr *fr_MA) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_MA'
func (fr *fr_MA) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_MA'
func (fr *fr_MA) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_MA'
func (fr *fr_MA) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_MA'
func (fr *fr_MA) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_MA'
func (fr *fr_MA) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_MA) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_MA) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_MA) GetMiscPatterns() *locales.MiscPatterns {
