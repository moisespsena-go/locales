...
func New() locales.Translator {
	return &dav_KE{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Imb", "Kaw", "Kad", "Kan", "Kas", "Kar", "Mfu", "Wun", "Ike", "Iku", "Imw", "Iwi"},
			MonthsNarrowValue:        []string{"", "I", "K", "K", "K", "K", "K", "M", "W", "I", "I", "I", "I"},
			MonthsWideValue:          []string{"", "Mori ghwa imbiri", "Mori ghwa kawi", "Mori ghwa kadadu", "Mori ghwa kana", "Mori ghwa kasanu", "Mori ghwa karandadu", "Mori ghwa mfungade", "Mori ghwa wunyanya", "Mori ghwa ikenda", "Mori ghwa ikumi", "Mori ghwa ikumi na imweri", "Mori ghwa ikumi na iwi"},
			WeekdaysAbbreviatedValue: []string{"Jum", "Jim", "Kaw", "Kad", "Kan", "Kas", "Ngu"},
			WeekdaysNarrowValue:      []string{"J", "J", "K", "K", "K", "K", "N"},
			WeekdaysWideValue:        []string{"Ituku ja jumwa", "Kuramuka jimweri", "Kuramuka kawi", "Kuramuka kadadu", "Kuramuka kana", "Kuramuka kasanu", "Kifula nguwo"},
			PeriodsAbbreviatedValue:  []string{"Luma lwa K", "luma lwa p"},
			PeriodsWideValue:         []string{"Luma lwa K", "luma lwa p"},
...
func (dav *dav_KE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(dav, dav.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'dav_KE'
func (dav *dav_KE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(dav, dav.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'dav_KE'
func (dav *dav_KE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(dav, dav.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'dav_KE'
func (dav *dav_KE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(dav, dav.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'dav_KE'
func (dav *dav_KE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(dav, dav.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'dav_KE'
func (dav *dav_KE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(dav, dav.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'dav_KE'
func (dav *dav_KE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(dav, dav.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'dav_KE'
func (dav *dav_KE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(dav, dav.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'dav_KE'
func (dav *dav_KE) DateFullLayout() string {
	return dav.dateFullLayout
}

// DateLongLayout returns the long date layout for 'dav_KE'
func (dav *dav_KE) DateLongLayout() string {
	return dav.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'dav_KE'
func (dav *dav_KE) DateMediumLayout() string {
	return dav.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'dav_KE'
func (dav *dav_KE) DateShortLayout() string {
	return dav.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'dav_KE'
func (dav *dav_KE) TimeFullLayout() string {
	return dav.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'dav_KE'
func (dav *dav_KE) TimeLongLayout() string {
	return dav.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'dav_KE'
func (dav *dav_KE) TimeMediumLayout() string {
	return dav.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'dav_KE'
func (dav *dav_KE) TimeShortLayout() string {
	return dav.timeShortLayout
}

func (dav *dav_KE) ListPatterns() *locales.ListPatterns {
	return dav.listPatterns
}

func (dav *dav_KE) GetDurationSpec() *locales.DurationSpec {
	return dav.DurationSpec
}

func (dav *dav_KE) GetMiscPatterns() *locales.MiscPatterns {
	return &dav.miscPatterns
}
