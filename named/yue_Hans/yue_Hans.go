...
func New() locales.Translator {
	return &yue_Hans{
		...
		TimeSpec: &locales.TimeSpec{
			...
			TimezonesValue:           map[string]string{"": "巴拉圭标准时间", "ACDT": "澳洲中部夏令时间", "ACST": "澳洲中部标准时间", "ACT": "艾克标准时间", "ACWDT": "澳洲中西部夏令时间", "ACWST": "澳洲中西部标准时间", "ADT": "大西洋夏令时间", "AEDT": "澳洲东部夏令时间", "AEST": "澳洲东部标准时间", "AFT": "阿富汗时间", "AKDT": "阿拉斯加夏令时间", "AKST": "阿拉斯加标准时间", "AMST": "亚马逊夏令时间", "AMT": "亚马逊标准时间", "ARST": "阿根廷夏令时间", "ART": "阿根廷标准时间", "AST": "大西洋标准时间", "AWDT": "澳洲西部夏令时间", "AWST": "澳洲西部标准时间", "BNT": "汶莱时间", "BOT": "玻利维亚时间", "BRST": "巴西利亚夏令时间", "BRT": "巴西利亚标准时间", "BST": "孟加拉夏令时间", "BTT": "不丹时间", "CAT": "中非时间", "CCT": "科科斯群岛时间", "CDT": "中部夏令时间", "CDT (Kuba)": "古巴夏令时间", "CHADT": "查坦群岛夏令时间", "CHAST": "查坦群岛标准时间", "CLST": "智利夏令时间", "CLT": "智利标准时间", "COST": "哥伦比亚夏令时间", "COT": "哥伦比亚标准时间", "CST": "中部标准时间", "CST (Kuba)": "古巴标准时间", "CXT": "圣诞岛时间", "ChST": "查莫洛时间", "EASST": "复活节岛夏令时间", "EAST": "复活节岛标准时间", "EAT": "东非时间", "ECT": "厄瓜多时间", "EDT": "东部夏令时间", "EGDT": "格陵兰东部夏令时间", "EGST": "格陵兰东部标准时间", "EST": "东部标准时间", "FKST": "福克兰群岛夏令时间", "GALT": "加拉巴哥群岛时间", "GFT": "法属圭亚那时间", "GMT": "格林威治标准时间", "GST": "波斯湾海域标准时间", "GYT": "盖亚那时间", "HADT": "夏威夷-阿留申夏令时间", "HAST": "夏威夷-阿留申标准时间", "HENOMX": "墨西哥西北部夏令时间", "HEOG": "格陵兰西部夏令时间", "HEPMX": "墨西哥太平洋夏令时间", "HKST": "香港夏令时间", "HKT": "香港标准时间", "HNNOMX": "墨西哥西北部标准时间", "HNOG": "格陵兰西部标准时间", "HNPMX": "墨西哥太平洋标准时间", "ICT": "印度支那时间", "IRDT": "伊朗夏令时间", "IRST": "伊朗标准时间", "IST": "印度标准时间", "JDT": "日本夏令时间", "JST": "日本标准时间", "LHDT": "豪勋爵岛夏令时间", "LHST": "豪勋爵岛标准时间", "MDT": "山区夏令时间", "MESZ": "中欧夏令时间", "MEZ": "中欧标准时间", "MST": "山区标准时间", "MVT": "马尔地夫时间", "MYT": "马来西亚时间", "NDT": "纽芬兰夏令时间", "NPT": "尼泊尔时间", "NST": "纽芬兰标准时间", "NZDT": "纽西兰夏令时间", "NZST": "纽西兰标准时间", "OESZ": "东欧夏令时间", "OEZ": "东欧标准时间", "PDT": "太平洋夏令时间", "PKT": "巴基斯坦夏令时间", "PMDT": "圣皮埃尔和密克隆群岛夏令时间", "PMST": "圣皮埃尔和密克隆群岛标准时间", "PST": "太平洋标准时间", "PYST": "巴拉圭夏令时间", "SAST": "南非标准时间", "SGT": "新加坡标准时间", "SRT": "苏利南时间", "TLT": "东帝汶时间", "TMST": "土库曼夏令时间", "TMT": "土库曼标准时间", "UYST": "乌拉圭夏令时间", "UYT": "乌拉圭标准时间", "VET": "委内瑞拉时间", "WARST": "阿根廷西部夏令时间", "WART": "阿根廷西部标准时间", "WAST": "西非夏令时间", "WAT": "西非标准时间", "WESZ": "西欧夏令时间", "WEZ": "西欧标准时间", "WIB": "印尼西部时间", "WIT": "印尼东部时间", "WITA": "印尼中部时间", "∅∅∅": "亚速尔群岛夏令时间"},
		},
...
// DateFullLayout returns the full date layout for 'yue_Hans'
func (yue *yue_Hans) DateFullLayout() string {
	return yue.dateFullLayout
}

// DateLongLayout returns the long date layout for 'yue_Hans'
func (yue *yue_Hans) DateLongLayout() string {
	return yue.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'yue_Hans'
func (yue *yue_Hans) DateMediumLayout() string {
	return yue.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'yue_Hans'
func (yue *yue_Hans) DateShortLayout() string {
	return yue.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'yue_Hans'
func (yue *yue_Hans) TimeFullLayout() string {
	return yue.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'yue_Hans'
func (yue *yue_Hans) TimeLongLayout() string {
	return yue.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'yue_Hans'
func (yue *yue_Hans) TimeMediumLayout() string {
	return yue.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'yue_Hans'
func (yue *yue_Hans) TimeShortLayout() string {
	return yue.timeShortLayout
}

func (yue *yue_Hans) ListPatterns() *locales.ListPatterns {
	return yue.listPatterns
}

func (yue *yue_Hans) GetDurationSpec() *locales.DurationSpec {
	return yue.DurationSpec
}

func (yue *yue_Hans) GetMiscPatterns() *locales.MiscPatterns {
