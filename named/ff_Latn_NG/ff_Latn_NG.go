...
// DateFullLayout returns the full date layout for 'ff_Latn_NG'
func (ff *ff_Latn_NG) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff_Latn_NG'
func (ff *ff_Latn_NG) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff_Latn_NG'
func (ff *ff_Latn_NG) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff_Latn_NG'
func (ff *ff_Latn_NG) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff_Latn_NG'
func (ff *ff_Latn_NG) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff_Latn_NG'
func (ff *ff_Latn_NG) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff_Latn_NG'
func (ff *ff_Latn_NG) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff_Latn_NG'
func (ff *ff_Latn_NG) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff_Latn_NG) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff_Latn_NG) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff_Latn_NG) GetMiscPatterns() *locales.MiscPatterns {
