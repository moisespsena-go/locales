...
// DateFullLayout returns the full date layout for 'en_CM'
func (en *en_CM) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_CM'
func (en *en_CM) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_CM'
func (en *en_CM) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_CM'
func (en *en_CM) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_CM'
func (en *en_CM) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_CM'
func (en *en_CM) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_CM'
func (en *en_CM) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_CM'
func (en *en_CM) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_CM) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_CM) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_CM) GetMiscPatterns() *locales.MiscPatterns {
