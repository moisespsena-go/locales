...
func New() locales.Translator {
	return &ky{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 миң ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 миң ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 миң ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 миң ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 миң ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 миң ¤"),
						}},
						...
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 млд ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 млд ¤"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 млд ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 млд ¤"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 млд ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 млд ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "янв.", "фев.", "мар.", "апр.", "май", "июн.", "июл.", "авг.", "сен.", "окт.", "ноя.", "дек."},
			MonthsNarrowValue:        []string{"", "Я", "Ф", "М", "А", "М", "И", "И", "А", "С", "О", "Н", "Д"},
			MonthsWideValue:          []string{"", "январь", "февраль", "март", "апрель", "май", "июнь", "июль", "август", "сентябрь", "октябрь", "ноябрь", "декабрь"},
			WeekdaysAbbreviatedValue: []string{"жек.", "дүй.", "шейш.", "шарш.", "бейш.", "жума", "ишм."},
			WeekdaysNarrowValue:      []string{"Ж", "Д", "Ш", "Ш", "Б", "Ж", "И"},
			WeekdaysShortValue:       []string{"жш.", "дш.", "шш.", "шр.", "бш.", "жм.", "иш."},
			WeekdaysWideValue:        []string{"жекшемби", "дүйшөмбү", "шейшемби", "шаршемби", "бейшемби", "жума", "ишемби"},
			PeriodsAbbreviatedValue:  []string{"тң", "тк"},
			PeriodsNarrowValue:       []string{"тң", "тк"},
			PeriodsWideValue:         []string{"таңкы", "түштөн кийинки"},
			ErasAbbreviatedValue:     []string{"б.з.ч.", "б.з."},
			ErasNarrowValue:          []string{"б.з.ч.", "б.з."},
			ErasWideValue:            []string{"биздин заманга чейин", "биздин заман"},
			TimezonesValue:           map[string]string{"": "Парагвай кышкы убактысы", "ACDT": "Австралия борбордук жайкы убактысы", "ACST": "Австралия борбордук кышкы убакыты", "ACT": "ACT", "ACWDT": "Австралия борбордук чыгыш жайкы убактысы", "ACWST": "Австралия борбордук батыш кышкы убакыты", "ADT": "Атлантика жайкы убактысы", "AEDT": "Австралия чыгыш жайкы убактысы", "AEST": "Австралия чыгыш кышкы убакыты", "AFT": "Афганистан убактысы", "AKDT": "Аляска жайкы убактысы", "AKST": "Аляска кышкы убактысы", "AMST": "Амазон жайкы убактысы", "AMT": "Амазон кышкы убактысы", "ARST": "Аргентина жайкы убактысы", "ART": "Аргентина кышкы убактысы", "AST": "Атлантика кышкы убактысы", "AWDT": "Австралия батыш жайкы убактысы", "AWST": "Австралия батыш кышкы убакыты", "BNT": "Бруней Даруссалам убактысы", "BOT": "Боливия убактысы", "BRST": "Бразилия жайкы убактысы", "BRT": "Бразилия кышкы убактысы", "BST": "Бангладеш жайкы убактысы", "BTT": "Бутан убактысы", "CAT": "Борбордук Африка убактысы", "CCT": "Кокос аралдарынын убактысы", "CDT": "Түндүк Америка, борбордук жайкы убактысы", "CDT (Kuba)": "Куба жайкы убактысы", "CHADT": "Чатам жайкы убактысы", "CHAST": "Чатам кышкы убакыт", "CLST": "Чили жайкы убактысы", "CLT": "Чили кышкы убактысы", "COST": "Колумбия жайкы убактысы", "COT": "Колумбия кышкы убактысы", "CST": "Түндүк Америка, борбордук кышкы убактысы", "CST (Kuba)": "Куба кышкы убактысы", "CXT": "Крисмас аралынын убактысы", "ChST": "Чаморро убактысы", "EASST": "Истер аралынын жайкы убакыты", "EAST": "Истер аралынын кышкы убакыты", "EAT": "Чыгыш Африка убактысы", "ECT": "Экуадор убактысы", "EDT": "Түндүк Америка, чыгыш жайкы убактысы", "EGDT": "Чыгыш Гренландия жайкы убактысы", "EGST": "Чыгыш Гренландия кышкы убактысы", "EST": "Түндүк Америка, чыгыш кышкы убактысы", "FKST": "Фолкленд аралдарынын жайкы убактысы", "GALT": "Галапагос убактысы", "GFT": "Француз Гвиана убактысы", "GMT": "Гринвич боюнча орточо убакыт", "GST": "Булуңдун стандарттык убакыты", "GYT": "Гвиана убактысы", "HADT": "Гавайи-Алеут жайкы убактысы", "HAST": "Гавайи-Алеут кышкы убактысы", "HENOMX": "Түндүк-чыгыш Мексика жайкы убактысы", "HEOG": "Батыш Гренландия жайкы убактысы", "HEPMX": "Мексика, Тынч океан жайкы убактысы", "HKST": "Гонконг жайкы убактысы", "HKT": "Гонконг кышкы убакыты", "HNNOMX": "Түндүк-чыгыш Мексика кышкы убактысы", "HNOG": "Батыш Гренландия кышкы убактысы", "HNPMX": "Мексика, Тынч океан кышкы убактысы", "ICT": "Индокытай убактысы", "IRDT": "Иран күндүзгү убактысы", "IRST": "Иран кышкы убакыты", "IST": "Индия убактысы", "JDT": "Жапон жайкы убактысы", "JST": "Жапон кышкы убакыты", "LHDT": "Лорд Хау жайкы убактысы", "LHST": "Лорд Хау кышкы убакыты", "MDT": "Түндүк Америка, тоо жайкы убактысы", "MESZ": "Борбордук Европа жайкы убактысы", "MEZ": "Борбордук Европа кышкы убакыты", "MST": "Түндүк Америка, тоо кышкы убактысы", "MVT": "Мальдив убактысы", "MYT": "Малайзия убактысы", "NDT": "Нюфаундлэнд жайкы убактысы", "NPT": "Непал убактысы", "NST": "Нюфаундлэнд кышкы убактысы", "NZDT": "Жаңы Зеландия жайкы убакыты", "NZST": "Жаңы Зеландия кышкы убакыты", "OESZ": "Чыгыш Европа жайкы убактысы", "OEZ": "Чыгыш Европа кышкы убакыты", "PDT": "Түндүк Америка, Тынч океан жайкы убактысы", "PKT": "Пакистан жайкы убактысы", "PMDT": "Сен Пьер жана Микелон жайкы убактысы", "PMST": "Сен Пьер жана Микелон кышкы убактысы", "PST": "Түндүк Америка, Тынч океан кышкы убактысы", "PYST": "Парагвай жайкы убактысы", "SAST": "Түштүк Африка убактысы", "SGT": "Сингапур убактысы", "SRT": "Суринаме убактысы", "TLT": "Чыгыш Тимор убактысы", "TMST": "Түркмөнстан жайкы убактысы", "TMT": "Түркмөнстан кышкы убакыты", "UYST": "Уругвай жайкы убактысы", "UYT": "Уругвай кышкы убактысы", "VET": "Венесуэла убактысы", "WARST": "Батыш Аргентина жайкы убактысы", "WART": "Батыш Аргентина кышкы убактысы", "WAST": "Батыш Африка жайкы убактысы", "WAT": "Батыш Африка кышкы убакыты", "WESZ": "Батыш Европа жайкы убактысы", "WEZ": "Батыш Европа кышкы убакыты", "WIB": "Батыш Индонезия убактысы", "WIT": "Чыгыш Индонезия убактысы", "WITA": "Борбордук Индонезия убактысы", "∅∅∅": "Азорс жайкы убактысы"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} жана {1}", "{0}, {1}", "{0}, {1}", "{0} жана {1}"}, {"{0} же {1}", "{0}, {1}", "{0}, {1}", "{0} же {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"к.", "%v к.", "%v к.", ""},
				Long:   &locales.CounterFormat{"кылым", "%v кылым", "%v кылым", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"декада", "%v дек.", "%v дек.", ""},
				Long:   &locales.CounterFormat{"декада", "%v декада", "%v декада", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"жыл", "%v ж.", "%v ж.", ""},
				Long:   &locales.CounterFormat{"жыл", "%v жыл", "%v жыл", "жылына %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ай", "%v ай", "%v ай", ""},
				Long:   &locales.CounterFormat{"ай", "%v ай", "%v ай", "айына %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"апт", "%v ап", "%v ап", ""},
				Long:   &locales.CounterFormat{"апта", "%v апта", "%v апта", "аптасына %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"күн", "%v кн", "%v кн", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"саат", "%v ст", "%v ст", ""},
				Long:   &locales.CounterFormat{"саат", "%v саат", "%v саат", "саатына %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мүн", "%v мүн", "%v мүн", ""},
				Long:   &locales.CounterFormat{"мүнөт", "%v мүнөт", "%v мүнөт", "мүнөтүнө %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"сек", "%v сек", "%v сек", ""},
				Long:   &locales.CounterFormat{"секунд", "%v секунд", "%v секунд", "секундуна %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"миллисек", "%v мсек", "%v мсек", ""},
				Long:   &locales.CounterFormat{"миллисекунд", "%v миллисекунд", "%v миллисекунд", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μсек", "%vμс", "%vμс", ""},
				Long:   &locales.CounterFormat{"микросекунд", "%v микросекунд", "%v микросекунд", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"наносек", "%v нс", "%v нс", ""},
				Long:   &locales.CounterFormat{"наносекунд", "%v наносекунд", "%v наносекунд", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (ky *ky) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ky, ky.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ky'
func (ky *ky) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ky, ky.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ky'
func (ky *ky) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ky, ky.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ky'
func (ky *ky) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ky, ky.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ky'
func (ky *ky) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ky, ky.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ky'
func (ky *ky) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ky, ky.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ky'
func (ky *ky) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ky, ky.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ky'
func (ky *ky) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ky, ky.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ky'
func (ky *ky) DateFullLayout() string {
	return ky.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ky'
func (ky *ky) DateLongLayout() string {
	return ky.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ky'
func (ky *ky) DateMediumLayout() string {
	return ky.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ky'
func (ky *ky) DateShortLayout() string {
	return ky.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ky'
func (ky *ky) TimeFullLayout() string {
	return ky.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ky'
func (ky *ky) TimeLongLayout() string {
	return ky.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ky'
func (ky *ky) TimeMediumLayout() string {
	return ky.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ky'
func (ky *ky) TimeShortLayout() string {
	return ky.timeShortLayout
}

func (ky *ky) ListPatterns() *locales.ListPatterns {
	return ky.listPatterns
}

func (ky *ky) GetDurationSpec() *locales.DurationSpec {
	return ky.DurationSpec
}

func (ky *ky) GetMiscPatterns() *locales.MiscPatterns {
	return &ky.miscPatterns
}
