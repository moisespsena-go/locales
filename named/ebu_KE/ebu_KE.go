...
func New() locales.Translator {
	return &ebu_KE{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Mbe", "Kai", "Kat", "Kan", "Gat", "Gan", "Mug", "Knn", "Ken", "Iku", "Imw", "Igi"},
			MonthsNarrowValue:        []string{"", "M", "K", "K", "K", "G", "G", "M", "K", "K", "I", "I", "I"},
			MonthsWideValue:          []string{"", "Mweri wa mbere", "Mweri wa kaĩri", "Mweri wa kathatũ", "Mweri wa kana", "Mweri wa gatano", "Mweri wa gatantatũ", "Mweri wa mũgwanja", "Mweri wa kanana", "Mweri wa kenda", "Mweri wa ikũmi", "Mweri wa ikũmi na ũmwe", "Mweri wa ikũmi na Kaĩrĩ"},
			WeekdaysAbbreviatedValue: []string{"Kma", "Tat", "Ine", "Tan", "Arm", "Maa", "NMM"},
			WeekdaysNarrowValue:      []string{"K", "N", "N", "N", "A", "M", "N"},
			WeekdaysWideValue:        []string{"Kiumia", "Njumatatu", "Njumaine", "Njumatano", "Aramithi", "Njumaa", "NJumamothii"},
			PeriodsAbbreviatedValue:  []string{"KI", "UT"},
			PeriodsWideValue:         []string{"KI", "UT"},
			ErasAbbreviatedValue:     []string{"MK", "TK"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Mbere ya Kristo", "Thutha wa Kristo"},
...
func (ebu *ebu_KE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ebu, ebu.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ebu_KE'
func (ebu *ebu_KE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ebu, ebu.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ebu_KE'
func (ebu *ebu_KE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ebu, ebu.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ebu_KE'
func (ebu *ebu_KE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ebu, ebu.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ebu_KE'
func (ebu *ebu_KE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ebu, ebu.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ebu_KE'
func (ebu *ebu_KE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ebu, ebu.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ebu_KE'
func (ebu *ebu_KE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ebu, ebu.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ebu_KE'
func (ebu *ebu_KE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ebu, ebu.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ebu_KE'
func (ebu *ebu_KE) DateFullLayout() string {
	return ebu.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ebu_KE'
func (ebu *ebu_KE) DateLongLayout() string {
	return ebu.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ebu_KE'
func (ebu *ebu_KE) DateMediumLayout() string {
	return ebu.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ebu_KE'
func (ebu *ebu_KE) DateShortLayout() string {
	return ebu.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ebu_KE'
func (ebu *ebu_KE) TimeFullLayout() string {
	return ebu.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ebu_KE'
func (ebu *ebu_KE) TimeLongLayout() string {
	return ebu.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ebu_KE'
func (ebu *ebu_KE) TimeMediumLayout() string {
	return ebu.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ebu_KE'
func (ebu *ebu_KE) TimeShortLayout() string {
	return ebu.timeShortLayout
}

func (ebu *ebu_KE) ListPatterns() *locales.ListPatterns {
	return ebu.listPatterns
}

func (ebu *ebu_KE) GetDurationSpec() *locales.DurationSpec {
	return ebu.DurationSpec
}

func (ebu *ebu_KE) GetMiscPatterns() *locales.MiscPatterns {
	return &ebu.miscPatterns
}
