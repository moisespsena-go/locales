...
func New() locales.Translator {
	return &ln{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "yan", "fbl", "msi", "apl", "mai", "yun", "yul", "agt", "stb", "ɔtb", "nvb", "dsb"},
			MonthsNarrowValue:        []string{"", "y", "f", "m", "a", "m", "y", "y", "a", "s", "ɔ", "n", "d"},
			MonthsWideValue:          []string{"", "sánzá ya yambo", "sánzá ya míbalé", "sánzá ya mísáto", "sánzá ya mínei", "sánzá ya mítáno", "sánzá ya motóbá", "sánzá ya nsambo", "sánzá ya mwambe", "sánzá ya libwa", "sánzá ya zómi", "sánzá ya zómi na mɔ̌kɔ́", "sánzá ya zómi na míbalé"},
			WeekdaysAbbreviatedValue: []string{"eye", "ybo", "mbl", "mst", "min", "mtn", "mps"},
			WeekdaysNarrowValue:      []string{"e", "y", "m", "m", "m", "m", "p"},
			WeekdaysWideValue:        []string{"eyenga", "mokɔlɔ mwa yambo", "mokɔlɔ mwa míbalé", "mokɔlɔ mwa mísáto", "mokɔlɔ ya mínéi", "mokɔlɔ ya mítáno", "mpɔ́sɔ"},
			PeriodsAbbreviatedValue:  []string{"ntɔ́ngɔ́", "mpókwa"},
			PeriodsWideValue:         []string{"ntɔ́ngɔ́", "mpókwa"},
			ErasAbbreviatedValue:     []string{"libóso ya", "nsima ya Y"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Yambo ya Yézu Krís", "Nsima ya Yézu Krís"},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "ADT", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "AST", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "Ntángo ya Lubumbashi", "CCT": "CCT", "CDT": "CDT", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "CST", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "Ntángo ya Afríka ya Ɛ́sita", "ECT": "ECT", "EDT": "EDT", "EGDT": "EGDT", "EGST": "EGST", "EST": "EST", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "Ntángo ya Londoni", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "MESZ", "MEZ": "MEZ", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "OESZ", "OEZ": "OEZ", "PDT": "PDT", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "PST", "PYST": "PYST", "SAST": "Ntángo ya Afríka ya Sidi", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "WESZ", "WEZ": "WEZ", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} mpé {1}", "{0}, {1}", "{0}, {1}", "{0} mpé {1}"}, []string(nil)}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"sekúlo", "%v sekúlo", "%v sekúlo", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"mibú", "%v mobú", "%v mibú", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sánzá", "%v sán", "%v sán", ""},
				Long:   &locales.CounterFormat{"sánzá", "%v sánzá", "%v sánzá", "%v/sán"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mps", "%v mps", "%v mps", ""},
				Long:   &locales.CounterFormat{"mpɔ́sɔ", "%v mpɔ́sɔ", "%v mpɔ́sɔ", "%v/mps"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mokɔlɔ", "%v d", "%v d", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ngonga", "%v h", "%v h", ""},
				Long:   &locales.CounterFormat{"ngonga", "%v ngonga", "%v ngonga", "%v/h"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%v min", "%v min", ""},
				Long:   &locales.CounterFormat{"minúti", "%v monúti", "%v minúti", "%v/monúti"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%v s", "%v s", ""},
				Long:   &locales.CounterFormat{"sekundí", "%v sekundí", "%v sekundí", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"millisekundí", "%v millisekundí", "%v millisekundí", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"mikrosekundí", "%v mikrosekundí", "%v mikrosekundí", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosekundí", "%v nanosekundí", "%v nanosekundí", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"",
			"",
...
func (ln *ln) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ln, ln.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ln'
func (ln *ln) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ln, ln.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ln'
func (ln *ln) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ln, ln.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ln'
func (ln *ln) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ln, ln.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ln'
func (ln *ln) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ln, ln.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ln'
func (ln *ln) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ln, ln.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ln'
func (ln *ln) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ln, ln.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ln'
func (ln *ln) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ln, ln.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ln'
func (ln *ln) DateFullLayout() string {
	return ln.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ln'
func (ln *ln) DateLongLayout() string {
	return ln.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ln'
func (ln *ln) DateMediumLayout() string {
	return ln.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ln'
func (ln *ln) DateShortLayout() string {
	return ln.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ln'
func (ln *ln) TimeFullLayout() string {
	return ln.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ln'
func (ln *ln) TimeLongLayout() string {
	return ln.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ln'
func (ln *ln) TimeMediumLayout() string {
	return ln.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ln'
func (ln *ln) TimeShortLayout() string {
	return ln.timeShortLayout
}

func (ln *ln) ListPatterns() *locales.ListPatterns {
	return ln.listPatterns
}

func (ln *ln) GetDurationSpec() *locales.DurationSpec {
	return ln.DurationSpec
}

func (ln *ln) GetMiscPatterns() *locales.MiscPatterns {
	return &ln.miscPatterns
}
