...
// DateFullLayout returns the full date layout for 'ru_BY'
func (ru *ru_BY) DateFullLayout() string {
	return ru.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ru_BY'
func (ru *ru_BY) DateLongLayout() string {
	return ru.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ru_BY'
func (ru *ru_BY) DateMediumLayout() string {
	return ru.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ru_BY'
func (ru *ru_BY) DateShortLayout() string {
	return ru.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ru_BY'
func (ru *ru_BY) TimeFullLayout() string {
	return ru.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ru_BY'
func (ru *ru_BY) TimeLongLayout() string {
	return ru.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ru_BY'
func (ru *ru_BY) TimeMediumLayout() string {
	return ru.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ru_BY'
func (ru *ru_BY) TimeShortLayout() string {
	return ru.timeShortLayout
}

func (ru *ru_BY) ListPatterns() *locales.ListPatterns {
	return ru.listPatterns
}

func (ru *ru_BY) GetDurationSpec() *locales.DurationSpec {
	return ru.DurationSpec
}

func (ru *ru_BY) GetMiscPatterns() *locales.MiscPatterns {
