...
// DateFullLayout returns the full date layout for 'en_ZW'
func (en *en_ZW) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_ZW'
func (en *en_ZW) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_ZW'
func (en *en_ZW) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_ZW'
func (en *en_ZW) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_ZW'
func (en *en_ZW) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_ZW'
func (en *en_ZW) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_ZW'
func (en *en_ZW) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_ZW'
func (en *en_ZW) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_ZW) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_ZW) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_ZW) GetMiscPatterns() *locales.MiscPatterns {
