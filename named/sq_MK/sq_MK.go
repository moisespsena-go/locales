...
// DateFullLayout returns the full date layout for 'sq_MK'
func (sq *sq_MK) DateFullLayout() string {
	return sq.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sq_MK'
func (sq *sq_MK) DateLongLayout() string {
	return sq.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sq_MK'
func (sq *sq_MK) DateMediumLayout() string {
	return sq.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sq_MK'
func (sq *sq_MK) DateShortLayout() string {
	return sq.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sq_MK'
func (sq *sq_MK) TimeFullLayout() string {
	return sq.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sq_MK'
func (sq *sq_MK) TimeLongLayout() string {
	return sq.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sq_MK'
func (sq *sq_MK) TimeMediumLayout() string {
	return sq.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sq_MK'
func (sq *sq_MK) TimeShortLayout() string {
	return sq.timeShortLayout
}

func (sq *sq_MK) ListPatterns() *locales.ListPatterns {
	return sq.listPatterns
}

func (sq *sq_MK) GetDurationSpec() *locales.DurationSpec {
	return sq.DurationSpec
}

func (sq *sq_MK) GetMiscPatterns() *locales.MiscPatterns {
