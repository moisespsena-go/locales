	...
	return &es_PY{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"años", "%v año", "%v años", "%v/año"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"meses", "%v mes", "%v meses", "%v/mes"}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"días", "%v día", "%v días", "%v/día"}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
...
// DateFullLayout returns the full date layout for 'es_PY'
func (es *es_PY) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_PY'
func (es *es_PY) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_PY'
func (es *es_PY) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_PY'
func (es *es_PY) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_PY'
func (es *es_PY) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_PY'
func (es *es_PY) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_PY'
func (es *es_PY) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_PY'
func (es *es_PY) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_PY) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_PY) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_PY) GetMiscPatterns() *locales.MiscPatterns {
