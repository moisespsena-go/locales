...
func (vun *vun_TZ) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(vun, vun.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'vun_TZ'
func (vun *vun_TZ) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(vun, vun.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'vun_TZ'
func (vun *vun_TZ) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(vun, vun.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'vun_TZ'
func (vun *vun_TZ) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(vun, vun.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'vun_TZ'
func (vun *vun_TZ) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(vun, vun.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'vun_TZ'
func (vun *vun_TZ) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(vun, vun.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'vun_TZ'
func (vun *vun_TZ) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(vun, vun.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'vun_TZ'
func (vun *vun_TZ) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(vun, vun.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'vun_TZ'
func (vun *vun_TZ) DateFullLayout() string {
	return vun.dateFullLayout
}

// DateLongLayout returns the long date layout for 'vun_TZ'
func (vun *vun_TZ) DateLongLayout() string {
	return vun.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'vun_TZ'
func (vun *vun_TZ) DateMediumLayout() string {
	return vun.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'vun_TZ'
func (vun *vun_TZ) DateShortLayout() string {
	return vun.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'vun_TZ'
func (vun *vun_TZ) TimeFullLayout() string {
	return vun.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'vun_TZ'
func (vun *vun_TZ) TimeLongLayout() string {
	return vun.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'vun_TZ'
func (vun *vun_TZ) TimeMediumLayout() string {
	return vun.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'vun_TZ'
func (vun *vun_TZ) TimeShortLayout() string {
	return vun.timeShortLayout
}

func (vun *vun_TZ) ListPatterns() *locales.ListPatterns {
	return vun.listPatterns
}

func (vun *vun_TZ) GetDurationSpec() *locales.DurationSpec {
	return vun.DurationSpec
}

func (vun *vun_TZ) GetMiscPatterns() *locales.MiscPatterns {
	return &vun.miscPatterns
}
