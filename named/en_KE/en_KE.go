...
// DateFullLayout returns the full date layout for 'en_KE'
func (en *en_KE) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_KE'
func (en *en_KE) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_KE'
func (en *en_KE) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_KE'
func (en *en_KE) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_KE'
func (en *en_KE) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_KE'
func (en *en_KE) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_KE'
func (en *en_KE) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_KE'
func (en *en_KE) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_KE) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_KE) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_KE) GetMiscPatterns() *locales.MiscPatterns {
