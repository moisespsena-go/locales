...
// DateFullLayout returns the full date layout for 'ku_TR'
func (ku *ku_TR) DateFullLayout() string {
	return ku.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ku_TR'
func (ku *ku_TR) DateLongLayout() string {
	return ku.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ku_TR'
func (ku *ku_TR) DateMediumLayout() string {
	return ku.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ku_TR'
func (ku *ku_TR) DateShortLayout() string {
	return ku.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ku_TR'
func (ku *ku_TR) TimeFullLayout() string {
	return ku.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ku_TR'
func (ku *ku_TR) TimeLongLayout() string {
	return ku.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ku_TR'
func (ku *ku_TR) TimeMediumLayout() string {
	return ku.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ku_TR'
func (ku *ku_TR) TimeShortLayout() string {
	return ku.timeShortLayout
}

func (ku *ku_TR) ListPatterns() *locales.ListPatterns {
	return ku.listPatterns
}

func (ku *ku_TR) GetDurationSpec() *locales.DurationSpec {
	return ku.DurationSpec
}

func (ku *ku_TR) GetMiscPatterns() *locales.MiscPatterns {
