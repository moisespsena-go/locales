...
func New() locales.Translator {
	return &is_IS{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 þ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 þ'.' ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 þ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 þ'.' ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 þ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 þ'.' ¤"),
						}},
						...
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 ma'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 ma'.' ¤"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 ma'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 ma'.' ¤"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 ma'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 ma'.' ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jan.", "feb.", "mar.", "apr.", "maí", "jún.", "júl.", "ágú.", "sep.", "okt.", "nóv.", "des."},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "Á", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "janúar", "febrúar", "mars", "apríl", "maí", "júní", "júlí", "ágúst", "september", "október", "nóvember", "desember"},
			WeekdaysAbbreviatedValue: []string{"sun.", "mán.", "þri.", "mið.", "fim.", "fös.", "lau."},
			WeekdaysNarrowValue:      []string{"S", "M", "Þ", "M", "F", "F", "L"},
			WeekdaysShortValue:       []string{"su.", "má.", "þr.", "mi.", "fi.", "fö.", "la."},
			WeekdaysWideValue:        []string{"sunnudagur", "mánudagur", "þriðjudagur", "miðvikudagur", "fimmtudagur", "föstudagur", "laugardagur"},
			PeriodsAbbreviatedValue:  []string{"f.h.", "e.h."},
			PeriodsNarrowValue:       []string{"f.", "e."},
			PeriodsWideValue:         []string{"f.h.", "e.h."},
			ErasAbbreviatedValue:     []string{"f.Kr.", "e.Kr."},
			ErasNarrowValue:          []string{"f.k.", "e.k."},
			ErasWideValue:            []string{"fyrir Krist", "eftir Krist"},
			TimezonesValue:           map[string]string{"": "Staðaltími á Falklandseyjum", "ACDT": "Sumartími í Mið-Ástralíu", "ACST": "Staðaltími í Mið-Ástralíu", "ACT": "ACT", "ACWDT": "Sumartími í miðvesturhluta Ástralíu", "ACWST": "Staðaltími í miðvesturhluta Ástralíu", "ADT": "Sumartími á Atlantshafssvæðinu", "AEDT": "Sumartími í Austur-Ástralíu", "AEST": "Staðaltími í Austur-Ástralíu", "AFT": "Afganistantími", "AKDT": "Sumartími í Alaska", "AKST": "Staðaltími í Alaska", "AMST": "Sumartími á Amasónsvæðinu", "AMT": "Staðaltími á Amasónsvæðinu", "ARST": "Sumartími í Argentínu", "ART": "Staðaltími í Argentínu", "AST": "Staðaltími á Atlantshafssvæðinu", "AWDT": "Sumartími í Vestur-Ástralíu", "AWST": "Staðaltími í Vestur-Ástralíu", "BNT": "Brúneitími", "BOT": "Bólivíutími", "BRST": "Sumartími í Brasilíu", "BRT": "Staðaltími í Brasilíu", "BST": "Sumartími í Bangladess", "BTT": "Bútantími", "CAT": "Mið-Afríkutími", "CCT": "Kókoseyjatími", "CDT": "Sumartími í miðhluta Bandaríkjanna og Kanada", "CDT (Kuba)": "Sumartími á Kúbu", "CHADT": "Sumartími í Chatham", "CHAST": "Staðaltími í Chatham", "CLST": "Sumartími í Síle", "CLT": "Staðaltími í Síle", "COST": "Sumartími í Kólumbíu", "COT": "Staðaltími í Kólumbíu", "CST": "Staðaltími í miðhluta Bandaríkjanna og Kanada", "CST (Kuba)": "Staðaltími á Kúbu", "CXT": "Jólaeyjartími", "ChST": "Chamorro-staðaltími", "EASST": "Sumartími á Páskaeyju", "EAST": "Staðaltími á Páskaeyju", "EAT": "Austur-Afríkutími", "ECT": "Ekvadortími", "EDT": "Sumartími í austurhluta Bandaríkjanna og Kanada", "EGDT": "Sumartími á Austur-Grænlandi", "EGST": "Staðaltími á Austur-Grænlandi", "EST": "Staðaltími í austurhluta Bandaríkjanna og Kanada", "FKST": "Sumartími á Falklandseyjum", "GALT": "Galapagos-tími", "GFT": "Tími í Frönsku Gvæjana", "GMT": "Greenwich-staðaltími", "GST": "Staðaltími við Persaflóa", "GYT": "Gvæjanatími", "HADT": "Sumartími á Havaí og Aleúta", "HAST": "Staðaltími á Havaí og Aleúta", "HENOMX": "Sumartími í Norðvestur-Mexíkó", "HEOG": "Sumartími á Vestur-Grænlandi", "HEPMX": "Sumartími í Mexíkó á Kyrrahafssvæðinu", "HKST": "Sumartími í Hong Kong", "HKT": "Staðaltími í Hong Kong", "HNNOMX": "Staðaltími í Norðvestur-Mexíkó", "HNOG": "Staðaltími á Vestur-Grænlandi", "HNPMX": "Staðaltími í Mexíkó á Kyrrahafssvæðinu", "ICT": "Indókínatími", "IRDT": "Sumartími í Íran", "IRST": "Staðaltími í Íran", "IST": "Indlandstími", "JDT": "Sumartími í Japan", "JST": "Staðaltími í Japan", "LHDT": "Sumartími á Lord Howe-eyju", "LHST": "Staðaltími á Lord Howe-eyju", "MDT": "MDT", "MESZ": "Sumartími í Mið-Evrópu", "MEZ": "Staðaltími í Mið-Evrópu", "MST": "MST", "MVT": "Maldíveyja-tími", "MYT": "Malasíutími", "NDT": "Sumartími á Nýfundnalandi", "NPT": "Nepaltími", "NST": "Staðaltími á Nýfundnalandi", "NZDT": "Sumartími á Nýja-Sjálandi", "NZST": "Staðaltími á Nýja-Sjálandi", "OESZ": "Sumartími í Austur-Evrópu", "OEZ": "Staðaltími í Austur-Evrópu", "PDT": "Sumartími á Kyrrahafssvæðinu", "PKT": "Sumartími í Pakistan", "PMDT": "Sumartími á Sankti Pierre og Miquelon", "PMST": "Staðaltími á Sankti Pierre og Miquelon", "PST": "Staðaltími á Kyrrahafssvæðinu", "PYST": "Sumartími í Paragvæ", "SAST": "Suður-Afríkutími", "SGT": "Singapúrtími", "SRT": "Súrinamtími", "TLT": "Tíminn á Tímor-Leste", "TMST": "Sumartími í Túrkmenistan", "TMT": "Staðaltími í Túrkmenistan", "UYST": "Sumartími í Úrúgvæ", "UYT": "Staðaltími í Úrúgvæ", "VET": "Venesúelatími", "WARST": "Sumartími í Vestur-Argentínu", "WART": "Staðaltími í Vestur-Argentínu", "WAST": "Sumartími í Vestur-Afríku", "WAT": "Staðaltími í Vestur-Afríku", "WESZ": "Sumartími í Vestur-Evrópu", "WEZ": "Staðaltími í Vestur-Evrópu", "WIB": "Vestur-Indónesíutími", "WIT": "Austur-Indónesíutími", "WITA": "Mið-Indónesíutími", "∅∅∅": "Sumartími í Perú"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} og {1}", "{0}, {1}", "{0}, {1}", "{0} og {1}"}, {"{0} eða {1}", "{0}, {1}", "{0}, {1}", "{0} eða {1}"}}),
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
			"≤%[1]v",
...
func (is *is_IS) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(is, is.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'is_IS'
func (is *is_IS) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(is, is.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'is_IS'
func (is *is_IS) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(is, is.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'is_IS'
func (is *is_IS) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(is, is.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'is_IS'
func (is *is_IS) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(is, is.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'is_IS'
func (is *is_IS) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(is, is.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'is_IS'
func (is *is_IS) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(is, is.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'is_IS'
func (is *is_IS) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(is, is.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'is_IS'
func (is *is_IS) DateFullLayout() string {
	return is.dateFullLayout
}

// DateLongLayout returns the long date layout for 'is_IS'
func (is *is_IS) DateLongLayout() string {
	return is.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'is_IS'
func (is *is_IS) DateMediumLayout() string {
	return is.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'is_IS'
func (is *is_IS) DateShortLayout() string {
	return is.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'is_IS'
func (is *is_IS) TimeFullLayout() string {
	return is.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'is_IS'
func (is *is_IS) TimeLongLayout() string {
	return is.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'is_IS'
func (is *is_IS) TimeMediumLayout() string {
	return is.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'is_IS'
func (is *is_IS) TimeShortLayout() string {
	return is.timeShortLayout
}

func (is *is_IS) ListPatterns() *locales.ListPatterns {
	return is.listPatterns
}

func (is *is_IS) GetDurationSpec() *locales.DurationSpec {
	return is.DurationSpec
}

func (is *is_IS) GetMiscPatterns() *locales.MiscPatterns {
	return &is.miscPatterns
}
