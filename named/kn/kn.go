...
func New() locales.Translator {
	return &kn{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ಜನವರಿ", "ಫೆಬ್ರವರಿ", "ಮಾರ್ಚ್", "ಏಪ್ರಿ", "ಮೇ", "ಜೂನ್", "ಜುಲೈ", "ಆಗ", "ಸೆಪ್ಟೆಂ", "ಅಕ್ಟೋ", "ನವೆಂ", "ಡಿಸೆಂ"},
			MonthsNarrowValue:        []string{"", "ಜ", "ಫೆ", "ಮಾ", "ಏ", "ಮೇ", "ಜೂ", "ಜು", "ಆ", "ಸೆ", "ಅ", "ನ", "ಡಿ"},
			MonthsWideValue:          []string{"", "ಜನವರಿ", "ಫೆಬ್ರವರಿ", "ಮಾರ್ಚ್", "ಏಪ್ರಿಲ್", "ಮೇ", "ಜೂನ್", "ಜುಲೈ", "ಆಗಸ್ಟ್", "ಸೆಪ್ಟೆಂಬರ್", "ಅಕ್ಟೋಬರ್", "ನವೆಂಬರ್", "ಡಿಸೆಂಬರ್"},
			WeekdaysAbbreviatedValue: []string{"ಭಾನು", "ಸೋಮ", "ಮಂಗಳ", "ಬುಧ", "ಗುರು", "ಶುಕ್ರ", "ಶನಿ"},
			WeekdaysNarrowValue:      []string{"ಭಾ", "ಸೋ", "ಮಂ", "ಬು", "ಗು", "ಶು", "ಶ"},
			WeekdaysShortValue:       []string{"ಭಾನು", "ಸೋಮ", "ಮಂಗಳ", "ಬುಧ", "ಗುರು", "ಶುಕ್ರ", "ಶನಿ"},
			WeekdaysWideValue:        []string{"ಭಾನುವಾರ", "ಸೋಮವಾರ", "ಮಂಗಳವಾರ", "ಬುಧವಾರ", "ಗುರುವಾರ", "ಶುಕ್ರವಾರ", "ಶನಿವಾರ"},
			PeriodsAbbreviatedValue:  []string{"ಪೂರ್ವಾಹ್ನ", "ಅಪರಾಹ್ನ"},
			PeriodsNarrowValue:       []string{"ಪೂ", "ಅ"},
			PeriodsWideValue:         []string{"ಪೂರ್ವಾಹ್ನ", "ಅಪರಾಹ್ನ"},
			ErasAbbreviatedValue:     []string{"ಕ್ರಿ.ಪೂ", "ಕ್ರಿ.ಶ"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"ಕ್ರಿಸ್ತ ಪೂರ್ವ", "ಕ್ರಿಸ್ತ ಶಕ"},
			TimezonesValue:           map[string]string{"": "ಫಾಕ್\u200cಲ್ಯಾಂಡ್ ದ್ವೀಪಗಳ ಪ್ರಮಾಣಿತ ಸಮಯ", "ACDT": "ಆಸ್ಟ್ರೇಲಿಯಾದ ಕೇಂದ್ರ ಹಗಲು ಸಮಯ", "ACST": "ಆಸ್ಟ್ರೇಲಿಯಾದ ಕೇಂದ್ರ ಪ್ರಮಾಣಿತ ಸಮಯ", "ACT": "ಏಕರ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "ACWDT": "ಆಸ್ಟ್ರೇಲಿಯಾದ ಕೇಂದ್ರ ಪಶ್ಚಿಮ ಹಗಲು ಸಮಯ", "ACWST": "ಆಸ್ಟ್ರೇಲಿಯಾದ ಕೇಂದ್ರ ಪಶ್ಚಿಮ ಪ್ರಮಾಣಿತ ಸಮಯ", "ADT": "ಅಟ್ಲಾಂಟಿಕ್ ದಿನದ ಸಮಯ", "AEDT": "ಪೂರ್ವ ಆಸ್ಟ್ರೇಲಿಯಾದ ಹಗಲು ಸಮಯ", "AEST": "ಆಸ್ಟ್ರೇಲಿಯಾದ ಪೂರ್ವ ಪ್ರಮಾಣಿತ ಸಮಯ", "AFT": "ಅಫಘಾನಿಸ್ತಾನ ಸಮಯ", "AKDT": "\u200cಅಲಾಸ್ಕಾ ಹಗಲು ಸಮಯ", "AKST": "ಅಲಾಸ್ಕಾ ಪ್ರಮಾಣಿತ ಸಮಯ", "AMST": "ಅಮೆಜಾನ್ ಬೇಸಿಗೆ ಸಮಯ", "AMT": "ಅಮೆಜಾನ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "ARST": "ಅರ್ಜೆಂಟಿನಾ ಬೇಸಿಗೆ ಸಮಯ", "ART": "ಅರ್ಜೆಂಟೀನಾ ಪ್ರಮಾಣಿತ ಸಮಯ", "AST": "ಅಟ್ಲಾಂಟಿಕ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "AWDT": "ಆಸ್ಟ್ರೇಲಿಯಾದ ಪಶ್ಚಿಮ ಹಗಲು ಸಮಯ", "AWST": "ಆಸ್ಟ್ರೇಲಿಯಾದ ಪಶ್ಚಿಮ ಪ್ರಮಾಣಿತ ಸಮಯ", "BNT": "ಬ್ರೂನಿ ದಾರುಸಲೆಮ್ ಸಮಯ", "BOT": "ಬೊಲಿವಿಯಾ ಸಮಯ", "BRST": "ಬ್ರೆಸಿಲಿಯಾ ಬೇಸಿಗೆ ಸಮಯ", "BRT": "ಬ್ರೆಸಿಲಿಯಾ ಪ್ರಮಾಣಿತ ಸಮಯ", "BST": "ಬಾಂಗ್ಲಾದೇಶ ಬೇಸಿಗೆ ಸಮಯ", "BTT": "ಭೂತಾನ್ ಸಮಯ", "CAT": "ಮಧ್ಯ ಆಫ್ರಿಕಾ ಸಮಯ", "CCT": "ಕೋಕೋಸ್ ದ್ವೀಪಗಳ ಸಮಯ", "CDT": "ಉತ್ತರ ಅಮೆರಿಕದ ಕೇಂದ್ರೀಯ ದಿನದ ಸಮಯ", "CDT (Kuba)": "ಕ್ಯೂಬಾ ದಿನದ ಸಮಯ", "CHADT": "ಚಥಾಮ್ ಹಗಲು ಸಮಯ", "CHAST": "ಚಥಾಮ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "CLST": "ಚಿಲಿ ಬೇಸಿಗೆ ಸಮಯ", "CLT": "ಚಿಲಿ ಪ್ರಮಾಣಿತ ಸಮಯ", "COST": "ಕೊಲಂಬಿಯಾ ಬೇಸಿಗೆ ಸಮಯ", "COT": "ಕೊಲಂಬಿಯಾ ಪ್ರಮಾಣಿತ ಸಮಯ", "CST": "ಉತ್ತರ ಅಮೆರಿಕದ ಕೇಂದ್ರ ಪ್ರಮಾಣಿತ ಸಮಯ", "CST (Kuba)": "ಕ್ಯೂಬಾ ಪ್ರಮಾಣಿತ ಸಮಯ", "CXT": "ಕ್ರಿಸ್ಮಸ್ ದ್ವೀಪ ಸಮಯ", "ChST": "ಚಮೋರೋ ಪ್ರಮಾಣಿತ ಸಮಯ", "EASST": "ಈಸ್ಟರ್ ದ್ವೀಪ ಬೇಸಿಗೆ ಸಮಯ", "EAST": "ಈಸ್ಟರ್ ದ್ವೀಪ ಪ್ರಮಾಣಿತ ಸಮಯ", "EAT": "ಪೂರ್ವ ಆಫ್ರಿಕಾ ಸಮಯ", "ECT": "ಈಕ್ವೆಡಾರ್ ಸಮಯ", "EDT": "ಉತ್ತರ ಅಮೆರಿಕದ ಪೂರ್ವದ ದಿನದ ಸಮಯ", "EGDT": "ಪೂರ್ವ ಗ್ರೀನ್\u200cಲ್ಯಾಂಡ್ ಬೇಸಿಗೆ ಸಮಯ", "EGST": "ಪೂರ್ವ ಗ್ರೀನ್\u200cಲ್ಯಾಂಡ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "EST": "ಉತ್ತರ ಅಮೆರಿಕದ ಪೂರ್ವದ ಪ್ರಮಾಣಿತ ಸಮಯ", "FKST": "ಫಾಕ್\u200cಲ್ಯಾಂಡ್ ದ್ವೀಪಗಳ ಬೇಸಿಗೆ ಸಮಯ", "GALT": "ಗಾಲಾಪಾಗೋಸ್ ಸಮಯ", "GFT": "ಫ್ರೆಂಚ್ ಗಯಾನಾ ಸಮಯ", "GMT": "ಗ್ರೀನ್\u200cವಿಚ್ ಸರಾಸರಿ ಕಾಲಮಾನ", "GST": "ಗಲ್ಫ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "GYT": "ಗಯಾನಾ ಸಮಯ", "HADT": "ಹವಾಯಿ-ಅಲ್ಯುಟಿಯನ್ ಹಗಲು ಸಮಯ", "HAST": "ಹವಾಯಿ-ಅಲ್ಯುಟಿಯನ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "HENOMX": "ವಾಯವ್ಯ ಮೆಕ್ಸಿಕೊ ಹಗಲು ಸಮಯ", "HEOG": "ಪಶ್ಚಿಮ ಗ್ರೀನ್\u200cಲ್ಯಾಂಡ್ ಬೇಸಿಗೆ ಸಮಯ", "HEPMX": "ಮೆಕ್ಸಿಕನ್ ಪೆಸಿಫಿಕ್ ಹಗಲು ಸಮಯ", "HKST": "ಹಾಂಗ್ ಕಾಂಗ್ ಬೇಸಿಗೆ ಸಮಯ", "HKT": "ಹಾಂಗ್ ಕಾಂಗ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "HNNOMX": "ವಾಯವ್ಯ ಮೆಕ್ಸಿಕೊ ಪ್ರಮಾಣಿತ ಸಮಯ", "HNOG": "ಪಶ್ಚಿಮ ಗ್ರೀನ್\u200cಲ್ಯಾಂಡ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "HNPMX": "ಮೆಕ್ಸಿಕನ್ ಪೆಸಿಫಿಕ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "ICT": "ಇಂಡೊಚೈನಾ ಸಮಯ", "IRDT": "ಇರಾನ್ ಹಗಲು ಸಮಯ", "IRST": "ಇರಾನ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "IST": "ಭಾರತೀಯ ಪ್ರಮಾಣಿತ ಸಮಯ", "JDT": "ಜಪಾನ್ ಹಗಲು ಸಮಯ", "JST": "ಜಪಾನ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "LHDT": "ಲಾರ್ಡ್ ಹೋವ್ ಬೆಳಗಿನ ಸಮಯ", "LHST": "ಲಾರ್ಡ್ ಹೋವ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "MDT": "ಮಕಾವ್ ಬೇಸಿಗೆ ಸಮಯ", "MESZ": "ಮಧ್ಯ ಯುರೋಪಿಯನ್ ಬೇಸಿಗೆ ಸಮಯ", "MEZ": "ಮಧ್ಯ ಯುರೋಪಿಯನ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "MST": "ಮಕಾವ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "MVT": "ಮಾಲ್ಡೀವ್ಸ್ ಸಮಯ", "MYT": "ಮಲೇಷಿಯಾ ಸಮಯ", "NDT": "ನ್ಯೂಫೌಂಡ್\u200cಲ್ಯಾಂಡ್ ದಿನದ ಸಮಯ", "NPT": "ನೇಪಾಳ ಸಮಯ", "NST": "ನ್ಯೂಫೌಂಡ್\u200cಲ್ಯಾಂಡ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "NZDT": "ನ್ಯೂಜಿಲ್ಯಾಂಡ್ ಹಗಲು ಸಮಯ", "NZST": "ನ್ಯೂಜಿಲ್ಯಾಂಡ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "OESZ": "ಪೂರ್ವ ಯುರೋಪಿಯನ್ ಬೇಸಿಗೆ ಸಮಯ", "OEZ": "ಪೂರ್ವ ಯುರೋಪಿಯನ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "PDT": "ಉತ್ತರ ಅಮೆರಿಕದ ಪೆಸಿಫಿಕ್ ದಿನದ ಸಮಯ", "PKT": "ಪಾಕಿಸ್ತಾನ ಬೇಸಿಗೆ ಸಮಯ", "PMDT": "ಸೇಂಟ್ ಪಿಯರ್ ಮತ್ತು ಮಿಕ್ವೆಲನ್ ಹಗಲು ಸಮಯ", "PMST": "ಸೇಂಟ್ ಪಿಯರ್ ಮತ್ತು ಮಿಕ್ವೆಲನ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "PST": "ಉತ್ತರ ಅಮೆರಿಕದ ಪೆಸಿಫಿಕ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "PYST": "ಪರಾಗ್ವೇ ಬೇಸಿಗೆ ಸಮಯ", "SAST": "ದಕ್ಷಿಣ ಆಫ್ರಿಕಾ ಪ್ರಮಾಣಿತ ಸಮಯ", "SGT": "ಸಿಂಗಪುರ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "SRT": "ಸುರಿನೇಮ್ ಸಮಯ", "TLT": "ಪೂರ್ವ ಟಿಮೋರ್ ಸಮಯ", "TMST": "ತುರ್ಕ್\u200cಮೇನಿಸ್ತಾನ್ ಬೇಸಿಗೆ ಸಮಯ", "TMT": "ತುರ್ಕ್\u200cಮೇನಿಸ್ತಾನ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "UYST": "ಉರುಗ್ವೇ ಬೇಸಿಗೆ ಸಮಯ", "UYT": "ಉರುಗ್ವೇ ಪ್ರಮಾಣಿತ ಸಮಯ", "VET": "ವೆನಿಜುವೆಲಾ ಸಮಯ", "WARST": "ಪಶ್ಚಿಮ ಅರ್ಜೆಂಟೀನಾ ಬೇಸಿಗೆ ಸಮಯ", "WART": "ಪಶ್ಚಿಮ ಅರ್ಜೆಂಟೀನಾ ಪ್ರಮಾಣಿತ ಸಮಯ", "WAST": "ಪಶ್ಚಿಮ ಆಫ್ರಿಕಾ ಬೇಸಿಗೆ ಸಮಯ", "WAT": "ಪಶ್ಚಿಮ ಆಫ್ರಿಕಾ ಪ್ರಮಾಣಿತ ಸಮಯ", "WESZ": "ಪಶ್ಚಿಮ ಯುರೋಪಿಯನ್ ಬೇಸಿಗೆ ಸಮಯ", "WEZ": "ಪಶ್ಚಿಮ ಯುರೋಪಿಯನ್ ಪ್ರಮಾಣಿತ ಸಮಯ", "WIB": "ಪಶ್ಚಿಮ ಇಂಡೋನೇಷಿಯ ಸಮಯ", "WIT": "ಪೂರ್ವ ಇಂಡೋನೇಷಿಯಾ ಸಮಯ", "WITA": "ಮಧ್ಯ ಇಂಡೋನೇಷಿಯಾ ಸಮಯ", "∅∅∅": "ಪೆರು ಬೇಸಿಗೆ ಸಮಯ"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} ಮತ್ತು {1}", "{0}, {1}", "{0}, {1}", "{0}, ಮತ್ತು {1}"}, {"{0} ಅಥವಾ {1}", "{0}, {1}", "{0}, {1}", "{0}, ಅಥವಾ {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ಶ", "%v ಶ", "%v ಶ", ""},
				Long:   &locales.CounterFormat{"ಶತಮಾನಗಳು", "%v ಶತಮಾನದಲ್ಲಿ", "%v ಶತಮಾನಗಳಲ್ಲಿ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ದಶಕ", "%v ದಶಕ", "%v ದಶಕ", ""},
				Long:   &locales.CounterFormat{"ದಶಕಗಳು", "%v ದಶಕದಲ್ಲಿ", "%v ದಶಕಗಳಲ್ಲಿ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ವ", "%vವ", "%vವ", ""},
				Long:   &locales.CounterFormat{"ವರ್ಷಗಳು", "%v ವರ್ಷದಲ್ಲಿ", "%v ವರ್ಷಗಳಲ್ಲಿ", "ಪ್ರತಿ ವರ್ಷಕ್ಕೆ %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ತಿಂಗಳು", "%vತಿಂ.", "%vತಿಂ.", "%v/ತಿ"},
				Long:   &locales.CounterFormat{"ತಿಂಗಳು", "%v ತಿಂಗಳಲ್ಲಿ", "%v ತಿಂಗಳುಗಳು", "ಪ್ರತಿ ತಿಂಗಳಿಗೆ %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ವಾರ", "%vವಾ", "%vವಾ", ""},
				Long:   &locales.CounterFormat{"ವಾರಗಳು", "%v ವಾರದಲ್ಲಿ", "%v ವಾರಗಳಲ್ಲಿ", "%v ಪ್ರತಿ ವಾರಕ್ಕೆ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ದಿನ", "%vದಿ", "%vದಿ", "%v/ದಿ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ಗಂಟೆ", "%vಗಂ.", "%vಗಂ.", "%v/ಗಂ"},
				Long:   &locales.CounterFormat{"ಗಂಟೆಗಳು", "%v ಗಂಟೆಯಲ್ಲಿ", "%v ಗಂಟೆಗಳಲ್ಲಿ", "ಪ್ರತಿ ಗಂಟೆಗೆ %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ನಿಮಿಷ", "%vನಿಮಿ", "%vನಿಮಿ", "%v/ನಿಮಿ"},
				Long:   &locales.CounterFormat{"ನಿಮಿಷಗಳು", "%v ನಿಮಿಷದಲ್ಲಿ", "%v ನಿಮಿಷಗಳಲ್ಲಿ", "ಪ್ರತಿ ನಿಮಿಷಕ್ಕೆ %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ಸೆಕೆಂ", "%vಸೆಕೆಂ", "%v ಸೆಕೆಂ", "%v/ಸೆ"},
				Long:   &locales.CounterFormat{"ಸೆಕೆಂಡುಗಳು", "%v ಸೆಕೆಂಡಿನಲ್ಲಿ", "%v ಸೆಕೆಂಡುಗಳಲ್ಲಿ", "ಪ್ರತಿ ಸೆಕೆಂಡ್\u200cಗೆ %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ಮಿ.ಸೆ.", "%vಮಿ.ಸೆ.", "%vಮಿ.ಸೆ.", ""},
				Long:   &locales.CounterFormat{"ಮಿಲಿಸೆಕೆಂಡುಗಳು", "%v ಮಿಲಿಸೆಕೆಂಡಿನಲ್ಲಿ", "%v ಮಿಲಿಸೆಕೆಂಡುಗಳಲ್ಲಿ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μsecs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"ಮೈಕ್ರೊಸೆಕೆಂಡುಗಳು", "%v ಮೈಕ್ರೊಸೆಕೆಂಡ್\u200cನಲ್ಲಿ", "%v ಮೈಕ್ರೊಸೆಕೆಂಡುಗಳಲ್ಲಿ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vನ್ಯಾಸೆ", "%vನ್ಯಾಸೆ", ""},
				Long:   &locales.CounterFormat{"ನ್ಯಾನೊಸೆಕೆಂಡುಗಳು", "%v ನ್ಯಾನೊಸೆಕೆಂಡ್\u200cನಲ್ಲಿ", "%v ನ್ಯಾನೊಸೆಕೆಂಡುಗಳಲ್ಲಿ", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (kn *kn) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(kn, kn.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'kn'
func (kn *kn) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(kn, kn.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'kn'
func (kn *kn) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(kn, kn.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'kn'
func (kn *kn) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(kn, kn.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'kn'
func (kn *kn) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(kn, kn.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'kn'
func (kn *kn) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(kn, kn.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'kn'
func (kn *kn) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(kn, kn.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'kn'
func (kn *kn) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(kn, kn.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'kn'
func (kn *kn) DateFullLayout() string {
	return kn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kn'
func (kn *kn) DateLongLayout() string {
	return kn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kn'
func (kn *kn) DateMediumLayout() string {
	return kn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kn'
func (kn *kn) DateShortLayout() string {
	return kn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kn'
func (kn *kn) TimeFullLayout() string {
	return kn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kn'
func (kn *kn) TimeLongLayout() string {
	return kn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kn'
func (kn *kn) TimeMediumLayout() string {
	return kn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kn'
func (kn *kn) TimeShortLayout() string {
	return kn.timeShortLayout
}

func (kn *kn) ListPatterns() *locales.ListPatterns {
	return kn.listPatterns
}

func (kn *kn) GetDurationSpec() *locales.DurationSpec {
	return kn.DurationSpec
}

func (kn *kn) GetMiscPatterns() *locales.MiscPatterns {
	return &kn.miscPatterns
}
