...
// DateFullLayout returns the full date layout for 'en_PH'
func (en *en_PH) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_PH'
func (en *en_PH) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_PH'
func (en *en_PH) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_PH'
func (en *en_PH) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_PH'
func (en *en_PH) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_PH'
func (en *en_PH) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_PH'
func (en *en_PH) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_PH'
func (en *en_PH) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_PH) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_PH) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_PH) GetMiscPatterns() *locales.MiscPatterns {
