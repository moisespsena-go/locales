...
func New() locales.Translator {
	return &uk{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 тис'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 тис'.' ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 тис'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 тис'.' ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 тис'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 тис'.' ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "січ.", "лют.", "бер.", "квіт.", "трав.", "черв.", "лип.", "серп.", "вер.", "жовт.", "лист.", "груд."},
			MonthsNarrowValue:        []string{"", "с", "л", "б", "к", "т", "ч", "л", "с", "в", "ж", "л", "г"},
			MonthsWideValue:          []string{"", "січня", "лютого", "березня", "квітня", "травня", "червня", "липня", "серпня", "вересня", "жовтня", "листопада", "грудня"},
			...
			WeekdaysWideValue:        []string{"неділя", "понеділок", "вівторок", "середа", "четвер", "пʼятниця", "субота"},
			PeriodsAbbreviatedValue:  []string{"дп", "пп"},
			PeriodsNarrowValue:       []string{"дп", "пп"},
			PeriodsWideValue:         []string{"дп", "пп"},
			ErasAbbreviatedValue:     []string{"до н. е.", "н. е."},
			ErasNarrowValue:          []string{"до н.е.", "н.е."},
			ErasWideValue:            []string{"до нашої ери", "нашої ери"},
			TimezonesValue:           map[string]string{"": "за стандартним часом на Фолклендських Островах", "ACDT": "за літнім центральноавстралійським часом", "ACST": "час: Акрі, літній", "ACT": "час: Акрі, стандартний", "ACWDT": "за літнім центральнозахідним австралійським часом", "ACWST": "за стандартним центральнозахідним австралійським часом", "ADT": "за атлантичним літнім часом", "AEDT": "за літнім східноавстралійським часом", "AEST": "за стандартним східноавстралійським часом", "AFT": "за часом в Афганістані", "AKDT": "за літнім часом на Алясці", "AKST": "за стандартним часом на Алясці", "AMST": "за літнім часом на Амазонці", "AMT": "за стандартним часом на Амазонці", "ARST": "за літнім аргентинським часом", "ART": "за стандартним аргентинським часом", "AST": "за атлантичним стандартним часом", "AWDT": "за літнім західноавстралійським часом", "AWST": "за стандартним західноавстралійським часом", "BNT": "за часом у Брунеї", "BOT": "за болівійським часом", "BRST": "за літнім бразильським часом", "BRT": "за стандартним бразильським часом", "BST": "за літнім часом у Бангладеш", "BTT": "за часом у Бутані", "CAT": "за центральноафриканським часом", "CCT": "за часом на Кокосових Островах", "CDT": "за північноамериканським центральним літнім часом", "CDT (Kuba)": "за літнім часом на Кубі", "CHADT": "за літнім часом на архіпелазі Чатем", "CHAST": "за стандартним часом на архіпелазі Чатем", "CLST": "за літнім чилійським часом", "CLT": "за стандартним чилійським часом", "COST": "за літнім колумбійським часом", "COT": "за стандартним колумбійським часом", "CST": "за північноамериканським центральним стандартним часом", "CST (Kuba)": "за стандартним часом на Кубі", "CXT": "за часом на острові Різдва", "ChST": "за часом на Північних Маріанських островах", "EASST": "за літнім часом на острові Пасхи", "EAST": "за стандартним часом на острові Пасхи", "EAT": "за східноафриканським часом", "ECT": "за часом в Еквадорі", "EDT": "за північноамериканським східним літнім часом", "EGDT": "за літнім східним часом у Ґренландії", "EGST": "за стандартним східним часом у Ґренландії", "EST": "за північноамериканським східним стандартним часом", "FKST": "за літнім часом на Фолклендських Островах", "GALT": "за часом Ґалапаґосу", "GFT": "за часом Французької Ґвіани", "GMT": "за Гринвічем", "GST": "за часом Перської затоки", "GYT": "за часом у Ґаяні", "HADT": "за літнім гавайсько-алеутським часом", "HAST": "за стандартним гавайсько-алеутським часом", "HENOMX": "за літнім північнозахідним часом у Мексиці", "HEOG": "за літнім західним часом у Ґренландії", "HEPMX": "за літнім тихоокеанським часом у Мексиці", "HKST": "за літнім часом у Гонконзі", "HKT": "за стандартним часом у Гонконзі", "HNNOMX": "за стандартним північнозахідним часом у Мексиці", "HNOG": "за стандартним західним часом у Ґренландії", "HNPMX": "за стандартним тихоокеанським часом у Мексиці", "ICT": "за часом в Індокитаї", "IRDT": "за іранським літнім часом", "IRST": "за іранським стандартним часом", "IST": "за індійським стандартним часом", "JDT": "за японським літнім часом", "JST": "за японським стандартним часом", "LHDT": "за літнім часом на острові Лорд-Хау", "LHST": "за стандартним часом на острові Лорд-Хау", "MDT": "MDT", "MESZ": "за центральноєвропейським літнім часом", "MEZ": "за центральноєвропейським стандартним часом", "MST": "MST", "MVT": "за часом на Мальдівах", "MYT": "за часом у Малайзії", "NDT": "за літнім часом у Ньюфаундленд", "NPT": "за часом у Непалі", "NST": "за стандартним часом на острові Ньюфаундленд", "NZDT": "за літнім часом у Новій Зеландії", "NZST": "за стандартним часом у Новій Зеландії", "OESZ": "за східноєвропейським літнім часом", "OEZ": "за східноєвропейським стандартним часом", "PDT": "за північноамериканським тихоокеанським літнім часом", "PKT": "за літнім часом у Пакистані", "PMDT": "за літнім часом на островах Сен-П’єр і Мікелон", "PMST": "за стандартним часом на островах Сен-П’єр і Мікелон", "PST": "за північноамериканським тихоокеанським стандартним часом", "PYST": "за літнім параґвайським часом", "SAST": "за південноафриканським часом", "SGT": "за часом у Сінгапурі", "SRT": "за часом у Суринамі", "TLT": "за часом у Східному Тиморі", "TMST": "за літнім часом у Туркменістані", "TMT": "за стандартним часом у Туркменістані", "UYST": "за літнім часом в Уруґваї", "UYT": "за стандартним часом в Уруґваї", "VET": "за часом у Венесуелі", "WARST": "за літнім за західноаргентинським часом", "WART": "за стандартним західноаргентинським часом", "WAST": "за західноафриканським літнім часом", "WAT": "за західноафриканським стандартним часом", "WESZ": "за західноєвропейським літнім часом", "WEZ": "за західноєвропейським стандартним часом", "WIB": "за західноіндонезійським часом", "WIT": "за східноіндонезійським часом", "WITA": "за центральноіндонезійським часом", "∅∅∅": "за літнім часом у Перу"},
		},
		...
		dateFullLayout:   "EEEE, d MMMM y 'р'.",
		dateLongLayout:   "d MMMM y 'р'.",
		dateMediumLayout: "d MMM y 'р'.",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} і {1}", "{0}, {1}", "{0}, {1}", "{0} і {1}"}, {"{0} або {1}", "{0}, {1}", "{0}, {1}", "{0} або {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ст", "%vст", "%vст", ""},
				Long:   &locales.CounterFormat{"століття", "%v столітті", "%v століття", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"10-річчя", "%v 10-річчя", "%v 10-річчя", ""},
				Long:   &locales.CounterFormat{"десятиріччя", "%v десятиріччі", "%v десятиріччя", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"р", "%vр", "%vр", "%v/р"},
				Long:   &locales.CounterFormat{"роки", "%v році", "%v року", "%v на рік"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"м", "%vм", "%vм", "%v/м"},
				Long:   &locales.CounterFormat{"місяці", "%v місяці", "%v місяця", "%v на місяць"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"т", "%vт", "%vт", "%v/т"},
				Long:   &locales.CounterFormat{"тижні", "%v тижні", "%v тижня", "%v на тиждень"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"д", "%vд", "%vд", "%v/д"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"г", "%v год.", "%v год.", "%v/г"},
				Long:   &locales.CounterFormat{"години", "%v годині", "%v години", "%v на годину"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"х", "%vх", "%vх", "%v/х"},
				Long:   &locales.CounterFormat{"хвилини", "%v хвилині", "%v хвилини", "%v на хвилину"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"с", "%vс", "%vс", "%v/с"},
				Long:   &locales.CounterFormat{"секунди", "%v секунді", "%v секунди", "%v на секунду"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мс", "%vмс", "%vмс", ""},
				Long:   &locales.CounterFormat{"мілісекунди", "%v мілісекунді", "%v мілісекунди", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мкс", "%vмкс", "%vмкс", ""},
				Long:   &locales.CounterFormat{"мікросекунди", "%v мікросекунді", "%v мікросекунди", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"нс", "%vнс", "%vнс", ""},
				Long:   &locales.CounterFormat{"наносекунди", "%v наносекунді", "%v наносекунди", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (uk *uk) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(uk, uk.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'uk'
func (uk *uk) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(uk, uk.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'uk'
func (uk *uk) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(uk, uk.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'uk'
func (uk *uk) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(uk, uk.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'uk'
func (uk *uk) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(uk, uk.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'uk'
func (uk *uk) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(uk, uk.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'uk'
func (uk *uk) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(uk, uk.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'uk'
func (uk *uk) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(uk, uk.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'uk'
func (uk *uk) DateFullLayout() string {
	return uk.dateFullLayout
}

// DateLongLayout returns the long date layout for 'uk'
func (uk *uk) DateLongLayout() string {
	return uk.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'uk'
func (uk *uk) DateMediumLayout() string {
	return uk.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'uk'
func (uk *uk) DateShortLayout() string {
	return uk.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'uk'
func (uk *uk) TimeFullLayout() string {
	return uk.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'uk'
func (uk *uk) TimeLongLayout() string {
	return uk.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'uk'
func (uk *uk) TimeMediumLayout() string {
	return uk.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'uk'
func (uk *uk) TimeShortLayout() string {
	return uk.timeShortLayout
}

func (uk *uk) ListPatterns() *locales.ListPatterns {
	return uk.listPatterns
}

func (uk *uk) GetDurationSpec() *locales.DurationSpec {
	return uk.DurationSpec
}

func (uk *uk) GetMiscPatterns() *locales.MiscPatterns {
	return &uk.miscPatterns
}
