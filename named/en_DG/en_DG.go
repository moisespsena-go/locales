...
// DateFullLayout returns the full date layout for 'en_DG'
func (en *en_DG) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_DG'
func (en *en_DG) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_DG'
func (en *en_DG) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_DG'
func (en *en_DG) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_DG'
func (en *en_DG) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_DG'
func (en *en_DG) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_DG'
func (en *en_DG) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_DG'
func (en *en_DG) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_DG) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_DG) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_DG) GetMiscPatterns() *locales.MiscPatterns {
