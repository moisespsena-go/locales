...
func New() locales.Translator {
	return &tg_TJ{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 ҳзр'.' ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 ҳзр'.' ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 ҳзр'.' ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			...
			MonthsWideValue:          []string{"", "Январ", "Феврал", "Март", "Апрел", "Май", "Июн", "Июл", "Август", "Сентябр", "Октябр", "Ноябр", "Декабр"},
			WeekdaysAbbreviatedValue: []string{"Яшб", "Дшб", "Сшб", "Чшб", "Пшб", "Ҷмъ", "Шнб"},
			WeekdaysNarrowValue:      []string{"Я", "Д", "С", "Ч", "П", "Ҷ", "Ш"},
			WeekdaysShortValue:       []string{"Яшб", "Дшб", "Сшб", "Чшб", "Пшб", "Ҷмъ", "Шнб"},
			WeekdaysWideValue:        []string{"Якшанбе", "Душанбе", "Сешанбе", "Чоршанбе", "Панҷшанбе", "Ҷумъа", "Шанбе"},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"ПеМ", "ПаМ"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Пеш аз милод", "Пас аз милод"},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "Вақти рӯзонаи атлантикӣ", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "Вақти стандартии атлантикӣ", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "CAT", "CCT": "CCT", "CDT": "Вақти рӯзонаи марказӣ", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "Вақти стандартии марказӣ", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "EAT", "ECT": "ECT", "EDT": "Вақти рӯзонаи шарқӣ", "EGDT": "EGDT", "EGST": "EGST", "EST": "Вақти стандартии шарқӣ", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "Ба вақти Гринвич", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "Вақти тобистонаи аврупоии марказӣ", "MEZ": "Вақти стандартии аврупоии марказӣ", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "Вақти тобистонаи аврупоии шарқӣ", "OEZ": "Вақти стандартии аврупоии шарқӣ", "PDT": "Вақти рӯзонаи Уқёнуси Ором", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "Вақти стандартии Уқёнуси Ором", "PYST": "PYST", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "Вақти тобистонаи аврупоии ғарбӣ", "WEZ": "Вақти стандартии аврупоии ғарбӣ", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0}, {1}", "{0}, {1}", "{0}, {1}", "{0}, {1}"}, []string(nil)}),
		miscPatterns: locales.MiscPatterns{
			"",
			"⩾%[1]v",
			"",
...
func (tg *tg_TJ) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(tg, tg.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'tg_TJ'
func (tg *tg_TJ) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(tg, tg.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'tg_TJ'
func (tg *tg_TJ) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(tg, tg.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'tg_TJ'
func (tg *tg_TJ) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(tg, tg.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'tg_TJ'
func (tg *tg_TJ) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(tg, tg.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'tg_TJ'
func (tg *tg_TJ) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(tg, tg.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'tg_TJ'
func (tg *tg_TJ) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(tg, tg.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'tg_TJ'
func (tg *tg_TJ) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(tg, tg.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'tg_TJ'
func (tg *tg_TJ) DateFullLayout() string {
	return tg.dateFullLayout
}

// DateLongLayout returns the long date layout for 'tg_TJ'
func (tg *tg_TJ) DateLongLayout() string {
	return tg.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'tg_TJ'
func (tg *tg_TJ) DateMediumLayout() string {
	return tg.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'tg_TJ'
func (tg *tg_TJ) DateShortLayout() string {
	return tg.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'tg_TJ'
func (tg *tg_TJ) TimeFullLayout() string {
	return tg.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'tg_TJ'
func (tg *tg_TJ) TimeLongLayout() string {
	return tg.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'tg_TJ'
func (tg *tg_TJ) TimeMediumLayout() string {
	return tg.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'tg_TJ'
func (tg *tg_TJ) TimeShortLayout() string {
	return tg.timeShortLayout
}

func (tg *tg_TJ) ListPatterns() *locales.ListPatterns {
	return tg.listPatterns
}

func (tg *tg_TJ) GetDurationSpec() *locales.DurationSpec {
	return tg.DurationSpec
}

func (tg *tg_TJ) GetMiscPatterns() *locales.MiscPatterns {
	return &tg.miscPatterns
}
