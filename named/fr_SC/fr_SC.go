...
// DateFullLayout returns the full date layout for 'fr_SC'
func (fr *fr_SC) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_SC'
func (fr *fr_SC) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_SC'
func (fr *fr_SC) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_SC'
func (fr *fr_SC) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_SC'
func (fr *fr_SC) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_SC'
func (fr *fr_SC) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_SC'
func (fr *fr_SC) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_SC'
func (fr *fr_SC) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_SC) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_SC) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_SC) GetMiscPatterns() *locales.MiscPatterns {
