...
// DateFullLayout returns the full date layout for 'en_BM'
func (en *en_BM) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_BM'
func (en *en_BM) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_BM'
func (en *en_BM) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_BM'
func (en *en_BM) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_BM'
func (en *en_BM) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_BM'
func (en *en_BM) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_BM'
func (en *en_BM) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_BM'
func (en *en_BM) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_BM) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_BM) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_BM) GetMiscPatterns() *locales.MiscPatterns {
