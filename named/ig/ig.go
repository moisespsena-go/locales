...
func New() locales.Translator {
	return &ig{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jen", "Feb", "Maa", "Epr", "Mee", "Juu", "Jul", "Ọgọ", "Sep", "Ọkt", "Nov", "Dis"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "E", "M", "J", "J", "Ọ", "S", "Ọ", "N", "D"},
			MonthsWideValue:          []string{"", "Jenụwarị", "Febrụwarị", "Maachị", "Epreel", "Mee", "Juun", "Julaị", "Ọgọọst", "Septemba", "Ọktoba", "Novemba", "Disemba"},
			WeekdaysAbbreviatedValue: []string{"Sọn", "Mọn", "Tiu", "Wen", "Tọọ", "Fraị", "Sat"},
			WeekdaysShortValue:       []string{"Sọn", "Mọn", "Tiu", "Wen", "Tọọ", "Fraị", "Sat"},
			WeekdaysWideValue:        []string{"Sọndee", "Mọnde", "Tiuzdee", "Wenezdee", "Tọọzdee", "Fraịdee", "Satọdee"},
			PeriodsAbbreviatedValue:  []string{"A.M.", "P.M."},
			PeriodsNarrowValue:       []string{"A.M.", "P.M."},
			PeriodsWideValue:         []string{"N’ụtụtụ", "N’abali"},
			ErasAbbreviatedValue:     []string{"T.K.", "A.K."},
			ErasNarrowValue:          []string{"T.K.", "A.K."},
			ErasWideValue:            []string{"Tupu Kraist", "Afọ Kraịst"},
			TimezonesValue:           map[string]string{"": "Oge Izugbe Falkland Islands", "ACDT": "Oge Ihe Etiti Australia", "ACST": "Oge Izugbe Etiti Australia", "ACT": "ACT", "ACWDT": "Oge Ihe Mpaghara Ọdịda Anyanwụ Etiti Australia", "ACWST": "Oge Izugbe Mpaghara Ọdịda Anyanwụ Etiti Australia", "ADT": "Oge Ihe Mpaghara Atlantic", "AEDT": "Oge Ihe Mpaghara Ọwụwa Anyanwụ Australia", "AEST": "Oge Izugbe Mpaghara Ọwụwa Anyanwụ Australia", "AFT": "Oge Afghanistan", "AKDT": "Oge Ihe Alaska", "AKST": "Oge Izugbe Alaska", "AMST": "Oge Okpomọkụ Amazon", "AMT": "Oge Izugbe Amazon", "ARST": "Oge Okpomọkụ Argentina", "ART": "Oge Izugbe Argentina", "AST": "Oge Izugbe Mpaghara Atlantic", "AWDT": "Oge Ihe Mpaghara Ọdịda Anyanwụ Australia", "AWST": "Oge Izugbe Mpaghara Ọdịda Anyanwụ Australia", "BNT": "Oge Brunei Darussalam", "BOT": "Oge Bolivia", "BRST": "Oge Okpomọkụ Brasilia", "BRT": "Oge Izugbe Brasilia", "BST": "Oge Okpomọkụ Bangladesh", "BTT": "Oge Bhutan", "CAT": "Oge Etiti Afrịka", "CCT": "Oge Cocos Islands", "CDT": "Oge Ihe Mpaghara Etiti", "CDT (Kuba)": "Oge Ihe Mpaghara Cuba", "CHADT": "Oge Ihe Chatham", "CHAST": "Oge Izugbe Chatham", "CLST": "Oge Okpomọkụ Chile", "CLT": "Oge Izugbe Chile", "COST": "Oge Okpomọkụ Columbia", "COT": "Oge Izugbe Columbia", "CST": "Oge Izugbe Mpaghara Etiti", "CST (Kuba)": "Oge Izugbe Cuba", "CXT": "Oge Ekeresimesi Island", "ChST": "Oge Izugbe Chamorro", "EASST": "Oge Okpomọkụ Mpaghara Ọwụwa Anyanwụ Island", "EAST": "Oge Izugbe Mpaghara Ọwụwa Anyanwụ Island", "EAT": "Oge Mpaghara Ọwụwa Anyanwụ Afrịka", "ECT": "Oge Ecuador", "EDT": "Oge Ihe Mpaghara Ọwụwa Anyanwụ", "EGDT": "Oge Okpomọkụ Mpaghara Ọwụwa Anyanwụ Greenland", "EGST": "Oge Izugbe Mpaghara Ọwụwa Anyanwụ Greenland", "EST": "Oge Izugbe Mpaghara Ọwụwa Anyanwụ", "FKST": "Oge Okpomọkụ Falkland Islands", "GALT": "Oge Galapagos", "GFT": "Oge French Guiana", "GMT": "Oge Mpaghara Greemwich Mean", "GST": "Oge Izugbe Gulf", "GYT": "Oge Guyana", "HADT": "Oge Ihe Hawaii-Aleutian", "HAST": "Oge Izugbe Hawaii-Aleutian", "HENOMX": "Oge Ihe Northwest Mexico", "HEOG": "Oge Okpomọkụ Mpaghara Ọdịda Anyanwụ Greenland", "HEPMX": "Oge Ihe Mexican Pacific", "HKST": "Oge Okpomọkụ Hong Kong", "HKT": "Oge Izugbe Hong Kong", "HNNOMX": "Oge Izugbe Northwest Mexico", "HNOG": "Oge Izugbe Mpaghara Ọdịda Anyanwụ Greenland", "HNPMX": "Oge Izugbe Mexican Pacific", "ICT": "Oge Indochina", "IRDT": "Oge Ihe Iran", "IRST": "Oge Izugbe Iran", "IST": "Oge Izugbe India", "JDT": "Oge Ihe Japan", "JST": "Oge Izugbe Japan", "LHDT": "Oge Ihe Lord Howe", "LHST": "Oge Izugbe Lord Howe", "MDT": "MDT", "MESZ": "Oge Okpomọkụ Mpaghara Etiti Europe", "MEZ": "Oge Izugbe Mpaghara Etiti Europe", "MST": "MST", "MVT": "Oge Maldives", "MYT": "Oge Malaysia", "NDT": "Oge Ihe Newfoundland", "NPT": "Oge Nepal", "NST": "Oge Izugbe Newfoundland", "NZDT": "Oge Ihe New Zealand", "NZST": "Oge Izugbe New Zealand", "OESZ": "Oge Okpomọkụ Mpaghara Ọwụwa Anyanwụ Europe", "OEZ": "Oge Izugbe Mpaghara Ọwụwa Anyanwụ Europe", "PDT": "Oge Ihe Mpaghara Pacific", "PKT": "Oge Okpomọkụ Pakistan", "PMDT": "Oge Ihe St. Pierre & Miquelon", "PMST": "Oge Izugbe St. Pierre & Miquelon", "PST": "Oge Izugbe Mpaghara Pacific", "PYST": "Oge Okpomọkụ Paraguay", "SAST": "Oge Izugbe Mpaghara Mgbada Ugwu Afrịka", "SGT": "Oge Izugbe Singapore", "SRT": "Oge Suriname", "TLT": "Oge Mpaghara Ọwụwa Anyanwụ Timor", "TMST": "Oge Okpomọkụ Turkmenist", "TMT": "Oge Izugbe Turkmenist", "UYST": "Oge Okpomọkụ Uruguay", "UYT": "Oge Izugbe Uruguay", "VET": "Oge Venezuela", "WARST": "Oge Okpomọkụ Mpaghara Ọdịda Anyanwụ Argentina", "WART": "Oge Izugbe Mpaghara Ọdịda Anyanwụ Argentina", "WAST": "Oge Okpomọkụ Mpaghara Ọdịda Anyanwụ Afrịka", "WAT": "Oge Izugbe Mpaghara Ọdịda Anyanwụ Afrịka", "WESZ": "Oge Okpomọkụ Mpaghara Ọdịda Anyanwụ Europe", "WEZ": "Oge Izugbe Mpaghara Ọdịda Anyanwụ Europe", "WIB": "Oge Mpaghara Ọdịda Anyanwụ Indonesia", "WIT": "Oge Mpaghara Ọwụwa Anyanwụ Indonesia", "WITA": "Oge Etiti Indonesia", "∅∅∅": "Oge Okpomọkụ Peru"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} na {1}", "", "{0}, {1}", "{0}, na {1}"}, []string(nil)}),
...
func (ig *ig) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ig, ig.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ig'
func (ig *ig) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ig, ig.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ig'
func (ig *ig) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ig, ig.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ig'
func (ig *ig) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ig, ig.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ig'
func (ig *ig) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ig, ig.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ig'
func (ig *ig) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ig, ig.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ig'
func (ig *ig) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ig, ig.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ig'
func (ig *ig) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ig, ig.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ig'
func (ig *ig) DateFullLayout() string {
	return ig.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ig'
func (ig *ig) DateLongLayout() string {
	return ig.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ig'
func (ig *ig) DateMediumLayout() string {
	return ig.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ig'
func (ig *ig) DateShortLayout() string {
	return ig.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ig'
func (ig *ig) TimeFullLayout() string {
	return ig.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ig'
func (ig *ig) TimeLongLayout() string {
	return ig.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ig'
func (ig *ig) TimeMediumLayout() string {
	return ig.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ig'
func (ig *ig) TimeShortLayout() string {
	return ig.timeShortLayout
}

func (ig *ig) ListPatterns() *locales.ListPatterns {
	return ig.listPatterns
}

func (ig *ig) GetDurationSpec() *locales.DurationSpec {
	return ig.DurationSpec
}

func (ig *ig) GetMiscPatterns() *locales.MiscPatterns {
	return &ig.miscPatterns
}
