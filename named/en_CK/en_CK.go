...
// DateFullLayout returns the full date layout for 'en_CK'
func (en *en_CK) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_CK'
func (en *en_CK) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_CK'
func (en *en_CK) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_CK'
func (en *en_CK) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_CK'
func (en *en_CK) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_CK'
func (en *en_CK) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_CK'
func (en *en_CK) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_CK'
func (en *en_CK) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_CK) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_CK) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_CK) GetMiscPatterns() *locales.MiscPatterns {
