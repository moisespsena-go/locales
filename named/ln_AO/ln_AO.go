...
// DateFullLayout returns the full date layout for 'ln_AO'
func (ln *ln_AO) DateFullLayout() string {
	return ln.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ln_AO'
func (ln *ln_AO) DateLongLayout() string {
	return ln.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ln_AO'
func (ln *ln_AO) DateMediumLayout() string {
	return ln.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ln_AO'
func (ln *ln_AO) DateShortLayout() string {
	return ln.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ln_AO'
func (ln *ln_AO) TimeFullLayout() string {
	return ln.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ln_AO'
func (ln *ln_AO) TimeLongLayout() string {
	return ln.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ln_AO'
func (ln *ln_AO) TimeMediumLayout() string {
	return ln.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ln_AO'
func (ln *ln_AO) TimeShortLayout() string {
	return ln.timeShortLayout
}

func (ln *ln_AO) ListPatterns() *locales.ListPatterns {
	return ln.listPatterns
}

func (ln *ln_AO) GetDurationSpec() *locales.DurationSpec {
	return ln.DurationSpec
}

func (ln *ln_AO) GetMiscPatterns() *locales.MiscPatterns {
