...
func New() locales.Translator {
	return &uz_Arab{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "جنو", "فبر", "مار", "اپر", "می", "جون", "جول", "اگس", "سپت", "اکت", "نوم", "دسم"},
			...
			WeekdaysAbbreviatedValue: []string{"ی.", "د.", "س.", "چ.", "پ.", "ج.", "ش."},
		...
		dateFullLayout:   "y نچی ییل d نچی MMMM EEEE کونی",
		dateLongLayout:   "d نچی MMMM y",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0}, {1}", "{0}, {1}", "{0}, {1}", "{0}, {1}"}, {"{0} or {1}", "{0}, {1}", "{0}, {1}", "{0}, or {1}"}}),
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"≥%[1]v",
			"≤%[1]v",
...
// DateFullLayout returns the full date layout for 'uz_Arab'
func (uz *uz_Arab) DateFullLayout() string {
	return uz.dateFullLayout
}

// DateLongLayout returns the long date layout for 'uz_Arab'
func (uz *uz_Arab) DateLongLayout() string {
	return uz.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'uz_Arab'
func (uz *uz_Arab) DateMediumLayout() string {
	return uz.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'uz_Arab'
func (uz *uz_Arab) DateShortLayout() string {
	return uz.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'uz_Arab'
func (uz *uz_Arab) TimeFullLayout() string {
	return uz.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'uz_Arab'
func (uz *uz_Arab) TimeLongLayout() string {
	return uz.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'uz_Arab'
func (uz *uz_Arab) TimeMediumLayout() string {
	return uz.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'uz_Arab'
func (uz *uz_Arab) TimeShortLayout() string {
	return uz.timeShortLayout
}

func (uz *uz_Arab) ListPatterns() *locales.ListPatterns {
	return uz.listPatterns
}

func (uz *uz_Arab) GetDurationSpec() *locales.DurationSpec {
	return uz.DurationSpec
}

func (uz *uz_Arab) GetMiscPatterns() *locales.MiscPatterns {
