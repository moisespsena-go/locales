...
// DateFullLayout returns the full date layout for 'en_FI'
func (en *en_FI) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_FI'
func (en *en_FI) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_FI'
func (en *en_FI) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_FI'
func (en *en_FI) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_FI'
func (en *en_FI) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_FI'
func (en *en_FI) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_FI'
func (en *en_FI) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_FI'
func (en *en_FI) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_FI) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_FI) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_FI) GetMiscPatterns() *locales.MiscPatterns {
