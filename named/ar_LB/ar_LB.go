...
func New() locales.Translator {
	return &ar_LB{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "كانون الثاني", "شباط", "آذار", "نيسان", "أيار", "حزيران", "تموز", "آب", "أيلول", "تشرين الأول", "تشرين الثاني", "كانون الأول"},
			MonthsNarrowValue:        []string{"", "ك", "ش", "آ", "ن", "أ", "ح", "ت", "آ", "أ", "ت", "ت", "ك"},
			MonthsWideValue:          []string{"", "كانون الثاني", "شباط", "آذار", "نيسان", "أيار", "حزيران", "تموز", "آب", "أيلول", "تشرين الأول", "تشرين الثاني", "كانون الأول"},
...
// DateFullLayout returns the full date layout for 'ar_LB'
func (ar *ar_LB) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_LB'
func (ar *ar_LB) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_LB'
func (ar *ar_LB) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_LB'
func (ar *ar_LB) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_LB'
func (ar *ar_LB) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_LB'
func (ar *ar_LB) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_LB'
func (ar *ar_LB) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_LB'
func (ar *ar_LB) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_LB) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_LB) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_LB) GetMiscPatterns() *locales.MiscPatterns {
