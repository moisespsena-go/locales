...
// DateFullLayout returns the full date layout for 'uk_UA'
func (uk *uk_UA) DateFullLayout() string {
	return uk.dateFullLayout
}

// DateLongLayout returns the long date layout for 'uk_UA'
func (uk *uk_UA) DateLongLayout() string {
	return uk.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'uk_UA'
func (uk *uk_UA) DateMediumLayout() string {
	return uk.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'uk_UA'
func (uk *uk_UA) DateShortLayout() string {
	return uk.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'uk_UA'
func (uk *uk_UA) TimeFullLayout() string {
	return uk.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'uk_UA'
func (uk *uk_UA) TimeLongLayout() string {
	return uk.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'uk_UA'
func (uk *uk_UA) TimeMediumLayout() string {
	return uk.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'uk_UA'
func (uk *uk_UA) TimeShortLayout() string {
	return uk.timeShortLayout
}

func (uk *uk_UA) ListPatterns() *locales.ListPatterns {
	return uk.listPatterns
}

func (uk *uk_UA) GetDurationSpec() *locales.DurationSpec {
	return uk.DurationSpec
}

func (uk *uk_UA) GetMiscPatterns() *locales.MiscPatterns {
