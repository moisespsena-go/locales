...
// DateFullLayout returns the full date layout for 'en_VG'
func (en *en_VG) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_VG'
func (en *en_VG) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_VG'
func (en *en_VG) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_VG'
func (en *en_VG) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_VG'
func (en *en_VG) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_VG'
func (en *en_VG) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_VG'
func (en *en_VG) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_VG'
func (en *en_VG) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_VG) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_VG) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_VG) GetMiscPatterns() *locales.MiscPatterns {
