...
func New() locales.Translator {
	return &twq_NE{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Žan", "Fee", "Mar", "Awi", "Me", "Žuw", "Žuy", "Ut", "Sek", "Okt", "Noo", "Dee"},
			MonthsNarrowValue:        []string{"", "Ž", "F", "M", "A", "M", "Ž", "Ž", "U", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Žanwiye", "Feewiriye", "Marsi", "Awiril", "Me", "Žuweŋ", "Žuyye", "Ut", "Sektanbur", "Oktoobur", "Noowanbur", "Deesanbur"},
			WeekdaysAbbreviatedValue: []string{"Alh", "Ati", "Ata", "Ala", "Alm", "Alz", "Asi"},
			WeekdaysNarrowValue:      []string{"H", "T", "T", "L", "L", "L", "S"},
			WeekdaysWideValue:        []string{"Alhadi", "Atinni", "Atalaata", "Alarba", "Alhamiisa", "Alzuma", "Asibti"},
			PeriodsAbbreviatedValue:  []string{"Subbaahi", "Zaarikay b"},
			PeriodsWideValue:         []string{"Subbaahi", "Zaarikay b"},
			ErasAbbreviatedValue:     []string{"IJ", "IZ"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Isaa jine", "Isaa zamanoo"},
...
func (twq *twq_NE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(twq, twq.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'twq_NE'
func (twq *twq_NE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(twq, twq.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'twq_NE'
func (twq *twq_NE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(twq, twq.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'twq_NE'
func (twq *twq_NE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(twq, twq.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'twq_NE'
func (twq *twq_NE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(twq, twq.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'twq_NE'
func (twq *twq_NE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(twq, twq.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'twq_NE'
func (twq *twq_NE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(twq, twq.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'twq_NE'
func (twq *twq_NE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(twq, twq.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'twq_NE'
func (twq *twq_NE) DateFullLayout() string {
	return twq.dateFullLayout
}

// DateLongLayout returns the long date layout for 'twq_NE'
func (twq *twq_NE) DateLongLayout() string {
	return twq.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'twq_NE'
func (twq *twq_NE) DateMediumLayout() string {
	return twq.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'twq_NE'
func (twq *twq_NE) DateShortLayout() string {
	return twq.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'twq_NE'
func (twq *twq_NE) TimeFullLayout() string {
	return twq.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'twq_NE'
func (twq *twq_NE) TimeLongLayout() string {
	return twq.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'twq_NE'
func (twq *twq_NE) TimeMediumLayout() string {
	return twq.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'twq_NE'
func (twq *twq_NE) TimeShortLayout() string {
	return twq.timeShortLayout
}

func (twq *twq_NE) ListPatterns() *locales.ListPatterns {
	return twq.listPatterns
}

func (twq *twq_NE) GetDurationSpec() *locales.DurationSpec {
	return twq.DurationSpec
}

func (twq *twq_NE) GetMiscPatterns() *locales.MiscPatterns {
	return &twq.miscPatterns
}
