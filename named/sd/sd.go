...
func New() locales.Translator {
	return &sd{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0هزار"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0هزار"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00هزار"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00هزار"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000لک"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000لک"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00لک"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00لک"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0ڪروڙ"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0ڪروڙ"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00ڪروڙ"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00ڪروڙ"),
						}},
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0ارب"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0ارب"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00ارب"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00ارب"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0کرب"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0کرب"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0ٽرلين"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0ٽرلين"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00ٽرلين"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00ٽرلين"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000ٽرلين"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000ٽرلين"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "جنوري", "فيبروري", "مارچ", "اپريل", "مئي", "جون", "جولاءِ", "آگسٽ", "سيپٽمبر", "آڪٽوبر", "نومبر", "ڊسمبر"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "جنوري", "فيبروري", "مارچ", "اپريل", "مئي", "جون", "جولاءِ", "آگسٽ", "سيپٽمبر", "آڪٽوبر", "نومبر", "ڊسمبر"},
			WeekdaysAbbreviatedValue: []string{"آچر", "سومر", "اڱارو", "اربع", "خميس", "جمعو", "ڇنڇر"},
			WeekdaysNarrowValue:      []string{"آچر", "سو", "اڱارو", "اربع", "خم", "جمعو", "ڇنڇر"},
			WeekdaysShortValue:       []string{"آچر", "سومر", "اڱارو", "اربع", "خميس", "جمعو", "ڇنڇر"},
			WeekdaysWideValue:        []string{"آچر", "سومر", "اڱارو", "اربع", "خميس", "جمعو", "ڇنڇر"},
			PeriodsAbbreviatedValue:  []string{"صبح، منجهند", "شام، منجهند"},
			PeriodsNarrowValue:       []string{"صبح، منجهند", "منجهند، شام"},
			PeriodsWideValue:         []string{"صبح، منجهند", "منجهند، شام"},
			ErasAbbreviatedValue:     []string{"BC", "CD"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"قبل مسيح", "عيسوي کان پهرين"},
			TimezonesValue:           map[string]string{"": "فاڪ لينڊ آئي لينڊ جو معياري وقت", "ACDT": "آسٽريليا جو مرڪزي ڏينهن جو وقت", "ACST": "آسٽريليا جو مرڪزي معياري وقت", "ACT": "ACT", "ACWDT": "آسٽريليا جو مرڪزي مغربي ڏينهن جو وقت", "ACWST": "آسٽريليا جو مرڪزي مغربي معياري وقت", "ADT": "ايٽلانٽڪ جي ڏينهن جو وقت", "AEDT": "آسٽريليا جو مشرقي ڏينهن جو وقت", "AEST": "آسٽريليا جو مشرقي معياري وقت", "AFT": "افغانستان جو وقت", "AKDT": "الاسڪا جي ڏينهن جو وقت", "AKST": "الاسڪا جو معياري وقت", "AMST": "ايميزون جي اونهاري جو وقت", "AMT": "ايميزون جو معياري وقت", "ARST": "ارجنٽائن جي اونهاري جو وقت", "ART": "ارجنٽائن معياري وقت", "AST": "ايٽلانٽڪ جو معياري وقت", "AWDT": "آسٽريليا جو مغربي ڏينهن جو وقت", "AWST": "آسٽريليا جو مغربي معياري وقت", "BNT": "برونائي دارالسلام جو وقت", "BOT": "بولويائي وقت", "BRST": "براسيليا جي اونهاري جو وقت", "BRT": "براسيليا جو معياري وقت", "BST": "بنگلاديش جي اونهاري جو وقت", "BTT": "ڀوٽان جو وقت", "CAT": "مرڪزي آفريقا جو وقت", "CCT": "ڪوڪوس آئي لينڊ جو وقت", "CDT": "مرڪزي ڏينهن جو وقت", "CDT (Kuba)": "ڪيوبا جي ڏينهن جو وقت", "CHADT": "چئٿم جي ڏينهن جو وقت", "CHAST": "چئٿم جو معياري وقت", "CLST": "چلي جي اونهاري جو وقت", "CLT": "چلي جو معياري وقت", "COST": "ڪولمبيا جي اونهاري جو وقت", "COT": "ڪولمبيا جو معياري وقت", "CST": "مرڪزي معياري وقت", "CST (Kuba)": "ڪيوبا جو معياري وقت", "CXT": "ڪرسمس آئي لينڊ جو وقت", "ChST": "چمورو جو معياري وقت", "EASST": "ايسٽر آئي لينڊ جي اونهاري جو وقت", "EAST": "ايسٽر آئي لينڊ جو معياري وقت", "EAT": "اوڀر آفريڪا جو وقت", "ECT": "ايڪواڊور جو وقت", "EDT": "مشرقي ڏينهن جو وقت", "EGDT": "مشرقي گرين لينڊ جي اونهاري جو وقت", "EGST": "مشرقي گرين لينڊ جو معياري وقت", "EST": "مشرقي معياري وقت", "FKST": "فاڪ لينڊ آئي لينڊ جي اونهاري جو وقت", "GALT": "گالاپاگوز جو وقت", "GFT": "فرانسيسي گيانا جو وقت", "GMT": "گرين وچ مين ٽائيم", "GST": "خليجي معياري وقت", "GYT": "گيانائي وقت", "HADT": "هوائي اليوٽين جي ڏينهن جو وقت", "HAST": "هوائي اليوٽين جو معياري وقت", "HENOMX": "شمالي مغربي ميڪسيڪو جي ڏينهن جو وقت", "HEOG": "مغربي گرين لينڊ جي اونهاري جو وقت", "HEPMX": "ميڪسيڪن پيسيفڪ جي ڏينهن جو وقت", "HKST": "هانگ ڪانگ جي اونهاري جو وقت", "HKT": "هانگ ڪانگ جو معياري وقت", "HNNOMX": "شمالي مغربي ميڪسيڪو جو معياري وقت", "HNOG": "مغربي گرين لينڊ جو معياري وقت", "HNPMX": "ميڪسيڪن پيسيفڪ جو معياري وقت", "ICT": "انڊو چائنا جو وقت", "IRDT": "ايران جي ڏينهن جو وقت", "IRST": "ايران جو معياري وقت", "IST": "ڀارت جو معياري وقت", "JDT": "جاپان جي ڏينهن جو وقت", "JST": "جاپان جو معياري وقت", "LHDT": "لورڊ هووي جي ڏينهن جو وقت", "LHST": "لورڊ هووي جو معياري وقت", "MDT": "MDT", "MESZ": "مرڪزي يورپي اونهاري جو وقت", "MEZ": "مرڪزي يورپي معياري وقت", "MST": "MST", "MVT": "مالديپ جو وقت", "MYT": "ملائيشيا جو وقت", "NDT": "نيو فائونڊ لينڊ جي ڏينهن جو وقت", "NPT": "نيپال جو وقت", "NST": "نيو فائونڊ لينڊ جو معياري وقت", "NZDT": "نيوزيلينڊ جي ڏينهن جو وقت", "NZST": "نيوزيلينڊ جو معياري وقت", "OESZ": "مشرقي يورپي اونهاري جو وقت", "OEZ": "مشرقي يورپي معياري وقت", "PDT": "پيسيفڪ ڏينهن جو وقت", "PKT": "پاڪستان جي اونهاري جو وقت", "PMDT": "سينٽ پيئر ۽ ميڪلون جي ڏينهن جو وقت", "PMST": "سينٽ پيئر ۽ ميڪلون جو معياري وقت", "PST": "پيسيفڪ معياري وقت", "PYST": "پيراگوئي جي اونهاري جو وقت", "SAST": "ڏکڻ آفريڪا جو معياري وقت", "SGT": "سنگاپور جو معياري وقت", "SRT": "سوري نام جو وقت", "TLT": "اوڀر تيمور جو وقت", "TMST": "ترڪمانستان جي اونهاري جو وقت", "TMT": "ترڪمانستان جو معياري وقت", "UYST": "يوروگائي جي اونهاري جو وقت", "UYT": "يوروگائي جو معياري وقت", "VET": "وينزويلا جو وقت", "WARST": "اولهه ارجنٽينا جي اونهاري جو وقت", "WART": "اولهه ارجنٽينا جو معياري وقت", "WAST": "اولهه آفريقا جي اونهاري جو وقت", "WAT": "اولهه آفريقا جو معياري وقت", "WESZ": "اولهه يورپي ڏينهن جو وقت", "WEZ": "اولهه يورپي معياري وقت", "WIB": "اولهه انڊونيشيا جو وقت", "WIT": "اوڀر انڊونيشيا جو وقت", "WITA": "مرڪزي انڊونيشيا جو وقت", "∅∅∅": "پيرو جي اونهاري جو وقت"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} ۽ {1}", "{0}, {1}", "{0}, {1}", "{0}، ۽ {1}"}, {"{0} يا {1}", "{0}, {1}", "{0}, {1}", "{0}, يا {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"c", "%v c", "%v c", ""},
				Long:   &locales.CounterFormat{"صديون", "%v c", "%v صديون", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ڏهاڪا", "%v ڏهاڪو", "%v ڏهاڪا", ""},
				Long:   &locales.CounterFormat{"ڏهاڪا", "%v ڏهاڪو", "%v ڏهاڪا", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"سال", "%v سال", "%v سال", ""},
				Long:   &locales.CounterFormat{"سال", "%v سال", "%v سال", "%v في سال"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"مهينو", "%v مهينا", "%v مهينا", ""},
				Long:   &locales.CounterFormat{"مهينا", "%v مهينا", "%v مهينا", "%v في مهيني"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"هفتو", "%v هفتا", "%v هفتي", ""},
				Long:   &locales.CounterFormat{"هفتا", "%v هفتا", "%v هفتا", "%v في هفتي"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ڏينهن", "%v ڏينهن", "%v ڏينهن", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ڪلاڪ", "%v ڪلاڪ", "%v ڪلاڪ", ""},
				Long:   &locales.CounterFormat{"ڪلاڪ", "%v ڪلاڪ", "%v ڪلاڪ", "%v في ڪلاڪ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"منٽ", "%v منٽ", "%v منٽ", ""},
				Long:   &locales.CounterFormat{"منٽ", "%v منٽ", "%v منٽ", "%v في منٽ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"سيڪنڊ", "%v s", "%v سيڪنڊ", ""},
				Long:   &locales.CounterFormat{"سيڪنڊ", "%v في سيڪنڊ", "%v سيڪنڊ", "%v في سيڪنڊ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ملي سيڪنڊ", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"ملي سيڪنڊ", "%v ملي سيڪنڊ", "%v ملي سيڪنڊ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"مائڪرو سيڪنڊ", "%v مائڪرو سيڪنڊ", "%v مائڪرو سيڪنڊ", ""},
				Long:   &locales.CounterFormat{"مائڪرو سيڪنڊ", "%v مائڪرو سيڪنڊ", "%v مائڪرو سيڪنڊ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"نينو سيڪنڊ", "%v نينو سيڪنڊ", "%v نينو سيڪنڊ", ""},
				Long:   &locales.CounterFormat{"نينو سيڪنڊ", "%v نينو سيڪنڊ", "%v نينو سيڪنڊ", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"≥%[1]v",
...
func (sd *sd) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'sd'
func (sd *sd) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'sd'
func (sd *sd) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'sd'
func (sd *sd) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'sd'
func (sd *sd) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'sd'
func (sd *sd) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'sd'
func (sd *sd) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'sd'
func (sd *sd) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'sd'
func (sd *sd) DateFullLayout() string {
	return sd.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sd'
func (sd *sd) DateLongLayout() string {
	return sd.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sd'
func (sd *sd) DateMediumLayout() string {
	return sd.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sd'
func (sd *sd) DateShortLayout() string {
	return sd.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sd'
func (sd *sd) TimeFullLayout() string {
	return sd.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sd'
func (sd *sd) TimeLongLayout() string {
	return sd.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sd'
func (sd *sd) TimeMediumLayout() string {
	return sd.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sd'
func (sd *sd) TimeShortLayout() string {
	return sd.timeShortLayout
}

func (sd *sd) ListPatterns() *locales.ListPatterns {
	return sd.listPatterns
}

func (sd *sd) GetDurationSpec() *locales.DurationSpec {
	return sd.DurationSpec
}

func (sd *sd) GetMiscPatterns() *locales.MiscPatterns {
	return &sd.miscPatterns
}
