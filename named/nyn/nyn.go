...
// DateFullLayout returns the full date layout for 'nyn'
func (nyn *nyn) DateFullLayout() string {
	return nyn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nyn'
func (nyn *nyn) DateLongLayout() string {
	return nyn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nyn'
func (nyn *nyn) DateMediumLayout() string {
	return nyn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nyn'
func (nyn *nyn) DateShortLayout() string {
	return nyn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nyn'
func (nyn *nyn) TimeFullLayout() string {
	return nyn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nyn'
func (nyn *nyn) TimeLongLayout() string {
	return nyn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nyn'
func (nyn *nyn) TimeMediumLayout() string {
	return nyn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nyn'
func (nyn *nyn) TimeShortLayout() string {
	return nyn.timeShortLayout
}

func (nyn *nyn) ListPatterns() *locales.ListPatterns {
	return nyn.listPatterns
}

func (nyn *nyn) GetDurationSpec() *locales.DurationSpec {
	return nyn.DurationSpec
}

func (nyn *nyn) GetMiscPatterns() *locales.MiscPatterns {
