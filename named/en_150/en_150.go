...
// DateFullLayout returns the full date layout for 'en_150'
func (en *en_150) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_150'
func (en *en_150) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_150'
func (en *en_150) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_150'
func (en *en_150) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_150'
func (en *en_150) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_150'
func (en *en_150) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_150'
func (en *en_150) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_150'
func (en *en_150) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_150) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_150) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_150) GetMiscPatterns() *locales.MiscPatterns {
