...
func New() locales.Translator {
	return &hy{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 հզր ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 հզր ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 հզր ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 հզր ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 հզր ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 հզր ¤"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 մլն ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 մլն ¤"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 մլն ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 մլն ¤"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 մլն ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 մլն ¤"),
						}},
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 մլրդ ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 մլրդ ¤"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 մլրդ ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 մլրդ ¤"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 մլրդ ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 մլրդ ¤"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 տրլն ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 տրլն ¤"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 տրլն ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 տրլն ¤"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 տրլն ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 տրլն ¤"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "հնվ", "փտվ", "մրտ", "ապր", "մյս", "հնս", "հլս", "օգս", "սեպ", "հոկ", "նոյ", "դեկ"},
			MonthsNarrowValue:        []string{"", "Հ", "Փ", "Մ", "Ա", "Մ", "Հ", "Հ", "Օ", "Ս", "Հ", "Ն", "Դ"},
			MonthsWideValue:          []string{"", "հունվարի", "փետրվարի", "մարտի", "ապրիլի", "մայիսի", "հունիսի", "հուլիսի", "օգոստոսի", "սեպտեմբերի", "հոկտեմբերի", "նոյեմբերի", "դեկտեմբերի"},
			WeekdaysAbbreviatedValue: []string{"կիր", "երկ", "երք", "չրք", "հնգ", "ուր", "շբթ"},
			WeekdaysNarrowValue:      []string{"Կ", "Ե", "Ե", "Չ", "Հ", "Ո", "Շ"},
			WeekdaysShortValue:       []string{"կր", "եկ", "եք", "չք", "հգ", "ու", "շբ"},
			WeekdaysWideValue:        []string{"կիրակի", "երկուշաբթի", "երեքշաբթի", "չորեքշաբթի", "հինգշաբթի", "ուրբաթ", "շաբաթ"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsNarrowValue:       []string{"ա", "հ"},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"մ.թ.ա.", "մ.թ."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Քրիստոսից առաջ", "Քրիստոսից հետո"},
			TimezonesValue:           map[string]string{"": "Պարագվայի ստանդարտ ժամանակ", "ACDT": "Կենտրոնական Ավստրալիայի ամառային ժամանակ", "ACST": "Կենտրոնական Ավստրալիայի ստանդարտ ժամանակ", "ACT": "ACT", "ACWDT": "Կենտրոնական Ավստրալիայի արևմտյան ամառային ժամանակ", "ACWST": "Կենտրոնական Ավստրալիայի արևմտյան ստանդարտ ժամանակ", "ADT": "Ատլանտյան ամառային ժամանակ", "AEDT": "Արևելյան Ավստրալիայի ամառային ժամանակ", "AEST": "Արևելյան Ավստրալիայի ստանդարտ ժամանակ", "AFT": "Աֆղանստանի ժամանակ", "AKDT": "Ալյասկայի ամառային ժամանակ", "AKST": "Ալյասկայի ստանդարտ ժամանակ", "AMST": "Ամազոնյան ամառային ժամանակ", "AMT": "Ամազոնյան ստանդարտ ժամանակ", "ARST": "Արգենտինայի ամառային ժամանակ", "ART": "Արգենտինայի ստնադարտ ժամանակ", "AST": "Ատլանտյան ստանդարտ ժամանակ", "AWDT": "Արևմտյան Ավստրալիայի ամառային ժամանակ", "AWST": "Արևմտյան Ավստրալիայի ստանդարտ ժամանակ", "BNT": "Բրունեյի ժամանակ", "BOT": "Բոլիվիայի ժամանակ", "BRST": "Բրազիլիայի ամառային ժամանակ", "BRT": "Բրազիլիայի ստանդարտ ժամանակ", "BST": "Բանգլադեշի ամառային ժամանակ", "BTT": "Բութանի ժամանակ", "CAT": "Կենտրոնական Աֆրիկայի ժամանակ", "CCT": "Կոկոսյան կղզիների ժամանակ", "CDT": "Կենտրոնական Ամերիկայի ամառային ժամանակ", "CDT (Kuba)": "Կուբայի ամառային ժամանակ", "CHADT": "Չաթեմ կղզու ամառային ժամանակ", "CHAST": "Չաթեմ կղզու ստանդարտ ժամանակ", "CLST": "Չիլիի ամառային ժամանակ", "CLT": "Չիլիի ստանդարտ ժամանակ", "COST": "Կոլումբիայի ամառային ժամանակ", "COT": "Կոլումբիայի ստանդարտ ժամանակ", "CST": "Կենտրոնական Ամերիկայի ստանդարտ ժամանակ", "CST (Kuba)": "Կուբայի ստանդարտ ժամանակ", "CXT": "Սուրբ Ծննդյան կղզու ժամանակ", "ChST": "Չամոռոյի ժամանակ", "EASST": "Զատկի կղզու ամառային ժամանակ", "EAST": "Զատկի կղզու ստանդարտ ժամանակ", "EAT": "Արևելյան Աֆրիկայի ժամանակ", "ECT": "Էկվադորի ժամանակ", "EDT": "Արևելյան Ամերիկայի ամառային ժամանակ", "EGDT": "Արևելյան Գրենլանդիայի ամառային ժամանակ", "EGST": "Արևելյան Գրենլանդիայի ստանդարտ ժամանակ", "EST": "Արևելյան Ամերիկայի ստանդարտ ժամանակ", "FKST": "Ֆոլքլենդյան կղզիների ամառային ժամանակ", "GALT": "Գալապագոսյան կղզիների ժամանակ", "GFT": "Ֆրանսիական Գվիանայի ժամանակ", "GMT": "Գրինվիչի ժամանակ", "GST": "Պարսից ծոցի ստանդարտ ժամանակ", "GYT": "Գայանայի ժամանակ", "HADT": "Հավայան-ալեության ամառային ժամանակ", "HAST": "Հավայան-ալեության ստանդարտ ժամանակ", "HENOMX": "Հյուսիսարևմտյան Մեքսիկայի ամառային ժամանակ", "HEOG": "Արևմտյան Գրենլանդիայի ամառային ժամանակ", "HEPMX": "Մեքսիկայի խաղաղօվկիանոսյան ամառային ժամանակ", "HKST": "Հոնկոնգի ամառային ժամանակ", "HKT": "Հոնկոնգի ստանդարտ ժամանակ", "HNNOMX": "Հյուսիսարևմտյան Մեքսիկայի ստանդարտ ժամանակ", "HNOG": "Արևմտյան Գրենլանդիայի ստանդարտ ժամանակ", "HNPMX": "Մեքսիկայի խաղաղօվկիանոսյան ստանդարտ ժամանակ", "ICT": "Հնդկաչինական ժամանակ", "IRDT": "Իրանի ամառային ժամանակ", "IRST": "Իրանի ստանդարտ ժամանակ", "IST": "Հնդկաստանի ստանդարտ ժամանակ", "JDT": "Ճապոնիայի ամառային ժամանակ", "JST": "Ճապոնիայի ստանդարտ ժամանակ", "LHDT": "Լորդ Հաուի ամառային ժամանակ", "LHST": "Լորդ Հաուի ստանդարտ ժամանակ", "MDT": "Լեռնային ամառային ժամանակ (ԱՄՆ)", "MESZ": "Կենտրոնական Եվրոպայի ամառային ժամանակ", "MEZ": "Կենտրոնական Եվրոպայի ստանդարտ ժամանակ", "MST": "Լեռնային ստանդարտ ժամանակ (ԱՄՆ)", "MVT": "Մալդիվների ժամանակ", "MYT": "Մալայզիայի ժամանակ", "NDT": "Նյուֆաունդլենդի ամառային ժամանակ", "NPT": "Նեպալի ժամանակ", "NST": "Նյուֆաունդլենդի ստանդարտ ժամանակ", "NZDT": "Նոր Զելանդիայի ամառային ժամանակ", "NZST": "Նոր Զելանդիայի ստանդարտ ժամանակ", "OESZ": "Արևելյան Եվրոպայի ամառային ժամանակ", "OEZ": "Արևելյան Եվրոպայի ստանդարտ ժամանակ", "PDT": "Խաղաղօվկիանոսյան ամառային ժամանակ", "PKT": "Պակիստանի ամառային ժամանակ", "PMDT": "Սեն Պիեռ և Միքելոնի ամառային ժամանակ", "PMST": "Սեն Պիեռ և Միքելոնի ստանդարտ ժամանակ", "PST": "Խաղաղօվկիանոսյան ստանդարտ ժամանակ", "PYST": "Պարագվայի ամառային ժամանակ", "SAST": "Հարավային Աֆրիկայի ժամանակ", "SGT": "Սինգապուրի ժամանակ", "SRT": "Սուրինամի ժամանակ", "TLT": "Արևելյան Թիմորի ժամանակ", "TMST": "Թուրքմենստանի ամառային ժամանակ", "TMT": "Թուրքմենստանի ստանդարտ ժամանակ", "UYST": "Ուրուգվայի ամառային ժամանակ", "UYT": "Ուրուգվայի ստանդարտ ժամանակ", "VET": "Վենեսուելայի ժամանակ", "WARST": "Արևմտյան Արգենտինայի ամառային ժամանակ", "WART": "Արևմտյան Արգենտինայի ստնադարտ ժամանակ", "WAST": "Արևմտյան Աֆրիկայի ամառային ժամանակ", "WAT": "Արևմտյան Աֆրիկայի ստանդարտ ժամանակ", "WESZ": "Արևմտյան Եվրոպայի ամառային ժամանակ", "WEZ": "Արևմտյան Եվրոպայի ստանդարտ ժամանակ", "WIB": "Արևմտյան Ինդոնեզիայի ժամանակ", "WIT": "Արևելյան Ինդոնեզիայի ժամանակ", "WITA": "Կենտրոնական Ինդոնեզիայի ժամանակ", "∅∅∅": "Ազորյան կղզիների ամառային ժամանակ"},
		},
		...
		dateFullLayout:   "y թ. MMMM d, EEEE",
		dateLongLayout:   "dd MMMM, y թ.",
		dateMediumLayout: "dd MMM, y թ.",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} և {1}", "{0}, {1}", "{0}, {1}", "{0} և {1}"}, {"{0} կամ {1}", "{0}, {1}", "{0}, {1}", "{0} կամ {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"դ․", "%v դ․", "%v դ․", ""},
				Long:   &locales.CounterFormat{"դարեր", "%v դարում", "%v դարում", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"10-ամյակ", "%v 10-ամյակ", "%v 10-ամյակ", ""},
				Long:   &locales.CounterFormat{"տասնամյակներ", "%v տասնամյակում", "%v տասնամյակում", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"տ", "%v տ", "%v տ", ""},
				Long:   &locales.CounterFormat{"տարիներ", "%v տարում", "%v տարում", "տարեկան %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ա", "%v ա", "%v ա", ""},
				Long:   &locales.CounterFormat{"ամիսներ", "%v ամսում", "%v ամսում", "ամսական %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"շ", "%v շ", "%v շ", ""},
				Long:   &locales.CounterFormat{"շաբաթներ", "%v շաբաթում", "%v շաբաթում", "շաբաթական %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"օ", "%v օ", "%v օ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ժ", "%v ժ", "%v ժ", ""},
				Long:   &locales.CounterFormat{"ժամեր", "%v ժամում", "%v ժամում", "%v ժամում"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ր", "%v ր", "%v ր", ""},
				Long:   &locales.CounterFormat{"րոպեներ", "%v րոպեում", "%v րոպեում", "%v րոպեում"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"վ", "%v վ", "%v վ", "%v/վ"},
				Long:   &locales.CounterFormat{"վայրկյաններ", "%v վայրկյանում", "%v վայրկյանում", "%v վայրկյանում"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"մվ", "%v մվ", "%v մվ", ""},
				Long:   &locales.CounterFormat{"միլիվայրկյաններ", "%v միլիվայրկյանում", "%v միլիվայրկյանում", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"մկվ", "%v մկվ", "%v մկվ", ""},
				Long:   &locales.CounterFormat{"միկրովայրկյաններ", "%v միկրովայրկյանում", "%v միկրովայրկյանում", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"նվ", "%v նվ", "%v նվ", ""},
				Long:   &locales.CounterFormat{"նանովայրկյաններ", "%v նանովայրկյանում", "%v նանովայրկյանում", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (hy *hy) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(hy, hy.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'hy'
func (hy *hy) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(hy, hy.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'hy'
func (hy *hy) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(hy, hy.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'hy'
func (hy *hy) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(hy, hy.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'hy'
func (hy *hy) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(hy, hy.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'hy'
func (hy *hy) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(hy, hy.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'hy'
func (hy *hy) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(hy, hy.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'hy'
func (hy *hy) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(hy, hy.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'hy'
func (hy *hy) DateFullLayout() string {
	return hy.dateFullLayout
}

// DateLongLayout returns the long date layout for 'hy'
func (hy *hy) DateLongLayout() string {
	return hy.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'hy'
func (hy *hy) DateMediumLayout() string {
	return hy.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'hy'
func (hy *hy) DateShortLayout() string {
	return hy.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'hy'
func (hy *hy) TimeFullLayout() string {
	return hy.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'hy'
func (hy *hy) TimeLongLayout() string {
	return hy.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'hy'
func (hy *hy) TimeMediumLayout() string {
	return hy.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'hy'
func (hy *hy) TimeShortLayout() string {
	return hy.timeShortLayout
}

func (hy *hy) ListPatterns() *locales.ListPatterns {
	return hy.listPatterns
}

func (hy *hy) GetDurationSpec() *locales.DurationSpec {
	return hy.DurationSpec
}

func (hy *hy) GetMiscPatterns() *locales.MiscPatterns {
	return &hy.miscPatterns
}
