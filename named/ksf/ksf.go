...
// DateFullLayout returns the full date layout for 'ksf'
func (ksf *ksf) DateFullLayout() string {
	return ksf.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ksf'
func (ksf *ksf) DateLongLayout() string {
	return ksf.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ksf'
func (ksf *ksf) DateMediumLayout() string {
	return ksf.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ksf'
func (ksf *ksf) DateShortLayout() string {
	return ksf.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ksf'
func (ksf *ksf) TimeFullLayout() string {
	return ksf.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ksf'
func (ksf *ksf) TimeLongLayout() string {
	return ksf.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ksf'
func (ksf *ksf) TimeMediumLayout() string {
	return ksf.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ksf'
func (ksf *ksf) TimeShortLayout() string {
	return ksf.timeShortLayout
}

func (ksf *ksf) ListPatterns() *locales.ListPatterns {
	return ksf.listPatterns
}

func (ksf *ksf) GetDurationSpec() *locales.DurationSpec {
	return ksf.DurationSpec
}

func (ksf *ksf) GetMiscPatterns() *locales.MiscPatterns {
