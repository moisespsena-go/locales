...
// DateFullLayout returns the full date layout for 'en_AI'
func (en *en_AI) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_AI'
func (en *en_AI) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_AI'
func (en *en_AI) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_AI'
func (en *en_AI) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_AI'
func (en *en_AI) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_AI'
func (en *en_AI) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_AI'
func (en *en_AI) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_AI'
func (en *en_AI) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_AI) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_AI) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_AI) GetMiscPatterns() *locales.MiscPatterns {
