...
func New() locales.Translator {
	return &ia{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jan", "feb", "mar", "apr", "mai", "jun", "jul", "aug", "sep", "oct", "nov", "dec"},
			MonthsNarrowValue:        []string{"", "j", "f", "m", "a", "m", "j", "j", "a", "s", "o", "n", "d"},
			MonthsWideValue:          []string{"", "januario", "februario", "martio", "april", "maio", "junio", "julio", "augusto", "septembre", "octobre", "novembre", "decembre"},
			WeekdaysAbbreviatedValue: []string{"dom", "lun", "mar", "mer", "jov", "ven", "sab"},
			WeekdaysNarrowValue:      []string{"d", "l", "m", "m", "j", "v", "s"},
			WeekdaysShortValue:       []string{"do", "lu", "ma", "me", "jo", "ve", "sa"},
			WeekdaysWideValue:        []string{"dominica", "lunedi", "martedi", "mercuridi", "jovedi", "venerdi", "sabbato"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsNarrowValue:       []string{"AM", "PM"},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"a.Chr.", "p.Chr."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"ante Christo", "post Christo"},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "hora estive atlantic", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "hora estive de Alaska", "AKST": "hora normal de Alaska", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "hora normal atlantic", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "CAT", "CCT": "CCT", "CDT": "hora estive central", "CDT (Kuba)": "hora estive de Cuba", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "hora normal central", "CST (Kuba)": "hora normal de Cuba", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "EAT", "ECT": "ECT", "EDT": "hora estive del est", "EGDT": "hora estive de Groenlandia oriental", "EGST": "hora normal de Groenlandia oriental", "EST": "hora normal del est", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "hora medie de Greenwich", "GST": "GST", "GYT": "GYT", "HADT": "hora estive de Hawaii-Aleutianas", "HAST": "hora normal de Hawaii-Aleutianas", "HENOMX": "hora estive del nordwest de Mexico", "HEOG": "hora estive de Groenlandia occidental", "HEPMX": "hora estive del Pacifico mexican", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "hora normal del nordwest de Mexico", "HNOG": "hora normal de Groenlandia occidental", "HNPMX": "hora normal del Pacifico mexican", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "hora estive del montanias", "MESZ": "hora estive de Europa central", "MEZ": "hora normal de Europa central", "MST": "hora normal del montanias", "MVT": "MVT", "MYT": "MYT", "NDT": "hora estive de Terranova", "NPT": "NPT", "NST": "hora normal de Terranova", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "hora estive de Europa oriental", "OEZ": "hora normal de Europa oriental", "PDT": "hora estive pacific", "PKT": "PKT", "PMDT": "hora estive de Saint-Pierre e Miquelon", "PMST": "hora normal de Saint-Pierre e Miquelon", "PST": "hora normal pacific", "PYST": "PYST", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "hora estive de Europa occidental", "WEZ": "hora normal de Europa occidental", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "hora estive del Azores"},
		},
		...
		dateFullLayout:   "EEEE 'le' d 'de' MMMM y",
		dateLongLayout:   "d 'de' MMMM y",
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"scl", "%v scl", "%v scl", ""},
				Long:   &locales.CounterFormat{"seculos", "%v seculo", "%v seculos", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"an", "%van", "%van", ""},
				Long:   &locales.CounterFormat{"annos", "%v anno", "%v annos", "%v per anno"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mense", "%vm", "%vm", ""},
				Long:   &locales.CounterFormat{"menses", "%v mense", "%v menses", "%v per mense"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sept.", "%vsept", "%vsept", ""},
				Long:   &locales.CounterFormat{"septimanas", "%v septimana", "%v septimanas", "%v per septimana"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"die", "%vd", "%vd", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"hora", "%vh", "%vh", ""},
				Long:   &locales.CounterFormat{"horas", "%v hora", "%v horas", "%v per hora"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%vm", "%vm", ""},
				Long:   &locales.CounterFormat{"minutas", "%v minuta", "%v minutas", "%v per minuta"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%vs", "%vs", ""},
				Long:   &locales.CounterFormat{"secundas", "%v secunda", "%v secundas", "%v per secunda"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"millisec", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"millisecundas", "%v millisecunda", "%v millisecundas", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v μs", "%vμs", ""},
				Long:   &locales.CounterFormat{"microsecundas", "%v microsecunda", "%v microsecundas", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"nanosecundas", "%v nanosecunda", "%v nanosecundas", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"",
			"⩾%[1]v",
...
func (ia *ia) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ia, ia.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ia'
func (ia *ia) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ia, ia.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ia'
func (ia *ia) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ia, ia.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ia'
func (ia *ia) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ia, ia.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ia'
func (ia *ia) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ia, ia.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ia'
func (ia *ia) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ia, ia.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ia'
func (ia *ia) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ia, ia.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ia'
func (ia *ia) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ia, ia.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ia'
func (ia *ia) DateFullLayout() string {
	return ia.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ia'
func (ia *ia) DateLongLayout() string {
	return ia.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ia'
func (ia *ia) DateMediumLayout() string {
	return ia.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ia'
func (ia *ia) DateShortLayout() string {
	return ia.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ia'
func (ia *ia) TimeFullLayout() string {
	return ia.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ia'
func (ia *ia) TimeLongLayout() string {
	return ia.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ia'
func (ia *ia) TimeMediumLayout() string {
	return ia.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ia'
func (ia *ia) TimeShortLayout() string {
	return ia.timeShortLayout
}

func (ia *ia) ListPatterns() *locales.ListPatterns {
	return ia.listPatterns
}

func (ia *ia) GetDurationSpec() *locales.DurationSpec {
	return ia.DurationSpec
}

func (ia *ia) GetMiscPatterns() *locales.MiscPatterns {
	return &ia.miscPatterns
}
