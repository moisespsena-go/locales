...
func New() locales.Translator {
	return &nmg_CM{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ng1", "ng2", "ng3", "ng4", "ng5", "ng6", "ng7", "ng8", "ng9", "ng10", "ng11", "kris"},
			MonthsWideValue:          []string{"", "ngwɛn matáhra", "ngwɛn ńmba", "ngwɛn ńlal", "ngwɛn ńna", "ngwɛn ńtan", "ngwɛn ńtuó", "ngwɛn hɛmbuɛrí", "ngwɛn lɔmbi", "ngwɛn rɛbvuâ", "ngwɛn wum", "ngwɛn wum navǔr", "krísimin"},
			WeekdaysAbbreviatedValue: []string{"sɔ́n", "mɔ́n", "smb", "sml", "smn", "mbs", "sas"},
			WeekdaysNarrowValue:      []string{"s", "m", "s", "s", "s", "m", "s"},
			WeekdaysWideValue:        []string{"sɔ́ndɔ", "mɔ́ndɔ", "sɔ́ndɔ mafú mába", "sɔ́ndɔ mafú málal", "sɔ́ndɔ mafú mána", "mabágá má sukul", "sásadi"},
			PeriodsAbbreviatedValue:  []string{"maná", "kugú"},
			PeriodsWideValue:         []string{"maná", "kugú"},
			ErasAbbreviatedValue:     []string{"BL", "PB"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Bó Lahlɛ̄", "Pfiɛ Burī"},
...
func (nmg *nmg_CM) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(nmg, nmg.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'nmg_CM'
func (nmg *nmg_CM) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(nmg, nmg.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'nmg_CM'
func (nmg *nmg_CM) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(nmg, nmg.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'nmg_CM'
func (nmg *nmg_CM) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(nmg, nmg.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'nmg_CM'
func (nmg *nmg_CM) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(nmg, nmg.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'nmg_CM'
func (nmg *nmg_CM) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(nmg, nmg.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'nmg_CM'
func (nmg *nmg_CM) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(nmg, nmg.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'nmg_CM'
func (nmg *nmg_CM) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(nmg, nmg.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'nmg_CM'
func (nmg *nmg_CM) DateFullLayout() string {
	return nmg.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nmg_CM'
func (nmg *nmg_CM) DateLongLayout() string {
	return nmg.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nmg_CM'
func (nmg *nmg_CM) DateMediumLayout() string {
	return nmg.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nmg_CM'
func (nmg *nmg_CM) DateShortLayout() string {
	return nmg.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nmg_CM'
func (nmg *nmg_CM) TimeFullLayout() string {
	return nmg.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nmg_CM'
func (nmg *nmg_CM) TimeLongLayout() string {
	return nmg.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nmg_CM'
func (nmg *nmg_CM) TimeMediumLayout() string {
	return nmg.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nmg_CM'
func (nmg *nmg_CM) TimeShortLayout() string {
	return nmg.timeShortLayout
}

func (nmg *nmg_CM) ListPatterns() *locales.ListPatterns {
	return nmg.listPatterns
}

func (nmg *nmg_CM) GetDurationSpec() *locales.DurationSpec {
	return nmg.DurationSpec
}

func (nmg *nmg_CM) GetMiscPatterns() *locales.MiscPatterns {
	return &nmg.miscPatterns
}
