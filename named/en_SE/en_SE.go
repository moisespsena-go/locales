...
// DateFullLayout returns the full date layout for 'en_SE'
func (en *en_SE) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_SE'
func (en *en_SE) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_SE'
func (en *en_SE) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_SE'
func (en *en_SE) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_SE'
func (en *en_SE) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_SE'
func (en *en_SE) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_SE'
func (en *en_SE) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_SE'
func (en *en_SE) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_SE) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_SE) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_SE) GetMiscPatterns() *locales.MiscPatterns {
