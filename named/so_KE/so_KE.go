...
// DateFullLayout returns the full date layout for 'so_KE'
func (so *so_KE) DateFullLayout() string {
	return so.dateFullLayout
}

// DateLongLayout returns the long date layout for 'so_KE'
func (so *so_KE) DateLongLayout() string {
	return so.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'so_KE'
func (so *so_KE) DateMediumLayout() string {
	return so.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'so_KE'
func (so *so_KE) DateShortLayout() string {
	return so.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'so_KE'
func (so *so_KE) TimeFullLayout() string {
	return so.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'so_KE'
func (so *so_KE) TimeLongLayout() string {
	return so.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'so_KE'
func (so *so_KE) TimeMediumLayout() string {
	return so.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'so_KE'
func (so *so_KE) TimeShortLayout() string {
	return so.timeShortLayout
}

func (so *so_KE) ListPatterns() *locales.ListPatterns {
	return so.listPatterns
}

func (so *so_KE) GetDurationSpec() *locales.DurationSpec {
	return so.DurationSpec
}

func (so *so_KE) GetMiscPatterns() *locales.MiscPatterns {
