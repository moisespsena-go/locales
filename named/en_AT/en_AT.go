...
// DateFullLayout returns the full date layout for 'en_AT'
func (en *en_AT) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_AT'
func (en *en_AT) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_AT'
func (en *en_AT) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_AT'
func (en *en_AT) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_AT'
func (en *en_AT) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_AT'
func (en *en_AT) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_AT'
func (en *en_AT) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_AT'
func (en *en_AT) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_AT) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_AT) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_AT) GetMiscPatterns() *locales.MiscPatterns {
