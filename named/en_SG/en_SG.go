...
// DateFullLayout returns the full date layout for 'en_SG'
func (en *en_SG) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_SG'
func (en *en_SG) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_SG'
func (en *en_SG) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_SG'
func (en *en_SG) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_SG'
func (en *en_SG) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_SG'
func (en *en_SG) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_SG'
func (en *en_SG) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_SG'
func (en *en_SG) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_SG) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_SG) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_SG) GetMiscPatterns() *locales.MiscPatterns {
