...
// DateFullLayout returns the full date layout for 'en_UG'
func (en *en_UG) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_UG'
func (en *en_UG) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_UG'
func (en *en_UG) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_UG'
func (en *en_UG) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_UG'
func (en *en_UG) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_UG'
func (en *en_UG) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_UG'
func (en *en_UG) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_UG'
func (en *en_UG) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_UG) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_UG) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_UG) GetMiscPatterns() *locales.MiscPatterns {
