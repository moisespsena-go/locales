...
// DateFullLayout returns the full date layout for 'en_NA'
func (en *en_NA) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_NA'
func (en *en_NA) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_NA'
func (en *en_NA) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_NA'
func (en *en_NA) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_NA'
func (en *en_NA) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_NA'
func (en *en_NA) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_NA'
func (en *en_NA) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_NA'
func (en *en_NA) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_NA) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_NA) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_NA) GetMiscPatterns() *locales.MiscPatterns {
