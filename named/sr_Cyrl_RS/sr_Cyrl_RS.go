...
// DateFullLayout returns the full date layout for 'sr_Cyrl_RS'
func (sr *sr_Cyrl_RS) DateFullLayout() string {
	return sr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sr_Cyrl_RS'
func (sr *sr_Cyrl_RS) DateLongLayout() string {
	return sr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sr_Cyrl_RS'
func (sr *sr_Cyrl_RS) DateMediumLayout() string {
	return sr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sr_Cyrl_RS'
func (sr *sr_Cyrl_RS) DateShortLayout() string {
	return sr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sr_Cyrl_RS'
func (sr *sr_Cyrl_RS) TimeFullLayout() string {
	return sr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sr_Cyrl_RS'
func (sr *sr_Cyrl_RS) TimeLongLayout() string {
	return sr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sr_Cyrl_RS'
func (sr *sr_Cyrl_RS) TimeMediumLayout() string {
	return sr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sr_Cyrl_RS'
func (sr *sr_Cyrl_RS) TimeShortLayout() string {
	return sr.timeShortLayout
}

func (sr *sr_Cyrl_RS) ListPatterns() *locales.ListPatterns {
	return sr.listPatterns
}

func (sr *sr_Cyrl_RS) GetDurationSpec() *locales.DurationSpec {
	return sr.DurationSpec
}

func (sr *sr_Cyrl_RS) GetMiscPatterns() *locales.MiscPatterns {
