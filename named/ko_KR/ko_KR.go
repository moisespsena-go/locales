...
// DateFullLayout returns the full date layout for 'ko_KR'
func (ko *ko_KR) DateFullLayout() string {
	return ko.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ko_KR'
func (ko *ko_KR) DateLongLayout() string {
	return ko.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ko_KR'
func (ko *ko_KR) DateMediumLayout() string {
	return ko.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ko_KR'
func (ko *ko_KR) DateShortLayout() string {
	return ko.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ko_KR'
func (ko *ko_KR) TimeFullLayout() string {
	return ko.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ko_KR'
func (ko *ko_KR) TimeLongLayout() string {
	return ko.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ko_KR'
func (ko *ko_KR) TimeMediumLayout() string {
	return ko.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ko_KR'
func (ko *ko_KR) TimeShortLayout() string {
	return ko.timeShortLayout
}

func (ko *ko_KR) ListPatterns() *locales.ListPatterns {
	return ko.listPatterns
}

func (ko *ko_KR) GetDurationSpec() *locales.DurationSpec {
	return ko.DurationSpec
}

func (ko *ko_KR) GetMiscPatterns() *locales.MiscPatterns {
