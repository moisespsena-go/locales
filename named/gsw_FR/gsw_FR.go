...
// DateFullLayout returns the full date layout for 'gsw_FR'
func (gsw *gsw_FR) DateFullLayout() string {
	return gsw.dateFullLayout
}

// DateLongLayout returns the long date layout for 'gsw_FR'
func (gsw *gsw_FR) DateLongLayout() string {
	return gsw.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'gsw_FR'
func (gsw *gsw_FR) DateMediumLayout() string {
	return gsw.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'gsw_FR'
func (gsw *gsw_FR) DateShortLayout() string {
	return gsw.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'gsw_FR'
func (gsw *gsw_FR) TimeFullLayout() string {
	return gsw.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'gsw_FR'
func (gsw *gsw_FR) TimeLongLayout() string {
	return gsw.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'gsw_FR'
func (gsw *gsw_FR) TimeMediumLayout() string {
	return gsw.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'gsw_FR'
func (gsw *gsw_FR) TimeShortLayout() string {
	return gsw.timeShortLayout
}

func (gsw *gsw_FR) ListPatterns() *locales.ListPatterns {
	return gsw.listPatterns
}

func (gsw *gsw_FR) GetDurationSpec() *locales.DurationSpec {
	return gsw.DurationSpec
}

func (gsw *gsw_FR) GetMiscPatterns() *locales.MiscPatterns {
