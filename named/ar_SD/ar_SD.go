...
// DateFullLayout returns the full date layout for 'ar_SD'
func (ar *ar_SD) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_SD'
func (ar *ar_SD) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_SD'
func (ar *ar_SD) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_SD'
func (ar *ar_SD) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_SD'
func (ar *ar_SD) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_SD'
func (ar *ar_SD) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_SD'
func (ar *ar_SD) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_SD'
func (ar *ar_SD) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_SD) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_SD) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_SD) GetMiscPatterns() *locales.MiscPatterns {
