...
// DateFullLayout returns the full date layout for 'jv_ID'
func (jv *jv_ID) DateFullLayout() string {
	return jv.dateFullLayout
}

// DateLongLayout returns the long date layout for 'jv_ID'
func (jv *jv_ID) DateLongLayout() string {
	return jv.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'jv_ID'
func (jv *jv_ID) DateMediumLayout() string {
	return jv.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'jv_ID'
func (jv *jv_ID) DateShortLayout() string {
	return jv.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'jv_ID'
func (jv *jv_ID) TimeFullLayout() string {
	return jv.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'jv_ID'
func (jv *jv_ID) TimeLongLayout() string {
	return jv.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'jv_ID'
func (jv *jv_ID) TimeMediumLayout() string {
	return jv.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'jv_ID'
func (jv *jv_ID) TimeShortLayout() string {
	return jv.timeShortLayout
}

func (jv *jv_ID) ListPatterns() *locales.ListPatterns {
	return jv.listPatterns
}

func (jv *jv_ID) GetDurationSpec() *locales.DurationSpec {
	return jv.DurationSpec
}

func (jv *jv_ID) GetMiscPatterns() *locales.MiscPatterns {
