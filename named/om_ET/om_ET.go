...
// DateFullLayout returns the full date layout for 'om_ET'
func (om *om_ET) DateFullLayout() string {
	return om.dateFullLayout
}

// DateLongLayout returns the long date layout for 'om_ET'
func (om *om_ET) DateLongLayout() string {
	return om.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'om_ET'
func (om *om_ET) DateMediumLayout() string {
	return om.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'om_ET'
func (om *om_ET) DateShortLayout() string {
	return om.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'om_ET'
func (om *om_ET) TimeFullLayout() string {
	return om.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'om_ET'
func (om *om_ET) TimeLongLayout() string {
	return om.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'om_ET'
func (om *om_ET) TimeMediumLayout() string {
	return om.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'om_ET'
func (om *om_ET) TimeShortLayout() string {
	return om.timeShortLayout
}

func (om *om_ET) ListPatterns() *locales.ListPatterns {
	return om.listPatterns
}

func (om *om_ET) GetDurationSpec() *locales.DurationSpec {
	return om.DurationSpec
}

func (om *om_ET) GetMiscPatterns() *locales.MiscPatterns {
