...
func New() locales.Translator {
	return &ki_KE{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "JEN", "WKR", "WGT", "WKN", "WTN", "WTD", "WMJ", "WNN", "WKD", "WIK", "WMW", "DIT"},
			MonthsNarrowValue:        []string{"", "J", "K", "G", "K", "G", "G", "M", "K", "K", "I", "I", "D"},
			MonthsWideValue:          []string{"", "Njenuarĩ", "Mwere wa kerĩ", "Mwere wa gatatũ", "Mwere wa kana", "Mwere wa gatano", "Mwere wa gatandatũ", "Mwere wa mũgwanja", "Mwere wa kanana", "Mwere wa kenda", "Mwere wa ikũmi", "Mwere wa ikũmi na ũmwe", "Ndithemba"},
			WeekdaysAbbreviatedValue: []string{"KMA", "NTT", "NMN", "NMT", "ART", "NMA", "NMM"},
			WeekdaysNarrowValue:      []string{"K", "N", "N", "N", "A", "N", "N"},
			WeekdaysWideValue:        []string{"Kiumia", "Njumatatũ", "Njumaine", "Njumatana", "Aramithi", "Njumaa", "Njumamothi"},
			PeriodsAbbreviatedValue:  []string{"Kiroko", "Hwaĩ-inĩ"},
			PeriodsWideValue:         []string{"Kiroko", "Hwaĩ-inĩ"},
...
func (ki *ki_KE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ki, ki.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ki_KE'
func (ki *ki_KE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ki, ki.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ki_KE'
func (ki *ki_KE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ki, ki.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ki_KE'
func (ki *ki_KE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ki, ki.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ki_KE'
func (ki *ki_KE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ki, ki.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ki_KE'
func (ki *ki_KE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ki, ki.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ki_KE'
func (ki *ki_KE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ki, ki.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ki_KE'
func (ki *ki_KE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ki, ki.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ki_KE'
func (ki *ki_KE) DateFullLayout() string {
	return ki.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ki_KE'
func (ki *ki_KE) DateLongLayout() string {
	return ki.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ki_KE'
func (ki *ki_KE) DateMediumLayout() string {
	return ki.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ki_KE'
func (ki *ki_KE) DateShortLayout() string {
	return ki.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ki_KE'
func (ki *ki_KE) TimeFullLayout() string {
	return ki.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ki_KE'
func (ki *ki_KE) TimeLongLayout() string {
	return ki.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ki_KE'
func (ki *ki_KE) TimeMediumLayout() string {
	return ki.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ki_KE'
func (ki *ki_KE) TimeShortLayout() string {
	return ki.timeShortLayout
}

func (ki *ki_KE) ListPatterns() *locales.ListPatterns {
	return ki.listPatterns
}

func (ki *ki_KE) GetDurationSpec() *locales.DurationSpec {
	return ki.DurationSpec
}

func (ki *ki_KE) GetMiscPatterns() *locales.MiscPatterns {
	return &ki.miscPatterns
}
