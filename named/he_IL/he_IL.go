...
// DateFullLayout returns the full date layout for 'he_IL'
func (he *he_IL) DateFullLayout() string {
	return he.dateFullLayout
}

// DateLongLayout returns the long date layout for 'he_IL'
func (he *he_IL) DateLongLayout() string {
	return he.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'he_IL'
func (he *he_IL) DateMediumLayout() string {
	return he.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'he_IL'
func (he *he_IL) DateShortLayout() string {
	return he.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'he_IL'
func (he *he_IL) TimeFullLayout() string {
	return he.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'he_IL'
func (he *he_IL) TimeLongLayout() string {
	return he.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'he_IL'
func (he *he_IL) TimeMediumLayout() string {
	return he.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'he_IL'
func (he *he_IL) TimeShortLayout() string {
	return he.timeShortLayout
}

func (he *he_IL) ListPatterns() *locales.ListPatterns {
	return he.listPatterns
}

func (he *he_IL) GetDurationSpec() *locales.DurationSpec {
	return he.DurationSpec
}

func (he *he_IL) GetMiscPatterns() *locales.MiscPatterns {
