...
// DateFullLayout returns the full date layout for 'es_UY'
func (es *es_UY) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_UY'
func (es *es_UY) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_UY'
func (es *es_UY) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_UY'
func (es *es_UY) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_UY'
func (es *es_UY) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_UY'
func (es *es_UY) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_UY'
func (es *es_UY) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_UY'
func (es *es_UY) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_UY) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_UY) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_UY) GetMiscPatterns() *locales.MiscPatterns {
