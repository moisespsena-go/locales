...
// DateFullLayout returns the full date layout for 'de_BE'
func (de *de_BE) DateFullLayout() string {
	return de.dateFullLayout
}

// DateLongLayout returns the long date layout for 'de_BE'
func (de *de_BE) DateLongLayout() string {
	return de.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'de_BE'
func (de *de_BE) DateMediumLayout() string {
	return de.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'de_BE'
func (de *de_BE) DateShortLayout() string {
	return de.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'de_BE'
func (de *de_BE) TimeFullLayout() string {
	return de.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'de_BE'
func (de *de_BE) TimeLongLayout() string {
	return de.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'de_BE'
func (de *de_BE) TimeMediumLayout() string {
	return de.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'de_BE'
func (de *de_BE) TimeShortLayout() string {
	return de.timeShortLayout
}

func (de *de_BE) ListPatterns() *locales.ListPatterns {
	return de.listPatterns
}

func (de *de_BE) GetDurationSpec() *locales.DurationSpec {
	return de.DurationSpec
}

func (de *de_BE) GetMiscPatterns() *locales.MiscPatterns {
