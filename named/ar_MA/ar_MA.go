...
func New() locales.Translator {
	return &ar_MA{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "أبريل", "ماي", "يوليوز", "غشت", "شتنبر", "نونبر", "دجنبر"},
			MonthsNarrowValue:        []string{"", "أ", "م", "ن", "ل", "ش", "ك", "ب", "د"},
			MonthsWideValue:          []string{"", "أبريل", "ماي", "يوليوز", "غشت", "شتنبر", "نونبر", "دجنبر"},
...
// DateFullLayout returns the full date layout for 'ar_MA'
func (ar *ar_MA) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_MA'
func (ar *ar_MA) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_MA'
func (ar *ar_MA) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_MA'
func (ar *ar_MA) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_MA'
func (ar *ar_MA) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_MA'
func (ar *ar_MA) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_MA'
func (ar *ar_MA) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_MA'
func (ar *ar_MA) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_MA) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_MA) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_MA) GetMiscPatterns() *locales.MiscPatterns {
