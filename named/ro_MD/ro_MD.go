...
func New() locales.Translator {
	return &ro_MD{
		...
		TimeSpec: &locales.TimeSpec{
			...
			WeekdaysNarrowValue:      []string{"D", "L", "Ma", "Mi", "J", "V", "S"},
			WeekdaysShortValue:       []string{"Du", "Lu", "Ma", "Mi", "Jo", "Vi", "Sâ"},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"", "%v an", "%v ani", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"lună", "%v lună", "%v luni", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v zi", "%v zile", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"min", "%v min.", "%v min.", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
...
// DateFullLayout returns the full date layout for 'ro_MD'
func (ro *ro_MD) DateFullLayout() string {
	return ro.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ro_MD'
func (ro *ro_MD) DateLongLayout() string {
	return ro.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ro_MD'
func (ro *ro_MD) DateMediumLayout() string {
	return ro.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ro_MD'
func (ro *ro_MD) DateShortLayout() string {
	return ro.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ro_MD'
func (ro *ro_MD) TimeFullLayout() string {
	return ro.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ro_MD'
func (ro *ro_MD) TimeLongLayout() string {
	return ro.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ro_MD'
func (ro *ro_MD) TimeMediumLayout() string {
	return ro.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ro_MD'
func (ro *ro_MD) TimeShortLayout() string {
	return ro.timeShortLayout
}

func (ro *ro_MD) ListPatterns() *locales.ListPatterns {
	return ro.listPatterns
}

func (ro *ro_MD) GetDurationSpec() *locales.DurationSpec {
	return ro.DurationSpec
}

func (ro *ro_MD) GetMiscPatterns() *locales.MiscPatterns {
