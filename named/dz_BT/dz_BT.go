...
func New() locales.Translator {
	return &dz_BT{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "༡", "༢", "༣", "༤", "༥", "༦", "༧", "༨", "༩", "༡༠", "༡༡", "12"},
			MonthsNarrowValue:        []string{"", "༡", "༢", "༣", "4", "༥", "༦", "༧", "༨", "9", "༡༠", "༡༡", "༡༢"},
			MonthsWideValue:          []string{"", "ཟླ་དངཔ་", "ཟླ་གཉིས་པ་", "ཟླ་གསུམ་པ་", "ཟླ་བཞི་པ་", "ཟླ་ལྔ་པ་", "ཟླ་དྲུག་པ", "ཟླ་བདུན་པ་", "ཟླ་བརྒྱད་པ་", "ཟླ་དགུ་པ་", "ཟླ་བཅུ་པ་", "ཟླ་བཅུ་གཅིག་པ་", "ཟླ་བཅུ་གཉིས་པ་"},
			WeekdaysAbbreviatedValue: []string{"ཟླ་", "མིར་", "ལྷག་", "ཕུར་", "སངས་", "སྤེན་", "ཉི་"},
			WeekdaysNarrowValue:      []string{"ཟླ", "མིར", "ལྷག", "ཕུར", "སངྶ", "སྤེན", "ཉི"},
			WeekdaysShortValue:       []string{"ཟླ་", "མིར་", "ལྷག་", "ཕུར་", "སངས་", "སྤེན་", "ཉི་"},
			WeekdaysWideValue:        []string{"གཟའ་ཟླ་བ་", "གཟའ་མིག་དམར་", "གཟའ་ལྷག་པ་", "གཟའ་ཕུར་བུ་", "གཟའ་པ་སངས་", "གཟའ་སྤེན་པ་", "གཟའ་ཉི་མ་"},
			PeriodsAbbreviatedValue:  []string{"སྔ་ཆ་", "ཕྱི་ཆ་"},
			PeriodsNarrowValue:       []string{"སྔ་ཆ་", "ཕྱི་ཆ་"},
			PeriodsWideValue:         []string{"སྔ་ཆ་", "ཕྱི་ཆ་"},
			ErasAbbreviatedValue:     []string{"BCE", "CE"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"", ""},
			TimezonesValue:           map[string]string{"": "ཕལཀ་ལེནཌ་ཨཱའི་ལེནཌས་ཚད་ལྡན་ཆུ་ཚོད", "ACDT": "དབུས་ཕྱོགས་ཨཱོས་ཊྲེལ་ལི་ཡ་ཉིན་སྲུང་ཆུ་ཚོད", "ACST": "ACST", "ACT": "ACT", "ACWDT": "དབུས་ནུབ་ཕྱོགས་ཨཱོས་ཊྲེལ་ལི་ཡ་ཉིན་སྲུང་ཆུ་ཚོད", "ACWST": "དབུས་ནུབ་ཕྱོགས་ཨཱོས་ཊྲེལ་ལི་ཡ་ཚད་ལྡན་ཆུ་ཚོད", "ADT": "ཨེཊ་ལེན་ཊིཀ་ཉིན་སྲུང་ཆུ་ཚོད", "AEDT": "ཤར་ཕྱོགས་ཕྱོགས་ཨཱོས་ཊྲེལ་ལི་ཡ་ཉིན་སྲུང་ཆུ་ཚོད", "AEST": "ཤར་ཕྱོགས་ཕྱོགས་ཨཱོས་ཊྲེལ་ལི་ཡ་ཚད་ལྡན་ཆུ་ཚོད", "AFT": "ཨཕ་ག་ནི་ས྄ཏཱནཆུ་ཚོད", "AKDT": "ཨ་ལསི་ཀ་ཉིན་སྲུང་ཆུ་ཚོད", "AKST": "ཨ་ལསི་ཀ་ཚད་ལྡན་ཆུ་ཚོད", "AMST": "ཨེ་མ་ཛཱོན་བྱཱར་དུས་ཆུ་ཚོད", "AMT": "ཨེ་མ་ཛཱོན་ཚད་ལྡན་ཆུ་ཚོད", "ARST": "ཨར་ཇེན་ཊི་ན་བྱཱར་དུས་ཆུ་ཚོད", "ART": "ཨར་ཇེན་ཊི་ན་ཚད་ལྡན་ཆུ་ཚོད", "AST": "ཨེཊ་ལེན་ཊིཀ་ཚད་ལྡན་ཆུ་ཚོད", "AWDT": "ནུབ་ཕྱོགས་ཨཱོས་ཊྲེལ་ལི་ཡ་ཉིན་སྲུང་ཆུ་ཚོད", "AWST": "ནུབ་ཕྱོགས་ཨཱོས་ཊྲེལ་ལི་ཡ་ཚད་ལྡན་ཆུ་ཚོད", "BNT": "BNT", "BOT": "བྷོ་ལི་བི་ཡ་ཆུ་ཚོད", "BRST": "བྲ་ཛི་ལི་ཡ་བྱཱར་དུས་ཆུ་ཚོད", "BRT": "བྲ་ཛི་ལི་ཡ་ཚད་ལྡན་ཆུ་ཚོད", "BST": "བངྒ་ལ་དེཤ་བྱཱར་དུས་ཆུ་ཚོད", "BTT": "འབྲུག་ཡུལ་ཆུ་ཚོད", "CAT": "དབུས་ཕྱོགས་ཨཕ་རི་ཀཱ་ཆུ་ཚོད", "CCT": "CCT", "CDT": "བྱང་ཨ་མི་རི་ཀ་དབུས་ཕྱོགས་ཉིན་སྲུང་ཆུ་ཚོད", "CDT (Kuba)": "ཀིའུ་བྷ་ཉིན་སྲུང་ཆུ་ཚོད", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "ཅི་ལི་བྱཱར་དུས་ཆུ་ཚོད", "CLT": "ཅི་ལི་ཚད་ལྡན་ཆུ་ཚོད", "COST": "ཀོ་ལོམ་བྷི་ཡ་བྱཱར་དུས་ཆུ་ཚོད", "COT": "ཀོ་ལོམ་བྷི་ཡ་ཚད་ལྡན་ཆུ་ཚོད", "CST": "བྱང་ཨ་མི་རི་ཀ་དབུས་ཕྱོགས་ཚད་ལྡན་ཆུ་ཚོད", "CST (Kuba)": "ཀིའུ་བྷ་ཚད་ལྡན་ཆུ་ཚོད", "CXT": "ཁི་རིསྟ་མེས་མཚོ་གླིང་ཆུ་ཚོད", "ChST": "ChST", "EASST": "ཨིསི་ཊར་ཨཱའི་ལེནཌ་བྱཱར་དུས་ཆུ་ཚོད", "EAST": "ཨིསི་ཊར་ཨཱའི་ལེནཌ་ཚད་ལྡན་ཆུ་ཚོད", "EAT": "ཤར་ཕྱོགས་ཨཕ་རི་ཀཱ་ཆུ་ཚོད", "ECT": "ཨེ་ཀུ་ཌཽ་ཆུ་ཚོད", "EDT": "བྱང་ཨ་མི་རི་ཀ་ཤར་ཕྱོགས་ཉིན་སྲུང་ཆུ་ཚོད", "EGDT": "ཤར་ཕྱོགས་གིརིན་ལེནཌ་བྱཱར་དུས་ཆུ་ཚོད", "EGST": "ཤར་ཕྱོགས་གིརིན་ལེནཌ་ཚད་ལྡན་ཆུ་ཚོད", "EST": "བྱང་ཨ་མི་རི་ཀ་ཤར་ཕྱོགས་ཚད་ལྡན་ཆུ་ཚོད", "FKST": "ཕལཀ་ལེནཌ་ཨཱའི་ལེནཌས་བྱཱར་དུས་ཆུ་ཚོད", "GALT": "ག་ལ་པ་གོསི་ཆུ་ཚོད", "GFT": "ཕིརེནཅ་གི་ཡ་ན་ཆུ་ཚོད", "GMT": "གིརིན་ཝིཆ་ལུ་ཡོད་པའི་ཆུ་ཚོད", "GST": "གཱལཕི་ཆུ་ཚོད", "GYT": "གུ་ཡ་ན་ཆུ་ཚོད", "HADT": "ཧ་ཝའི་-ཨེ་ལིའུ་ཤེན་ཉིན་སྲུང་ཆུ་ཚོད", "HAST": "ཧ་ཝའི་-ཨེ་ལིའུ་ཤེན་ཚད་ལྡན་ཆུ་ཚོད", "HENOMX": "HENOMX", "HEOG": "ནུབ་ཕྱོགས་གིརིན་ལེནཌ་བྱཱར་དུས་ཆུ་ཚོད", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "ནུབ་ཕྱོགས་གིརིན་ལེནཌ་ཚད་ལྡན་ཆུ་ཚོད", "HNPMX": "HNPMX", "ICT": "ཨིན་ཌོ་ཅཱའི་ན་ཆུ་ཚོད", "IRDT": "ཨི་རཱན་ཉིན་སྲུང་ཆུ་ཚོད", "IRST": "ཨི་རཱན་ཚད་ལྡན་ཆུ་ཚོད", "IST": "རྒྱ་གར་ཆུ་ཚོད", "JDT": "ཇ་པཱན་ཉིན་སྲུང་ཆུ་ཚོད", "JST": "ཇ་པཱན་ཚད་ལྡན་ཆུ་ཚོད", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "དབུས་ཕྱོགས་ཡུ་རོ་པེན་བྱཱར་དུས་ཆུ་ཚོད", "MEZ": "དབུས་ཕྱོགས་ཡུ་རོ་པེན་ཚད་ལྡན་ཆུ་ཚོད", "MST": "MST", "MVT": "མཱལ་དིབས་ཆུ་ཚོད", "MYT": "MYT", "NDT": "ནིའུ་ཕའུནཌ་ལེནཌ་ཉིན་སྲུང་ཆུ་ཚོད", "NPT": "ནེ་པཱལ་ཆུ་ཚོད", "NST": "ནིའུ་ཕའུནཌ་ལེནཌ་ཚད་ལྡན་ཆུ་ཚོད", "NZDT": "ནིའུ་ཛི་ལེནཌ་ཉིན་སྲུང་ཆུ་ཚོད", "NZST": "ནིའུ་ཛི་ལེནཌ་ཚད་ལྡན་ཆུ་ཚོད", "OESZ": "ཤར་ཕྱོགས་ཡུ་རོ་པེན་བྱཱར་དུས་ཆུ་ཚོད", "OEZ": "ཤར་ཕྱོགས་ཡུ་རོ་པེན་ཚད་ལྡན་ཆུ་ཚོད", "PDT": "བྱང་ཨ་མི་རི་ཀ་པེ་སི་ཕིག་ཉིན་སྲུང་ཆུ་ཚོད", "PKT": "པ་ཀི་ས྄ཏཱན་བྱཱར་དུས་ཆུ་ཚོད", "PMDT": "པའི་རི་དང་མི་ཀི་ལཱོན་ཉིན་སྲུང་ཆུ་ཚོད", "PMST": "པའི་རི་དང་མི་ཀི་ལཱོན་ཚད་ལྡན་ཆུ་ཚོད", "PST": "བྱང་ཨ་མི་རི་ཀ་པེ་སི་ཕིག་ཚད་ལྡན་ཆུ་ཚོད", "PYST": "པ་ར་གུ་ཝའི་བྱཱར་དུས་ཆུ་ཚོད", "SAST": "ལྷོ་ཕྱོགས་ཨཕ་རི་ཀཱ་ཆུ་ཚོད", "SGT": "SGT", "SRT": "སུ་རི་ནཱམ་ཆུ་ཚོད", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "ཡུ་རུ་གུ་ཝཱའི་བྱཱར་དུས་ཆུ་ཚོད", "UYT": "ཡུ་རུ་གུ་ཝཱའི་ཚད་ལྡན་ཆུ་ཚོད", "VET": "བེ་ནི་ཛུ་ཝེ་ལ་ཆུ་ཚོད", "WARST": "ནུབ་ཕྱོགས་ཨར་ཇེན་ཊི་ན་བྱཱར་དུས་ཆུ་ཚོད", "WART": "ནུབ་ཕྱོགས་ཨར་ཇེན་ཊི་ན་ཚད་ལྡན་ཆུ་ཚོད", "WAST": "ནུབ་ཕྱོགས་ཨཕ་རི་ཀཱ་བྱཱར་དུས་ཆུ་ཚོད", "WAT": "ནུབ་ཕྱོགས་ཨཕ་རི་ཀཱ་ཚད་ལྡན་ཆུ་ཚོད", "WESZ": "ནུབ་ཕྱོགས་ཡུ་རོ་པེན་བྱཱར་དུས་ཆུ་ཚོད", "WEZ": "ནུབ་ཕྱོགས་ཡུ་རོ་པེན་ཚད་ལྡན་ཆུ་ཚོད", "WIB": "ནུབ་ཕྱོགས་ཨིན་ཌོ་ནེ་ཤི་ཡ་ཆུ་ཚོད", "WIT": "ཤར་ཕྱོགས་ཨིན་ཌོ་ནེ་ཤི་ཡ་ཆུ་ཚོད", "WITA": "དབུས་ཕྱོགས་ཨིན་ཌོ་ནེ་ཤི་ཡ་ཆུ་ཚོད", "∅∅∅": "པ་རུ་བྱཱར་དུས་ཆུ་ཚོད"},
		},
		...
		dateFullLayout:   "EEEE, སྤྱི་ལོ་y MMMM ཚེས་dd",
		dateLongLayout:   "སྤྱི་ལོ་y MMMM ཚེས་ dd",
		dateMediumLayout: "སྤྱི་ལོ་y ཟླ་MMM ཚེས་dd",
		dateShortLayout:  "y-MM-dd",
		timeFullLayout:   "ཆུ་ཚོད་ h སྐར་མ་ mm:ss a zzzz",
		timeLongLayout:   "ཆུ་ཚོད་ h སྐར་མ་ mm:ss a z",
		timeMediumLayout: "ཆུ་ཚོད་h:mm:ss a",
		timeShortLayout:  "ཆུ་ཚོད་ h སྐར་མ་ mm a",
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} དང་ {1}", "{0} དང་ {1}", "{0} དང་ {1}", "{0} དང་ {1}"}, []string(nil)}),
		miscPatterns: locales.MiscPatterns{
			"",
			"",
			"",
...
func (dz *dz_BT) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(dz, dz.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'dz_BT'
func (dz *dz_BT) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(dz, dz.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'dz_BT'
func (dz *dz_BT) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(dz, dz.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'dz_BT'
func (dz *dz_BT) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(dz, dz.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'dz_BT'
func (dz *dz_BT) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(dz, dz.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'dz_BT'
func (dz *dz_BT) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(dz, dz.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'dz_BT'
func (dz *dz_BT) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(dz, dz.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'dz_BT'
func (dz *dz_BT) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(dz, dz.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'dz_BT'
func (dz *dz_BT) DateFullLayout() string {
	return dz.dateFullLayout
}

// DateLongLayout returns the long date layout for 'dz_BT'
func (dz *dz_BT) DateLongLayout() string {
	return dz.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'dz_BT'
func (dz *dz_BT) DateMediumLayout() string {
	return dz.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'dz_BT'
func (dz *dz_BT) DateShortLayout() string {
	return dz.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'dz_BT'
func (dz *dz_BT) TimeFullLayout() string {
	return dz.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'dz_BT'
func (dz *dz_BT) TimeLongLayout() string {
	return dz.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'dz_BT'
func (dz *dz_BT) TimeMediumLayout() string {
	return dz.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'dz_BT'
func (dz *dz_BT) TimeShortLayout() string {
	return dz.timeShortLayout
}

func (dz *dz_BT) ListPatterns() *locales.ListPatterns {
	return dz.listPatterns
}

func (dz *dz_BT) GetDurationSpec() *locales.DurationSpec {
	return dz.DurationSpec
}

func (dz *dz_BT) GetMiscPatterns() *locales.MiscPatterns {
	return &dz.miscPatterns
}
