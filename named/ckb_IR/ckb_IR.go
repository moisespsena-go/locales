...
func New() locales.Translator {
	return &ckb_IR{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "کانوونی دووەم", "شوبات", "ئازار", "نیسان", "ئایار", "حوزەیران", "تەمووز", "ئاب", "ئەیلوول", "تشرینی یەکەم", "تشرینی دووەم", "کانونی یەکەم"},
			MonthsNarrowValue:        []string{"", "ک", "ش", "ئ", "ن", "ئ", "ح", "ت", "ئ", "ئ", "ت", "ت", "ک"},
			MonthsWideValue:          []string{"", "کانوونی دووەم", "شوبات", "ئازار", "نیسان", "ئایار", "حوزەیران", "تەمووز", "ئاب", "ئەیلوول", "تشرینی یەکەم", "تشرینی دووەم", "کانونی یەکەم"},
			WeekdaysAbbreviatedValue: []string{"یەکشەممە", "دووشەممە", "سێشەممە", "چوارشەممە", "پێنجشەممە", "ھەینی", "شەممە"},
			WeekdaysNarrowValue:      []string{"ی", "د", "س", "چ", "پ", "ھ", "ش"},
			WeekdaysShortValue:       []string{"١ش", "٢ش", "٣ش", "٤ش", "٥ش", "ھ", "ش"},
			WeekdaysWideValue:        []string{"یەکشەممە", "دووشەممە", "سێشەممە", "چوارشەممە", "پێنجشەممە", "ھەینی", "شەممە"},
			PeriodsAbbreviatedValue:  []string{"ب.ن", "د.ن"},
			PeriodsNarrowValue:       []string{"ب.ن", "د.ن"},
			PeriodsWideValue:         []string{"ب.ن", "د.ن"},
			ErasAbbreviatedValue:     []string{"پێش زایین", "زایینی"},
			ErasNarrowValue:          []string{"پ.ن", "ز"},
			ErasWideValue:            []string{"پێش زایین", "زایینی"},
...
func (ckb *ckb_IR) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ckb, ckb.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ckb_IR'
func (ckb *ckb_IR) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ckb, ckb.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ckb_IR'
func (ckb *ckb_IR) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ckb, ckb.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ckb_IR'
func (ckb *ckb_IR) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ckb, ckb.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ckb_IR'
func (ckb *ckb_IR) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ckb, ckb.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ckb_IR'
func (ckb *ckb_IR) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ckb, ckb.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ckb_IR'
func (ckb *ckb_IR) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ckb, ckb.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ckb_IR'
func (ckb *ckb_IR) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ckb, ckb.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ckb_IR'
func (ckb *ckb_IR) DateFullLayout() string {
	return ckb.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ckb_IR'
func (ckb *ckb_IR) DateLongLayout() string {
	return ckb.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ckb_IR'
func (ckb *ckb_IR) DateMediumLayout() string {
	return ckb.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ckb_IR'
func (ckb *ckb_IR) DateShortLayout() string {
	return ckb.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ckb_IR'
func (ckb *ckb_IR) TimeFullLayout() string {
	return ckb.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ckb_IR'
func (ckb *ckb_IR) TimeLongLayout() string {
	return ckb.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ckb_IR'
func (ckb *ckb_IR) TimeMediumLayout() string {
	return ckb.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ckb_IR'
func (ckb *ckb_IR) TimeShortLayout() string {
	return ckb.timeShortLayout
}

func (ckb *ckb_IR) ListPatterns() *locales.ListPatterns {
	return ckb.listPatterns
}

func (ckb *ckb_IR) GetDurationSpec() *locales.DurationSpec {
	return ckb.DurationSpec
}

func (ckb *ckb_IR) GetMiscPatterns() *locales.MiscPatterns {
	return &ckb.miscPatterns
}
