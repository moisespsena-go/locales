...
func New() locales.Translator {
	return &se_FI{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 dt ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 dt ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 dt ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 dt ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 dt ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 dt ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "cuoŋ"},
			MonthsNarrowValue:        []string{"", "O", "G", "N", "C", "M", "G", "S", "B", "Č", "G", "S", "J"},
			MonthsWideValue:          []string{"", "ođđajagemánnu", "guovvamánnu", "njukčamánnu", "cuoŋománnu", "miessemánnu", "geassemánnu", "suoidnemánnu", "borgemánnu", "čakčamánnu", "golggotmánnu", "skábmamánnu", "juovlamánnu"},
			WeekdaysAbbreviatedValue: []string{"so", "má", "di", "ga", "du", "be", "lá"},
			WeekdaysNarrowValue:      []string{"M", "D"},
			WeekdaysShortValue:       []string{"so", "má", "di", "ga", "du", "be", "lá"},
			WeekdaysWideValue:        []string{"mánnodat", "disdat", "gaskavahkku", "duorastat", "bearjadat", "lávvordat"},
			PeriodsAbbreviatedValue:  []string{"ib", "eb"},
			PeriodsNarrowValue:       []string{"i", "e"},
			PeriodsWideValue:         []string{"ib", "eb"},
			ErasAbbreviatedValue:     []string{"oKr.", "mKr."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"ovdal Kristusa", "maŋŋel Kristusa"},
			TimezonesValue:           map[string]string{"": "Falklandsulluid dálveáigi", "ACDT": "Gaska-Austrália geasseáigi", "ACST": "Gaska-Austrália dálveáigi", "ACT": "ACT", "ACWDT": "Gaska-Austrália oarjjabeali geasseáigi", "ACWST": "Gaska-Austrália oarjjabeali dálveáigi", "ADT": "atlántalaš geasseáigi", "AEDT": "Nuorta-Austrália geasseáigi", "AEST": "Nuorta-Austrália dálveáigi", "AFT": "Afganisthana áigi", "AKDT": "Alaska geasseáigi", "AKST": "Alaska dálveáigi", "AMST": "Amazona geasseáigi", "AMT": "Amazona dálveáigi", "ARST": "Argentina geasseáigi", "ART": "Argentina dálveáigi", "AST": "atlántalaš dálveáigi", "AWDT": "Oarje-Austrália geasseáigi", "AWST": "Oarje-Austrália dálveáigi", "BNT": "Brunei Darussalama áigi", "BOT": "Bolivia áigi", "BRST": "Brasilia geasseáigi", "BRT": "Brasilia dálveáigi", "BST": "Bangladesha geasseáigi", "BTT": "Bhutana áigi", "CAT": "Gaska-Afrihká áigi", "CCT": "Kokossulloid áigi", "CDT": "dábálaš geasseáigi", "CDT (Kuba)": "Cuba geasseáigi", "CHADT": "Chathama geasseáigi", "CHAST": "Chathama dálveáigi", "CLST": "Chile geasseáigi", "CLT": "Chile dálveáigi", "COST": "Colombia geasseáigi", "COT": "Colombia dálveáigi", "CST": "dábálaš dálveáigi", "CST (Kuba)": "Cuba dálveáigi", "CXT": "Juovlasullo áigi", "ChST": "Čamorro dálveáigi", "EASST": "Beassášsullo geasseáigi", "EAST": "Beassášsullo dálveáigi", "EAT": "Nuorta-Afrihká áigi", "ECT": "Ecuadora áigi", "EDT": "geasseáigi nuortan", "EGDT": "Nuorta-Ruonáeatnama geasseáigi", "EGST": "Nuorta-Ruonáeatnama dálveáigi", "EST": "dálveáigi nuortan", "FKST": "Falklandsulluid geasseáigi", "GALT": "Galapagosa áigi", "GFT": "Frankriikka Guyana áigi", "GMT": "Greenwicha áigi", "GST": "Golfa dálveáigi", "GYT": "Guyana áigi", "HADT": "Hawaii-aleuhtalaš geasseáigi", "HAST": "Hawaii-aleuhtalaš dálveáigi", "HENOMX": "Oarjedavvi-Meksiko geasseáigi", "HEOG": "Oarje-Ruonáeatnama geasseáigi", "HEPMX": "Meksiko Jáskesábi geasseáigi", "HKST": "Hong Konga geasseáigi", "HKT": "Hong Konga dálveáigi", "HNNOMX": "Oarjedavvi-Meksiko dálveáigi", "HNOG": "Oarje-Ruonáeatnama dálveáigi", "HNPMX": "Meksiko Jáskesábi dálveáigi", "ICT": "Indokiinná áigi", "IRDT": "Irana geasseáigi", "IRST": "Irana dálveáigi", "IST": "India dálveáigi", "JDT": "Japána geasseáigi", "JST": "Japána dálveáigi", "LHDT": "Lord Howe geasseáigi", "LHST": "Lord Howe dálveáigi", "MDT": "MDT", "MESZ": "Gaska-Eurohpá geasseáigi", "MEZ": "Gaska-Eurohpá dálveáigi", "MST": "MST", "MVT": "Malediivvaid áigi", "MYT": "Malesia áigi", "NDT": "Newfoundlanda geasseáigi", "NPT": "Nepala áigi", "NST": "Newfoundlanda dálveáigi", "NZDT": "Ođđa-Selánda geasseáigi", "NZST": "Ođđa-Selánda dálveáigi", "OESZ": "Nuorta-Eurohpa geasseáigi", "OEZ": "Nuorta-Eurohpa dálveáigi", "PDT": "Jaskesábi geasseáigi", "PKT": "Pakistana geasseáigi", "PMDT": "St. Pierre & Miquelo geasseáigi", "PMST": "St. Pierre & Miquelo dálveáigi", "PST": "Jaskesábi dálveáigi", "PYST": "Paraguaya geasseáigi", "SAST": "Lulli-Afrihká dálveáigi", "SGT": "Singapore dálveáigi", "SRT": "Suriname áigi", "TLT": "Nuorta-Timora áigi", "TMST": "Turkmenistana geasseáigi", "TMT": "Turkmenistana dálveáigi", "UYST": "Uruguaya geasseáigi", "UYT": "Uruguaya dálveáigi", "VET": "Venezuela áigi", "WARST": "Oarje-Argentina geasseáigi", "WART": "Oarje-Argentina dálveáigi", "WAST": "Oarje-Afrihká geasseáigi", "WAT": "Oarje-Afrihká dálveáigi", "WESZ": "Oarje-Eurohpá geasseáigi", "WEZ": "Oarje-Eurohpá dálveáigi", "WIB": "Oarje-Indonesia áigi", "WIT": "Nuorta-Indonesia áigi", "WITA": "Gaska-Indonesia áigi", "∅∅∅": "Peru geasseáigi"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} ja {1}", "{0}, {1}", "{0}, {1}", "{0} ja {1}"}, []string(nil)}),
		miscPatterns: locales.MiscPatterns{
			"",
			"≥%[1]v",
			"",
...
func (se *se_FI) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(se, se.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'se_FI'
func (se *se_FI) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(se, se.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'se_FI'
func (se *se_FI) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(se, se.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'se_FI'
func (se *se_FI) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(se, se.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'se_FI'
func (se *se_FI) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(se, se.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'se_FI'
func (se *se_FI) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(se, se.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'se_FI'
func (se *se_FI) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(se, se.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'se_FI'
func (se *se_FI) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(se, se.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'se_FI'
func (se *se_FI) DateFullLayout() string {
	return se.dateFullLayout
}

// DateLongLayout returns the long date layout for 'se_FI'
func (se *se_FI) DateLongLayout() string {
	return se.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'se_FI'
func (se *se_FI) DateMediumLayout() string {
	return se.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'se_FI'
func (se *se_FI) DateShortLayout() string {
	return se.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'se_FI'
func (se *se_FI) TimeFullLayout() string {
	return se.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'se_FI'
func (se *se_FI) TimeLongLayout() string {
	return se.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'se_FI'
func (se *se_FI) TimeMediumLayout() string {
	return se.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'se_FI'
func (se *se_FI) TimeShortLayout() string {
	return se.timeShortLayout
}

func (se *se_FI) ListPatterns() *locales.ListPatterns {
	return se.listPatterns
}

func (se *se_FI) GetDurationSpec() *locales.DurationSpec {
	return se.DurationSpec
}

func (se *se_FI) GetMiscPatterns() *locales.MiscPatterns {
	return &se.miscPatterns
}
