...
// DateFullLayout returns the full date layout for 'en_IM'
func (en *en_IM) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_IM'
func (en *en_IM) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_IM'
func (en *en_IM) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_IM'
func (en *en_IM) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_IM'
func (en *en_IM) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_IM'
func (en *en_IM) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_IM'
func (en *en_IM) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_IM'
func (en *en_IM) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_IM) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_IM) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_IM) GetMiscPatterns() *locales.MiscPatterns {
