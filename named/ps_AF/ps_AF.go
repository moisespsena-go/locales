...
// DateFullLayout returns the full date layout for 'ps_AF'
func (ps *ps_AF) DateFullLayout() string {
	return ps.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ps_AF'
func (ps *ps_AF) DateLongLayout() string {
	return ps.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ps_AF'
func (ps *ps_AF) DateMediumLayout() string {
	return ps.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ps_AF'
func (ps *ps_AF) DateShortLayout() string {
	return ps.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ps_AF'
func (ps *ps_AF) TimeFullLayout() string {
	return ps.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ps_AF'
func (ps *ps_AF) TimeLongLayout() string {
	return ps.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ps_AF'
func (ps *ps_AF) TimeMediumLayout() string {
	return ps.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ps_AF'
func (ps *ps_AF) TimeShortLayout() string {
	return ps.timeShortLayout
}

func (ps *ps_AF) ListPatterns() *locales.ListPatterns {
	return ps.listPatterns
}

func (ps *ps_AF) GetDurationSpec() *locales.DurationSpec {
	return ps.DurationSpec
}

func (ps *ps_AF) GetMiscPatterns() *locales.MiscPatterns {
