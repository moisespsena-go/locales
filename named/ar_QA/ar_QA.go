...
// DateFullLayout returns the full date layout for 'ar_QA'
func (ar *ar_QA) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_QA'
func (ar *ar_QA) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_QA'
func (ar *ar_QA) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_QA'
func (ar *ar_QA) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_QA'
func (ar *ar_QA) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_QA'
func (ar *ar_QA) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_QA'
func (ar *ar_QA) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_QA'
func (ar *ar_QA) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_QA) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_QA) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_QA) GetMiscPatterns() *locales.MiscPatterns {
