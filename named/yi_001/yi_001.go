...
func New() locales.Translator {
	return &yi_001{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "יאַנואַר", "פֿעברואַר", "מערץ", "אַפּריל", "מיי", "יוני", "יולי", "אויגוסט", "סעפּטעמבער", "אקטאבער", "נאוועמבער", "דעצעמבער"},
			MonthsWideValue:          []string{"", "יאַנואַר", "פֿעברואַר", "מערץ", "אַפּריל", "מיי", "יוני", "יולי", "אויגוסט", "סעפּטעמבער", "אקטאבער", "נאוועמבער", "דעצעמבער"},
			WeekdaysAbbreviatedValue: []string{"זונטיק", "מאָנטיק", "דינסטיק", "מיטוואך", "דאנערשטיק", "פֿרײַטיק", "שבת"},
			WeekdaysShortValue:       []string{"זונטיק", "מאָנטיק", "דינסטיק", "מיטוואך", "דאנערשטיק", "פֿרײַטיק", "שבת"},
			WeekdaysWideValue:        []string{"זונטיק", "מאָנטיק", "דינסטיק", "מיטוואך", "דאנערשטיק", "פֿרײַטיק", "שבת"},
			PeriodsAbbreviatedValue:  []string{"פֿאַרמיטאָג", "נאָכמיטאָג"},
			PeriodsWideValue:         []string{"פֿאַרמיטאָג", "נאָכמיטאָג"},
		...
		dateFullLayout:   "EEEE, dטן MMMM y",
		dateLongLayout:   "dטן MMMM y",
		dateMediumLayout: "dטן MMM y",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} און {1}", "{0}, {1}", "{0}, {1}", "{0} און {1}"}, []string(nil)}),
		miscPatterns: locales.MiscPatterns{
			"",
			"",
			"",
...
func (yi *yi_001) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(yi, yi.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'yi_001'
func (yi *yi_001) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(yi, yi.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'yi_001'
func (yi *yi_001) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(yi, yi.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'yi_001'
func (yi *yi_001) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(yi, yi.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'yi_001'
func (yi *yi_001) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(yi, yi.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'yi_001'
func (yi *yi_001) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(yi, yi.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'yi_001'
func (yi *yi_001) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(yi, yi.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'yi_001'
func (yi *yi_001) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(yi, yi.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'yi_001'
func (yi *yi_001) DateFullLayout() string {
	return yi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'yi_001'
func (yi *yi_001) DateLongLayout() string {
	return yi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'yi_001'
func (yi *yi_001) DateMediumLayout() string {
	return yi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'yi_001'
func (yi *yi_001) DateShortLayout() string {
	return yi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'yi_001'
func (yi *yi_001) TimeFullLayout() string {
	return yi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'yi_001'
func (yi *yi_001) TimeLongLayout() string {
	return yi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'yi_001'
func (yi *yi_001) TimeMediumLayout() string {
	return yi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'yi_001'
func (yi *yi_001) TimeShortLayout() string {
	return yi.timeShortLayout
}

func (yi *yi_001) ListPatterns() *locales.ListPatterns {
	return yi.listPatterns
}

func (yi *yi_001) GetDurationSpec() *locales.DurationSpec {
	return yi.DurationSpec
}

func (yi *yi_001) GetMiscPatterns() *locales.MiscPatterns {
	return &yi.miscPatterns
}
