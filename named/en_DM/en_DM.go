...
// DateFullLayout returns the full date layout for 'en_DM'
func (en *en_DM) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_DM'
func (en *en_DM) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_DM'
func (en *en_DM) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_DM'
func (en *en_DM) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_DM'
func (en *en_DM) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_DM'
func (en *en_DM) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_DM'
func (en *en_DM) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_DM'
func (en *en_DM) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_DM) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_DM) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_DM) GetMiscPatterns() *locales.MiscPatterns {
