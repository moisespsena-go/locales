...
// DateFullLayout returns the full date layout for 'en_SS'
func (en *en_SS) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_SS'
func (en *en_SS) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_SS'
func (en *en_SS) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_SS'
func (en *en_SS) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_SS'
func (en *en_SS) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_SS'
func (en *en_SS) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_SS'
func (en *en_SS) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_SS'
func (en *en_SS) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_SS) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_SS) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_SS) GetMiscPatterns() *locales.MiscPatterns {
