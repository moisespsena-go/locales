...
func New() locales.Translator {
	return &sr{
		...
		TimeSpec: &locales.TimeSpec{
			...
			WeekdaysAbbreviatedValue: []string{"нед", "пон", "уто", "сре", "чет", "пет", "суб"},
			WeekdaysNarrowValue:      []string{"н", "п", "у", "с", "ч", "п", "с"},
			WeekdaysShortValue:       []string{"не", "по", "ут", "ср", "че", "пе", "су"},
			WeekdaysWideValue:        []string{"недеља", "понедељак", "уторак", "среда", "четвртак", "петак", "субота"},
			...
			ErasNarrowValue:          []string{"п.н.е.", "н.е."},
			ErasWideValue:            []string{"пре нове ере", "нове ере"},
			TimezonesValue:           map[string]string{"": "Фолкландска Острва, стандардно време", "ACDT": "Аустралијско централно летње време", "ACST": "Аустралијско централно стандардно време", "ACT": "Акре стандардно време", "ACWDT": "Аустралијско централно западно летње време", "ACWST": "Аустралијско централно западно стандардно време", "ADT": "Атлантско летње време", "AEDT": "Аустралијско источно летње време", "AEST": "Аустралијско источно стандардно време", "AFT": "Авганистан време", "AKDT": "Аљаска, летње време", "AKST": "Аљаска, стандардно време", "AMST": "Амазон, летње време", "AMT": "Амазон, стандардно време", "ARST": "Аргентина, летње време", "ART": "Аргентина, стандардно време", "AST": "Атлантско стандардно време", "AWDT": "Аустралијско западно летње време", "AWST": "Аустралијско западно стандардно време", "BNT": "Брунеј Дарусалум време", "BOT": "Боливија време", "BRST": "Бразилија, летње време", "BRT": "Бразилија, стандардно време", "BST": "Бангладеш, летње време", "BTT": "Бутан време", "CAT": "Централно-афричко време", "CCT": "Кокос (Келинг) Острва време", "CDT": "Северноамеричко централно летње време", "CDT (Kuba)": "Куба, летње време", "CHADT": "Чатам, летње време", "CHAST": "Чатам, стандардно време", "CLST": "Чиле, летње време", "CLT": "Чиле, стандардно време", "COST": "Колумбија, летње време", "COT": "Колумбија, стандардно време", "CST": "Северноамеричко централно стандардно време", "CST (Kuba)": "Куба, стандардно време", "CXT": "Божићно острво време", "ChST": "Чаморо време", "EASST": "Ускршња острва, летње време", "EAST": "Ускршња острва, стандардно време", "EAT": "Источно-афричко време", "ECT": "Еквадор време", "EDT": "Северноамеричко источно летње време", "EGDT": "Источни Гренланд, летње време", "EGST": "Источни Гренланд, стандардно време", "EST": "Северноамеричко источно стандардно време", "FKST": "Фолкландска Острва, летње време", "GALT": "Галапагос време", "GFT": "Француска Гвајана време", "GMT": "Средње време по Гриничу", "GST": "Заливско време", "GYT": "Гвајана време", "HADT": "Хавајско-алеутско летње време", "HAST": "Хавајско-алеутско стандардно време", "HENOMX": "Северозападни Мексико, летње време", "HEOG": "Западни Гренланд, летње време", "HEPMX": "Мексички Пацифик, летње време", "HKST": "Хонг Конг, летње време", "HKT": "Хонг Конг, стандардно време", "HNNOMX": "Северозападни Мексико, стандардно време", "HNOG": "Западни Гренланд, стандардно време", "HNPMX": "Мексички Пацифик, стандардно време", "ICT": "Индокина време", "IRDT": "Иран, летње време", "IRST": "Иран, стандардно време", "IST": "Индијско стандардно време", "JDT": "Јапанско летње време", "JST": "Јапанско стандардно време", "LHDT": "Лорд Хов, летње време", "LHST": "Лорд Хов, стандардно време", "MDT": "Макао летње рачунање времена", "MESZ": "Средњеевропско летње време", "MEZ": "Средњеевропско стандардно време", "MST": "Макао стандардно време", "MVT": "Малдиви време", "MYT": "Малезија време", "NDT": "Њуфаундленд, летње време", "NPT": "Непал време", "NST": "Њуфаундленд, стандардно време", "NZDT": "Нови Зеланд, летње време", "NZST": "Нови Зеланд, стандардно време", "OESZ": "Источноевропско летње време", "OEZ": "Источноевропско стандардно време", "PDT": "Северноамеричко пацифичко летње време", "PKT": "Пакистан, летње време", "PMDT": "Сен Пјер и Микелон, летње време", "PMST": "Сен Пјер и Микелон, стандардно време", "PST": "Северноамеричко пацифичко стандардно време", "PYST": "Парагвај, летње време", "SAST": "Јужно-афричко време", "SGT": "Сингапур, стандардно време", "SRT": "Суринам време", "TLT": "Источни тимор време", "TMST": "Туркменистан, летње време", "TMT": "Туркменистан, стандардно време", "UYST": "Уругвај, летње време", "UYT": "Уругвај, стандардно време", "VET": "Венецуела време", "WARST": "Западна Аргентина, летње време", "WART": "Западна Аргентина, стандардно време", "WAST": "Западно-афричко летње време", "WAT": "Западно-афричко стандардно време", "WESZ": "Западноевропско летње време", "WEZ": "Западноевропско стандардно време", "WIB": "Западно-индонезијско време", "WIT": "Источно-индонезијско време", "WITA": "Централно-индонезијско време", "∅∅∅": "Перу, летње време"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"векови", "%v веком", "%v векова", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"дец.", "%v дец.", "%v дец.", ""},
				Long:   &locales.CounterFormat{"деценије", "%v деценијом", "%v деценија", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"г.", "%v г", "%v г", ""},
				Long:   &locales.CounterFormat{"године", "%v годином", "%v година", "%v годишње"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"м.", "%v м", "%v м", ""},
				Long:   &locales.CounterFormat{"месеци", "%v месецом", "%v месеци", "%v месечно"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"н.", "%v н", "%v н", ""},
				Long:   &locales.CounterFormat{"недеље", "%v недељом", "%v недеља", "%v недељно"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"сати", "%v сатом", "%v сати", "%v/сат"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мин", "%v м", "%v м", ""},
				Long:   &locales.CounterFormat{"минути", "%v минутом", "%v минута", "%v у минуту"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"с", "%v с", "%v с", ""},
				Long:   &locales.CounterFormat{"секунде", "%v секундом", "%v секунди", "%v/у секунди"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"милисекунде", "%v милисекундом", "%v милисекунди", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"микросекунде", "%v микросекундом", "%v микросекунди", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"наносекунде", "%v наносекундом", "%v наносекунди", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"≥%[1]v",
...
// DateFullLayout returns the full date layout for 'sr'
func (sr *sr) DateFullLayout() string {
	return sr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sr'
func (sr *sr) DateLongLayout() string {
	return sr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sr'
func (sr *sr) DateMediumLayout() string {
	return sr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sr'
func (sr *sr) DateShortLayout() string {
	return sr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sr'
func (sr *sr) TimeFullLayout() string {
	return sr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sr'
func (sr *sr) TimeLongLayout() string {
	return sr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sr'
func (sr *sr) TimeMediumLayout() string {
	return sr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sr'
func (sr *sr) TimeShortLayout() string {
	return sr.timeShortLayout
}

func (sr *sr) ListPatterns() *locales.ListPatterns {
	return sr.listPatterns
}

func (sr *sr) GetDurationSpec() *locales.DurationSpec {
	return sr.DurationSpec
}

func (sr *sr) GetMiscPatterns() *locales.MiscPatterns {
