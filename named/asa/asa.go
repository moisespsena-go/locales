...
// DateFullLayout returns the full date layout for 'asa'
func (asa *asa) DateFullLayout() string {
	return asa.dateFullLayout
}

// DateLongLayout returns the long date layout for 'asa'
func (asa *asa) DateLongLayout() string {
	return asa.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'asa'
func (asa *asa) DateMediumLayout() string {
	return asa.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'asa'
func (asa *asa) DateShortLayout() string {
	return asa.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'asa'
func (asa *asa) TimeFullLayout() string {
	return asa.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'asa'
func (asa *asa) TimeLongLayout() string {
	return asa.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'asa'
func (asa *asa) TimeMediumLayout() string {
	return asa.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'asa'
func (asa *asa) TimeShortLayout() string {
	return asa.timeShortLayout
}

func (asa *asa) ListPatterns() *locales.ListPatterns {
	return asa.listPatterns
}

func (asa *asa) GetDurationSpec() *locales.DurationSpec {
	return asa.DurationSpec
}

func (asa *asa) GetMiscPatterns() *locales.MiscPatterns {
