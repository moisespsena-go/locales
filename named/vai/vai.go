...
// DateFullLayout returns the full date layout for 'vai'
func (vai *vai) DateFullLayout() string {
	return vai.dateFullLayout
}

// DateLongLayout returns the long date layout for 'vai'
func (vai *vai) DateLongLayout() string {
	return vai.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'vai'
func (vai *vai) DateMediumLayout() string {
	return vai.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'vai'
func (vai *vai) DateShortLayout() string {
	return vai.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'vai'
func (vai *vai) TimeFullLayout() string {
	return vai.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'vai'
func (vai *vai) TimeLongLayout() string {
	return vai.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'vai'
func (vai *vai) TimeMediumLayout() string {
	return vai.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'vai'
func (vai *vai) TimeShortLayout() string {
	return vai.timeShortLayout
}

func (vai *vai) ListPatterns() *locales.ListPatterns {
	return vai.listPatterns
}

func (vai *vai) GetDurationSpec() *locales.DurationSpec {
	return vai.DurationSpec
}

func (vai *vai) GetMiscPatterns() *locales.MiscPatterns {
