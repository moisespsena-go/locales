...
func New() locales.Translator {
	return &mg_MG{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mar", "Apr", "Mey", "Jon", "Jol", "Aog", "Sep", "Okt", "Nov", "Des"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Janoary", "Febroary", "Martsa", "Aprily", "Mey", "Jona", "Jolay", "Aogositra", "Septambra", "Oktobra", "Novambra", "Desambra"},
			WeekdaysAbbreviatedValue: []string{"Alah", "Alats", "Tal", "Alar", "Alak", "Zom", "Asab"},
			WeekdaysNarrowValue:      []string{"A", "A", "T", "A", "A", "Z", "A"},
			WeekdaysShortValue:       []string{"Alah", "Alats", "Tal", "Alar", "Alak", "Zom", "Asab"},
			WeekdaysWideValue:        []string{"Alahady", "Alatsinainy", "Talata", "Alarobia", "Alakamisy", "Zoma", "Asabotsy"},
			...
			ErasWideValue:            []string{"Alohan’i JK", "Aorian’i JK"},
...
func (mg *mg_MG) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(mg, mg.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'mg_MG'
func (mg *mg_MG) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(mg, mg.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'mg_MG'
func (mg *mg_MG) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(mg, mg.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'mg_MG'
func (mg *mg_MG) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(mg, mg.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'mg_MG'
func (mg *mg_MG) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(mg, mg.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'mg_MG'
func (mg *mg_MG) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(mg, mg.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'mg_MG'
func (mg *mg_MG) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(mg, mg.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'mg_MG'
func (mg *mg_MG) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(mg, mg.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'mg_MG'
func (mg *mg_MG) DateFullLayout() string {
	return mg.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mg_MG'
func (mg *mg_MG) DateLongLayout() string {
	return mg.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mg_MG'
func (mg *mg_MG) DateMediumLayout() string {
	return mg.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mg_MG'
func (mg *mg_MG) DateShortLayout() string {
	return mg.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mg_MG'
func (mg *mg_MG) TimeFullLayout() string {
	return mg.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mg_MG'
func (mg *mg_MG) TimeLongLayout() string {
	return mg.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mg_MG'
func (mg *mg_MG) TimeMediumLayout() string {
	return mg.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mg_MG'
func (mg *mg_MG) TimeShortLayout() string {
	return mg.timeShortLayout
}

func (mg *mg_MG) ListPatterns() *locales.ListPatterns {
	return mg.listPatterns
}

func (mg *mg_MG) GetDurationSpec() *locales.DurationSpec {
	return mg.DurationSpec
}

func (mg *mg_MG) GetMiscPatterns() *locales.MiscPatterns {
	return &mg.miscPatterns
}
