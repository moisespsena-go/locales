...
// DateFullLayout returns the full date layout for 'el_CY'
func (el *el_CY) DateFullLayout() string {
	return el.dateFullLayout
}

// DateLongLayout returns the long date layout for 'el_CY'
func (el *el_CY) DateLongLayout() string {
	return el.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'el_CY'
func (el *el_CY) DateMediumLayout() string {
	return el.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'el_CY'
func (el *el_CY) DateShortLayout() string {
	return el.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'el_CY'
func (el *el_CY) TimeFullLayout() string {
	return el.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'el_CY'
func (el *el_CY) TimeLongLayout() string {
	return el.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'el_CY'
func (el *el_CY) TimeMediumLayout() string {
	return el.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'el_CY'
func (el *el_CY) TimeShortLayout() string {
	return el.timeShortLayout
}

func (el *el_CY) ListPatterns() *locales.ListPatterns {
	return el.listPatterns
}

func (el *el_CY) GetDurationSpec() *locales.DurationSpec {
	return el.DurationSpec
}

func (el *el_CY) GetMiscPatterns() *locales.MiscPatterns {
