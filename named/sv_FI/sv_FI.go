...
// DateFullLayout returns the full date layout for 'sv_FI'
func (sv *sv_FI) DateFullLayout() string {
	return sv.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sv_FI'
func (sv *sv_FI) DateLongLayout() string {
	return sv.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sv_FI'
func (sv *sv_FI) DateMediumLayout() string {
	return sv.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sv_FI'
func (sv *sv_FI) DateShortLayout() string {
	return sv.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sv_FI'
func (sv *sv_FI) TimeFullLayout() string {
	return sv.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sv_FI'
func (sv *sv_FI) TimeLongLayout() string {
	return sv.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sv_FI'
func (sv *sv_FI) TimeMediumLayout() string {
	return sv.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sv_FI'
func (sv *sv_FI) TimeShortLayout() string {
	return sv.timeShortLayout
}

func (sv *sv_FI) ListPatterns() *locales.ListPatterns {
	return sv.listPatterns
}

func (sv *sv_FI) GetDurationSpec() *locales.DurationSpec {
	return sv.DurationSpec
}

func (sv *sv_FI) GetMiscPatterns() *locales.MiscPatterns {
