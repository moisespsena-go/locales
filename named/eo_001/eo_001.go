...
// DateFullLayout returns the full date layout for 'eo_001'
func (eo *eo_001) DateFullLayout() string {
	return eo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'eo_001'
func (eo *eo_001) DateLongLayout() string {
	return eo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'eo_001'
func (eo *eo_001) DateMediumLayout() string {
	return eo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'eo_001'
func (eo *eo_001) DateShortLayout() string {
	return eo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'eo_001'
func (eo *eo_001) TimeFullLayout() string {
	return eo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'eo_001'
func (eo *eo_001) TimeLongLayout() string {
	return eo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'eo_001'
func (eo *eo_001) TimeMediumLayout() string {
	return eo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'eo_001'
func (eo *eo_001) TimeShortLayout() string {
	return eo.timeShortLayout
}

func (eo *eo_001) ListPatterns() *locales.ListPatterns {
	return eo.listPatterns
}

func (eo *eo_001) GetDurationSpec() *locales.DurationSpec {
	return eo.DurationSpec
}

func (eo *eo_001) GetMiscPatterns() *locales.MiscPatterns {
