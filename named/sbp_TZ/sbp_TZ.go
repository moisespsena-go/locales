...
func New() locales.Translator {
	return &sbp_TZ{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Mup", "Mwi", "Msh", "Mun", "Mag", "Muj", "Msp", "Mpg", "Mye", "Mok", "Mus", "Muh"},
			MonthsWideValue:          []string{"", "Mupalangulwa", "Mwitope", "Mushende", "Munyi", "Mushende Magali", "Mujimbi", "Mushipepo", "Mupuguto", "Munyense", "Mokhu", "Musongandembwe", "Muhaano"},
			WeekdaysAbbreviatedValue: []string{"Mul", "Jtt", "Jnn", "Jtn", "Alh", "Iju", "Jmo"},
			WeekdaysNarrowValue:      []string{"M", "J", "J", "J", "A", "I", "J"},
			WeekdaysWideValue:        []string{"Mulungu", "Jumatatu", "Jumanne", "Jumatano", "Alahamisi", "Ijumaa", "Jumamosi"},
			PeriodsAbbreviatedValue:  []string{"Lwamilawu", "Pashamihe"},
			PeriodsWideValue:         []string{"Lwamilawu", "Pashamihe"},
			ErasAbbreviatedValue:     []string{"AK", "PK"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Ashanali uKilisito", "Pamwandi ya Kilisto"},
...
func (sbp *sbp_TZ) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(sbp, sbp.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'sbp_TZ'
func (sbp *sbp_TZ) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(sbp, sbp.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'sbp_TZ'
func (sbp *sbp_TZ) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(sbp, sbp.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'sbp_TZ'
func (sbp *sbp_TZ) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(sbp, sbp.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'sbp_TZ'
func (sbp *sbp_TZ) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(sbp, sbp.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'sbp_TZ'
func (sbp *sbp_TZ) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(sbp, sbp.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'sbp_TZ'
func (sbp *sbp_TZ) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(sbp, sbp.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'sbp_TZ'
func (sbp *sbp_TZ) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(sbp, sbp.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'sbp_TZ'
func (sbp *sbp_TZ) DateFullLayout() string {
	return sbp.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sbp_TZ'
func (sbp *sbp_TZ) DateLongLayout() string {
	return sbp.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sbp_TZ'
func (sbp *sbp_TZ) DateMediumLayout() string {
	return sbp.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sbp_TZ'
func (sbp *sbp_TZ) DateShortLayout() string {
	return sbp.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sbp_TZ'
func (sbp *sbp_TZ) TimeFullLayout() string {
	return sbp.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sbp_TZ'
func (sbp *sbp_TZ) TimeLongLayout() string {
	return sbp.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sbp_TZ'
func (sbp *sbp_TZ) TimeMediumLayout() string {
	return sbp.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sbp_TZ'
func (sbp *sbp_TZ) TimeShortLayout() string {
	return sbp.timeShortLayout
}

func (sbp *sbp_TZ) ListPatterns() *locales.ListPatterns {
	return sbp.listPatterns
}

func (sbp *sbp_TZ) GetDurationSpec() *locales.DurationSpec {
	return sbp.DurationSpec
}

func (sbp *sbp_TZ) GetMiscPatterns() *locales.MiscPatterns {
	return &sbp.miscPatterns
}
