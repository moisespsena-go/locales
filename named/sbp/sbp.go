...
// DateFullLayout returns the full date layout for 'sbp'
func (sbp *sbp) DateFullLayout() string {
	return sbp.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sbp'
func (sbp *sbp) DateLongLayout() string {
	return sbp.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sbp'
func (sbp *sbp) DateMediumLayout() string {
	return sbp.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sbp'
func (sbp *sbp) DateShortLayout() string {
	return sbp.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sbp'
func (sbp *sbp) TimeFullLayout() string {
	return sbp.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sbp'
func (sbp *sbp) TimeLongLayout() string {
	return sbp.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sbp'
func (sbp *sbp) TimeMediumLayout() string {
	return sbp.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sbp'
func (sbp *sbp) TimeShortLayout() string {
	return sbp.timeShortLayout
}

func (sbp *sbp) ListPatterns() *locales.ListPatterns {
	return sbp.listPatterns
}

func (sbp *sbp) GetDurationSpec() *locales.DurationSpec {
	return sbp.DurationSpec
}

func (sbp *sbp) GetMiscPatterns() *locales.MiscPatterns {
