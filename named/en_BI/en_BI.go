...
// DateFullLayout returns the full date layout for 'en_BI'
func (en *en_BI) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_BI'
func (en *en_BI) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_BI'
func (en *en_BI) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_BI'
func (en *en_BI) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_BI'
func (en *en_BI) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_BI'
func (en *en_BI) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_BI'
func (en *en_BI) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_BI'
func (en *en_BI) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_BI) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_BI) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_BI) GetMiscPatterns() *locales.MiscPatterns {
