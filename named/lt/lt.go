...
func New() locales.Translator {
	return &lt{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 tūkst'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 tūkst'.' ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 tūkst'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 tūkst'.' ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 tūkst'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 tūkst'.' ¤"),
						}},
						...
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 mlrd'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 mlrd'.' ¤"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 mlrd'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 mlrd'.' ¤"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 mlrd'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 mlrd'.' ¤"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 trln'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 trln'.' ¤"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 trln'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 trln'.' ¤"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 trln'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 trln'.' ¤"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "saus.", "vas.", "kov.", "bal.", "geg.", "birž.", "liep.", "rugp.", "rugs.", "spal.", "lapkr.", "gruod."},
			MonthsNarrowValue:        []string{"", "S", "V", "K", "B", "G", "B", "L", "R", "R", "S", "L", "G"},
			MonthsWideValue:          []string{"", "sausio", "vasario", "kovo", "balandžio", "gegužės", "birželio", "liepos", "rugpjūčio", "rugsėjo", "spalio", "lapkričio", "gruodžio"},
			WeekdaysAbbreviatedValue: []string{"sk", "pr", "an", "tr", "kt", "pn", "št"},
			WeekdaysNarrowValue:      []string{"S", "P", "A", "T", "K", "P", "Š"},
			WeekdaysShortValue:       []string{"Sk", "Pr", "An", "Tr", "Kt", "Pn", "Št"},
			WeekdaysWideValue:        []string{"sekmadienis", "pirmadienis", "antradienis", "trečiadienis", "ketvirtadienis", "penktadienis", "šeštadienis"},
			PeriodsAbbreviatedValue:  []string{"priešpiet", "popiet"},
			PeriodsNarrowValue:       []string{"pr.\u00a0p.", "pop."},
			PeriodsWideValue:         []string{"priešpiet", "popiet"},
			ErasAbbreviatedValue:     []string{"pr. Kr.", "po Kr."},
			ErasNarrowValue:          []string{"pr. Kr.", "po Kr."},
			ErasWideValue:            []string{"prieš Kristų", "po Kristaus"},
			TimezonesValue:           map[string]string{"": "Folklandų Salų žiemos laikas", "ACDT": "Centrinės Australijos vasaros laikas", "ACST": "Centrinės Australijos žiemos laikas", "ACT": "Ako standartinis laikas", "ACWDT": "Centrinės vakarų Australijos vasaros laikas", "ACWST": "Centrinės vakarų Australijos žiemos laikas", "ADT": "Atlanto vasaros laikas", "AEDT": "Rytų Australijos vasaros laikas", "AEST": "Rytų Australijos žiemos laikas", "AFT": "Afganistano laikas", "AKDT": "Aliaskos vasaros laikas", "AKST": "Aliaskos žiemos laikas", "AMST": "Amazonės vasaros laikas", "AMT": "Amazonės žiemos laikas", "ARST": "Argentinos vasaros laikas", "ART": "Argentinos žiemos laikas", "AST": "Atlanto žiemos laikas", "AWDT": "Vakarų Australijos vasaros laikas", "AWST": "Vakarų Australijos žiemos laikas", "BNT": "Brunėjaus Darusalamo laikas", "BOT": "Bolivijos laikas", "BRST": "Brazilijos vasaros laikas", "BRT": "Brazilijos žiemos laikas", "BST": "Bangladešo vasaros laikas", "BTT": "Butano laikas", "CAT": "Centrinės Afrikos laikas", "CCT": "Kokosų Salų laikas", "CDT": "Šiaurės Amerikos centro vasaros laikas", "CDT (Kuba)": "Kubos vasaros laikas", "CHADT": "Čatamo vasaros laikas", "CHAST": "Čatamo žiemos laikas", "CLST": "Čilės vasaros laikas", "CLT": "Čilės žiemos laikas", "COST": "Kolumbijos vasaros laikas", "COT": "Kolumbijos žiemos laikas", "CST": "Šiaurės Amerikos centro žiemos laikas", "CST (Kuba)": "Kubos žiemos laikas", "CXT": "Kalėdų Salos laikas", "ChST": "Čamoro laikas", "EASST": "Velykų Salos vasaros laikas", "EAST": "Velykų salos žiemos laikas", "EAT": "Rytų Afrikos laikas", "ECT": "Ekvadoro laikas", "EDT": "Šiaurės Amerikos rytų vasaros laikas", "EGDT": "Grenlandijos rytų vasaros laikas", "EGST": "Grenlandijos rytų žiemos laikas", "EST": "Šiaurės Amerikos rytų žiemos laikas", "FKST": "Folklando Salų vasaros laikas", "GALT": "Galapagų laikas", "GFT": "Prancūzijos Gvianos laikas", "GMT": "Grinvičo laikas", "GST": "Persijos įlankos laikas", "GYT": "Gajanos laikas", "HADT": "Havajų–Aleutų vasaros laikas", "HAST": "Havajų–Aleutų žiemos laikas", "HENOMX": "Šiaurės Vakarų Meksikos vasaros laikas", "HEOG": "Grenlandijos vakarų vasaros laikas", "HEPMX": "Meksikos Ramiojo vandenyno vasaros laikas", "HKST": "Honkongo vasaros laikas", "HKT": "Honkongo žiemos laikas", "HNNOMX": "Šiaurės Vakarų Meksikos žiemos laikas", "HNOG": "Grenlandijos vakarų žiemos laikas", "HNPMX": "Meksikos Ramiojo vandenyno žiemos laikas", "ICT": "Indokinijos laikas", "IRDT": "Irano vasaros laikas", "IRST": "Irano žiemos laikas", "IST": "Indijos laikas", "JDT": "Japonijos vasaros laikas", "JST": "Japonijos žiemos laikas", "LHDT": "Lordo Hau vasaros laikas", "LHST": "Lordo Hau žiemos laikas", "MDT": "Makau vasaros laikas", "MESZ": "Vidurio Europos vasaros laikas", "MEZ": "Vidurio Europos žiemos laikas", "MST": "Makau žiemos laikas", "MVT": "Maldyvų laikas", "MYT": "Malaizijos laikas", "NDT": "Niufaundlendo vasaros laikas", "NPT": "Nepalo laikas", "NST": "Niufaundlendo žiemos laikas", "NZDT": "Naujosios Zelandijos vasaros laikas", "NZST": "Naujosios Zelandijos žiemos laikas", "OESZ": "Rytų Europos vasaros laikas", "OEZ": "Rytų Europos žiemos laikas", "PDT": "Šiaurės Amerikos Ramiojo vandenyno vasaros laikas", "PKT": "Pakistano vasaros laikas", "PMDT": "Sen Pjero ir Mikelono vasaros laikas", "PMST": "Sen Pjero ir Mikelono žiemos laikas", "PST": "Šiaurės Amerikos Ramiojo vandenyno žiemos laikas", "PYST": "Paragvajaus vasaros laikas", "SAST": "Pietų Afrikos laikas", "SGT": "Singapūro laikas", "SRT": "Surinamo laikas", "TLT": "Rytų Timoro laikas", "TMST": "Turkmėnistano vasaros laikas", "TMT": "Turkmėnistano žiemos laikas", "UYST": "Urugvajaus vasaros laikas", "UYT": "Urugvajaus žiemos laikas", "VET": "Venesuelos laikas", "WARST": "Vakarų Argentinos vasaros laikas", "WART": "Vakarų Argentinos žiemos laikas", "WAST": "Vakarų Afrikos vasaros laikas", "WAT": "Vakarų Afrikos žiemos laikas", "WESZ": "Vakarų Europos vasaros laikas", "WEZ": "Vakarų Europos žiemos laikas", "WIB": "Vakarų Indonezijos laikas", "WIT": "Rytų Indonezijos laikas", "WITA": "Centrinės Indonezijos laikas", "∅∅∅": "Peru vasaros laikas"},
		},
		...
		dateFullLayout:   "y 'm'. MMMM d 'd'., EEEE",
		dateLongLayout:   "y 'm'. MMMM d 'd'.",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} ir {1}", "{0}, {1}", "{0}, {1}", "{0} ir {1}"}, {"{0} ar {1}", "{0}, {1}", "{0}, {1}", "{0} ar {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"a.", "%v a.", "%v a.", ""},
				Long:   &locales.CounterFormat{"amžiai", "%v amžiuje", "%v amžių", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dekados", "%v dek.", "%v dek.", ""},
				Long:   &locales.CounterFormat{"dekados", "%v dekadoje", "%v dekadų", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"metai", "%v m.", "%v m.", "%v/m."},
				Long:   &locales.CounterFormat{"metai", "%v metuose", "%v metų", "%v per metus"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mėnuo", "%v mėn.", "%v mėn.", "%v/mėn."},
				Long:   &locales.CounterFormat{"mėnesiai", "%v mėnesyje", "%v mėnesių", "%v per mėnesį"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sav.", "%v sav.", "%v sav.", "%v/sav."},
				Long:   &locales.CounterFormat{"savaitės", "%v savaitėje", "%v savaičių", "%v per savaitę"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"diena", "%v d.", "%v d.", "%v/d."}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"valanda", "%v h", "%v h", "%v/h"},
				Long:   &locales.CounterFormat{"valandos", "%v valandoje", "%v valandų", "%v/h"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min.", "%v min.", "%v min.", "%v/min."},
				Long:   &locales.CounterFormat{"minutės", "%v minutėje", "%v minučių", "%v per minutę"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sek.", "%v s", "%v s", "%v/s"},
				Long:   &locales.CounterFormat{"sekundės", "%v sekundėje", "%v sekundžių", "%v/s"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"milisek.", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"milisekundės", "%v milisekundėje", "%v milisekundžių", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"mikrosekundės", "%v mikrosekundėje", "%v mikrosekundžių", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"nanosek.", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosekundės", "%v nanosekundėje", "%v nanosekundžių", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"≥%[1]v",
...
func (lt *lt) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(lt, lt.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'lt'
func (lt *lt) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(lt, lt.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'lt'
func (lt *lt) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(lt, lt.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'lt'
func (lt *lt) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(lt, lt.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'lt'
func (lt *lt) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(lt, lt.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'lt'
func (lt *lt) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(lt, lt.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'lt'
func (lt *lt) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(lt, lt.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'lt'
func (lt *lt) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(lt, lt.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'lt'
func (lt *lt) DateFullLayout() string {
	return lt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'lt'
func (lt *lt) DateLongLayout() string {
	return lt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'lt'
func (lt *lt) DateMediumLayout() string {
	return lt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'lt'
func (lt *lt) DateShortLayout() string {
	return lt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'lt'
func (lt *lt) TimeFullLayout() string {
	return lt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'lt'
func (lt *lt) TimeLongLayout() string {
	return lt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'lt'
func (lt *lt) TimeMediumLayout() string {
	return lt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'lt'
func (lt *lt) TimeShortLayout() string {
	return lt.timeShortLayout
}

func (lt *lt) ListPatterns() *locales.ListPatterns {
	return lt.listPatterns
}

func (lt *lt) GetDurationSpec() *locales.DurationSpec {
	return lt.DurationSpec
}

func (lt *lt) GetMiscPatterns() *locales.MiscPatterns {
	return &lt.miscPatterns
}
