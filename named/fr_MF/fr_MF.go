...
// DateFullLayout returns the full date layout for 'fr_MF'
func (fr *fr_MF) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_MF'
func (fr *fr_MF) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_MF'
func (fr *fr_MF) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_MF'
func (fr *fr_MF) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_MF'
func (fr *fr_MF) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_MF'
func (fr *fr_MF) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_MF'
func (fr *fr_MF) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_MF'
func (fr *fr_MF) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_MF) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_MF) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_MF) GetMiscPatterns() *locales.MiscPatterns {
