...
// DateFullLayout returns the full date layout for 'en_PK'
func (en *en_PK) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_PK'
func (en *en_PK) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_PK'
func (en *en_PK) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_PK'
func (en *en_PK) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_PK'
func (en *en_PK) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_PK'
func (en *en_PK) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_PK'
func (en *en_PK) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_PK'
func (en *en_PK) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_PK) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_PK) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_PK) GetMiscPatterns() *locales.MiscPatterns {
