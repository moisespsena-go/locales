...
func New() locales.Translator {
	return &fa{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ژانویه", "فوریه", "مارس", "آوریل", "مه", "ژوئن", "ژوئیه", "اوت", "سپتامبر", "اکتبر", "نوامبر", "دسامبر"},
			MonthsNarrowValue:        []string{"", "ژ", "ف", "م", "آ", "م", "ژ", "ژ", "ا", "س", "ا", "ن", "د"},
			MonthsWideValue:          []string{"", "ژانویهٔ", "فوریهٔ", "مارس", "آوریل", "مهٔ", "ژوئن", "ژوئیهٔ", "اوت", "سپتامبر", "اکتبر", "نوامبر", "دسامبر"},
			WeekdaysAbbreviatedValue: []string{"یکشنبه", "دوشنبه", "سه\u200cشنبه", "چهارشنبه", "پنجشنبه", "جمعه", "شنبه"},
			WeekdaysNarrowValue:      []string{"ی", "د", "س", "چ", "پ", "ج", "ش"},
			WeekdaysShortValue:       []string{"۱ش", "۲ش", "۳ش", "۴ش", "۵ش", "ج", "ش"},
			WeekdaysWideValue:        []string{"یکشنبه", "دوشنبه", "سه\u200cشنبه", "چهارشنبه", "پنجشنبه", "جمعه", "شنبه"},
			PeriodsAbbreviatedValue:  []string{"ق.ظ.", "ب.ظ."},
			PeriodsNarrowValue:       []string{"ق", "ب"},
			PeriodsWideValue:         []string{"قبل\u200cازظهر", "بعدازظهر"},
			ErasAbbreviatedValue:     []string{"ق.م.", "م."},
			ErasNarrowValue:          []string{"ق", "م"},
			ErasWideValue:            []string{"قبل از میلاد", "میلادی"},
			TimezonesValue:           map[string]string{"": "وقت عادی جزایر فالکلند", "ACDT": "وقت تابستانی مرکز استرالیا", "ACST": "وقت عادی مرکز استرالیا", "ACT": "ACT", "ACWDT": "وقت تابستانی مرکز-غرب استرالیا", "ACWST": "وقت عادی مرکز-غرب استرالیا", "ADT": "وقت تابستانی آتلانتیک", "AEDT": "وقت تابستانی شرق استرالیا", "AEST": "وقت عادی شرق استرالیا", "AFT": "وقت افغانستان", "AKDT": "وقت تابستانی آلاسکا", "AKST": "وقت عادی آلاسکا", "AMST": "وقت تابستانی آمازون", "AMT": "وقت عادی آمازون", "ARST": "وقت تابستانی آرژانتین", "ART": "وقت عادی آرژانتین", "AST": "وقت عادی آتلانتیک", "AWDT": "وقت تابستانی غرب استرالیا", "AWST": "وقت عادی غرب استرالیا", "BNT": "وقت برونئی دارالسلام", "BOT": "وقت بولیوی", "BRST": "وقت تابستانی برازیلیا", "BRT": "وقت عادی برازیلیا", "BST": "وقت تابستانی بنگلادش", "BTT": "وقت بوتان", "CAT": "وقت مرکز افریقا", "CCT": "وقت جزایر کوکوس", "CDT": "وقت تابستانی مرکز امریکا", "CDT (Kuba)": "وقت تابستانی کوبا", "CHADT": "وقت تابستانی چت\u200cهام", "CHAST": "وقت عادی چت\u200cهام", "CLST": "وقت تابستانی شیلی", "CLT": "وقت عادی شیلی", "COST": "وقت تابستانی کلمبیا", "COT": "وقت عادی کلمبیا", "CST": "وقت عادی مرکز امریکا", "CST (Kuba)": "وقت عادی کوبا", "CXT": "وقت جزیرهٔ کریسمس", "ChST": "وقت عادی چامورو", "EASST": "وقت تابستانی جزیرهٔ ایستر", "EAST": "وقت عادی جزیرهٔ ایستر", "EAT": "وقت شرق افریقا", "ECT": "وقت اکوادور", "EDT": "وقت تابستانی شرق امریکا", "EGDT": "وقت تابستانی شرق گرینلند", "EGST": "وقت عادی شرق گرینلند", "EST": "وقت عادی شرق امریکا", "FKST": "وقت تابستانی جزایر فالکلند", "GALT": "وقت گالاپاگوس", "GFT": "وقت گویان فرانسه", "GMT": "وقت گرینویچ", "GST": "وقت عادی خلیج فارس", "GYT": "وقت گویان", "HADT": "وقت تابستانی هاوایی‐الوشن", "HAST": "وقت عادی هاوایی‐الوشن", "HENOMX": "وقت تابستانی شمال غرب مکزیک", "HEOG": "وقت تابستانی غرب گرینلند", "HEPMX": "وقت تابستانی شرق مکزیک", "HKST": "وقت تابستانی هنگ\u200cکنگ", "HKT": "وقت عادی هنگ\u200cکنگ", "HNNOMX": "وقت عادی شمال غرب مکزیک", "HNOG": "وقت عادی غرب گرینلند", "HNPMX": "وقت عادی شرق مکزیک", "ICT": "وقت هندوچین", "IRDT": "وقت تابستانی ایران", "IRST": "وقت عادی ایران", "IST": "وقت هند", "JDT": "وقت تابستانی ژاپن", "JST": "وقت عادی ژاپن", "LHDT": "وقت تابستانی لردهو", "LHST": "وقت عادی لردهو", "MDT": "وقت تابستانی ماکائو", "MESZ": "وقت تابستانی مرکز اروپا", "MEZ": "وقت عادی مرکز اروپا", "MST": "وقت عادی ماکائو", "MVT": "وقت مالدیو", "MYT": "وقت مالزی", "NDT": "وقت تابستانی نیوفاندلند", "NPT": "وقت نپال", "NST": "وقت عادی نیوفاندلند", "NZDT": "وقت تابستانی نیوزیلند", "NZST": "وقت عادی نیوزیلند", "OESZ": "وقت تابستانی شرق اروپا", "OEZ": "وقت عادی شرق اروپا", "PDT": "وقت تابستانی غرب امریکا", "PKT": "وقت تابستانی پاکستان", "PMDT": "وقت تابستانی سنت\u200cپیر و میکلون", "PMST": "وقت عادی سنت\u200cپیر و میکلون", "PST": "وقت عادی غرب امریکا", "PYST": "وقت تابستانی پاراگوئه", "SAST": "وقت عادی جنوب افریقا", "SGT": "وقت سنگاپور", "SRT": "وقت سورینام", "TLT": "وقت تیمور شرقی", "TMST": "وقت تابستانی ترکمنستان", "TMT": "وقت عادی ترکمنستان", "UYST": "وقت تابستانی اروگوئه", "UYT": "وقت عادی اروگوئه", "VET": "وقت ونزوئلا", "WARST": "وقت تابستانی غرب آرژانتین", "WART": "وقت عادی غرب آرژانتین", "WAST": "وقت تابستانی غرب افریقا", "WAT": "وقت عادی غرب افریقا", "WESZ": "وقت تابستانی غرب اروپا", "WEZ": "وقت عادی غرب اروپا", "WIB": "وقت غرب اندونزی", "WIT": "وقت شرق اندونزی", "WITA": "وقت مرکز اندونزی", "∅∅∅": "وقت تابستانی پرو"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} و {1}", "{0}،\u200f {1}", "{0}،\u200f {1}", "{0}، و {1}"}, {"{0} یا {1}", "{0}،\u200f {1}", "{0}،\u200f {1}", "{0}، یا {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"سده", "%v سده", "%v سده", ""},
				Long:   &locales.CounterFormat{"سده", "%v سده", "%v سده", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"دهه", "%v دهه", "%v دهه", ""},
				Long:   &locales.CounterFormat{"دهه", "%v دهه", "%v دهه", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"سال", "%v سال", "%v سال", ""},
				Long:   &locales.CounterFormat{"سال", "%v سال", "%v سال", "%v در سال"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ماه", "%v ماه", "%v ماه", "%v/ماه"},
				Long:   &locales.CounterFormat{"ماه", "%v ماه", "%v ماه", "%v در ماه"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"هفته", "%v هفته", "%v هفته", "%v/هفته"},
				Long:   &locales.CounterFormat{"هفته", "%v هفته", "%v هفته", "%v در هفته"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"روز", "%v روز", "%v روز", "%v/روز"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ساعت", "%vh", "%vh", "%v/ساعت"},
				Long:   &locales.CounterFormat{"ساعت", "%v ساعت", "%v ساعت", "%v در ساعت"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"دقیقه", "%vm", "%vm", "%v/دقیقه"},
				Long:   &locales.CounterFormat{"دقیقه", "%v دقیقه", "%v دقیقه", "%v در دقیقه"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ثانیه", "%vs", "%vs", "%v/ثانیه"},
				Long:   &locales.CounterFormat{"ثانیه", "%v ثانیه", "%v ثانیه", "%v در ثانیه"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"میلی\u200cثانیه", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"میلی\u200cثانیه", "%v میلی\u200cثانیه", "%v میلی\u200cثانیه", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vμs", "%vμs", ""},
				Long:   &locales.CounterFormat{"میکروثانیه", "%v میکروثانیه", "%v میکروثانیه", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"نانوثانیه", "%vns", "%vns", ""},
				Long:   &locales.CounterFormat{"نانوثانیه", "%v نانوثانیه", "%v نانوثانیه", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"‎%[1]v+‎",
...
func (fa *fa) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(fa, fa.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'fa'
func (fa *fa) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(fa, fa.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'fa'
func (fa *fa) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(fa, fa.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'fa'
func (fa *fa) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(fa, fa.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'fa'
func (fa *fa) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(fa, fa.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'fa'
func (fa *fa) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(fa, fa.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'fa'
func (fa *fa) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(fa, fa.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'fa'
func (fa *fa) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(fa, fa.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'fa'
func (fa *fa) DateFullLayout() string {
	return fa.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fa'
func (fa *fa) DateLongLayout() string {
	return fa.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fa'
func (fa *fa) DateMediumLayout() string {
	return fa.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fa'
func (fa *fa) DateShortLayout() string {
	return fa.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fa'
func (fa *fa) TimeFullLayout() string {
	return fa.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fa'
func (fa *fa) TimeLongLayout() string {
	return fa.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fa'
func (fa *fa) TimeMediumLayout() string {
	return fa.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fa'
func (fa *fa) TimeShortLayout() string {
	return fa.timeShortLayout
}

func (fa *fa) ListPatterns() *locales.ListPatterns {
	return fa.listPatterns
}

func (fa *fa) GetDurationSpec() *locales.DurationSpec {
	return fa.DurationSpec
}

func (fa *fa) GetMiscPatterns() *locales.MiscPatterns {
	return &fa.miscPatterns
}
