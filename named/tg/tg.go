...
// DateFullLayout returns the full date layout for 'tg'
func (tg *tg) DateFullLayout() string {
	return tg.dateFullLayout
}

// DateLongLayout returns the long date layout for 'tg'
func (tg *tg) DateLongLayout() string {
	return tg.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'tg'
func (tg *tg) DateMediumLayout() string {
	return tg.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'tg'
func (tg *tg) DateShortLayout() string {
	return tg.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'tg'
func (tg *tg) TimeFullLayout() string {
	return tg.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'tg'
func (tg *tg) TimeLongLayout() string {
	return tg.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'tg'
func (tg *tg) TimeMediumLayout() string {
	return tg.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'tg'
func (tg *tg) TimeShortLayout() string {
	return tg.timeShortLayout
}

func (tg *tg) ListPatterns() *locales.ListPatterns {
	return tg.listPatterns
}

func (tg *tg) GetDurationSpec() *locales.DurationSpec {
	return tg.DurationSpec
}

func (tg *tg) GetMiscPatterns() *locales.MiscPatterns {
