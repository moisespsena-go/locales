...
// DateFullLayout returns the full date layout for 'kw'
func (kw *kw) DateFullLayout() string {
	return kw.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kw'
func (kw *kw) DateLongLayout() string {
	return kw.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kw'
func (kw *kw) DateMediumLayout() string {
	return kw.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kw'
func (kw *kw) DateShortLayout() string {
	return kw.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kw'
func (kw *kw) TimeFullLayout() string {
	return kw.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kw'
func (kw *kw) TimeLongLayout() string {
	return kw.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kw'
func (kw *kw) TimeMediumLayout() string {
	return kw.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kw'
func (kw *kw) TimeShortLayout() string {
	return kw.timeShortLayout
}

func (kw *kw) ListPatterns() *locales.ListPatterns {
	return kw.listPatterns
}

func (kw *kw) GetDurationSpec() *locales.DurationSpec {
	return kw.DurationSpec
}

func (kw *kw) GetMiscPatterns() *locales.MiscPatterns {
