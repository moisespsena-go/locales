...
// DateFullLayout returns the full date layout for 'pl_PL'
func (pl *pl_PL) DateFullLayout() string {
	return pl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pl_PL'
func (pl *pl_PL) DateLongLayout() string {
	return pl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pl_PL'
func (pl *pl_PL) DateMediumLayout() string {
	return pl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pl_PL'
func (pl *pl_PL) DateShortLayout() string {
	return pl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pl_PL'
func (pl *pl_PL) TimeFullLayout() string {
	return pl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pl_PL'
func (pl *pl_PL) TimeLongLayout() string {
	return pl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pl_PL'
func (pl *pl_PL) TimeMediumLayout() string {
	return pl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pl_PL'
func (pl *pl_PL) TimeShortLayout() string {
	return pl.timeShortLayout
}

func (pl *pl_PL) ListPatterns() *locales.ListPatterns {
	return pl.listPatterns
}

func (pl *pl_PL) GetDurationSpec() *locales.DurationSpec {
	return pl.DurationSpec
}

func (pl *pl_PL) GetMiscPatterns() *locales.MiscPatterns {
