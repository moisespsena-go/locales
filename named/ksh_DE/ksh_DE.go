...
// DateFullLayout returns the full date layout for 'ksh_DE'
func (ksh *ksh_DE) DateFullLayout() string {
	return ksh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ksh_DE'
func (ksh *ksh_DE) DateLongLayout() string {
	return ksh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ksh_DE'
func (ksh *ksh_DE) DateMediumLayout() string {
	return ksh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ksh_DE'
func (ksh *ksh_DE) DateShortLayout() string {
	return ksh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ksh_DE'
func (ksh *ksh_DE) TimeFullLayout() string {
	return ksh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ksh_DE'
func (ksh *ksh_DE) TimeLongLayout() string {
	return ksh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ksh_DE'
func (ksh *ksh_DE) TimeMediumLayout() string {
	return ksh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ksh_DE'
func (ksh *ksh_DE) TimeShortLayout() string {
	return ksh.timeShortLayout
}

func (ksh *ksh_DE) ListPatterns() *locales.ListPatterns {
	return ksh.listPatterns
}

func (ksh *ksh_DE) GetDurationSpec() *locales.DurationSpec {
	return ksh.DurationSpec
}

func (ksh *ksh_DE) GetMiscPatterns() *locales.MiscPatterns {
