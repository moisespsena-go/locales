...
func New() locales.Translator {
	return &rwk_TZ{
		...
		TimeSpec: &locales.TimeSpec{
			...
			MonthsWideValue:          []string{"", "Januari", "Februari", "Machi", "Aprilyi", "Mei", "Junyi", "Julyai", "Agusti", "Septemba", "Oktoba", "Novemba", "Desemba"},
			WeekdaysAbbreviatedValue: []string{"Jpi", "Jtt", "Jnn", "Jtn", "Alh", "Iju", "Jmo"},
			WeekdaysNarrowValue:      []string{"J", "J", "J", "J", "A", "I", "J"},
			WeekdaysWideValue:        []string{"Jumapilyi", "Jumatatuu", "Jumanne", "Jumatanu", "Alhamisi", "Ijumaa", "Jumamosi"},
			PeriodsAbbreviatedValue:  []string{"utuko", "kyiukonyi"},
			PeriodsWideValue:         []string{"utuko", "kyiukonyi"},
			ErasAbbreviatedValue:     []string{"KK", "BK"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Kabla ya Kristu", "Baada ya Kristu"},
...
func (rwk *rwk_TZ) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(rwk, rwk.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'rwk_TZ'
func (rwk *rwk_TZ) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(rwk, rwk.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'rwk_TZ'
func (rwk *rwk_TZ) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(rwk, rwk.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'rwk_TZ'
func (rwk *rwk_TZ) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(rwk, rwk.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'rwk_TZ'
func (rwk *rwk_TZ) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(rwk, rwk.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'rwk_TZ'
func (rwk *rwk_TZ) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(rwk, rwk.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'rwk_TZ'
func (rwk *rwk_TZ) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(rwk, rwk.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'rwk_TZ'
func (rwk *rwk_TZ) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(rwk, rwk.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'rwk_TZ'
func (rwk *rwk_TZ) DateFullLayout() string {
	return rwk.dateFullLayout
}

// DateLongLayout returns the long date layout for 'rwk_TZ'
func (rwk *rwk_TZ) DateLongLayout() string {
	return rwk.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'rwk_TZ'
func (rwk *rwk_TZ) DateMediumLayout() string {
	return rwk.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'rwk_TZ'
func (rwk *rwk_TZ) DateShortLayout() string {
	return rwk.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'rwk_TZ'
func (rwk *rwk_TZ) TimeFullLayout() string {
	return rwk.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'rwk_TZ'
func (rwk *rwk_TZ) TimeLongLayout() string {
	return rwk.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'rwk_TZ'
func (rwk *rwk_TZ) TimeMediumLayout() string {
	return rwk.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'rwk_TZ'
func (rwk *rwk_TZ) TimeShortLayout() string {
	return rwk.timeShortLayout
}

func (rwk *rwk_TZ) ListPatterns() *locales.ListPatterns {
	return rwk.listPatterns
}

func (rwk *rwk_TZ) GetDurationSpec() *locales.DurationSpec {
	return rwk.DurationSpec
}

func (rwk *rwk_TZ) GetMiscPatterns() *locales.MiscPatterns {
	return &rwk.miscPatterns
}
