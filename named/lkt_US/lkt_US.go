...
func New() locales.Translator {
	return &lkt_US{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:           ":",
			MonthsWideValue:     []string{"", "Wiótheȟika Wí", "Thiyóȟeyuŋka Wí", "Ištáwičhayazaŋ Wí", "Pȟežítȟo Wí", "Čhaŋwápetȟo Wí", "Wípazukȟa-wašté Wí", "Čhaŋpȟásapa Wí", "Wasútȟuŋ Wí", "Čhaŋwápeǧi Wí", "Čhaŋwápe-kasná Wí", "Waníyetu Wí", "Tȟahékapšuŋ Wí"},
			WeekdaysNarrowValue: []string{"A", "W", "N", "Y", "T", "Z", "O"},
			WeekdaysWideValue:   []string{"Aŋpétuwakȟaŋ", "Aŋpétuwaŋži", "Aŋpétunuŋpa", "Aŋpétuyamni", "Aŋpétutopa", "Aŋpétuzaptaŋ", "Owáŋgyužažapi"},
...
func (lkt *lkt_US) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(lkt, lkt.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'lkt_US'
func (lkt *lkt_US) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(lkt, lkt.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'lkt_US'
func (lkt *lkt_US) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(lkt, lkt.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'lkt_US'
func (lkt *lkt_US) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(lkt, lkt.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'lkt_US'
func (lkt *lkt_US) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(lkt, lkt.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'lkt_US'
func (lkt *lkt_US) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(lkt, lkt.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'lkt_US'
func (lkt *lkt_US) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(lkt, lkt.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'lkt_US'
func (lkt *lkt_US) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(lkt, lkt.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'lkt_US'
func (lkt *lkt_US) DateFullLayout() string {
	return lkt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'lkt_US'
func (lkt *lkt_US) DateLongLayout() string {
	return lkt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'lkt_US'
func (lkt *lkt_US) DateMediumLayout() string {
	return lkt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'lkt_US'
func (lkt *lkt_US) DateShortLayout() string {
	return lkt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'lkt_US'
func (lkt *lkt_US) TimeFullLayout() string {
	return lkt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'lkt_US'
func (lkt *lkt_US) TimeLongLayout() string {
	return lkt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'lkt_US'
func (lkt *lkt_US) TimeMediumLayout() string {
	return lkt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'lkt_US'
func (lkt *lkt_US) TimeShortLayout() string {
	return lkt.timeShortLayout
}

func (lkt *lkt_US) ListPatterns() *locales.ListPatterns {
	return lkt.listPatterns
}

func (lkt *lkt_US) GetDurationSpec() *locales.DurationSpec {
	return lkt.DurationSpec
}

func (lkt *lkt_US) GetMiscPatterns() *locales.MiscPatterns {
	return &lkt.miscPatterns
}
