...
// DateFullLayout returns the full date layout for 'sl_SI'
func (sl *sl_SI) DateFullLayout() string {
	return sl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sl_SI'
func (sl *sl_SI) DateLongLayout() string {
	return sl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sl_SI'
func (sl *sl_SI) DateMediumLayout() string {
	return sl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sl_SI'
func (sl *sl_SI) DateShortLayout() string {
	return sl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sl_SI'
func (sl *sl_SI) TimeFullLayout() string {
	return sl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sl_SI'
func (sl *sl_SI) TimeLongLayout() string {
	return sl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sl_SI'
func (sl *sl_SI) TimeMediumLayout() string {
	return sl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sl_SI'
func (sl *sl_SI) TimeShortLayout() string {
	return sl.timeShortLayout
}

func (sl *sl_SI) ListPatterns() *locales.ListPatterns {
	return sl.listPatterns
}

func (sl *sl_SI) GetDurationSpec() *locales.DurationSpec {
	return sl.DurationSpec
}

func (sl *sl_SI) GetMiscPatterns() *locales.MiscPatterns {
