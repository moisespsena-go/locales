...
// DateFullLayout returns the full date layout for 'teo'
func (teo *teo) DateFullLayout() string {
	return teo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'teo'
func (teo *teo) DateLongLayout() string {
	return teo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'teo'
func (teo *teo) DateMediumLayout() string {
	return teo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'teo'
func (teo *teo) DateShortLayout() string {
	return teo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'teo'
func (teo *teo) TimeFullLayout() string {
	return teo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'teo'
func (teo *teo) TimeLongLayout() string {
	return teo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'teo'
func (teo *teo) TimeMediumLayout() string {
	return teo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'teo'
func (teo *teo) TimeShortLayout() string {
	return teo.timeShortLayout
}

func (teo *teo) ListPatterns() *locales.ListPatterns {
	return teo.listPatterns
}

func (teo *teo) GetDurationSpec() *locales.DurationSpec {
	return teo.DurationSpec
}

func (teo *teo) GetMiscPatterns() *locales.MiscPatterns {
