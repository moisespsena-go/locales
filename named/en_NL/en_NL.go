...
// DateFullLayout returns the full date layout for 'en_NL'
func (en *en_NL) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_NL'
func (en *en_NL) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_NL'
func (en *en_NL) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_NL'
func (en *en_NL) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_NL'
func (en *en_NL) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_NL'
func (en *en_NL) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_NL'
func (en *en_NL) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_NL'
func (en *en_NL) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_NL) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_NL) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_NL) GetMiscPatterns() *locales.MiscPatterns {
