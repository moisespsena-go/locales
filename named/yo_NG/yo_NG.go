...
// DateFullLayout returns the full date layout for 'yo_NG'
func (yo *yo_NG) DateFullLayout() string {
	return yo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'yo_NG'
func (yo *yo_NG) DateLongLayout() string {
	return yo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'yo_NG'
func (yo *yo_NG) DateMediumLayout() string {
	return yo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'yo_NG'
func (yo *yo_NG) DateShortLayout() string {
	return yo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'yo_NG'
func (yo *yo_NG) TimeFullLayout() string {
	return yo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'yo_NG'
func (yo *yo_NG) TimeLongLayout() string {
	return yo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'yo_NG'
func (yo *yo_NG) TimeMediumLayout() string {
	return yo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'yo_NG'
func (yo *yo_NG) TimeShortLayout() string {
	return yo.timeShortLayout
}

func (yo *yo_NG) ListPatterns() *locales.ListPatterns {
	return yo.listPatterns
}

func (yo *yo_NG) GetDurationSpec() *locales.DurationSpec {
	return yo.DurationSpec
}

func (yo *yo_NG) GetMiscPatterns() *locales.MiscPatterns {
