...
// DateFullLayout returns the full date layout for 'en_IL'
func (en *en_IL) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_IL'
func (en *en_IL) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_IL'
func (en *en_IL) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_IL'
func (en *en_IL) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_IL'
func (en *en_IL) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_IL'
func (en *en_IL) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_IL'
func (en *en_IL) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_IL'
func (en *en_IL) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_IL) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_IL) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_IL) GetMiscPatterns() *locales.MiscPatterns {
