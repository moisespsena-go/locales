...
// DateFullLayout returns the full date layout for 'en_GI'
func (en *en_GI) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_GI'
func (en *en_GI) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_GI'
func (en *en_GI) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_GI'
func (en *en_GI) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_GI'
func (en *en_GI) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_GI'
func (en *en_GI) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_GI'
func (en *en_GI) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_GI'
func (en *en_GI) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_GI) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_GI) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_GI) GetMiscPatterns() *locales.MiscPatterns {
