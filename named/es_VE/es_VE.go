...
// DateFullLayout returns the full date layout for 'es_VE'
func (es *es_VE) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_VE'
func (es *es_VE) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_VE'
func (es *es_VE) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_VE'
func (es *es_VE) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_VE'
func (es *es_VE) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_VE'
func (es *es_VE) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_VE'
func (es *es_VE) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_VE'
func (es *es_VE) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_VE) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_VE) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_VE) GetMiscPatterns() *locales.MiscPatterns {
