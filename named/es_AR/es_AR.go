...
func New() locales.Translator {
	return &es_AR{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%va.", "%va.", ""},
				Long:   &locales.CounterFormat{"años", "%v año", "%v años", "%v/a"}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine},
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"seg.", "%vseg.", "%vseg.", ""},
				Long:   &locales.CounterFormat{"seg.", "%v seg.", "%v seg.", "%v/seg."}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
...
// DateFullLayout returns the full date layout for 'es_AR'
func (es *es_AR) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_AR'
func (es *es_AR) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_AR'
func (es *es_AR) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_AR'
func (es *es_AR) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_AR'
func (es *es_AR) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_AR'
func (es *es_AR) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_AR'
func (es *es_AR) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_AR'
func (es *es_AR) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_AR) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_AR) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_AR) GetMiscPatterns() *locales.MiscPatterns {
