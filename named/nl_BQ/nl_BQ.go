...
// DateFullLayout returns the full date layout for 'nl_BQ'
func (nl *nl_BQ) DateFullLayout() string {
	return nl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nl_BQ'
func (nl *nl_BQ) DateLongLayout() string {
	return nl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nl_BQ'
func (nl *nl_BQ) DateMediumLayout() string {
	return nl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nl_BQ'
func (nl *nl_BQ) DateShortLayout() string {
	return nl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nl_BQ'
func (nl *nl_BQ) TimeFullLayout() string {
	return nl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nl_BQ'
func (nl *nl_BQ) TimeLongLayout() string {
	return nl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nl_BQ'
func (nl *nl_BQ) TimeMediumLayout() string {
	return nl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nl_BQ'
func (nl *nl_BQ) TimeShortLayout() string {
	return nl.timeShortLayout
}

func (nl *nl_BQ) ListPatterns() *locales.ListPatterns {
	return nl.listPatterns
}

func (nl *nl_BQ) GetDurationSpec() *locales.DurationSpec {
	return nl.DurationSpec
}

func (nl *nl_BQ) GetMiscPatterns() *locales.MiscPatterns {
