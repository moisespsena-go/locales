...
// DateFullLayout returns the full date layout for 'pt_AO'
func (pt *pt_AO) DateFullLayout() string {
	return pt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pt_AO'
func (pt *pt_AO) DateLongLayout() string {
	return pt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pt_AO'
func (pt *pt_AO) DateMediumLayout() string {
	return pt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pt_AO'
func (pt *pt_AO) DateShortLayout() string {
	return pt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pt_AO'
func (pt *pt_AO) TimeFullLayout() string {
	return pt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pt_AO'
func (pt *pt_AO) TimeLongLayout() string {
	return pt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pt_AO'
func (pt *pt_AO) TimeMediumLayout() string {
	return pt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pt_AO'
func (pt *pt_AO) TimeShortLayout() string {
	return pt.timeShortLayout
}

func (pt *pt_AO) ListPatterns() *locales.ListPatterns {
	return pt.listPatterns
}

func (pt *pt_AO) GetDurationSpec() *locales.DurationSpec {
	return pt.DurationSpec
}

func (pt *pt_AO) GetMiscPatterns() *locales.MiscPatterns {
