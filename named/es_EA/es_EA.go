...
// DateFullLayout returns the full date layout for 'es_EA'
func (es *es_EA) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_EA'
func (es *es_EA) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_EA'
func (es *es_EA) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_EA'
func (es *es_EA) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_EA'
func (es *es_EA) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_EA'
func (es *es_EA) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_EA'
func (es *es_EA) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_EA'
func (es *es_EA) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_EA) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_EA) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_EA) GetMiscPatterns() *locales.MiscPatterns {
