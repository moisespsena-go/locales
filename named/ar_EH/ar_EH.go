...
// DateFullLayout returns the full date layout for 'ar_EH'
func (ar *ar_EH) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_EH'
func (ar *ar_EH) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_EH'
func (ar *ar_EH) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_EH'
func (ar *ar_EH) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_EH'
func (ar *ar_EH) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_EH'
func (ar *ar_EH) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_EH'
func (ar *ar_EH) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_EH'
func (ar *ar_EH) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_EH) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_EH) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_EH) GetMiscPatterns() *locales.MiscPatterns {
