...
// DateFullLayout returns the full date layout for 'teo_UG'
func (teo *teo_UG) DateFullLayout() string {
	return teo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'teo_UG'
func (teo *teo_UG) DateLongLayout() string {
	return teo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'teo_UG'
func (teo *teo_UG) DateMediumLayout() string {
	return teo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'teo_UG'
func (teo *teo_UG) DateShortLayout() string {
	return teo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'teo_UG'
func (teo *teo_UG) TimeFullLayout() string {
	return teo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'teo_UG'
func (teo *teo_UG) TimeLongLayout() string {
	return teo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'teo_UG'
func (teo *teo_UG) TimeMediumLayout() string {
	return teo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'teo_UG'
func (teo *teo_UG) TimeShortLayout() string {
	return teo.timeShortLayout
}

func (teo *teo_UG) ListPatterns() *locales.ListPatterns {
	return teo.listPatterns
}

func (teo *teo_UG) GetDurationSpec() *locales.DurationSpec {
	return teo.DurationSpec
}

func (teo *teo_UG) GetMiscPatterns() *locales.MiscPatterns {
