...
// DateFullLayout returns the full date layout for 'sah'
func (sah *sah) DateFullLayout() string {
	return sah.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sah'
func (sah *sah) DateLongLayout() string {
	return sah.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sah'
func (sah *sah) DateMediumLayout() string {
	return sah.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sah'
func (sah *sah) DateShortLayout() string {
	return sah.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sah'
func (sah *sah) TimeFullLayout() string {
	return sah.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sah'
func (sah *sah) TimeLongLayout() string {
	return sah.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sah'
func (sah *sah) TimeMediumLayout() string {
	return sah.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sah'
func (sah *sah) TimeShortLayout() string {
	return sah.timeShortLayout
}

func (sah *sah) ListPatterns() *locales.ListPatterns {
	return sah.listPatterns
}

func (sah *sah) GetDurationSpec() *locales.DurationSpec {
	return sah.DurationSpec
}

func (sah *sah) GetMiscPatterns() *locales.MiscPatterns {
