...
// DateFullLayout returns the full date layout for 'uz_Latn_UZ'
func (uz *uz_Latn_UZ) DateFullLayout() string {
	return uz.dateFullLayout
}

// DateLongLayout returns the long date layout for 'uz_Latn_UZ'
func (uz *uz_Latn_UZ) DateLongLayout() string {
	return uz.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'uz_Latn_UZ'
func (uz *uz_Latn_UZ) DateMediumLayout() string {
	return uz.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'uz_Latn_UZ'
func (uz *uz_Latn_UZ) DateShortLayout() string {
	return uz.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'uz_Latn_UZ'
func (uz *uz_Latn_UZ) TimeFullLayout() string {
	return uz.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'uz_Latn_UZ'
func (uz *uz_Latn_UZ) TimeLongLayout() string {
	return uz.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'uz_Latn_UZ'
func (uz *uz_Latn_UZ) TimeMediumLayout() string {
	return uz.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'uz_Latn_UZ'
func (uz *uz_Latn_UZ) TimeShortLayout() string {
	return uz.timeShortLayout
}

func (uz *uz_Latn_UZ) ListPatterns() *locales.ListPatterns {
	return uz.listPatterns
}

func (uz *uz_Latn_UZ) GetDurationSpec() *locales.DurationSpec {
	return uz.DurationSpec
}

func (uz *uz_Latn_UZ) GetMiscPatterns() *locales.MiscPatterns {
