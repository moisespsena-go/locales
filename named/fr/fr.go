	...
	return &fr{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"siècles", "%v siècle", "%v siècles", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"déc.", "%vdéc.", "%vdéc.", ""},
				Long:   &locales.CounterFormat{"décennies", "%v décennie", "%v décennies", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"a", "%va", "%va", "%v/a"},
				Long:   &locales.CounterFormat{"ans", "%v\u00a0an", "%v ans", "%v par an"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m.", "%vm.", "%vm.", "%v/m."},
				Long:   &locales.CounterFormat{"mois", "%v\u00a0mois", "%v\u00a0mois", "%v par mois"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sem.", "%vsem.", "%vsem.", "%v/sem."},
				Long:   &locales.CounterFormat{"semaines", "%v\u00a0semaine", "%v\u00a0semaines", "%v par semaine"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"j", "%vj", "%vj", "%v/j"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"h", "%vh", "%vh", "%v/h"},
				Long:   &locales.CounterFormat{"heures", "%v\u00a0heure", "%v\u00a0heures", "%v par heure"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%vmin", "%vmin", "%v/min"},
				Long:   &locales.CounterFormat{"minutes", "%v minute", "%v minutes", "%v par minute"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%vs", "%vs", "%v/s"},
				Long:   &locales.CounterFormat{"secondes", "%v\u00a0seconde", "%v\u00a0secondes", "%v par seconde"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"millisecondes", "%v\u00a0milliseconde", "%v\u00a0millisecondes", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%vμs", "%vμs", ""},
				Long:   &locales.CounterFormat{"microsecondes", "%v\u00a0microseconde", "%v\u00a0microsecondes", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%vns", "%vns", ""},
				Long:   &locales.CounterFormat{"nanosecondes", "%v\u00a0nanoseconde", "%v\u00a0nanosecondes", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"≈%[1]v",
			"≥%[1]v",
...
// DateFullLayout returns the full date layout for 'fr'
func (fr *fr) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr'
func (fr *fr) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr'
func (fr *fr) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr'
func (fr *fr) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr'
func (fr *fr) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr'
func (fr *fr) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr'
func (fr *fr) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr'
func (fr *fr) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr) GetMiscPatterns() *locales.MiscPatterns {
