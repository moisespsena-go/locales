...
// DateFullLayout returns the full date layout for 'ar_ER'
func (ar *ar_ER) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_ER'
func (ar *ar_ER) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_ER'
func (ar *ar_ER) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_ER'
func (ar *ar_ER) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_ER'
func (ar *ar_ER) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_ER'
func (ar *ar_ER) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_ER'
func (ar *ar_ER) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_ER'
func (ar *ar_ER) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_ER) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_ER) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_ER) GetMiscPatterns() *locales.MiscPatterns {
