...
// DateFullLayout returns the full date layout for 'ar_DJ'
func (ar *ar_DJ) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_DJ'
func (ar *ar_DJ) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_DJ'
func (ar *ar_DJ) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_DJ'
func (ar *ar_DJ) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_DJ'
func (ar *ar_DJ) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_DJ'
func (ar *ar_DJ) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_DJ'
func (ar *ar_DJ) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_DJ'
func (ar *ar_DJ) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_DJ) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_DJ) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_DJ) GetMiscPatterns() *locales.MiscPatterns {
