...
func New() locales.Translator {
	return &fr_CM{
		...
		TimeSpec: &locales.TimeSpec{
			...
			PeriodsAbbreviatedValue:  []string{"mat.", "soir"},
			PeriodsNarrowValue:       []string{"mat.", "soir"},
			PeriodsWideValue:         []string{"matin", "soir"},
...
// DateFullLayout returns the full date layout for 'fr_CM'
func (fr *fr_CM) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_CM'
func (fr *fr_CM) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_CM'
func (fr *fr_CM) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_CM'
func (fr *fr_CM) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_CM'
func (fr *fr_CM) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_CM'
func (fr *fr_CM) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_CM'
func (fr *fr_CM) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_CM'
func (fr *fr_CM) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_CM) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_CM) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_CM) GetMiscPatterns() *locales.MiscPatterns {
