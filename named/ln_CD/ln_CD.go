...
// DateFullLayout returns the full date layout for 'ln_CD'
func (ln *ln_CD) DateFullLayout() string {
	return ln.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ln_CD'
func (ln *ln_CD) DateLongLayout() string {
	return ln.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ln_CD'
func (ln *ln_CD) DateMediumLayout() string {
	return ln.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ln_CD'
func (ln *ln_CD) DateShortLayout() string {
	return ln.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ln_CD'
func (ln *ln_CD) TimeFullLayout() string {
	return ln.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ln_CD'
func (ln *ln_CD) TimeLongLayout() string {
	return ln.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ln_CD'
func (ln *ln_CD) TimeMediumLayout() string {
	return ln.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ln_CD'
func (ln *ln_CD) TimeShortLayout() string {
	return ln.timeShortLayout
}

func (ln *ln_CD) ListPatterns() *locales.ListPatterns {
	return ln.listPatterns
}

func (ln *ln_CD) GetDurationSpec() *locales.DurationSpec {
	return ln.DurationSpec
}

func (ln *ln_CD) GetMiscPatterns() *locales.MiscPatterns {
