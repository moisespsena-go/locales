...
// DateFullLayout returns the full date layout for 'hu_HU'
func (hu *hu_HU) DateFullLayout() string {
	return hu.dateFullLayout
}

// DateLongLayout returns the long date layout for 'hu_HU'
func (hu *hu_HU) DateLongLayout() string {
	return hu.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'hu_HU'
func (hu *hu_HU) DateMediumLayout() string {
	return hu.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'hu_HU'
func (hu *hu_HU) DateShortLayout() string {
	return hu.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'hu_HU'
func (hu *hu_HU) TimeFullLayout() string {
	return hu.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'hu_HU'
func (hu *hu_HU) TimeLongLayout() string {
	return hu.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'hu_HU'
func (hu *hu_HU) TimeMediumLayout() string {
	return hu.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'hu_HU'
func (hu *hu_HU) TimeShortLayout() string {
	return hu.timeShortLayout
}

func (hu *hu_HU) ListPatterns() *locales.ListPatterns {
	return hu.listPatterns
}

func (hu *hu_HU) GetDurationSpec() *locales.DurationSpec {
	return hu.DurationSpec
}

func (hu *hu_HU) GetMiscPatterns() *locales.MiscPatterns {
