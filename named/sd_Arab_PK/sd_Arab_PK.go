...
// New returns a new instance of translator for the 'sd_Arab_PK' locale
...
func (sd *sd_Arab_PK) Locale() string {
	return sd.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'sd_Arab_PK'
func (sd *sd_Arab_PK) PluralsCardinal() []locales.PluralRule {
	return sd.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'sd_Arab_PK'
func (sd *sd_Arab_PK) PluralsOrdinal() []locales.PluralRule {
	return sd.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'sd_Arab_PK'
func (sd *sd_Arab_PK) PluralsRange() []locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'sd_Arab_PK'
func (sd *sd_Arab_PK) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleOther
}
...
// DateFullLayout returns the full date layout for 'sd_Arab_PK'
func (sd *sd_Arab_PK) DateFullLayout() string {
	return sd.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sd_Arab_PK'
func (sd *sd_Arab_PK) DateLongLayout() string {
	return sd.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sd_Arab_PK'
func (sd *sd_Arab_PK) DateMediumLayout() string {
	return sd.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sd_Arab_PK'
func (sd *sd_Arab_PK) DateShortLayout() string {
	return sd.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sd_Arab_PK'
func (sd *sd_Arab_PK) TimeFullLayout() string {
	return sd.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sd_Arab_PK'
func (sd *sd_Arab_PK) TimeLongLayout() string {
	return sd.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sd_Arab_PK'
func (sd *sd_Arab_PK) TimeMediumLayout() string {
	return sd.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sd_Arab_PK'
func (sd *sd_Arab_PK) TimeShortLayout() string {
	return sd.timeShortLayout
}

func (sd *sd_Arab_PK) ListPatterns() *locales.ListPatterns {
	return sd.listPatterns
}

func (sd *sd_Arab_PK) GetDurationSpec() *locales.DurationSpec {
	return sd.DurationSpec
}

func (sd *sd_Arab_PK) GetMiscPatterns() *locales.MiscPatterns {
