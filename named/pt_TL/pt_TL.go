...
func New() locales.Translator {
	return &pt_TL{
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"", "{0}, {1}", "{0}, {1}", ""}, []string(nil)}),
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"+%[1]v",
			"≤%[1]v",
...
// DateFullLayout returns the full date layout for 'pt_TL'
func (pt *pt_TL) DateFullLayout() string {
	return pt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pt_TL'
func (pt *pt_TL) DateLongLayout() string {
	return pt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pt_TL'
func (pt *pt_TL) DateMediumLayout() string {
	return pt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pt_TL'
func (pt *pt_TL) DateShortLayout() string {
	return pt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pt_TL'
func (pt *pt_TL) TimeFullLayout() string {
	return pt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pt_TL'
func (pt *pt_TL) TimeLongLayout() string {
	return pt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pt_TL'
func (pt *pt_TL) TimeMediumLayout() string {
	return pt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pt_TL'
func (pt *pt_TL) TimeShortLayout() string {
	return pt.timeShortLayout
}

func (pt *pt_TL) ListPatterns() *locales.ListPatterns {
	return pt.listPatterns
}

func (pt *pt_TL) GetDurationSpec() *locales.DurationSpec {
	return pt.DurationSpec
}

func (pt *pt_TL) GetMiscPatterns() *locales.MiscPatterns {
