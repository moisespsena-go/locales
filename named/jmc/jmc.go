...
// DateFullLayout returns the full date layout for 'jmc'
func (jmc *jmc) DateFullLayout() string {
	return jmc.dateFullLayout
}

// DateLongLayout returns the long date layout for 'jmc'
func (jmc *jmc) DateLongLayout() string {
	return jmc.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'jmc'
func (jmc *jmc) DateMediumLayout() string {
	return jmc.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'jmc'
func (jmc *jmc) DateShortLayout() string {
	return jmc.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'jmc'
func (jmc *jmc) TimeFullLayout() string {
	return jmc.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'jmc'
func (jmc *jmc) TimeLongLayout() string {
	return jmc.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'jmc'
func (jmc *jmc) TimeMediumLayout() string {
	return jmc.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'jmc'
func (jmc *jmc) TimeShortLayout() string {
	return jmc.timeShortLayout
}

func (jmc *jmc) ListPatterns() *locales.ListPatterns {
	return jmc.listPatterns
}

func (jmc *jmc) GetDurationSpec() *locales.DurationSpec {
	return jmc.DurationSpec
}

func (jmc *jmc) GetMiscPatterns() *locales.MiscPatterns {
