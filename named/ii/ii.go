...
// DateFullLayout returns the full date layout for 'ii'
func (ii *ii) DateFullLayout() string {
	return ii.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ii'
func (ii *ii) DateLongLayout() string {
	return ii.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ii'
func (ii *ii) DateMediumLayout() string {
	return ii.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ii'
func (ii *ii) DateShortLayout() string {
	return ii.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ii'
func (ii *ii) TimeFullLayout() string {
	return ii.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ii'
func (ii *ii) TimeLongLayout() string {
	return ii.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ii'
func (ii *ii) TimeMediumLayout() string {
	return ii.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ii'
func (ii *ii) TimeShortLayout() string {
	return ii.timeShortLayout
}

func (ii *ii) ListPatterns() *locales.ListPatterns {
	return ii.listPatterns
}

func (ii *ii) GetDurationSpec() *locales.DurationSpec {
	return ii.DurationSpec
}

func (ii *ii) GetMiscPatterns() *locales.MiscPatterns {
