...
// DateFullLayout returns the full date layout for 'ta_SG'
func (ta *ta_SG) DateFullLayout() string {
	return ta.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ta_SG'
func (ta *ta_SG) DateLongLayout() string {
	return ta.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ta_SG'
func (ta *ta_SG) DateMediumLayout() string {
	return ta.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ta_SG'
func (ta *ta_SG) DateShortLayout() string {
	return ta.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ta_SG'
func (ta *ta_SG) TimeFullLayout() string {
	return ta.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ta_SG'
func (ta *ta_SG) TimeLongLayout() string {
	return ta.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ta_SG'
func (ta *ta_SG) TimeMediumLayout() string {
	return ta.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ta_SG'
func (ta *ta_SG) TimeShortLayout() string {
	return ta.timeShortLayout
}

func (ta *ta_SG) ListPatterns() *locales.ListPatterns {
	return ta.listPatterns
}

func (ta *ta_SG) GetDurationSpec() *locales.DurationSpec {
	return ta.DurationSpec
}

func (ta *ta_SG) GetMiscPatterns() *locales.MiscPatterns {
