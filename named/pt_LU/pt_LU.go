...
// DateFullLayout returns the full date layout for 'pt_LU'
func (pt *pt_LU) DateFullLayout() string {
	return pt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pt_LU'
func (pt *pt_LU) DateLongLayout() string {
	return pt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pt_LU'
func (pt *pt_LU) DateMediumLayout() string {
	return pt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pt_LU'
func (pt *pt_LU) DateShortLayout() string {
	return pt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pt_LU'
func (pt *pt_LU) TimeFullLayout() string {
	return pt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pt_LU'
func (pt *pt_LU) TimeLongLayout() string {
	return pt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pt_LU'
func (pt *pt_LU) TimeMediumLayout() string {
	return pt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pt_LU'
func (pt *pt_LU) TimeShortLayout() string {
	return pt.timeShortLayout
}

func (pt *pt_LU) ListPatterns() *locales.ListPatterns {
	return pt.listPatterns
}

func (pt *pt_LU) GetDurationSpec() *locales.DurationSpec {
	return pt.DurationSpec
}

func (pt *pt_LU) GetMiscPatterns() *locales.MiscPatterns {
