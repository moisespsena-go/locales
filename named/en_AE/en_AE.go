...
// DateFullLayout returns the full date layout for 'en_AE'
func (en *en_AE) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_AE'
func (en *en_AE) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_AE'
func (en *en_AE) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_AE'
func (en *en_AE) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_AE'
func (en *en_AE) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_AE'
func (en *en_AE) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_AE'
func (en *en_AE) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_AE'
func (en *en_AE) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_AE) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_AE) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_AE) GetMiscPatterns() *locales.MiscPatterns {
