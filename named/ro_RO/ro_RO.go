...
func New() locales.Translator {
	return &ro_RO{
		...
		TimeSpec: &locales.TimeSpec{
			...
			TimezonesValue:           map[string]string{"": "Ora standard din Paraguay", "ACDT": "Ora de vară a Australiei Centrale", "ACST": "Ora standard a Australiei Centrale", "ACT": "Ora standard Acre", "ACWDT": "Ora de vară a Australiei Central Occidentale", "ACWST": "Ora standard a Australiei Central Occidentale", "ADT": "Ora de vară în zona Atlantic nord-americană", "AEDT": "Ora de vară a Australiei Orientale", "AEST": "Ora standard a Australiei Orientale", "AFT": "Ora Afganistanului", "AKDT": "Ora de vară din Alaska", "AKST": "Ora standard din Alaska", "AMST": "Ora de vară a Amazonului", "AMT": "Ora standard a Amazonului", "ARST": "Ora de vară a Argentinei", "ART": "Ora standard a Argentinei", "AST": "Ora standard în zona Atlantic nord-americană", "AWDT": "Ora de vară a Australiei Occidentale", "AWST": "Ora standard a Australiei Occidentale", "BNT": "Ora din Brunei Darussalam", "BOT": "Ora Boliviei", "BRST": "Ora de vară a Brasiliei", "BRT": "Ora standard a Brasiliei", "BST": "Ora de vară din Bangladesh", "BTT": "Ora Bhutanului", "CAT": "Ora Africii Centrale", "CCT": "Ora Insulelor Cocos", "CDT": "Ora de vară centrală nord-americană", "CDT (Kuba)": "Ora de vară a Cubei", "CHADT": "Ora de vară din Chatham", "CHAST": "Ora standard din Chatham", "CLST": "Ora de vară din Chile", "CLT": "Ora standard din Chile", "COST": "Ora de vară a Columbiei", "COT": "Ora standard a Columbiei", "CST": "Ora standard centrală nord-americană", "CST (Kuba)": "Ora standard a Cubei", "CXT": "Ora din Insula Christmas", "ChST": "Ora din Chamorro", "EASST": "Ora de vară din Insula Paștelui", "EAST": "Ora standard din Insula Paștelui", "EAT": "Ora Africii Orientale", "ECT": "Ora Ecuadorului", "EDT": "Ora de vară orientală nord-americană", "EGDT": "Ora de vară a Groenlandei orientale", "EGST": "Ora standard a Groenlandei orientale", "EST": "Ora standard orientală nord-americană", "FKST": "Ora de vară din Insulele Falkland", "GALT": "Ora din Galapagos", "GFT": "Ora din Guyana Franceză", "GMT": "Ora de Greenwhich", "GST": "Ora standard a Golfului", "GYT": "Ora din Guyana", "HADT": "Ora de vară din Hawaii-Aleutine", "HAST": "Ora standard din Hawaii-Aleutine", "HENOMX": "Ora de vară a Mexicului de nord-vest", "HEOG": "Ora de vară a Groenlandei occidentale", "HEPMX": "Ora de vară a zonei Pacific mexicane", "HKST": "Ora de vară din Hong Kong", "HKT": "Ora standard din Hong Kong", "HNNOMX": "Ora standard a Mexicului de nord-vest", "HNOG": "Ora standard a Groenlandei occidentale", "HNPMX": "Ora standard a zonei Pacific mexicane", "ICT": "Ora Indochinei", "IRDT": "Ora de vară a Iranului", "IRST": "Ora standard a Iranului", "IST": "Ora Indiei", "JDT": "Ora de vară a Japoniei", "JST": "Ora standard a Japoniei", "LHDT": "Ora de vară din Lord Howe", "LHST": "Ora standard din Lord Howe", "MDT": "Ora de vară în zona montană nord-americană", "MESZ": "Ora de vară a Europei Centrale", "MEZ": "Ora standard a Europei Centrale", "MST": "Ora standard în zona montană nord-americană", "MVT": "Ora din Maldive", "MYT": "Ora din Malaysia", "NDT": "Ora de vară din Newfoundland", "NPT": "Ora Nepalului", "NST": "Ora standard din Newfoundland", "NZDT": "Ora de vară a Noii Zeelande", "NZST": "Ora standard a Noii Zeelande", "OESZ": "Ora de vară a Europei de Est", "OEZ": "Ora standard a Europei de Est", "PDT": "Ora de vară în zona Pacific nord-americană", "PKT": "Ora de vară a Pakistanului", "PMDT": "Ora de vară din Saint-Pierre și Miquelon", "PMST": "Ora standard din Saint-Pierre și Miquelon", "PST": "Ora standard în zona Pacific nord-americană", "PYST": "Ora de vară din Paraguay", "SAST": "Ora Africii Meridionale", "SGT": "Ora din Singapore", "SRT": "Ora Surinamului", "TLT": "Ora Timorului de Est", "TMST": "Ora de vară din Turkmenistan", "TMT": "Ora standard din Turkmenistan", "UYST": "Ora de vară a Uruguayului", "UYT": "Ora standard a Uruguayului", "VET": "Ora Venezuelei", "WARST": "Ora de vară a Argentinei Occidentale", "WART": "Ora standard a Argentinei Occidentale", "WAST": "Ora de vară a Africii Occidentale", "WAT": "Ora standard a Africii Occidentale", "WESZ": "Ora de vară a Europei de Vest", "WEZ": "Ora standard a Europei de Vest", "WIB": "Ora Indoneziei de Vest", "WIT": "Ora Indoneziei de Est", "WITA": "Ora Indoneziei Centrale", "∅∅∅": "Ora de vară din Peru"},
		},
...
// DateFullLayout returns the full date layout for 'ro_RO'
func (ro *ro_RO) DateFullLayout() string {
	return ro.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ro_RO'
func (ro *ro_RO) DateLongLayout() string {
	return ro.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ro_RO'
func (ro *ro_RO) DateMediumLayout() string {
	return ro.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ro_RO'
func (ro *ro_RO) DateShortLayout() string {
	return ro.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ro_RO'
func (ro *ro_RO) TimeFullLayout() string {
	return ro.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ro_RO'
func (ro *ro_RO) TimeLongLayout() string {
	return ro.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ro_RO'
func (ro *ro_RO) TimeMediumLayout() string {
	return ro.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ro_RO'
func (ro *ro_RO) TimeShortLayout() string {
	return ro.timeShortLayout
}

func (ro *ro_RO) ListPatterns() *locales.ListPatterns {
	return ro.listPatterns
}

func (ro *ro_RO) GetDurationSpec() *locales.DurationSpec {
	return ro.DurationSpec
}

func (ro *ro_RO) GetMiscPatterns() *locales.MiscPatterns {
