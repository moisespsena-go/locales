...
// DateFullLayout returns the full date layout for 'ar_SO'
func (ar *ar_SO) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_SO'
func (ar *ar_SO) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_SO'
func (ar *ar_SO) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_SO'
func (ar *ar_SO) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_SO'
func (ar *ar_SO) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_SO'
func (ar *ar_SO) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_SO'
func (ar *ar_SO) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_SO'
func (ar *ar_SO) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_SO) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_SO) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_SO) GetMiscPatterns() *locales.MiscPatterns {
