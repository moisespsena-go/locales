...
func New() locales.Translator {
	return &yo_BJ{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Shɛ́r", "Èrèl", "Ɛrɛ̀n", "Ìgb", "Ɛ̀bi", "Òkú", "Agɛ", "Ògú", "Owe", "Ɔ̀wà", "Bél", "Ɔ̀pɛ"},
			MonthsNarrowValue:        []string{"", "S", "È", "Ɛ", "Ì", "Ɛ̀", "Ò", "A", "Ò", "O", "Ɔ̀", "B", "Ɔ̀"},
			MonthsWideValue:          []string{"", "Oshù Shɛ́rɛ́", "Oshù Èrèlè", "Oshù Ɛrɛ̀nà", "Oshù Ìgbé", "Oshù Ɛ̀bibi", "Oshù Òkúdu", "Oshù Agɛmɔ", "Oshù Ògún", "Oshù Owewe", "Oshù Ɔ̀wàrà", "Oshù Bélú", "Oshù Ɔ̀pɛ̀"},
			WeekdaysAbbreviatedValue: []string{"Àìk", "Aj", "Ìsɛ́g", "Ɔjɔ́r", "Ɔjɔ́b", "Ɛt", "Àbám"},
			WeekdaysNarrowValue:      []string{"À", "A", "Ì", "Ɔ", "Ɔ", "Ɛ", "À"},
			WeekdaysWideValue:        []string{"Ɔjɔ́ Àìkú", "Ɔjɔ́ Ajé", "Ɔjɔ́ Ìsɛ́gun", "Ɔjɔ́rú", "Ɔjɔ́bɔ", "Ɔjɔ́ Ɛtì", "Ɔjɔ́ Àbámɛ́ta"},
			PeriodsAbbreviatedValue:  []string{"Àárɔ̀", "Ɔ̀sán"},
			PeriodsNarrowValue:       []string{"Àárɔ̀", "Ɔ̀sán"},
			PeriodsWideValue:         []string{"Àárɔ̀", "Ɔ̀sán"},
			ErasAbbreviatedValue:     []string{"", ""},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"", ""},
			TimezonesValue:           map[string]string{"": "Àkókò Àfɛnukò Etíkun Fókílándì", "ACDT": "Australian Central Daylight Time", "ACST": "Australian Central Standard Time", "ACT": "ACT", "ACWDT": "Australian Central Western Daylight Time", "ACWST": "Australian Central Western Standard Time", "ADT": "Àkókò Ìyálɛta Àtìláńtíìkì", "AEDT": "Australian Eastern Daylight Time", "AEST": "Australian Eastern Standard Time", "AFT": "Afghanistan Time", "AKDT": "Àkókò Ìyálɛ̀ta Alásíkà", "AKST": "Àkókò Àfɛnukò Alásíkà", "AMST": "Àkókò Oru Amásɔ́nì", "AMT": "Àkókò Afɛnukò Amásɔ́nì", "ARST": "Aago Soma Argentina", "ART": "Aago àsìkò Argentina", "AST": "Àkókò àsikò Àtìláńtíìkì", "AWDT": "Australian Western Daylight Time", "AWST": "Australian Western Standard Time", "BNT": "Brunei Darussalam Time", "BOT": "Aago Bolivia", "BRST": "Aago Soma Brasilia", "BRT": "Aago àsìkò Bùràsílíà", "BST": "Bangladesh Summer Time", "BTT": "Bhutan Time", "CAT": "Àkókò Àárín Afírikà", "CCT": "Cocos Islands Time", "CDT": "Akókò àárín gbùngbùn ojúmɔmɔ", "CDT (Kuba)": "Àkókò Ojúmɔmɔ Kúbà", "CHADT": "Chatham Daylight Time", "CHAST": "Chatham Standard Time", "CLST": "Àkókò Oru Shílè", "CLT": "Àkókò Àfɛnukò Shílè", "COST": "Aago Soma Colombia", "COT": "Aago àsìkò Kolombia", "CST": "àkókò asiko àárín gbùngbùn", "CST (Kuba)": "Àkókò Àfɛnukò Kúbà", "CXT": "Christmas Island Time", "ChST": "Chamorro Standard Time", "EASST": "Aago Soma Easter Island", "EAST": "Aago àsìkò Easter Island", "EAT": "Àkókò Ìlà-Oòrùn Afírikà", "ECT": "Aago Ecuador", "EDT": "Àkókò ojúmɔmɔ Ìhà Ìlà Oòrun", "EGDT": "Àkókò ìgbà Ooru Greenland", "EGST": "Àkókò Ìwɔ̀ Ìfɛnukò oorùn Greenland", "EST": "Akókò Àsikò Ìha Ìla Oòrùn", "FKST": "Àkókò Ooru Etíkun Fókílándì", "GALT": "Aago Galapago", "GFT": "Àkókò Gúyánà Fáránsè", "GMT": "Greenwich Mean Time", "GST": "Gulf Standard Time [translation hint: translate as just \"Gulf Time\"]", "GYT": "Àkókò Gúyànà", "HADT": "Àkókò Ojúmɔmɔ Hawaii-Aleutian", "HAST": "Àkókò Àfɛnukò Hawaii-Aleutian", "HENOMX": "Àkókò Ojúmɔmɔ Apá Ìwɔ̀ Oorùn Mɛ́shíkò", "HEOG": "Àkókò Àfɛnukò Ìgba Oòru Greenland", "HEPMX": "Àkókò Ojúmɔmɔ Pásífíìkì Mɛ́síkò", "HKST": "Hong Kong Summer Time", "HKT": "Hong Kong Standard Time", "HNNOMX": "Àkókò Àfɛnukò Apá Ìwɔ̀ Oorùn Mɛ́shíkò", "HNOG": "Àkókò Àfɛnukò Ìwɔ̀ Oòrùn Greenland", "HNPMX": "Àkókò Àfɛnukò Pásífíìkì Mɛ́síkò", "ICT": "Àkókò Indochina", "IRDT": "Iran Daylight Time", "IRST": "Iran Standard Time", "IST": "India Standard Time", "JDT": "Japan Daylight Time", "JST": "Japan Standard Time", "LHDT": "Lord Howe Daylight Time", "LHST": "Lord Howe Standard Time", "MDT": "MDT", "MESZ": "Àkókò Àárin Sɔmà Europe", "MEZ": "Àkókò Àárin àsikò Europe", "MST": "MST", "MVT": "Maldives Time", "MYT": "Malaysia Time", "NDT": "Àkókò Ojúmɔmɔ Newfoundland", "NPT": "Nepal Time", "NST": "Àkókò Àfɛnukò Newfoundland", "NZDT": "New Zealand Daylight Time", "NZST": "New Zealand Standard Time", "OESZ": "Àkókò Sɔmà Ìha Ìlà Oòrùn Europe", "OEZ": "Àkókò àsikò Ìhà Ìlà Oòrùn Europe", "PDT": "Àkókò Ìyálɛta Pàsífíìkì", "PKT": "Pakistan Summer Time", "PMDT": "Àkókò Ojúmɔmɔ Pierre & Miquelon", "PMST": "Àkókò Àfɛnukò Pierre & Miquelon", "PST": "Àkókò àsikò Pàsífíìkì", "PYST": "Àkókò Ooru Párágúwè", "SAST": "South Africa Standard Time", "SGT": "Singapore Standard Time", "SRT": "Àkókò Súrínámù", "TLT": "Àkókò Ìlà oorùn Timor", "TMST": "Turkmenistan Summer Time", "TMT": "Turkmenistan Standard Time", "UYST": "Aago Soma Uruguay", "UYT": "Àkókò Àfɛnukò Úrúgúwè", "VET": "Aago Venezuela", "WARST": "Àkókò Oru Iwɔ́-oòrùn Ajɛ́ntínà", "WART": "Àkókò Iwɔ́-oòrùn Àfɛnukò Ajɛ́ntínà", "WAST": "Àkókò Ìwɔ̀-Oòrùn Ooru Afírikà", "WAT": "Àkókò Ìwɔ̀-Oòrùn Àfɛnukò Afírikà", "WESZ": "Àkókò Sɔmà Ìhà Ìwɔ Oòrùn Europe", "WEZ": "Àkókò àsikò Ìwɔ Oòrùn Europe", "WIB": "Àkókò Ìwɔ̀ oorùn Indonesia", "WIT": "Eastern Indonesia Time", "WITA": "Àkókò Ààrin Gbùngbùn Indonesia", "∅∅∅": "Àkókò Ooru Pérù"},
		},
...
// DateFullLayout returns the full date layout for 'yo_BJ'
func (yo *yo_BJ) DateFullLayout() string {
	return yo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'yo_BJ'
func (yo *yo_BJ) DateLongLayout() string {
	return yo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'yo_BJ'
func (yo *yo_BJ) DateMediumLayout() string {
	return yo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'yo_BJ'
func (yo *yo_BJ) DateShortLayout() string {
	return yo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'yo_BJ'
func (yo *yo_BJ) TimeFullLayout() string {
	return yo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'yo_BJ'
func (yo *yo_BJ) TimeLongLayout() string {
	return yo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'yo_BJ'
func (yo *yo_BJ) TimeMediumLayout() string {
	return yo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'yo_BJ'
func (yo *yo_BJ) TimeShortLayout() string {
	return yo.timeShortLayout
}

func (yo *yo_BJ) ListPatterns() *locales.ListPatterns {
	return yo.listPatterns
}

func (yo *yo_BJ) GetDurationSpec() *locales.DurationSpec {
	return yo.DurationSpec
}

func (yo *yo_BJ) GetMiscPatterns() *locales.MiscPatterns {
