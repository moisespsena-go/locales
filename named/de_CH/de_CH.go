...
// DateFullLayout returns the full date layout for 'de_CH'
func (de *de_CH) DateFullLayout() string {
	return de.dateFullLayout
}

// DateLongLayout returns the long date layout for 'de_CH'
func (de *de_CH) DateLongLayout() string {
	return de.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'de_CH'
func (de *de_CH) DateMediumLayout() string {
	return de.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'de_CH'
func (de *de_CH) DateShortLayout() string {
	return de.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'de_CH'
func (de *de_CH) TimeFullLayout() string {
	return de.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'de_CH'
func (de *de_CH) TimeLongLayout() string {
	return de.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'de_CH'
func (de *de_CH) TimeMediumLayout() string {
	return de.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'de_CH'
func (de *de_CH) TimeShortLayout() string {
	return de.timeShortLayout
}

func (de *de_CH) ListPatterns() *locales.ListPatterns {
	return de.listPatterns
}

func (de *de_CH) GetDurationSpec() *locales.DurationSpec {
	return de.DurationSpec
}

func (de *de_CH) GetMiscPatterns() *locales.MiscPatterns {
