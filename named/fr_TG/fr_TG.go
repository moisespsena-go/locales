...
// DateFullLayout returns the full date layout for 'fr_TG'
func (fr *fr_TG) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_TG'
func (fr *fr_TG) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_TG'
func (fr *fr_TG) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_TG'
func (fr *fr_TG) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_TG'
func (fr *fr_TG) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_TG'
func (fr *fr_TG) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_TG'
func (fr *fr_TG) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_TG'
func (fr *fr_TG) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_TG) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_TG) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_TG) GetMiscPatterns() *locales.MiscPatterns {
