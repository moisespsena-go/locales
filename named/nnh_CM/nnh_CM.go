...
func New() locales.Translator {
	return &nnh_CM{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "saŋ tsetsɛ̀ɛ lùm", "saŋ kàg ngwóŋ", "saŋ lepyè shúm", "saŋ cÿó", "saŋ tsɛ̀ɛ cÿó", "saŋ njÿoláʼ", "saŋ tyɛ̀b tyɛ̀b mbʉ̀ŋ", "saŋ mbʉ̀ŋ", "saŋ ngwɔ̀ʼ mbÿɛ", "saŋ tàŋa tsetsáʼ", "saŋ mejwoŋó", "saŋ lùm"},
			MonthsWideValue:          []string{"", "saŋ tsetsɛ̀ɛ lùm", "saŋ kàg ngwóŋ", "saŋ lepyè shúm", "saŋ cÿó", "saŋ tsɛ̀ɛ cÿó", "saŋ njÿoláʼ", "saŋ tyɛ̀b tyɛ̀b mbʉ̀ŋ", "saŋ mbʉ̀ŋ", "saŋ ngwɔ̀ʼ mbÿɛ", "saŋ tàŋa tsetsáʼ", "saŋ mejwoŋó", "saŋ lùm"},
			WeekdaysAbbreviatedValue: []string{"lyɛʼɛ́ sẅíŋtè", "mvfò lyɛ̌ʼ", "mbɔ́ɔntè mvfò lyɛ̌ʼ", "tsètsɛ̀ɛ lyɛ̌ʼ", "mbɔ́ɔntè tsetsɛ̀ɛ lyɛ̌ʼ", "mvfò màga lyɛ̌ʼ", "màga lyɛ̌ʼ"},
			WeekdaysShortValue:       []string{"lyɛʼɛ́ sẅíŋtè", "mvfò lyɛ̌ʼ", "mbɔ́ɔntè mvfò lyɛ̌ʼ", "tsètsɛ̀ɛ lyɛ̌ʼ", "mbɔ́ɔntè tsetsɛ̀ɛ lyɛ̌ʼ", "mvfò màga lyɛ̌ʼ", "màga lyɛ̌ʼ"},
			WeekdaysWideValue:        []string{"lyɛʼɛ́ sẅíŋtè", "mvfò lyɛ̌ʼ", "mbɔ́ɔntè mvfò lyɛ̌ʼ", "tsètsɛ̀ɛ lyɛ̌ʼ", "mbɔ́ɔntè tsetsɛ̀ɛ lyɛ̌ʼ", "mvfò màga lyɛ̌ʼ", "màga lyɛ̌ʼ"},
			PeriodsAbbreviatedValue:  []string{"mbaʼámbaʼ", "ncwònzém"},
			PeriodsWideValue:         []string{"mbaʼámbaʼ", "ncwònzém"},
			ErasAbbreviatedValue:     []string{"m.z.Y.", "m.g.n.Y."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"mé zyé Yěsô", "mé gÿo ńzyé Yěsô"},
		...
		dateFullLayout:   "EEEE , 'lyɛ'̌ʼ d 'na' MMMM, y",
		dateLongLayout:   "'lyɛ'̌ʼ d 'na' MMMM, y",
...
func (nnh *nnh_CM) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(nnh, nnh.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'nnh_CM'
func (nnh *nnh_CM) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(nnh, nnh.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'nnh_CM'
func (nnh *nnh_CM) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(nnh, nnh.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'nnh_CM'
func (nnh *nnh_CM) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(nnh, nnh.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'nnh_CM'
func (nnh *nnh_CM) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(nnh, nnh.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'nnh_CM'
func (nnh *nnh_CM) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(nnh, nnh.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'nnh_CM'
func (nnh *nnh_CM) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(nnh, nnh.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'nnh_CM'
func (nnh *nnh_CM) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(nnh, nnh.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'nnh_CM'
func (nnh *nnh_CM) DateFullLayout() string {
	return nnh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nnh_CM'
func (nnh *nnh_CM) DateLongLayout() string {
	return nnh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nnh_CM'
func (nnh *nnh_CM) DateMediumLayout() string {
	return nnh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nnh_CM'
func (nnh *nnh_CM) DateShortLayout() string {
	return nnh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nnh_CM'
func (nnh *nnh_CM) TimeFullLayout() string {
	return nnh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nnh_CM'
func (nnh *nnh_CM) TimeLongLayout() string {
	return nnh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nnh_CM'
func (nnh *nnh_CM) TimeMediumLayout() string {
	return nnh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nnh_CM'
func (nnh *nnh_CM) TimeShortLayout() string {
	return nnh.timeShortLayout
}

func (nnh *nnh_CM) ListPatterns() *locales.ListPatterns {
	return nnh.listPatterns
}

func (nnh *nnh_CM) GetDurationSpec() *locales.DurationSpec {
	return nnh.DurationSpec
}

func (nnh *nnh_CM) GetMiscPatterns() *locales.MiscPatterns {
	return &nnh.miscPatterns
}
