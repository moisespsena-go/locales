...
// DateFullLayout returns the full date layout for 'se_SE'
func (se *se_SE) DateFullLayout() string {
	return se.dateFullLayout
}

// DateLongLayout returns the long date layout for 'se_SE'
func (se *se_SE) DateLongLayout() string {
	return se.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'se_SE'
func (se *se_SE) DateMediumLayout() string {
	return se.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'se_SE'
func (se *se_SE) DateShortLayout() string {
	return se.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'se_SE'
func (se *se_SE) TimeFullLayout() string {
	return se.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'se_SE'
func (se *se_SE) TimeLongLayout() string {
	return se.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'se_SE'
func (se *se_SE) TimeMediumLayout() string {
	return se.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'se_SE'
func (se *se_SE) TimeShortLayout() string {
	return se.timeShortLayout
}

func (se *se_SE) ListPatterns() *locales.ListPatterns {
	return se.listPatterns
}

func (se *se_SE) GetDurationSpec() *locales.DurationSpec {
	return se.DurationSpec
}

func (se *se_SE) GetMiscPatterns() *locales.MiscPatterns {
