...
// DateFullLayout returns the full date layout for 'id'
func (id *id) DateFullLayout() string {
	return id.dateFullLayout
}

// DateLongLayout returns the long date layout for 'id'
func (id *id) DateLongLayout() string {
	return id.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'id'
func (id *id) DateMediumLayout() string {
	return id.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'id'
func (id *id) DateShortLayout() string {
	return id.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'id'
func (id *id) TimeFullLayout() string {
	return id.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'id'
func (id *id) TimeLongLayout() string {
	return id.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'id'
func (id *id) TimeMediumLayout() string {
	return id.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'id'
func (id *id) TimeShortLayout() string {
	return id.timeShortLayout
}

func (id *id) ListPatterns() *locales.ListPatterns {
	return id.listPatterns
}

func (id *id) GetDurationSpec() *locales.DurationSpec {
	return id.DurationSpec
}

func (id *id) GetMiscPatterns() *locales.MiscPatterns {
