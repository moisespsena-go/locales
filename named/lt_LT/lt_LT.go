...
// DateFullLayout returns the full date layout for 'lt_LT'
func (lt *lt_LT) DateFullLayout() string {
	return lt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'lt_LT'
func (lt *lt_LT) DateLongLayout() string {
	return lt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'lt_LT'
func (lt *lt_LT) DateMediumLayout() string {
	return lt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'lt_LT'
func (lt *lt_LT) DateShortLayout() string {
	return lt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'lt_LT'
func (lt *lt_LT) TimeFullLayout() string {
	return lt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'lt_LT'
func (lt *lt_LT) TimeLongLayout() string {
	return lt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'lt_LT'
func (lt *lt_LT) TimeMediumLayout() string {
	return lt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'lt_LT'
func (lt *lt_LT) TimeShortLayout() string {
	return lt.timeShortLayout
}

func (lt *lt_LT) ListPatterns() *locales.ListPatterns {
	return lt.listPatterns
}

func (lt *lt_LT) GetDurationSpec() *locales.DurationSpec {
	return lt.DurationSpec
}

func (lt *lt_LT) GetMiscPatterns() *locales.MiscPatterns {
