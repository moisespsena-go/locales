...
// DateFullLayout returns the full date layout for 'uz_Arab_AF'
func (uz *uz_Arab_AF) DateFullLayout() string {
	return uz.dateFullLayout
}

// DateLongLayout returns the long date layout for 'uz_Arab_AF'
func (uz *uz_Arab_AF) DateLongLayout() string {
	return uz.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'uz_Arab_AF'
func (uz *uz_Arab_AF) DateMediumLayout() string {
	return uz.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'uz_Arab_AF'
func (uz *uz_Arab_AF) DateShortLayout() string {
	return uz.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'uz_Arab_AF'
func (uz *uz_Arab_AF) TimeFullLayout() string {
	return uz.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'uz_Arab_AF'
func (uz *uz_Arab_AF) TimeLongLayout() string {
	return uz.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'uz_Arab_AF'
func (uz *uz_Arab_AF) TimeMediumLayout() string {
	return uz.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'uz_Arab_AF'
func (uz *uz_Arab_AF) TimeShortLayout() string {
	return uz.timeShortLayout
}

func (uz *uz_Arab_AF) ListPatterns() *locales.ListPatterns {
	return uz.listPatterns
}

func (uz *uz_Arab_AF) GetDurationSpec() *locales.DurationSpec {
	return uz.DurationSpec
}

func (uz *uz_Arab_AF) GetMiscPatterns() *locales.MiscPatterns {
