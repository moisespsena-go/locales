...
// DateFullLayout returns the full date layout for 'en_TT'
func (en *en_TT) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_TT'
func (en *en_TT) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_TT'
func (en *en_TT) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_TT'
func (en *en_TT) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_TT'
func (en *en_TT) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_TT'
func (en *en_TT) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_TT'
func (en *en_TT) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_TT'
func (en *en_TT) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_TT) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_TT) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_TT) GetMiscPatterns() *locales.MiscPatterns {
