...
// DateFullLayout returns the full date layout for 'sa'
func (sa *sa) DateFullLayout() string {
	return sa.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sa'
func (sa *sa) DateLongLayout() string {
	return sa.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sa'
func (sa *sa) DateMediumLayout() string {
	return sa.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sa'
func (sa *sa) DateShortLayout() string {
	return sa.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sa'
func (sa *sa) TimeFullLayout() string {
	return sa.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sa'
func (sa *sa) TimeLongLayout() string {
	return sa.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sa'
func (sa *sa) TimeMediumLayout() string {
	return sa.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sa'
func (sa *sa) TimeShortLayout() string {
	return sa.timeShortLayout
}

func (sa *sa) ListPatterns() *locales.ListPatterns {
	return sa.listPatterns
}

func (sa *sa) GetDurationSpec() *locales.DurationSpec {
	return sa.DurationSpec
}

func (sa *sa) GetMiscPatterns() *locales.MiscPatterns {
