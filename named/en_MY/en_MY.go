...
// DateFullLayout returns the full date layout for 'en_MY'
func (en *en_MY) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_MY'
func (en *en_MY) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_MY'
func (en *en_MY) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_MY'
func (en *en_MY) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_MY'
func (en *en_MY) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_MY'
func (en *en_MY) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_MY'
func (en *en_MY) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_MY'
func (en *en_MY) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_MY) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_MY) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_MY) GetMiscPatterns() *locales.MiscPatterns {
