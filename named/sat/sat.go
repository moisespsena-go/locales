...
// DateFullLayout returns the full date layout for 'sat'
func (sat *sat) DateFullLayout() string {
	return sat.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sat'
func (sat *sat) DateLongLayout() string {
	return sat.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sat'
func (sat *sat) DateMediumLayout() string {
	return sat.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sat'
func (sat *sat) DateShortLayout() string {
	return sat.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sat'
func (sat *sat) TimeFullLayout() string {
	return sat.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sat'
func (sat *sat) TimeLongLayout() string {
	return sat.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sat'
func (sat *sat) TimeMediumLayout() string {
	return sat.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sat'
func (sat *sat) TimeShortLayout() string {
	return sat.timeShortLayout
}

func (sat *sat) ListPatterns() *locales.ListPatterns {
	return sat.listPatterns
}

func (sat *sat) GetDurationSpec() *locales.DurationSpec {
	return sat.DurationSpec
}

func (sat *sat) GetMiscPatterns() *locales.MiscPatterns {
