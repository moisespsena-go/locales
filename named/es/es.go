...
func New() locales.Translator {
	return &es{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						...
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0000 M¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0000 M¤"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 mil M¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 mil M¤"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 mil M¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 mil M¤"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 B¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 B¤"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 B¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 B¤"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 B¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 B¤"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ene", "feb", "mar", "abr", "may", "jun", "jul", "ago", "sept", "oct", "nov", "dic"},
			MonthsNarrowValue:        []string{"", "E", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "enero", "febrero", "marzo", "abril", "mayo", "junio", "julio", "agosto", "septiembre", "octubre", "noviembre", "diciembre"},
			WeekdaysAbbreviatedValue: []string{"dom", "lun", "mar", "mié", "jue", "vie", "sáb"},
			WeekdaysNarrowValue:      []string{"D", "L", "M", "X", "J", "V", "S"},
			WeekdaysShortValue:       []string{"DO", "LU", "MA", "MI", "JU", "VI", "SA"},
			WeekdaysWideValue:        []string{"domingo", "lunes", "martes", "miércoles", "jueves", "viernes", "sábado"},
			PeriodsAbbreviatedValue:  []string{"a.\u00a0m.", "p.\u00a0m."},
			PeriodsNarrowValue:       []string{"a.\u00a0m.", "p.\u00a0m."},
			PeriodsWideValue:         []string{"a.\u00a0m.", "p.\u00a0m."},
			ErasAbbreviatedValue:     []string{"a. C.", "d. C."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"antes de Cristo", "después de Cristo"},
			TimezonesValue:           map[string]string{"": "hora estándar de las islas Malvinas", "ACDT": "hora de verano de Australia central", "ACST": "Hora de verano de Acre", "ACT": "Hora estándar de Acre", "ACWDT": "hora de verano de Australia centroccidental", "ACWST": "hora estándar de Australia centroccidental", "ADT": "hora de verano del Atlántico", "AEDT": "hora de verano de Australia oriental", "AEST": "hora estándar de Australia oriental", "AFT": "hora de Afganistán", "AKDT": "hora de verano de Alaska", "AKST": "hora estándar de Alaska", "AMST": "hora de verano del Amazonas", "AMT": "hora estándar del Amazonas", "ARST": "hora de verano de Argentina", "ART": "hora estándar de Argentina", "AST": "hora estándar del Atlántico", "AWDT": "hora de verano de Australia occidental", "AWST": "hora estándar de Australia occidental", "BNT": "hora de Brunéi", "BOT": "hora de Bolivia", "BRST": "hora de verano de Brasilia", "BRT": "hora estándar de Brasilia", "BST": "hora de verano de Bangladés", "BTT": "hora de Bután", "CAT": "hora de África central", "CCT": "hora de las Islas Cocos", "CDT": "hora de verano central", "CDT (Kuba)": "hora de verano de Cuba", "CHADT": "hora de verano de Chatham", "CHAST": "hora estándar de Chatham", "CLST": "hora de verano de Chile", "CLT": "hora estándar de Chile", "COST": "hora de verano de Colombia", "COT": "hora estándar de Colombia", "CST": "hora estándar central", "CST (Kuba)": "hora estándar de Cuba", "CXT": "hora de la Isla de Navidad", "ChST": "hora estándar de Chamorro", "EASST": "hora de verano de la isla de Pascua", "EAST": "hora estándar de la isla de Pascua", "EAT": "hora de África oriental", "ECT": "hora de Ecuador", "EDT": "hora de verano oriental", "EGDT": "hora de verano de Groenlandia oriental", "EGST": "hora estándar de Groenlandia oriental", "EST": "hora estándar oriental", "FKST": "hora de verano de las islas Malvinas", "GALT": "hora de Galápagos", "GFT": "hora de la Guayana Francesa", "GMT": "hora del meridiano de Greenwich", "GST": "hora estándar del Golfo", "GYT": "hora de Guyana", "HADT": "hora de verano de Hawái-Aleutianas", "HAST": "hora estándar de Hawái-Aleutianas", "HENOMX": "hora de verano del noroeste de México", "HEOG": "hora de verano de Groenlandia occidental", "HEPMX": "hora de verano del Pacífico de México", "HKST": "hora de verano de Hong Kong", "HKT": "hora estándar de Hong Kong", "HNNOMX": "hora estándar del noroeste de México", "HNOG": "hora estándar de Groenlandia occidental", "HNPMX": "hora estándar del Pacífico de México", "ICT": "hora de Indochina", "IRDT": "hora de verano de Irán", "IRST": "hora estándar de Irán", "IST": "hora estándar de la India", "JDT": "hora de verano de Japón", "JST": "hora estándar de Japón", "LHDT": "hora de verano de Lord Howe", "LHST": "hora estándar de Lord Howe", "MDT": "Hora de verano de Macao", "MESZ": "hora de verano de Europa central", "MEZ": "hora estándar de Europa central", "MST": "Hora estándar de Macao", "MVT": "hora de Maldivas", "MYT": "hora de Malasia", "NDT": "hora de verano de Terranova", "NPT": "hora de Nepal", "NST": "hora estándar de Terranova", "NZDT": "hora de verano de Nueva Zelanda", "NZST": "hora estándar de Nueva Zelanda", "OESZ": "hora de verano de Europa oriental", "OEZ": "hora estándar de Europa oriental", "PDT": "hora de verano del Pacífico", "PKT": "hora de verano de Pakistán", "PMDT": "hora de verano de San Pedro y Miquelón", "PMST": "hora estándar de San Pedro y Miquelón", "PST": "hora estándar del Pacífico", "PYST": "hora de verano de Paraguay", "SAST": "hora de Sudáfrica", "SGT": "hora de Singapur", "SRT": "hora de Surinam", "TLT": "hora de Timor Oriental", "TMST": "hora de verano de Turkmenistán", "TMT": "hora estándar de Turkmenistán", "UYST": "hora de verano de Uruguay", "UYT": "hora estándar de Uruguay", "VET": "hora de Venezuela", "WARST": "hora de verano de Argentina occidental", "WART": "hora estándar de Argentina occidental", "WAST": "hora de verano de África occidental", "WAT": "hora estándar de África occidental", "WESZ": "hora de verano de Europa occidental", "WEZ": "hora estándar de Europa occidental", "WIB": "hora de Indonesia occidental", "WIT": "hora de Indonesia oriental", "WITA": "hora de Indonesia central", "∅∅∅": "hora de verano de Perú"},
		},
		...
		dateFullLayout:   "EEEE, d 'de' MMMM 'de' y",
		dateLongLayout:   "d 'de' MMMM 'de' y",
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"s", "%vs", "%vs", ""},
				Long:   &locales.CounterFormat{"siglos", "%v siglo", "%v siglos", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"déc", "%vdéc", "%vdéc", ""},
				Long:   &locales.CounterFormat{"décadas", "%v década", "%v décadas", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"a", "%va", "%va", "%v/a"},
				Long:   &locales.CounterFormat{"años", "%v año", "%v años", "%v por año"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m", "%vm", "%vm", "%v/m"},
				Long:   &locales.CounterFormat{"meses", "%v mes", "%v meses", "%v por mes"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sem", "%vsem", "%vsem", "%v/sem"},
				Long:   &locales.CounterFormat{"semanas", "%v semana", "%v semanas", "%v por semana"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"horas", "%v hora", "%v horas", "%v por hora"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%vmin", "%vmin", "%v/min"},
				Long:   &locales.CounterFormat{"minutos", "%v minuto", "%v minutos", "%v por minuto"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%vs", "%vs", "%v/s"},
				Long:   &locales.CounterFormat{"segundos", "%v segundo", "%v segundos", "%v por segundo"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"milisegundos", "%v milisegundo", "%v milisegundos", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%vμs", "%vμs", ""},
				Long:   &locales.CounterFormat{"microsegundos", "%v microsegundo", "%v microsegundos", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%vns", "%vns", ""},
				Long:   &locales.CounterFormat{"nanosegundos", "%v nanosegundo", "%v nanosegundos", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"Más de %[1]v",
...
func (es *es) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(es, es.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'es'
func (es *es) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(es, es.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'es'
func (es *es) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(es, es.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'es'
func (es *es) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(es, es.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'es'
func (es *es) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(es, es.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'es'
func (es *es) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(es, es.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'es'
func (es *es) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(es, es.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'es'
func (es *es) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(es, es.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'es'
func (es *es) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es'
func (es *es) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es'
func (es *es) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es'
func (es *es) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es'
func (es *es) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es'
func (es *es) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es'
func (es *es) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es'
func (es *es) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es) GetMiscPatterns() *locales.MiscPatterns {
	return &es.miscPatterns
}
