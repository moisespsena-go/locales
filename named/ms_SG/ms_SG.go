...
// DateFullLayout returns the full date layout for 'ms_SG'
func (ms *ms_SG) DateFullLayout() string {
	return ms.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ms_SG'
func (ms *ms_SG) DateLongLayout() string {
	return ms.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ms_SG'
func (ms *ms_SG) DateMediumLayout() string {
	return ms.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ms_SG'
func (ms *ms_SG) DateShortLayout() string {
	return ms.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ms_SG'
func (ms *ms_SG) TimeFullLayout() string {
	return ms.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ms_SG'
func (ms *ms_SG) TimeLongLayout() string {
	return ms.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ms_SG'
func (ms *ms_SG) TimeMediumLayout() string {
	return ms.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ms_SG'
func (ms *ms_SG) TimeShortLayout() string {
	return ms.timeShortLayout
}

func (ms *ms_SG) ListPatterns() *locales.ListPatterns {
	return ms.listPatterns
}

func (ms *ms_SG) GetDurationSpec() *locales.DurationSpec {
	return ms.DurationSpec
}

func (ms *ms_SG) GetMiscPatterns() *locales.MiscPatterns {
