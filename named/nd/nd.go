...
// DateFullLayout returns the full date layout for 'nd'
func (nd *nd) DateFullLayout() string {
	return nd.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nd'
func (nd *nd) DateLongLayout() string {
	return nd.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nd'
func (nd *nd) DateMediumLayout() string {
	return nd.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nd'
func (nd *nd) DateShortLayout() string {
	return nd.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nd'
func (nd *nd) TimeFullLayout() string {
	return nd.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nd'
func (nd *nd) TimeLongLayout() string {
	return nd.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nd'
func (nd *nd) TimeMediumLayout() string {
	return nd.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nd'
func (nd *nd) TimeShortLayout() string {
	return nd.timeShortLayout
}

func (nd *nd) ListPatterns() *locales.ListPatterns {
	return nd.listPatterns
}

func (nd *nd) GetDurationSpec() *locales.DurationSpec {
	return nd.DurationSpec
}

func (nd *nd) GetMiscPatterns() *locales.MiscPatterns {
