...
func New() locales.Translator {
	return &ksh{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 tsd ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 tsd ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 tsd ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 tsd ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 tsd ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 tsd ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Fäb", "Mäz", "Apr", "Mai", "Jun", "Jul", "Ouj", "Säp", "Okt", "Nov", "Dez"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "O", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Jannewa", "Fäbrowa", "Määz", "Aprell", "Mai", "Juuni", "Juuli", "Oujoß", "Septämber", "Oktohber", "Novämber", "Dezämber"},
			WeekdaysAbbreviatedValue: []string{"Su.", "Mo.", "Di.", "Me.", "Du.", "Fr.", "Sa."},
			WeekdaysNarrowValue:      []string{"S", "M", "D", "M", "D", "F", "S"},
			WeekdaysShortValue:       []string{"Su", "Mo", "Di", "Me", "Du", "Fr", "Sa"},
			WeekdaysWideValue:        []string{"Sunndaach", "Mohndaach", "Dinnsdaach", "Metwoch", "Dunnersdaach", "Friidaach", "Samsdaach"},
			PeriodsAbbreviatedValue:  []string{"v.M.", "n.M."},
			PeriodsWideValue:         []string{"Uhr vörmiddaachs", "Uhr nommendaachs"},
			ErasAbbreviatedValue:     []string{"v. Chr.", "n. Chr."},
			ErasNarrowValue:          []string{"vC", "nC"},
			ErasWideValue:            []string{"vür Krestos", "noh Krestos"},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "ADT", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "AST", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "Zentraal-Affrekaanesche Zigg", "CCT": "CCT", "CDT": "CDT", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "CST", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "Oß-Affrekaanesche Zigg", "ECT": "ECT", "EDT": "EDT", "EGDT": "EGDT", "EGST": "EGST", "EST": "EST", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "Greenwich sing Standat-Zick", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "Meddel-Europpa sing Summerzick", "MEZ": "Meddel-Europpa sing jewöhnlijje Zick", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "Oß-Europpa sing Summerzick", "OEZ": "Oß-Europpa sing jewöhnlijje Zick", "PDT": "PDT", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "PST", "PYST": "PYST", "SAST": "Söd-Affrekaanesche Zigg", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "Wäß-Affrekaanesche Sommerzigg", "WAT": "Jewöhnlijje Wäß-Affrekaanesche Zigg", "WESZ": "Weß-Europpa sing Summerzick", "WEZ": "Weß-Europpa sing jewöhnlijje Zick", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		dateFullLayout:   "EEEE, 'dä' d. MMMM y",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} un {1}", "{0}, {1}", "{0}, {1}", "{0} un {1}"}, []string(nil)}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "%v Jrh", "%v Jrh", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v Jr", "%v Jr", ""},
				Long:   &locales.CounterFormat{"Johre", "%v Johre", "%v Johre", "%v pro Johre"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v Mohn", "%v Mohn", ""},
				Long:   &locales.CounterFormat{"Mohnde", "%v Mohnde", "%v Mohnde", "%v pro Mohnde"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"Woche", "%v Woche", "%v Woche", "%v pro Woche"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"Schtunde", "%v Schtunde", "%v Schtunde", "%v pro Schtunde"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vm", "%vm", ""},
				Long:   &locales.CounterFormat{"Menutte", "%v Menutte", "%v Menutte", "%v pro Menutte"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vs", "%vs", ""},
				Long:   &locales.CounterFormat{"Sekunde", "%v Sekunde", "%v Sekunde", "%v pro Sekunde"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
...
func (ksh *ksh) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ksh, ksh.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ksh'
func (ksh *ksh) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ksh, ksh.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ksh'
func (ksh *ksh) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ksh, ksh.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ksh'
func (ksh *ksh) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ksh, ksh.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ksh'
func (ksh *ksh) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ksh, ksh.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ksh'
func (ksh *ksh) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ksh, ksh.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ksh'
func (ksh *ksh) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ksh, ksh.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ksh'
func (ksh *ksh) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ksh, ksh.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ksh'
func (ksh *ksh) DateFullLayout() string {
	return ksh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ksh'
func (ksh *ksh) DateLongLayout() string {
	return ksh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ksh'
func (ksh *ksh) DateMediumLayout() string {
	return ksh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ksh'
func (ksh *ksh) DateShortLayout() string {
	return ksh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ksh'
func (ksh *ksh) TimeFullLayout() string {
	return ksh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ksh'
func (ksh *ksh) TimeLongLayout() string {
	return ksh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ksh'
func (ksh *ksh) TimeMediumLayout() string {
	return ksh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ksh'
func (ksh *ksh) TimeShortLayout() string {
	return ksh.timeShortLayout
}

func (ksh *ksh) ListPatterns() *locales.ListPatterns {
	return ksh.listPatterns
}

func (ksh *ksh) GetDurationSpec() *locales.DurationSpec {
	return ksh.DurationSpec
}

func (ksh *ksh) GetMiscPatterns() *locales.MiscPatterns {
	return &ksh.miscPatterns
}
