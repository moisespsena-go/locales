...
func New() locales.Translator {
	return &nn{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jan.", "feb.", "mars", "apr.", "mai", "juni", "juli", "aug.", "sep.", "okt.", "nov.", "des."},
			WeekdaysAbbreviatedValue: []string{"sø.", "må.", "ty.", "on.", "to.", "fr.", "la."},
			WeekdaysNarrowValue:      []string{"S", "M", "T", "O", "T", "F", "L"},
			WeekdaysShortValue:       []string{"sø.", "må.", "ty.", "on.", "to.", "fr.", "la."},
			WeekdaysWideValue:        []string{"søndag", "måndag", "tysdag", "onsdag", "torsdag", "fredag", "laurdag"},
			PeriodsAbbreviatedValue:  []string{"f.m.", "e.m."},
			PeriodsNarrowValue:       []string{"f.m.", "e.m."},
			PeriodsWideValue:         []string{"", ""},
			ErasAbbreviatedValue:     []string{"", ""},
			ErasNarrowValue:          []string{"fvt", "vt"},
			ErasWideValue:            []string{"før vår tidsrekning", "etter vår tidsrekning"},
			TimezonesValue:           map[string]string{"": "normaltid for Falklandsøyane", "ACDT": "sentralaustralsk sommartid", "ACST": "ACST", "ACT": "ACT", "ACWDT": "vest-sentralaustralsk sommartid", "ACWST": "vest-sentralaustralsk standardtid", "ADT": "sommartid for den nordamerikanske atlanterhavskysten", "AEDT": "austaustralsk sommartid", "AEST": "austaustralsk standardtid", "AFT": "AFT", "AKDT": "alaskisk sommartid", "AKST": "alaskisk normaltid", "AMST": "sommartid for Amazonas", "AMT": "normaltid for Amazonas", "ARST": "argentinsk sommartid", "ART": "argentinsk normaltid", "AST": "normaltid for den nordamerikanske atlanterhavskysten", "AWDT": "vestaustralsk sommartid", "AWST": "vestaustralsk standardtid", "BNT": "BNT", "BOT": "BOT", "BRST": "sommartid for Brasilia", "BRT": "normaltid for Brasilia", "BST": "bangladeshisk sommartid", "BTT": "BTT", "CAT": "CAT", "CCT": "tidssone for Kokosøyane", "CDT": "sommartid for sentrale Nord-Amerika", "CDT (Kuba)": "kubansk sommartid", "CHADT": "sommartid for Chatham", "CHAST": "normaltid for Chatham", "CLST": "chilensk sommartid", "CLT": "chilensk normaltid", "COST": "kolombiansk sommartid", "COT": "kolombiansk normaltid", "CST": "normaltid for sentrale Nord-Amerika", "CST (Kuba)": "kubansk normaltid", "CXT": "CXT", "ChST": "ChST", "EASST": "sommartid for Påskeøya", "EAST": "normaltid for Påskeøya", "EAT": "austafrikansk tid", "ECT": "ECT", "EDT": "sommartid for den nordamerikansk austkysten", "EGDT": "austgrønlandsk sommartid", "EGST": "austgrønlandsk normaltid", "EST": "normaltid for den nordamerikanske austkysten", "FKST": "sommartid for Falklandsøyane", "GALT": "tidssone for Galápagosøyane", "GFT": "GFT", "GMT": "GMT", "GST": "GST", "GYT": "GYT", "HADT": "sommartid for Hawaii og Aleutene", "HAST": "normaltid for Hawaii og Aleutene", "HENOMX": "sommartid for nordvestlege Mexico", "HEOG": "vestgrønlandsk sommartid", "HEPMX": "sommartid for den meksikanske stillehavskysten", "HKST": "hongkongkinesisk sommartid", "HKT": "hongkongkinesisk normaltid", "HNNOMX": "normaltid for nordvestlege Mexico", "HNOG": "vestgrønlandsk normaltid", "HNPMX": "normaltid for den meksikanske stillehavskysten", "ICT": "ICT", "IRDT": "iransk sommartid", "IRST": "iransk normaltid", "IST": "IST", "JDT": "japansk sommartid", "JST": "japansk normaltid", "LHDT": "sommartid for Lord Howe-øya", "LHST": "normaltid for Lord Howe-øya", "MDT": "MDT", "MESZ": "sentraleuropeisk sommartid", "MEZ": "sentraleuropeisk standardtid", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "sommartid for Newfoundland", "NPT": "NPT", "NST": "normaltid for Newfoundland", "NZDT": "nyzealandsk sumartid", "NZST": "nyzealandsk normaltid", "OESZ": "austeuropeisk sommartid", "OEZ": "austeuropeisk standardtid", "PDT": "sommartid for den nordamerikanske stillehavskysten", "PKT": "pakistansk sommartid", "PMDT": "sommartid for Saint-Pierre-et-Miquelon", "PMST": "normaltid for Saint-Pierre-et-Miquelon", "PST": "normaltid for den nordamerikanske stillehavskysten", "PYST": "paraguayansk sommartid", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "austtimoresisk tid", "TMST": "turkmensk sommartid", "TMT": "turkmensk normaltid", "UYST": "uruguayansk sommartid", "UYT": "uruguayansk normaltid", "VET": "VET", "WARST": "vestargentinsk sommartid", "WART": "vestargentinsk normaltid", "WAST": "vestafrikansk sommartid", "WAT": "vestafrikansk standardtid", "WESZ": "vesteuropeisk sommartid", "WEZ": "vesteuropeisk standardtid", "WIB": "WIB", "WIT": "austindonesisk tid", "WITA": "WITA", "∅∅∅": "asorisk sommartid"},
		},
		...
		timeFullLayout:   "'kl'. HH:mm:ss zzzz",
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"hå.", "%v hå.", "%v hå.", ""},
				Long:   &locales.CounterFormat{"hundreår", "%v hundreårs", "%v hundreårs", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"månad", "%vm", "%vm", ""},
				Long:   &locales.CounterFormat{"månadar", "%v månads", "%v månaders", "%v per månad"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"vk.", "%vv", "%vv", "%v/v"},
				Long:   &locales.CounterFormat{"veker", "%v vekes", "%v vekers", "%v\u00a0per veke"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"timar", "%v times", "%v timars", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"minutt", "%v minutts", "%v minutts", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sekund", "%v s", "%v s", ""},
				Long:   &locales.CounterFormat{"sekund", "%v sekunds", "%v sekunds", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"millisekund", "%v millisekunds", "%v millisekunds", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"mikrosekund", "%v mikrosekunds", "%v mikrosekunds", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"nanosekund", "%v nanosekunds", "%v nanosekunds", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"",
			"",
...
func (nn *nn) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(nn, nn.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'nn'
func (nn *nn) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(nn, nn.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'nn'
func (nn *nn) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(nn, nn.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'nn'
func (nn *nn) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(nn, nn.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'nn'
func (nn *nn) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(nn, nn.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'nn'
func (nn *nn) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(nn, nn.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'nn'
func (nn *nn) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(nn, nn.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'nn'
func (nn *nn) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(nn, nn.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'nn'
func (nn *nn) DateFullLayout() string {
	return nn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nn'
func (nn *nn) DateLongLayout() string {
	return nn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nn'
func (nn *nn) DateMediumLayout() string {
	return nn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nn'
func (nn *nn) DateShortLayout() string {
	return nn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nn'
func (nn *nn) TimeFullLayout() string {
	return nn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nn'
func (nn *nn) TimeLongLayout() string {
	return nn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nn'
func (nn *nn) TimeMediumLayout() string {
	return nn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nn'
func (nn *nn) TimeShortLayout() string {
	return nn.timeShortLayout
}

func (nn *nn) ListPatterns() *locales.ListPatterns {
	return nn.listPatterns
}

func (nn *nn) GetDurationSpec() *locales.DurationSpec {
	return nn.DurationSpec
}

func (nn *nn) GetMiscPatterns() *locales.MiscPatterns {
	return &nn.miscPatterns
}
