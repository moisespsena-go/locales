...
// DateFullLayout returns the full date layout for 'bn_BD'
func (bn *bn_BD) DateFullLayout() string {
	return bn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bn_BD'
func (bn *bn_BD) DateLongLayout() string {
	return bn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bn_BD'
func (bn *bn_BD) DateMediumLayout() string {
	return bn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bn_BD'
func (bn *bn_BD) DateShortLayout() string {
	return bn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bn_BD'
func (bn *bn_BD) TimeFullLayout() string {
	return bn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bn_BD'
func (bn *bn_BD) TimeLongLayout() string {
	return bn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bn_BD'
func (bn *bn_BD) TimeMediumLayout() string {
	return bn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bn_BD'
func (bn *bn_BD) TimeShortLayout() string {
	return bn.timeShortLayout
}

func (bn *bn_BD) ListPatterns() *locales.ListPatterns {
	return bn.listPatterns
}

func (bn *bn_BD) GetDurationSpec() *locales.DurationSpec {
	return bn.DurationSpec
}

func (bn *bn_BD) GetMiscPatterns() *locales.MiscPatterns {
