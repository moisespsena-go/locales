...
// DateFullLayout returns the full date layout for 'fr_CD'
func (fr *fr_CD) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_CD'
func (fr *fr_CD) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_CD'
func (fr *fr_CD) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_CD'
func (fr *fr_CD) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_CD'
func (fr *fr_CD) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_CD'
func (fr *fr_CD) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_CD'
func (fr *fr_CD) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_CD'
func (fr *fr_CD) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_CD) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_CD) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_CD) GetMiscPatterns() *locales.MiscPatterns {
