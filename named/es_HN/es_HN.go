...
func New() locales.Translator {
	return &es_HN{
		...
		dateFullLayout:   "EEEE dd 'de' MMMM 'de' y",
		dateLongLayout:   "dd 'de' MMMM 'de' y",
...
// DateFullLayout returns the full date layout for 'es_HN'
func (es *es_HN) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_HN'
func (es *es_HN) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_HN'
func (es *es_HN) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_HN'
func (es *es_HN) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_HN'
func (es *es_HN) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_HN'
func (es *es_HN) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_HN'
func (es *es_HN) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_HN'
func (es *es_HN) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_HN) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_HN) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_HN) GetMiscPatterns() *locales.MiscPatterns {
