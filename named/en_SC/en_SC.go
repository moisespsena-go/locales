...
// DateFullLayout returns the full date layout for 'en_SC'
func (en *en_SC) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_SC'
func (en *en_SC) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_SC'
func (en *en_SC) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_SC'
func (en *en_SC) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_SC'
func (en *en_SC) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_SC'
func (en *en_SC) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_SC'
func (en *en_SC) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_SC'
func (en *en_SC) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_SC) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_SC) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_SC) GetMiscPatterns() *locales.MiscPatterns {
