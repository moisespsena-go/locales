...
// DateFullLayout returns the full date layout for 'en_TO'
func (en *en_TO) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_TO'
func (en *en_TO) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_TO'
func (en *en_TO) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_TO'
func (en *en_TO) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_TO'
func (en *en_TO) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_TO'
func (en *en_TO) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_TO'
func (en *en_TO) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_TO'
func (en *en_TO) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_TO) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_TO) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_TO) GetMiscPatterns() *locales.MiscPatterns {
