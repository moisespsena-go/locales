...
// DateFullLayout returns the full date layout for 'so_SO'
func (so *so_SO) DateFullLayout() string {
	return so.dateFullLayout
}

// DateLongLayout returns the long date layout for 'so_SO'
func (so *so_SO) DateLongLayout() string {
	return so.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'so_SO'
func (so *so_SO) DateMediumLayout() string {
	return so.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'so_SO'
func (so *so_SO) DateShortLayout() string {
	return so.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'so_SO'
func (so *so_SO) TimeFullLayout() string {
	return so.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'so_SO'
func (so *so_SO) TimeLongLayout() string {
	return so.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'so_SO'
func (so *so_SO) TimeMediumLayout() string {
	return so.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'so_SO'
func (so *so_SO) TimeShortLayout() string {
	return so.timeShortLayout
}

func (so *so_SO) ListPatterns() *locales.ListPatterns {
	return so.listPatterns
}

func (so *so_SO) GetDurationSpec() *locales.DurationSpec {
	return so.DurationSpec
}

func (so *so_SO) GetMiscPatterns() *locales.MiscPatterns {
