...
// DateFullLayout returns the full date layout for 'nmg'
func (nmg *nmg) DateFullLayout() string {
	return nmg.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nmg'
func (nmg *nmg) DateLongLayout() string {
	return nmg.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nmg'
func (nmg *nmg) DateMediumLayout() string {
	return nmg.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nmg'
func (nmg *nmg) DateShortLayout() string {
	return nmg.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nmg'
func (nmg *nmg) TimeFullLayout() string {
	return nmg.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nmg'
func (nmg *nmg) TimeLongLayout() string {
	return nmg.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nmg'
func (nmg *nmg) TimeMediumLayout() string {
	return nmg.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nmg'
func (nmg *nmg) TimeShortLayout() string {
	return nmg.timeShortLayout
}

func (nmg *nmg) ListPatterns() *locales.ListPatterns {
	return nmg.listPatterns
}

func (nmg *nmg) GetDurationSpec() *locales.DurationSpec {
	return nmg.DurationSpec
}

func (nmg *nmg) GetMiscPatterns() *locales.MiscPatterns {
