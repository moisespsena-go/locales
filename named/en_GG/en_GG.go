...
// DateFullLayout returns the full date layout for 'en_GG'
func (en *en_GG) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_GG'
func (en *en_GG) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_GG'
func (en *en_GG) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_GG'
func (en *en_GG) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_GG'
func (en *en_GG) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_GG'
func (en *en_GG) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_GG'
func (en *en_GG) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_GG'
func (en *en_GG) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_GG) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_GG) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_GG) GetMiscPatterns() *locales.MiscPatterns {
