...
// DateFullLayout returns the full date layout for 'nnh'
func (nnh *nnh) DateFullLayout() string {
	return nnh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nnh'
func (nnh *nnh) DateLongLayout() string {
	return nnh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nnh'
func (nnh *nnh) DateMediumLayout() string {
	return nnh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nnh'
func (nnh *nnh) DateShortLayout() string {
	return nnh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nnh'
func (nnh *nnh) TimeFullLayout() string {
	return nnh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nnh'
func (nnh *nnh) TimeLongLayout() string {
	return nnh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nnh'
func (nnh *nnh) TimeMediumLayout() string {
	return nnh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nnh'
func (nnh *nnh) TimeShortLayout() string {
	return nnh.timeShortLayout
}

func (nnh *nnh) ListPatterns() *locales.ListPatterns {
	return nnh.listPatterns
}

func (nnh *nnh) GetDurationSpec() *locales.DurationSpec {
	return nnh.DurationSpec
}

func (nnh *nnh) GetMiscPatterns() *locales.MiscPatterns {
