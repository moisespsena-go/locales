...
func New() locales.Translator {
	return &sn_ZW{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Ndi", "Kuk", "Kur", "Kub", "Chv", "Chk", "Chg", "Nya", "Gun", "Gum", "Mbu", "Zvi"},
			MonthsNarrowValue:        []string{"", "N", "K", "K", "K", "C", "C", "C", "N", "G", "G", "M", "Z"},
			MonthsWideValue:          []string{"", "Ndira", "Kukadzi", "Kurume", "Kubvumbi", "Chivabvu", "Chikumi", "Chikunguru", "Nyamavhuvhu", "Gunyana", "Gumiguru", "Mbudzi", "Zvita"},
			WeekdaysAbbreviatedValue: []string{"Svo", "Muv", "Chp", "Cht", "Chn", "Chs", "Mug"},
			WeekdaysNarrowValue:      []string{"S", "M", "C", "C", "C", "C", "M"},
			WeekdaysShortValue:       []string{"Sv", "Mu", "Cp", "Ct", "Cn", "Cs", "Mg"},
			WeekdaysWideValue:        []string{"Svondo", "Muvhuro", "Chipiri", "Chitatu", "China", "Chishanu", "Mugovera"},
			...
			ErasWideValue:            []string{"Kristo asati auya", "mugore ramambo vedu"},
...
func (sn *sn_ZW) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(sn, sn.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'sn_ZW'
func (sn *sn_ZW) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(sn, sn.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'sn_ZW'
func (sn *sn_ZW) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(sn, sn.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'sn_ZW'
func (sn *sn_ZW) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(sn, sn.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'sn_ZW'
func (sn *sn_ZW) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(sn, sn.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'sn_ZW'
func (sn *sn_ZW) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(sn, sn.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'sn_ZW'
func (sn *sn_ZW) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(sn, sn.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'sn_ZW'
func (sn *sn_ZW) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(sn, sn.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'sn_ZW'
func (sn *sn_ZW) DateFullLayout() string {
	return sn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sn_ZW'
func (sn *sn_ZW) DateLongLayout() string {
	return sn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sn_ZW'
func (sn *sn_ZW) DateMediumLayout() string {
	return sn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sn_ZW'
func (sn *sn_ZW) DateShortLayout() string {
	return sn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sn_ZW'
func (sn *sn_ZW) TimeFullLayout() string {
	return sn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sn_ZW'
func (sn *sn_ZW) TimeLongLayout() string {
	return sn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sn_ZW'
func (sn *sn_ZW) TimeMediumLayout() string {
	return sn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sn_ZW'
func (sn *sn_ZW) TimeShortLayout() string {
	return sn.timeShortLayout
}

func (sn *sn_ZW) ListPatterns() *locales.ListPatterns {
	return sn.listPatterns
}

func (sn *sn_ZW) GetDurationSpec() *locales.DurationSpec {
	return sn.DurationSpec
}

func (sn *sn_ZW) GetMiscPatterns() *locales.MiscPatterns {
	return &sn.miscPatterns
}
