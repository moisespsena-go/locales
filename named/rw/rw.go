...
// DateFullLayout returns the full date layout for 'rw'
func (rw *rw) DateFullLayout() string {
	return rw.dateFullLayout
}

// DateLongLayout returns the long date layout for 'rw'
func (rw *rw) DateLongLayout() string {
	return rw.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'rw'
func (rw *rw) DateMediumLayout() string {
	return rw.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'rw'
func (rw *rw) DateShortLayout() string {
	return rw.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'rw'
func (rw *rw) TimeFullLayout() string {
	return rw.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'rw'
func (rw *rw) TimeLongLayout() string {
	return rw.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'rw'
func (rw *rw) TimeMediumLayout() string {
	return rw.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'rw'
func (rw *rw) TimeShortLayout() string {
	return rw.timeShortLayout
}

func (rw *rw) ListPatterns() *locales.ListPatterns {
	return rw.listPatterns
}

func (rw *rw) GetDurationSpec() *locales.DurationSpec {
	return rw.DurationSpec
}

func (rw *rw) GetMiscPatterns() *locales.MiscPatterns {
