...
// DateFullLayout returns the full date layout for 'es_BO'
func (es *es_BO) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_BO'
func (es *es_BO) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_BO'
func (es *es_BO) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_BO'
func (es *es_BO) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_BO'
func (es *es_BO) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_BO'
func (es *es_BO) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_BO'
func (es *es_BO) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_BO'
func (es *es_BO) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_BO) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_BO) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_BO) GetMiscPatterns() *locales.MiscPatterns {
