...
// DateFullLayout returns the full date layout for 'ebu'
func (ebu *ebu) DateFullLayout() string {
	return ebu.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ebu'
func (ebu *ebu) DateLongLayout() string {
	return ebu.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ebu'
func (ebu *ebu) DateMediumLayout() string {
	return ebu.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ebu'
func (ebu *ebu) DateShortLayout() string {
	return ebu.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ebu'
func (ebu *ebu) TimeFullLayout() string {
	return ebu.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ebu'
func (ebu *ebu) TimeLongLayout() string {
	return ebu.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ebu'
func (ebu *ebu) TimeMediumLayout() string {
	return ebu.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ebu'
func (ebu *ebu) TimeShortLayout() string {
	return ebu.timeShortLayout
}

func (ebu *ebu) ListPatterns() *locales.ListPatterns {
	return ebu.listPatterns
}

func (ebu *ebu) GetDurationSpec() *locales.DurationSpec {
	return ebu.DurationSpec
}

func (ebu *ebu) GetMiscPatterns() *locales.MiscPatterns {
