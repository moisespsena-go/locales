...
func New() locales.Translator {
	return &sa_IN{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "जनवरी:", "फरवरी:", "मार्च:", "अप्रैल:", "मई", "जून:", "जुलाई:", "अगस्त:", "सितंबर:", "अक्तूबर:", "नवंबर:", "दिसंबर:"},
			MonthsNarrowValue:        []string{"", "ज", "फ", "मा", "अ", "म", "जू", "जु", "अ", "सि", "अ", "न", "दि"},
			MonthsWideValue:          []string{"", "जनवरीमासः", "फरवरीमासः", "मार्चमासः", "अप्रैलमासः", "मईमासः", "जूनमासः", "जुलाईमासः", "अगस्तमासः", "सितंबरमासः", "अक्तूबरमासः", "नवंबरमासः", "दिसंबरमासः"},
			WeekdaysAbbreviatedValue: []string{"रवि", "सोम", "मंगल", "बुध", "गुरु", "शुक्र", "शनि"},
			WeekdaysNarrowValue:      []string{"र", "सो", "मं", "बु", "गु", "शु", "श"},
			WeekdaysShortValue:       []string{"Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"},
			WeekdaysWideValue:        []string{"रविवासरः", "सोमवासरः", "मंगलवासरः", "बुधवासरः", "गुरुवासर:", "शुक्रवासरः", "शनिवासरः"},
			...
			ErasWideValue:            []string{"BCE", "CE"},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "अटलाण्टिक अयाम समयः", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "अटलाण्टिक आदर्श समयः", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "CAT", "CCT": "CCT", "CDT": "उत्तर अमेरिका: मध्य अयाम समयः", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "उत्तर अमेरिका: मध्य आदर्श समयः", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "EAT", "ECT": "ECT", "EDT": "उत्तर अमेरिका: पौर्व अयाम समय:", "EGDT": "EGDT", "EGST": "EGST", "EST": "उत्तर अमेरिका: पौर्व आदर्श समयः", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "ग्रीनविच मीन समयः", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "मध्य यूरोपीय ग्रीष्म समयः", "MEZ": "मध्य यूरोपीय आदर्श समयः", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "पौर्व यूरोपीय ग्रीष्म समयः", "OEZ": "पौर्व यूरोपीय आदर्श समयः", "PDT": "उत्तर अमेरिका: सन्धिप्रिय अयाम समयः", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "उत्तर अमेरिका: सन्धिप्रिय आदर्श समयः", "PYST": "PYST", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "पाश्चात्य यूरोपीय ग्रीष्म समयः", "WEZ": "पाश्चात्य यूरोपीय आदर्श समयः", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} तथा {1}", "", "", "{0}, तथा {1}"}, []string(nil)}),
		miscPatterns: locales.MiscPatterns{
			"",
			"≥%[1]v",
			"",
...
func (sa *sa_IN) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(sa, sa.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'sa_IN'
func (sa *sa_IN) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(sa, sa.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'sa_IN'
func (sa *sa_IN) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(sa, sa.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'sa_IN'
func (sa *sa_IN) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(sa, sa.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'sa_IN'
func (sa *sa_IN) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(sa, sa.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'sa_IN'
func (sa *sa_IN) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(sa, sa.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'sa_IN'
func (sa *sa_IN) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(sa, sa.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'sa_IN'
func (sa *sa_IN) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(sa, sa.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'sa_IN'
func (sa *sa_IN) DateFullLayout() string {
	return sa.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sa_IN'
func (sa *sa_IN) DateLongLayout() string {
	return sa.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sa_IN'
func (sa *sa_IN) DateMediumLayout() string {
	return sa.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sa_IN'
func (sa *sa_IN) DateShortLayout() string {
	return sa.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sa_IN'
func (sa *sa_IN) TimeFullLayout() string {
	return sa.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sa_IN'
func (sa *sa_IN) TimeLongLayout() string {
	return sa.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sa_IN'
func (sa *sa_IN) TimeMediumLayout() string {
	return sa.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sa_IN'
func (sa *sa_IN) TimeShortLayout() string {
	return sa.timeShortLayout
}

func (sa *sa_IN) ListPatterns() *locales.ListPatterns {
	return sa.listPatterns
}

func (sa *sa_IN) GetDurationSpec() *locales.DurationSpec {
	return sa.DurationSpec
}

func (sa *sa_IN) GetMiscPatterns() *locales.MiscPatterns {
	return &sa.miscPatterns
}
