...
// DateFullLayout returns the full date layout for 'ff_Latn_CM'
func (ff *ff_Latn_CM) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff_Latn_CM'
func (ff *ff_Latn_CM) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff_Latn_CM'
func (ff *ff_Latn_CM) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff_Latn_CM'
func (ff *ff_Latn_CM) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff_Latn_CM'
func (ff *ff_Latn_CM) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff_Latn_CM'
func (ff *ff_Latn_CM) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff_Latn_CM'
func (ff *ff_Latn_CM) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff_Latn_CM'
func (ff *ff_Latn_CM) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff_Latn_CM) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff_Latn_CM) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff_Latn_CM) GetMiscPatterns() *locales.MiscPatterns {
