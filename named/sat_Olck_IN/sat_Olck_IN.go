...
// New returns a new instance of translator for the 'sat_Olck_IN' locale
func New() locales.Translator {
	return &sat_Olck_IN{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ᱡᱟᱱ", "ᱯᱷᱟ", "ᱢᱟᱨ", "ᱟᱯᱨ", "ᱢᱮ", "ᱡᱩᱱ", "ᱡᱩᱞ", "ᱟᱜᱟ", "ᱥᱮᱯ", "ᱚᱠᱴ", "ᱱᱟᱣ", "ᱫᱤᱥ"},
			MonthsNarrowValue:        []string{"", "ᱡ", "ᱯ", "ᱢ", "ᱟ", "ᱢ", "ᱡ", "ᱡ", "ᱟ", "ᱥ", "ᱚ", "ᱱ", "ᱫ"},
			MonthsWideValue:          []string{"", "ᱡᱟᱱᱣᱟᱨᱤ", "ᱯᱷᱟᱨᱣᱟᱨᱤ", "ᱢᱟᱨᱪ", "ᱟᱯᱨᱮᱞ", "ᱢᱮ", "ᱡᱩᱱ", "ᱡᱩᱞᱟᱭ", "ᱟᱜᱟᱥᱛ", "ᱥᱮᱯᱴᱮᱢᱵᱟᱨ", "ᱚᱠᱴᱚᱵᱟᱨ", "ᱱᱟᱣᱟᱢᱵᱟᱨ", "ᱫᱤᱥᱟᱢᱵᱟᱨ"},
			WeekdaysAbbreviatedValue: []string{"ᱥᱤᱸ", "ᱚᱛ", "ᱵᱟ", "ᱥᱟᱹ", "ᱥᱟᱹᱨ", "ᱡᱟᱹ", "ᱧᱩ"},
			WeekdaysNarrowValue:      []string{"ᱥ", "ᱚ", "ᱵ", "ᱥ", "ᱥ", "ᱡ", "ᱧ"},
			WeekdaysWideValue:        []string{"ᱥᱤᱸᱜᱮ", "ᱚᱛᱮ", "ᱵᱟᱞᱮ", "ᱥᱟᱹᱜᱩᱱ", "ᱥᱟᱹᱨᱫᱤ", "ᱡᱟᱹᱨᱩᱢ", "ᱧᱩᱦᱩᱢ"},
			PeriodsWideValue:         []string{"ᱥᱮᱛᱟᱜ", "ᱧᱤᱫᱟᱹ"},
			ErasAbbreviatedValue:     []string{"ᱥᱮᱨᱢᱟ ᱞᱟᱦᱟ", "ᱤᱥᱣᱤ"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"", ""},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "ᱮᱴᱞᱟᱱᱴᱤᱠ ᱥᱤᱧᱟᱜ ᱚᱠᱛᱚ", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "ᱮᱴᱞᱟᱱᱴᱤᱠ ᱮᱥᱴᱮᱱᱰᱟᱨᱰ ᱚᱠᱛᱚ", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "CAT", "CCT": "CCT", "CDT": "ᱛᱟᱱᱟᱞᱟ ᱥᱤᱧᱟᱜ ᱚᱠᱛᱚ", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "ᱛᱟᱱᱟᱞᱟ ᱮᱥᱴᱮᱱᱰᱟᱨᱰ ᱚᱠᱛᱚ", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "EAT", "ECT": "ECT", "EDT": "ᱤᱥᱴᱟᱨᱱ ᱥᱤᱧᱟᱜ ᱵᱚᱠᱛᱚ", "EGDT": "EGDT", "EGST": "EGST", "EST": "ᱤᱥᱴᱟᱨᱱ ᱮᱥᱴᱮᱱᱰᱟᱨᱰ ᱚᱠᱛᱚ", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "ᱜᱨᱤᱱᱣᱤᱪ ᱢᱤᱱ ᱚᱠᱛᱚ", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "ᱥᱮᱱᱴᱨᱟᱞ ᱩᱨᱚᱯᱤᱭᱟᱱ ᱥᱟᱢᱟᱨ ᱚᱠᱛᱚ", "MEZ": "ᱥᱮᱱᱴᱨᱟᱞ ᱩᱨᱚᱯᱤᱭᱟᱱ ᱮᱥᱴᱮᱱᱰᱟᱨᱰ ᱚᱠᱛᱚ", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "ᱤᱥᱴᱟᱨᱱ ᱩᱨᱚᱯᱤᱭᱟᱱ ᱥᱟᱢᱟᱨ ᱚᱠᱛᱚ", "OEZ": "ᱤᱥᱴᱟᱨᱱ ᱩᱨᱚᱯᱤᱭᱟᱱ ᱮᱥᱴᱮᱱᱰᱟᱨᱰ ᱚᱠᱛᱚ", "PDT": "ᱯᱮᱥᱤᱯᱷᱤᱠ ᱥᱤᱧᱟᱜ ᱚᱠᱛᱚ", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "ᱯᱮᱥᱤᱯᱷᱤᱠ ᱮᱥᱴᱮᱱᱰᱟᱨᱰ ᱚᱠᱛᱚ", "PYST": "PYST", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "ᱣᱮᱥᱴᱟᱨᱱ ᱩᱨᱚᱯᱤᱭᱟᱱ ᱥᱟᱢᱟᱨ ᱚᱠᱛᱚ", "WEZ": "ᱣᱮᱥᱴᱟᱨᱱ ᱩᱨᱚᱯᱤᱭᱟᱱ ᱮᱥᱴᱮᱱᱰᱟᱨᱰ ᱚᱠᱛᱚ", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} ᱟᱨ ᱵᱟᱝ {1}", "", "", "{0} ᱟᱨ ᱵᱟᱝ {1}"}, {"{0} ᱟᱨ ᱵᱟᱝ {1}", "", "", "{0} ᱟᱨ ᱵᱟᱝ {1}"}}),
		miscPatterns: locales.MiscPatterns{
			"",
			"",
			"",
...
func (sat *sat_Olck_IN) Locale() string {
	return sat.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'sat_Olck_IN'
func (sat *sat_Olck_IN) PluralsCardinal() []locales.PluralRule {
	return sat.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'sat_Olck_IN'
func (sat *sat_Olck_IN) PluralsOrdinal() []locales.PluralRule {
	return sat.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'sat_Olck_IN'
func (sat *sat_Olck_IN) PluralsRange() []locales.PluralRule {
	return sat.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'sat_Olck_IN'
func (sat *sat_Olck_IN) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'sat_Olck_IN'
func (sat *sat_Olck_IN) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'sat_Olck_IN'
func (sat *sat_Olck_IN) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// FmtDateShort returns the short date representation of 't' for 'sat_Olck_IN'
func (sat *sat_Olck_IN) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(sat, sat.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'sat_Olck_IN'
func (sat *sat_Olck_IN) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(sat, sat.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'sat_Olck_IN'
func (sat *sat_Olck_IN) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(sat, sat.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'sat_Olck_IN'
func (sat *sat_Olck_IN) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(sat, sat.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'sat_Olck_IN'
func (sat *sat_Olck_IN) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(sat, sat.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'sat_Olck_IN'
func (sat *sat_Olck_IN) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(sat, sat.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'sat_Olck_IN'
func (sat *sat_Olck_IN) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(sat, sat.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'sat_Olck_IN'
func (sat *sat_Olck_IN) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(sat, sat.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'sat_Olck_IN'
func (sat *sat_Olck_IN) DateFullLayout() string {
	return sat.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sat_Olck_IN'
func (sat *sat_Olck_IN) DateLongLayout() string {
	return sat.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sat_Olck_IN'
func (sat *sat_Olck_IN) DateMediumLayout() string {
	return sat.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sat_Olck_IN'
func (sat *sat_Olck_IN) DateShortLayout() string {
	return sat.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sat_Olck_IN'
func (sat *sat_Olck_IN) TimeFullLayout() string {
	return sat.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sat_Olck_IN'
func (sat *sat_Olck_IN) TimeLongLayout() string {
	return sat.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sat_Olck_IN'
func (sat *sat_Olck_IN) TimeMediumLayout() string {
	return sat.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sat_Olck_IN'
func (sat *sat_Olck_IN) TimeShortLayout() string {
	return sat.timeShortLayout
}

func (sat *sat_Olck_IN) ListPatterns() *locales.ListPatterns {
	return sat.listPatterns
}

func (sat *sat_Olck_IN) GetDurationSpec() *locales.DurationSpec {
	return sat.DurationSpec
}

func (sat *sat_Olck_IN) GetMiscPatterns() *locales.MiscPatterns {
	return &sat.miscPatterns
}
