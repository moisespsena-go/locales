...
// DateFullLayout returns the full date layout for 'br_FR'
func (br *br_FR) DateFullLayout() string {
	return br.dateFullLayout
}

// DateLongLayout returns the long date layout for 'br_FR'
func (br *br_FR) DateLongLayout() string {
	return br.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'br_FR'
func (br *br_FR) DateMediumLayout() string {
	return br.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'br_FR'
func (br *br_FR) DateShortLayout() string {
	return br.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'br_FR'
func (br *br_FR) TimeFullLayout() string {
	return br.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'br_FR'
func (br *br_FR) TimeLongLayout() string {
	return br.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'br_FR'
func (br *br_FR) TimeMediumLayout() string {
	return br.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'br_FR'
func (br *br_FR) TimeShortLayout() string {
	return br.timeShortLayout
}

func (br *br_FR) ListPatterns() *locales.ListPatterns {
	return br.listPatterns
}

func (br *br_FR) GetDurationSpec() *locales.DurationSpec {
	return br.DurationSpec
}

func (br *br_FR) GetMiscPatterns() *locales.MiscPatterns {
