...
// DateFullLayout returns the full date layout for 'bem'
func (bem *bem) DateFullLayout() string {
	return bem.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bem'
func (bem *bem) DateLongLayout() string {
	return bem.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bem'
func (bem *bem) DateMediumLayout() string {
	return bem.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bem'
func (bem *bem) DateShortLayout() string {
	return bem.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bem'
func (bem *bem) TimeFullLayout() string {
	return bem.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bem'
func (bem *bem) TimeLongLayout() string {
	return bem.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bem'
func (bem *bem) TimeMediumLayout() string {
	return bem.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bem'
func (bem *bem) TimeShortLayout() string {
	return bem.timeShortLayout
}

func (bem *bem) ListPatterns() *locales.ListPatterns {
	return bem.listPatterns
}

func (bem *bem) GetDurationSpec() *locales.DurationSpec {
	return bem.DurationSpec
}

func (bem *bem) GetMiscPatterns() *locales.MiscPatterns {
