...
func New() locales.Translator {
	return &de{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0"),
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan.", "Feb.", "März", "Apr.", "Mai", "Juni", "Juli", "Aug.", "Sept.", "Okt.", "Nov.", "Dez."},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Januar", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"},
			WeekdaysAbbreviatedValue: []string{"So.", "Mo.", "Di.", "Mi.", "Do.", "Fr.", "Sa."},
			WeekdaysNarrowValue:      []string{"S", "M", "D", "M", "D", "F", "S"},
			WeekdaysShortValue:       []string{"So.", "Mo.", "Di.", "Mi.", "Do.", "Fr.", "Sa."},
			WeekdaysWideValue:        []string{"Sonntag", "Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag"},
			...
			ErasNarrowValue:          []string{"v. Chr.", "n. Chr."},
			ErasWideValue:            []string{"v. Chr.", "n. Chr."},
			TimezonesValue:           map[string]string{"": "Falklandinseln-Normalzeit", "ACDT": "Zentralaustralische Sommerzeit", "ACST": "Acre-Sommerzeit", "ACT": "Acre-Normalzeit", "ACWDT": "Zentral-/Westaustralische Sommerzeit", "ACWST": "Zentral-/Westaustralische Normalzeit", "ADT": "Atlantik-Sommerzeit", "AEDT": "Ostaustralische Sommerzeit", "AEST": "Ostaustralische Normalzeit", "AFT": "Afghanistan-Zeit", "AKDT": "Alaska-Sommerzeit", "AKST": "Alaska-Normalzeit", "AMST": "Amazonas-Sommerzeit", "AMT": "Amazonas-Normalzeit", "ARST": "Argentinische Sommerzeit", "ART": "Argentinische Normalzeit", "AST": "Atlantik-Normalzeit", "AWDT": "Westaustralische Sommerzeit", "AWST": "Westaustralische Normalzeit", "BNT": "Brunei-Darussalam-Zeit", "BOT": "Bolivianische Zeit", "BRST": "Brasília-Sommerzeit", "BRT": "Brasília-Normalzeit", "BST": "Bangladesch-Sommerzeit", "BTT": "Bhutan-Zeit", "CAT": "Zentralafrikanische Zeit", "CCT": "Kokosinseln-Zeit", "CDT": "Nordamerikanische Inland-Sommerzeit", "CDT (Kuba)": "Kubanische Sommerzeit", "CHADT": "Chatham-Sommerzeit", "CHAST": "Chatham-Normalzeit", "CLST": "Chilenische Sommerzeit", "CLT": "Chilenische Normalzeit", "COST": "Kolumbianische Sommerzeit", "COT": "Kolumbianische Normalzeit", "CST": "Nordamerikanische Inland-Normalzeit", "CST (Kuba)": "Kubanische Normalzeit", "CXT": "Weihnachtsinsel-Zeit", "ChST": "Chamorro-Zeit", "EASST": "Osterinsel-Sommerzeit", "EAST": "Osterinsel-Normalzeit", "EAT": "Ostafrikanische Zeit", "ECT": "Ecuadorianische Zeit", "EDT": "Nordamerikanische Ostküsten-Sommerzeit", "EGDT": "Ostgrönland-Sommerzeit", "EGST": "Ostgrönland-Normalzeit", "EST": "Nordamerikanische Ostküsten-Normalzeit", "FKST": "Falklandinseln-Sommerzeit", "GALT": "Galapagos-Zeit", "GFT": "Französisch-Guayana-Zeit", "GMT": "Mittlere Greenwich-Zeit", "GST": "Golf-Zeit", "GYT": "Guyana-Zeit", "HADT": "Hawaii-Aleuten-Sommerzeit", "HAST": "Hawaii-Aleuten-Normalzeit", "HENOMX": "Mexiko Nordwestliche Zone-Sommerzeit", "HEOG": "Westgrönland-Sommerzeit", "HEPMX": "Mexiko Pazifikzone-Sommerzeit", "HKST": "Hongkong-Sommerzeit", "HKT": "Hongkong-Normalzeit", "HNNOMX": "Mexiko Nordwestliche Zone-Normalzeit", "HNOG": "Westgrönland-Normalzeit", "HNPMX": "Mexiko Pazifikzone-Normalzeit", "ICT": "Indochina-Zeit", "IRDT": "Iranische Sommerzeit", "IRST": "Iranische Normalzeit", "IST": "Indische Normalzeit", "JDT": "Japanische Sommerzeit", "JST": "Japanische Normalzeit", "LHDT": "Lord-Howe-Sommerzeit", "LHST": "Lord-Howe-Normalzeit", "MDT": "Macau-Sommerzeit", "MESZ": "Mitteleuropäische Sommerzeit", "MEZ": "Mitteleuropäische Normalzeit", "MST": "Macau-Normalzeit", "MVT": "Malediven-Zeit", "MYT": "Malaysische Zeit", "NDT": "Neufundland-Sommerzeit", "NPT": "Nepalesische Zeit", "NST": "Neufundland-Normalzeit", "NZDT": "Neuseeland-Sommerzeit", "NZST": "Neuseeland-Normalzeit", "OESZ": "Osteuropäische Sommerzeit", "OEZ": "Osteuropäische Normalzeit", "PDT": "Nordamerikanische Westküsten-Sommerzeit", "PKT": "Pakistanische Sommerzeit", "PMDT": "St.-Pierre-und-Miquelon-Sommerzeit", "PMST": "St.-Pierre-und-Miquelon-Normalzeit", "PST": "Nordamerikanische Westküsten-Normalzeit", "PYST": "Paraguayanische Sommerzeit", "SAST": "Südafrikanische Zeit", "SGT": "Singapurische Normalzeit", "SRT": "Suriname-Zeit", "TLT": "Osttimor-Zeit", "TMST": "Turkmenistan-Sommerzeit", "TMT": "Turkmenistan-Normalzeit", "UYST": "Uruguayanische Sommerzeit", "UYT": "Uruguyanische Normalzeit", "VET": "Venezuela-Zeit", "WARST": "Westargentinische Sommerzeit", "WART": "Westargentinische Normalzeit", "WAST": "Westafrikanische Sommerzeit", "WAT": "Westafrikanische Normalzeit", "WESZ": "Westeuropäische Sommerzeit", "WEZ": "Westeuropäische Normalzeit", "WIB": "Westindonesische Zeit", "WIT": "Ostindonesische Zeit", "WITA": "Zentralindonesische Zeit", "∅∅∅": "Peruanische Sommerzeit"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} und {1}", "{0}, {1}", "{0}, {1}", "{0} und {1}"}, {"{0} oder {1}", "{0}, {1}", "{0}, {1}", "{0} oder {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Jh.", "%v Jh.", "%v Jh.", ""},
				Long:   &locales.CounterFormat{"Jahrhunderte", "%v Jahrhunderts", "%v Jahrhunderte", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Jz.", "%v\u00a0Jz.", "%v\u00a0Jz.", ""},
				Long:   &locales.CounterFormat{"Jahrzehnte", "%v Jahrzehnts", "%v\u00a0Jahrzehnte", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"J", "%v J", "%v J", "%v/J"},
				Long:   &locales.CounterFormat{"Jahre", "%v Jahrs", "%v Jahre", "%v pro Jahr"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"M", "%v M", "%v M", "%v/M"},
				Long:   &locales.CounterFormat{"Monate", "%v Monats", "%v Monate", "%v pro Monat"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"W", "%v W", "%v W", "%v/W"},
				Long:   &locales.CounterFormat{"Wochen", "%v Woche", "%v Wochen", "%v pro Woche"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"T", "%v T", "%v T", "%v/T"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Std.", "%v Std.", "%v Std.", "%v/h"},
				Long:   &locales.CounterFormat{"Stunden", "%v Stunde", "%v Stunden", "%v pro Stunde"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%v Min.", "%v Min.", "%v/min"},
				Long:   &locales.CounterFormat{"Minuten", "%v Minute", "%v Minuten", "%v pro Minute"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Sek.", "%v Sek.", "%v Sek.", ""},
				Long:   &locales.CounterFormat{"Sekunden", "%v Sekunde", "%v Sekunden", "%v pro Sekunde"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"Millisekunden", "%v Millisekunde", "%v Millisekunden", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"Mikrosekunden", "%v Mikrosekunde", "%v Mikrosekunden", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"Nanosekunden", "%v Nanosekunde", "%v Nanosekunden", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"≈%[1]v",
			"%[1]v+",
...
func (de *de) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(de, de.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'de'
func (de *de) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(de, de.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'de'
func (de *de) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(de, de.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'de'
func (de *de) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(de, de.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'de'
func (de *de) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(de, de.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'de'
func (de *de) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(de, de.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'de'
func (de *de) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(de, de.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'de'
func (de *de) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(de, de.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'de'
func (de *de) DateFullLayout() string {
	return de.dateFullLayout
}

// DateLongLayout returns the long date layout for 'de'
func (de *de) DateLongLayout() string {
	return de.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'de'
func (de *de) DateMediumLayout() string {
	return de.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'de'
func (de *de) DateShortLayout() string {
	return de.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'de'
func (de *de) TimeFullLayout() string {
	return de.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'de'
func (de *de) TimeLongLayout() string {
	return de.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'de'
func (de *de) TimeMediumLayout() string {
	return de.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'de'
func (de *de) TimeShortLayout() string {
	return de.timeShortLayout
}

func (de *de) ListPatterns() *locales.ListPatterns {
	return de.listPatterns
}

func (de *de) GetDurationSpec() *locales.DurationSpec {
	return de.DurationSpec
}

func (de *de) GetMiscPatterns() *locales.MiscPatterns {
	return &de.miscPatterns
}
