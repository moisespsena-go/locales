...
// DateFullLayout returns the full date layout for 'brx_IN'
func (brx *brx_IN) DateFullLayout() string {
	return brx.dateFullLayout
}

// DateLongLayout returns the long date layout for 'brx_IN'
func (brx *brx_IN) DateLongLayout() string {
	return brx.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'brx_IN'
func (brx *brx_IN) DateMediumLayout() string {
	return brx.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'brx_IN'
func (brx *brx_IN) DateShortLayout() string {
	return brx.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'brx_IN'
func (brx *brx_IN) TimeFullLayout() string {
	return brx.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'brx_IN'
func (brx *brx_IN) TimeLongLayout() string {
	return brx.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'brx_IN'
func (brx *brx_IN) TimeMediumLayout() string {
	return brx.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'brx_IN'
func (brx *brx_IN) TimeShortLayout() string {
	return brx.timeShortLayout
}

func (brx *brx_IN) ListPatterns() *locales.ListPatterns {
	return brx.listPatterns
}

func (brx *brx_IN) GetDurationSpec() *locales.DurationSpec {
	return brx.DurationSpec
}

func (brx *brx_IN) GetMiscPatterns() *locales.MiscPatterns {
