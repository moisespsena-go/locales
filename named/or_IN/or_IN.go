...
// DateFullLayout returns the full date layout for 'or_IN'
func (or *or_IN) DateFullLayout() string {
	return or.dateFullLayout
}

// DateLongLayout returns the long date layout for 'or_IN'
func (or *or_IN) DateLongLayout() string {
	return or.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'or_IN'
func (or *or_IN) DateMediumLayout() string {
	return or.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'or_IN'
func (or *or_IN) DateShortLayout() string {
	return or.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'or_IN'
func (or *or_IN) TimeFullLayout() string {
	return or.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'or_IN'
func (or *or_IN) TimeLongLayout() string {
	return or.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'or_IN'
func (or *or_IN) TimeMediumLayout() string {
	return or.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'or_IN'
func (or *or_IN) TimeShortLayout() string {
	return or.timeShortLayout
}

func (or *or_IN) ListPatterns() *locales.ListPatterns {
	return or.listPatterns
}

func (or *or_IN) GetDurationSpec() *locales.DurationSpec {
	return or.DurationSpec
}

func (or *or_IN) GetMiscPatterns() *locales.MiscPatterns {
