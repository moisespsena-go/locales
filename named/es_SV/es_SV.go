...
// DateFullLayout returns the full date layout for 'es_SV'
func (es *es_SV) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_SV'
func (es *es_SV) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_SV'
func (es *es_SV) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_SV'
func (es *es_SV) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_SV'
func (es *es_SV) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_SV'
func (es *es_SV) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_SV'
func (es *es_SV) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_SV'
func (es *es_SV) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_SV) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_SV) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_SV) GetMiscPatterns() *locales.MiscPatterns {
