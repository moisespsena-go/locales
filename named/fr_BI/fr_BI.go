...
// DateFullLayout returns the full date layout for 'fr_BI'
func (fr *fr_BI) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_BI'
func (fr *fr_BI) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_BI'
func (fr *fr_BI) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_BI'
func (fr *fr_BI) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_BI'
func (fr *fr_BI) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_BI'
func (fr *fr_BI) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_BI'
func (fr *fr_BI) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_BI'
func (fr *fr_BI) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_BI) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_BI) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_BI) GetMiscPatterns() *locales.MiscPatterns {
