...
// DateFullLayout returns the full date layout for 'hi_IN'
func (hi *hi_IN) DateFullLayout() string {
	return hi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'hi_IN'
func (hi *hi_IN) DateLongLayout() string {
	return hi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'hi_IN'
func (hi *hi_IN) DateMediumLayout() string {
	return hi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'hi_IN'
func (hi *hi_IN) DateShortLayout() string {
	return hi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'hi_IN'
func (hi *hi_IN) TimeFullLayout() string {
	return hi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'hi_IN'
func (hi *hi_IN) TimeLongLayout() string {
	return hi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'hi_IN'
func (hi *hi_IN) TimeMediumLayout() string {
	return hi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'hi_IN'
func (hi *hi_IN) TimeShortLayout() string {
	return hi.timeShortLayout
}

func (hi *hi_IN) ListPatterns() *locales.ListPatterns {
	return hi.listPatterns
}

func (hi *hi_IN) GetDurationSpec() *locales.DurationSpec {
	return hi.DurationSpec
}

func (hi *hi_IN) GetMiscPatterns() *locales.MiscPatterns {
