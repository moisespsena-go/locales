...
// DateFullLayout returns the full date layout for 'bo_IN'
func (bo *bo_IN) DateFullLayout() string {
	return bo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bo_IN'
func (bo *bo_IN) DateLongLayout() string {
	return bo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bo_IN'
func (bo *bo_IN) DateMediumLayout() string {
	return bo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bo_IN'
func (bo *bo_IN) DateShortLayout() string {
	return bo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bo_IN'
func (bo *bo_IN) TimeFullLayout() string {
	return bo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bo_IN'
func (bo *bo_IN) TimeLongLayout() string {
	return bo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bo_IN'
func (bo *bo_IN) TimeMediumLayout() string {
	return bo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bo_IN'
func (bo *bo_IN) TimeShortLayout() string {
	return bo.timeShortLayout
}

func (bo *bo_IN) ListPatterns() *locales.ListPatterns {
	return bo.listPatterns
}

func (bo *bo_IN) GetDurationSpec() *locales.DurationSpec {
	return bo.DurationSpec
}

func (bo *bo_IN) GetMiscPatterns() *locales.MiscPatterns {
