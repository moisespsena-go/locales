...
// DateFullLayout returns the full date layout for 'mn_MN'
func (mn *mn_MN) DateFullLayout() string {
	return mn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mn_MN'
func (mn *mn_MN) DateLongLayout() string {
	return mn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mn_MN'
func (mn *mn_MN) DateMediumLayout() string {
	return mn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mn_MN'
func (mn *mn_MN) DateShortLayout() string {
	return mn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mn_MN'
func (mn *mn_MN) TimeFullLayout() string {
	return mn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mn_MN'
func (mn *mn_MN) TimeLongLayout() string {
	return mn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mn_MN'
func (mn *mn_MN) TimeMediumLayout() string {
	return mn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mn_MN'
func (mn *mn_MN) TimeShortLayout() string {
	return mn.timeShortLayout
}

func (mn *mn_MN) ListPatterns() *locales.ListPatterns {
	return mn.listPatterns
}

func (mn *mn_MN) GetDurationSpec() *locales.DurationSpec {
	return mn.DurationSpec
}

func (mn *mn_MN) GetMiscPatterns() *locales.MiscPatterns {
