...
// DateFullLayout returns the full date layout for 'ar_DZ'
func (ar *ar_DZ) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_DZ'
func (ar *ar_DZ) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_DZ'
func (ar *ar_DZ) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_DZ'
func (ar *ar_DZ) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_DZ'
func (ar *ar_DZ) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_DZ'
func (ar *ar_DZ) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_DZ'
func (ar *ar_DZ) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_DZ'
func (ar *ar_DZ) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_DZ) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_DZ) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_DZ) GetMiscPatterns() *locales.MiscPatterns {
