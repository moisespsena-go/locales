...
func New() locales.Translator {
	return &ka{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 ათ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 ათ'.' ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 ათ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 ათ'.' ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 ათ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 ათ'.' ¤"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 მლნ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 მლნ'.' ¤"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 მლნ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 მლნ'.' ¤"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 მლნ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 მლნ'.' ¤"),
						}},
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 მლრდ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 მლრდ'.' ¤"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 მლრდ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 მლრდ'.' ¤"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 მლრ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 მლრ'.' ¤"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 ტრლ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 ტრლ'.' ¤"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 ტრლ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 ტრლ'.' ¤"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 ტრლ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 ტრლ'.' ¤"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "იან", "თებ", "მარ", "აპრ", "მაი", "ივნ", "ივლ", "აგვ", "სექ", "ოქტ", "ნოე", "დეკ"},
			MonthsNarrowValue:        []string{"", "ი", "თ", "მ", "ა", "მ", "ი", "ი", "ა", "ს", "ო", "ნ", "დ"},
			MonthsWideValue:          []string{"", "იანვარი", "თებერვალი", "მარტი", "აპრილი", "მაისი", "ივნისი", "ივლისი", "აგვისტო", "სექტემბერი", "ოქტომბერი", "ნოემბერი", "დეკემბერი"},
			WeekdaysAbbreviatedValue: []string{"კვი", "ორშ", "სამ", "ოთხ", "ხუთ", "პარ", "შაბ"},
			WeekdaysNarrowValue:      []string{"კ", "ო", "ს", "ო", "ხ", "პ", "შ"},
			WeekdaysShortValue:       []string{"კვ", "ორ", "სმ", "ოთ", "ხთ", "პრ", "შბ"},
			WeekdaysWideValue:        []string{"კვირა", "ორშაბათი", "სამშაბათი", "ოთხშაბათი", "ხუთშაბათი", "პარასკევი", "შაბათი"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsNarrowValue:       []string{"a", "p"},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"ძვ. წ.", "ახ. წ."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"ძველი წელთაღრიცხვით", "ახალი წელთაღრიცხვით"},
			TimezonesValue:           map[string]string{"": "ფოლკლენდის კუნძულების სტანდარტული დრო", "ACDT": "ავსტრალიის ცენტრალური ზაფხულის დრო", "ACST": "ავსტრალიის ცენტრალური სტანდარტული დრო", "ACT": "ACT", "ACWDT": "ცენტრალური და დასავლეთ ავსტრალიის ზაფხულის დრო", "ACWST": "ცენტრალური და დასავლეთ ავსტრალიის სტანდარტული დრო", "ADT": "ატლანტიკის ოკეანის ზაფხულის დრო", "AEDT": "აღმოსავლეთ ავსტრალიის ზაფხულის დრო", "AEST": "აღმოსავლეთ ავსტრალიის სტანდარტული დრო", "AFT": "ავღანეთის დრო", "AKDT": "ალასკის ზაფხულის დრო", "AKST": "ალასკის სტანდარტული დრო", "AMST": "ამაზონიის ზაფხულის დრო", "AMT": "ამაზონიის სტანდარტული დრო", "ARST": "არგენტინის ზაფხულის დრო", "ART": "არგენტინის სტანდარტული დრო", "AST": "ატლანტიკის ოკეანის სტანდარტული დრო", "AWDT": "დასავლეთ ავსტრალიის ზაფხულის დრო", "AWST": "დასავლეთ ავსტრალიის სტანდარტული დრო", "BNT": "ბრუნეი-დარუსალამის დრო", "BOT": "ბოლივიის დრო", "BRST": "ბრაზილიის ზაფხულის დრო", "BRT": "ბრაზილიის სტანდარტული დრო", "BST": "ბანგლადეშის ზაფხულის დრო", "BTT": "ბუტანის დრო", "CAT": "ცენტრალური აფრიკის დრო", "CCT": "ქოქოსის კუნძულების დრო", "CDT": "ჩრდილოეთ ამერიკის ცენტრალური ზაფხულის დრო", "CDT (Kuba)": "კუბის ზაფხულის დრო", "CHADT": "ჩატემის ზაფხულის დრო", "CHAST": "ჩატემის სტანდარტული დრო", "CLST": "ჩილეს ზაფხულის დრო", "CLT": "ჩილეს სტანდარტული დრო", "COST": "კოლუმბიის ზაფხულის დრო", "COT": "კოლუმბიის სტანდარტული დრო", "CST": "ჩრდილოეთ ამერიკის ცენტრალური სტანდარტული დრო", "CST (Kuba)": "კუბის სტანდარტული დრო", "CXT": "შობის კუნძულის დრო", "ChST": "ჩამოროს დრო", "EASST": "აღდგომის კუნძულის ზაფხულის დრო", "EAST": "აღდგომის კუნძულის სტანდარტული დრო", "EAT": "აღმოსავლეთ აფრიკის დრო", "ECT": "ეკვადორის დრო", "EDT": "ჩრდილოეთ ამერიკის აღმოსავლეთის ზაფხულის დრო", "EGDT": "აღმოსავლეთ გრენლანდიის ზაფხულის დრო", "EGST": "აღმოსავლეთ გრენლანდიის სტანდარტული დრო", "EST": "ჩრდილოეთ ამერიკის აღმოსავლეთის სტანდარტული დრო", "FKST": "ფოლკლენდის კუნძულების ზაფხულის დრო", "GALT": "გალაპაგოსის დრო", "GFT": "საფრანგეთის გვიანის დრო", "GMT": "გრინვიჩის საშუალო დრო", "GST": "სპარსეთის ყურის სტანდარტული დრო", "GYT": "გაიანის დრო", "HADT": "ჰავაისა და ალეუტის ზაფხულის დრო", "HAST": "ჰავაისა და ალეუტის სტანდარტული დრო", "HENOMX": "ჩრდილო-დასავლეთ მექსიკის ზაფხულის დრო", "HEOG": "დასავლეთ გრენლანდიის ზაფხულის დრო", "HEPMX": "მექსიკის წყნარი ოკეანის ზაფხულის დრო", "HKST": "ჰონკონგის ზაფხულის დრო", "HKT": "ჰონკონგის სტანდარტული დრო", "HNNOMX": "ჩრდილო-დასავლეთ მექსიკის დრო", "HNOG": "დასავლეთ გრენლანდიის სტანდარტული დრო", "HNPMX": "მექსიკის წყნარი ოკეანის სტანდარტული დრო", "ICT": "ინდოჩინეთის დრო", "IRDT": "ირანის დროის სარტყელი", "IRST": "ირანის სტანდარტული დრო", "IST": "ინდოეთის დრო", "JDT": "იაპონიის ზაფხულის დრო", "JST": "იაპონიის სტანდარტული დრო", "LHDT": "ლორდ-ჰაუს ზაფხულის დრო", "LHST": "ლორდ-ჰაუს სტანდარტული დრო", "MDT": "MDT", "MESZ": "ცენტრალური ევროპის ზაფხულის დრო", "MEZ": "ცენტრალური ევროპის სტანდარტული დრო", "MST": "MST", "MVT": "მალდივების დრო", "MYT": "მალაიზიის დრო", "NDT": "ნიუფაუნდლენდის ზაფხულის დრო", "NPT": "ნეპალის დრო", "NST": "ნიუფაუნდლენდის სტანდარტული დრო", "NZDT": "ახალი ზელანდიის ზაფხულის დრო", "NZST": "ახალი ზელანდიის სტანდარტული დრო", "OESZ": "აღმოსავლეთ ევროპის ზაფხულის დრო", "OEZ": "აღმოსავლეთ ევროპის სტანდარტული დრო", "PDT": "ჩრდილოეთ ამერიკის წყნარი ოკეანის ზაფხულის დრო", "PKT": "პაკისტანის ზაფხულის დრო", "PMDT": "სენ-პიერის და მიკელონის ზაფხულის დრო", "PMST": "სენ-პიერის და მიკელონის სტანდარტული დრო", "PST": "ჩრდილოეთ ამერიკის წყნარი ოკეანის სტანდარტული დრო", "PYST": "პარაგვაის ზაფხულის დრო", "SAST": "სამხრეთ აფრიკის დრო", "SGT": "სინგაპურის დრო", "SRT": "სურინამის დრო", "TLT": "აღმოსავლეთ ტიმორის დრო", "TMST": "თურქმენეთის ზაფხულის დრო", "TMT": "თურქმენეთის სტანდარტული დრო", "UYST": "ურუგვაის ზაფხულის დრო", "UYT": "ურუგვაის სტანდარტული დრო", "VET": "ვენესუელის დრო", "WARST": "დასავლეთ არგენტინის ზაფხულის დრო", "WART": "დასავლეთ არგენტინის სტანდარტული დრო", "WAST": "დასავლეთ აფრიკის ზაფხულის დრო", "WAT": "დასავლეთ აფრიკის სტანდარტული დრო", "WESZ": "დასავლეთ ევროპის ზაფხულის დრო", "WEZ": "დასავლეთ ევროპის სტანდარტული დრო", "WIB": "დასავლეთ ინდონეზიის დრო", "WIT": "აღმოსავლეთ ინდონეზიის დრო", "WITA": "ცენტრალური ინდონეზიის დრო", "∅∅∅": "პერუს ზაფხულის დრო"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} და {1}", "{0}, {1}", "{0}, {1}", "{0} და {1}"}, {"{0} ან {1}", "{0}, {1}", "{0}, {1}", "{0} ან {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ს.", "%v ს.", "%v ს.", ""},
				Long:   &locales.CounterFormat{"საუკუნე", "%v საუკუნე", "%v საუკუნე", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"დეკადა", "%v დეკადა", "%v დეკადა", ""},
				Long:   &locales.CounterFormat{"დეკადა", "%v დეკადა", "%v დეკადა", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"წ", "%v წ", "%v წ", ""},
				Long:   &locales.CounterFormat{"წელი", "%v წელი", "%v წელი", "%v წელში"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"თვე", "%v თვე", "%v თვე", ""},
				Long:   &locales.CounterFormat{"თვე", "%v თვე", "%v თვე", "%v თვეში"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"კვრ", "%v კვრ", "%v კვრ", ""},
				Long:   &locales.CounterFormat{"კვირა", "%v კვირა", "%v კვირა", "%v კვირაში"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"დღე", "%v დღე", "%v დღე", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"საათი", "%vსთ", "%vსთ", ""},
				Long:   &locales.CounterFormat{"საათი", "%v საათი", "%v საათი", "%v საათში"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"წთ", "%vწთ", "%vწთ", ""},
				Long:   &locales.CounterFormat{"წუთი", "%v წუთი", "%v წუთი", "%v წუთში"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"წმ", "%vწმ", "%vწმ", ""},
				Long:   &locales.CounterFormat{"წამი", "%v წამი", "%v წამი", "%v წამში"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"მწმ", "%v მწმ", "%v მწმ", ""},
				Long:   &locales.CounterFormat{"მილიწამი", "%v მილიწამი", "%v მილიწამი", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"მკწმ", "%v მკწმ", "%v მკწმ", ""},
				Long:   &locales.CounterFormat{"მიკროწამი", "%v მიკროწამი", "%v მიკროწამი", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ნწმ", "%v ნწმ", "%v ნწმ", ""},
				Long:   &locales.CounterFormat{"ნანოწამი", "%v ნანოწამი", "%v ნანოწამი", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"≈%[1]v",
			"%[1]v+",
...
func (ka *ka) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ka, ka.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ka'
func (ka *ka) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ka, ka.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ka'
func (ka *ka) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ka, ka.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ka'
func (ka *ka) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ka, ka.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ka'
func (ka *ka) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ka, ka.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ka'
func (ka *ka) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ka, ka.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ka'
func (ka *ka) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ka, ka.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ka'
func (ka *ka) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ka, ka.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ka'
func (ka *ka) DateFullLayout() string {
	return ka.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ka'
func (ka *ka) DateLongLayout() string {
	return ka.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ka'
func (ka *ka) DateMediumLayout() string {
	return ka.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ka'
func (ka *ka) DateShortLayout() string {
	return ka.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ka'
func (ka *ka) TimeFullLayout() string {
	return ka.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ka'
func (ka *ka) TimeLongLayout() string {
	return ka.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ka'
func (ka *ka) TimeMediumLayout() string {
	return ka.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ka'
func (ka *ka) TimeShortLayout() string {
	return ka.timeShortLayout
}

func (ka *ka) ListPatterns() *locales.ListPatterns {
	return ka.listPatterns
}

func (ka *ka) GetDurationSpec() *locales.DurationSpec {
	return ka.DurationSpec
}

func (ka *ka) GetMiscPatterns() *locales.MiscPatterns {
	return &ka.miscPatterns
}
