...
func New() locales.Translator {
	return &uz_Cyrl{
		...
		TimeSpec: &locales.TimeSpec{
			...
			WeekdaysAbbreviatedValue: []string{"якш", "душ", "сеш", "чор", "пай", "жум", "шан"},
			WeekdaysNarrowValue:      []string{"Я", "Д", "С", "Ч", "П", "Ж", "Ш"},
			WeekdaysShortValue:       []string{"як", "ду", "се", "чо", "па", "жу", "ша"},
			WeekdaysWideValue:        []string{"якшанба", "душанба", "сешанба", "чоршанба", "пайшанба", "жума", "шанба"},
			PeriodsAbbreviatedValue:  []string{"ТО", "ТК"},
			PeriodsNarrowValue:       []string{"ТО", "ТК"},
			PeriodsWideValue:         []string{"ТО", "ТК"},
			ErasAbbreviatedValue:     []string{"м.а.", "милодий"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"милоддан аввалги", "милодий"},
			TimezonesValue:           map[string]string{"": "Парагвай стандарт вақти", "ACDT": "Марказий Австралия кундузги вақти", "ACST": "Марказий Австралия стандарт вақти", "ACT": "ACT", "ACWDT": "Марказий Австралия Ғарбий кундузги вақти", "ACWST": "Марказий Австралия Ғарбий стандарт вақти", "ADT": "Атлантика кундузги вақти", "AEDT": "Шарқий Австралия кундузги вақти", "AEST": "Шарқий Австралия стандарт вақти", "AFT": "Афғонистон вақти", "AKDT": "Аляска кундузги вақти", "AKST": "Аляска стандарт вақти", "AMST": "Амазонка ёзги вақти", "AMT": "Амазонка стандарт вақти", "ARST": "Аргентина ёзги вақти", "ART": "Аргентина стандарт вақти", "AST": "Атлантика стандарт вақти", "AWDT": "Ғарбий Австралия кундузги вақти", "AWST": "Ғарбий Австралия стандарт вақти", "BNT": "Бруней Даруссалом вақти", "BOT": "Боливия вақти", "BRST": "Бразилия ёзги вақти", "BRT": "Бразилия стандарт вақти", "BST": "Бангладеш ёзги вақти", "BTT": "Бутан вақти", "CAT": "Марказий Африка вақти", "CCT": "Кокос ороллари вақти", "CDT": "Шимолий Америка марказий кундузги вақти", "CDT (Kuba)": "Куба кундузги вақти", "CHADT": "Чатхам кундузги вақти", "CHAST": "Чатхам стандарт вақти", "CLST": "Чили ёзги вақти", "CLT": "Чили стандарт вақти", "COST": "Колумбия ёзги вақти", "COT": "Колумбия стандарт вақти", "CST": "Шимолий Америка марказий стандарт вақти", "CST (Kuba)": "Куба стандарт вақти", "CXT": "Рождество ороли вақти", "ChST": "Каморро вақти", "EASST": "Пасхи ороли ёзги вақти", "EAST": "Пасхи ороли стандарт вақти", "EAT": "Шарқий Африка вақти", "ECT": "Эквадор вақти", "EDT": "Шимолий Америка шарқий кундузги вақти", "EGDT": "Шарқий Гренландия ёзги вақти", "EGST": "Шарқий Гренландия стандарт вақти", "EST": "Шимолий Америка шарқий стандарт вақти", "FKST": "Фолькленд ороллари ёзги вақти", "GALT": "Галапагос вақти", "GFT": "Француз Гвианаси вақти", "GMT": "Гринвич вақти", "GST": "Кўрфаз вақти", "GYT": "Гайана вақти", "HADT": "Гавайи-алеут кундузги вақти", "HAST": "Гавайи-алеут стандарт вақти", "HENOMX": "Shimoli-g‘arbiy Meksika yozgi vaqti", "HEOG": "Ғарбий Гренландия ёзги вақти", "HEPMX": "Meksika Tinch okeani yozgi vaqti", "HKST": "Гонконг ёзги вақти", "HKT": "Гонконг стандарт вақти", "HNNOMX": "Shimoli-g‘arbiy Meksika standart vaqti", "HNOG": "Ғарбий Гренландия стандарт вақти", "HNPMX": "Meksika Tinch okeani standart vaqti", "ICT": "Ҳинд-Хитой вақти", "IRDT": "Эрон кундузги вақти", "IRST": "Эрон стандарт вақти", "IST": "Ҳиндистон вақти", "JDT": "Япония кундузги вақти", "JST": "Япония стандарт вақти", "LHDT": "Лорд Хове кундузги вақти", "LHST": "Лорд Хове стандарт вақти", "MDT": "Шимолий Америка тоғ кундузги вақти", "MESZ": "Марказий Европа ёзги вақти", "MEZ": "Марказий Европа стандарт вақти", "MST": "Шимолий Америка тоғ стандарт вақти", "MVT": "Мальдив ороллар", "MYT": "Малайзия вақти", "NDT": "Ньюфаундленд кундузги вақти", "NPT": "Непал вақти", "NST": "Ньюфаундленд стандарт вақти", "NZDT": "Янги Зеландия кундузги вақти", "NZST": "Янги Зеландия стандарт вақти", "OESZ": "Шарқий Европа ёзги вақти", "OEZ": "Шарқий Европа стандарт вақти", "PDT": "Шимолий Америка тинч океани кундузги вақти", "PKT": "Покистон ёзги вақти", "PMDT": "Сент-Пьер ва Микелон кундузги вақти", "PMST": "Сент-Пьер ва Микелон стандарт вақти", "PST": "Шимолий Америка тинч океани стандарт вақти", "PYST": "Парагвай ёзги вақти", "SAST": "Жанубий Африка вақти", "SGT": "Сингапур вақти", "SRT": "Суринам вақти", "TLT": "Шарқий Тимор вақти", "TMST": "Туркманистон ёзги вақти", "TMT": "Туркманистон стандарт вақти", "UYST": "Уругвай ёзги вақти", "UYT": "Уругвай стандарт вақти", "VET": "Венесуэла вақти", "WARST": "Ғарбий Аргентина ёзги вақти", "WART": "Ғарбий Аргентина стандарт вақти", "WAST": "Ғарбий Африка ёзги вақти", "WAT": "Ғарбий Африка стандарт вақти", "WESZ": "Ғарбий Европа ёзги вақти", "WEZ": "Ғарбий Европа стандарт вақти", "WIB": "Ғарбий Индонезия вақти", "WIT": "Шарқий Индонезия вақти", "WITA": "Марказий Индонезия вақти", "∅∅∅": "Азор ёзги вақти"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"", "%v й", "%v й", ""},
				Long:   &locales.CounterFormat{"йил", "%v йил", "%v йил", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v ой", "%v ой", ""},
				Long:   &locales.CounterFormat{"ой", "%v ой", "%v ой", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v ҳафт", "%v ҳафт", ""},
				Long:   &locales.CounterFormat{"ҳафта", "%v ҳафта", "%v ҳафта", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v к", "%v к", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v с", "%v с", ""},
				Long:   &locales.CounterFormat{"соат", "%v соат", "%v соат", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v дақ", "%v дақ", ""},
				Long:   &locales.CounterFormat{"дақиқа", "%v дақиқа", "%v дақиқа", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v сон", "%v сон", ""},
				Long:   &locales.CounterFormat{"сония", "%v сония", "%v сония", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v мс", "%v мс", ""},
				Long:   &locales.CounterFormat{"миллисония", "%v миллисония", "%v миллисония", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
		miscPatterns: locales.MiscPatterns{
...
func (uz *uz_Cyrl) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(uz, uz.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'uz_Cyrl'
func (uz *uz_Cyrl) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(uz, uz.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'uz_Cyrl'
func (uz *uz_Cyrl) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(uz, uz.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'uz_Cyrl'
func (uz *uz_Cyrl) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(uz, uz.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'uz_Cyrl'
func (uz *uz_Cyrl) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(uz, uz.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'uz_Cyrl'
func (uz *uz_Cyrl) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(uz, uz.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'uz_Cyrl'
func (uz *uz_Cyrl) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(uz, uz.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'uz_Cyrl'
func (uz *uz_Cyrl) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(uz, uz.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'uz_Cyrl'
func (uz *uz_Cyrl) DateFullLayout() string {
	return uz.dateFullLayout
}

// DateLongLayout returns the long date layout for 'uz_Cyrl'
func (uz *uz_Cyrl) DateLongLayout() string {
	return uz.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'uz_Cyrl'
func (uz *uz_Cyrl) DateMediumLayout() string {
	return uz.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'uz_Cyrl'
func (uz *uz_Cyrl) DateShortLayout() string {
	return uz.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'uz_Cyrl'
func (uz *uz_Cyrl) TimeFullLayout() string {
	return uz.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'uz_Cyrl'
func (uz *uz_Cyrl) TimeLongLayout() string {
	return uz.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'uz_Cyrl'
func (uz *uz_Cyrl) TimeMediumLayout() string {
	return uz.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'uz_Cyrl'
func (uz *uz_Cyrl) TimeShortLayout() string {
	return uz.timeShortLayout
}

func (uz *uz_Cyrl) ListPatterns() *locales.ListPatterns {
	return uz.listPatterns
}

func (uz *uz_Cyrl) GetDurationSpec() *locales.DurationSpec {
	return uz.DurationSpec
}

func (uz *uz_Cyrl) GetMiscPatterns() *locales.MiscPatterns {
	return &uz.miscPatterns
}
