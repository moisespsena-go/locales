...
func New() locales.Translator {
	return &smn{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"mikrosekunteh", "%v μs", "%v μs", ""}},
			locales.DurationSpecPair{},
		},
		miscPatterns: locales.MiscPatterns{
			"",
...
// DateFullLayout returns the full date layout for 'smn'
func (smn *smn) DateFullLayout() string {
	return smn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'smn'
func (smn *smn) DateLongLayout() string {
	return smn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'smn'
func (smn *smn) DateMediumLayout() string {
	return smn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'smn'
func (smn *smn) DateShortLayout() string {
	return smn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'smn'
func (smn *smn) TimeFullLayout() string {
	return smn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'smn'
func (smn *smn) TimeLongLayout() string {
	return smn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'smn'
func (smn *smn) TimeMediumLayout() string {
	return smn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'smn'
func (smn *smn) TimeShortLayout() string {
	return smn.timeShortLayout
}

func (smn *smn) ListPatterns() *locales.ListPatterns {
	return smn.listPatterns
}

func (smn *smn) GetDurationSpec() *locales.DurationSpec {
	return smn.DurationSpec
}

func (smn *smn) GetMiscPatterns() *locales.MiscPatterns {
