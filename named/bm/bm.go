...
// DateFullLayout returns the full date layout for 'bm'
func (bm *bm) DateFullLayout() string {
	return bm.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bm'
func (bm *bm) DateLongLayout() string {
	return bm.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bm'
func (bm *bm) DateMediumLayout() string {
	return bm.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bm'
func (bm *bm) DateShortLayout() string {
	return bm.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bm'
func (bm *bm) TimeFullLayout() string {
	return bm.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bm'
func (bm *bm) TimeLongLayout() string {
	return bm.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bm'
func (bm *bm) TimeMediumLayout() string {
	return bm.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bm'
func (bm *bm) TimeShortLayout() string {
	return bm.timeShortLayout
}

func (bm *bm) ListPatterns() *locales.ListPatterns {
	return bm.listPatterns
}

func (bm *bm) GetDurationSpec() *locales.DurationSpec {
	return bm.DurationSpec
}

func (bm *bm) GetMiscPatterns() *locales.MiscPatterns {
