...
func New() locales.Translator {
	return &ewo_CM{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ngo", "ngb", "ngl", "ngn", "ngt", "ngs", "ngz", "ngm", "nge", "nga", "ngad", "ngab"},
			MonthsNarrowValue:        []string{"", "o", "b", "l", "n", "t", "s", "z", "m", "e", "a", "d", "b"},
			MonthsWideValue:          []string{"", "ngɔn osú", "ngɔn bɛ̌", "ngɔn lála", "ngɔn nyina", "ngɔn tána", "ngɔn saməna", "ngɔn zamgbála", "ngɔn mwom", "ngɔn ebulú", "ngɔn awóm", "ngɔn awóm ai dziá", "ngɔn awóm ai bɛ̌"},
			WeekdaysAbbreviatedValue: []string{"sɔ́n", "mɔ́n", "smb", "sml", "smn", "fúl", "sér"},
			WeekdaysNarrowValue:      []string{"s", "m", "s", "s", "s", "f", "s"},
			WeekdaysWideValue:        []string{"sɔ́ndɔ", "mɔ́ndi", "sɔ́ndɔ məlú mə́bɛ̌", "sɔ́ndɔ məlú mə́lɛ́", "sɔ́ndɔ məlú mə́nyi", "fúladé", "séradé"},
			PeriodsAbbreviatedValue:  []string{"kíkíríg", "ngəgógəle"},
			PeriodsWideValue:         []string{"kíkíríg", "ngəgógəle"},
			ErasAbbreviatedValue:     []string{"oyk", "ayk"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"osúsúa Yésus kiri", "ámvus Yésus Kirís"},
...
func (ewo *ewo_CM) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ewo, ewo.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ewo_CM'
func (ewo *ewo_CM) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ewo, ewo.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ewo_CM'
func (ewo *ewo_CM) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ewo, ewo.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ewo_CM'
func (ewo *ewo_CM) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ewo, ewo.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ewo_CM'
func (ewo *ewo_CM) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ewo, ewo.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ewo_CM'
func (ewo *ewo_CM) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ewo, ewo.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ewo_CM'
func (ewo *ewo_CM) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ewo, ewo.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ewo_CM'
func (ewo *ewo_CM) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ewo, ewo.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ewo_CM'
func (ewo *ewo_CM) DateFullLayout() string {
	return ewo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ewo_CM'
func (ewo *ewo_CM) DateLongLayout() string {
	return ewo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ewo_CM'
func (ewo *ewo_CM) DateMediumLayout() string {
	return ewo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ewo_CM'
func (ewo *ewo_CM) DateShortLayout() string {
	return ewo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ewo_CM'
func (ewo *ewo_CM) TimeFullLayout() string {
	return ewo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ewo_CM'
func (ewo *ewo_CM) TimeLongLayout() string {
	return ewo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ewo_CM'
func (ewo *ewo_CM) TimeMediumLayout() string {
	return ewo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ewo_CM'
func (ewo *ewo_CM) TimeShortLayout() string {
	return ewo.timeShortLayout
}

func (ewo *ewo_CM) ListPatterns() *locales.ListPatterns {
	return ewo.listPatterns
}

func (ewo *ewo_CM) GetDurationSpec() *locales.DurationSpec {
	return ewo.DurationSpec
}

func (ewo *ewo_CM) GetMiscPatterns() *locales.MiscPatterns {
	return &ewo.miscPatterns
}
