...
// DateFullLayout returns the full date layout for 'mua'
func (mua *mua) DateFullLayout() string {
	return mua.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mua'
func (mua *mua) DateLongLayout() string {
	return mua.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mua'
func (mua *mua) DateMediumLayout() string {
	return mua.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mua'
func (mua *mua) DateShortLayout() string {
	return mua.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mua'
func (mua *mua) TimeFullLayout() string {
	return mua.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mua'
func (mua *mua) TimeLongLayout() string {
	return mua.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mua'
func (mua *mua) TimeMediumLayout() string {
	return mua.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mua'
func (mua *mua) TimeShortLayout() string {
	return mua.timeShortLayout
}

func (mua *mua) ListPatterns() *locales.ListPatterns {
	return mua.listPatterns
}

func (mua *mua) GetDurationSpec() *locales.DurationSpec {
	return mua.DurationSpec
}

func (mua *mua) GetMiscPatterns() *locales.MiscPatterns {
