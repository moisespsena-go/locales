...
func New() locales.Translator {
	return &zh{
		...
		TimeSpec: &locales.TimeSpec{
			...
			MonthsWideValue:          []string{"", "一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"},
			WeekdaysAbbreviatedValue: []string{"周日", "周一", "周二", "周三", "周四", "周五", "周六"},
			WeekdaysNarrowValue:      []string{"日", "一", "二", "三", "四", "五", "六"},
			WeekdaysShortValue:       []string{"周日", "周一", "周二", "周三", "周四", "周五", "周六"},
			...
			ErasAbbreviatedValue:     []string{"公元前", "公元"},
			ErasNarrowValue:          []string{"公元前", "公元"},
			ErasWideValue:            []string{"公元前", "公元"},
			TimezonesValue:           map[string]string{"": "福克兰群岛标准时间", "ACDT": "澳大利亚中部夏令时间", "ACST": "阿克里夏令时间", "ACT": "阿克里标准时间", "ACWDT": "澳大利亚中西部夏令时间", "ACWST": "澳大利亚中西部标准时间", "ADT": "大西洋夏令时间", "AEDT": "澳大利亚东部夏令时间", "AEST": "澳大利亚东部标准时间", "AFT": "阿富汗时间", "AKDT": "阿拉斯加夏令时间", "AKST": "阿拉斯加标准时间", "AMST": "亚马逊夏令时间", "AMT": "亚马逊标准时间", "ARST": "阿根廷夏令时间", "ART": "阿根廷标准时间", "AST": "大西洋标准时间", "AWDT": "澳大利亚西部夏令时间", "AWST": "澳大利亚西部标准时间", "BNT": "文莱达鲁萨兰时间", "BOT": "玻利维亚标准时间", "BRST": "巴西利亚夏令时间", "BRT": "巴西利亚标准时间", "BST": "孟加拉夏令时间", "BTT": "不丹时间", "CAT": "中部非洲时间", "CCT": "科科斯群岛时间", "CDT": "北美中部夏令时间", "CDT (Kuba)": "古巴夏令时间", "CHADT": "查坦夏令时间", "CHAST": "查坦标准时间", "CLST": "智利夏令时间", "CLT": "智利标准时间", "COST": "哥伦比亚夏令时间", "COT": "哥伦比亚标准时间", "CST": "北美中部标准时间", "CST (Kuba)": "古巴标准时间", "CXT": "圣诞岛时间", "ChST": "查莫罗时间", "EASST": "复活节岛夏令时间", "EAST": "复活节岛标准时间", "EAT": "东部非洲时间", "ECT": "厄瓜多尔标准时间", "EDT": "北美东部夏令时间", "EGDT": "格陵兰岛东部夏令时间", "EGST": "格陵兰岛东部标准时间", "EST": "北美东部标准时间", "FKST": "福克兰群岛夏令时间", "GALT": "加拉帕戈斯时间", "GFT": "法属圭亚那标准时间", "GMT": "格林尼治标准时间", "GST": "海湾标准时间", "GYT": "圭亚那时间", "HADT": "夏威夷-阿留申夏令时间", "HAST": "夏威夷-阿留申标准时间", "HENOMX": "墨西哥西北部夏令时间", "HEOG": "格陵兰岛西部夏令时间", "HEPMX": "墨西哥太平洋夏令时间", "HKST": "香港夏令时间", "HKT": "香港标准时间", "HNNOMX": "墨西哥西北部标准时间", "HNOG": "格陵兰岛西部标准时间", "HNPMX": "墨西哥太平洋标准时间", "ICT": "中南半岛时间", "IRDT": "伊朗夏令时间", "IRST": "伊朗标准时间", "IST": "印度时间", "JDT": "日本夏令时间", "JST": "日本标准时间", "LHDT": "豪勋爵岛夏令时间", "LHST": "豪勋爵岛标准时间", "MDT": "澳门夏令时间", "MESZ": "中欧夏令时间", "MEZ": "中欧标准时间", "MST": "澳门标准时间", "MVT": "马尔代夫时间", "MYT": "马来西亚时间", "NDT": "纽芬兰夏令时间", "NPT": "尼泊尔时间", "NST": "纽芬兰标准时间", "NZDT": "新西兰夏令时间", "NZST": "新西兰标准时间", "OESZ": "东欧夏令时间", "OEZ": "东欧标准时间", "PDT": "北美太平洋夏令时间", "PKT": "巴基斯坦夏令时间", "PMDT": "圣皮埃尔和密克隆群岛夏令时间", "PMST": "圣皮埃尔和密克隆群岛标准时间", "PST": "北美太平洋标准时间", "PYST": "巴拉圭夏令时间", "SAST": "南非标准时间", "SGT": "新加坡标准时间", "SRT": "苏里南时间", "TLT": "东帝汶时间", "TMST": "土库曼斯坦夏令时间", "TMT": "土库曼斯坦标准时间", "UYST": "乌拉圭夏令时间", "UYT": "乌拉圭标准时间", "VET": "委内瑞拉时间", "WARST": "阿根廷西部夏令时间", "WART": "阿根廷西部标准时间", "WAST": "西部非洲夏令时间", "WAT": "西部非洲标准时间", "WESZ": "西欧夏令时间", "WEZ": "西欧标准时间", "WIB": "印度尼西亚西部时间", "WIT": "印度尼西亚东部时间", "WITA": "印度尼西亚中部时间", "∅∅∅": "秘鲁夏令时间"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0}和{1}", "{0}、{1}", "{0}、{1}", "{0}和{1}"}, {"{0}或{1}", "{0}、{1}", "{0}、{1}", "{0}或{1}"}}),
...
func (zh *zh) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(zh, zh.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'zh'
func (zh *zh) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(zh, zh.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'zh'
func (zh *zh) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(zh, zh.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'zh'
func (zh *zh) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(zh, zh.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'zh'
func (zh *zh) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(zh, zh.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'zh'
func (zh *zh) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(zh, zh.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'zh'
func (zh *zh) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(zh, zh.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'zh'
func (zh *zh) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(zh, zh.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'zh'
func (zh *zh) DateFullLayout() string {
	return zh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'zh'
func (zh *zh) DateLongLayout() string {
	return zh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'zh'
func (zh *zh) DateMediumLayout() string {
	return zh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'zh'
func (zh *zh) DateShortLayout() string {
	return zh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'zh'
func (zh *zh) TimeFullLayout() string {
	return zh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'zh'
func (zh *zh) TimeLongLayout() string {
	return zh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'zh'
func (zh *zh) TimeMediumLayout() string {
	return zh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'zh'
func (zh *zh) TimeShortLayout() string {
	return zh.timeShortLayout
}

func (zh *zh) ListPatterns() *locales.ListPatterns {
	return zh.listPatterns
}

func (zh *zh) GetDurationSpec() *locales.DurationSpec {
	return zh.DurationSpec
}

func (zh *zh) GetMiscPatterns() *locales.MiscPatterns {
	return &zh.miscPatterns
}
