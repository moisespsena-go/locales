...
// DateFullLayout returns the full date layout for 'pt_MO'
func (pt *pt_MO) DateFullLayout() string {
	return pt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pt_MO'
func (pt *pt_MO) DateLongLayout() string {
	return pt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pt_MO'
func (pt *pt_MO) DateMediumLayout() string {
	return pt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pt_MO'
func (pt *pt_MO) DateShortLayout() string {
	return pt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pt_MO'
func (pt *pt_MO) TimeFullLayout() string {
	return pt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pt_MO'
func (pt *pt_MO) TimeLongLayout() string {
	return pt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pt_MO'
func (pt *pt_MO) TimeMediumLayout() string {
	return pt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pt_MO'
func (pt *pt_MO) TimeShortLayout() string {
	return pt.timeShortLayout
}

func (pt *pt_MO) ListPatterns() *locales.ListPatterns {
	return pt.listPatterns
}

func (pt *pt_MO) GetDurationSpec() *locales.DurationSpec {
	return pt.DurationSpec
}

func (pt *pt_MO) GetMiscPatterns() *locales.MiscPatterns {
