...
// DateFullLayout returns the full date layout for 'es_NI'
func (es *es_NI) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_NI'
func (es *es_NI) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_NI'
func (es *es_NI) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_NI'
func (es *es_NI) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_NI'
func (es *es_NI) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_NI'
func (es *es_NI) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_NI'
func (es *es_NI) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_NI'
func (es *es_NI) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_NI) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_NI) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_NI) GetMiscPatterns() *locales.MiscPatterns {
