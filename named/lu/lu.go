...
// DateFullLayout returns the full date layout for 'lu'
func (lu *lu) DateFullLayout() string {
	return lu.dateFullLayout
}

// DateLongLayout returns the long date layout for 'lu'
func (lu *lu) DateLongLayout() string {
	return lu.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'lu'
func (lu *lu) DateMediumLayout() string {
	return lu.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'lu'
func (lu *lu) DateShortLayout() string {
	return lu.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'lu'
func (lu *lu) TimeFullLayout() string {
	return lu.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'lu'
func (lu *lu) TimeLongLayout() string {
	return lu.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'lu'
func (lu *lu) TimeMediumLayout() string {
	return lu.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'lu'
func (lu *lu) TimeShortLayout() string {
	return lu.timeShortLayout
}

func (lu *lu) ListPatterns() *locales.ListPatterns {
	return lu.listPatterns
}

func (lu *lu) GetDurationSpec() *locales.DurationSpec {
	return lu.DurationSpec
}

func (lu *lu) GetMiscPatterns() *locales.MiscPatterns {
