...
// DateFullLayout returns the full date layout for 'en_NZ'
func (en *en_NZ) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_NZ'
func (en *en_NZ) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_NZ'
func (en *en_NZ) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_NZ'
func (en *en_NZ) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_NZ'
func (en *en_NZ) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_NZ'
func (en *en_NZ) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_NZ'
func (en *en_NZ) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_NZ'
func (en *en_NZ) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_NZ) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_NZ) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_NZ) GetMiscPatterns() *locales.MiscPatterns {
