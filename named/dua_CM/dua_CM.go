...
func New() locales.Translator {
	return &dua_CM{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "di", "ŋgɔn", "sɔŋ", "diɓ", "emi", "esɔ", "mad", "diŋ", "nyɛt", "may", "tin", "elá"},
			MonthsNarrowValue:        []string{"", "d", "ŋ", "s", "d", "e", "e", "m", "d", "n", "m", "t", "e"},
			MonthsWideValue:          []string{"", "dimɔ́di", "ŋgɔndɛ", "sɔŋɛ", "diɓáɓá", "emiasele", "esɔpɛsɔpɛ", "madiɓɛ́díɓɛ́", "diŋgindi", "nyɛtɛki", "mayésɛ́", "tiníní", "eláŋgɛ́"},
			WeekdaysAbbreviatedValue: []string{"ét", "mɔ́s", "kwa", "muk", "ŋgi", "ɗón", "esa"},
			WeekdaysNarrowValue:      []string{"e", "m", "k", "m", "ŋ", "ɗ", "e"},
			WeekdaysWideValue:        []string{"éti", "mɔ́sú", "kwasú", "mukɔ́sú", "ŋgisú", "ɗónɛsú", "esaɓasú"},
			PeriodsAbbreviatedValue:  []string{"idiɓa", "ebyámu"},
			PeriodsWideValue:         []string{"idiɓa", "ebyámu"},
			ErasAbbreviatedValue:     []string{"ɓ.Ys", "mb.Ys"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"ɓoso ɓwá yáɓe lá", "mbúsa kwédi a Yés"},
...
func (dua *dua_CM) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(dua, dua.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'dua_CM'
func (dua *dua_CM) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(dua, dua.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'dua_CM'
func (dua *dua_CM) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(dua, dua.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'dua_CM'
func (dua *dua_CM) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(dua, dua.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'dua_CM'
func (dua *dua_CM) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(dua, dua.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'dua_CM'
func (dua *dua_CM) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(dua, dua.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'dua_CM'
func (dua *dua_CM) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(dua, dua.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'dua_CM'
func (dua *dua_CM) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(dua, dua.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'dua_CM'
func (dua *dua_CM) DateFullLayout() string {
	return dua.dateFullLayout
}

// DateLongLayout returns the long date layout for 'dua_CM'
func (dua *dua_CM) DateLongLayout() string {
	return dua.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'dua_CM'
func (dua *dua_CM) DateMediumLayout() string {
	return dua.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'dua_CM'
func (dua *dua_CM) DateShortLayout() string {
	return dua.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'dua_CM'
func (dua *dua_CM) TimeFullLayout() string {
	return dua.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'dua_CM'
func (dua *dua_CM) TimeLongLayout() string {
	return dua.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'dua_CM'
func (dua *dua_CM) TimeMediumLayout() string {
	return dua.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'dua_CM'
func (dua *dua_CM) TimeShortLayout() string {
	return dua.timeShortLayout
}

func (dua *dua_CM) ListPatterns() *locales.ListPatterns {
	return dua.listPatterns
}

func (dua *dua_CM) GetDurationSpec() *locales.DurationSpec {
	return dua.DurationSpec
}

func (dua *dua_CM) GetMiscPatterns() *locales.MiscPatterns {
	return &dua.miscPatterns
}
