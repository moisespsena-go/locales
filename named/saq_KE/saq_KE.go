...
func New() locales.Translator {
	return &saq_KE{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Obo", "Waa", "Oku", "Ong", "Ime", "Ile", "Sap", "Isi", "Saa", "Tom", "Tob", "Tow"},
			MonthsNarrowValue:        []string{"", "O", "W", "O", "O", "I", "I", "S", "I", "S", "T", "T", "T"},
			MonthsWideValue:          []string{"", "Lapa le obo", "Lapa le waare", "Lapa le okuni", "Lapa le ong’wan", "Lapa le imet", "Lapa le ile", "Lapa le sapa", "Lapa le isiet", "Lapa le saal", "Lapa le tomon", "Lapa le tomon obo", "Lapa le tomon waare"},
			WeekdaysAbbreviatedValue: []string{"Are", "Kun", "Ong", "Ine", "Ile", "Sap", "Kwe"},
			WeekdaysNarrowValue:      []string{"A", "K", "O", "I", "I", "S", "K"},
			WeekdaysWideValue:        []string{"Mderot ee are", "Mderot ee kuni", "Mderot ee ong’wan", "Mderot ee inet", "Mderot ee ile", "Mderot ee sapa", "Mderot ee kwe"},
			PeriodsAbbreviatedValue:  []string{"Tesiran", "Teipa"},
			PeriodsWideValue:         []string{"Tesiran", "Teipa"},
			ErasAbbreviatedValue:     []string{"KK", "BK"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Kabla ya Christo", "Baada ya Christo"},
...
func (saq *saq_KE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(saq, saq.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'saq_KE'
func (saq *saq_KE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(saq, saq.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'saq_KE'
func (saq *saq_KE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(saq, saq.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'saq_KE'
func (saq *saq_KE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(saq, saq.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'saq_KE'
func (saq *saq_KE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(saq, saq.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'saq_KE'
func (saq *saq_KE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(saq, saq.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'saq_KE'
func (saq *saq_KE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(saq, saq.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'saq_KE'
func (saq *saq_KE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(saq, saq.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'saq_KE'
func (saq *saq_KE) DateFullLayout() string {
	return saq.dateFullLayout
}

// DateLongLayout returns the long date layout for 'saq_KE'
func (saq *saq_KE) DateLongLayout() string {
	return saq.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'saq_KE'
func (saq *saq_KE) DateMediumLayout() string {
	return saq.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'saq_KE'
func (saq *saq_KE) DateShortLayout() string {
	return saq.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'saq_KE'
func (saq *saq_KE) TimeFullLayout() string {
	return saq.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'saq_KE'
func (saq *saq_KE) TimeLongLayout() string {
	return saq.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'saq_KE'
func (saq *saq_KE) TimeMediumLayout() string {
	return saq.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'saq_KE'
func (saq *saq_KE) TimeShortLayout() string {
	return saq.timeShortLayout
}

func (saq *saq_KE) ListPatterns() *locales.ListPatterns {
	return saq.listPatterns
}

func (saq *saq_KE) GetDurationSpec() *locales.DurationSpec {
	return saq.DurationSpec
}

func (saq *saq_KE) GetMiscPatterns() *locales.MiscPatterns {
	return &saq.miscPatterns
}
