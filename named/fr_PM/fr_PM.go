...
// DateFullLayout returns the full date layout for 'fr_PM'
func (fr *fr_PM) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_PM'
func (fr *fr_PM) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_PM'
func (fr *fr_PM) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_PM'
func (fr *fr_PM) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_PM'
func (fr *fr_PM) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_PM'
func (fr *fr_PM) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_PM'
func (fr *fr_PM) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_PM'
func (fr *fr_PM) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_PM) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_PM) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_PM) GetMiscPatterns() *locales.MiscPatterns {
