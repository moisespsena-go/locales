...
func New() locales.Translator {
	return &sd_Deva{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "जन", "फर", "मार्च", "अप्रै", "मई", "जून", "जु", "अग", "सप्टे", "ऑक्टो", "नवं", "डिसं"},
			MonthsNarrowValue:        []string{"", "ज", "फ़", "मा", "अ", "मा", "जू", "जु", "अग", "स", "ऑ", "न", "डि"},
			MonthsWideValue:          []string{"", "जनवरी", "फरवरी", "मार्चु", "अप्रैल", "मई", "जून", "जुलाई", "अगस्ट", "सप्टेंबर", "ऑक्टोबर", "नवंबर", "डिसंबर"},
			WeekdaysAbbreviatedValue: []string{"आर्त", "सू", "मंग", "बु॒ध", "विस", "जुम", "छंछ"},
			WeekdaysNarrowValue:      []string{"आ", "सू", "मं", "बु॒", "वि", "जु", "छं"},
			WeekdaysShortValue:       []string{"آچر", "سومر", "اڱارو", "اربع", "خميس", "جمعو", "ڇنڇر"},
			WeekdaysWideValue:        []string{"आर्तवार", "सूमर", "मंगलु", "बु॒धर", "विस्पत", "जुमो", "छंछर"},
			PeriodsAbbreviatedValue:  []string{"صبح، منجهند", "شام، منجهند"},
			PeriodsNarrowValue:       []string{"صبح، منجهند", "منجهند، شام"},
			PeriodsWideValue:         []string{"मंझंदि खां पहिंरियों", "मंझंदि खां पोइ"},
			ErasAbbreviatedValue:     []string{"बीसी", "एडी"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"", ""},
			TimezonesValue:           map[string]string{"": "پيراگوئي جو معياري وقت", "ACDT": "آسٽريليا جو مرڪزي ڏينهن جو وقت", "ACST": "آسٽريليا جو مرڪزي معياري وقت", "ACT": "ACT", "ACWDT": "آسٽريليا جو مرڪزي مغربي ڏينهن جو وقت", "ACWST": "آسٽريليا جو مرڪزي مغربي معياري وقت", "ADT": "अटलांटिक दीं॒ह जो वक्त", "AEDT": "آسٽريليا جو مشرقي ڏينهن جو وقت", "AEST": "آسٽريليا جو مشرقي معياري وقت", "AFT": "افغانستان جو وقت", "AKDT": "الاسڪا جي ڏينهن جو وقت", "AKST": "الاسڪا جو معياري وقت", "AMST": "ايميزون جي اونهاري جو وقت", "AMT": "ايميزون جو معياري وقت", "ARST": "ارجنٽائن جي اونهاري جو وقت", "ART": "ارجنٽائن معياري وقت", "AST": "अटलांटिक मअयारी वक्त", "AWDT": "آسٽريليا جو مغربي ڏينهن جو وقت", "AWST": "آسٽريليا جو مغربي معياري وقت", "BNT": "برونائي دارالسلام جو وقت", "BOT": "بولويائي وقت", "BRST": "براسيليا جي اونهاري جو وقت", "BRT": "براسيليا جو معياري وقت", "BST": "بنگلاديش جي اونهاري جو وقت", "BTT": "ڀوٽان جو وقت", "CAT": "مرڪزي آفريقا جو وقت", "CCT": "ڪوڪوس آئي لينڊ جو وقت", "CDT": "मरकज़ी दीं॒ह जो वक्त", "CDT (Kuba)": "ڪيوبا جي ڏينهن جو وقت", "CHADT": "چئٿم جي ڏينهن جو وقت", "CHAST": "چئٿم جو معياري وقت", "CLST": "چلي جي اونهاري جو وقت", "CLT": "چلي جو معياري وقت", "COST": "ڪولمبيا جي اونهاري جو وقت", "COT": "ڪولمبيا جو معياري وقت", "CST": "मरकज़ी मअयारी वक्त", "CST (Kuba)": "ڪيوبا جو معياري وقت", "CXT": "ڪرسمس آئي لينڊ جو وقت", "ChST": "چمورو جو معياري وقت", "EASST": "ايسٽر آئي لينڊ جي اونهاري جو وقت", "EAST": "ايسٽر آئي لينڊ جو معياري وقت", "EAT": "اوڀر آفريڪا جو وقت", "ECT": "ايڪواڊور جو وقت", "EDT": "ओभरी दीं॒ह जो वक्त", "EGDT": "مشرقي گرين لينڊ جي اونهاري جو وقت", "EGST": "مشرقي گرين لينڊ جو معياري وقت", "EST": "ओभरी मअयारी वक्त", "FKST": "فاڪ لينڊ آئي لينڊ جي اونهاري جو وقت", "GALT": "گالاپاگوز جو وقت", "GFT": "فرانسيسي گيانا جو وقت", "GMT": "ग्रीनविच मीन वक्तु", "GST": "خليجي معياري وقت", "GYT": "گيانائي وقت", "HADT": "هوائي اليوٽين جي ڏينهن جو وقت", "HAST": "هوائي اليوٽين جو معياري وقت", "HENOMX": "شمالي مغربي ميڪسيڪو جي ڏينهن جو وقت", "HEOG": "مغربي گرين لينڊ جي اونهاري جو وقت", "HEPMX": "ميڪسيڪن پيسيفڪ جي ڏينهن جو وقت", "HKST": "هانگ ڪانگ جي اونهاري جو وقت", "HKT": "هانگ ڪانگ جو معياري وقت", "HNNOMX": "شمالي مغربي ميڪسيڪو جو معياري وقت", "HNOG": "مغربي گرين لينڊ جو معياري وقت", "HNPMX": "ميڪسيڪن پيسيفڪ جو معياري وقت", "ICT": "انڊو چائنا جو وقت", "IRDT": "ايران جي ڏينهن جو وقت", "IRST": "ايران جو معياري وقت", "IST": "ڀارت جو معياري وقت", "JDT": "جاپان جي ڏينهن جو وقت", "JST": "جاپان جو معياري وقت", "LHDT": "لورڊ هووي جي ڏينهن جو وقت", "LHST": "لورڊ هووي جو معياري وقت", "MDT": "पहाड़ी दीं॒ह जो वक्त", "MESZ": "मरकज़ी यूरोपी उनहारे जो वक्तु", "MEZ": "मरकज़ी यूरोपी मअयारी वक्तु", "MST": "पहाड़ी मअयारी वक्त", "MVT": "مالديپ جو وقت", "MYT": "ملائيشيا جو وقت", "NDT": "نيو فائونڊ لينڊ جي ڏينهن جو وقت", "NPT": "نيپال جو وقت", "NST": "نيو فائونڊ لينڊ جو معياري وقت", "NZDT": "نيوزيلينڊ جي ڏينهن جو وقت", "NZST": "نيوزيلينڊ جو معياري وقت", "OESZ": "ओभरी यूरोपी उनहारे जो वक्तु", "OEZ": "ओभरी यूरोपी मअयारी वक्तु", "PDT": "पेसिफिक दीं॒ह जो वक्त", "PKT": "پاڪستان جي اونهاري جو وقت", "PMDT": "سينٽ پيئر ۽ ميڪلون جي ڏينهن جو وقت", "PMST": "سينٽ پيئر ۽ ميڪلون جو معياري وقت", "PST": "पेसिफिक मअयारी वक्त", "PYST": "پيراگوئي جي اونهاري جو وقت", "SAST": "ڏکڻ آفريڪا جو معياري وقت", "SGT": "سنگاپور جو معياري وقت", "SRT": "سوري نام جو وقت", "TLT": "اوڀر تيمور جو وقت", "TMST": "ترڪمانستان جي اونهاري جو وقت", "TMT": "ترڪمانستان جو معياري وقت", "UYST": "يوروگائي جي اونهاري جو وقت", "UYT": "يوروگائي جو معياري وقت", "VET": "وينزويلا جو وقت", "WARST": "اولهه ارجنٽينا جي اونهاري جو وقت", "WART": "اولهه ارجنٽينا جو معياري وقت", "WAST": "اولهه آفريقا جي اونهاري جو وقت", "WAT": "اولهه آفريقا جو معياري وقت", "WESZ": "उलहंदो यूरोपी उनहारे जो वक्तु", "WEZ": "उलहंदो यूरोपी मअयारी वक्तु", "WIB": "اولهه انڊونيشيا جو وقت", "WIT": "اوڀر انڊونيشيا جو وقت", "WITA": "مرڪزي انڊونيشيا جو وقت", "∅∅∅": "ازورز جي اونهاري جو وقت"},
		},
...
// DateFullLayout returns the full date layout for 'sd_Deva'
func (sd *sd_Deva) DateFullLayout() string {
	return sd.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sd_Deva'
func (sd *sd_Deva) DateLongLayout() string {
	return sd.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sd_Deva'
func (sd *sd_Deva) DateMediumLayout() string {
	return sd.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sd_Deva'
func (sd *sd_Deva) DateShortLayout() string {
	return sd.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sd_Deva'
func (sd *sd_Deva) TimeFullLayout() string {
	return sd.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sd_Deva'
func (sd *sd_Deva) TimeLongLayout() string {
	return sd.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sd_Deva'
func (sd *sd_Deva) TimeMediumLayout() string {
	return sd.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sd_Deva'
func (sd *sd_Deva) TimeShortLayout() string {
	return sd.timeShortLayout
}

func (sd *sd_Deva) ListPatterns() *locales.ListPatterns {
	return sd.listPatterns
}

func (sd *sd_Deva) GetDurationSpec() *locales.DurationSpec {
	return sd.DurationSpec
}

func (sd *sd_Deva) GetMiscPatterns() *locales.MiscPatterns {
