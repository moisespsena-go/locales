...
func New() locales.Translator {
	return &pa_Arab{
		...
		TimeSpec: &locales.TimeSpec{
			...
			MonthsWideValue:          []string{"", "جنوری", "فروری", "مارچ", "اپریل", "مئ", "جون", "جولائی", "اگست", "ستمبر", "اکتوبر", "نومبر", "دسمبر"},
...
// DateFullLayout returns the full date layout for 'pa_Arab'
func (pa *pa_Arab) DateFullLayout() string {
	return pa.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pa_Arab'
func (pa *pa_Arab) DateLongLayout() string {
	return pa.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pa_Arab'
func (pa *pa_Arab) DateMediumLayout() string {
	return pa.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pa_Arab'
func (pa *pa_Arab) DateShortLayout() string {
	return pa.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pa_Arab'
func (pa *pa_Arab) TimeFullLayout() string {
	return pa.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pa_Arab'
func (pa *pa_Arab) TimeLongLayout() string {
	return pa.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pa_Arab'
func (pa *pa_Arab) TimeMediumLayout() string {
	return pa.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pa_Arab'
func (pa *pa_Arab) TimeShortLayout() string {
	return pa.timeShortLayout
}

func (pa *pa_Arab) ListPatterns() *locales.ListPatterns {
	return pa.listPatterns
}

func (pa *pa_Arab) GetDurationSpec() *locales.DurationSpec {
	return pa.DurationSpec
}

func (pa *pa_Arab) GetMiscPatterns() *locales.MiscPatterns {
