...
// DateFullLayout returns the full date layout for 'sr_Cyrl_XK'
func (sr *sr_Cyrl_XK) DateFullLayout() string {
	return sr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sr_Cyrl_XK'
func (sr *sr_Cyrl_XK) DateLongLayout() string {
	return sr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sr_Cyrl_XK'
func (sr *sr_Cyrl_XK) DateMediumLayout() string {
	return sr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sr_Cyrl_XK'
func (sr *sr_Cyrl_XK) DateShortLayout() string {
	return sr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sr_Cyrl_XK'
func (sr *sr_Cyrl_XK) TimeFullLayout() string {
	return sr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sr_Cyrl_XK'
func (sr *sr_Cyrl_XK) TimeLongLayout() string {
	return sr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sr_Cyrl_XK'
func (sr *sr_Cyrl_XK) TimeMediumLayout() string {
	return sr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sr_Cyrl_XK'
func (sr *sr_Cyrl_XK) TimeShortLayout() string {
	return sr.timeShortLayout
}

func (sr *sr_Cyrl_XK) ListPatterns() *locales.ListPatterns {
	return sr.listPatterns
}

func (sr *sr_Cyrl_XK) GetDurationSpec() *locales.DurationSpec {
	return sr.DurationSpec
}

func (sr *sr_Cyrl_XK) GetMiscPatterns() *locales.MiscPatterns {
