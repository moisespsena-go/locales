...
// DateFullLayout returns the full date layout for 'kam'
func (kam *kam) DateFullLayout() string {
	return kam.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kam'
func (kam *kam) DateLongLayout() string {
	return kam.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kam'
func (kam *kam) DateMediumLayout() string {
	return kam.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kam'
func (kam *kam) DateShortLayout() string {
	return kam.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kam'
func (kam *kam) TimeFullLayout() string {
	return kam.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kam'
func (kam *kam) TimeLongLayout() string {
	return kam.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kam'
func (kam *kam) TimeMediumLayout() string {
	return kam.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kam'
func (kam *kam) TimeShortLayout() string {
	return kam.timeShortLayout
}

func (kam *kam) ListPatterns() *locales.ListPatterns {
	return kam.listPatterns
}

func (kam *kam) GetDurationSpec() *locales.DurationSpec {
	return kam.DurationSpec
}

func (kam *kam) GetMiscPatterns() *locales.MiscPatterns {
