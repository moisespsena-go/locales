...
// DateFullLayout returns the full date layout for 'hr_BA'
func (hr *hr_BA) DateFullLayout() string {
	return hr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'hr_BA'
func (hr *hr_BA) DateLongLayout() string {
	return hr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'hr_BA'
func (hr *hr_BA) DateMediumLayout() string {
	return hr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'hr_BA'
func (hr *hr_BA) DateShortLayout() string {
	return hr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'hr_BA'
func (hr *hr_BA) TimeFullLayout() string {
	return hr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'hr_BA'
func (hr *hr_BA) TimeLongLayout() string {
	return hr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'hr_BA'
func (hr *hr_BA) TimeMediumLayout() string {
	return hr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'hr_BA'
func (hr *hr_BA) TimeShortLayout() string {
	return hr.timeShortLayout
}

func (hr *hr_BA) ListPatterns() *locales.ListPatterns {
	return hr.listPatterns
}

func (hr *hr_BA) GetDurationSpec() *locales.DurationSpec {
	return hr.DurationSpec
}

func (hr *hr_BA) GetMiscPatterns() *locales.MiscPatterns {
