...
// DateFullLayout returns the full date layout for 'fr_LU'
func (fr *fr_LU) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_LU'
func (fr *fr_LU) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_LU'
func (fr *fr_LU) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_LU'
func (fr *fr_LU) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_LU'
func (fr *fr_LU) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_LU'
func (fr *fr_LU) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_LU'
func (fr *fr_LU) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_LU'
func (fr *fr_LU) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_LU) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_LU) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_LU) GetMiscPatterns() *locales.MiscPatterns {
