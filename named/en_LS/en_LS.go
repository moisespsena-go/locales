...
// DateFullLayout returns the full date layout for 'en_LS'
func (en *en_LS) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_LS'
func (en *en_LS) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_LS'
func (en *en_LS) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_LS'
func (en *en_LS) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_LS'
func (en *en_LS) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_LS'
func (en *en_LS) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_LS'
func (en *en_LS) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_LS'
func (en *en_LS) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_LS) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_LS) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_LS) GetMiscPatterns() *locales.MiscPatterns {
