...
// DateFullLayout returns the full date layout for 'ff_Latn_NE'
func (ff *ff_Latn_NE) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff_Latn_NE'
func (ff *ff_Latn_NE) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff_Latn_NE'
func (ff *ff_Latn_NE) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff_Latn_NE'
func (ff *ff_Latn_NE) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff_Latn_NE'
func (ff *ff_Latn_NE) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff_Latn_NE'
func (ff *ff_Latn_NE) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff_Latn_NE'
func (ff *ff_Latn_NE) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff_Latn_NE'
func (ff *ff_Latn_NE) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff_Latn_NE) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff_Latn_NE) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff_Latn_NE) GetMiscPatterns() *locales.MiscPatterns {
