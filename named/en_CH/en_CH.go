...
// DateFullLayout returns the full date layout for 'en_CH'
func (en *en_CH) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_CH'
func (en *en_CH) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_CH'
func (en *en_CH) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_CH'
func (en *en_CH) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_CH'
func (en *en_CH) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_CH'
func (en *en_CH) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_CH'
func (en *en_CH) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_CH'
func (en *en_CH) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_CH) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_CH) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_CH) GetMiscPatterns() *locales.MiscPatterns {
