...
// DateFullLayout returns the full date layout for 'fr_BF'
func (fr *fr_BF) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_BF'
func (fr *fr_BF) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_BF'
func (fr *fr_BF) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_BF'
func (fr *fr_BF) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_BF'
func (fr *fr_BF) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_BF'
func (fr *fr_BF) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_BF'
func (fr *fr_BF) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_BF'
func (fr *fr_BF) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_BF) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_BF) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_BF) GetMiscPatterns() *locales.MiscPatterns {
