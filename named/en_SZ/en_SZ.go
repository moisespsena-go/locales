...
// DateFullLayout returns the full date layout for 'en_SZ'
func (en *en_SZ) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_SZ'
func (en *en_SZ) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_SZ'
func (en *en_SZ) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_SZ'
func (en *en_SZ) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_SZ'
func (en *en_SZ) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_SZ'
func (en *en_SZ) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_SZ'
func (en *en_SZ) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_SZ'
func (en *en_SZ) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_SZ) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_SZ) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_SZ) GetMiscPatterns() *locales.MiscPatterns {
