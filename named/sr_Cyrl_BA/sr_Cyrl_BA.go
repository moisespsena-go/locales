...
func New() locales.Translator {
	return &sr_Cyrl_BA{
		...
		TimeSpec: &locales.TimeSpec{
			...
			WeekdaysAbbreviatedValue: []string{"нед", "пон", "уто", "сри", "чет", "пет", "суб"},
			WeekdaysNarrowValue:      []string{"н", "п", "у", "с", "ч", "п", "с"},
			WeekdaysShortValue:       []string{"не", "по", "ут", "ср", "че", "пе", "су"},
			WeekdaysWideValue:        []string{"недјеља", "понедјељак", "уторак", "сриједа", "четвртак", "петак", "субота"},
			PeriodsAbbreviatedValue:  []string{"прије подне", "по подне"},
			PeriodsNarrowValue:       []string{"", ""},
			PeriodsWideValue:         []string{"прије подне", "по подне"},
			ErasAbbreviatedValue:     []string{"", ""},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"прије нове ере", "нове ере"},
			TimezonesValue:           map[string]string{"": "Фолкландска Острва, стандардно вријеме", "ACDT": "Аустралијско централно љетње вријеме", "ACST": "Аустралијско централно стандардно вријеме", "ACT": "Акре стандардно време", "ACWDT": "Аустралијско централно западно љетње вријеме", "ACWST": "Аустралијско централно западно стандардно вријеме", "ADT": "Атлантско љетње вријеме", "AEDT": "Аустралијско источно љетње вријеме", "AEST": "Аустралијско источно стандардно вријеме", "AFT": "Авганистан вријеме", "AKDT": "Аљаска, љетње вријеме", "AKST": "Аљаска, стандардно вријеме", "AMST": "Амазон, љетње вријеме", "AMT": "Амазон, стандардно вријеме", "ARST": "Аргентина, љетње вријеме", "ART": "Аргентина, стандардно вријеме", "AST": "Атлантско стандардно вријеме", "AWDT": "Аустралијско западно љетње вријеме", "AWST": "Аустралијско западно стандардно вријеме", "BNT": "Брунеј Дарусалум вријеме", "BOT": "Боливија вријеме", "BRST": "Бразилија, љетње вријеме", "BRT": "Бразилија, стандардно вријеме", "BST": "Бангладеш, љетње вријеме", "BTT": "Бутан вријеме", "CAT": "Централно-афричко вријеме", "CCT": "Кокосова (Килинг) острва вријеме", "CDT": "Сјеверноамеричко централно љетње вријеме", "CDT (Kuba)": "Куба, љетње вријеме", "CHADT": "Чатам, љетње вријеме", "CHAST": "Чатам, стандардно вријеме", "CLST": "Чиле, љетње вријеме", "CLT": "Чиле, стандардно вријеме", "COST": "Колумбија, љетње вријеме", "COT": "Колумбија, стандардно вријеме", "CST": "Сјеверноамеричко централно стандардно вријеме", "CST (Kuba)": "Куба, стандардно вријеме", "CXT": "Божићно острво вријеме", "ChST": "Чаморо вријеме", "EASST": "Ускршња острва, љетње вријеме", "EAST": "Ускршња острва, стандардно вријеме", "EAT": "Источно-афричко вријеме", "ECT": "Еквадор вријеме", "EDT": "Сјеверноамеричко источно љетње вријеме", "EGDT": "Источни Гренланд, љетње вријеме", "EGST": "Источни Гренланд, стандардно вријеме", "EST": "Сјеверноамеричко источно стандардно вријеме", "FKST": "Фолкландска Острва, љетње вријеме", "GALT": "Галапагос вријеме", "GFT": "Француска Гвајана вријеме", "GMT": "Средње вријеме по Гриничу", "GST": "Заливско вријеме", "GYT": "Гвајана вријеме", "HADT": "Хавајско-алеутско љетње вријеме", "HAST": "Хавајско-алеутско стандардно вријеме", "HENOMX": "Сјеверозападни Мексико, летње вријеме", "HEOG": "Западни Гренланд, љетње вријеме", "HEPMX": "Мексички Пацифик, љетње вријеме", "HKST": "Хонг Конг, љетње вријеме", "HKT": "Хонг Конг, стандардно вријеме", "HNNOMX": "Сјеверозападни Мексико, стандардно вријеме", "HNOG": "Западни Гренланд, стандардно вријеме", "HNPMX": "Мексички Пацифик, стандардно вријеме", "ICT": "Индокина вријеме", "IRDT": "Иран, љетње вријеме", "IRST": "Иран, стандардно вријеме", "IST": "Индијско стандардно вријеме", "JDT": "Јапанско љетње вријеме", "JST": "Јапанско стандардно вријеме", "LHDT": "Лорд Хов, љетње вријеме", "LHST": "Лорд Хов, стандардно вријеме", "MDT": "Макао летње рачунање времена", "MESZ": "Средњоевропско љетње вријеме", "MEZ": "Средњоевропско стандардно вријеме", "MST": "Макао стандардно време", "MVT": "Малдиви вријеме", "MYT": "Малезија вријеме", "NDT": "Њуфаундленд, љетње вријеме", "NPT": "Непал вријеме", "NST": "Њуфаундленд, стандардно вријеме", "NZDT": "Нови Зеланд, љетње вријеме", "NZST": "Нови Зеланд, стандардно вријеме", "OESZ": "Источноевропско љетње вријеме", "OEZ": "Источноевропско стандардно вријеме", "PDT": "Сјеверноамеричко пацифичко летње вријеме", "PKT": "Пакистан, љетње вријеме", "PMDT": "Сен Пјер и Микелон, љетње вријеме", "PMST": "Сен Пјер и Микелон, стандардно вријеме", "PST": "Сјеверноамеричко пацифичко стандардно вријеме", "PYST": "Парагвај, љетње вријеме", "SAST": "Јужно-афричко вријеме", "SGT": "Сингапур, стандардно вријеме", "SRT": "Суринам вријеме", "TLT": "Источни Тимор вријеме", "TMST": "Туркменистан, љетње вријеме", "TMT": "Туркменистан, стандардно вријеме", "UYST": "Уругвај, љетње вријеме", "UYT": "Уругвај, стандардно вријеме", "VET": "Венецуела вријеме", "WARST": "Западна Аргентина, љетње вријеме", "WART": "Западна Аргентина, стандардно вријеме", "WAST": "Западно-афричко љетње вријеме", "WAT": "Западно-афричко стандардно вријеме", "WESZ": "Западноевропско љетње вријеме", "WEZ": "Западноевропско стандардно вријеме", "WIB": "Западно-индонезијско вријеме", "WIT": "Источно-индонезијско вријеме", "WITA": "Централно-индонезијско вријеме", "∅∅∅": "Перу, љетње вријеме"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"вијекови", "%v вијек", "%v вијекова", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мјесеци", "%v мјес.", "%v мјес.", ""},
				Long:   &locales.CounterFormat{"мјесеци", "%v мјесец", "%v мјесеци", "%v мјесечно"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"недјеље", "%v недјеља", "%v недјеља", "%v недјељно"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
...
// DateFullLayout returns the full date layout for 'sr_Cyrl_BA'
func (sr *sr_Cyrl_BA) DateFullLayout() string {
	return sr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sr_Cyrl_BA'
func (sr *sr_Cyrl_BA) DateLongLayout() string {
	return sr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sr_Cyrl_BA'
func (sr *sr_Cyrl_BA) DateMediumLayout() string {
	return sr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sr_Cyrl_BA'
func (sr *sr_Cyrl_BA) DateShortLayout() string {
	return sr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sr_Cyrl_BA'
func (sr *sr_Cyrl_BA) TimeFullLayout() string {
	return sr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sr_Cyrl_BA'
func (sr *sr_Cyrl_BA) TimeLongLayout() string {
	return sr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sr_Cyrl_BA'
func (sr *sr_Cyrl_BA) TimeMediumLayout() string {
	return sr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sr_Cyrl_BA'
func (sr *sr_Cyrl_BA) TimeShortLayout() string {
	return sr.timeShortLayout
}

func (sr *sr_Cyrl_BA) ListPatterns() *locales.ListPatterns {
	return sr.listPatterns
}

func (sr *sr_Cyrl_BA) GetDurationSpec() *locales.DurationSpec {
	return sr.DurationSpec
}

func (sr *sr_Cyrl_BA) GetMiscPatterns() *locales.MiscPatterns {
