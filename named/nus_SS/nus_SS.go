...
func New() locales.Translator {
	return &nus_SS{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Tiop", "Pɛt", "Duɔ̱ɔ̱", "Guak", "Duä", "Kor", "Pay", "Thoo", "Tɛɛ", "Laa", "Kur", "Tid"},
			MonthsNarrowValue:        []string{"", "T", "P", "D", "G", "D", "K", "P", "T", "T", "L", "K", "T"},
			MonthsWideValue:          []string{"", "Tiop thar pɛt", "Pɛt", "Duɔ̱ɔ̱ŋ", "Guak", "Duät", "Kornyoot", "Pay yie̱tni", "Tho̱o̱r", "Tɛɛr", "Laath", "Kur", "Tio̱p in di̱i̱t"},
			WeekdaysAbbreviatedValue: []string{"Cäŋ", "Jiec", "Rɛw", "Diɔ̱k", "Ŋuaan", "Dhieec", "Bäkɛl"},
			WeekdaysNarrowValue:      []string{"C", "J", "R", "D", "Ŋ", "D", "B"},
			WeekdaysWideValue:        []string{"Cäŋ kuɔth", "Jiec la̱t", "Rɛw lätni", "Diɔ̱k lätni", "Ŋuaan lätni", "Dhieec lätni", "Bäkɛl lätni"},
			PeriodsAbbreviatedValue:  []string{"RW", "TŊ"},
			PeriodsWideValue:         []string{"RW", "TŊ"},
			ErasAbbreviatedValue:     []string{"AY", "ƐY"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"A ka̱n Yecu ni dap", "Ɛ ca Yecu dap"},
		...
		timeFullLayout:   "zzzz h:mm:ss a",
		timeLongLayout:   "z h:mm:ss a",
...
func (nus *nus_SS) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(nus, nus.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'nus_SS'
func (nus *nus_SS) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(nus, nus.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'nus_SS'
func (nus *nus_SS) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(nus, nus.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'nus_SS'
func (nus *nus_SS) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(nus, nus.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'nus_SS'
func (nus *nus_SS) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(nus, nus.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'nus_SS'
func (nus *nus_SS) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(nus, nus.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'nus_SS'
func (nus *nus_SS) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(nus, nus.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'nus_SS'
func (nus *nus_SS) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(nus, nus.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'nus_SS'
func (nus *nus_SS) DateFullLayout() string {
	return nus.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nus_SS'
func (nus *nus_SS) DateLongLayout() string {
	return nus.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nus_SS'
func (nus *nus_SS) DateMediumLayout() string {
	return nus.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nus_SS'
func (nus *nus_SS) DateShortLayout() string {
	return nus.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nus_SS'
func (nus *nus_SS) TimeFullLayout() string {
	return nus.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nus_SS'
func (nus *nus_SS) TimeLongLayout() string {
	return nus.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nus_SS'
func (nus *nus_SS) TimeMediumLayout() string {
	return nus.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nus_SS'
func (nus *nus_SS) TimeShortLayout() string {
	return nus.timeShortLayout
}

func (nus *nus_SS) ListPatterns() *locales.ListPatterns {
	return nus.listPatterns
}

func (nus *nus_SS) GetDurationSpec() *locales.DurationSpec {
	return nus.DurationSpec
}

func (nus *nus_SS) GetMiscPatterns() *locales.MiscPatterns {
	return &nus.miscPatterns
}
