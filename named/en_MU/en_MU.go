...
// DateFullLayout returns the full date layout for 'en_MU'
func (en *en_MU) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_MU'
func (en *en_MU) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_MU'
func (en *en_MU) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_MU'
func (en *en_MU) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_MU'
func (en *en_MU) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_MU'
func (en *en_MU) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_MU'
func (en *en_MU) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_MU'
func (en *en_MU) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_MU) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_MU) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_MU) GetMiscPatterns() *locales.MiscPatterns {
