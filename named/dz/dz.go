...
// DateFullLayout returns the full date layout for 'dz'
func (dz *dz) DateFullLayout() string {
	return dz.dateFullLayout
}

// DateLongLayout returns the long date layout for 'dz'
func (dz *dz) DateLongLayout() string {
	return dz.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'dz'
func (dz *dz) DateMediumLayout() string {
	return dz.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'dz'
func (dz *dz) DateShortLayout() string {
	return dz.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'dz'
func (dz *dz) TimeFullLayout() string {
	return dz.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'dz'
func (dz *dz) TimeLongLayout() string {
	return dz.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'dz'
func (dz *dz) TimeMediumLayout() string {
	return dz.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'dz'
func (dz *dz) TimeShortLayout() string {
	return dz.timeShortLayout
}

func (dz *dz) ListPatterns() *locales.ListPatterns {
	return dz.listPatterns
}

func (dz *dz) GetDurationSpec() *locales.DurationSpec {
	return dz.DurationSpec
}

func (dz *dz) GetMiscPatterns() *locales.MiscPatterns {
