	...
	return &it_CH{
		...
		CurrencySpec: &locales.CurrencySpec{
			...
			Formatters: &locales.CurrencyFormatters{
				CurrencyFmt: locales.MustParseNumberFormatPatterns("¤\u00a0#,##0.00;¤-#,##0.00"),
			},
		},
...
// DateFullLayout returns the full date layout for 'it_CH'
func (it *it_CH) DateFullLayout() string {
	return it.dateFullLayout
}

// DateLongLayout returns the long date layout for 'it_CH'
func (it *it_CH) DateLongLayout() string {
	return it.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'it_CH'
func (it *it_CH) DateMediumLayout() string {
	return it.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'it_CH'
func (it *it_CH) DateShortLayout() string {
	return it.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'it_CH'
func (it *it_CH) TimeFullLayout() string {
	return it.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'it_CH'
func (it *it_CH) TimeLongLayout() string {
	return it.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'it_CH'
func (it *it_CH) TimeMediumLayout() string {
	return it.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'it_CH'
func (it *it_CH) TimeShortLayout() string {
	return it.timeShortLayout
}

func (it *it_CH) ListPatterns() *locales.ListPatterns {
	return it.listPatterns
}

func (it *it_CH) GetDurationSpec() *locales.DurationSpec {
	return it.DurationSpec
}

func (it *it_CH) GetMiscPatterns() *locales.MiscPatterns {
