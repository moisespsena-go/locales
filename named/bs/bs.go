...
func New() locales.Translator {
	return &bs{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 hilj'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 hilj'.' ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 hilj'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 hilj'.' ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 hilj'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 hilj'.' ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jan", "feb", "mar", "apr", "maj", "jun", "jul", "aug", "sep", "okt", "nov", "dec"},
			MonthsNarrowValue:        []string{"", "j", "f", "m", "a", "m", "j", "j", "a", "s", "o", "n", "d"},
			MonthsWideValue:          []string{"", "januar", "februar", "mart", "april", "maj", "juni", "juli", "august", "septembar", "oktobar", "novembar", "decembar"},
			...
			PeriodsNarrowValue:       []string{"prijepodne", "popodne"},
			PeriodsWideValue:         []string{"prijepodne", "popodne"},
			ErasAbbreviatedValue:     []string{"", ""},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"prije nove ere", "nove ere"},
			TimezonesValue:           map[string]string{"": "Paragvajsko standardno vrijeme", "ACDT": "Centralnoaustralijsko ljetno vrijeme", "ACST": "Centralnoaustralijsko standardno vrijeme", "ACT": "Acre standardno vreme", "ACWDT": "Australijsko centralnozapadno ljetno vrijeme", "ACWST": "Australijsko centralnozapadno standardno vrijeme", "ADT": "Sjevernoameričko atlantsko ljetno vrijeme", "AEDT": "Istočnoaustralijsko ljetno vrijeme", "AEST": "Istočnoaustralijsko standardno vrijeme", "AFT": "Afganistansko vrijeme", "AKDT": "Aljaskansko ljetno vrijeme", "AKST": "Aljaskansko standardno vrijeme", "AMST": "Amazonsko ljetno vrijeme", "AMT": "Amazonsko standardno vrijeme", "ARST": "Argentinsko ljetno vrijeme", "ART": "Argentinsko standardno vrijeme", "AST": "Sjevernoameričko atlantsko standardno vrijeme", "AWDT": "Zapadnoaustralijsko ljetno vrijeme", "AWST": "Zapadnoaustralijsko standardno vrijeme", "BNT": "Brunejsko vrijeme", "BOT": "Bolivijsko vrijeme", "BRST": "Brazilijsko ljetno vrijeme", "BRT": "Brazilijsko standardno vrijeme", "BST": "Bangladeško ljetno vrijeme", "BTT": "Butansko vrijeme", "CAT": "Centralnoafričko vrijeme", "CCT": "Vrijeme na Ostrvima Kokos", "CDT": "Sjevernoameričko centralno ljetno vrijeme", "CDT (Kuba)": "Kubansko ljetno vrijeme", "CHADT": "Čatamsko ljetno vrijeme", "CHAST": "Čatamsko standardno vrijeme", "CLST": "Čileansko ljetno vrijeme", "CLT": "Čileansko standardno vrijeme", "COST": "Kolumbijsko ljetno vrijeme", "COT": "Kolumbijsko standardno vrijeme", "CST": "Sjevernoameričko centralno standardno vrijeme", "CST (Kuba)": "Kubansko standardno vrijeme", "CXT": "Vrijeme na Božićnom Ostrvu", "ChST": "Čamorsko standardno vrijeme", "EASST": "Uskršnjeostrvsko ljetno vrijeme", "EAST": "Uskršnjeostrvsko standardno vrijeme", "EAT": "Istočnoafričko vrijeme", "ECT": "Ekvadorsko vrijeme", "EDT": "Sjevernoameričko istočno ljetno vrijeme", "EGDT": "Istočnogrenlandsko ljetno vrijeme", "EGST": "Istočnogrenlandsko standardno vrijeme", "EST": "Sjevernoameričko istočno standardno vrijeme", "FKST": "Folklandsko ljetno vrijeme", "GALT": "Galapagosko vrijeme", "GFT": "Francuskogvajansko vrijeme", "GMT": "Griničko vrijeme", "GST": "Zalivsko standardno vrijeme", "GYT": "Gvajansko vrijeme", "HADT": "Havajsko-aleućansko ljetno vrijeme", "HAST": "Havajsko-aleućansko standardno vrijeme", "HENOMX": "Sjeverozapadno meksičko ljetno vrijeme", "HEOG": "Zapadnogrenlandsko ljetno vrijeme", "HEPMX": "Meksičko pacifičko ljetno vrijeme", "HKST": "Hongkonško ljetno vrijeme", "HKT": "Hongkonško standardno vrijeme", "HNNOMX": "Sjeverozapadno meksičko standardno vrijeme", "HNOG": "Zapadnogrenlandsko standardno vrijeme", "HNPMX": "Meksičko pacifičko standardno vrijeme", "ICT": "Indokinesko vrijeme", "IRDT": "Iransko ljetno vrijeme", "IRST": "Iransko standardno vrijeme", "IST": "Indijsko standardno vrijeme", "JDT": "Japansko ljetno vrijeme", "JST": "Japansko standardno vrijeme", "LHDT": "Ljetno vrijeme na Ostrvu Lord Hau", "LHST": "Standardno vrijeme na Ostrvu Lord Hau", "MDT": "Sjevernoameričko planinsko ljetno vrijeme", "MESZ": "Centralnoevropsko ljetno vrijeme", "MEZ": "Centralnoevropsko standardno vrijeme", "MST": "Sjevernoameričko planinsko standardno vrijeme", "MVT": "Maldivsko vrijeme", "MYT": "Malezijsko vrijeme", "NDT": "Njufaundlendsko ljetno vrijeme", "NPT": "Nepalsko vrijeme", "NST": "Njufaundlendsko standardno vrijeme", "NZDT": "Novozelandsko ljetno vrijeme", "NZST": "Novozelandsko standardno vrijeme", "OESZ": "Istočnoevropsko ljetno vrijeme", "OEZ": "Istočnoevropsko standardno vrijeme", "PDT": "Sjevernoameričko pacifičko ljetno vrijeme", "PKT": "Pakistansko ljetno vrijeme", "PMDT": "Ljetno vrijeme na Ostrvima Sveti Petar i Mikelon", "PMST": "Standardno vrijeme na Ostrvima Sveti Petar i Mikelon", "PST": "Sjevernoameričko pacifičko standardno vrijeme", "PYST": "Paragvajsko ljetno vrijeme", "SAST": "Južnoafričko standardno vrijeme", "SGT": "Singapursko standardno vrijeme", "SRT": "Surinamsko vrijeme", "TLT": "Istočnotimorsko vrijeme", "TMST": "Turkmenistansko ljetno vrijeme", "TMT": "Turkmenistansko standardno vrijeme", "UYST": "Urugvajsko ljetno vrijeme", "UYT": "Urugvajsko standardno vrijeme", "VET": "Venecuelansko vrijeme", "WARST": "Zapadnoargentinsko ljetno vrijeme", "WART": "Zapadnoargentinsko standardno vrijeme", "WAST": "Zapadnoafričko ljetno vrijeme", "WAT": "Zapadnoafričko standardno vrijeme", "WESZ": "Zapadnoevropsko ljetno vrijeme", "WEZ": "Zapadnoevropsko standardno vrijeme", "WIB": "Zapadnoindonezijsko vrijeme", "WIT": "Istočnoindonezijsko vrijeme", "WITA": "Centralnoindonezijsko vrijeme", "∅∅∅": "Peruansko ljetno vrijeme"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"stoljeća", "%v stoljeće", "%v stoljeća", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dec.", "%v dec.", "%v dec.", ""},
				Long:   &locales.CounterFormat{"decenije", "%v decenija", "%v decenija", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"god.", "%v god.", "%v god.", ""},
				Long:   &locales.CounterFormat{"godine", "%v godina", "%v godina", "%v godišnje"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mjesec", "%v mj.", "%v mj.", ""},
				Long:   &locales.CounterFormat{"mjeseci", "%v mjesec", "%v mjeseci", "%v mjesečno"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sedm.", "%v sedm.", "%v sedm.", ""},
				Long:   &locales.CounterFormat{"sedmice", "%v sedmica", "%v sedmica", "%v sedmično"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dan", "%v d.", "%v d.", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sat", "%v h", "%v h", ""},
				Long:   &locales.CounterFormat{"sati", "%v sat", "%v sati", "%v na sat"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"minuta", "%v m", "%v m", ""},
				Long:   &locales.CounterFormat{"minute", "%v minuta", "%v minuta", "%v po minuti"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sekunda", "%v s", "%v s", ""},
				Long:   &locales.CounterFormat{"sekunde", "%v sekunda", "%v sekundi", "%v po sekundi"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"milisekunda", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"milisekunde", "%v milisekunda", "%v milisekundi", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mikrosekunde", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"mikrosekunde", "%v mikrosekunda", "%v mikrosekundi", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"nanosekunde", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosekunde", "%v nanosekunda", "%v nanosekundi", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (bs *bs) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(bs, bs.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'bs'
func (bs *bs) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(bs, bs.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'bs'
func (bs *bs) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(bs, bs.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'bs'
func (bs *bs) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(bs, bs.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'bs'
func (bs *bs) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(bs, bs.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'bs'
func (bs *bs) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(bs, bs.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'bs'
func (bs *bs) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(bs, bs.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'bs'
func (bs *bs) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(bs, bs.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'bs'
func (bs *bs) DateFullLayout() string {
	return bs.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bs'
func (bs *bs) DateLongLayout() string {
	return bs.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bs'
func (bs *bs) DateMediumLayout() string {
	return bs.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bs'
func (bs *bs) DateShortLayout() string {
	return bs.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bs'
func (bs *bs) TimeFullLayout() string {
	return bs.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bs'
func (bs *bs) TimeLongLayout() string {
	return bs.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bs'
func (bs *bs) TimeMediumLayout() string {
	return bs.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bs'
func (bs *bs) TimeShortLayout() string {
	return bs.timeShortLayout
}

func (bs *bs) ListPatterns() *locales.ListPatterns {
	return bs.listPatterns
}

func (bs *bs) GetDurationSpec() *locales.DurationSpec {
	return bs.DurationSpec
}

func (bs *bs) GetMiscPatterns() *locales.MiscPatterns {
	return &bs.miscPatterns
}
