...
// DateFullLayout returns the full date layout for 'ca_AD'
func (ca *ca_AD) DateFullLayout() string {
	return ca.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ca_AD'
func (ca *ca_AD) DateLongLayout() string {
	return ca.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ca_AD'
func (ca *ca_AD) DateMediumLayout() string {
	return ca.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ca_AD'
func (ca *ca_AD) DateShortLayout() string {
	return ca.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ca_AD'
func (ca *ca_AD) TimeFullLayout() string {
	return ca.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ca_AD'
func (ca *ca_AD) TimeLongLayout() string {
	return ca.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ca_AD'
func (ca *ca_AD) TimeMediumLayout() string {
	return ca.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ca_AD'
func (ca *ca_AD) TimeShortLayout() string {
	return ca.timeShortLayout
}

func (ca *ca_AD) ListPatterns() *locales.ListPatterns {
	return ca.listPatterns
}

func (ca *ca_AD) GetDurationSpec() *locales.DurationSpec {
	return ca.DurationSpec
}

func (ca *ca_AD) GetMiscPatterns() *locales.MiscPatterns {
