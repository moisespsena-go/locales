...
func New() locales.Translator {
	return &bas_CM{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "kɔn", "mac", "mat", "mto", "mpu", "hil", "nje", "hik", "dip", "bio", "may", "liɓ"},
			MonthsNarrowValue:        []string{"", "k", "m", "m", "m", "m", "h", "n", "h", "d", "b", "m", "l"},
			MonthsWideValue:          []string{"", "Kɔndɔŋ", "Màcɛ̂l", "Màtùmb", "Màtop", "M̀puyɛ", "Hìlòndɛ̀", "Njèbà", "Hìkaŋ", "Dìpɔ̀s", "Bìòôm", "Màyɛsèp", "Lìbuy li ńyèe"},
			WeekdaysAbbreviatedValue: []string{"nɔy", "nja", "uum", "ŋge", "mbɔ", "kɔɔ", "jon"},
			WeekdaysNarrowValue:      []string{"n", "n", "u", "ŋ", "m", "k", "j"},
			WeekdaysWideValue:        []string{"ŋgwà nɔ̂y", "ŋgwà njaŋgumba", "ŋgwà ûm", "ŋgwà ŋgê", "ŋgwà mbɔk", "ŋgwà kɔɔ", "ŋgwà jôn"},
			PeriodsAbbreviatedValue:  []string{"I bikɛ̂glà", "I ɓugajɔp"},
			PeriodsWideValue:         []string{"I bikɛ̂glà", "I ɓugajɔp"},
			ErasAbbreviatedValue:     []string{"b.Y.K", "m.Y.K"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"bisū bi Yesù Krǐstò", "i mbūs Yesù Krǐstò"},
...
func (bas *bas_CM) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(bas, bas.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'bas_CM'
func (bas *bas_CM) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(bas, bas.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'bas_CM'
func (bas *bas_CM) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(bas, bas.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'bas_CM'
func (bas *bas_CM) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(bas, bas.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'bas_CM'
func (bas *bas_CM) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(bas, bas.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'bas_CM'
func (bas *bas_CM) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(bas, bas.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'bas_CM'
func (bas *bas_CM) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(bas, bas.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'bas_CM'
func (bas *bas_CM) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(bas, bas.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'bas_CM'
func (bas *bas_CM) DateFullLayout() string {
	return bas.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bas_CM'
func (bas *bas_CM) DateLongLayout() string {
	return bas.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bas_CM'
func (bas *bas_CM) DateMediumLayout() string {
	return bas.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bas_CM'
func (bas *bas_CM) DateShortLayout() string {
	return bas.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bas_CM'
func (bas *bas_CM) TimeFullLayout() string {
	return bas.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bas_CM'
func (bas *bas_CM) TimeLongLayout() string {
	return bas.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bas_CM'
func (bas *bas_CM) TimeMediumLayout() string {
	return bas.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bas_CM'
func (bas *bas_CM) TimeShortLayout() string {
	return bas.timeShortLayout
}

func (bas *bas_CM) ListPatterns() *locales.ListPatterns {
	return bas.listPatterns
}

func (bas *bas_CM) GetDurationSpec() *locales.DurationSpec {
	return bas.DurationSpec
}

func (bas *bas_CM) GetMiscPatterns() *locales.MiscPatterns {
	return &bas.miscPatterns
}
