	...
	return &ar{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"قرن", "قرن", "%v قرن", ""},
				Long:   &locales.CounterFormat{"قرون", "قرن", "%v قرن", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"عقد", "عقد", "%v عقد", ""},
				Long:   &locales.CounterFormat{"عقود", "عقد", "%v عقد", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"سنة", "%v سنة", "%v سنة", "%v/سنة"},
				Long:   &locales.CounterFormat{"سنوات", "سنة", "%v سنة", "%v في السنة"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"شهر", "شهر", "%v شهر", "%v/ش"},
				Long:   &locales.CounterFormat{"شهور", "شهر", "%v شهر", "%v في الشهر"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"أسبوع", "%v أ", "%v أ", ""},
				Long:   &locales.CounterFormat{"أسابيع", "أسبوع", "%v أسبوع", "%v في الأسبوع"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"يوم", "%v ي", "%v ي", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ساعة", "%v س", "%v س", ""},
				Long:   &locales.CounterFormat{"ساعات", "ساعة", "%v ساعة", "%v في الساعة"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"د", "%v د", "%v د", ""},
				Long:   &locales.CounterFormat{"دقيقة", "دقيقة", "%v دقيقة", "%v كل دقيقة"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ث", "%v ث", "%v ث", ""},
				Long:   &locales.CounterFormat{"ثانية", "ثانية", "%v ثانية", "%v في الثانية"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ملي ث.", "%v ملي ث", "%v ملي ث", ""},
				Long:   &locales.CounterFormat{"ملي ثانية", "%v ملي ثانية", "%v ملي ثانية", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"م.ث.", "%v م.ث.", "%v م.ث.", ""},
				Long:   &locales.CounterFormat{"ميكروثانية", "%v ميكروثانية", "%v ميكروثانية", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ن.ث.", "%v ن.ث.", "%v ن.ث.", ""},
				Long:   &locales.CounterFormat{"نانو ثانية", "%v نانو ثانية", "%v نانو ثانية", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"+%[1]v",
...
// DateFullLayout returns the full date layout for 'ar'
func (ar *ar) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar'
func (ar *ar) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar'
func (ar *ar) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar'
func (ar *ar) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar'
func (ar *ar) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar'
func (ar *ar) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar'
func (ar *ar) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar'
func (ar *ar) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar) GetMiscPatterns() *locales.MiscPatterns {
