...
// DateFullLayout returns the full date layout for 'nl_SX'
func (nl *nl_SX) DateFullLayout() string {
	return nl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nl_SX'
func (nl *nl_SX) DateLongLayout() string {
	return nl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nl_SX'
func (nl *nl_SX) DateMediumLayout() string {
	return nl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nl_SX'
func (nl *nl_SX) DateShortLayout() string {
	return nl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nl_SX'
func (nl *nl_SX) TimeFullLayout() string {
	return nl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nl_SX'
func (nl *nl_SX) TimeLongLayout() string {
	return nl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nl_SX'
func (nl *nl_SX) TimeMediumLayout() string {
	return nl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nl_SX'
func (nl *nl_SX) TimeShortLayout() string {
	return nl.timeShortLayout
}

func (nl *nl_SX) ListPatterns() *locales.ListPatterns {
	return nl.listPatterns
}

func (nl *nl_SX) GetDurationSpec() *locales.DurationSpec {
	return nl.DurationSpec
}

func (nl *nl_SX) GetMiscPatterns() *locales.MiscPatterns {
