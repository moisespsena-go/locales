...
// DateFullLayout returns the full date layout for 'vai_Vaii'
func (vai *vai_Vaii) DateFullLayout() string {
	return vai.dateFullLayout
}

// DateLongLayout returns the long date layout for 'vai_Vaii'
func (vai *vai_Vaii) DateLongLayout() string {
	return vai.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'vai_Vaii'
func (vai *vai_Vaii) DateMediumLayout() string {
	return vai.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'vai_Vaii'
func (vai *vai_Vaii) DateShortLayout() string {
	return vai.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'vai_Vaii'
func (vai *vai_Vaii) TimeFullLayout() string {
	return vai.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'vai_Vaii'
func (vai *vai_Vaii) TimeLongLayout() string {
	return vai.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'vai_Vaii'
func (vai *vai_Vaii) TimeMediumLayout() string {
	return vai.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'vai_Vaii'
func (vai *vai_Vaii) TimeShortLayout() string {
	return vai.timeShortLayout
}

func (vai *vai_Vaii) ListPatterns() *locales.ListPatterns {
	return vai.listPatterns
}

func (vai *vai_Vaii) GetDurationSpec() *locales.DurationSpec {
	return vai.DurationSpec
}

func (vai *vai_Vaii) GetMiscPatterns() *locales.MiscPatterns {
