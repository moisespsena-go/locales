...
// DateFullLayout returns the full date layout for 'ff_Latn_LR'
func (ff *ff_Latn_LR) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff_Latn_LR'
func (ff *ff_Latn_LR) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff_Latn_LR'
func (ff *ff_Latn_LR) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff_Latn_LR'
func (ff *ff_Latn_LR) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff_Latn_LR'
func (ff *ff_Latn_LR) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff_Latn_LR'
func (ff *ff_Latn_LR) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff_Latn_LR'
func (ff *ff_Latn_LR) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff_Latn_LR'
func (ff *ff_Latn_LR) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff_Latn_LR) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff_Latn_LR) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff_Latn_LR) GetMiscPatterns() *locales.MiscPatterns {
