	...
	return &es_CO{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"", "%v a.", "%v a.", ""},
				Long:   &locales.CounterFormat{"a.", "%v a.", "%v a.", "%v/año"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mes", "%v mes", "%v meses", ""},
				Long:   &locales.CounterFormat{"mes", "%v mes", "%v meses", "%v/mes"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "%v sem.", "%v sems.", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"día", "%v día", "%v días", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "%v h", "%v h", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "%v min", "%v min", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "%v s", "%v s", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
...
// DateFullLayout returns the full date layout for 'es_CO'
func (es *es_CO) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_CO'
func (es *es_CO) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_CO'
func (es *es_CO) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_CO'
func (es *es_CO) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_CO'
func (es *es_CO) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_CO'
func (es *es_CO) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_CO'
func (es *es_CO) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_CO'
func (es *es_CO) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_CO) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_CO) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_CO) GetMiscPatterns() *locales.MiscPatterns {
