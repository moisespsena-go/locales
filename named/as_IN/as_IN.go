...
// DateFullLayout returns the full date layout for 'as_IN'
func (as *as_IN) DateFullLayout() string {
	return as.dateFullLayout
}

// DateLongLayout returns the long date layout for 'as_IN'
func (as *as_IN) DateLongLayout() string {
	return as.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'as_IN'
func (as *as_IN) DateMediumLayout() string {
	return as.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'as_IN'
func (as *as_IN) DateShortLayout() string {
	return as.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'as_IN'
func (as *as_IN) TimeFullLayout() string {
	return as.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'as_IN'
func (as *as_IN) TimeLongLayout() string {
	return as.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'as_IN'
func (as *as_IN) TimeMediumLayout() string {
	return as.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'as_IN'
func (as *as_IN) TimeShortLayout() string {
	return as.timeShortLayout
}

func (as *as_IN) ListPatterns() *locales.ListPatterns {
	return as.listPatterns
}

func (as *as_IN) GetDurationSpec() *locales.DurationSpec {
	return as.DurationSpec
}

func (as *as_IN) GetMiscPatterns() *locales.MiscPatterns {
