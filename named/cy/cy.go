	...
	return &cy{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"canrifoedd", "%v canrif", "%v canrif", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"deg", "%v deg", "%v deg", ""},
				Long:   &locales.CounterFormat{"degawdau", "%v degawd", "%v degawd", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"bl", "%vbl", "%vbl", "%v/bl"},
				Long:   &locales.CounterFormat{"blynyddoedd", "%v flwyddyn", "%v mlynedd", "%v y flwyddyn"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mis", "%vm", "%vm", "%v/m"},
				Long:   &locales.CounterFormat{"misoedd", "%v mis", "%v mis", "%v y mis"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ws", "%vw", "%vw", "%v/w"},
				Long:   &locales.CounterFormat{"wythnosau", "%v wythnos", "%v wythnos", "%v yr wythnos"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"d", "%vd", "%vd", "%v/d"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"awr", "%v awr", "%v awr", "%v/a"},
				Long:   &locales.CounterFormat{"oriau", "%v awr", "%v awr", "%v yr awr"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mun", "%vmun", "%vmun", "%v/mun"},
				Long:   &locales.CounterFormat{"munudau", "%v munud", "%v munud", "%v y munud"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"eil", "%v eil", "%v eil", "%v/e"},
				Long:   &locales.CounterFormat{"eiliadau", "%v eiliad", "%v eiliad", "%v yr eiliad"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"milieiliad", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"milieiliadau", "%v milieiliad", "%v milieiliad", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"microeiliadau", "%v microeiliadau", "%v microeiliadau", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanoeiliadau", "%v nanoeiliadau", "%v nanoeiliadau", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
// DateFullLayout returns the full date layout for 'cy'
func (cy *cy) DateFullLayout() string {
	return cy.dateFullLayout
}

// DateLongLayout returns the long date layout for 'cy'
func (cy *cy) DateLongLayout() string {
	return cy.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'cy'
func (cy *cy) DateMediumLayout() string {
	return cy.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'cy'
func (cy *cy) DateShortLayout() string {
	return cy.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'cy'
func (cy *cy) TimeFullLayout() string {
	return cy.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'cy'
func (cy *cy) TimeLongLayout() string {
	return cy.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'cy'
func (cy *cy) TimeMediumLayout() string {
	return cy.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'cy'
func (cy *cy) TimeShortLayout() string {
	return cy.timeShortLayout
}

func (cy *cy) ListPatterns() *locales.ListPatterns {
	return cy.listPatterns
}

func (cy *cy) GetDurationSpec() *locales.DurationSpec {
	return cy.DurationSpec
}

func (cy *cy) GetMiscPatterns() *locales.MiscPatterns {
