...
func New() locales.Translator {
	return &ti{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0 ሽ"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 ሽ"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00 ሽ"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 ሽ"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000 ሽ"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000 ሽ"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ጥሪ", "ለካ", "መጋ", "ሚያ", "ግን", "ሰነ", "ሓም", "ነሓ", "መስ", "ጥቅ", "ሕዳ", "ታሕ"},
			MonthsNarrowValue:        []string{"", "ጥ", "ለ", "መ", "ሚ", "ግ", "ሰ", "ሓ", "ነ", "መ", "ጥ", "ሕ", "ታ"},
			MonthsWideValue:          []string{"", "ጥሪ", "ለካቲት", "መጋቢት", "ሚያዝያ", "ግንቦት", "ሰነ", "ሓምለ", "ነሓሰ", "መስከረም", "ጥቅምቲ", "ሕዳር", "ታሕሳስ"},
			WeekdaysAbbreviatedValue: []string{"ሰን", "ሰኑ", "ሰሉ", "ረቡ", "ሓሙ", "ዓር", "ቀዳ"},
			WeekdaysNarrowValue:      []string{"ሰ", "ሰ", "ሰ", "ረ", "ሓ", "ዓ", "ቀ"},
			WeekdaysShortValue:       []string{"ሰን", "ሰኑ", "ሰሉ", "ረቡ", "ሓሙ", "ዓር", "ቀዳ"},
			WeekdaysWideValue:        []string{"ሰንበት", "ሰኑይ", "ሰሉስ", "ረቡዕ", "ሓሙስ", "ዓርቢ", "ቀዳም"},
			PeriodsAbbreviatedValue:  []string{"ቅ.ቀ.", "ድ.ቀ."},
			PeriodsNarrowValue:       []string{"ቅ.ቀ.", "ድ.ቀ."},
			PeriodsWideValue:         []string{"ቅ.ቀ.", "ድ.ቀ."},
			ErasAbbreviatedValue:     []string{"ዓ/ዓ", "ዓ/ም"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"ቅድመ ክርስቶስ", "ዓመተ ምሕረት"},
			TimezonesValue:           map[string]string{"": "ምዱብ ግዜ ፓራጓይ", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ምዱብ ግዜ ኣክሪ", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "ADT", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "ግዜ ክረምቲ ኣላስካ", "AKST": "ምዱብ ግዜ ኣላስካ", "AMST": "ግዜ ክረምቲ ኣማዞን", "AMT": "ምዱብ ግዜ ኣማዞን", "ARST": "ግዜ ክረምቲ ኣርጀንቲና", "ART": "ምዱብ ግዜ ኣርጀንቲና", "AST": "AST", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "ግዜ ቦሊቭያ", "BRST": "ግዜ ክረምቲ ብራዚልያ", "BRT": "ምዱብ ግዜ ብራዚልያ", "BST": "BST", "BTT": "BTT", "CAT": "ግዜ ማእከላይ ኣፍሪቃ", "CCT": "CCT", "CDT": "CDT", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "ግዜ ክረምቲ ቺሌ", "CLT": "ምዱብ ግዜ ቺሌ", "COST": "ግዜ ክረምቲ ኮሎምብያ", "COT": "ምዱብ ግዜ ኮሎምብያ", "CST": "CST", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "ግዜ ክረምቲ ደሴት ፋሲካ", "EAST": "ምዱብ ግዜ ደሴት ፋሲካ", "EAT": "ግዜ ምብራቕ ኣፍሪቃ", "ECT": "ግዜ ኤኳዶር", "EDT": "EDT", "EGDT": "EGDT", "EGST": "EGST", "EST": "EST", "FKST": "ግዜ ከረምቲ ደሴታት ፎክላንድ", "GALT": "ግዜ ጋላፓጎስ", "GFT": "ግዜ ፈረንሳዊት ጊያና", "GMT": "GMT", "GST": "GST", "GYT": "ግዜ ጉያና", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "ግዜ ክረምቲ ኤውሮጳ", "MEZ": "ምዱብ ግዜ ማእከላይ ኤውሮጳ", "MST": "MST", "MVT": "MVT", "MYT": "ግዜ ማለዥያ", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "ግዜ ክረምቲ ምብራቕ ኤውሮጳ", "OEZ": "ምዱብ ግዜ ምብራቕ ኤውሮጳ", "PDT": "PDT", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "PST", "PYST": "ግዜ ክረምቲ ፓራጓይ", "SAST": "ግዜ ደቡብ ኣፍሪቃ", "SGT": "ግዜ ሲንጋፖር", "SRT": "ግዜ ሱሪናም", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "ግዜ ክረምቲ ኡራጓይ", "UYT": "ምዱብ ግዜ ኡራጓይ", "VET": "ግዜ ቬኔዝዌላ", "WARST": "WARST", "WART": "WART", "WAST": "ግዜ ክረምቲ ምዕራብ ኣፍሪቃ", "WAT": "ምዱብ ግዜ ምዕራብ ኣፍሪቃ", "WESZ": "WESZ", "WEZ": "WEZ", "WIB": "ግዜ ምዕራባዊ ኢንዶነዥያ", "WIT": "ግዜ ምብራቓዊ ኢንዶነዥያ", "WITA": "ግዜ ማእከላይ ኢንዶነዥያ", "∅∅∅": "ግዜ ክረምቲ ፔሩ"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0}ን {1}ን", "{0}፣ {1}", "{0}፣ {1}", "{0}ን {1}ን"}, {"{0} ወይ {1}", "{0}፣ {1}", "{0}፣ {1}", "{0} ወይ {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ዘመን", "%v ዘመን", "%v ዘመናት", ""},
				Long:   &locales.CounterFormat{"ዘመናት", "%v ዘመን", "%v ዘመናት", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ዓሰርተ ዓመት", "%v ዓ.ዓ.", "%v ዓ.ዓ.", ""},
				Long:   &locales.CounterFormat{"ዓሰርተታት ዓመታት", "%v ዓሰርተ ዓመት", "%v ዓሰርተታት ዓመታት", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
...
func (ti *ti) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ti, ti.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ti'
func (ti *ti) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ti, ti.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ti'
func (ti *ti) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ti, ti.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ti'
func (ti *ti) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ti, ti.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ti'
func (ti *ti) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ti, ti.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ti'
func (ti *ti) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ti, ti.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ti'
func (ti *ti) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ti, ti.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ti'
func (ti *ti) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ti, ti.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ti'
func (ti *ti) DateFullLayout() string {
	return ti.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ti'
func (ti *ti) DateLongLayout() string {
	return ti.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ti'
func (ti *ti) DateMediumLayout() string {
	return ti.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ti'
func (ti *ti) DateShortLayout() string {
	return ti.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ti'
func (ti *ti) TimeFullLayout() string {
	return ti.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ti'
func (ti *ti) TimeLongLayout() string {
	return ti.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ti'
func (ti *ti) TimeMediumLayout() string {
	return ti.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ti'
func (ti *ti) TimeShortLayout() string {
	return ti.timeShortLayout
}

func (ti *ti) ListPatterns() *locales.ListPatterns {
	return ti.listPatterns
}

func (ti *ti) GetDurationSpec() *locales.DurationSpec {
	return ti.DurationSpec
}

func (ti *ti) GetMiscPatterns() *locales.MiscPatterns {
	return &ti.miscPatterns
}
