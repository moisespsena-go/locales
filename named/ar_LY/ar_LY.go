...
// DateFullLayout returns the full date layout for 'ar_LY'
func (ar *ar_LY) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_LY'
func (ar *ar_LY) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_LY'
func (ar *ar_LY) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_LY'
func (ar *ar_LY) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_LY'
func (ar *ar_LY) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_LY'
func (ar *ar_LY) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_LY'
func (ar *ar_LY) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_LY'
func (ar *ar_LY) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_LY) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_LY) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_LY) GetMiscPatterns() *locales.MiscPatterns {
