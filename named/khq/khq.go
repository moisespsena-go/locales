...
// DateFullLayout returns the full date layout for 'khq'
func (khq *khq) DateFullLayout() string {
	return khq.dateFullLayout
}

// DateLongLayout returns the long date layout for 'khq'
func (khq *khq) DateLongLayout() string {
	return khq.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'khq'
func (khq *khq) DateMediumLayout() string {
	return khq.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'khq'
func (khq *khq) DateShortLayout() string {
	return khq.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'khq'
func (khq *khq) TimeFullLayout() string {
	return khq.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'khq'
func (khq *khq) TimeLongLayout() string {
	return khq.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'khq'
func (khq *khq) TimeMediumLayout() string {
	return khq.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'khq'
func (khq *khq) TimeShortLayout() string {
	return khq.timeShortLayout
}

func (khq *khq) ListPatterns() *locales.ListPatterns {
	return khq.listPatterns
}

func (khq *khq) GetDurationSpec() *locales.DurationSpec {
	return khq.DurationSpec
}

func (khq *khq) GetMiscPatterns() *locales.MiscPatterns {
