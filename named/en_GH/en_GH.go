...
// DateFullLayout returns the full date layout for 'en_GH'
func (en *en_GH) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_GH'
func (en *en_GH) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_GH'
func (en *en_GH) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_GH'
func (en *en_GH) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_GH'
func (en *en_GH) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_GH'
func (en *en_GH) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_GH'
func (en *en_GH) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_GH'
func (en *en_GH) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_GH) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_GH) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_GH) GetMiscPatterns() *locales.MiscPatterns {
