...
func New() locales.Translator {
	return &ms_MY{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						...
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0J"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00J"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000J"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mac", "Apr", "Mei", "Jun", "Jul", "Ogo", "Sep", "Okt", "Nov", "Dis"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "O", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Januari", "Februari", "Mac", "April", "Mei", "Jun", "Julai", "Ogos", "September", "Oktober", "November", "Disember"},
			WeekdaysAbbreviatedValue: []string{"Ahd", "Isn", "Sel", "Rab", "Kha", "Jum", "Sab"},
			WeekdaysNarrowValue:      []string{"A", "I", "S", "R", "K", "J", "S"},
			WeekdaysShortValue:       []string{"Ah", "Is", "Se", "Ra", "Kh", "Ju", "Sa"},
			WeekdaysWideValue:        []string{"Ahad", "Isnin", "Selasa", "Rabu", "Khamis", "Jumaat", "Sabtu"},
			PeriodsAbbreviatedValue:  []string{"PG", "PTG"},
			PeriodsNarrowValue:       []string{"a", "p"},
			PeriodsWideValue:         []string{"PG", "PTG"},
			ErasAbbreviatedValue:     []string{"S.M.", "TM"},
			ErasNarrowValue:          []string{"S.M.", "TM"},
			ErasWideValue:            []string{"S.M.", "TM"},
			TimezonesValue:           map[string]string{"": "Waktu Piawai Kepulauan Falkland", "ACDT": "Waktu Siang Australia Tengah", "ACST": "Waktu Piawai Australia Tengah", "ACT": "Waktu Piawai Acre", "ACWDT": "Waktu Siang Barat Tengah Australia", "ACWST": "Waktu Piawai Barat Tengah Australia", "ADT": "Waktu Siang Atlantik", "AEDT": "Waktu Siang Australia Timur", "AEST": "Waktu Piawai Timur Australia", "AFT": "Waktu Afghanistan", "AKDT": "Waktu Siang Alaska", "AKST": "Waktu Piawai Alaska", "AMST": "Waktu Musim Panas Amazon", "AMT": "Waktu Piawai Amazon", "ARST": "Waktu Musim Panas Argentina", "ART": "Waktu Piawai Argentina", "AST": "Waktu Piawai Atlantik", "AWDT": "Waktu Siang Australia Barat", "AWST": "Waktu Piawai Australia Barat", "BNT": "Waktu Brunei Darussalam", "BOT": "Waktu Bolivia", "BRST": "Waktu Musim Panas Brasilia", "BRT": "Waktu Piawai Brasilia", "BST": "Waktu Musim Panas Bangladesh", "BTT": "Waktu Bhutan", "CAT": "Waktu Afrika Tengah", "CCT": "Waktu Kepulauan Cocos", "CDT": "Waktu Siang Tengah", "CDT (Kuba)": "Waktu Siang Cuba", "CHADT": "Waktu Siang Chatham", "CHAST": "Waktu Piawai Chatham", "CLST": "Waktu Musim Panas Chile", "CLT": "Waktu Piawai Chile", "COST": "Waktu Musim Panas Colombia", "COT": "Waktu Piawai Colombia", "CST": "Waktu Piawai Pusat", "CST (Kuba)": "Waktu Piawai Cuba", "CXT": "Waktu Pulau Christmas", "ChST": "Waktu Piawai Chamorro", "EASST": "Waktu Musim Panas Pulau Easter", "EAST": "Waktu Piawai Pulau Easter", "EAT": "Waktu Afrika Timur", "ECT": "Waktu Ecuador", "EDT": "Waktu Siang Timur", "EGDT": "Waktu Musim Panas Greenland Timur", "EGST": "Waktu Piawai Greenland Timur", "EST": "Waktu Piawai Timur", "FKST": "Waktu Musim Panas Kepulauan Falkland", "GALT": "Waktu Galapagos", "GFT": "Waktu Guyana Perancis", "GMT": "Waktu Min Greenwich", "GST": "Waktu Piawai Teluk", "GYT": "Waktu Guyana", "HADT": "Waktu Siang Hawaii-Aleutian", "HAST": "Waktu Piawai Hawaii-Aleutian", "HENOMX": "Waktu Siang Barat Laut Mexico", "HEOG": "Waktu Musim Panas Greenland Barat", "HEPMX": "Waktu Siang Pasifik Mexico", "HKST": "Waktu Musim Panas Hong Kong", "HKT": "Waktu Piawai Hong Kong", "HNNOMX": "Waktu Piawai Barat Laut Mexico", "HNOG": "Waktu Piawai Greenland Barat", "HNPMX": "Waktu Piawai Pasifik Mexico", "ICT": "Waktu Indochina", "IRDT": "Waktu Siang Iran", "IRST": "Waktu Piawai Iran", "IST": "Waktu Piawai India", "JDT": "Waktu Siang Jepun", "JST": "Waktu Piawai Jepun", "LHDT": "Waktu Siang Lord Howe", "LHST": "Waktu Piawai Lord Howe", "MDT": "Waktu Musim Panas Macao", "MESZ": "Waktu Musim Panas Eropah Tengah", "MEZ": "Waktu Piawai Eropah Tengah", "MST": "Waktu Piawai Macao", "MVT": "Waktu Maldives", "MYT": "Waktu Malaysia", "NDT": "Waktu Siang Newfoundland", "NPT": "Waktu Nepal", "NST": "Waktu Piawai Newfoundland", "NZDT": "Waktu Siang New Zealand", "NZST": "Waktu Piawai New Zealand", "OESZ": "Waktu Musim Panas Eropah Timur", "OEZ": "Waktu Piawai Eropah Timur", "PDT": "Waktu Siang Pasifik", "PKT": "Waktu Musim Panas Pakistan", "PMDT": "Waktu Siang Saint Pierre dan Miquelon", "PMST": "Waktu Piawai Saint Pierre dan Miquelon", "PST": "Waktu Piawai Pasifik", "PYST": "Waktu Musim Panas Paraguay", "SAST": "Waktu Piawai Afrika Selatan", "SGT": "Waktu Piawai Singapura", "SRT": "Waktu Suriname", "TLT": "Waktu Timor Timur", "TMST": "Waktu Musim Panas Turkmenistan", "TMT": "Waktu Piawai Turkmenistan", "UYST": "Waktu Musim Panas Uruguay", "UYT": "Waktu Piawai Uruguay", "VET": "Waktu Venezuela", "WARST": "Waktu Musim Panas Argentina Barat", "WART": "Waktu Piawai Argentina Barat", "WAST": "Waktu Musim Panas Afrika Barat", "WAT": "Waktu Piawai Afrika Barat", "WESZ": "Waktu Musim Panas Eropah Barat", "WEZ": "Waktu Piawai Eropah Barat", "WIB": "Waktu Indonesia Barat", "WIT": "Waktu Indonesia Timur", "WITA": "Waktu Indonesia Tengah", "∅∅∅": "Waktu Musim Panas Peru"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} dan {1}", "{0}, {1}", "{0}, {1}", "{0} dan {1}"}, {"{0} atau {1}", "{0}, {1}", "{0}, {1}", "{0}, atau {1}"}}),
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
			"≤%[1]v",
...
func (ms *ms_MY) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ms, ms.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ms_MY'
func (ms *ms_MY) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ms, ms.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ms_MY'
func (ms *ms_MY) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ms, ms.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ms_MY'
func (ms *ms_MY) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ms, ms.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ms_MY'
func (ms *ms_MY) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ms, ms.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ms_MY'
func (ms *ms_MY) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ms, ms.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ms_MY'
func (ms *ms_MY) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ms, ms.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ms_MY'
func (ms *ms_MY) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ms, ms.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ms_MY'
func (ms *ms_MY) DateFullLayout() string {
	return ms.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ms_MY'
func (ms *ms_MY) DateLongLayout() string {
	return ms.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ms_MY'
func (ms *ms_MY) DateMediumLayout() string {
	return ms.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ms_MY'
func (ms *ms_MY) DateShortLayout() string {
	return ms.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ms_MY'
func (ms *ms_MY) TimeFullLayout() string {
	return ms.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ms_MY'
func (ms *ms_MY) TimeLongLayout() string {
	return ms.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ms_MY'
func (ms *ms_MY) TimeMediumLayout() string {
	return ms.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ms_MY'
func (ms *ms_MY) TimeShortLayout() string {
	return ms.timeShortLayout
}

func (ms *ms_MY) ListPatterns() *locales.ListPatterns {
	return ms.listPatterns
}

func (ms *ms_MY) GetDurationSpec() *locales.DurationSpec {
	return ms.DurationSpec
}

func (ms *ms_MY) GetMiscPatterns() *locales.MiscPatterns {
	return &ms.miscPatterns
}
