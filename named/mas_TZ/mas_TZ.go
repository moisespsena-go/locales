...
// DateFullLayout returns the full date layout for 'mas_TZ'
func (mas *mas_TZ) DateFullLayout() string {
	return mas.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mas_TZ'
func (mas *mas_TZ) DateLongLayout() string {
	return mas.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mas_TZ'
func (mas *mas_TZ) DateMediumLayout() string {
	return mas.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mas_TZ'
func (mas *mas_TZ) DateShortLayout() string {
	return mas.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mas_TZ'
func (mas *mas_TZ) TimeFullLayout() string {
	return mas.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mas_TZ'
func (mas *mas_TZ) TimeLongLayout() string {
	return mas.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mas_TZ'
func (mas *mas_TZ) TimeMediumLayout() string {
	return mas.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mas_TZ'
func (mas *mas_TZ) TimeShortLayout() string {
	return mas.timeShortLayout
}

func (mas *mas_TZ) ListPatterns() *locales.ListPatterns {
	return mas.listPatterns
}

func (mas *mas_TZ) GetDurationSpec() *locales.DurationSpec {
	return mas.DurationSpec
}

func (mas *mas_TZ) GetMiscPatterns() *locales.MiscPatterns {
