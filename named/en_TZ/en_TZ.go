...
// DateFullLayout returns the full date layout for 'en_TZ'
func (en *en_TZ) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_TZ'
func (en *en_TZ) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_TZ'
func (en *en_TZ) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_TZ'
func (en *en_TZ) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_TZ'
func (en *en_TZ) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_TZ'
func (en *en_TZ) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_TZ'
func (en *en_TZ) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_TZ'
func (en *en_TZ) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_TZ) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_TZ) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_TZ) GetMiscPatterns() *locales.MiscPatterns {
