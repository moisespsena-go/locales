...
// DateFullLayout returns the full date layout for 'en_PG'
func (en *en_PG) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_PG'
func (en *en_PG) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_PG'
func (en *en_PG) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_PG'
func (en *en_PG) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_PG'
func (en *en_PG) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_PG'
func (en *en_PG) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_PG'
func (en *en_PG) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_PG'
func (en *en_PG) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_PG) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_PG) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_PG) GetMiscPatterns() *locales.MiscPatterns {
