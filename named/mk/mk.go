...
func New() locales.Translator {
	return &mk{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 илј'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 илј'.' ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 илј'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 илј'.' ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 илј'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 илј'.' ¤"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 мил'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 мил'.' ¤"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 мил'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 мил'.' ¤"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 мил'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 мил'.' ¤"),
						}},
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 милј'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 милј'.' ¤"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 милј'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 милј'.' ¤"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 милј'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 милј'.' ¤"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 бил'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 бил'.' ¤"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 бил'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 бил'.' ¤"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 бил'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 бил'.' ¤"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "јан.", "фев.", "мар.", "апр.", "мај", "јун.", "јул.", "авг.", "септ.", "окт.", "ноем.", "дек."},
			MonthsNarrowValue:        []string{"", "ј", "ф", "м", "а", "м", "ј", "ј", "а", "с", "о", "н", "д"},
			MonthsWideValue:          []string{"", "јануари", "февруари", "март", "април", "мај", "јуни", "јули", "август", "септември", "октомври", "ноември", "декември"},
			WeekdaysAbbreviatedValue: []string{"нед.", "пон.", "вто.", "сре.", "чет.", "пет.", "саб."},
			WeekdaysNarrowValue:      []string{"н", "п", "в", "с", "ч", "п", "с"},
			WeekdaysShortValue:       []string{"нед.", "пон.", "вто.", "сре.", "чет.", "пет.", "саб."},
			WeekdaysWideValue:        []string{"недела", "понеделник", "вторник", "среда", "четврток", "петок", "сабота"},
			PeriodsAbbreviatedValue:  []string{"претпл.", "попл."},
			PeriodsNarrowValue:       []string{"претпл.", "попл."},
			PeriodsWideValue:         []string{"претпладне", "попладне"},
			ErasAbbreviatedValue:     []string{"п.н.е.", "н.е."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"пред нашата ера", "од нашата ера"},
			TimezonesValue:           map[string]string{"": "Стандардно време во Парагвај", "ACDT": "Летно сметање на времето во Централна Австралија", "ACST": "Стандардно време во Централна Австралија", "ACT": "Акре стандардно време", "ACWDT": "Летно сметање на времето во Централна и Западна Австралија", "ACWST": "Стандардно време во Централна и Западна Австралија", "ADT": "Атлантско летно сметање на времето", "AEDT": "Летно сметање на времето во Источна Австралија", "AEST": "Стандардно време во Источна Австралија", "AFT": "Време во Авганистан", "AKDT": "Летно сметање на времето во Алјаска", "AKST": "Стандардно време во Алјаска", "AMST": "Летно сметање на времето во Амазон", "AMT": "Стандардно време во Амазон", "ARST": "Летно сметање на времето во Аргентина", "ART": "Стандардно време во Аргентина", "AST": "Атлантско стандардно време", "AWDT": "Летно сметање на времето во Западна Австралија", "AWST": "Стандардно време во Западна Австралија", "BNT": "Време во Брунеј Дарусалам", "BOT": "Време во Боливија", "BRST": "Летно сметање на времето во Бразилија", "BRT": "Стандардно време во Бразилија", "BST": "Летно време во Бангладеш", "BTT": "Време во Бутан", "CAT": "Средноафриканско време", "CCT": "Време на Кокосовите Острови", "CDT": "Централно летно сметање на времето во Северна Америка", "CDT (Kuba)": "Летно сметање на времето во Куба", "CHADT": "Летно сметање на времето во Чатам", "CHAST": "Стандардно време во Чатам", "CLST": "Летно сметање на времето во Чиле", "CLT": "Стандардно време во Чиле", "COST": "Летно сметање на времето во Колумбија", "COT": "Стандардно време во Колумбија", "CST": "Централно стандардно време во Северна Америка", "CST (Kuba)": "Стандардно време во Куба", "CXT": "Време на Божиќниот Остров", "ChST": "Време во Чаморо", "EASST": "Летно време на Велигденскиот Остров", "EAST": "Стандардно време на Велигденскиот Остров", "EAT": "Источноафриканско време", "ECT": "Време во Еквадор", "EDT": "Источно летно сметање на времето во Северна Америка", "EGDT": "Летно сметање на времето во Источен Гренланд", "EGST": "Стандардно време во Источен Гренланд", "EST": "Источно стандардно време во Северна Америка", "FKST": "Летно сметање на времето на Фолкландските Острови", "GALT": "Време во Галапагос", "GFT": "Време во Француска Гвајана", "GMT": "Средно време по Гринич", "GST": "Време на Мексиканскиот Залив", "GYT": "Време во Гвајана", "HADT": "Летно сметање на времето во Хаваи - Алеутски острови", "HAST": "Стандардно време во Хаваи - Алеутски острови", "HENOMX": "Летно сметање на времето во северозападно Мексико", "HEOG": "Летно сметање на времето во Западен Гренланд", "HEPMX": "Летно пацифичко време во Мексико", "HKST": "Летно време во Хонг Конг", "HKT": "Стандардно време во Хонг Конг", "HNNOMX": "Стандардно време во северозападно Мексико", "HNOG": "Стандардно време во Западен Гренланд", "HNPMX": "Стандардно пацифичко време во Мексико", "ICT": "Време во Индокина", "IRDT": "Летно сметање на времето во Иран", "IRST": "Стандардно време во Иран", "IST": "Време во Индија", "JDT": "Летно сметање на времето во Јапонија", "JST": "Стандардно време во Јапонија", "LHDT": "Летно сметање на времето во Лорд Хау", "LHST": "Стандардно време во Лорд Хау", "MDT": "Планинско летно сметање на времето во Северна Америка", "MESZ": "Средноевропско летно време", "MEZ": "Средноевропско стандардно време", "MST": "Планинско стандардно време во Северна Америка", "MVT": "Време на Малдиви", "MYT": "Време во Малезија", "NDT": "Летно сметање на времето на Њуфаундленд", "NPT": "Време во Непал", "NST": "Стандардно време на Њуфаундленд", "NZDT": "Летно сметање на времето во Нов Зеланд", "NZST": "Стандардно време во Нов Зеланд", "OESZ": "Источноевропско летно време", "OEZ": "Источноевропско стандардно време", "PDT": "Пацифичко летно сметање на времето во Северна Америка", "PKT": "Летно време во Пакистан", "PMDT": "Летно сметање на времето на Сент Пјер и Микелан", "PMST": "Стандардно време на Сент Пјер и Микелан", "PST": "Пацифичко стандардно време во Северна Америка", "PYST": "Летно сметање на времето во Парагвај", "SAST": "Време во Јужноафриканска Република", "SGT": "Време во Сингапур", "SRT": "Време во Суринам", "TLT": "Време во Источен Тимор", "TMST": "Летно време во Туркменистан", "TMT": "Стандардно време во Туркменистан", "UYST": "Летно сметање на времето во Уругвај", "UYT": "Стандардно време во Уругвај", "VET": "Време во Венецуела", "WARST": "Летно сметање на времето во западна Аргентина", "WART": "Стандардно време во западна Аргентина", "WAST": "Западноафриканско летно сметање на времето", "WAT": "Западноафриканско стандардно време", "WESZ": "Западноевропско летно време", "WEZ": "Западноевропско стандардно време", "WIB": "Време во Западна Индонезија", "WIT": "Време во Источна Индонезија", "WITA": "Време во Централна Индонезија", "∅∅∅": "Летно сметање на времето во Перу"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"векови", "%v век", "%v векови", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"дец.", "%v дец.", "%v дец.", ""},
				Long:   &locales.CounterFormat{"децении", "%v деценија", "%v децении", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"г.", "%v г.", "%v г.", "%v/г."},
				Long:   &locales.CounterFormat{"години", "%v година", "%v години", "%v годишно"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"месец", "%v м.", "%v м.", "%v/м."},
				Long:   &locales.CounterFormat{"месеци", "%v месец", "%v месеци", "%v месечно"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"сед.", "%v с.", "%v с.", "%v/с."},
				Long:   &locales.CounterFormat{"седмици", "%v седмица", "%v седмици", "%v седмично"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ден", "%v д.", "%v д.", "%v/д."}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"час", "%v ч.", "%v ч.", "%v/ч."},
				Long:   &locales.CounterFormat{"часа", "%v час", "%v часа", "%v на час"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мин", "%v м.", "%v м.", "%v/м."},
				Long:   &locales.CounterFormat{"минути", "%v минута", "%v минути", "%v на минута"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"сек.", "%v с.", "%v с.", "%v/с."},
				Long:   &locales.CounterFormat{"секунди", "%v секунда", "%v секунди", "%v во секунда"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μс", "%vμс", "%vμс", ""},
...
func (mk *mk) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(mk, mk.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'mk'
func (mk *mk) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(mk, mk.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'mk'
func (mk *mk) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(mk, mk.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'mk'
func (mk *mk) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(mk, mk.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'mk'
func (mk *mk) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(mk, mk.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'mk'
func (mk *mk) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(mk, mk.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'mk'
func (mk *mk) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(mk, mk.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'mk'
func (mk *mk) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(mk, mk.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'mk'
func (mk *mk) DateFullLayout() string {
	return mk.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mk'
func (mk *mk) DateLongLayout() string {
	return mk.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mk'
func (mk *mk) DateMediumLayout() string {
	return mk.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mk'
func (mk *mk) DateShortLayout() string {
	return mk.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mk'
func (mk *mk) TimeFullLayout() string {
	return mk.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mk'
func (mk *mk) TimeLongLayout() string {
	return mk.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mk'
func (mk *mk) TimeMediumLayout() string {
	return mk.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mk'
func (mk *mk) TimeShortLayout() string {
	return mk.timeShortLayout
}

func (mk *mk) ListPatterns() *locales.ListPatterns {
	return mk.listPatterns
}

func (mk *mk) GetDurationSpec() *locales.DurationSpec {
	return mk.DurationSpec
}

func (mk *mk) GetMiscPatterns() *locales.MiscPatterns {
	return &mk.miscPatterns
}
