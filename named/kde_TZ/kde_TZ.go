...
func New() locales.Translator {
	return &kde_TZ{
		...
		TimeSpec: &locales.TimeSpec{
			...
			MonthsWideValue:          []string{"", "Mwedi Ntandi", "Mwedi wa Pili", "Mwedi wa Tatu", "Mwedi wa Nchechi", "Mwedi wa Nnyano", "Mwedi wa Nnyano na Umo", "Mwedi wa Nnyano na Mivili", "Mwedi wa Nnyano na Mitatu", "Mwedi wa Nnyano na Nchechi", "Mwedi wa Nnyano na Nnyano", "Mwedi wa Nnyano na Nnyano na U", "Mwedi wa Nnyano na Nnyano na M"},
			WeekdaysAbbreviatedValue: []string{"Ll2", "Ll3", "Ll4", "Ll5", "Ll6", "Ll7", "Ll1"},
			WeekdaysNarrowValue:      []string{"2", "3", "4", "5", "6", "7", "1"},
			WeekdaysWideValue:        []string{"Liduva lyapili", "Liduva lyatatu", "Liduva lyanchechi", "Liduva lyannyano", "Liduva lyannyano na linji", "Liduva lyannyano na mavili", "Liduva litandi"},
			PeriodsAbbreviatedValue:  []string{"Muhi", "Chilo"},
			PeriodsWideValue:         []string{"Muhi", "Chilo"},
			ErasAbbreviatedValue:     []string{"AY", "NY"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Akanapawa Yesu", "Nankuida Yesu"},
...
func (kde *kde_TZ) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(kde, kde.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'kde_TZ'
func (kde *kde_TZ) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(kde, kde.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'kde_TZ'
func (kde *kde_TZ) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(kde, kde.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'kde_TZ'
func (kde *kde_TZ) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(kde, kde.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'kde_TZ'
func (kde *kde_TZ) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(kde, kde.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'kde_TZ'
func (kde *kde_TZ) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(kde, kde.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'kde_TZ'
func (kde *kde_TZ) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(kde, kde.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'kde_TZ'
func (kde *kde_TZ) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(kde, kde.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'kde_TZ'
func (kde *kde_TZ) DateFullLayout() string {
	return kde.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kde_TZ'
func (kde *kde_TZ) DateLongLayout() string {
	return kde.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kde_TZ'
func (kde *kde_TZ) DateMediumLayout() string {
	return kde.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kde_TZ'
func (kde *kde_TZ) DateShortLayout() string {
	return kde.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kde_TZ'
func (kde *kde_TZ) TimeFullLayout() string {
	return kde.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kde_TZ'
func (kde *kde_TZ) TimeLongLayout() string {
	return kde.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kde_TZ'
func (kde *kde_TZ) TimeMediumLayout() string {
	return kde.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kde_TZ'
func (kde *kde_TZ) TimeShortLayout() string {
	return kde.timeShortLayout
}

func (kde *kde_TZ) ListPatterns() *locales.ListPatterns {
	return kde.listPatterns
}

func (kde *kde_TZ) GetDurationSpec() *locales.DurationSpec {
	return kde.DurationSpec
}

func (kde *kde_TZ) GetMiscPatterns() *locales.MiscPatterns {
	return &kde.miscPatterns
}
