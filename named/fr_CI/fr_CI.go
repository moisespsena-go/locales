...
// DateFullLayout returns the full date layout for 'fr_CI'
func (fr *fr_CI) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_CI'
func (fr *fr_CI) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_CI'
func (fr *fr_CI) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_CI'
func (fr *fr_CI) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_CI'
func (fr *fr_CI) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_CI'
func (fr *fr_CI) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_CI'
func (fr *fr_CI) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_CI'
func (fr *fr_CI) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_CI) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_CI) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_CI) GetMiscPatterns() *locales.MiscPatterns {
