...
// DateFullLayout returns the full date layout for 'ar_TD'
func (ar *ar_TD) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_TD'
func (ar *ar_TD) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_TD'
func (ar *ar_TD) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_TD'
func (ar *ar_TD) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_TD'
func (ar *ar_TD) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_TD'
func (ar *ar_TD) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_TD'
func (ar *ar_TD) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_TD'
func (ar *ar_TD) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_TD) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_TD) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_TD) GetMiscPatterns() *locales.MiscPatterns {
