...
// DateFullLayout returns the full date layout for 'fr_MR'
func (fr *fr_MR) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_MR'
func (fr *fr_MR) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_MR'
func (fr *fr_MR) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_MR'
func (fr *fr_MR) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_MR'
func (fr *fr_MR) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_MR'
func (fr *fr_MR) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_MR'
func (fr *fr_MR) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_MR'
func (fr *fr_MR) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_MR) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_MR) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_MR) GetMiscPatterns() *locales.MiscPatterns {
