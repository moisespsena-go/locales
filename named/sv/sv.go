...
func New() locales.Translator {
	return &sv{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 tn ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 tn ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 tn ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 tn ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 tn ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 tn ¤"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 mn ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 mn ¤"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 mn ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 mn ¤"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 mn ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 mn ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jan.", "feb.", "mars", "apr.", "maj", "juni", "juli", "aug.", "sep.", "okt.", "nov.", "dec."},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "januari", "februari", "mars", "april", "maj", "juni", "juli", "augusti", "september", "oktober", "november", "december"},
			WeekdaysAbbreviatedValue: []string{"sön", "mån", "tis", "ons", "tors", "fre", "lör"},
			WeekdaysNarrowValue:      []string{"S", "M", "T", "O", "T", "F", "L"},
			WeekdaysShortValue:       []string{"sö", "må", "ti", "on", "to", "fr", "lö"},
			WeekdaysWideValue:        []string{"söndag", "måndag", "tisdag", "onsdag", "torsdag", "fredag", "lördag"},
			PeriodsAbbreviatedValue:  []string{"fm", "em"},
			PeriodsNarrowValue:       []string{"fm", "em"},
			PeriodsWideValue:         []string{"fm", "em"},
			ErasAbbreviatedValue:     []string{"f.Kr.", "e.Kr."},
			ErasNarrowValue:          []string{"f.Kr.", "e.Kr."},
			ErasWideValue:            []string{"före Kristus", "efter Kristus"},
			TimezonesValue:           map[string]string{"": "paraguayansk normaltid", "ACDT": "centralaustralisk sommartid", "ACST": "västbrasiliansk sommartid", "ACT": "västbrasiliansk normaltid", "ACWDT": "västcentralaustralisk sommartid", "ACWST": "västcentralaustralisk normaltid", "ADT": "nordamerikansk atlantsommartid", "AEDT": "östaustralisk sommartid", "AEST": "östaustralisk normaltid", "AFT": "afghansk tid", "AKDT": "Alaska, sommartid", "AKST": "Alaska, normaltid", "AMST": "Amazonas, sommartid", "AMT": "Amazonas, normaltid", "ARST": "östargentinsk sommartid", "ART": "östargentinsk normaltid", "AST": "nordamerikansk atlantnormaltid", "AWDT": "västaustralisk sommartid", "AWST": "västaustralisk normaltid", "BNT": "Bruneitid", "BOT": "boliviansk tid", "BRST": "Brasilia, sommartid", "BRT": "Brasilia, normaltid", "BST": "bangladeshisk sommartid", "BTT": "bhutansk tid", "CAT": "centralafrikansk tid", "CCT": "Keelingöarnas tid", "CDT": "centralnordamerikansk sommartid", "CDT (Kuba)": "kubansk sommartid", "CHADT": "Chatham, sommartid", "CHAST": "Chatham, normaltid", "CLST": "chilensk sommartid", "CLT": "chilensk normaltid", "COST": "colombiansk sommartid", "COT": "colombiansk normaltid", "CST": "centralnordamerikansk normaltid", "CST (Kuba)": "kubansk normaltid", "CXT": "Julöns tid", "ChST": "Chamorrotid", "EASST": "Påskön, sommartid", "EAST": "Påskön, normaltid", "EAT": "östafrikansk tid", "ECT": "ecuadoriansk tid", "EDT": "östnordamerikansk sommartid", "EGDT": "östgrönländsk sommartid", "EGST": "östgrönländsk normaltid", "EST": "östnordamerikansk normaltid", "FKST": "Falklandsöarna, sommartid", "GALT": "Galápagostid", "GFT": "Franska Guyanatid", "GMT": "Greenwichtid", "GST": "Persiska vikentid", "GYT": "Guyanatid", "HADT": "Honolulu, sommartid", "HAST": "Honolulu, normaltid", "HENOMX": "nordvästmexikansk sommartid", "HEOG": "västgrönländsk sommartid", "HEPMX": "mexikansk stillahavstid, sommartid", "HKST": "Hongkong, sommartid", "HKT": "Hongkong, normaltid", "HNNOMX": "nordvästmexikansk normaltid", "HNOG": "västgrönländsk normaltid", "HNPMX": "mexikansk stillahavstid, normaltid", "ICT": "indokinesisk tid", "IRDT": "iransk sommartid", "IRST": "iransk normaltid", "IST": "indisk tid", "JDT": "japansk sommartid", "JST": "japansk normaltid", "LHDT": "Lord Howe, sommartid", "LHST": "Lord Howe, normaltid", "MDT": "Macaosommartid", "MESZ": "centraleuropeisk sommartid", "MEZ": "centraleuropeisk normaltid", "MST": "Macaonormaltid", "MVT": "Maldivernatid", "MYT": "malaysisk tid", "NDT": "Newfoundland, sommartid", "NPT": "nepalesisk tid", "NST": "Newfoundland, normaltid", "NZDT": "nyzeeländsk sommartid", "NZST": "nyzeeländsk normaltid", "OESZ": "östeuropeisk sommartid", "OEZ": "östeuropeisk normaltid", "PDT": "västnordamerikansk sommartid", "PKT": "pakistansk sommartid", "PMDT": "S:t Pierre och Miquelon, sommartid", "PMST": "S:t Pierre och Miquelon, normaltid", "PST": "västnordamerikansk normaltid", "PYST": "paraguayansk sommartid", "SAST": "sydafrikansk tid", "SGT": "Singaporetid", "SRT": "Surinamtid", "TLT": "östtimorisk tid", "TMST": "turkmensk sommartid", "TMT": "turkmensk normaltid", "UYST": "uruguayansk sommartid", "UYT": "uruguayansk normaltid", "VET": "venezuelansk tid", "WARST": "västargentinsk sommartid", "WART": "västargentinsk normaltid", "WAST": "västafrikansk sommartid", "WAT": "västafrikansk normaltid", "WESZ": "västeuropeisk sommartid", "WEZ": "västeuropeisk normaltid", "WIB": "västindonesisk tid", "WIT": "östindonesisk tid", "WITA": "centralindonesisk tid", "∅∅∅": "azorisk sommartid"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} och {1}", "{0}, {1}", "{0}, {1}", "{0} och {1}"}, {"{0} eller {1}", "{0}, {1}", "{0}, {1}", "{0} eller {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"årh", "%vårh", "%vårh", ""},
				Long:   &locales.CounterFormat{"århundraden", "%v århundrades", "%v århundradens", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vårt", "%vårt", ""},
				Long:   &locales.CounterFormat{"årtionden", "%v årtiondes", "%v årtiondens", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"år", "%vå", "%vå", "%v/år"},
				Long:   &locales.CounterFormat{"år", "%v års", "%v års", "%v per år"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m", "%vm", "%vm", "%v/mån"},
				Long:   &locales.CounterFormat{"månader", "%v månads", "%v månaders", "%v per månad"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"v", "%vv", "%vv", "%v/v"},
				Long:   &locales.CounterFormat{"veckor", "%v veckas", "%v veckors", "%v per vecka"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"d", "%vd", "%vd", "%v/d"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"h", "%vh", "%vh", "%v/h"},
				Long:   &locales.CounterFormat{"timmar", "%v timmes", "%v timmars", "%v per timme"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m", "%vm", "%vm", "%v/m"},
				Long:   &locales.CounterFormat{"minuter", "%v minuts", "%v minuters", "%v per minut"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sek", "%vs", "%vs", "%v/s"},
				Long:   &locales.CounterFormat{"sekunder", "%v sekunds", "%v sekunders", "%v per sekund"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"millisekunder", "%v millisekunds", "%v millisekunders", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%vμs", "%vμs", ""},
				Long:   &locales.CounterFormat{"mikrosekunder", "%v mikrosekunds", "%v mikrosekunders", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%vns", "%vns", ""},
				Long:   &locales.CounterFormat{"nanosekunder", "%v nanosekunds", "%v nanosekunders", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"⩾%[1]v",
...
func (sv *sv) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(sv, sv.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'sv'
func (sv *sv) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(sv, sv.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'sv'
func (sv *sv) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(sv, sv.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'sv'
func (sv *sv) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(sv, sv.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'sv'
func (sv *sv) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(sv, sv.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'sv'
func (sv *sv) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(sv, sv.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'sv'
func (sv *sv) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(sv, sv.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'sv'
func (sv *sv) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(sv, sv.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'sv'
func (sv *sv) DateFullLayout() string {
	return sv.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sv'
func (sv *sv) DateLongLayout() string {
	return sv.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sv'
func (sv *sv) DateMediumLayout() string {
	return sv.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sv'
func (sv *sv) DateShortLayout() string {
	return sv.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sv'
func (sv *sv) TimeFullLayout() string {
	return sv.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sv'
func (sv *sv) TimeLongLayout() string {
	return sv.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sv'
func (sv *sv) TimeMediumLayout() string {
	return sv.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sv'
func (sv *sv) TimeShortLayout() string {
	return sv.timeShortLayout
}

func (sv *sv) ListPatterns() *locales.ListPatterns {
	return sv.listPatterns
}

func (sv *sv) GetDurationSpec() *locales.DurationSpec {
	return sv.DurationSpec
}

func (sv *sv) GetMiscPatterns() *locales.MiscPatterns {
	return &sv.miscPatterns
}
