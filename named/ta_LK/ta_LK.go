...
// DateFullLayout returns the full date layout for 'ta_LK'
func (ta *ta_LK) DateFullLayout() string {
	return ta.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ta_LK'
func (ta *ta_LK) DateLongLayout() string {
	return ta.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ta_LK'
func (ta *ta_LK) DateMediumLayout() string {
	return ta.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ta_LK'
func (ta *ta_LK) DateShortLayout() string {
	return ta.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ta_LK'
func (ta *ta_LK) TimeFullLayout() string {
	return ta.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ta_LK'
func (ta *ta_LK) TimeLongLayout() string {
	return ta.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ta_LK'
func (ta *ta_LK) TimeMediumLayout() string {
	return ta.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ta_LK'
func (ta *ta_LK) TimeShortLayout() string {
	return ta.timeShortLayout
}

func (ta *ta_LK) ListPatterns() *locales.ListPatterns {
	return ta.listPatterns
}

func (ta *ta_LK) GetDurationSpec() *locales.DurationSpec {
	return ta.DurationSpec
}

func (ta *ta_LK) GetMiscPatterns() *locales.MiscPatterns {
