...
// DateFullLayout returns the full date layout for 'fr_GP'
func (fr *fr_GP) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_GP'
func (fr *fr_GP) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_GP'
func (fr *fr_GP) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_GP'
func (fr *fr_GP) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_GP'
func (fr *fr_GP) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_GP'
func (fr *fr_GP) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_GP'
func (fr *fr_GP) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_GP'
func (fr *fr_GP) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_GP) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_GP) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_GP) GetMiscPatterns() *locales.MiscPatterns {
