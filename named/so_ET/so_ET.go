...
// DateFullLayout returns the full date layout for 'so_ET'
func (so *so_ET) DateFullLayout() string {
	return so.dateFullLayout
}

// DateLongLayout returns the long date layout for 'so_ET'
func (so *so_ET) DateLongLayout() string {
	return so.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'so_ET'
func (so *so_ET) DateMediumLayout() string {
	return so.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'so_ET'
func (so *so_ET) DateShortLayout() string {
	return so.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'so_ET'
func (so *so_ET) TimeFullLayout() string {
	return so.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'so_ET'
func (so *so_ET) TimeLongLayout() string {
	return so.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'so_ET'
func (so *so_ET) TimeMediumLayout() string {
	return so.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'so_ET'
func (so *so_ET) TimeShortLayout() string {
	return so.timeShortLayout
}

func (so *so_ET) ListPatterns() *locales.ListPatterns {
	return so.listPatterns
}

func (so *so_ET) GetDurationSpec() *locales.DurationSpec {
	return so.DurationSpec
}

func (so *so_ET) GetMiscPatterns() *locales.MiscPatterns {
