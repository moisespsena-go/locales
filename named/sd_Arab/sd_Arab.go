...
// New returns a new instance of translator for the 'sd_Arab' locale
...
func (sd *sd_Arab) Locale() string {
	return sd.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'sd_Arab'
func (sd *sd_Arab) PluralsCardinal() []locales.PluralRule {
	return sd.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'sd_Arab'
func (sd *sd_Arab) PluralsOrdinal() []locales.PluralRule {
	return sd.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'sd_Arab'
func (sd *sd_Arab) PluralsRange() []locales.PluralRule {
	return sd.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'sd_Arab'
func (sd *sd_Arab) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'sd_Arab'
func (sd *sd_Arab) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleOther
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'sd_Arab'
func (sd *sd_Arab) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
...
// FmtDateShort returns the short date representation of 't' for 'sd_Arab'
func (sd *sd_Arab) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'sd_Arab'
func (sd *sd_Arab) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'sd_Arab'
func (sd *sd_Arab) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'sd_Arab'
func (sd *sd_Arab) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'sd_Arab'
func (sd *sd_Arab) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'sd_Arab'
func (sd *sd_Arab) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'sd_Arab'
func (sd *sd_Arab) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'sd_Arab'
func (sd *sd_Arab) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(sd, sd.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'sd_Arab'
func (sd *sd_Arab) DateFullLayout() string {
	return sd.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sd_Arab'
func (sd *sd_Arab) DateLongLayout() string {
	return sd.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sd_Arab'
func (sd *sd_Arab) DateMediumLayout() string {
	return sd.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sd_Arab'
func (sd *sd_Arab) DateShortLayout() string {
	return sd.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sd_Arab'
func (sd *sd_Arab) TimeFullLayout() string {
	return sd.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sd_Arab'
func (sd *sd_Arab) TimeLongLayout() string {
	return sd.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sd_Arab'
func (sd *sd_Arab) TimeMediumLayout() string {
	return sd.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sd_Arab'
func (sd *sd_Arab) TimeShortLayout() string {
	return sd.timeShortLayout
}

func (sd *sd_Arab) ListPatterns() *locales.ListPatterns {
	return sd.listPatterns
}

func (sd *sd_Arab) GetDurationSpec() *locales.DurationSpec {
	return sd.DurationSpec
}

func (sd *sd_Arab) GetMiscPatterns() *locales.MiscPatterns {
