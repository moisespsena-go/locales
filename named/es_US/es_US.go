...
func New() locales.Translator {
	return &es_US{
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"", "", "", ""}, []string(nil)}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"", "%v a", "%v aa.", "%v/a"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m", "%vm", "%vm", ""},
				Long:   &locales.CounterFormat{"", "%v m", "%v mm.", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"día", "%vd", "%vd", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
...
// DateFullLayout returns the full date layout for 'es_US'
func (es *es_US) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_US'
func (es *es_US) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_US'
func (es *es_US) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_US'
func (es *es_US) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_US'
func (es *es_US) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_US'
func (es *es_US) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_US'
func (es *es_US) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_US'
func (es *es_US) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_US) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_US) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_US) GetMiscPatterns() *locales.MiscPatterns {
