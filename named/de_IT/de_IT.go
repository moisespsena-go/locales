...
// DateFullLayout returns the full date layout for 'de_IT'
func (de *de_IT) DateFullLayout() string {
	return de.dateFullLayout
}

// DateLongLayout returns the long date layout for 'de_IT'
func (de *de_IT) DateLongLayout() string {
	return de.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'de_IT'
func (de *de_IT) DateMediumLayout() string {
	return de.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'de_IT'
func (de *de_IT) DateShortLayout() string {
	return de.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'de_IT'
func (de *de_IT) TimeFullLayout() string {
	return de.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'de_IT'
func (de *de_IT) TimeLongLayout() string {
	return de.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'de_IT'
func (de *de_IT) TimeMediumLayout() string {
	return de.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'de_IT'
func (de *de_IT) TimeShortLayout() string {
	return de.timeShortLayout
}

func (de *de_IT) ListPatterns() *locales.ListPatterns {
	return de.listPatterns
}

func (de *de_IT) GetDurationSpec() *locales.DurationSpec {
	return de.DurationSpec
}

func (de *de_IT) GetMiscPatterns() *locales.MiscPatterns {
