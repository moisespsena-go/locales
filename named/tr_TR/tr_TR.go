...
// DateFullLayout returns the full date layout for 'tr_TR'
func (tr *tr_TR) DateFullLayout() string {
	return tr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'tr_TR'
func (tr *tr_TR) DateLongLayout() string {
	return tr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'tr_TR'
func (tr *tr_TR) DateMediumLayout() string {
	return tr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'tr_TR'
func (tr *tr_TR) DateShortLayout() string {
	return tr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'tr_TR'
func (tr *tr_TR) TimeFullLayout() string {
	return tr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'tr_TR'
func (tr *tr_TR) TimeLongLayout() string {
	return tr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'tr_TR'
func (tr *tr_TR) TimeMediumLayout() string {
	return tr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'tr_TR'
func (tr *tr_TR) TimeShortLayout() string {
	return tr.timeShortLayout
}

func (tr *tr_TR) ListPatterns() *locales.ListPatterns {
	return tr.listPatterns
}

func (tr *tr_TR) GetDurationSpec() *locales.DurationSpec {
	return tr.DurationSpec
}

func (tr *tr_TR) GetMiscPatterns() *locales.MiscPatterns {
