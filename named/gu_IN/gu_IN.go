...
func New() locales.Translator {
	return &gu_IN{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "જાન્યુ", "ફેબ્રુ", "માર્ચ", "એપ્રિલ", "મે", "જૂન", "જુલાઈ", "ઑગસ્ટ", "સપ્ટે", "ઑક્ટો", "નવે", "ડિસે"},
			MonthsNarrowValue:        []string{"", "જા", "ફે", "મા", "એ", "મે", "જૂ", "જુ", "ઑ", "સ", "ઑ", "ન", "ડિ"},
			MonthsWideValue:          []string{"", "જાન્યુઆરી", "ફેબ્રુઆરી", "માર્ચ", "એપ્રિલ", "મે", "જૂન", "જુલાઈ", "ઑગસ્ટ", "સપ્ટેમ્બર", "ઑક્ટોબર", "નવેમ્બર", "ડિસેમ્બર"},
			WeekdaysAbbreviatedValue: []string{"રવિ", "સોમ", "મંગળ", "બુધ", "ગુરુ", "શુક્ર", "શનિ"},
			WeekdaysNarrowValue:      []string{"ર", "સો", "મં", "બુ", "ગુ", "શુ", "શ"},
			WeekdaysShortValue:       []string{"ર", "સો", "મં", "બુ", "ગુ", "શુ", "શ"},
			WeekdaysWideValue:        []string{"રવિવાર", "સોમવાર", "મંગળવાર", "બુધવાર", "ગુરુવાર", "શુક્રવાર", "શનિવાર"},
			...
			ErasNarrowValue:          []string{"ઇ સ પુ", "ઇસ"},
			ErasWideValue:            []string{"ઈસવીસન પૂર્વે", "ઇસવીસન"},
			TimezonesValue:           map[string]string{"": "ફૉકલેન્ડ આઇલેન્ડ્સ માનક સમય", "ACDT": "ઓસ્ટ્રેલિયન કેન્દ્રીય દિવસ સમય", "ACST": "એકર ગ્રીષ્મ સમય", "ACT": "એકર પ્રમાણભૂત સમય", "ACWDT": "ઓસ્ટ્રેલિયન કેન્દ્રીય પશ્ચિમી દિવસ સમય", "ACWST": "ઑસ્ટ્રેલિયન કેન્દ્રીય પશ્ચિમી માનક સમય", "ADT": "એટલાન્ટિક દિવસ સમય", "AEDT": "ઓસ્ટ્રેલિયન પૂર્વીય દિવસ સમય", "AEST": "ઑસ્ટ્રેલિયન પૂર્વીય માનક સમય", "AFT": "અફઘાનિસ્તાન સમય", "AKDT": "અલાસ્કા દિવસ સમય", "AKST": "અલાસ્કા માનક સમય", "AMST": "એમેઝોન ગ્રીષ્મ સમય", "AMT": "એમેઝોન માનક સમય", "ARST": "આર્જેન્ટીના ગ્રીષ્મ સમય", "ART": "આર્જેન્ટીના માનક સમય", "AST": "એટલાન્ટિક માનક સમય", "AWDT": "ઓસ્ટ્રેલિયન પશ્ચિમી દિવસ સમય", "AWST": "ઑસ્ટ્રેલિયન પશ્ચિમી માનક સમય", "BNT": "બ્રુનેઇ દરુસલામ સમય", "BOT": "બોલિવિયા સમય", "BRST": "બ્રાઝિલિયા ગ્રીષ્મ સમય", "BRT": "બ્રાઝિલિયા માનક સમય", "BST": "બાંગ્લાદેશ ગ્રીષ્મ સમય", "BTT": "ભૂટાન સમય", "CAT": "મધ્ય આફ્રિકા સમય", "CCT": "કોકોઝ આઇલેન્ડ્સ સમય", "CDT": "ઉત્તર અમેરિકન કેન્દ્રીય દિવસ સમય", "CDT (Kuba)": "ક્યુબા દિવસ સમય", "CHADT": "ચેતહામ દિવસ સમય", "CHAST": "ચેતહામ માનક સમય", "CLST": "ચિલી ગ્રીષ્મ સમય", "CLT": "ચિલી માનક સમય", "COST": "કોલમ્બિયા ગ્રીષ્મ સમય", "COT": "કોલમ્બિયા માનક સમય", "CST": "ઉત્તર અમેરિકન કેન્દ્રીય માનક સમય", "CST (Kuba)": "ક્યુબા માનક સમય", "CXT": "ક્રિસમસ આઇલેન્ડ સમય", "ChST": "કેમોરો માનક સમય", "EASST": "ઇસ્ટર આઇલેન્ડ ગ્રીષ્મ સમય", "EAST": "ઇસ્ટર આઇલેન્ડ માનક સમય", "EAT": "પૂર્વ આફ્રિકા સમય", "ECT": "એક્વાડોર સમય", "EDT": "ઉત્તર અમેરિકન પૂર્વી દિવસ સમય", "EGDT": "પૂર્વ ગ્રીનલેન્ડ ગ્રીષ્મ સમય", "EGST": "પૂર્વ ગ્રીનલેન્ડ માનક સમય", "EST": "ઉત્તર અમેરિકન પૂર્વી માનક સમય", "FKST": "ફૉકલેન્ડ આઇલેન્ડ્સ ગ્રીષ્મ સમય", "GALT": "ગાલાપાગોસ સમય", "GFT": "ફ્રેંચ ગયાના સમય", "GMT": "ગ્રીનવિચ મધ્યમ સમય", "GST": "ગલ્ફ માનક સમય", "GYT": "ગયાના સમય", "HADT": "હવાઇ-એલ્યુશિઅન દિવસ સમય", "HAST": "હવાઇ-એલ્યુશિઅન માનક સમય", "HENOMX": "ઉત્તરપશ્ચિમ મેક્સિકો દિવસ સમય", "HEOG": "પશ્ચિમ ગ્રીનલેન્ડ ગ્રીષ્મ સમય", "HEPMX": "મેક્સિકન પેસિફિક દિવસ સમય", "HKST": "હોંગ કોંગ ગ્રીષ્મ સમય", "HKT": "હોંગ કોંગ માનક સમય", "HNNOMX": "ઉત્તરપશ્ચિમ મેક્સિકો માનક સમય", "HNOG": "પશ્ચિમ ગ્રીનલેન્ડ માનક સમય", "HNPMX": "મેક્સિકન પેસિફિક માનક સમય", "ICT": "ઇન્ડોચાઇના સમય", "IRDT": "ઈરાન દિવસ સમય", "IRST": "ઈરાન માનક સમય", "IST": "ભારતીય માનક સમય", "JDT": "જાપાન દિવસ સમય", "JST": "જાપાન માનક સમય", "LHDT": "લોર્ડ હોવ દિવસ સમય", "LHST": "લોર્ડ હોવ માનક સમય", "MDT": "મકાઉ ગ્રીષ્મ સમય", "MESZ": "મધ્ય યુરોપિયન ગ્રીષ્મ સમય", "MEZ": "મધ્ય યુરોપિયન માનક સમય", "MST": "મકાઉ પ્રમાણભૂત સમય", "MVT": "માલદીવ સમય", "MYT": "મલેશિયા સમય", "NDT": "ન્યૂફાઉન્ડલેન્ડ દિવસ સમય", "NPT": "નેપાળ સમય", "NST": "ન્યૂફાઉન્ડલેન્ડ માનક સમય", "NZDT": "ન્યુઝીલેન્ડ દિવસ સમય", "NZST": "ન્યુઝીલેન્ડ માનક સમય", "OESZ": "પૂર્વી યુરોપિયન ગ્રીષ્મ સમય", "OEZ": "પૂર્વી યુરોપિયન માનક સમય", "PDT": "ઉત્તર અમેરિકન પેસિફિક દિવસ સમય", "PKT": "પાકિસ્તાન ગ્રીષ્મ સમય", "PMDT": "સેંટ પીએરી અને મિક્યુલોન દિવસ સમય", "PMST": "સેંટ પીએરી અને મિક્યુલોન માનક સમય", "PST": "ઉત્તર અમેરિકન પેસિફિક માનક સમય", "PYST": "પેરાગ્વે ગ્રીષ્મ સમય", "SAST": "દક્ષિણ આફ્રિકા માનક સમય", "SGT": "સિંગાપુર માનક સમય", "SRT": "સુરીનામ સમય", "TLT": "પૂર્વ તિમોર સમય", "TMST": "તુર્કમેનિસ્તાન ગ્રીષ્મ સમય", "TMT": "તુર્કમેનિસ્તાન માનક સમય", "UYST": "ઉરુગ્વે ગ્રીષ્મ સમય", "UYT": "ઉરુગ્વે માનક સમય", "VET": "વેનેઝુએલા સમય", "WARST": "પશ્ચિમી આર્જેન્ટીના ગ્રીષ્મ સમય", "WART": "પશ્ચિમી આર્જેન્ટીના માનક સમય", "WAST": "પશ્ચિમ આફ્રિકા ગ્રીષ્મ સમય", "WAT": "પશ્ચિમ આફ્રિકા માનક સમય", "WESZ": "પશ્ચિમી યુરોપિયન ગ્રીષ્મ સમય", "WEZ": "પશ્ચિમી યુરોપિયન માનક સમય", "WIB": "પશ્ચિમી ઇન્ડોનેશિયા સમય", "WIT": "પૂર્વીય ઇન્ડોનેશિયા સમય", "WITA": "મધ્ય ઇન્ડોનેશિયા સમય", "∅∅∅": "પેરુ ગ્રીષ્મ સમય"},
		},
		...
		timeFullLayout:   "hh:mm:ss a zzzz",
		timeLongLayout:   "hh:mm:ss a z",
		timeMediumLayout: "hh:mm:ss a",
		timeShortLayout:  "hh:mm a",
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} અને {1}", "{0}, {1}", "{0}, {1}", "{0} અને {1}"}, {"{0} અથવા {1}", "{0}, {1}", "{0}, {1}", "{0}, અથવા {1}"}}),
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
			"≤%[1]v",
...
func (gu *gu_IN) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(gu, gu.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'gu_IN'
func (gu *gu_IN) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(gu, gu.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'gu_IN'
func (gu *gu_IN) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(gu, gu.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'gu_IN'
func (gu *gu_IN) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(gu, gu.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'gu_IN'
func (gu *gu_IN) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(gu, gu.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'gu_IN'
func (gu *gu_IN) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(gu, gu.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'gu_IN'
func (gu *gu_IN) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(gu, gu.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'gu_IN'
func (gu *gu_IN) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(gu, gu.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'gu_IN'
func (gu *gu_IN) DateFullLayout() string {
	return gu.dateFullLayout
}

// DateLongLayout returns the long date layout for 'gu_IN'
func (gu *gu_IN) DateLongLayout() string {
	return gu.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'gu_IN'
func (gu *gu_IN) DateMediumLayout() string {
	return gu.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'gu_IN'
func (gu *gu_IN) DateShortLayout() string {
	return gu.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'gu_IN'
func (gu *gu_IN) TimeFullLayout() string {
	return gu.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'gu_IN'
func (gu *gu_IN) TimeLongLayout() string {
	return gu.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'gu_IN'
func (gu *gu_IN) TimeMediumLayout() string {
	return gu.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'gu_IN'
func (gu *gu_IN) TimeShortLayout() string {
	return gu.timeShortLayout
}

func (gu *gu_IN) ListPatterns() *locales.ListPatterns {
	return gu.listPatterns
}

func (gu *gu_IN) GetDurationSpec() *locales.DurationSpec {
	return gu.DurationSpec
}

func (gu *gu_IN) GetMiscPatterns() *locales.MiscPatterns {
	return &gu.miscPatterns
}
