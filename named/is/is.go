	...
	return &is{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"árh", "%várh", "%várh", ""},
				Long:   &locales.CounterFormat{"aldir", "%v aldar", "%v alda", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"árat.", "%v árat.", "%v árat.", ""},
				Long:   &locales.CounterFormat{"áratugir", "%v áratugs", "%v áratuga", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ár", "%vá", "%vá", "%v/ár"},
				Long:   &locales.CounterFormat{"ár", "%v árs", "%v ára", "%v á ári"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mánuður", "%v mán.", "%v mán.", "%v/m"},
				Long:   &locales.CounterFormat{"", "%v mánaðar", "%v mánaða", "%v á mánuði"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"vika", "%v v.", "%v v.", "%v/v"},
				Long:   &locales.CounterFormat{"vikur", "%v viku", "%v vikna", "%v á viku"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dagur", "%v d.", "%v d.", "%v/d."}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"klukkustund", "%v klst.", "%v klst.", "%v/klst."},
				Long:   &locales.CounterFormat{"klukkustundir", "%v klukkustundar", "%v klukkustunda", "%v á klst."}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mín.", "%v mín.", "%v mín.", "%v/min"},
				Long:   &locales.CounterFormat{"mínútur", "%v mínútu", "%v mínútna", "%v á mínútu"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sek.", "%v sek.", "%v sek.", "%v/sek."},
				Long:   &locales.CounterFormat{"sekúndur", "%v sekúndu", "%v sekúndna", "%v á sekúndu"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"millisek.", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"millisekúndur", "%v millisekúndu", "%v millisekúndna", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μsek.", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"míkrósekúndur", "%v míkrósekúndu", "%v míkrósekúndna", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"nanósek.", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanósekúndur", "%v nanósekúndu", "%v nanósekúndna", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
// DateFullLayout returns the full date layout for 'is'
func (is *is) DateFullLayout() string {
	return is.dateFullLayout
}

// DateLongLayout returns the long date layout for 'is'
func (is *is) DateLongLayout() string {
	return is.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'is'
func (is *is) DateMediumLayout() string {
	return is.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'is'
func (is *is) DateShortLayout() string {
	return is.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'is'
func (is *is) TimeFullLayout() string {
	return is.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'is'
func (is *is) TimeLongLayout() string {
	return is.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'is'
func (is *is) TimeMediumLayout() string {
	return is.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'is'
func (is *is) TimeShortLayout() string {
	return is.timeShortLayout
}

func (is *is) ListPatterns() *locales.ListPatterns {
	return is.listPatterns
}

func (is *is) GetDurationSpec() *locales.DurationSpec {
	return is.DurationSpec
}

func (is *is) GetMiscPatterns() *locales.MiscPatterns {
