...
// DateFullLayout returns the full date layout for 'nl_CW'
func (nl *nl_CW) DateFullLayout() string {
	return nl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nl_CW'
func (nl *nl_CW) DateLongLayout() string {
	return nl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nl_CW'
func (nl *nl_CW) DateMediumLayout() string {
	return nl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nl_CW'
func (nl *nl_CW) DateShortLayout() string {
	return nl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nl_CW'
func (nl *nl_CW) TimeFullLayout() string {
	return nl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nl_CW'
func (nl *nl_CW) TimeLongLayout() string {
	return nl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nl_CW'
func (nl *nl_CW) TimeMediumLayout() string {
	return nl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nl_CW'
func (nl *nl_CW) TimeShortLayout() string {
	return nl.timeShortLayout
}

func (nl *nl_CW) ListPatterns() *locales.ListPatterns {
	return nl.listPatterns
}

func (nl *nl_CW) GetDurationSpec() *locales.DurationSpec {
	return nl.DurationSpec
}

func (nl *nl_CW) GetMiscPatterns() *locales.MiscPatterns {
