...
// DateFullLayout returns the full date layout for 'en_MT'
func (en *en_MT) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_MT'
func (en *en_MT) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_MT'
func (en *en_MT) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_MT'
func (en *en_MT) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_MT'
func (en *en_MT) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_MT'
func (en *en_MT) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_MT'
func (en *en_MT) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_MT'
func (en *en_MT) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_MT) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_MT) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_MT) GetMiscPatterns() *locales.MiscPatterns {
