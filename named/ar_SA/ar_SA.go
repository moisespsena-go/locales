	...
	return &ar_SA{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"", "سنة", "%v سنة", ""},
				Long:   &locales.CounterFormat{"سنوات", "سنة", "%v سنة", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "شهر", "%v شهر", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine},
			locales.DurationSpecPair{},
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "ثانية", "%v ثانية", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
...
// DateFullLayout returns the full date layout for 'ar_SA'
func (ar *ar_SA) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_SA'
func (ar *ar_SA) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_SA'
func (ar *ar_SA) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_SA'
func (ar *ar_SA) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_SA'
func (ar *ar_SA) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_SA'
func (ar *ar_SA) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_SA'
func (ar *ar_SA) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_SA'
func (ar *ar_SA) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_SA) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_SA) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_SA) GetMiscPatterns() *locales.MiscPatterns {
