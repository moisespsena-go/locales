...
// DateFullLayout returns the full date layout for 'ja'
func (ja *ja) DateFullLayout() string {
	return ja.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ja'
func (ja *ja) DateLongLayout() string {
	return ja.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ja'
func (ja *ja) DateMediumLayout() string {
	return ja.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ja'
func (ja *ja) DateShortLayout() string {
	return ja.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ja'
func (ja *ja) TimeFullLayout() string {
	return ja.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ja'
func (ja *ja) TimeLongLayout() string {
	return ja.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ja'
func (ja *ja) TimeMediumLayout() string {
	return ja.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ja'
func (ja *ja) TimeShortLayout() string {
	return ja.timeShortLayout
}

func (ja *ja) ListPatterns() *locales.ListPatterns {
	return ja.listPatterns
}

func (ja *ja) GetDurationSpec() *locales.DurationSpec {
	return ja.DurationSpec
}

func (ja *ja) GetMiscPatterns() *locales.MiscPatterns {
