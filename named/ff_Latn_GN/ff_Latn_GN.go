...
// DateFullLayout returns the full date layout for 'ff_Latn_GN'
func (ff *ff_Latn_GN) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff_Latn_GN'
func (ff *ff_Latn_GN) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff_Latn_GN'
func (ff *ff_Latn_GN) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff_Latn_GN'
func (ff *ff_Latn_GN) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff_Latn_GN'
func (ff *ff_Latn_GN) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff_Latn_GN'
func (ff *ff_Latn_GN) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff_Latn_GN'
func (ff *ff_Latn_GN) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff_Latn_GN'
func (ff *ff_Latn_GN) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff_Latn_GN) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff_Latn_GN) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff_Latn_GN) GetMiscPatterns() *locales.MiscPatterns {
