...
func New() locales.Translator {
	return &mfe_MU{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "zan", "fev", "mar", "avr", "me", "zin", "zil", "out", "sep", "okt", "nov", "des"},
			MonthsNarrowValue:        []string{"", "z", "f", "m", "a", "m", "z", "z", "o", "s", "o", "n", "d"},
			MonthsWideValue:          []string{"", "zanvie", "fevriye", "mars", "avril", "me", "zin", "zilye", "out", "septam", "oktob", "novam", "desam"},
			WeekdaysAbbreviatedValue: []string{"dim", "lin", "mar", "mer", "ze", "van", "sam"},
			WeekdaysNarrowValue:      []string{"d", "l", "m", "m", "z", "v", "s"},
			WeekdaysWideValue:        []string{"dimans", "lindi", "mardi", "merkredi", "zedi", "vandredi", "samdi"},
			ErasAbbreviatedValue:     []string{"av. Z-K", "ap. Z-K"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"avan Zezi-Krist", "apre Zezi-Krist"},
...
func (mfe *mfe_MU) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(mfe, mfe.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'mfe_MU'
func (mfe *mfe_MU) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(mfe, mfe.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'mfe_MU'
func (mfe *mfe_MU) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(mfe, mfe.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'mfe_MU'
func (mfe *mfe_MU) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(mfe, mfe.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'mfe_MU'
func (mfe *mfe_MU) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(mfe, mfe.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'mfe_MU'
func (mfe *mfe_MU) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(mfe, mfe.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'mfe_MU'
func (mfe *mfe_MU) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(mfe, mfe.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'mfe_MU'
func (mfe *mfe_MU) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(mfe, mfe.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'mfe_MU'
func (mfe *mfe_MU) DateFullLayout() string {
	return mfe.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mfe_MU'
func (mfe *mfe_MU) DateLongLayout() string {
	return mfe.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mfe_MU'
func (mfe *mfe_MU) DateMediumLayout() string {
	return mfe.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mfe_MU'
func (mfe *mfe_MU) DateShortLayout() string {
	return mfe.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mfe_MU'
func (mfe *mfe_MU) TimeFullLayout() string {
	return mfe.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mfe_MU'
func (mfe *mfe_MU) TimeLongLayout() string {
	return mfe.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mfe_MU'
func (mfe *mfe_MU) TimeMediumLayout() string {
	return mfe.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mfe_MU'
func (mfe *mfe_MU) TimeShortLayout() string {
	return mfe.timeShortLayout
}

func (mfe *mfe_MU) ListPatterns() *locales.ListPatterns {
	return mfe.listPatterns
}

func (mfe *mfe_MU) GetDurationSpec() *locales.DurationSpec {
	return mfe.DurationSpec
}

func (mfe *mfe_MU) GetMiscPatterns() *locales.MiscPatterns {
	return &mfe.miscPatterns
}
