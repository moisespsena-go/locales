...
// DateFullLayout returns the full date layout for 'vi'
func (vi *vi) DateFullLayout() string {
	return vi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'vi'
func (vi *vi) DateLongLayout() string {
	return vi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'vi'
func (vi *vi) DateMediumLayout() string {
	return vi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'vi'
func (vi *vi) DateShortLayout() string {
	return vi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'vi'
func (vi *vi) TimeFullLayout() string {
	return vi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'vi'
func (vi *vi) TimeLongLayout() string {
	return vi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'vi'
func (vi *vi) TimeMediumLayout() string {
	return vi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'vi'
func (vi *vi) TimeShortLayout() string {
	return vi.timeShortLayout
}

func (vi *vi) ListPatterns() *locales.ListPatterns {
	return vi.listPatterns
}

func (vi *vi) GetDurationSpec() *locales.DurationSpec {
	return vi.DurationSpec
}

func (vi *vi) GetMiscPatterns() *locales.MiscPatterns {
