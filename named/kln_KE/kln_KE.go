...
func New() locales.Translator {
	return &kln_KE{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Mul", "Ngat", "Taa", "Iwo", "Mam", "Paa", "Nge", "Roo", "Bur", "Epe", "Kpt", "Kpa"},
			MonthsNarrowValue:        []string{"", "M", "N", "T", "I", "M", "P", "N", "R", "B", "E", "K", "K"},
			MonthsWideValue:          []string{"", "Mulgul", "Ng’atyaato", "Kiptaamo", "Iwootkuut", "Mamuut", "Paagi", "Ng’eiyeet", "Rooptui", "Bureet", "Epeeso", "Kipsuunde ne taai", "Kipsuunde nebo aeng’"},
			WeekdaysAbbreviatedValue: []string{"Kts", "Kot", "Koo", "Kos", "Koa", "Kom", "Kol"},
			WeekdaysNarrowValue:      []string{"T", "T", "O", "S", "A", "M", "L"},
			WeekdaysWideValue:        []string{"Kotisap", "Kotaai", "Koaeng’", "Kosomok", "Koang’wan", "Komuut", "Kolo"},
			PeriodsAbbreviatedValue:  []string{"krn", "koosk"},
			PeriodsWideValue:         []string{"karoon", "kooskoliny"},
			ErasAbbreviatedValue:     []string{"AM", "KO"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Amait kesich Jesu", "Kokakesich Jesu"},
...
func (kln *kln_KE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(kln, kln.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'kln_KE'
func (kln *kln_KE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(kln, kln.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'kln_KE'
func (kln *kln_KE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(kln, kln.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'kln_KE'
func (kln *kln_KE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(kln, kln.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'kln_KE'
func (kln *kln_KE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(kln, kln.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'kln_KE'
func (kln *kln_KE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(kln, kln.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'kln_KE'
func (kln *kln_KE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(kln, kln.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'kln_KE'
func (kln *kln_KE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(kln, kln.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'kln_KE'
func (kln *kln_KE) DateFullLayout() string {
	return kln.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kln_KE'
func (kln *kln_KE) DateLongLayout() string {
	return kln.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kln_KE'
func (kln *kln_KE) DateMediumLayout() string {
	return kln.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kln_KE'
func (kln *kln_KE) DateShortLayout() string {
	return kln.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kln_KE'
func (kln *kln_KE) TimeFullLayout() string {
	return kln.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kln_KE'
func (kln *kln_KE) TimeLongLayout() string {
	return kln.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kln_KE'
func (kln *kln_KE) TimeMediumLayout() string {
	return kln.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kln_KE'
func (kln *kln_KE) TimeShortLayout() string {
	return kln.timeShortLayout
}

func (kln *kln_KE) ListPatterns() *locales.ListPatterns {
	return kln.listPatterns
}

func (kln *kln_KE) GetDurationSpec() *locales.DurationSpec {
	return kln.DurationSpec
}

func (kln *kln_KE) GetMiscPatterns() *locales.MiscPatterns {
	return &kln.miscPatterns
}
