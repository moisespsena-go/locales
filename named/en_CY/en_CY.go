...
// DateFullLayout returns the full date layout for 'en_CY'
func (en *en_CY) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_CY'
func (en *en_CY) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_CY'
func (en *en_CY) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_CY'
func (en *en_CY) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_CY'
func (en *en_CY) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_CY'
func (en *en_CY) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_CY'
func (en *en_CY) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_CY'
func (en *en_CY) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_CY) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_CY) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_CY) GetMiscPatterns() *locales.MiscPatterns {
