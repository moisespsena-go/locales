...
func New() locales.Translator {
	return &sah_RU{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 тыһ'.' ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 тыһ'.' ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 тыһ'.' ¤"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 мөл ¤"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 мөл ¤"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 мөл ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Тохс", "Олун", "Клн", "Мсу", "Ыам", "Бэс", "Отй", "Атр", "Блҕ", "Алт", "Сэт", "Ахс"},
			MonthsNarrowValue:        []string{"", "Т", "О", "К", "М", "Ы", "Б", "О", "А", "Б", "А", "С", "А"},
			MonthsWideValue:          []string{"", "Тохсунньу", "Олунньу", "Кулун тутар", "Муус устар", "Ыам ыйын", "Бэс ыйын", "От ыйын", "Атырдьых ыйын", "Балаҕан ыйын", "Алтынньы", "Сэтинньи", "ахсынньы"},
			WeekdaysAbbreviatedValue: []string{"бс", "бн", "оп", "сэ", "чп", "бэ", "сб"},
			WeekdaysNarrowValue:      []string{"Б", "Б", "О", "С", "Ч", "Б", "С"},
			WeekdaysShortValue:       []string{"бс", "бн", "оп", "сэ", "чп", "бэ", "сб"},
			WeekdaysWideValue:        []string{"баскыһыанньа", "бэнидиэнньик", "оптуорунньук", "сэрэдэ", "чэппиэр", "Бээтиҥсэ", "субуота"},
			PeriodsAbbreviatedValue:  []string{"ЭИ", "ЭК"},
			PeriodsNarrowValue:       []string{"ЭИ", "ЭК"},
			PeriodsWideValue:         []string{"ЭИ", "ЭК"},
			ErasAbbreviatedValue:     []string{"б. э. и.", "б. э"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"б. э. и.", "б. э"},
			TimezonesValue:           map[string]string{"": "", "ACDT": "Киин Австралия сайыҥҥы кэмэ", "ACST": "Киин Австралия сүрүн кэмэ", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "ADT", "AEDT": "Илин Австралия сайыҥҥы кэмэ", "AEST": "Илин Австралия сүрүн кэмэ", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "AST", "AWDT": "Арҕаа Австралия сайыҥҥы кэмэ", "AWST": "Арҕаа Австралия сүрүн кэмэ", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "CAT", "CCT": "CCT", "CDT": "CDT", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "CST", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "EAT", "ECT": "ECT", "EDT": "EDT", "EGDT": "EGDT", "EGST": "EGST", "EST": "EST", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "GMT", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "Ыраан сайыҥҥы кэмэ", "IRST": "Ираан сүрүн кэмэ", "IST": "Ииндийэ сүрүн кэмэ", "JDT": "Дьоппуон сайыҥҥы кэмэ", "JST": "Дьоппуон сүрүн кэмэ", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "MESZ", "MEZ": "MEZ", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "Саҥа Сэйлэнд сайыҥҥы кэмэ", "NZST": "Саҥа Сэйлэнд сүрүн кэмэ", "OESZ": "OESZ", "OEZ": "OEZ", "PDT": "PDT", "PKT": "Пакистаан сайыҥҥы кэмэ", "PMDT": "PMDT", "PMST": "PMST", "PST": "PST", "PYST": "PYST", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "WESZ", "WEZ": "WEZ", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		dateFullLayout:   "y 'сыл' MMMM d 'күнэ', EEEE",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} уонна {1}", "{0}, {1}", "{0}, {1}", "{0} уонна {1}"}, []string(nil)}),
		miscPatterns: locales.MiscPatterns{
			"",
			"≥%[1]v",
			"",
...
func (sah *sah_RU) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(sah, sah.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'sah_RU'
func (sah *sah_RU) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(sah, sah.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'sah_RU'
func (sah *sah_RU) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(sah, sah.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'sah_RU'
func (sah *sah_RU) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(sah, sah.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'sah_RU'
func (sah *sah_RU) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(sah, sah.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'sah_RU'
func (sah *sah_RU) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(sah, sah.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'sah_RU'
func (sah *sah_RU) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(sah, sah.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'sah_RU'
func (sah *sah_RU) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(sah, sah.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'sah_RU'
func (sah *sah_RU) DateFullLayout() string {
	return sah.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sah_RU'
func (sah *sah_RU) DateLongLayout() string {
	return sah.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sah_RU'
func (sah *sah_RU) DateMediumLayout() string {
	return sah.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sah_RU'
func (sah *sah_RU) DateShortLayout() string {
	return sah.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sah_RU'
func (sah *sah_RU) TimeFullLayout() string {
	return sah.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sah_RU'
func (sah *sah_RU) TimeLongLayout() string {
	return sah.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sah_RU'
func (sah *sah_RU) TimeMediumLayout() string {
	return sah.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sah_RU'
func (sah *sah_RU) TimeShortLayout() string {
	return sah.timeShortLayout
}

func (sah *sah_RU) ListPatterns() *locales.ListPatterns {
	return sah.listPatterns
}

func (sah *sah_RU) GetDurationSpec() *locales.DurationSpec {
	return sah.DurationSpec
}

func (sah *sah_RU) GetMiscPatterns() *locales.MiscPatterns {
	return &sah.miscPatterns
}
