...
// DateFullLayout returns the full date layout for 'saq'
func (saq *saq) DateFullLayout() string {
	return saq.dateFullLayout
}

// DateLongLayout returns the long date layout for 'saq'
func (saq *saq) DateLongLayout() string {
	return saq.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'saq'
func (saq *saq) DateMediumLayout() string {
	return saq.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'saq'
func (saq *saq) DateShortLayout() string {
	return saq.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'saq'
func (saq *saq) TimeFullLayout() string {
	return saq.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'saq'
func (saq *saq) TimeLongLayout() string {
	return saq.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'saq'
func (saq *saq) TimeMediumLayout() string {
	return saq.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'saq'
func (saq *saq) TimeShortLayout() string {
	return saq.timeShortLayout
}

func (saq *saq) ListPatterns() *locales.ListPatterns {
	return saq.listPatterns
}

func (saq *saq) GetDurationSpec() *locales.DurationSpec {
	return saq.DurationSpec
}

func (saq *saq) GetMiscPatterns() *locales.MiscPatterns {
