...
// DateFullLayout returns the full date layout for 'fr_KM'
func (fr *fr_KM) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_KM'
func (fr *fr_KM) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_KM'
func (fr *fr_KM) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_KM'
func (fr *fr_KM) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_KM'
func (fr *fr_KM) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_KM'
func (fr *fr_KM) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_KM'
func (fr *fr_KM) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_KM'
func (fr *fr_KM) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_KM) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_KM) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_KM) GetMiscPatterns() *locales.MiscPatterns {
