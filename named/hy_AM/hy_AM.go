...
// DateFullLayout returns the full date layout for 'hy_AM'
func (hy *hy_AM) DateFullLayout() string {
	return hy.dateFullLayout
}

// DateLongLayout returns the long date layout for 'hy_AM'
func (hy *hy_AM) DateLongLayout() string {
	return hy.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'hy_AM'
func (hy *hy_AM) DateMediumLayout() string {
	return hy.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'hy_AM'
func (hy *hy_AM) DateShortLayout() string {
	return hy.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'hy_AM'
func (hy *hy_AM) TimeFullLayout() string {
	return hy.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'hy_AM'
func (hy *hy_AM) TimeLongLayout() string {
	return hy.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'hy_AM'
func (hy *hy_AM) TimeMediumLayout() string {
	return hy.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'hy_AM'
func (hy *hy_AM) TimeShortLayout() string {
	return hy.timeShortLayout
}

func (hy *hy_AM) ListPatterns() *locales.ListPatterns {
	return hy.listPatterns
}

func (hy *hy_AM) GetDurationSpec() *locales.DurationSpec {
	return hy.DurationSpec
}

func (hy *hy_AM) GetMiscPatterns() *locales.MiscPatterns {
