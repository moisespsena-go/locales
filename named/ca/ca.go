...
func New() locales.Translator {
	return &ca{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						...
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00mM ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00mM ¤"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000mM ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000mM ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "de gen.", "de febr.", "de març", "d’abr.", "de maig", "de juny", "de jul.", "d’ag.", "de set.", "d’oct.", "de nov.", "de des."},
			MonthsNarrowValue:        []string{"", "GN", "FB", "MÇ", "AB", "MG", "JN", "JL", "AG", "ST", "OC", "NV", "DS"},
			MonthsWideValue:          []string{"", "de gener", "de febrer", "de març", "d’abril", "de maig", "de juny", "de juliol", "d’agost", "de setembre", "d’octubre", "de novembre", "de desembre"},
			WeekdaysAbbreviatedValue: []string{"dg.", "dl.", "dt.", "dc.", "dj.", "dv.", "ds."},
			WeekdaysNarrowValue:      []string{"dg", "dl", "dt", "dc", "dj", "dv", "ds"},
			WeekdaysShortValue:       []string{"dg.", "dl.", "dt.", "dc.", "dj.", "dv.", "ds."},
			WeekdaysWideValue:        []string{"diumenge", "dilluns", "dimarts", "dimecres", "dijous", "divendres", "dissabte"},
			PeriodsAbbreviatedValue:  []string{"a.\u00a0m.", "p.\u00a0m."},
			PeriodsNarrowValue:       []string{"a.\u00a0m.", "p.\u00a0m."},
			PeriodsWideValue:         []string{"a.\u00a0m.", "p.\u00a0m."},
			ErasAbbreviatedValue:     []string{"aC", "dC"},
			ErasNarrowValue:          []string{"aC", "dC"},
			ErasWideValue:            []string{"abans de Crist", "després de Crist"},
			TimezonesValue:           map[string]string{"": "Hora estàndard de les illes Malvines", "ACDT": "Hora d’estiu d’Austràlia Central", "ACST": "Hora estàndard d’Austràlia Central", "ACT": "ACT", "ACWDT": "Hora d’estiu d’Austràlia centre-occidental", "ACWST": "Hora estàndard d’Austràlia centre-occidental", "ADT": "Hora d’estiu de l’Atlàntic", "AEDT": "Hora d’estiu d’Austràlia Oriental", "AEST": "Hora estàndard d’Austràlia Oriental", "AFT": "Hora de l’Afganistan", "AKDT": "Hora d’estiu d’Alaska", "AKST": "Hora estàndard d’Alaska", "AMST": "Hora d’estiu de l’Amazones", "AMT": "Hora estàndard de l’Amazones", "ARST": "Hora d’estiu de l’Argentina", "ART": "Hora estàndard de l’Argentina", "AST": "Hora estàndard de l’Atlàntic", "AWDT": "Hora d’estiu d’Austràlia Occidental", "AWST": "Hora estàndard d’Austràlia Occidental", "BNT": "Hora de Brunei Darussalam", "BOT": "Hora de Bolívia", "BRST": "Hora d’estiu de Brasília", "BRT": "Hora estàndard de Brasília", "BST": "Hora d’estiu de Bangladesh", "BTT": "Hora de Bhutan", "CAT": "Hora de l’Àfrica Central", "CCT": "Hora de les illes Cocos", "CDT": "Hora d’estiu central d’Amèrica del Nord", "CDT (Kuba)": "Hora d’estiu de Cuba", "CHADT": "Hora d’estiu de Chatham", "CHAST": "Hora estàndard de Chatham", "CLST": "Hora d’estiu de Xile", "CLT": "Hora estàndard de Xile", "COST": "Hora d’estiu de Colòmbia", "COT": "Hora estàndard de Colòmbia", "CST": "Hora estàndard central d’Amèrica del Nord", "CST (Kuba)": "Hora estàndard de Cuba", "CXT": "Hora de Kiritimati", "ChST": "Hora estàndard de Chamorro", "EASST": "Hora d’estiu de l’illa de Pasqua", "EAST": "Hora estàndard de l’illa de Pasqua", "EAT": "Hora de l’Àfrica Oriental", "ECT": "Hora de l’Equador", "EDT": "Hora d’estiu oriental d’Amèrica del Nord", "EGDT": "Hora d’estiu de l’Est de Groenlàndia", "EGST": "Hora estàndard de l’Est de Groenlàndia", "EST": "Hora estàndard oriental d’Amèrica del Nord", "FKST": "Hora d’estiu de les illes Malvines", "GALT": "Hora de Galápagos", "GFT": "Hora de la Guaiana Francesa", "GMT": "Hora del Meridià de Greenwich", "GST": "Hora estàndard del Golf", "GYT": "Hora de Guyana", "HADT": "Hora d’estiu de Hawaii-Aleutianes", "HAST": "Hora estàndard de Hawaii-Aleutianes", "HENOMX": "Hora d’estiu del nord-oest de Mèxic", "HEOG": "Hora d’estiu de l’Oest de Groenlàndia", "HEPMX": "Hora d’estiu del Pacífic de Mèxic", "HKST": "Hora d’estiu de Hong Kong", "HKT": "Hora estàndard de Hong Kong", "HNNOMX": "Hora estàndard del nord-oest de Mèxic", "HNOG": "Hora estàndard de l’Oest de Groenlàndia", "HNPMX": "Hora estàndard del Pacífic de Mèxic", "ICT": "Hora de l’Indoxina", "IRDT": "Hora d’estiu de l’Iran", "IRST": "Hora estàndard de l’Iran", "IST": "Hora de l’Índia", "JDT": "Hora d’estiu del Japó", "JST": "Hora estàndard del Japó", "LHDT": "Horari d’estiu de Lord Howe", "LHST": "Hora estàndard de Lord Howe", "MDT": "Hora d’estiu de Macau", "MESZ": "Hora d’estiu del Centre d’Europa", "MEZ": "Hora estàndard del Centre d’Europa", "MST": "Hora estàndard de Macau", "MVT": "Hora de les Maldives", "MYT": "Hora de Malàisia", "NDT": "Hora d’estiu de Terranova", "NPT": "Hora del Nepal", "NST": "Hora estàndard de Terranova", "NZDT": "Hora d’estiu de Nova Zelanda", "NZST": "Hora estàndard de Nova Zelanda", "OESZ": "Hora d’estiu de l’Est d’Europa", "OEZ": "Hora estàndard de l’Est d’Europa", "PDT": "Hora d’estiu del Pacífic d’Amèrica del Nord", "PKT": "Hora d’estiu del Pakistan", "PMDT": "Hora d’estiu de Saint-Pierre-et-Miquelon", "PMST": "Hora estàndard de Saint-Pierre-et-Miquelon", "PST": "Hora estàndard del Pacífic d’Amèrica del Nord", "PYST": "Hora d’estiu del Paraguai", "SAST": "Hora estàndard del sud de l’Àfrica", "SGT": "Hora de Singapur", "SRT": "Hora de Surinam", "TLT": "Hora de Timor Oriental", "TMST": "Hora d’estiu del Turkmenistan", "TMT": "Hora estàndard del Turkmenistan", "UYST": "Hora d’estiu de l’Uruguai", "UYT": "Hora estàndard de l’Uruguai", "VET": "Hora de Veneçuela", "WARST": "Hora d’estiu de l’oest de l’Argentina", "WART": "Hora estàndard de l’oest de l’Argentina", "WAST": "Hora d’estiu de l’Àfrica Occidental", "WAT": "Hora estàndard de l’Àfrica Occidental", "WESZ": "Hora d’estiu de l’Oest d’Europa", "WEZ": "Hora estàndard de l’Oest d’Europa", "WIB": "Hora de l’oest d’Indonèsia", "WIT": "Hora de l’est d’Indonèsia", "WITA": "Hora central d’Indonèsia", "∅∅∅": "Hora d’estiu del Perú"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} i {1}", "{0}, {1}", "{0}, {1}", "{0} i {1}"}, {"{0} o {1}", "{0}, {1}", "{0}, {1}", "{0} o {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s.", "%v s.", "%v s.", ""},
				Long:   &locales.CounterFormat{"segles", "%v segle", "%v segles", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dèc.", "%v dèc.", "%v dèc.", ""},
				Long:   &locales.CounterFormat{"dècades", "%v dècada", "%v dècades", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"anys", "%v any", "%v anys", "%v/any"},
				Long:   &locales.CounterFormat{"anys", "%v any", "%v anys", "%v per any"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mes", "%v m", "%v m", ""},
				Long:   &locales.CounterFormat{"mesos", "%v mes", "%v mesos", "%v per mes"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"setm.", "%v setm.", "%v setm.", "%v/setm."},
				Long:   &locales.CounterFormat{"setmanes", "%v setmana", "%v setmanes", "%v per setmana"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dia", "%v d", "%v d", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"h", "%v h", "%v h", ""},
				Long:   &locales.CounterFormat{"hores", "%v hora", "%v hores", "%v per hora"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%v min", "%v min", ""},
				Long:   &locales.CounterFormat{"minuts", "%v minut", "%v minuts", "%v per minut"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%v s", "%v s", ""},
				Long:   &locales.CounterFormat{"segons", "%v segon", "%v segons", "%v per segon"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"mil·lisegons", "%v mil·lisegon", "%v mil·lisegons", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"microsegons", "%v microsegon", "%v microsegons", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosegons", "%v nanosegon", "%v nanosegons", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"≥ %[1]v",
...
func (ca *ca) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ca, ca.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ca'
func (ca *ca) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ca, ca.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ca'
func (ca *ca) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ca, ca.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ca'
func (ca *ca) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ca, ca.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ca'
func (ca *ca) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ca, ca.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ca'
func (ca *ca) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ca, ca.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ca'
func (ca *ca) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ca, ca.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ca'
func (ca *ca) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ca, ca.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ca'
func (ca *ca) DateFullLayout() string {
	return ca.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ca'
func (ca *ca) DateLongLayout() string {
	return ca.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ca'
func (ca *ca) DateMediumLayout() string {
	return ca.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ca'
func (ca *ca) DateShortLayout() string {
	return ca.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ca'
func (ca *ca) TimeFullLayout() string {
	return ca.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ca'
func (ca *ca) TimeLongLayout() string {
	return ca.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ca'
func (ca *ca) TimeMediumLayout() string {
	return ca.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ca'
func (ca *ca) TimeShortLayout() string {
	return ca.timeShortLayout
}

func (ca *ca) ListPatterns() *locales.ListPatterns {
	return ca.listPatterns
}

func (ca *ca) GetDurationSpec() *locales.DurationSpec {
	return ca.DurationSpec
}

func (ca *ca) GetMiscPatterns() *locales.MiscPatterns {
	return &ca.miscPatterns
}
