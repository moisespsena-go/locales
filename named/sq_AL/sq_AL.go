...
// DateFullLayout returns the full date layout for 'sq_AL'
func (sq *sq_AL) DateFullLayout() string {
	return sq.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sq_AL'
func (sq *sq_AL) DateLongLayout() string {
	return sq.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sq_AL'
func (sq *sq_AL) DateMediumLayout() string {
	return sq.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sq_AL'
func (sq *sq_AL) DateShortLayout() string {
	return sq.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sq_AL'
func (sq *sq_AL) TimeFullLayout() string {
	return sq.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sq_AL'
func (sq *sq_AL) TimeLongLayout() string {
	return sq.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sq_AL'
func (sq *sq_AL) TimeMediumLayout() string {
	return sq.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sq_AL'
func (sq *sq_AL) TimeShortLayout() string {
	return sq.timeShortLayout
}

func (sq *sq_AL) ListPatterns() *locales.ListPatterns {
	return sq.listPatterns
}

func (sq *sq_AL) GetDurationSpec() *locales.DurationSpec {
	return sq.DurationSpec
}

func (sq *sq_AL) GetMiscPatterns() *locales.MiscPatterns {
