...
func New() locales.Translator {
	return &luy_KE{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mar", "Apr", "Mei", "Jun", "Jul", "Ago", "Sep", "Okt", "Nov", "Des"},
			...
			WeekdaysAbbreviatedValue: []string{"J2", "J3", "J4", "J5", "Al", "Ij", "J1"},
			WeekdaysNarrowValue:      []string{"S", "M", "T", "W", "T", "F", "S"},
			WeekdaysWideValue:        []string{"Jumapiri", "Jumatatu", "Jumanne", "Jumatano", "Murwa wa Kanne", "Murwa wa Katano", "Jumamosi"},
			...
			ErasWideValue:            []string{"Imberi ya Kuuza Kwa", "Muhiga Kuvita Kuuza"},
...
func (luy *luy_KE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(luy, luy.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'luy_KE'
func (luy *luy_KE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(luy, luy.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'luy_KE'
func (luy *luy_KE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(luy, luy.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'luy_KE'
func (luy *luy_KE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(luy, luy.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'luy_KE'
func (luy *luy_KE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(luy, luy.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'luy_KE'
func (luy *luy_KE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(luy, luy.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'luy_KE'
func (luy *luy_KE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(luy, luy.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'luy_KE'
func (luy *luy_KE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(luy, luy.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'luy_KE'
func (luy *luy_KE) DateFullLayout() string {
	return luy.dateFullLayout
}

// DateLongLayout returns the long date layout for 'luy_KE'
func (luy *luy_KE) DateLongLayout() string {
	return luy.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'luy_KE'
func (luy *luy_KE) DateMediumLayout() string {
	return luy.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'luy_KE'
func (luy *luy_KE) DateShortLayout() string {
	return luy.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'luy_KE'
func (luy *luy_KE) TimeFullLayout() string {
	return luy.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'luy_KE'
func (luy *luy_KE) TimeLongLayout() string {
	return luy.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'luy_KE'
func (luy *luy_KE) TimeMediumLayout() string {
	return luy.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'luy_KE'
func (luy *luy_KE) TimeShortLayout() string {
	return luy.timeShortLayout
}

func (luy *luy_KE) ListPatterns() *locales.ListPatterns {
	return luy.listPatterns
}

func (luy *luy_KE) GetDurationSpec() *locales.DurationSpec {
	return luy.DurationSpec
}

func (luy *luy_KE) GetMiscPatterns() *locales.MiscPatterns {
	return &luy.miscPatterns
}
