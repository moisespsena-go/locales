...
func New() locales.Translator {
	return &shi_Tfng_MA{
		...
		TimeSpec: &locales.TimeSpec{
			...
			WeekdaysWideValue:        []string{"ⴰⵙⴰⵎⴰⵙ", "ⴰⵢⵏⴰⵙ", "ⴰⵙⵉⵏⴰⵙ", "ⴰⴽⵕⴰⵙ", "ⴰⴽⵡⴰⵙ", "ⵙⵉⵎⵡⴰⵙ", "ⴰⵙⵉⴹⵢⴰⵙ"},
...
func (shi *shi_Tfng_MA) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(shi, shi.dateShortLayout, t, 2)
}
...
func (shi *shi_Tfng_MA) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(shi, shi.timeShortLayout, t, 2)
}
...
func (shi *shi_Tfng_MA) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(shi, shi.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'shi_Tfng_MA'
func (shi *shi_Tfng_MA) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(shi, shi.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'shi_Tfng_MA'
func (shi *shi_Tfng_MA) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(shi, shi.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'shi_Tfng_MA'
func (shi *shi_Tfng_MA) DateFullLayout() string {
	return shi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'shi_Tfng_MA'
func (shi *shi_Tfng_MA) DateLongLayout() string {
	return shi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'shi_Tfng_MA'
func (shi *shi_Tfng_MA) DateMediumLayout() string {
	return shi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'shi_Tfng_MA'
func (shi *shi_Tfng_MA) DateShortLayout() string {
	return shi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'shi_Tfng_MA'
func (shi *shi_Tfng_MA) TimeFullLayout() string {
	return shi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'shi_Tfng_MA'
func (shi *shi_Tfng_MA) TimeLongLayout() string {
	return shi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'shi_Tfng_MA'
func (shi *shi_Tfng_MA) TimeMediumLayout() string {
	return shi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'shi_Tfng_MA'
func (shi *shi_Tfng_MA) TimeShortLayout() string {
	return shi.timeShortLayout
}

func (shi *shi_Tfng_MA) ListPatterns() *locales.ListPatterns {
	return shi.listPatterns
}

func (shi *shi_Tfng_MA) GetDurationSpec() *locales.DurationSpec {
	return shi.DurationSpec
}

func (shi *shi_Tfng_MA) GetMiscPatterns() *locales.MiscPatterns {
	return &shi.miscPatterns
}
