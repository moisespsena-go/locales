...
// DateFullLayout returns the full date layout for 'guz'
func (guz *guz) DateFullLayout() string {
	return guz.dateFullLayout
}

// DateLongLayout returns the long date layout for 'guz'
func (guz *guz) DateLongLayout() string {
	return guz.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'guz'
func (guz *guz) DateMediumLayout() string {
	return guz.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'guz'
func (guz *guz) DateShortLayout() string {
	return guz.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'guz'
func (guz *guz) TimeFullLayout() string {
	return guz.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'guz'
func (guz *guz) TimeLongLayout() string {
	return guz.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'guz'
func (guz *guz) TimeMediumLayout() string {
	return guz.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'guz'
func (guz *guz) TimeShortLayout() string {
	return guz.timeShortLayout
}

func (guz *guz) ListPatterns() *locales.ListPatterns {
	return guz.listPatterns
}

func (guz *guz) GetDurationSpec() *locales.DurationSpec {
	return guz.DurationSpec
}

func (guz *guz) GetMiscPatterns() *locales.MiscPatterns {
