...
// DateFullLayout returns the full date layout for 'ar_PS'
func (ar *ar_PS) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_PS'
func (ar *ar_PS) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_PS'
func (ar *ar_PS) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_PS'
func (ar *ar_PS) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_PS'
func (ar *ar_PS) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_PS'
func (ar *ar_PS) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_PS'
func (ar *ar_PS) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_PS'
func (ar *ar_PS) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_PS) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_PS) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_PS) GetMiscPatterns() *locales.MiscPatterns {
