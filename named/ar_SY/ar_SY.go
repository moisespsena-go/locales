...
// DateFullLayout returns the full date layout for 'ar_SY'
func (ar *ar_SY) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_SY'
func (ar *ar_SY) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_SY'
func (ar *ar_SY) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_SY'
func (ar *ar_SY) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_SY'
func (ar *ar_SY) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_SY'
func (ar *ar_SY) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_SY'
func (ar *ar_SY) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_SY'
func (ar *ar_SY) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_SY) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_SY) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_SY) GetMiscPatterns() *locales.MiscPatterns {
