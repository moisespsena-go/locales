...
// DateFullLayout returns the full date layout for 'es_PE'
func (es *es_PE) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_PE'
func (es *es_PE) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_PE'
func (es *es_PE) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_PE'
func (es *es_PE) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_PE'
func (es *es_PE) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_PE'
func (es *es_PE) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_PE'
func (es *es_PE) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_PE'
func (es *es_PE) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_PE) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_PE) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_PE) GetMiscPatterns() *locales.MiscPatterns {
