...
func New() locales.Translator {
	return &smn_FI{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ".",
			MonthsAbbreviatedValue:   []string{"", "uđiv", "kuovâ", "njuhčâ", "cuáŋui", "vyesi", "kesi", "syeini", "porge", "čohčâ", "roovvâd", "skammâ", "juovlâ"},
			MonthsNarrowValue:        []string{"", "U", "K", "NJ", "C", "V", "K", "S", "P", "Č", "R", "S", "J"},
			MonthsWideValue:          []string{"", "uđđâivemáánu", "kuovâmáánu", "njuhčâmáánu", "cuáŋuimáánu", "vyesimáánu", "kesimáánu", "syeinimáánu", "porgemáánu", "čohčâmáánu", "roovvâdmáánu", "skammâmáánu", "juovlâmáánu"},
			WeekdaysAbbreviatedValue: []string{"pas", "vuo", "maj", "kos", "tuo", "vás", "láv"},
			WeekdaysNarrowValue:      []string{"p", "V", "M", "K", "T", "V", "L"},
			WeekdaysShortValue:       []string{"pa", "vu", "ma", "ko", "tu", "vá", "lá"},
			WeekdaysWideValue:        []string{"pasepeeivi", "vuossaargâ", "majebaargâ", "koskoho", "tuorâstuv", "vástuppeeivi", "lávurduv"},
			PeriodsAbbreviatedValue:  []string{"ip.", "ep."},
			PeriodsNarrowValue:       []string{"ip.", "ep."},
			PeriodsWideValue:         []string{"ip.", "ep."},
			ErasAbbreviatedValue:     []string{"oKr.", "mKr."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Ovdil Kristus šoddâm", "maŋa Kristus šoddâm"},
...
func (smn *smn_FI) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(smn, smn.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'smn_FI'
func (smn *smn_FI) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(smn, smn.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'smn_FI'
func (smn *smn_FI) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(smn, smn.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'smn_FI'
func (smn *smn_FI) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(smn, smn.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'smn_FI'
func (smn *smn_FI) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(smn, smn.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'smn_FI'
func (smn *smn_FI) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(smn, smn.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'smn_FI'
func (smn *smn_FI) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(smn, smn.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'smn_FI'
func (smn *smn_FI) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(smn, smn.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'smn_FI'
func (smn *smn_FI) DateFullLayout() string {
	return smn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'smn_FI'
func (smn *smn_FI) DateLongLayout() string {
	return smn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'smn_FI'
func (smn *smn_FI) DateMediumLayout() string {
	return smn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'smn_FI'
func (smn *smn_FI) DateShortLayout() string {
	return smn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'smn_FI'
func (smn *smn_FI) TimeFullLayout() string {
	return smn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'smn_FI'
func (smn *smn_FI) TimeLongLayout() string {
	return smn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'smn_FI'
func (smn *smn_FI) TimeMediumLayout() string {
	return smn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'smn_FI'
func (smn *smn_FI) TimeShortLayout() string {
	return smn.timeShortLayout
}

func (smn *smn_FI) ListPatterns() *locales.ListPatterns {
	return smn.listPatterns
}

func (smn *smn_FI) GetDurationSpec() *locales.DurationSpec {
	return smn.DurationSpec
}

func (smn *smn_FI) GetMiscPatterns() *locales.MiscPatterns {
	return &smn.miscPatterns
}
