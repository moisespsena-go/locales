...
// DateFullLayout returns the full date layout for 'my'
func (my *my) DateFullLayout() string {
	return my.dateFullLayout
}

// DateLongLayout returns the long date layout for 'my'
func (my *my) DateLongLayout() string {
	return my.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'my'
func (my *my) DateMediumLayout() string {
	return my.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'my'
func (my *my) DateShortLayout() string {
	return my.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'my'
func (my *my) TimeFullLayout() string {
	return my.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'my'
func (my *my) TimeLongLayout() string {
	return my.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'my'
func (my *my) TimeMediumLayout() string {
	return my.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'my'
func (my *my) TimeShortLayout() string {
	return my.timeShortLayout
}

func (my *my) ListPatterns() *locales.ListPatterns {
	return my.listPatterns
}

func (my *my) GetDurationSpec() *locales.DurationSpec {
	return my.DurationSpec
}

func (my *my) GetMiscPatterns() *locales.MiscPatterns {
