...
// DateFullLayout returns the full date layout for 'mas'
func (mas *mas) DateFullLayout() string {
	return mas.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mas'
func (mas *mas) DateLongLayout() string {
	return mas.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mas'
func (mas *mas) DateMediumLayout() string {
	return mas.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mas'
func (mas *mas) DateShortLayout() string {
	return mas.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mas'
func (mas *mas) TimeFullLayout() string {
	return mas.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mas'
func (mas *mas) TimeLongLayout() string {
	return mas.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mas'
func (mas *mas) TimeMediumLayout() string {
	return mas.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mas'
func (mas *mas) TimeShortLayout() string {
	return mas.timeShortLayout
}

func (mas *mas) ListPatterns() *locales.ListPatterns {
	return mas.listPatterns
}

func (mas *mas) GetDurationSpec() *locales.DurationSpec {
	return mas.DurationSpec
}

func (mas *mas) GetMiscPatterns() *locales.MiscPatterns {
