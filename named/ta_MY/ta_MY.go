...
// DateFullLayout returns the full date layout for 'ta_MY'
func (ta *ta_MY) DateFullLayout() string {
	return ta.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ta_MY'
func (ta *ta_MY) DateLongLayout() string {
	return ta.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ta_MY'
func (ta *ta_MY) DateMediumLayout() string {
	return ta.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ta_MY'
func (ta *ta_MY) DateShortLayout() string {
	return ta.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ta_MY'
func (ta *ta_MY) TimeFullLayout() string {
	return ta.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ta_MY'
func (ta *ta_MY) TimeLongLayout() string {
	return ta.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ta_MY'
func (ta *ta_MY) TimeMediumLayout() string {
	return ta.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ta_MY'
func (ta *ta_MY) TimeShortLayout() string {
	return ta.timeShortLayout
}

func (ta *ta_MY) ListPatterns() *locales.ListPatterns {
	return ta.listPatterns
}

func (ta *ta_MY) GetDurationSpec() *locales.DurationSpec {
	return ta.DurationSpec
}

func (ta *ta_MY) GetMiscPatterns() *locales.MiscPatterns {
