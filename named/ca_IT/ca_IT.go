...
// DateFullLayout returns the full date layout for 'ca_IT'
func (ca *ca_IT) DateFullLayout() string {
	return ca.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ca_IT'
func (ca *ca_IT) DateLongLayout() string {
	return ca.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ca_IT'
func (ca *ca_IT) DateMediumLayout() string {
	return ca.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ca_IT'
func (ca *ca_IT) DateShortLayout() string {
	return ca.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ca_IT'
func (ca *ca_IT) TimeFullLayout() string {
	return ca.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ca_IT'
func (ca *ca_IT) TimeLongLayout() string {
	return ca.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ca_IT'
func (ca *ca_IT) TimeMediumLayout() string {
	return ca.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ca_IT'
func (ca *ca_IT) TimeShortLayout() string {
	return ca.timeShortLayout
}

func (ca *ca_IT) ListPatterns() *locales.ListPatterns {
	return ca.listPatterns
}

func (ca *ca_IT) GetDurationSpec() *locales.DurationSpec {
	return ca.DurationSpec
}

func (ca *ca_IT) GetMiscPatterns() *locales.MiscPatterns {
