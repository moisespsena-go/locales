...
// DateFullLayout returns the full date layout for 'en_IE'
func (en *en_IE) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_IE'
func (en *en_IE) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_IE'
func (en *en_IE) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_IE'
func (en *en_IE) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_IE'
func (en *en_IE) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_IE'
func (en *en_IE) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_IE'
func (en *en_IE) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_IE'
func (en *en_IE) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_IE) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_IE) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_IE) GetMiscPatterns() *locales.MiscPatterns {
