...
func New() locales.Translator {
	return &gsw{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 Tsg'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 Tsg'.' ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 Tsg'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 Tsg'.' ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 Tsg'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 Tsg'.' ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mär", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Januar", "Februar", "März", "April", "Mai", "Juni", "Juli", "Auguscht", "Septämber", "Oktoober", "Novämber", "Dezämber"},
			WeekdaysAbbreviatedValue: []string{"Su.", "Mä.", "Zi.", "Mi.", "Du.", "Fr.", "Sa."},
			WeekdaysNarrowValue:      []string{"S", "M", "D", "M", "D", "F", "S"},
			WeekdaysWideValue:        []string{"Sunntig", "Määntig", "Ziischtig", "Mittwuch", "Dunschtig", "Friitig", "Samschtig"},
			PeriodsAbbreviatedValue:  []string{"vorm.", "nam."},
			PeriodsWideValue:         []string{"am Vormittag", "am Namittag"},
			ErasAbbreviatedValue:     []string{"v. Chr.", "n. Chr."},
			ErasNarrowValue:          []string{"v. Chr.", "n. Chr."},
			ErasWideValue:            []string{"v. Chr.", "n. Chr."},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "Acre-Summerziit", "ACT": "Acre-Schtandardziit", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "ADT", "AEDT": "AEDT", "AEST": "AEST", "AFT": "Afghanischtan-Ziit", "AKDT": "Alaska-Summerziit", "AKST": "Alaska-Schtandardziit", "AMST": "Amazonas-Summerziit", "AMT": "Amazonas-Schtandardziit", "ARST": "ARST", "ART": "ART", "AST": "AST", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "Zentralafrikanischi Ziit", "CCT": "CCT", "CDT": "Amerika-Zentraal Summerziit", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "Amerika-Zentraal Schtandardziit", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "Oschtafrikanischi Ziit", "ECT": "ECT", "EDT": "EDT", "EGDT": "EGDT", "EGST": "EGST", "EST": "EST", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "GMT", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "Mitteleuropäischi Summerziit", "MEZ": "Mitteleuropäischi Schtandardziit", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "Oschteuropäischi Summerziit", "OEZ": "Oschteuropäischi Schtandardziit", "PDT": "PDT", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "PST", "PYST": "PYST", "SAST": "Süüdafrikanischi ziit", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "Weschtafrikanischi Summerziit", "WAT": "Weschtafrikanischi Schtandardziit", "WESZ": "Weschteuropäischi Summerziit", "WEZ": "Weschteuropäischi Schtandardziit", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} und {1}", "{0}, {1}", "{0}, {1}", "{0} und {1}"}, []string(nil)}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"Jahr", "%v Jahr", "%v Jahr", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"Mönet", "%v Monet", "%v Mönet", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"Wuche", "%v Wuche", "%v Wuche", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"Schtunde", "%v Schtund", "%v Schtunde", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vm", "%vm", ""},
				Long:   &locales.CounterFormat{"Minuute", "%v Minuute", "%v Minuute", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vs", "%vs", ""},
				Long:   &locales.CounterFormat{"Sekunde", "%v Sekunde", "%v Sekunde", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"Millisekunde", "%v Millisekunde", "%v Millisekunde", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
		miscPatterns: locales.MiscPatterns{
...
func (gsw *gsw) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(gsw, gsw.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'gsw'
func (gsw *gsw) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(gsw, gsw.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'gsw'
func (gsw *gsw) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(gsw, gsw.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'gsw'
func (gsw *gsw) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(gsw, gsw.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'gsw'
func (gsw *gsw) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(gsw, gsw.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'gsw'
func (gsw *gsw) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(gsw, gsw.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'gsw'
func (gsw *gsw) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(gsw, gsw.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'gsw'
func (gsw *gsw) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(gsw, gsw.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'gsw'
func (gsw *gsw) DateFullLayout() string {
	return gsw.dateFullLayout
}

// DateLongLayout returns the long date layout for 'gsw'
func (gsw *gsw) DateLongLayout() string {
	return gsw.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'gsw'
func (gsw *gsw) DateMediumLayout() string {
	return gsw.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'gsw'
func (gsw *gsw) DateShortLayout() string {
	return gsw.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'gsw'
func (gsw *gsw) TimeFullLayout() string {
	return gsw.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'gsw'
func (gsw *gsw) TimeLongLayout() string {
	return gsw.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'gsw'
func (gsw *gsw) TimeMediumLayout() string {
	return gsw.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'gsw'
func (gsw *gsw) TimeShortLayout() string {
	return gsw.timeShortLayout
}

func (gsw *gsw) ListPatterns() *locales.ListPatterns {
	return gsw.listPatterns
}

func (gsw *gsw) GetDurationSpec() *locales.DurationSpec {
	return gsw.DurationSpec
}

func (gsw *gsw) GetMiscPatterns() *locales.MiscPatterns {
	return &gsw.miscPatterns
}
