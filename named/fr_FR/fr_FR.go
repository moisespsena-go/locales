...
// DateFullLayout returns the full date layout for 'fr_FR'
func (fr *fr_FR) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_FR'
func (fr *fr_FR) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_FR'
func (fr *fr_FR) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_FR'
func (fr *fr_FR) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_FR'
func (fr *fr_FR) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_FR'
func (fr *fr_FR) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_FR'
func (fr *fr_FR) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_FR'
func (fr *fr_FR) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_FR) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_FR) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_FR) GetMiscPatterns() *locales.MiscPatterns {
