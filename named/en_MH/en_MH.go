...
// DateFullLayout returns the full date layout for 'en_MH'
func (en *en_MH) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_MH'
func (en *en_MH) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_MH'
func (en *en_MH) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_MH'
func (en *en_MH) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_MH'
func (en *en_MH) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_MH'
func (en *en_MH) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_MH'
func (en *en_MH) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_MH'
func (en *en_MH) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_MH) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_MH) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_MH) GetMiscPatterns() *locales.MiscPatterns {
