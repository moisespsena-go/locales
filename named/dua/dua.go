...
// DateFullLayout returns the full date layout for 'dua'
func (dua *dua) DateFullLayout() string {
	return dua.dateFullLayout
}

// DateLongLayout returns the long date layout for 'dua'
func (dua *dua) DateLongLayout() string {
	return dua.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'dua'
func (dua *dua) DateMediumLayout() string {
	return dua.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'dua'
func (dua *dua) DateShortLayout() string {
	return dua.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'dua'
func (dua *dua) TimeFullLayout() string {
	return dua.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'dua'
func (dua *dua) TimeLongLayout() string {
	return dua.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'dua'
func (dua *dua) TimeMediumLayout() string {
	return dua.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'dua'
func (dua *dua) TimeShortLayout() string {
	return dua.timeShortLayout
}

func (dua *dua) ListPatterns() *locales.ListPatterns {
	return dua.listPatterns
}

func (dua *dua) GetDurationSpec() *locales.DurationSpec {
	return dua.DurationSpec
}

func (dua *dua) GetMiscPatterns() *locales.MiscPatterns {
