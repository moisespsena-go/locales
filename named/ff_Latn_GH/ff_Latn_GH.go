...
// DateFullLayout returns the full date layout for 'ff_Latn_GH'
func (ff *ff_Latn_GH) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff_Latn_GH'
func (ff *ff_Latn_GH) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff_Latn_GH'
func (ff *ff_Latn_GH) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff_Latn_GH'
func (ff *ff_Latn_GH) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff_Latn_GH'
func (ff *ff_Latn_GH) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff_Latn_GH'
func (ff *ff_Latn_GH) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff_Latn_GH'
func (ff *ff_Latn_GH) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff_Latn_GH'
func (ff *ff_Latn_GH) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff_Latn_GH) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff_Latn_GH) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff_Latn_GH) GetMiscPatterns() *locales.MiscPatterns {
