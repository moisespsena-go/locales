...
func New() locales.Translator {
	return &fr_CA{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						...
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 G¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 G¤"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 G¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 G¤"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 G¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 G¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "janv.", "févr.", "mars", "avr.", "mai", "juin", "juill.", "août", "sept.", "oct.", "nov.", "déc."},
			...
			ErasWideValue:            []string{"avant l’ère chrétienne", "de l’ère chrétienne"},
			TimezonesValue:           map[string]string{"": "heure normale du Paraguay", "ACDT": "heure avancée du centre de l’Australie", "ACST": "heure normale du centre de l’Australie", "ACT": "heure normale de l’Acre", "ACWDT": "heure avancée du centre-ouest de l’Australie", "ACWST": "heure normale du centre-ouest de l’Australie", "ADT": "heure avancée de l’Atlantique", "AEDT": "heure avancée de l’Est de l’Australie", "AEST": "heure normale de l’Est de l’Australie", "AFT": "heure de l’Afghanistan", "AKDT": "heure avancée de l’Alaska", "AKST": "heure normale de l’Alaska", "AMST": "heure avancée de l’Amazonie", "AMT": "heure normale de l’Amazonie", "ARST": "heure avancée de l’Argentine", "ART": "heure normale d’Argentine", "AST": "heure normale de l’Atlantique", "AWDT": "heure avancée de l’Ouest de l’Australie", "AWST": "heure normale de l’Ouest de l’Australie", "BNT": "heure du Brunéi", "BOT": "heure de Bolivie", "BRST": "heure avancée de Brasilia", "BRT": "heure normale de Brasilia", "BST": "heure avancée du Bangladesh", "BTT": "heure du Bhoutan", "CAT": "heure d’Afrique centrale", "CCT": "heure des îles Cocos", "CDT": "heure avancée du Centre", "CDT (Kuba)": "heure avancée de Cuba", "CHADT": "heure d’été des îles Chatham", "CHAST": "heure normale des îles Chatham", "CLST": "heure avancée du Chili", "CLT": "heure normale du Chili", "COST": "heure avancée de Colombie", "COT": "heure normale de Colombie", "CST": "heure normale du Centre", "CST (Kuba)": "heure normale de Cuba", "CXT": "heure de l’île Christmas", "ChST": "heure des Chamorro", "EASST": "heure avancée de l’île de Pâques", "EAST": "heure normale de l’île de Pâques", "EAT": "heure d’Afrique orientale", "ECT": "heure de l’Équateur", "EDT": "heure avancée de l’Est", "EGDT": "heure avancée de l’Est du Groenland", "EGST": "heure normale de l’Est du Groenland", "EST": "heure normale de l’Est", "FKST": "heure avancée des îles Malouines", "GALT": "heure des îles Galápagos", "GFT": "heure de Guyane française", "GMT": "heure moyenne de Greenwich", "GST": "heure du Golfe", "GYT": "heure du Guyana", "HADT": "heure avancée d’Hawaï-Aléoutiennes", "HAST": "heure normale d’Hawaï-Aléoutiennes", "HENOMX": "heure avancée du Nord-Ouest du Mexique", "HEOG": "heure avancée de l’Ouest du Groenland", "HEPMX": "heure avancée du Pacifique mexicain", "HKST": "heure avancée de Hong Kong", "HKT": "heure normale de Hong Kong", "HNNOMX": "heure normale du Nord-Ouest du Mexique", "HNOG": "heure normale de l’Ouest du Groenland", "HNPMX": "heure normale du Pacifique mexicain", "ICT": "heure d’Indochine", "IRDT": "heure avancée d’Iran", "IRST": "heure normale d’Iran", "IST": "heure de l’Inde", "JDT": "heure avancée du Japon", "JST": "heure normale du Japon", "LHDT": "heure avancée de Lord Howe", "LHST": "heure normale de Lord Howe", "MDT": "heure avancée des Rocheuses", "MESZ": "heure avancée de l’Europe centrale", "MEZ": "heure normale de l’Europe centrale", "MST": "heure normale des Rocheuses", "MVT": "heure des Maldives", "MYT": "heure de la Malaisie", "NDT": "heure avancée de Terre-Neuve", "NPT": "heure du Népal", "NST": "heure normale de Terre-Neuve", "NZDT": "heure avancée de la Nouvelle-Zélande", "NZST": "heure normale de la Nouvelle-Zélande", "OESZ": "heure avancée de l’Europe de l’Est", "OEZ": "heure normale de l’Europe de l’Est", "PDT": "heure avancée du Pacifique", "PKT": "heure avancée du Pakistan", "PMDT": "heure avancée de Saint-Pierre-et-Miquelon", "PMST": "heure normale de Saint-Pierre-et-Miquelon", "PST": "heure normale du Pacifique", "PYST": "heure avancée du Paraguay", "SAST": "heure normale d’Afrique du Sud", "SGT": "heure de Singapour", "SRT": "heure du Suriname", "TLT": "heure du Timor oriental", "TMST": "heure avancée du Turkménistan", "TMT": "heure normale du Turkménistan", "UYST": "heure avancée de l’Uruguay", "UYT": "heure normale de l’Uruguay", "VET": "heure du Venezuela", "WARST": "heure avancée de l’Ouest argentin", "WART": "heure normale de l’Ouest argentin", "WAST": "heure avancée d’Afrique de l’Ouest", "WAT": "heure normale d’Afrique de l’Ouest", "WESZ": "heure avancée de l’Europe de l’Ouest", "WEZ": "heure normale de l’Europe de l’Ouest", "WIB": "heure de l’Ouest indonésien", "WIT": "heure de l’Est indonésien", "WITA": "heure du Centre indonésien", "∅∅∅": "heure avancée du Pérou"},
		},
		...
		timeFullLayout:   "HH 'h' mm 'min' ss 's' zzzz",
		timeLongLayout:   "HH 'h' mm 'min' ss 's' z",
		timeMediumLayout: "HH 'h' mm 'min' ss 's'",
		timeShortLayout:  "HH 'h' mm",
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"", "´%vs.", "´%vs.", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"déc", "%vdéc", "%vdéc", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v an", "%v ans", ""},
				Long:   &locales.CounterFormat{"", "%v an", "%v ans", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vm", "%vm", "%v/m"},
				Long:   &locales.CounterFormat{"", "%v mois", "%v mois", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sem", "%vsem", "%vsem", "%v/sem"},
				Long:   &locales.CounterFormat{"", "%v semaine", "%v semaines", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v j", "%v j", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v h", "%v h", ""},
				Long:   &locales.CounterFormat{"", "%v heure", "%v heures", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vm", "%vm", "%v/m"},
				Long:   &locales.CounterFormat{"", "%v min", "%v min", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v s", "%v s", ""},
				Long:   &locales.CounterFormat{"", "%v seconde", "%v secondes", "%v à la seconde"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"", "%v milliseconde", "%v millisecondes", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"", "%v microseconde", "%v microsecondes", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"", "%v nanoseconde", "%v nanosecondes", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"≈%[1]v",
			"≥%[1]v",
...
// DateFullLayout returns the full date layout for 'fr_CA'
func (fr *fr_CA) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_CA'
func (fr *fr_CA) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_CA'
func (fr *fr_CA) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_CA'
func (fr *fr_CA) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_CA'
func (fr *fr_CA) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_CA'
func (fr *fr_CA) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_CA'
func (fr *fr_CA) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_CA'
func (fr *fr_CA) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_CA) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_CA) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_CA) GetMiscPatterns() *locales.MiscPatterns {
