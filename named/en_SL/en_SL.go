...
// DateFullLayout returns the full date layout for 'en_SL'
func (en *en_SL) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_SL'
func (en *en_SL) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_SL'
func (en *en_SL) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_SL'
func (en *en_SL) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_SL'
func (en *en_SL) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_SL'
func (en *en_SL) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_SL'
func (en *en_SL) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_SL'
func (en *en_SL) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_SL) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_SL) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_SL) GetMiscPatterns() *locales.MiscPatterns {
