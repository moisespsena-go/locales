...
// DateFullLayout returns the full date layout for 'fr_TD'
func (fr *fr_TD) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_TD'
func (fr *fr_TD) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_TD'
func (fr *fr_TD) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_TD'
func (fr *fr_TD) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_TD'
func (fr *fr_TD) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_TD'
func (fr *fr_TD) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_TD'
func (fr *fr_TD) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_TD'
func (fr *fr_TD) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_TD) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_TD) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_TD) GetMiscPatterns() *locales.MiscPatterns {
