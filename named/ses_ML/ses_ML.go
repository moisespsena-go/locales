...
func New() locales.Translator {
	return &ses_ML{
		...
		TimeSpec: &locales.TimeSpec{
			...
			PeriodsAbbreviatedValue:  []string{"Adduha", "Aluula"},
			PeriodsWideValue:         []string{"Adduha", "Aluula"},
...
func (ses *ses_ML) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ses, ses.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ses_ML'
func (ses *ses_ML) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ses, ses.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ses_ML'
func (ses *ses_ML) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ses, ses.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ses_ML'
func (ses *ses_ML) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ses, ses.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ses_ML'
func (ses *ses_ML) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ses, ses.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ses_ML'
func (ses *ses_ML) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ses, ses.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ses_ML'
func (ses *ses_ML) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ses, ses.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ses_ML'
func (ses *ses_ML) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ses, ses.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ses_ML'
func (ses *ses_ML) DateFullLayout() string {
	return ses.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ses_ML'
func (ses *ses_ML) DateLongLayout() string {
	return ses.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ses_ML'
func (ses *ses_ML) DateMediumLayout() string {
	return ses.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ses_ML'
func (ses *ses_ML) DateShortLayout() string {
	return ses.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ses_ML'
func (ses *ses_ML) TimeFullLayout() string {
	return ses.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ses_ML'
func (ses *ses_ML) TimeLongLayout() string {
	return ses.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ses_ML'
func (ses *ses_ML) TimeMediumLayout() string {
	return ses.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ses_ML'
func (ses *ses_ML) TimeShortLayout() string {
	return ses.timeShortLayout
}

func (ses *ses_ML) ListPatterns() *locales.ListPatterns {
	return ses.listPatterns
}

func (ses *ses_ML) GetDurationSpec() *locales.DurationSpec {
	return ses.DurationSpec
}

func (ses *ses_ML) GetMiscPatterns() *locales.MiscPatterns {
	return &ses.miscPatterns
}
