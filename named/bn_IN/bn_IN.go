...
// DateFullLayout returns the full date layout for 'bn_IN'
func (bn *bn_IN) DateFullLayout() string {
	return bn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bn_IN'
func (bn *bn_IN) DateLongLayout() string {
	return bn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bn_IN'
func (bn *bn_IN) DateMediumLayout() string {
	return bn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bn_IN'
func (bn *bn_IN) DateShortLayout() string {
	return bn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bn_IN'
func (bn *bn_IN) TimeFullLayout() string {
	return bn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bn_IN'
func (bn *bn_IN) TimeLongLayout() string {
	return bn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bn_IN'
func (bn *bn_IN) TimeMediumLayout() string {
	return bn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bn_IN'
func (bn *bn_IN) TimeShortLayout() string {
	return bn.timeShortLayout
}

func (bn *bn_IN) ListPatterns() *locales.ListPatterns {
	return bn.listPatterns
}

func (bn *bn_IN) GetDurationSpec() *locales.DurationSpec {
	return bn.DurationSpec
}

func (bn *bn_IN) GetMiscPatterns() *locales.MiscPatterns {
