...
// DateFullLayout returns the full date layout for 'fr_GF'
func (fr *fr_GF) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_GF'
func (fr *fr_GF) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_GF'
func (fr *fr_GF) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_GF'
func (fr *fr_GF) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_GF'
func (fr *fr_GF) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_GF'
func (fr *fr_GF) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_GF'
func (fr *fr_GF) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_GF'
func (fr *fr_GF) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_GF) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_GF) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_GF) GetMiscPatterns() *locales.MiscPatterns {
