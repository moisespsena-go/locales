...
// DateFullLayout returns the full date layout for 'fr_GN'
func (fr *fr_GN) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_GN'
func (fr *fr_GN) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_GN'
func (fr *fr_GN) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_GN'
func (fr *fr_GN) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_GN'
func (fr *fr_GN) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_GN'
func (fr *fr_GN) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_GN'
func (fr *fr_GN) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_GN'
func (fr *fr_GN) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_GN) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_GN) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_GN) GetMiscPatterns() *locales.MiscPatterns {
