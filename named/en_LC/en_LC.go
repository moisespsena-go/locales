...
// DateFullLayout returns the full date layout for 'en_LC'
func (en *en_LC) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_LC'
func (en *en_LC) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_LC'
func (en *en_LC) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_LC'
func (en *en_LC) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_LC'
func (en *en_LC) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_LC'
func (en *en_LC) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_LC'
func (en *en_LC) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_LC'
func (en *en_LC) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_LC) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_LC) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_LC) GetMiscPatterns() *locales.MiscPatterns {
