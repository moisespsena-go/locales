...
// DateFullLayout returns the full date layout for 'es_EC'
func (es *es_EC) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_EC'
func (es *es_EC) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_EC'
func (es *es_EC) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_EC'
func (es *es_EC) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_EC'
func (es *es_EC) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_EC'
func (es *es_EC) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_EC'
func (es *es_EC) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_EC'
func (es *es_EC) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_EC) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_EC) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_EC) GetMiscPatterns() *locales.MiscPatterns {
