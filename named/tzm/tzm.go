...
// DateFullLayout returns the full date layout for 'tzm'
func (tzm *tzm) DateFullLayout() string {
	return tzm.dateFullLayout
}

// DateLongLayout returns the long date layout for 'tzm'
func (tzm *tzm) DateLongLayout() string {
	return tzm.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'tzm'
func (tzm *tzm) DateMediumLayout() string {
	return tzm.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'tzm'
func (tzm *tzm) DateShortLayout() string {
	return tzm.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'tzm'
func (tzm *tzm) TimeFullLayout() string {
	return tzm.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'tzm'
func (tzm *tzm) TimeLongLayout() string {
	return tzm.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'tzm'
func (tzm *tzm) TimeMediumLayout() string {
	return tzm.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'tzm'
func (tzm *tzm) TimeShortLayout() string {
	return tzm.timeShortLayout
}

func (tzm *tzm) ListPatterns() *locales.ListPatterns {
	return tzm.listPatterns
}

func (tzm *tzm) GetDurationSpec() *locales.DurationSpec {
	return tzm.DurationSpec
}

func (tzm *tzm) GetMiscPatterns() *locales.MiscPatterns {
