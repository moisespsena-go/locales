...
// DateFullLayout returns the full date layout for 'fr_GA'
func (fr *fr_GA) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_GA'
func (fr *fr_GA) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_GA'
func (fr *fr_GA) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_GA'
func (fr *fr_GA) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_GA'
func (fr *fr_GA) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_GA'
func (fr *fr_GA) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_GA'
func (fr *fr_GA) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_GA'
func (fr *fr_GA) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_GA) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_GA) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_GA) GetMiscPatterns() *locales.MiscPatterns {
