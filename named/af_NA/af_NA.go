...
// DateFullLayout returns the full date layout for 'af_NA'
func (af *af_NA) DateFullLayout() string {
	return af.dateFullLayout
}

// DateLongLayout returns the long date layout for 'af_NA'
func (af *af_NA) DateLongLayout() string {
	return af.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'af_NA'
func (af *af_NA) DateMediumLayout() string {
	return af.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'af_NA'
func (af *af_NA) DateShortLayout() string {
	return af.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'af_NA'
func (af *af_NA) TimeFullLayout() string {
	return af.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'af_NA'
func (af *af_NA) TimeLongLayout() string {
	return af.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'af_NA'
func (af *af_NA) TimeMediumLayout() string {
	return af.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'af_NA'
func (af *af_NA) TimeShortLayout() string {
	return af.timeShortLayout
}

func (af *af_NA) ListPatterns() *locales.ListPatterns {
	return af.listPatterns
}

func (af *af_NA) GetDurationSpec() *locales.DurationSpec {
	return af.DurationSpec
}

func (af *af_NA) GetMiscPatterns() *locales.MiscPatterns {
