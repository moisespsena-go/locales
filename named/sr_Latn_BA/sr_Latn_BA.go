...
func New() locales.Translator {
	return &sr_Latn_BA{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 хиљ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 хиљ'.' ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 хиљ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 хиљ'.' ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 хиљ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 хиљ'.' ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "јан", "феб", "мар", "апр", "мај", "јун", "јул", "авг", "сеп", "окт", "нов", "дец"},
			MonthsNarrowValue:        []string{"", "ј", "ф", "м", "а", "м", "ј", "ј", "а", "с", "о", "н", "д"},
			MonthsWideValue:          []string{"", "јануар", "фебруар", "март", "април", "мај", "јун", "јул", "август", "септембар", "октобар", "новембар", "децембар"},
			WeekdaysAbbreviatedValue: []string{"ned", "pon", "uto", "sri", "čet", "pet", "sub"},
			WeekdaysNarrowValue:      []string{"н", "п", "у", "с", "ч", "п", "с"},
			WeekdaysShortValue:       []string{"не", "по", "ут", "ср", "че", "пе", "су"},
			WeekdaysWideValue:        []string{"nedjelja", "ponedjeljak", "utorak", "srijeda", "četvrtak", "petak", "subota"},
			PeriodsAbbreviatedValue:  []string{"prije podne", "po podne"},
			PeriodsNarrowValue:       []string{"", ""},
			PeriodsWideValue:         []string{"prije podne", "po podne"},
			ErasAbbreviatedValue:     []string{"", ""},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"prije nove ere", "nove ere"},
			TimezonesValue:           map[string]string{"": "Folklandska Ostrva, standardno vrijeme", "ACDT": "Australijsko centralno ljetnje vrijeme", "ACST": "Australijsko centralno standardno vrijeme", "ACT": "Акре стандардно време", "ACWDT": "Australijsko centralno zapadno ljetnje vrijeme", "ACWST": "Australijsko centralno zapadno standardno vrijeme", "ADT": "Atlantsko ljetnje vrijeme", "AEDT": "Australijsko istočno ljetnje vrijeme", "AEST": "Australijsko istočno standardno vrijeme", "AFT": "Avganistan vrijeme", "AKDT": "Aljaska, ljetnje vrijeme", "AKST": "Aljaska, standardno vrijeme", "AMST": "Amazon, ljetnje vrijeme", "AMT": "Amazon, standardno vrijeme", "ARST": "Argentina, ljetnje vrijeme", "ART": "Argentina, standardno vrijeme", "AST": "Atlantsko standardno vrijeme", "AWDT": "Australijsko zapadno ljetnje vrijeme", "AWST": "Australijsko zapadno standardno vrijeme", "BNT": "Brunej Darusalum vrijeme", "BOT": "Bolivija vrijeme", "BRST": "Brazilija, ljetnje vrijeme", "BRT": "Brazilija, standardno vrijeme", "BST": "Bangladeš, ljetnje vrijeme", "BTT": "Butan vrijeme", "CAT": "Centralno-afričko vrijeme", "CCT": "Kokosova (Kiling) ostrva vrijeme", "CDT": "Sjevernoameričko centralno ljetnje vrijeme", "CDT (Kuba)": "Kuba, ljetnje vrijeme", "CHADT": "Čatam, ljetnje vrijeme", "CHAST": "Čatam, standardno vrijeme", "CLST": "Čile, ljetnje vrijeme", "CLT": "Čile, standardno vrijeme", "COST": "Kolumbija, ljetnje vrijeme", "COT": "Kolumbija, standardno vrijeme", "CST": "Sjevernoameričko centralno standardno vrijeme", "CST (Kuba)": "Kuba, standardno vrijeme", "CXT": "Božićno ostrvo vrijeme", "ChST": "Čamoro vrijeme", "EASST": "Uskršnja ostrva, ljetnje vrijeme", "EAST": "Uskršnja ostrva, standardno vrijeme", "EAT": "Istočno-afričko vrijeme", "ECT": "Ekvador vrijeme", "EDT": "Sjevernoameričko istočno ljetnje vrijeme", "EGDT": "Istočni Grenland, ljetnje vrijeme", "EGST": "Istočni Grenland, standardno vrijeme", "EST": "Sjevernoameričko istočno standardno vrijeme", "FKST": "Folklandska Ostrva, ljetnje vrijeme", "GALT": "Galapagos vrijeme", "GFT": "Francuska Gvajana vrijeme", "GMT": "Srednje vrijeme po Griniču", "GST": "Zalivsko vrijeme", "GYT": "Gvajana vrijeme", "HADT": "Havajsko-aleutsko ljetnje vrijeme", "HAST": "Havajsko-aleutsko standardno vrijeme", "HENOMX": "Sjeverozapadni Meksiko, letnje vrijeme", "HEOG": "Zapadni Grenland, ljetnje vrijeme", "HEPMX": "Meksički Pacifik, ljetnje vrijeme", "HKST": "Hong Kong, ljetnje vrijeme", "HKT": "Hong Kong, standardno vrijeme", "HNNOMX": "Sjeverozapadni Meksiko, standardno vrijeme", "HNOG": "Zapadni Grenland, standardno vrijeme", "HNPMX": "Meksički Pacifik, standardno vrijeme", "ICT": "Indokina vrijeme", "IRDT": "Iran, ljetnje vrijeme", "IRST": "Iran, standardno vrijeme", "IST": "Indijsko standardno vrijeme", "JDT": "Japansko ljetnje vrijeme", "JST": "Japansko standardno vrijeme", "LHDT": "Lord Hov, ljetnje vrijeme", "LHST": "Lord Hov, standardno vrijeme", "MDT": "Макао летње рачунање времена", "MESZ": "Srednjoevropsko ljetnje vrijeme", "MEZ": "Srednjoevropsko standardno vrijeme", "MST": "Макао стандардно време", "MVT": "Maldivi vrijeme", "MYT": "Malezija vrijeme", "NDT": "Njufaundlend, ljetnje vrijeme", "NPT": "Nepal vrijeme", "NST": "Njufaundlend, standardno vrijeme", "NZDT": "Novi Zeland, ljetnje vrijeme", "NZST": "Novi Zeland, standardno vrijeme", "OESZ": "Istočnoevropsko ljetnje vrijeme", "OEZ": "Istočnoevropsko standardno vrijeme", "PDT": "Sjevernoameričko pacifičko letnje vrijeme", "PKT": "Pakistan, ljetnje vrijeme", "PMDT": "Sen Pjer i Mikelon, ljetnje vrijeme", "PMST": "Sen Pjer i Mikelon, standardno vrijeme", "PST": "Sjevernoameričko pacifičko standardno vrijeme", "PYST": "Paragvaj, ljetnje vrijeme", "SAST": "Južno-afričko vrijeme", "SGT": "Singapur, standardno vrijeme", "SRT": "Surinam vrijeme", "TLT": "Istočni Timor vrijeme", "TMST": "Turkmenistan, ljetnje vrijeme", "TMT": "Turkmenistan, standardno vrijeme", "UYST": "Urugvaj, ljetnje vrijeme", "UYT": "Urugvaj, standardno vrijeme", "VET": "Venecuela vrijeme", "WARST": "Zapadna Argentina, ljetnje vrijeme", "WART": "Zapadna Argentina, standardno vrijeme", "WAST": "Zapadno-afričko ljetnje vrijeme", "WAT": "Zapadno-afričko standardno vrijeme", "WESZ": "Zapadnoevropsko ljetnje vrijeme", "WEZ": "Zapadnoevropsko standardno vrijeme", "WIB": "Zapadno-indonezijsko vrijeme", "WIT": "Istočno-indonezijsko vrijeme", "WITA": "Centralno-indonezijsko vrijeme", "∅∅∅": "Peru, ljetnje vrijeme"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"vijekovi", "%v vijek", "%v vijekova", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mjeseci", "%v mjes.", "%v mjes.", ""},
				Long:   &locales.CounterFormat{"mjeseci", "%v mjesec", "%v mjeseci", "%v mjesečno"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"nedjelje", "%v nedjelja", "%v nedjelja", "%v nedjeljno"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
...
// DateFullLayout returns the full date layout for 'sr_Latn_BA'
func (sr *sr_Latn_BA) DateFullLayout() string {
	return sr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sr_Latn_BA'
func (sr *sr_Latn_BA) DateLongLayout() string {
	return sr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sr_Latn_BA'
func (sr *sr_Latn_BA) DateMediumLayout() string {
	return sr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sr_Latn_BA'
func (sr *sr_Latn_BA) DateShortLayout() string {
	return sr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sr_Latn_BA'
func (sr *sr_Latn_BA) TimeFullLayout() string {
	return sr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sr_Latn_BA'
func (sr *sr_Latn_BA) TimeLongLayout() string {
	return sr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sr_Latn_BA'
func (sr *sr_Latn_BA) TimeMediumLayout() string {
	return sr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sr_Latn_BA'
func (sr *sr_Latn_BA) TimeShortLayout() string {
	return sr.timeShortLayout
}

func (sr *sr_Latn_BA) ListPatterns() *locales.ListPatterns {
	return sr.listPatterns
}

func (sr *sr_Latn_BA) GetDurationSpec() *locales.DurationSpec {
	return sr.DurationSpec
}

func (sr *sr_Latn_BA) GetMiscPatterns() *locales.MiscPatterns {
