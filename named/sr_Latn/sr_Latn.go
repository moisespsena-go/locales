...
func New() locales.Translator {
	return &sr_Latn{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jan", "feb", "mar", "apr", "maj", "jun", "jul", "avg", "sep", "okt", "nov", "dec"},
			MonthsNarrowValue:        []string{"", "j", "f", "m", "a", "m", "j", "j", "a", "s", "o", "n", "d"},
			MonthsWideValue:          []string{"", "januar", "februar", "mart", "april", "maj", "jun", "jul", "avgust", "septembar", "oktobar", "novembar", "decembar"},
			WeekdaysAbbreviatedValue: []string{"ned", "pon", "uto", "sre", "čet", "pet", "sub"},
			WeekdaysNarrowValue:      []string{"n", "p", "u", "s", "č", "p", "s"},
			WeekdaysShortValue:       []string{"ne", "po", "ut", "sr", "če", "pe", "su"},
			WeekdaysWideValue:        []string{"nedelja", "ponedeljak", "utorak", "sreda", "četvrtak", "petak", "subota"},
			PeriodsAbbreviatedValue:  []string{"", ""},
			PeriodsNarrowValue:       []string{"AM", "PM"},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"p. n. e.", "n. e."},
			ErasNarrowValue:          []string{"p.n.e.", "n.e."},
			ErasWideValue:            []string{"pre nove ere", "nove ere"},
			TimezonesValue:           map[string]string{"": "Paragvaj, standardno vreme", "ACDT": "Australijsko centralno letnje vreme", "ACST": "Australijsko centralno standardno vreme", "ACT": "Akre standardno vreme", "ACWDT": "Australijsko centralno zapadno letnje vreme", "ACWST": "Australijsko centralno zapadno standardno vreme", "ADT": "Atlantsko letnje vreme", "AEDT": "Australijsko istočno letnje vreme", "AEST": "Australijsko istočno standardno vreme", "AFT": "Avganistan vreme", "AKDT": "Aljaska, letnje vreme", "AKST": "Aljaska, standardno vreme", "AMST": "Amazon, letnje vreme", "AMT": "Amazon, standardno vreme", "ARST": "Argentina, letnje vreme", "ART": "Argentina, standardno vreme", "AST": "Atlantsko standardno vreme", "AWDT": "Australijsko zapadno letnje vreme", "AWST": "Australijsko zapadno standardno vreme", "BNT": "Brunej Darusalum vreme", "BOT": "Bolivija vreme", "BRST": "Brazilija, letnje vreme", "BRT": "Brazilija, standardno vreme", "BST": "Bangladeš, letnje vreme", "BTT": "Butan vreme", "CAT": "Centralno-afričko vreme", "CCT": "Kokos (Keling) Ostrva vreme", "CDT": "Severnoameričko centralno letnje vreme", "CDT (Kuba)": "Kuba, letnje vreme", "CHADT": "Čatam, letnje vreme", "CHAST": "Čatam, standardno vreme", "CLST": "Čile, letnje vreme", "CLT": "Čile, standardno vreme", "COST": "Kolumbija, letnje vreme", "COT": "Kolumbija, standardno vreme", "CST": "Severnoameričko centralno standardno vreme", "CST (Kuba)": "Kuba, standardno vreme", "CXT": "Božićno ostrvo vreme", "ChST": "Čamoro vreme", "EASST": "Uskršnja ostrva, letnje vreme", "EAST": "Uskršnja ostrva, standardno vreme", "EAT": "Istočno-afričko vreme", "ECT": "Ekvador vreme", "EDT": "Severnoameričko istočno letnje vreme", "EGDT": "Istočni Grenland, letnje vreme", "EGST": "Istočni Grenland, standardno vreme", "EST": "Severnoameričko istočno standardno vreme", "FKST": "Folklandska Ostrva, letnje vreme", "GALT": "Galapagos vreme", "GFT": "Francuska Gvajana vreme", "GMT": "Srednje vreme po Griniču", "GST": "Zalivsko vreme", "GYT": "Gvajana vreme", "HADT": "Havajsko-aleutsko letnje vreme", "HAST": "Havajsko-aleutsko standardno vreme", "HENOMX": "Severozapadni Meksiko, letnje vreme", "HEOG": "Zapadni Grenland, letnje vreme", "HEPMX": "Meksički Pacifik, letnje vreme", "HKST": "Hong Kong, letnje vreme", "HKT": "Hong Kong, standardno vreme", "HNNOMX": "Severozapadni Meksiko, standardno vreme", "HNOG": "Zapadni Grenland, standardno vreme", "HNPMX": "Meksički Pacifik, standardno vreme", "ICT": "Indokina vreme", "IRDT": "Iran, letnje vreme", "IRST": "Iran, standardno vreme", "IST": "Indijsko standardno vreme", "JDT": "Japansko letnje vreme", "JST": "Japansko standardno vreme", "LHDT": "Lord Hov, letnje vreme", "LHST": "Lord Hov, standardno vreme", "MDT": "Severnoameričko planinsko letnje vreme", "MESZ": "Srednjeevropsko letnje vreme", "MEZ": "Srednjeevropsko standardno vreme", "MST": "Severnoameričko planinsko standardno vreme", "MVT": "Maldivi vreme", "MYT": "Malezija vreme", "NDT": "Njufaundlend, letnje vreme", "NPT": "Nepal vreme", "NST": "Njufaundlend, standardno vreme", "NZDT": "Novi Zeland, letnje vreme", "NZST": "Novi Zeland, standardno vreme", "OESZ": "Istočnoevropsko letnje vreme", "OEZ": "Istočnoevropsko standardno vreme", "PDT": "Severnoameričko pacifičko letnje vreme", "PKT": "Pakistan, letnje vreme", "PMDT": "Sen Pjer i Mikelon, letnje vreme", "PMST": "Sen Pjer i Mikelon, standardno vreme", "PST": "Severnoameričko pacifičko standardno vreme", "PYST": "Paragvaj, letnje vreme", "SAST": "Južno-afričko vreme", "SGT": "Singapur, standardno vreme", "SRT": "Surinam vreme", "TLT": "Istočni timor vreme", "TMST": "Turkmenistan, letnje vreme", "TMT": "Turkmenistan, standardno vreme", "UYST": "Urugvaj, letnje vreme", "UYT": "Urugvaj, standardno vreme", "VET": "Venecuela vreme", "WARST": "Zapadna Argentina, letnje vreme", "WART": "Zapadna Argentina, standardno vreme", "WAST": "Zapadno-afričko letnje vreme", "WAT": "Zapadno-afričko standardno vreme", "WESZ": "Zapadnoevropsko letnje vreme", "WEZ": "Zapadnoevropsko standardno vreme", "WIB": "Zapadno-indonezijsko vreme", "WIT": "Istočno-indonezijsko vreme", "WITA": "Centralno-indonezijsko vreme", "∅∅∅": "Peru, letnje vreme"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"v.", "%v v", "%v v", ""},
				Long:   &locales.CounterFormat{"vekovi", "%v vekom", "%v vekova", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dec.", "%v dec.", "%v dec.", ""},
				Long:   &locales.CounterFormat{"decenije", "%v decenijom", "%v decenija", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"g.", "%v g", "%v g", ""},
				Long:   &locales.CounterFormat{"godine", "%v godinom", "%v godina", "%v godišnje"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m.", "%v m", "%v m", ""},
				Long:   &locales.CounterFormat{"meseci", "%v mesecom", "%v meseci", "%v mesečno"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"n.", "%v n", "%v n", ""},
				Long:   &locales.CounterFormat{"nedelje", "%v nedeljom", "%v nedelja", "%v nedeljno"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"d", "%v d", "%v d", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"č", "%v č", "%v č", ""},
				Long:   &locales.CounterFormat{"sati", "%v satom", "%v sati", "%v/sat"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%v m", "%v m", ""},
				Long:   &locales.CounterFormat{"minuti", "%v minutom", "%v minuta", "%v u minutu"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%v s", "%v s", ""},
				Long:   &locales.CounterFormat{"sekunde", "%v sekundom", "%v sekundi", "%v/u sekundi"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"milisekunde", "%v milisekundom", "%v milisekundi", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"mikrosekunde", "%v mikrosekundom", "%v mikrosekundi", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosekunde", "%v nanosekundom", "%v nanosekundi", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"≥%[1]v",
...
func (sr *sr_Latn) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(sr, sr.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'sr_Latn'
func (sr *sr_Latn) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(sr, sr.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'sr_Latn'
func (sr *sr_Latn) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(sr, sr.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'sr_Latn'
func (sr *sr_Latn) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(sr, sr.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'sr_Latn'
func (sr *sr_Latn) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(sr, sr.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'sr_Latn'
func (sr *sr_Latn) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(sr, sr.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'sr_Latn'
func (sr *sr_Latn) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(sr, sr.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'sr_Latn'
func (sr *sr_Latn) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(sr, sr.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'sr_Latn'
func (sr *sr_Latn) DateFullLayout() string {
	return sr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sr_Latn'
func (sr *sr_Latn) DateLongLayout() string {
	return sr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sr_Latn'
func (sr *sr_Latn) DateMediumLayout() string {
	return sr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sr_Latn'
func (sr *sr_Latn) DateShortLayout() string {
	return sr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sr_Latn'
func (sr *sr_Latn) TimeFullLayout() string {
	return sr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sr_Latn'
func (sr *sr_Latn) TimeLongLayout() string {
	return sr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sr_Latn'
func (sr *sr_Latn) TimeMediumLayout() string {
	return sr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sr_Latn'
func (sr *sr_Latn) TimeShortLayout() string {
	return sr.timeShortLayout
}

func (sr *sr_Latn) ListPatterns() *locales.ListPatterns {
	return sr.listPatterns
}

func (sr *sr_Latn) GetDurationSpec() *locales.DurationSpec {
	return sr.DurationSpec
}

func (sr *sr_Latn) GetMiscPatterns() *locales.MiscPatterns {
	return &sr.miscPatterns
}
