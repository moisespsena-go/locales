...
func New() locales.Translator {
	return &en_GB{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"},
...
// DateFullLayout returns the full date layout for 'en_GB'
func (en *en_GB) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_GB'
func (en *en_GB) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_GB'
func (en *en_GB) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_GB'
func (en *en_GB) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_GB'
func (en *en_GB) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_GB'
func (en *en_GB) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_GB'
func (en *en_GB) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_GB'
func (en *en_GB) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_GB) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_GB) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_GB) GetMiscPatterns() *locales.MiscPatterns {
