...
// DateFullLayout returns the full date layout for 'xog'
func (xog *xog) DateFullLayout() string {
	return xog.dateFullLayout
}

// DateLongLayout returns the long date layout for 'xog'
func (xog *xog) DateLongLayout() string {
	return xog.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'xog'
func (xog *xog) DateMediumLayout() string {
	return xog.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'xog'
func (xog *xog) DateShortLayout() string {
	return xog.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'xog'
func (xog *xog) TimeFullLayout() string {
	return xog.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'xog'
func (xog *xog) TimeLongLayout() string {
	return xog.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'xog'
func (xog *xog) TimeMediumLayout() string {
	return xog.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'xog'
func (xog *xog) TimeShortLayout() string {
	return xog.timeShortLayout
}

func (xog *xog) ListPatterns() *locales.ListPatterns {
	return xog.listPatterns
}

func (xog *xog) GetDurationSpec() *locales.DurationSpec {
	return xog.DurationSpec
}

func (xog *xog) GetMiscPatterns() *locales.MiscPatterns {
