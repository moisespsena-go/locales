	...
	return &fi{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"vs", "%v vs", "%v vs", ""},
				Long:   &locales.CounterFormat{"vuosisadat", "%v vuosisataa", "%v vuosisataa", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"vuosikymmenet", "%v vuosikymmentä", "%v vuosikymmentä", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"v", "%vv", "%vv", "%v/v"},
				Long:   &locales.CounterFormat{"vuodet", "%v vuotta", "%v vuoteen", "%v / vuosi"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"kk", "%vkk", "%vkk", "%v/kk"},
				Long:   &locales.CounterFormat{"kuukaudet", "%v kuukautta", "%v kuukautta", "%v / kuukausi"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"vk", "%vvk", "%vvk", "%v/vk"},
				Long:   &locales.CounterFormat{"viikot", "%v viikkoa", "%v viikkoa", "%v / viikko"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"pv", "%vpv", "%vpv", "%v/pv"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"t", "%vt", "%vt", "%v/t"},
				Long:   &locales.CounterFormat{"tunnit", "%v tuntia", "%v tuntia", "%v / tunti"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%vmin", "%vmin", "%v/min"},
				Long:   &locales.CounterFormat{"minuutit", "%v minuuttia", "%v minuuttia", "%v / minuutti"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%vs", "%vs", "%v/s"},
				Long:   &locales.CounterFormat{"sekunnit", "%v sekuntia", "%v sekuntia", "%v / sekunti"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"millisekunnit", "%v millisekuntia", "%v millisekuntia", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%vμs", "%vμs", ""},
				Long:   &locales.CounterFormat{"mikrosekunnit", "%v mikrosekuntia", "%v mikrosekuntia", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%vns", "%vns", ""},
				Long:   &locales.CounterFormat{"nanosekunnit", "%v nanosekuntia", "%v nanosekuntia", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"vähintään %[1]v",
...
// DateFullLayout returns the full date layout for 'fi'
func (fi *fi) DateFullLayout() string {
	return fi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fi'
func (fi *fi) DateLongLayout() string {
	return fi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fi'
func (fi *fi) DateMediumLayout() string {
	return fi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fi'
func (fi *fi) DateShortLayout() string {
	return fi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fi'
func (fi *fi) TimeFullLayout() string {
	return fi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fi'
func (fi *fi) TimeLongLayout() string {
	return fi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fi'
func (fi *fi) TimeMediumLayout() string {
	return fi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fi'
func (fi *fi) TimeShortLayout() string {
	return fi.timeShortLayout
}

func (fi *fi) ListPatterns() *locales.ListPatterns {
	return fi.listPatterns
}

func (fi *fi) GetDurationSpec() *locales.DurationSpec {
	return fi.DurationSpec
}

func (fi *fi) GetMiscPatterns() *locales.MiscPatterns {
