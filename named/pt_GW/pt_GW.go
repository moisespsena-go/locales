...
func New() locales.Translator {
	return &pt_GW{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						...
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 mM ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 mM ¤"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 mM ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 mM ¤"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 mM ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 mM ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			...
			WeekdaysAbbreviatedValue: []string{"domingo", "segunda", "terça", "quarta", "quinta", "sexta", "sábado"},
			WeekdaysNarrowValue:      []string{"D", "S", "T", "Q", "Q", "S", "S"},
			WeekdaysShortValue:       []string{"dom.", "seg.", "ter.", "qua.", "qui.", "sex.", "sáb."},
			...
			PeriodsWideValue:         []string{"da manhã", "da tarde"},
			ErasAbbreviatedValue:     []string{"a.E.C.", "E.C."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"", ""},
			TimezonesValue:           map[string]string{"": "Hora padrão do Paraguai", "ACDT": "Hora de verão da Austrália Central", "ACST": "Hora padrão da Austrália Central", "ACT": "Hora padrão do Acre", "ACWDT": "Hora de verão da Austrália Central Ocidental", "ACWST": "Hora padrão da Austrália Central Ocidental", "ADT": "Hora de verão do Atlântico", "AEDT": "Hora de verão da Austrália Oriental", "AEST": "Hora padrão da Austrália Oriental", "AFT": "Hora do Afeganistão", "AKDT": "Hora de verão do Alasca", "AKST": "Hora padrão do Alasca", "AMST": "Hora de verão do Amazonas", "AMT": "Hora padrão do Amazonas", "ARST": "Hora de verão da Argentina", "ART": "Hora padrão da Argentina", "AST": "Hora padrão do Atlântico", "AWDT": "Hora de verão da Austrália Ocidental", "AWST": "Hora padrão da Austrália Ocidental", "BNT": "Hora do Brunei Darussalam", "BOT": "Hora da Bolívia", "BRST": "Hora de verão de Brasília", "BRT": "Hora padrão de Brasília", "BST": "Hora de verão do Bangladeche", "BTT": "Hora do Butão", "CAT": "Hora da África Central", "CCT": "Hora das Ilhas Cocos", "CDT": "Hora de verão central norte-americana", "CDT (Kuba)": "Hora de verão de Cuba", "CHADT": "Hora de verão de Chatham", "CHAST": "Hora padrão de Chatham", "CLST": "Hora de verão do Chile", "CLT": "Hora padrão do Chile", "COST": "Hora de verão da Colômbia", "COT": "Hora padrão da Colômbia", "CST": "Hora padrão central norte-americana", "CST (Kuba)": "Hora padrão de Cuba", "CXT": "Hora da Ilha do Natal", "ChST": "Hora padrão de Chamorro", "EASST": "Hora de verão da Ilha da Páscoa", "EAST": "Hora padrão da Ilha da Páscoa", "EAT": "Hora da África Oriental", "ECT": "Hora do Equador", "EDT": "Hora de verão oriental norte-americana", "EGDT": "Hora de verão da Gronelândia Oriental", "EGST": "Hora padrão da Gronelândia Oriental", "EST": "Hora padrão oriental norte-americana", "FKST": "Hora de verão das Ilhas Falkland", "GALT": "Hora das Galápagos", "GFT": "Hora da Guiana Francesa", "GMT": "Hora de Greenwich", "GST": "Hora padrão do Golfo", "GYT": "Hora da Guiana", "HADT": "Hora de verão do Havai e Aleutas", "HAST": "Hora padrão do Havai e Aleutas", "HENOMX": "Hora de verão do Noroeste do México", "HEOG": "Hora de verão da Gronelândia Ocidental", "HEPMX": "Hora de verão do Pacífico Mexicano", "HKST": "Hora de verão de Hong Kong", "HKT": "Hora padrão de Hong Kong", "HNNOMX": "Hora padrão do Noroeste do México", "HNOG": "Hora padrão da Gronelândia Ocidental", "HNPMX": "Hora padrão do Pacífico Mexicano", "ICT": "Hora da Indochina", "IRDT": "Hora de verão do Irão", "IRST": "Hora padrão do Irão", "IST": "Hora padrão da Índia", "JDT": "Hora de verão do Japão", "JST": "Hora padrão do Japão", "LHDT": "Hora de verão de Lord Howe", "LHST": "Hora padrão de Lord Howe", "MDT": "Hora de verão de montanha norte-americana", "MESZ": "Hora de verão da Europa Central", "MEZ": "Hora padrão da Europa Central", "MST": "Hora padrão de montanha norte-americana", "MVT": "Hora das Maldivas", "MYT": "Hora da Malásia", "NDT": "Hora de verão da Terra Nova", "NPT": "Hora do Nepal", "NST": "Hora padrão da Terra Nova", "NZDT": "Hora de verão da Nova Zelândia", "NZST": "Hora padrão da Nova Zelândia", "OESZ": "Hora de verão da Europa Oriental", "OEZ": "Hora padrão da Europa Oriental", "PDT": "Hora de verão do Pacífico norte-americana", "PKT": "Hora de verão do Paquistão", "PMDT": "Hora de verão de São Pedro e Miquelão", "PMST": "Hora padrão de São Pedro e Miquelão", "PST": "Hora padrão do Pacífico norte-americana", "PYST": "Hora de verão do Paraguai", "SAST": "Hora da África do Sul", "SGT": "Hora padrão de Singapura", "SRT": "Hora do Suriname", "TLT": "Hora de Timor Leste", "TMST": "Hora de verão do Turquemenistão", "TMT": "Hora padrão do Turquemenistão", "UYST": "Hora de verão do Uruguai", "UYT": "Hora padrão do Uruguai", "VET": "Hora da Venezuela", "WARST": "Hora de verão da Argentina Ocidental", "WART": "Hora padrão da Argentina Ocidental", "WAST": "Hora de verão da África Ocidental", "WAT": "Hora padrão da África Ocidental", "WESZ": "Hora de verão da Europa Ocidental", "WEZ": "Hora padrão da Europa Ocidental", "WIB": "Hora da Indonésia Ocidental", "WIT": "Hora da Indonésia Oriental", "WITA": "Hora da Indonésia Central", "∅∅∅": "Hora de verão do Peru"},
		},
...
// DateFullLayout returns the full date layout for 'pt_GW'
func (pt *pt_GW) DateFullLayout() string {
	return pt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pt_GW'
func (pt *pt_GW) DateLongLayout() string {
	return pt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pt_GW'
func (pt *pt_GW) DateMediumLayout() string {
	return pt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pt_GW'
func (pt *pt_GW) DateShortLayout() string {
	return pt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pt_GW'
func (pt *pt_GW) TimeFullLayout() string {
	return pt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pt_GW'
func (pt *pt_GW) TimeLongLayout() string {
	return pt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pt_GW'
func (pt *pt_GW) TimeMediumLayout() string {
	return pt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pt_GW'
func (pt *pt_GW) TimeShortLayout() string {
	return pt.timeShortLayout
}

func (pt *pt_GW) ListPatterns() *locales.ListPatterns {
	return pt.listPatterns
}

func (pt *pt_GW) GetDurationSpec() *locales.DurationSpec {
	return pt.DurationSpec
}

func (pt *pt_GW) GetMiscPatterns() *locales.MiscPatterns {
