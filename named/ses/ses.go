...
// DateFullLayout returns the full date layout for 'ses'
func (ses *ses) DateFullLayout() string {
	return ses.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ses'
func (ses *ses) DateLongLayout() string {
	return ses.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ses'
func (ses *ses) DateMediumLayout() string {
	return ses.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ses'
func (ses *ses) DateShortLayout() string {
	return ses.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ses'
func (ses *ses) TimeFullLayout() string {
	return ses.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ses'
func (ses *ses) TimeLongLayout() string {
	return ses.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ses'
func (ses *ses) TimeMediumLayout() string {
	return ses.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ses'
func (ses *ses) TimeShortLayout() string {
	return ses.timeShortLayout
}

func (ses *ses) ListPatterns() *locales.ListPatterns {
	return ses.listPatterns
}

func (ses *ses) GetDurationSpec() *locales.DurationSpec {
	return ses.DurationSpec
}

func (ses *ses) GetMiscPatterns() *locales.MiscPatterns {
