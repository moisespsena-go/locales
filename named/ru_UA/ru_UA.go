...
// DateFullLayout returns the full date layout for 'ru_UA'
func (ru *ru_UA) DateFullLayout() string {
	return ru.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ru_UA'
func (ru *ru_UA) DateLongLayout() string {
	return ru.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ru_UA'
func (ru *ru_UA) DateMediumLayout() string {
	return ru.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ru_UA'
func (ru *ru_UA) DateShortLayout() string {
	return ru.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ru_UA'
func (ru *ru_UA) TimeFullLayout() string {
	return ru.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ru_UA'
func (ru *ru_UA) TimeLongLayout() string {
	return ru.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ru_UA'
func (ru *ru_UA) TimeMediumLayout() string {
	return ru.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ru_UA'
func (ru *ru_UA) TimeShortLayout() string {
	return ru.timeShortLayout
}

func (ru *ru_UA) ListPatterns() *locales.ListPatterns {
	return ru.listPatterns
}

func (ru *ru_UA) GetDurationSpec() *locales.DurationSpec {
	return ru.DurationSpec
}

func (ru *ru_UA) GetMiscPatterns() *locales.MiscPatterns {
