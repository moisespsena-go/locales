...
// DateFullLayout returns the full date layout for 'ru_KZ'
func (ru *ru_KZ) DateFullLayout() string {
	return ru.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ru_KZ'
func (ru *ru_KZ) DateLongLayout() string {
	return ru.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ru_KZ'
func (ru *ru_KZ) DateMediumLayout() string {
	return ru.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ru_KZ'
func (ru *ru_KZ) DateShortLayout() string {
	return ru.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ru_KZ'
func (ru *ru_KZ) TimeFullLayout() string {
	return ru.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ru_KZ'
func (ru *ru_KZ) TimeLongLayout() string {
	return ru.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ru_KZ'
func (ru *ru_KZ) TimeMediumLayout() string {
	return ru.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ru_KZ'
func (ru *ru_KZ) TimeShortLayout() string {
	return ru.timeShortLayout
}

func (ru *ru_KZ) ListPatterns() *locales.ListPatterns {
	return ru.listPatterns
}

func (ru *ru_KZ) GetDurationSpec() *locales.DurationSpec {
	return ru.DurationSpec
}

func (ru *ru_KZ) GetMiscPatterns() *locales.MiscPatterns {
