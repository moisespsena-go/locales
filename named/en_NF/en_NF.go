...
// DateFullLayout returns the full date layout for 'en_NF'
func (en *en_NF) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_NF'
func (en *en_NF) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_NF'
func (en *en_NF) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_NF'
func (en *en_NF) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_NF'
func (en *en_NF) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_NF'
func (en *en_NF) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_NF'
func (en *en_NF) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_NF'
func (en *en_NF) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_NF) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_NF) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_NF) GetMiscPatterns() *locales.MiscPatterns {
