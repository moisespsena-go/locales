...
// DateFullLayout returns the full date layout for 'ca_FR'
func (ca *ca_FR) DateFullLayout() string {
	return ca.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ca_FR'
func (ca *ca_FR) DateLongLayout() string {
	return ca.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ca_FR'
func (ca *ca_FR) DateMediumLayout() string {
	return ca.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ca_FR'
func (ca *ca_FR) DateShortLayout() string {
	return ca.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ca_FR'
func (ca *ca_FR) TimeFullLayout() string {
	return ca.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ca_FR'
func (ca *ca_FR) TimeLongLayout() string {
	return ca.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ca_FR'
func (ca *ca_FR) TimeMediumLayout() string {
	return ca.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ca_FR'
func (ca *ca_FR) TimeShortLayout() string {
	return ca.timeShortLayout
}

func (ca *ca_FR) ListPatterns() *locales.ListPatterns {
	return ca.listPatterns
}

func (ca *ca_FR) GetDurationSpec() *locales.DurationSpec {
	return ca.DurationSpec
}

func (ca *ca_FR) GetMiscPatterns() *locales.MiscPatterns {
