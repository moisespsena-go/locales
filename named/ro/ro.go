...
func New() locales.Translator {
	return &ro{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 mie ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 mii ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 mii ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 mii ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 mii ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 mii ¤"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 mil'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 mil'.' ¤"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 mil'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 mil'.' ¤"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 mil'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 mil'.' ¤"),
						}},
						...
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 tril'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 tril'.' ¤"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 tril'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 tril'.' ¤"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 tril'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 tril'.' ¤"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ian.", "feb.", "mar.", "apr.", "mai", "iun.", "iul.", "aug.", "sept.", "oct.", "nov.", "dec."},
			MonthsNarrowValue:        []string{"", "I", "F", "M", "A", "M", "I", "I", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "ianuarie", "februarie", "martie", "aprilie", "mai", "iunie", "iulie", "august", "septembrie", "octombrie", "noiembrie", "decembrie"},
			WeekdaysAbbreviatedValue: []string{"dum.", "lun.", "mar.", "mie.", "joi", "vin.", "sâm."},
			WeekdaysNarrowValue:      []string{"D", "L", "M", "M", "J", "V", "S"},
			WeekdaysShortValue:       []string{"du.", "lu.", "ma.", "mi.", "joi", "vi.", "sâ."},
			WeekdaysWideValue:        []string{"duminică", "luni", "marți", "miercuri", "joi", "vineri", "sâmbătă"},
			PeriodsAbbreviatedValue:  []string{"a.m.", "p.m."},
			PeriodsNarrowValue:       []string{"a.m.", "p.m."},
			PeriodsWideValue:         []string{"a.m.", "p.m."},
			ErasAbbreviatedValue:     []string{"î.Hr.", "d.Hr."},
			ErasNarrowValue:          []string{"î.Hr.", "d.Hr."},
			ErasWideValue:            []string{"înainte de Hristos", "după Hristos"},
			TimezonesValue:           map[string]string{"": "Ora standard din Paraguay", "ACDT": "Ora de vară a Australiei Centrale", "ACST": "Ora de vară Acre", "ACT": "Ora standard Acre", "ACWDT": "Ora de vară a Australiei Central Occidentale", "ACWST": "Ora standard a Australiei Central Occidentale", "ADT": "Ora de vară în zona Atlantic nord-americană", "AEDT": "Ora de vară a Australiei Orientale", "AEST": "Ora standard a Australiei Orientale", "AFT": "Ora Afganistanului", "AKDT": "Ora de vară din Alaska", "AKST": "Ora standard din Alaska", "AMST": "Ora de vară a Amazonului", "AMT": "Ora standard a Amazonului", "ARST": "Ora de vară a Argentinei", "ART": "Ora standard a Argentinei", "AST": "Ora standard în zona Atlantic nord-americană", "AWDT": "Ora de vară a Australiei Occidentale", "AWST": "Ora standard a Australiei Occidentale", "BNT": "Ora din Brunei Darussalam", "BOT": "Ora Boliviei", "BRST": "Ora de vară a Brasiliei", "BRT": "Ora standard a Brasiliei", "BST": "Ora de vară din Bangladesh", "BTT": "Ora Bhutanului", "CAT": "Ora Africii Centrale", "CCT": "Ora Insulelor Cocos", "CDT": "Ora de vară centrală nord-americană", "CDT (Kuba)": "Ora de vară a Cubei", "CHADT": "Ora de vară din Chatham", "CHAST": "Ora standard din Chatham", "CLST": "Ora de vară din Chile", "CLT": "Ora standard din Chile", "COST": "Ora de vară a Columbiei", "COT": "Ora standard a Columbiei", "CST": "Ora standard centrală nord-americană", "CST (Kuba)": "Ora standard a Cubei", "CXT": "Ora din Insula Christmas", "ChST": "Ora din Chamorro", "EASST": "Ora de vară din Insula Paștelui", "EAST": "Ora standard din Insula Paștelui", "EAT": "Ora Africii Orientale", "ECT": "Ora Ecuadorului", "EDT": "Ora de vară orientală nord-americană", "EGDT": "Ora de vară a Groenlandei orientale", "EGST": "Ora standard a Groenlandei orientale", "EST": "Ora standard orientală nord-americană", "FKST": "Ora de vară din Insulele Falkland", "GALT": "Ora din Galapagos", "GFT": "Ora din Guyana Franceză", "GMT": "Ora de Greenwhich", "GST": "Ora standard a Golfului", "GYT": "Ora din Guyana", "HADT": "Ora de vară din Hawaii-Aleutine", "HAST": "Ora standard din Hawaii-Aleutine", "HENOMX": "Ora de vară a Mexicului de nord-vest", "HEOG": "Ora de vară a Groenlandei occidentale", "HEPMX": "Ora de vară a zonei Pacific mexicane", "HKST": "Ora de vară din Hong Kong", "HKT": "Ora standard din Hong Kong", "HNNOMX": "Ora standard a Mexicului de nord-vest", "HNOG": "Ora standard a Groenlandei occidentale", "HNPMX": "Ora standard a zonei Pacific mexicane", "ICT": "Ora Indochinei", "IRDT": "Ora de vară a Iranului", "IRST": "Ora standard a Iranului", "IST": "Ora Indiei", "JDT": "Ora de vară a Japoniei", "JST": "Ora standard a Japoniei", "LHDT": "Ora de vară din Lord Howe", "LHST": "Ora standard din Lord Howe", "MDT": "MDT", "MESZ": "Ora de vară a Europei Centrale", "MEZ": "Ora standard a Europei Centrale", "MST": "MST", "MVT": "Ora din Maldive", "MYT": "Ora din Malaysia", "NDT": "Ora de vară din Newfoundland", "NPT": "Ora Nepalului", "NST": "Ora standard din Newfoundland", "NZDT": "Ora de vară a Noii Zeelande", "NZST": "Ora standard a Noii Zeelande", "OESZ": "Ora de vară a Europei de Est", "OEZ": "Ora standard a Europei de Est", "PDT": "Ora de vară în zona Pacific nord-americană", "PKT": "Ora de vară a Pakistanului", "PMDT": "Ora de vară din Saint-Pierre și Miquelon", "PMST": "Ora standard din Saint-Pierre și Miquelon", "PST": "Ora standard în zona Pacific nord-americană", "PYST": "Ora de vară din Paraguay", "SAST": "Ora Africii Meridionale", "SGT": "Ora din Singapore", "SRT": "Ora Surinamului", "TLT": "Ora Timorului de Est", "TMST": "Ora de vară din Turkmenistan", "TMT": "Ora standard din Turkmenistan", "UYST": "Ora de vară a Uruguayului", "UYT": "Ora standard a Uruguayului", "VET": "Ora Venezuelei", "WARST": "Ora de vară a Argentinei Occidentale", "WART": "Ora standard a Argentinei Occidentale", "WAST": "Ora de vară a Africii Occidentale", "WAT": "Ora standard a Africii Occidentale", "WESZ": "Ora de vară a Europei de Vest", "WEZ": "Ora standard a Europei de Vest", "WIB": "Ora Indoneziei de Vest", "WIT": "Ora Indoneziei de Est", "WITA": "Ora Indoneziei Centrale", "∅∅∅": "Ora de vară din Azore"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} și {1}", "{0}, {1}", "{0}, {1}", "{0} și {1}"}, {"{0} sau {1}", "{0}, {1}", "{0}, {1}", "{0} sau {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sec.", "%v sec.", "%v sec.", ""},
				Long:   &locales.CounterFormat{"secole", "unui secol", "%v de secole", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dec.", "%v dec.", "%v dec.", ""},
				Long:   &locales.CounterFormat{"decenii", "unui deceniu", "%v de decenii", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"a", "%v a", "%v a", "%v/an"},
				Long:   &locales.CounterFormat{"ani", "unui an", "%v de ani", "%v pe an"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"l", "%v l", "%v l", "%v/lună"},
				Long:   &locales.CounterFormat{"luni", "unei luni", "%v de luni", "%v pe lună"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"săpt.", "%v săpt.", "%v săpt.", "%v/săpt."},
				Long:   &locales.CounterFormat{"săptămâni", "unei săptămâni", "%v de săptămâni", "%v pe săptămână"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"zi", "%v z", "%v z", "%v/zi"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"oră", "%v h", "%v h", "%v/h"},
				Long:   &locales.CounterFormat{"ore", "unei ore", "%v de ore", "%v pe oră"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m", "%v m", "%v m", "%v/min."},
				Long:   &locales.CounterFormat{"minute", "unui minut", "%v de minute", "%v pe minut"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%v s", "%v s", "%v/s"},
				Long:   &locales.CounterFormat{"secunde", "unei secunde", "%v de secunde", "%v pe secundă"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"milisecunde", "unei milisecunde", "%v de milisecunde", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"microsecunde", "unei microsecunde", "%v de microsecunde", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosecunde", "unei nanosecunde", "%v de nanosecunde", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"≥%[1]v",
...
func (ro *ro) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ro, ro.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ro'
func (ro *ro) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ro, ro.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ro'
func (ro *ro) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ro, ro.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ro'
func (ro *ro) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ro, ro.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ro'
func (ro *ro) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ro, ro.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ro'
func (ro *ro) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ro, ro.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ro'
func (ro *ro) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ro, ro.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ro'
func (ro *ro) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ro, ro.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ro'
func (ro *ro) DateFullLayout() string {
	return ro.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ro'
func (ro *ro) DateLongLayout() string {
	return ro.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ro'
func (ro *ro) DateMediumLayout() string {
	return ro.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ro'
func (ro *ro) DateShortLayout() string {
	return ro.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ro'
func (ro *ro) TimeFullLayout() string {
	return ro.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ro'
func (ro *ro) TimeLongLayout() string {
	return ro.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ro'
func (ro *ro) TimeMediumLayout() string {
	return ro.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ro'
func (ro *ro) TimeShortLayout() string {
	return ro.timeShortLayout
}

func (ro *ro) ListPatterns() *locales.ListPatterns {
	return ro.listPatterns
}

func (ro *ro) GetDurationSpec() *locales.DurationSpec {
	return ro.DurationSpec
}

func (ro *ro) GetMiscPatterns() *locales.MiscPatterns {
	return &ro.miscPatterns
}
