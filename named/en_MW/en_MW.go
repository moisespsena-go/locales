...
// DateFullLayout returns the full date layout for 'en_MW'
func (en *en_MW) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_MW'
func (en *en_MW) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_MW'
func (en *en_MW) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_MW'
func (en *en_MW) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_MW'
func (en *en_MW) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_MW'
func (en *en_MW) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_MW'
func (en *en_MW) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_MW'
func (en *en_MW) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_MW) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_MW) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_MW) GetMiscPatterns() *locales.MiscPatterns {
