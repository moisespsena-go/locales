...
// DateFullLayout returns the full date layout for 'en_ZM'
func (en *en_ZM) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_ZM'
func (en *en_ZM) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_ZM'
func (en *en_ZM) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_ZM'
func (en *en_ZM) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_ZM'
func (en *en_ZM) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_ZM'
func (en *en_ZM) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_ZM'
func (en *en_ZM) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_ZM'
func (en *en_ZM) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_ZM) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_ZM) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_ZM) GetMiscPatterns() *locales.MiscPatterns {
