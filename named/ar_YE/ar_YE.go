...
// DateFullLayout returns the full date layout for 'ar_YE'
func (ar *ar_YE) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_YE'
func (ar *ar_YE) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_YE'
func (ar *ar_YE) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_YE'
func (ar *ar_YE) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_YE'
func (ar *ar_YE) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_YE'
func (ar *ar_YE) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_YE'
func (ar *ar_YE) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_YE'
func (ar *ar_YE) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_YE) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_YE) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_YE) GetMiscPatterns() *locales.MiscPatterns {
