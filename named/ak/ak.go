...
// DateFullLayout returns the full date layout for 'ak'
func (ak *ak) DateFullLayout() string {
	return ak.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ak'
func (ak *ak) DateLongLayout() string {
	return ak.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ak'
func (ak *ak) DateMediumLayout() string {
	return ak.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ak'
func (ak *ak) DateShortLayout() string {
	return ak.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ak'
func (ak *ak) TimeFullLayout() string {
	return ak.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ak'
func (ak *ak) TimeLongLayout() string {
	return ak.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ak'
func (ak *ak) TimeMediumLayout() string {
	return ak.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ak'
func (ak *ak) TimeShortLayout() string {
	return ak.timeShortLayout
}

func (ak *ak) ListPatterns() *locales.ListPatterns {
	return ak.listPatterns
}

func (ak *ak) GetDurationSpec() *locales.DurationSpec {
	return ak.DurationSpec
}

func (ak *ak) GetMiscPatterns() *locales.MiscPatterns {
