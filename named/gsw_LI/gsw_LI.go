...
// DateFullLayout returns the full date layout for 'gsw_LI'
func (gsw *gsw_LI) DateFullLayout() string {
	return gsw.dateFullLayout
}

// DateLongLayout returns the long date layout for 'gsw_LI'
func (gsw *gsw_LI) DateLongLayout() string {
	return gsw.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'gsw_LI'
func (gsw *gsw_LI) DateMediumLayout() string {
	return gsw.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'gsw_LI'
func (gsw *gsw_LI) DateShortLayout() string {
	return gsw.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'gsw_LI'
func (gsw *gsw_LI) TimeFullLayout() string {
	return gsw.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'gsw_LI'
func (gsw *gsw_LI) TimeLongLayout() string {
	return gsw.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'gsw_LI'
func (gsw *gsw_LI) TimeMediumLayout() string {
	return gsw.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'gsw_LI'
func (gsw *gsw_LI) TimeShortLayout() string {
	return gsw.timeShortLayout
}

func (gsw *gsw_LI) ListPatterns() *locales.ListPatterns {
	return gsw.listPatterns
}

func (gsw *gsw_LI) GetDurationSpec() *locales.DurationSpec {
	return gsw.DurationSpec
}

func (gsw *gsw_LI) GetMiscPatterns() *locales.MiscPatterns {
