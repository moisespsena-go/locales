...
// DateFullLayout returns the full date layout for 'gd_GB'
func (gd *gd_GB) DateFullLayout() string {
	return gd.dateFullLayout
}

// DateLongLayout returns the long date layout for 'gd_GB'
func (gd *gd_GB) DateLongLayout() string {
	return gd.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'gd_GB'
func (gd *gd_GB) DateMediumLayout() string {
	return gd.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'gd_GB'
func (gd *gd_GB) DateShortLayout() string {
	return gd.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'gd_GB'
func (gd *gd_GB) TimeFullLayout() string {
	return gd.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'gd_GB'
func (gd *gd_GB) TimeLongLayout() string {
	return gd.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'gd_GB'
func (gd *gd_GB) TimeMediumLayout() string {
	return gd.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'gd_GB'
func (gd *gd_GB) TimeShortLayout() string {
	return gd.timeShortLayout
}

func (gd *gd_GB) ListPatterns() *locales.ListPatterns {
	return gd.listPatterns
}

func (gd *gd_GB) GetDurationSpec() *locales.DurationSpec {
	return gd.DurationSpec
}

func (gd *gd_GB) GetMiscPatterns() *locales.MiscPatterns {
