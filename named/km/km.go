...
// DateFullLayout returns the full date layout for 'km'
func (km *km) DateFullLayout() string {
	return km.dateFullLayout
}

// DateLongLayout returns the long date layout for 'km'
func (km *km) DateLongLayout() string {
	return km.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'km'
func (km *km) DateMediumLayout() string {
	return km.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'km'
func (km *km) DateShortLayout() string {
	return km.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'km'
func (km *km) TimeFullLayout() string {
	return km.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'km'
func (km *km) TimeLongLayout() string {
	return km.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'km'
func (km *km) TimeMediumLayout() string {
	return km.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'km'
func (km *km) TimeShortLayout() string {
	return km.timeShortLayout
}

func (km *km) ListPatterns() *locales.ListPatterns {
	return km.listPatterns
}

func (km *km) GetDurationSpec() *locales.DurationSpec {
	return km.DurationSpec
}

func (km *km) GetMiscPatterns() *locales.MiscPatterns {
