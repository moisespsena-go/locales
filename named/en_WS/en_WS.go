...
// DateFullLayout returns the full date layout for 'en_WS'
func (en *en_WS) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_WS'
func (en *en_WS) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_WS'
func (en *en_WS) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_WS'
func (en *en_WS) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_WS'
func (en *en_WS) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_WS'
func (en *en_WS) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_WS'
func (en *en_WS) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_WS'
func (en *en_WS) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_WS) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_WS) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_WS) GetMiscPatterns() *locales.MiscPatterns {
