...
// DateFullLayout returns the full date layout for 'es_CR'
func (es *es_CR) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_CR'
func (es *es_CR) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_CR'
func (es *es_CR) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_CR'
func (es *es_CR) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_CR'
func (es *es_CR) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_CR'
func (es *es_CR) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_CR'
func (es *es_CR) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_CR'
func (es *es_CR) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_CR) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_CR) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_CR) GetMiscPatterns() *locales.MiscPatterns {
