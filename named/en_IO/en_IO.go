...
// DateFullLayout returns the full date layout for 'en_IO'
func (en *en_IO) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_IO'
func (en *en_IO) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_IO'
func (en *en_IO) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_IO'
func (en *en_IO) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_IO'
func (en *en_IO) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_IO'
func (en *en_IO) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_IO'
func (en *en_IO) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_IO'
func (en *en_IO) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_IO) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_IO) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_IO) GetMiscPatterns() *locales.MiscPatterns {
