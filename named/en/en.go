	...
	return &en{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"c", "%vc", "%vc", ""},
				Long:   &locales.CounterFormat{"centuries", "%v century", "%v centuries", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dec", "%vdec", "%vdec", ""},
				Long:   &locales.CounterFormat{"decades", "%v decade", "%v decades", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"yr", "%vy", "%vy", ""},
				Long:   &locales.CounterFormat{"years", "%v year", "%v years", "%v per year"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"month", "%vm", "%vm", ""},
				Long:   &locales.CounterFormat{"months", "%v month", "%v months", "%v per month"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"wk", "%vw", "%vw", ""},
				Long:   &locales.CounterFormat{"weeks", "%v week", "%v weeks", "%v per week"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"day", "%vd", "%vd", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"hour", "%vh", "%vh", ""},
				Long:   &locales.CounterFormat{"hours", "%v hour", "%v hours", "%v per hour"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%vm", "%vm", ""},
				Long:   &locales.CounterFormat{"minutes", "%v minute", "%v minutes", "%v per minute"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sec", "%vs", "%vs", ""},
				Long:   &locales.CounterFormat{"seconds", "%v second", "%v seconds", "%v per second"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"msec", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"milliseconds", "%v millisecond", "%v milliseconds", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μsec", "%vμs", "%vμs", ""},
				Long:   &locales.CounterFormat{"microseconds", "%v microsecond", "%v microseconds", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%vns", "%vns", ""},
				Long:   &locales.CounterFormat{"nanoseconds", "%v nanosecond", "%v nanoseconds", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"",
			"%[1]v+",
...
// DateFullLayout returns the full date layout for 'en'
func (en *en) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en'
func (en *en) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en'
func (en *en) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en'
func (en *en) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en'
func (en *en) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en'
func (en *en) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en'
func (en *en) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en'
func (en *en) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en) GetMiscPatterns() *locales.MiscPatterns {
