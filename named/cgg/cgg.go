...
// DateFullLayout returns the full date layout for 'cgg'
func (cgg *cgg) DateFullLayout() string {
	return cgg.dateFullLayout
}

// DateLongLayout returns the long date layout for 'cgg'
func (cgg *cgg) DateLongLayout() string {
	return cgg.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'cgg'
func (cgg *cgg) DateMediumLayout() string {
	return cgg.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'cgg'
func (cgg *cgg) DateShortLayout() string {
	return cgg.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'cgg'
func (cgg *cgg) TimeFullLayout() string {
	return cgg.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'cgg'
func (cgg *cgg) TimeLongLayout() string {
	return cgg.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'cgg'
func (cgg *cgg) TimeMediumLayout() string {
	return cgg.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'cgg'
func (cgg *cgg) TimeShortLayout() string {
	return cgg.timeShortLayout
}

func (cgg *cgg) ListPatterns() *locales.ListPatterns {
	return cgg.listPatterns
}

func (cgg *cgg) GetDurationSpec() *locales.DurationSpec {
	return cgg.DurationSpec
}

func (cgg *cgg) GetMiscPatterns() *locales.MiscPatterns {
