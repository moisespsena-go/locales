...
func (root *root) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(root, root.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'root'
func (root *root) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(root, root.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'root'
func (root *root) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(root, root.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'root'
func (root *root) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(root, root.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'root'
func (root *root) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(root, root.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'root'
func (root *root) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(root, root.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'root'
func (root *root) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(root, root.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'root'
func (root *root) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(root, root.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'root'
func (root *root) DateFullLayout() string {
	return root.dateFullLayout
}

// DateLongLayout returns the long date layout for 'root'
func (root *root) DateLongLayout() string {
	return root.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'root'
func (root *root) DateMediumLayout() string {
	return root.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'root'
func (root *root) DateShortLayout() string {
	return root.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'root'
func (root *root) TimeFullLayout() string {
	return root.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'root'
func (root *root) TimeLongLayout() string {
	return root.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'root'
func (root *root) TimeMediumLayout() string {
	return root.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'root'
func (root *root) TimeShortLayout() string {
	return root.timeShortLayout
}

func (root *root) ListPatterns() *locales.ListPatterns {
	return root.listPatterns
}

func (root *root) GetDurationSpec() *locales.DurationSpec {
	return root.DurationSpec
}

func (root *root) GetMiscPatterns() *locales.MiscPatterns {
	return &root.miscPatterns
}
