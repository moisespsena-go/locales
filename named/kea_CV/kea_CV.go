...
func New() locales.Translator {
	return &kea_CV{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Otu", "Nuv", "Diz"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Janeru", "Febreru", "Marsu", "Abril", "Maiu", "Junhu", "Julhu", "Agostu", "Setenbru", "Otubru", "Nuvenbru", "Dizenbru"},
			WeekdaysAbbreviatedValue: []string{"dum", "sig", "ter", "kua", "kin", "ses", "sab"},
			WeekdaysNarrowValue:      []string{"D", "S", "T", "K", "K", "S", "S"},
			WeekdaysShortValue:       []string{"du", "si", "te", "ku", "ki", "se", "sa"},
			WeekdaysWideValue:        []string{"dumingu", "sigunda-fera", "tersa-fera", "kuarta-fera", "kinta-fera", "sesta-fera", "sábadu"},
			PeriodsAbbreviatedValue:  []string{"am", "pm"},
			PeriodsWideValue:         []string{"am", "pm"},
			ErasAbbreviatedValue:     []string{"AK", "DK"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"antis di Kristu", "dispos di Kristu"},
			TimezonesValue:           map[string]string{"": "", "ACDT": "Ora di Veron di Austrália Sentral", "ACST": "Ora Padron di Austrália Sentral", "ACT": "ACT", "ACWDT": "Ora di Veron di Austrália Sentru-Osidental", "ACWST": "Ora Padron di Austrália Sentru-Osidental", "ADT": "Ora di Veron di Atlántiku", "AEDT": "Ora di Veron di Austrália Oriental", "AEST": "Ora Padron di Austrália Oriental", "AFT": "AFT", "AKDT": "Ora di Veron di Alaska", "AKST": "Ora Padron di Alaska", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "Ora Padron di Atlántiku", "AWDT": "Ora di Veron di Austrália Osidental", "AWST": "Ora Padron di Austrália Osidental", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "Ora di Áfrika Sentral", "CCT": "CCT", "CDT": "Ora di Veron Sentral", "CDT (Kuba)": "Ora di Veron di Kuba", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "Ora Padron Sentral", "CST (Kuba)": "Ora Padron di Kuba", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "Ora di Áfrika Oriental", "ECT": "ECT", "EDT": "Ora di Veron Oriental", "EGDT": "Ora di Veron di Gronelándia Oriental", "EGST": "Ora Padron di Gronelándia Oriental", "EST": "Ora Padron Oriental", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "Ora Médiu di Greenwich", "GST": "GST", "GYT": "GYT", "HADT": "Ora di Veron di Avaí i Aleutas", "HAST": "Ora Padron di Avaí i Aleutas", "HENOMX": "Ora di Veron di Noroesti di Méxiku", "HEOG": "Ora di Veron di Gronelándia Osidental", "HEPMX": "Ora di Veron di Pasífiku Mexikanu", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "Ora Padron di Noroesti di Méxiku", "HNOG": "Ora Padron di Gronelándia Osidental", "HNPMX": "Ora Padron di Pasífiku Mexikanu", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "Ora di Veron di Europa Sentral", "MEZ": "Ora Padron di Europa Sentral", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "Ora di Veron di Tera Nova", "NPT": "NPT", "NST": "Ora Padron di Tera Nova", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "Ora di Veron di Europa Oriental", "OEZ": "Ora Padron di Europa Oriental", "PDT": "Ora di Veron di Pasífiku", "PKT": "PKT", "PMDT": "Ora di Veron di San Pedru i Mikelon", "PMST": "Ora Padron di San Pedru i Mikelon", "PST": "Ora Padron di Pasífiku", "PYST": "PYST", "SAST": "Ora di Sul di Áfrika", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "Ora di Veron di Áfrika Osidental", "WAT": "Ora Padron di Áfrika Osidental", "WESZ": "Ora di Veron di Europa Osidental", "WEZ": "Ora Padron di Europa Osidental", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		dateFullLayout:   "EEEE, d 'di' MMMM 'di' y",
		dateLongLayout:   "d 'di' MMMM 'di' y",
...
func (kea *kea_CV) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(kea, kea.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'kea_CV'
func (kea *kea_CV) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(kea, kea.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'kea_CV'
func (kea *kea_CV) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(kea, kea.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'kea_CV'
func (kea *kea_CV) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(kea, kea.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'kea_CV'
func (kea *kea_CV) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(kea, kea.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'kea_CV'
func (kea *kea_CV) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(kea, kea.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'kea_CV'
func (kea *kea_CV) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(kea, kea.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'kea_CV'
func (kea *kea_CV) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(kea, kea.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'kea_CV'
func (kea *kea_CV) DateFullLayout() string {
	return kea.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kea_CV'
func (kea *kea_CV) DateLongLayout() string {
	return kea.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kea_CV'
func (kea *kea_CV) DateMediumLayout() string {
	return kea.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kea_CV'
func (kea *kea_CV) DateShortLayout() string {
	return kea.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kea_CV'
func (kea *kea_CV) TimeFullLayout() string {
	return kea.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kea_CV'
func (kea *kea_CV) TimeLongLayout() string {
	return kea.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kea_CV'
func (kea *kea_CV) TimeMediumLayout() string {
	return kea.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kea_CV'
func (kea *kea_CV) TimeShortLayout() string {
	return kea.timeShortLayout
}

func (kea *kea_CV) ListPatterns() *locales.ListPatterns {
	return kea.listPatterns
}

func (kea *kea_CV) GetDurationSpec() *locales.DurationSpec {
	return kea.DurationSpec
}

func (kea *kea_CV) GetMiscPatterns() *locales.MiscPatterns {
	return &kea.miscPatterns
}
