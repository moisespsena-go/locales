...
func New() locales.Translator {
	return &rof_TZ{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "M1", "M2", "M3", "M4", "M5", "M6", "M7", "M8", "M9", "M10", "M11", "M12"},
			MonthsNarrowValue:        []string{"", "K", "K", "K", "K", "T", "S", "S", "N", "T", "I", "I", "I"},
			MonthsWideValue:          []string{"", "Mweri wa kwanza", "Mweri wa kaili", "Mweri wa katatu", "Mweri wa kaana", "Mweri wa tanu", "Mweri wa sita", "Mweri wa saba", "Mweri wa nane", "Mweri wa tisa", "Mweri wa ikumi", "Mweri wa ikumi na moja", "Mweri wa ikumi na mbili"},
			WeekdaysAbbreviatedValue: []string{"Ijp", "Ijt", "Ijn", "Ijtn", "Alh", "Iju", "Ijm"},
			WeekdaysNarrowValue:      []string{"2", "3", "4", "5", "6", "7", "1"},
			WeekdaysWideValue:        []string{"Ijumapili", "Ijumatatu", "Ijumanne", "Ijumatano", "Alhamisi", "Ijumaa", "Ijumamosi"},
			PeriodsAbbreviatedValue:  []string{"kang’ama", "kingoto"},
			PeriodsWideValue:         []string{"kang’ama", "kingoto"},
			ErasAbbreviatedValue:     []string{"KM", "BM"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Kabla ya Mayesu", "Baada ya Mayesu"},
...
func (rof *rof_TZ) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(rof, rof.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'rof_TZ'
func (rof *rof_TZ) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(rof, rof.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'rof_TZ'
func (rof *rof_TZ) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(rof, rof.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'rof_TZ'
func (rof *rof_TZ) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(rof, rof.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'rof_TZ'
func (rof *rof_TZ) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(rof, rof.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'rof_TZ'
func (rof *rof_TZ) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(rof, rof.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'rof_TZ'
func (rof *rof_TZ) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(rof, rof.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'rof_TZ'
func (rof *rof_TZ) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(rof, rof.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'rof_TZ'
func (rof *rof_TZ) DateFullLayout() string {
	return rof.dateFullLayout
}

// DateLongLayout returns the long date layout for 'rof_TZ'
func (rof *rof_TZ) DateLongLayout() string {
	return rof.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'rof_TZ'
func (rof *rof_TZ) DateMediumLayout() string {
	return rof.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'rof_TZ'
func (rof *rof_TZ) DateShortLayout() string {
	return rof.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'rof_TZ'
func (rof *rof_TZ) TimeFullLayout() string {
	return rof.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'rof_TZ'
func (rof *rof_TZ) TimeLongLayout() string {
	return rof.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'rof_TZ'
func (rof *rof_TZ) TimeMediumLayout() string {
	return rof.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'rof_TZ'
func (rof *rof_TZ) TimeShortLayout() string {
	return rof.timeShortLayout
}

func (rof *rof_TZ) ListPatterns() *locales.ListPatterns {
	return rof.listPatterns
}

func (rof *rof_TZ) GetDurationSpec() *locales.DurationSpec {
	return rof.DurationSpec
}

func (rof *rof_TZ) GetMiscPatterns() *locales.MiscPatterns {
	return &rof.miscPatterns
}
