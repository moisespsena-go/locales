...
func New() locales.Translator {
	return &zu{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mas", "Eph", "Mey", "Jun", "Jul", "Aga", "Sep", "Okt", "Nov", "Dis"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "E", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Januwari", "Februwari", "Mashi", "Ephreli", "Meyi", "Juni", "Julayi", "Agasti", "Septhemba", "Okthoba", "Novemba", "Disemba"},
			WeekdaysAbbreviatedValue: []string{"Son", "Mso", "Bil", "Tha", "Sin", "Hla", "Mgq"},
			WeekdaysNarrowValue:      []string{"S", "M", "B", "T", "S", "H", "M"},
			WeekdaysShortValue:       []string{"Son", "Mso", "Bil", "Tha", "Sin", "Hla", "Mgq"},
			WeekdaysWideValue:        []string{"ISonto", "UMsombuluko", "ULwesibili", "ULwesithathu", "ULwesine", "ULwesihlanu", "UMgqibelo"},
			...
			ErasWideValue:            []string{"BC", "AD"},
			TimezonesValue:           map[string]string{"": "Isikhathi sase-Falkland Islands esijwayelekile", "ACDT": "Isikhathi sase-Australian Central sasemini", "ACST": "ACST", "ACT": "ACT", "ACWDT": "Isikhathi sasemini sase-Australian Central West", "ACWST": "Isikhathi sase-Australian Central West esivamile", "ADT": "Isikhathi sase-Atlantic sasemini", "AEDT": "Isikhathi sasemini sase-Australian East", "AEST": "Isikhathi esivamile sase-Australian East", "AFT": "Isikhathi sase-Afghanistan", "AKDT": "Isikhathi sase-Alaska sasemini", "AKST": "Isikhathi sase-Alaska esijwayelekile", "AMST": "Isikhathi sase-Amazon sasehlobo", "AMT": "Isikhathi sase-Amazon esijwayelekile", "ARST": "Isikhathi sase-Argentina sasehlobo", "ART": "Isikhathi sase-Argentina esijwayelekile", "AST": "Isikhathi sase-Atlantic esijwayelekile", "AWDT": "Isikhathi sase-Australian Western sasemini", "AWST": "Isikhathi sase-Australian Western esivamile", "BNT": "Isikhathi sase-Brunei Darussalam", "BOT": "Isikhathi sase-Bolivia", "BRST": "Isikhathi sase-Brasilia sasehlobo", "BRT": "Isikhathi sase-Brasilia esijwayelekile", "BST": "Isikhathi sase-Bangladesh sasehlobo", "BTT": "Isikhathi sase-Bhutan", "CAT": "Isikhathi sase-Central Africa", "CCT": "Isikhathi sase-Cocos Islands", "CDT": "Isikhathi sase-North American Central sasemini", "CDT (Kuba)": "Isikhathi sase-Cuba sasemini", "CHADT": "Isikhathi sasemini sase-Chatham", "CHAST": "Isikhathi esivamile sase-Chatham", "CLST": "Isikhathi sase-Chile sasehlobo", "CLT": "Isikhathi sase-Chile esijwayelekile", "COST": "Isikhathi sase-Colombia sasehlobo", "COT": "Isikhathi sase-Colombia esijwayelekile", "CST": "Isikhathi sase-North American Central esijwayelekile", "CST (Kuba)": "Isikhathi sase-Cuba esijwayelekile", "CXT": "Isikhathi sase-Christmas Island", "ChST": "Isikhathi esivamile sase-Chamorro", "EASST": "Isikhathi sase-Easter Island sasehlobo", "EAST": "Isikhathi sase-Easter Island esijwayelekile", "EAT": "Isikhathi saseMpumalanga Afrika", "ECT": "Isikhathi sase-Ecuador", "EDT": "Isikhathi sase-North American East sasemini", "EGDT": "Isikhathi sase-East Greenland sasemini", "EGST": "Isikhathi sase-East Greenland esijwayelekile", "EST": "Isikhathi sase-North American East esijwayelekile", "FKST": "Isikhathi sase-Falkland Islands sasehlobo", "GALT": "Isikhathi sase-Galapagos", "GFT": "Isikhathi sase-French Guiana", "GMT": "Isikhathi sase-Greenwich Mean", "GST": "Isikhathi esivamile sase-Gulf", "GYT": "Isikhathi sase-Guyana", "HADT": "Isikhathi sase-Hawaii-Aleutia sasemini", "HAST": "Isikhathi sase-Hawaii-Aleutia esijwayelekile", "HENOMX": "Isikhathi sase-Northwest Mexico sasemini", "HEOG": "Isikhathi sase-West Greenland sasehlobo", "HEPMX": "Isikhathi sase-Mexican Pacific sasemini", "HKST": "Isikhathi sehlobo sase-Hong Kong", "HKT": "Isikhathi esivamile sase-Hong Kong", "HNNOMX": "Isikhathi sase-Northwest Mexico esijwayelekile", "HNOG": "Isikhathi sase-West Greenland esijwayelekile", "HNPMX": "Isikhathi sase-Mexican Pacific esijwayelekile", "ICT": "Isikhathi sase-Indochina", "IRDT": "Isikhathi sase-Iran sasemini", "IRST": "Isikhathi sase-Iran esivamile", "IST": "Isikhathi sase-India esivamile", "JDT": "Isikhathi semini sase-Japan", "JST": "Isikhathi esivamile sase-Japan", "LHDT": "Isikhathi sase-Lord Howe sasemini", "LHST": "Isikhathi sase-Lord Howe esivamile", "MDT": "MDT", "MESZ": "Isikhathi sasehlobo sase-Central Europe", "MEZ": "Isikhathi esijwayelekile sase-Central Europe", "MST": "MST", "MVT": "Isikhathi sase-Maldives", "MYT": "Isikhathi sase-Malaysia", "NDT": "Isikhathi sase-Newfoundland sasemini", "NPT": "Isikhathi sase-Nepal", "NST": "Isikhathi sase-Newfoundland esijwayelekile", "NZDT": "Isikhathi sasemini sase-New Zealand", "NZST": "Isikhathi esivamile sase-New Zealand", "OESZ": "Isikhathi sasehlobo sase-Eastern Europe", "OEZ": "Isikhathi esijwayelekile sase-Eastern Europe", "PDT": "Isikhathi sase-North American Pacific sasemini", "PKT": "Isikhathi sase-Pakistan sasehlobo", "PMDT": "Isikhathi sase-Saint Pierre nase-Miquelon sasemini", "PMST": "Iikhathi sase-Saint Pierre nase-Miquelon esijwayelekile", "PST": "Isikhathi sase-North American Pacific esijwayelekile", "PYST": "Isikhathi sase-Paraguay sasehlobo", "SAST": "Isikhathi esivamile saseNingizimu Afrika", "SGT": "Isikhathi esivamile sase-Singapore", "SRT": "Isikhathi sase-Suriname", "TLT": "Isikhathi sase-East Timor", "TMST": "Isikhathi sehlobo sase-Turkmenistan", "TMT": "Isikhathi esivamile sase-Turkmenistan", "UYST": "Isikhathi sase-Uruguay sasehlobo", "UYT": "Isikhathi sase-Uruguay esijwayelekile", "VET": "Isikhathi sase-Venezuela", "WARST": "Isikhathi saseNyakatho ne-Argentina sasehlobo", "WART": "Isikhathi saseNyakatho ne-Argentina esijwayelekile", "WAST": "Isikhathi sasehlobo saseNtshonalanga Afrika", "WAT": "Isikhathi esivamile saseNtshonalanga Afrika", "WESZ": "Isikhathi sasehlobo sase-Western Europe", "WEZ": "Isikhathi esijwayelekile sase-Western Europe", "WIB": "Isikhathi sase-Western Indonesia", "WIT": "Isikhathi sase-Eastern Indonesia", "WITA": "Isikhathi sase-Central Indonesia", "∅∅∅": "Isikhathi sase-Peru sasehlobo"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} ne-{1}", "{0}, {1}", "{0}, {1}", "{0}, ne-{1}"}, {"{0} or {1}", "{0}, {1}", "{0}, {1}", "{0}, or {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"c", "%v c", "%v c", ""},
				Long:   &locales.CounterFormat{"c", "%v c", "%v c", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "%v dec", "%v decades", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"y", "%v y", "%v y", ""},
				Long:   &locales.CounterFormat{"y", "%v y", "%v y", "%v/y"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"izinyanga", "%v m", "%v m", ""},
				Long:   &locales.CounterFormat{"izinyanga", "%v inyanga", "%v izinyanga", "%v ngenyanga"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"amaviki", "%v w", "%v w", ""},
				Long:   &locales.CounterFormat{"amaviki", "%v iviki", "%v amaviki", "%v/w"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"izinsuku", "%v", "%v suku", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"amahora", "%v hora", "%v hora", ""},
				Long:   &locales.CounterFormat{"amahora", "%v ihora", "%v amahora", "%v/h"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"amaminithi", "%v umzuzu", "%v umzuzu", ""},
				Long:   &locales.CounterFormat{"amaminithi", "%v iminithi", "%v amaminithi", "%v/min"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"isekhondi", "%v s", "%v s", ""},
				Long:   &locales.CounterFormat{"amasekhondi", "%v isekhondi", "%v amasekhondi", "%vps"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"microseconds", "%v microsecond", "%v microseconds", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
...
func (zu *zu) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(zu, zu.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'zu'
func (zu *zu) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(zu, zu.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'zu'
func (zu *zu) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(zu, zu.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'zu'
func (zu *zu) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(zu, zu.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'zu'
func (zu *zu) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(zu, zu.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'zu'
func (zu *zu) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(zu, zu.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'zu'
func (zu *zu) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(zu, zu.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'zu'
func (zu *zu) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(zu, zu.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'zu'
func (zu *zu) DateFullLayout() string {
	return zu.dateFullLayout
}

// DateLongLayout returns the long date layout for 'zu'
func (zu *zu) DateLongLayout() string {
	return zu.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'zu'
func (zu *zu) DateMediumLayout() string {
	return zu.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'zu'
func (zu *zu) DateShortLayout() string {
	return zu.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'zu'
func (zu *zu) TimeFullLayout() string {
	return zu.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'zu'
func (zu *zu) TimeLongLayout() string {
	return zu.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'zu'
func (zu *zu) TimeMediumLayout() string {
	return zu.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'zu'
func (zu *zu) TimeShortLayout() string {
	return zu.timeShortLayout
}

func (zu *zu) ListPatterns() *locales.ListPatterns {
	return zu.listPatterns
}

func (zu *zu) GetDurationSpec() *locales.DurationSpec {
	return zu.DurationSpec
}

func (zu *zu) GetMiscPatterns() *locales.MiscPatterns {
	return &zu.miscPatterns
}
