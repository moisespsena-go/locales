...
// DateFullLayout returns the full date layout for 'tk_TM'
func (tk *tk_TM) DateFullLayout() string {
	return tk.dateFullLayout
}

// DateLongLayout returns the long date layout for 'tk_TM'
func (tk *tk_TM) DateLongLayout() string {
	return tk.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'tk_TM'
func (tk *tk_TM) DateMediumLayout() string {
	return tk.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'tk_TM'
func (tk *tk_TM) DateShortLayout() string {
	return tk.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'tk_TM'
func (tk *tk_TM) TimeFullLayout() string {
	return tk.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'tk_TM'
func (tk *tk_TM) TimeLongLayout() string {
	return tk.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'tk_TM'
func (tk *tk_TM) TimeMediumLayout() string {
	return tk.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'tk_TM'
func (tk *tk_TM) TimeShortLayout() string {
	return tk.timeShortLayout
}

func (tk *tk_TM) ListPatterns() *locales.ListPatterns {
	return tk.listPatterns
}

func (tk *tk_TM) GetDurationSpec() *locales.DurationSpec {
	return tk.DurationSpec
}

func (tk *tk_TM) GetMiscPatterns() *locales.MiscPatterns {
