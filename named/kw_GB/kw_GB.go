...
func New() locales.Translator {
	return &kw_GB{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Gen", "Hwe", "Meu", "Ebr", "Me", "Met", "Gor", "Est", "Gwn", "Hed", "Du", "Kev"},
			MonthsWideValue:          []string{"", "mis Genver", "mis Hwevrer", "mis Meurth", "mis Ebrel", "mis Me", "mis Metheven", "mis Gortheren", "mis Est", "mis Gwynngala", "mis Hedra", "mis Du", "mis Kevardhu"},
			WeekdaysAbbreviatedValue: []string{"Sul", "Lun", "Mth", "Mhr", "Yow", "Gwe", "Sad"},
			WeekdaysWideValue:        []string{"dy Sul", "dy Lun", "dy Meurth", "dy Merher", "dy Yow", "dy Gwener", "dy Sadorn"},
...
func (kw *kw_GB) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(kw, kw.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'kw_GB'
func (kw *kw_GB) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(kw, kw.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'kw_GB'
func (kw *kw_GB) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(kw, kw.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'kw_GB'
func (kw *kw_GB) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(kw, kw.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'kw_GB'
func (kw *kw_GB) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(kw, kw.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'kw_GB'
func (kw *kw_GB) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(kw, kw.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'kw_GB'
func (kw *kw_GB) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(kw, kw.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'kw_GB'
func (kw *kw_GB) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(kw, kw.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'kw_GB'
func (kw *kw_GB) DateFullLayout() string {
	return kw.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kw_GB'
func (kw *kw_GB) DateLongLayout() string {
	return kw.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kw_GB'
func (kw *kw_GB) DateMediumLayout() string {
	return kw.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kw_GB'
func (kw *kw_GB) DateShortLayout() string {
	return kw.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kw_GB'
func (kw *kw_GB) TimeFullLayout() string {
	return kw.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kw_GB'
func (kw *kw_GB) TimeLongLayout() string {
	return kw.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kw_GB'
func (kw *kw_GB) TimeMediumLayout() string {
	return kw.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kw_GB'
func (kw *kw_GB) TimeShortLayout() string {
	return kw.timeShortLayout
}

func (kw *kw_GB) ListPatterns() *locales.ListPatterns {
	return kw.listPatterns
}

func (kw *kw_GB) GetDurationSpec() *locales.DurationSpec {
	return kw.DurationSpec
}

func (kw *kw_GB) GetMiscPatterns() *locales.MiscPatterns {
	return &kw.miscPatterns
}
