...
// DateFullLayout returns the full date layout for 'fil_PH'
func (fil *fil_PH) DateFullLayout() string {
	return fil.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fil_PH'
func (fil *fil_PH) DateLongLayout() string {
	return fil.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fil_PH'
func (fil *fil_PH) DateMediumLayout() string {
	return fil.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fil_PH'
func (fil *fil_PH) DateShortLayout() string {
	return fil.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fil_PH'
func (fil *fil_PH) TimeFullLayout() string {
	return fil.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fil_PH'
func (fil *fil_PH) TimeLongLayout() string {
	return fil.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fil_PH'
func (fil *fil_PH) TimeMediumLayout() string {
	return fil.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fil_PH'
func (fil *fil_PH) TimeShortLayout() string {
	return fil.timeShortLayout
}

func (fil *fil_PH) ListPatterns() *locales.ListPatterns {
	return fil.listPatterns
}

func (fil *fil_PH) GetDurationSpec() *locales.DurationSpec {
	return fil.DurationSpec
}

func (fil *fil_PH) GetMiscPatterns() *locales.MiscPatterns {
