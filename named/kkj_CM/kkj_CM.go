...
func New() locales.Translator {
	return &kkj_CM{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsWideValue:          []string{"", "pamba", "wanja", "mbiyɔ mɛndoŋgɔ", "Nyɔlɔmbɔŋgɔ", "Mɔnɔ ŋgbanja", "Nyaŋgwɛ ŋgbanja", "kuŋgwɛ", "fɛ", "njapi", "nyukul", "M11", "ɓulɓusɛ"},
			WeekdaysAbbreviatedValue: []string{"sɔndi", "lundi", "mardi", "mɛrkɛrɛdi", "yedi", "vaŋdɛrɛdi", "mɔnɔ sɔndi"},
			WeekdaysNarrowValue:      []string{"so", "lu", "ma", "mɛ", "ye", "va", "ms"},
			WeekdaysShortValue:       []string{"sɔndi", "lundi", "mardi", "mɛrkɛrɛdi", "yedi", "vaŋdɛrɛdi", "mɔnɔ sɔndi"},
			WeekdaysWideValue:        []string{"sɔndi", "lundi", "mardi", "mɛrkɛrɛdi", "yedi", "vaŋdɛrɛdi", "mɔnɔ sɔndi"},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"", "{0}, {1}", "{0}, {1}", "{0}, {1}"}, []string(nil)}),
		miscPatterns: locales.MiscPatterns{
			"",
			"",
			"",
...
func (kkj *kkj_CM) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(kkj, kkj.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'kkj_CM'
func (kkj *kkj_CM) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(kkj, kkj.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'kkj_CM'
func (kkj *kkj_CM) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(kkj, kkj.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'kkj_CM'
func (kkj *kkj_CM) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(kkj, kkj.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'kkj_CM'
func (kkj *kkj_CM) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(kkj, kkj.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'kkj_CM'
func (kkj *kkj_CM) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(kkj, kkj.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'kkj_CM'
func (kkj *kkj_CM) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(kkj, kkj.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'kkj_CM'
func (kkj *kkj_CM) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(kkj, kkj.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'kkj_CM'
func (kkj *kkj_CM) DateFullLayout() string {
	return kkj.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kkj_CM'
func (kkj *kkj_CM) DateLongLayout() string {
	return kkj.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kkj_CM'
func (kkj *kkj_CM) DateMediumLayout() string {
	return kkj.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kkj_CM'
func (kkj *kkj_CM) DateShortLayout() string {
	return kkj.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kkj_CM'
func (kkj *kkj_CM) TimeFullLayout() string {
	return kkj.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kkj_CM'
func (kkj *kkj_CM) TimeLongLayout() string {
	return kkj.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kkj_CM'
func (kkj *kkj_CM) TimeMediumLayout() string {
	return kkj.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kkj_CM'
func (kkj *kkj_CM) TimeShortLayout() string {
	return kkj.timeShortLayout
}

func (kkj *kkj_CM) ListPatterns() *locales.ListPatterns {
	return kkj.listPatterns
}

func (kkj *kkj_CM) GetDurationSpec() *locales.DurationSpec {
	return kkj.DurationSpec
}

func (kkj *kkj_CM) GetMiscPatterns() *locales.MiscPatterns {
	return &kkj.miscPatterns
}
