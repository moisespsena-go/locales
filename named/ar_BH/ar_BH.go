...
// DateFullLayout returns the full date layout for 'ar_BH'
func (ar *ar_BH) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_BH'
func (ar *ar_BH) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_BH'
func (ar *ar_BH) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_BH'
func (ar *ar_BH) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_BH'
func (ar *ar_BH) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_BH'
func (ar *ar_BH) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_BH'
func (ar *ar_BH) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_BH'
func (ar *ar_BH) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_BH) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_BH) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_BH) GetMiscPatterns() *locales.MiscPatterns {
