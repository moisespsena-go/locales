...
// DateFullLayout returns the full date layout for 'ff_Latn_SN'
func (ff *ff_Latn_SN) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff_Latn_SN'
func (ff *ff_Latn_SN) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff_Latn_SN'
func (ff *ff_Latn_SN) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff_Latn_SN'
func (ff *ff_Latn_SN) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff_Latn_SN'
func (ff *ff_Latn_SN) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff_Latn_SN'
func (ff *ff_Latn_SN) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff_Latn_SN'
func (ff *ff_Latn_SN) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff_Latn_SN'
func (ff *ff_Latn_SN) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff_Latn_SN) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff_Latn_SN) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff_Latn_SN) GetMiscPatterns() *locales.MiscPatterns {
