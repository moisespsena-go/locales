...
// New returns a new instance of translator for the 'doi' locale
func New() locales.Translator {
	return &doi{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "जन.", "फर.", "मार्च", "अप्रैल", "मेई", "जून", "जुलाई", "अग.", "सित.", "अक्तू.", "नव.", "दिस."},
			MonthsNarrowValue:        []string{"", "ज", "फ", "मा", "अ", "मे", "जू", "जु", "अ", "सि", "अ", "न", "दि"},
			MonthsWideValue:          []string{"", "जनवरी", "फरवरी", "मार्च", "अप्रैल", "मेई", "जून", "जुलाई", "अगस्त", "सितंबर", "अत्तूबर", "नवंबर", "दिसंबर"},
			WeekdaysAbbreviatedValue: []string{"ऐत", "सोम", "मंगल", "बुध", "बीर", "शुक्र", "शनि"},
			WeekdaysNarrowValue:      []string{"ऐ.", "सो.", "म.", "बु.", "बी.", "शु.", "श."},
			WeekdaysShortValue:       []string{"ऐत", "सोम", "मंगल", "बुध", "बीर", "शुक्र", "शनि"},
			WeekdaysWideValue:        []string{"ऐतबार", "सोमबार", "मंगलबार", "बुधबार", "बीरबार", "शुक्रबार", "शनीबार"},
			PeriodsAbbreviatedValue:  []string{"सवेर", "स’ञ"},
			PeriodsNarrowValue:       []string{"सवेर", "स’ञ"},
			PeriodsWideValue:         []string{"सवेर", "बाद दपैहर"},
			ErasAbbreviatedValue:     []string{"", ""},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"", ""},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "अटलांटिक डेलाइट समां", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "अटलांटिक मानक समां", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "CAT", "CCT": "CCT", "CDT": "उत्तरी अमरीकी डेलाइट केंदरी समां", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "उत्तरी अमरीकी मानक केंदरी समां", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "EAT", "ECT": "ECT", "EDT": "उत्तरी अमरीकी डेलाइट पूर्वी समां", "EGDT": "EGDT", "EGST": "EGST", "EST": "उत्तरी अमरीकी मानक पूर्वी समां", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "ग्रीनविच मीन टाइम", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "केंदरी यूरोपी गर्मियें दा समां", "MEZ": "केंदरी यूरोपी मानक समां", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "उत्तरी यूरोपी गर्मियें दा समां", "OEZ": "उत्तरी यूरोपी मानक समां", "PDT": "उत्तरी अमरीकी डेलाइट प्रशांत समां", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "उत्तरी अमरीकी मानक प्रशांत समां", "PYST": "PYST", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "पच्छमी यूरोपी गर्मियें दा समां", "WEZ": "पच्छमी यूरोपी मानक समां", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} ते {1}", "{0}, {1}", "{0}, {1}", "{0}, ते {1}"}, []string(nil)}),
...
func (doi *doi) Locale() string {
	return doi.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'doi'
func (doi *doi) PluralsCardinal() []locales.PluralRule {
	return doi.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'doi'
func (doi *doi) PluralsOrdinal() []locales.PluralRule {
	return doi.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'doi'
func (doi *doi) PluralsRange() []locales.PluralRule {
	return doi.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'doi'
func (doi *doi) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'doi'
func (doi *doi) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'doi'
func (doi *doi) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// FmtDateShort returns the short date representation of 't' for 'doi'
func (doi *doi) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(doi, doi.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'doi'
func (doi *doi) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(doi, doi.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'doi'
func (doi *doi) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(doi, doi.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'doi'
func (doi *doi) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(doi, doi.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'doi'
func (doi *doi) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(doi, doi.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'doi'
func (doi *doi) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(doi, doi.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'doi'
func (doi *doi) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(doi, doi.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'doi'
func (doi *doi) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(doi, doi.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'doi'
func (doi *doi) DateFullLayout() string {
	return doi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'doi'
func (doi *doi) DateLongLayout() string {
	return doi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'doi'
func (doi *doi) DateMediumLayout() string {
	return doi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'doi'
func (doi *doi) DateShortLayout() string {
	return doi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'doi'
func (doi *doi) TimeFullLayout() string {
	return doi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'doi'
func (doi *doi) TimeLongLayout() string {
	return doi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'doi'
func (doi *doi) TimeMediumLayout() string {
	return doi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'doi'
func (doi *doi) TimeShortLayout() string {
	return doi.timeShortLayout
}

func (doi *doi) ListPatterns() *locales.ListPatterns {
	return doi.listPatterns
}

func (doi *doi) GetDurationSpec() *locales.DurationSpec {
	return doi.DurationSpec
}

func (doi *doi) GetMiscPatterns() *locales.MiscPatterns {
	return &doi.miscPatterns
}
