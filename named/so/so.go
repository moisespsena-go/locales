...
func New() locales.Translator {
	return &so{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mar", "Abr", "May", "Jun", "Lul", "Ogs", "Seb", "Okt", "Nof", "Dis"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "L", "O", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Bisha Koobaad", "Bisha Labaad", "Bisha Saddexaad", "Bisha Afraad", "Bisha Shanaad", "Bisha Lixaad", "Bisha Todobaad", "Bisha Sideedaad", "Bisha Sagaalaad", "Bisha Tobnaad", "Bisha Kow iyo Tobnaad", "Bisha Laba iyo Tobnaad"},
			WeekdaysAbbreviatedValue: []string{"Axd", "Isn", "Tldo", "Arbc", "Khms", "Jmc", "Sbti"},
			WeekdaysNarrowValue:      []string{"A", "I", "T", "A", "Kh", "J", "S"},
			WeekdaysShortValue:       []string{"Axd", "Isn", "Tldo", "Arbc", "Khms", "Jmc", "Sbti"},
			WeekdaysWideValue:        []string{"Axad", "Isniin", "Talaado", "Arbaco", "Khamiis", "Jimco", "Sabti"},
			PeriodsAbbreviatedValue:  []string{"GH", "GD"},
			PeriodsNarrowValue:       []string{"h", "d"},
			PeriodsWideValue:         []string{"GH", "GD"},
			ErasAbbreviatedValue:     []string{"BC", "AD"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Ciise Hortii", "Ciise Dabadii"},
			TimezonesValue:           map[string]string{"": "Waqtiga Caadiga Ah ee Baragwaay", "ACDT": "Waqtiga Dharaarta ee Bartamaha Astaraaliya", "ACST": "Waqtiga Caadiga Ah ee Bartamaha Astaraaliya", "ACT": "Wakhtiga Caadiga ah ee Acre", "ACWDT": "Waqtiga Dharaarta Bartamaha Galbeedka Australiya", "ACWST": "Waqtiga Caadiga Ah ee Bartamaha Galbeedka Astaraaliya", "ADT": "Waqtiga Dharaarta ee Atlantika Waqooyiga Ameerika", "AEDT": "Waqtiga Dharaarta ee Bariga Astaraaliya", "AEST": "Waqtiyada Caadiga ah ee Bariga Astaraaliya", "AFT": "Waqtiga Afggaanistaan", "AKDT": "Waqtiga Dharaarta ee Alaska", "AKST": "Waqtiga Caadiga Ah ee Alaska", "AMST": "Waqtiga Xagaaga ee Amason", "AMT": "Waqtiga Caadiga Ah ee Amason", "ARST": "Waqtiga Xagaaga ee Arjentiina", "ART": "Waqtiga Caadiga Ah ee Arjentiina", "AST": "Waqtiga Caadiga Ah ee Atlantika Waqooyiga Ameerika", "AWDT": "Waqtiga Dharaarta ee Galbeedka Astaraaliya", "AWST": "Waqtiga Caadiga Ah ee Galbeedka Astaraaliya", "BNT": "Waqtiga Buruney Daarusalaam", "BOT": "Waqtiga Boliifiya", "BRST": "Waqtiga Xagaaga ee Baraasiliya", "BRT": "Waqtiga Caadiga ah ee Baraasiliya", "BST": "Waqtiga Xagaaga ee Bangledeesh", "BTT": "Waqtiga Butaan", "CAT": "Waqtiga Bartamaha Afrika", "CCT": "Waqtiga Kokos Aylaan", "CDT": "Waqtiga Dharaarta ee Bartamaha Waqooyiga Ameerika", "CDT (Kuba)": "Waqtiga Dharaarta ee Kuuba", "CHADT": "Waqtiga Dharaarta ee Jaatam", "CHAST": "Waqtiga Caadiga Ah ee Jaatam", "CLST": "Waqtiga Xagaaga ee Jili", "CLT": "Waqtiga Caadiga Ah ee Jili", "COST": "Waqtiga Xagaaga ee Kolambiya", "COT": "Waqtiga Caadiga Ah ee Kolambiya", "CST": "Waqtiga Caadiga Ah ee Bartamaha Waqooyiga Ameerika", "CST (Kuba)": "Waqtiga Caadiga Ah ee Kuuba", "CXT": "Waqtiga Kirismas Aylaan", "ChST": "Waqtiga Jamoro", "EASST": "Waqtiga Xagaaga ee Iistar Aylaan", "EAST": "Waqtiga Caadiga Ah ee Iistar Aylaan", "EAT": "Waqtiga Bariga Afrika", "ECT": "Waqtiga Ekuwadoor", "EDT": "Waqtiga Dharaarta ee Bariga Waqooyiga Ameerika", "EGDT": "Waqtiga Xagaaga ee Bariga Giriinlaan", "EGST": "Waqtiga Caadiga ah ee Bariga Giriinlaan", "EST": "Waqtiga Caadiga Ah ee Bariga Waqooyiga Ameerika", "FKST": "Waqtiga Xagaaga ee Faalklaan Aylaanis", "GALT": "Waqtiga Galabagos", "GFT": "Waqtiga Ferenj Guyana", "GMT": "Wakhtiga Giriinwij", "GST": "Waqtiga Gacanka", "GYT": "Waqtiga Guyaana", "HADT": "Waqtiga Dharaarta ee Hawaay-Alutiyaan", "HAST": "Waqtiga Caadiga Ah ee Hawaay-Alutiyaan", "HENOMX": "Waqtiga Dharaarta ee Waqooyi-Galbeed Meksiko", "HEOG": "Waqtiga Xagaaga ee Galbeedka Giriinlaan", "HEPMX": "Waqtiga Dharaarta ee Baasifikada Meksiko", "HKST": "Waqtiga Xagaaga ee Hoong Koong", "HKT": "Waqtiga Caadiga Ah ee Hoong Koong", "HNNOMX": "Waqtiga Caadiga Ah ee Waqooyi-Galbeed Meksiko", "HNOG": "Waqtiga Caadiga Ah ee Galbeedka Giriinlaan", "HNPMX": "Waqtiga Caadiga Ah ee Baasifikada Meksiko", "ICT": "Waqtiga Indoshiina", "IRDT": "Waqtiga Dharaarta ee Iiraan", "IRST": "Waqtiga Caadiga Ah ee Iiraan", "IST": "Waqtiga Caadiga Ah ee Hindiya", "JDT": "Waqtiga Dharaarta ee Jabaan", "JST": "Waqtiga Caadiga Ah ee Jabaan", "LHDT": "Waqtiga Dharaarta ee Lod How", "LHST": "Waqtiga Caadiga Ah ee Lod How", "MDT": "Waqtiga Dharaarta ee Buurleyda Waqooyiga Ameerika", "MESZ": "Waqtiga Xagaaga ee Bartamaha Yurub", "MEZ": "Waqtiga Caadiga Ah ee Bartamaha Yurub", "MST": "Waqtiga Caadiga ah ee Buuraleyda Waqooyiga Ameerika", "MVT": "Waqtiga Maldifis", "MYT": "Waqtiga Maleyshiya", "NDT": "Waqtiga Dharaarta ee Niyuufoonlaan", "NPT": "Waqtiga Neebaal", "NST": "Waqtiga Caadiga Ah ee Niyuufoonlaan", "NZDT": "Waqtiga Dharaarta ee Niyuu Si’laan", "NZST": "Waqtiga Caadiga Ah ee Niyuu Si’laan", "OESZ": "Waqtiga Xagaaga ee Bariga Yurub", "OEZ": "Waqtiga Caadiga Ah ee Bariga Yurub", "PDT": "Waqtiga Dharaarta ee Basifika Waqooyiga Ameerika", "PKT": "Waqtiga Xagaaga ee Bakistaan", "PMDT": "Waqtiga Dharaarta ee St. Beere & Mikiwelon", "PMST": "Waqtiga Caadiga Ah St. Beere & Mikiwelon", "PST": "Waqtiga Caadiga ah ee Basifika Waqooyiga Ameerika", "PYST": "Waqtiga Xagaaga ee Baragwaay", "SAST": "Waqtiyada Caadiga Ah ee Koonfur Afrika", "SGT": "Waqtiga Singabuur", "SRT": "Waqtiga Surineym", "TLT": "Waqtiga Iist Timoor", "TMST": "Waqtiga Xagaaga ee Turkmenistan", "TMT": "Waqtiga Caadiga Ah ee Turkmenistan", "UYST": "Waqtiga Xagaaga ee Urugwaay", "UYT": "Waqtiga Caadiga Ah ee Urugwaay", "VET": "Waqtiga Fenezuweela", "WARST": "Waqtiga Xagaaga ee Galbeedka Arjentiina", "WART": "Waqtiga Caadiga Ah ee Galbeedka Arjentiina", "WAST": "Waqtiga Xagaaga ee Galbeedka Afrika", "WAT": "Waqtiga Caadiga Ah ee Galbeedka Afrika", "WESZ": "Waqtiga Xagaaga ee Galbeedka Yurub", "WEZ": "Waqtiga Caadiga Ah ee Galbeedka Yurub", "WIB": "Waqtiga Galbeedka Indoneeysiya", "WIT": "Waqtiga Indoneeysiya", "WITA": "Waqtiga Bartamaha Indoneeysiya", "∅∅∅": "Waqtiga Xagaaga ee Beeru"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} iyo {1}", "{0}, {1}", "{0}, {1}", "{0} iyo {1}"}, {"{0} ama {1}", "{0}, {1}", "{0}, {1}", "{0} ama {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"q", "%v q", "%v q", ""},
				Long:   &locales.CounterFormat{"qarni", "%v qarni", "%v qarniyo", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"toban sano", "%vdiis", "%vdiis", ""},
				Long:   &locales.CounterFormat{"rubuc qarni", "rubuc qarni", "%v dec", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"snd", "%vs", "%vs", ""},
				Long:   &locales.CounterFormat{"Sannado", "%v Sannad", "%v Sannado", "%v Sannadkiiba"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Bil", "%vb", "%vb", ""},
				Long:   &locales.CounterFormat{"Bilo", "%v bil", "%v bilood", "%v bishiiba"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"t", "%vt", "%vt", "%v/tobaadkii"},
				Long:   &locales.CounterFormat{"toddobaadyo", "%v toddobaad", "%v toddobaadyo", "%v toddobaadkiiba"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mln", "%vm", "%vm", "%v/m"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"scd", "%v scd", "%v s", ""},
				Long:   &locales.CounterFormat{"saacado", "%v saacad", "%v saacadood", "%v saacadiiba"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dqqd", "%vd", "%vd", ""},
				Long:   &locales.CounterFormat{"", "%v daqiiqad", "%v daqiiqo", "%v daqiiqadiiba"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vil", "%vil", ""},
				Long:   &locales.CounterFormat{"ilbiriqsi", "%v ilbiriqsi", "%v ilbiriqsi", "%v Ilbiriqsigiiba"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mlsek", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"miliseken", "%v miliseken", "%v miliseken", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mykseken", "%v myks", "%v myks", ""},
				Long:   &locales.CounterFormat{"maykroseken", "%v maykroseken", "%v maykroseken", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"nanosek", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanoseken", "%v nanoseken", "%v nanoseken", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"",
			"",
...
func (so *so) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(so, so.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'so'
func (so *so) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(so, so.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'so'
func (so *so) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(so, so.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'so'
func (so *so) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(so, so.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'so'
func (so *so) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(so, so.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'so'
func (so *so) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(so, so.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'so'
func (so *so) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(so, so.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'so'
func (so *so) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(so, so.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'so'
func (so *so) DateFullLayout() string {
	return so.dateFullLayout
}

// DateLongLayout returns the long date layout for 'so'
func (so *so) DateLongLayout() string {
	return so.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'so'
func (so *so) DateMediumLayout() string {
	return so.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'so'
func (so *so) DateShortLayout() string {
	return so.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'so'
func (so *so) TimeFullLayout() string {
	return so.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'so'
func (so *so) TimeLongLayout() string {
	return so.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'so'
func (so *so) TimeMediumLayout() string {
	return so.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'so'
func (so *so) TimeShortLayout() string {
	return so.timeShortLayout
}

func (so *so) ListPatterns() *locales.ListPatterns {
	return so.listPatterns
}

func (so *so) GetDurationSpec() *locales.DurationSpec {
	return so.DurationSpec
}

func (so *so) GetMiscPatterns() *locales.MiscPatterns {
	return &so.miscPatterns
}
