...
// DateFullLayout returns the full date layout for 'ia_001'
func (ia *ia_001) DateFullLayout() string {
	return ia.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ia_001'
func (ia *ia_001) DateLongLayout() string {
	return ia.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ia_001'
func (ia *ia_001) DateMediumLayout() string {
	return ia.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ia_001'
func (ia *ia_001) DateShortLayout() string {
	return ia.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ia_001'
func (ia *ia_001) TimeFullLayout() string {
	return ia.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ia_001'
func (ia *ia_001) TimeLongLayout() string {
	return ia.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ia_001'
func (ia *ia_001) TimeMediumLayout() string {
	return ia.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ia_001'
func (ia *ia_001) TimeShortLayout() string {
	return ia.timeShortLayout
}

func (ia *ia_001) ListPatterns() *locales.ListPatterns {
	return ia.listPatterns
}

func (ia *ia_001) GetDurationSpec() *locales.DurationSpec {
	return ia.DurationSpec
}

func (ia *ia_001) GetMiscPatterns() *locales.MiscPatterns {
