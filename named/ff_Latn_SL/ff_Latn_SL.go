...
// DateFullLayout returns the full date layout for 'ff_Latn_SL'
func (ff *ff_Latn_SL) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff_Latn_SL'
func (ff *ff_Latn_SL) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff_Latn_SL'
func (ff *ff_Latn_SL) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff_Latn_SL'
func (ff *ff_Latn_SL) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff_Latn_SL'
func (ff *ff_Latn_SL) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff_Latn_SL'
func (ff *ff_Latn_SL) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff_Latn_SL'
func (ff *ff_Latn_SL) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff_Latn_SL'
func (ff *ff_Latn_SL) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff_Latn_SL) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff_Latn_SL) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff_Latn_SL) GetMiscPatterns() *locales.MiscPatterns {
