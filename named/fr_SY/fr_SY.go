...
// DateFullLayout returns the full date layout for 'fr_SY'
func (fr *fr_SY) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_SY'
func (fr *fr_SY) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_SY'
func (fr *fr_SY) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_SY'
func (fr *fr_SY) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_SY'
func (fr *fr_SY) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_SY'
func (fr *fr_SY) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_SY'
func (fr *fr_SY) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_SY'
func (fr *fr_SY) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_SY) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_SY) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_SY) GetMiscPatterns() *locales.MiscPatterns {
