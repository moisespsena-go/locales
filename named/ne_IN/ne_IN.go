...
// DateFullLayout returns the full date layout for 'ne_IN'
func (ne *ne_IN) DateFullLayout() string {
	return ne.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ne_IN'
func (ne *ne_IN) DateLongLayout() string {
	return ne.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ne_IN'
func (ne *ne_IN) DateMediumLayout() string {
	return ne.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ne_IN'
func (ne *ne_IN) DateShortLayout() string {
	return ne.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ne_IN'
func (ne *ne_IN) TimeFullLayout() string {
	return ne.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ne_IN'
func (ne *ne_IN) TimeLongLayout() string {
	return ne.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ne_IN'
func (ne *ne_IN) TimeMediumLayout() string {
	return ne.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ne_IN'
func (ne *ne_IN) TimeShortLayout() string {
	return ne.timeShortLayout
}

func (ne *ne_IN) ListPatterns() *locales.ListPatterns {
	return ne.listPatterns
}

func (ne *ne_IN) GetDurationSpec() *locales.DurationSpec {
	return ne.DurationSpec
}

func (ne *ne_IN) GetMiscPatterns() *locales.MiscPatterns {
