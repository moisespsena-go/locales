...
// DateFullLayout returns the full date layout for 'kn_IN'
func (kn *kn_IN) DateFullLayout() string {
	return kn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kn_IN'
func (kn *kn_IN) DateLongLayout() string {
	return kn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kn_IN'
func (kn *kn_IN) DateMediumLayout() string {
	return kn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kn_IN'
func (kn *kn_IN) DateShortLayout() string {
	return kn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kn_IN'
func (kn *kn_IN) TimeFullLayout() string {
	return kn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kn_IN'
func (kn *kn_IN) TimeLongLayout() string {
	return kn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kn_IN'
func (kn *kn_IN) TimeMediumLayout() string {
	return kn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kn_IN'
func (kn *kn_IN) TimeShortLayout() string {
	return kn.timeShortLayout
}

func (kn *kn_IN) ListPatterns() *locales.ListPatterns {
	return kn.listPatterns
}

func (kn *kn_IN) GetDurationSpec() *locales.DurationSpec {
	return kn.DurationSpec
}

func (kn *kn_IN) GetMiscPatterns() *locales.MiscPatterns {
