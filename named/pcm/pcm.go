...
func New() locales.Translator {
	return &pcm{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jén", "Fẹ́b", "Mach", "Épr", "Mee", "Jun", "Jul", "Ọgọ", "Sẹp", "Ọkt", "Nọv", "Dis"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Jénúári", "Fẹ́búári", "Mach", "Éprel", "Mee", "Jun", "Julai", "Ọgọst", "Sẹptẹ́mba", "Ọktóba", "Nọvẹ́mba", "Disẹ́mba"},
			WeekdaysAbbreviatedValue: []string{"Sọ́n", "Mọ́n", "Tiú", "Wẹ́n", "Tọ́z", "Fraí", "Sát"},
			WeekdaysNarrowValue:      []string{"S", "M", "T", "W", "T", "F", "S"},
			WeekdaysShortValue:       []string{"Sọ́n", "Mọ́n", "Tiú", "Wẹ́n", "Tọ́z", "Fraí", "Sát"},
			WeekdaysWideValue:        []string{"Sọ́ndè", "Mọ́ndè", "Tiúzdè", "Wẹ́nẹ́zdè", "Tọ́zdè", "Fraídè", "Sátọdè"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsNarrowValue:       []string{"AM", "PM"},
			PeriodsWideValue:         []string{"Fọ mọ́nin", "Fọ ívnin"},
			ErasAbbreviatedValue:     []string{"BK", "KIY"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Bifọ́ Kraist", "Kraist Im Yiẹ"},
			TimezonesValue:           map[string]string{"": "Párágwue Fíksd Taim", "ACDT": "Ọstrélia Mídúl Délaít Taim", "ACST": "Ọstrélia Mídúl Fíksd Taim", "ACT": "ACT", "ACWDT": "Ọstrélia Mídúl Wẹ́stán Délaít Taim", "ACWST": "Ọstrélia Mídúl Wẹ́stán Fíksd Taim", "ADT": "Atlántík Délaít Taim", "AEDT": "Ọstrélia Ístán Délaít Taim", "AEST": "Ọstrélia Ístán Fíksd Taim", "AFT": "Afgánístan Taim", "AKDT": "Aláská Délaít Taim", "AKST": "Aláská Fíksd Taim", "AMST": "Ámázọn Họ́t Sízín Taim", "AMT": "Ámázọn Fíksd Taim", "ARST": "Ajẹntína Họ́t Sízín Taim", "ART": "Ajẹntína Fíksd Taim", "AST": "Atlántík Fíksd Taim", "AWDT": "Ọstrélia Wẹ́stán Délaít Taim", "AWST": "Ọstrélia Wẹ́stán Fíksd Taim", "BNT": "Brunẹi Darúsalam Taim", "BOT": "Bolívia Fíksd Taim", "BRST": "Brasília Họ́t Sízín Taim", "BRT": "Brasília Fíksd Taim", "BST": "Bangladẹsh Délaít Taim", "BTT": "Butan Taim", "CAT": "Mídúl Áfríká Taim", "CCT": "Kókós Aílands Taim", "CDT": "Nọ́t Amẹ́ríká Mídúl Ériá Délaít Taim", "CDT (Kuba)": "Kúba Délaít Taim", "CHADT": "Chátam Délaít Taim", "CHAST": "Chátam Fíksd Taim", "CLST": "Chílẹ Họ́t Sízín Taim", "CLT": "Chílẹ Fíksd Taim", "COST": "Kolómbia Họ́t Sízín Taim", "COT": "Kolómbia Fíksd Taim", "CST": "Nọ́t Amẹ́ríká Mídúl Ériá Fíksd Taim", "CST (Kuba)": "Kúba Fíksd Taim", "CXT": "Krísmás Aíland Taim", "ChST": "Chamóro Fíksd Taim", "EASST": "Ísta Họ́t Sízín Taim", "EAST": "Ísta Fíksd Taim", "EAT": "Íst Áfríká Taim", "ECT": "Ẹ́kwuádọ Taim", "EDT": "Nọ́t Amẹ́ríká Ístán Ériá Délaít Taim", "EGDT": "Íist Grínlánd Họ́t Sízin Taim", "EGST": "Íist Grínlánd Fíksd Taim", "EST": "Nọ́t Amẹ́ríká Ístán Ériá Fíksd Taim", "FKST": "Fọ́lkland Họ́t Sízín Taim", "GALT": "Galápágọs Taim", "GFT": "Frẹ́nch Giána Taim", "GMT": "Grínwích Mín Taim", "GST": "Gọ́lf Fíksd Taim", "GYT": "Gayána Taim", "HADT": "Hawaií-Elúshián Délaít Taim", "HAST": "Hawaií-Elúshián Fíksd Taim", "HENOMX": "Nọ́twẹ́st Mẹ́ksíko Délaít Taim", "HEOG": "Wẹ́st Grínlánd Họ́t Sízin Taim", "HEPMX": "Mẹ́ksíkó Pasífík Délaít Taim", "HKST": "Họng Kọng Họ́t Sízin Taim", "HKT": "Họng Kọng Fíksd Taim", "HNNOMX": "Nọ́twẹ́st Mẹ́ksíko Fíksd Taim", "HNOG": "Wẹ́st Grínlánd Fíksd Taim", "HNPMX": "Mẹ́ksíkó Pasífík Fíksd Taim", "ICT": "Indochaína Taim", "IRDT": "Iran Délaít Taim", "IRST": "Iran Fíksd Taim", "IST": "Índia Fíksd Taim", "JDT": "Japan Délaít Taim", "JST": "Japan Fíksd Taim", "LHDT": "Lọd Haú Délaít Taim", "LHST": "Lọd Haú Fíksd Taim", "MDT": "Nọ́t Amẹ́ríká Maúntin Ériá Délaít Taim", "MESZ": "Mídúl Yúrop Họ́t Sízin Taim", "MEZ": "Mídúl Yúrop Fíksd Taim", "MST": "Nọ́t Amẹ́ríká Maúntin Ériá Fíksd Taim", "MVT": "Mọ́divs Taim", "MYT": "Maléshia Taim", "NDT": "Niúfaúndlánd Délaít Taim", "NPT": "Nẹpọl Taim", "NST": "Niúfaúndlánd Fíksd Taim", "NZDT": "Niú Ziland Délaít Taim", "NZST": "Niú Ziland Fíksd Taim", "OESZ": "Ístán Yúrop Họ́t Sízin Taim", "OEZ": "Ístán Yúrop Fíksd Taim", "PDT": "Nọ́t Amẹ́ríká Pasífík Ériá Délaít Taim", "PKT": "Pákístan Họ́t Sízin Taim", "PMDT": "Sent Piẹr an Míkẹlọn Délaít Taim", "PMST": "Sent Piẹr an Míkẹlọn Fíksd Taim", "PST": "Nọ́t Amẹ́ríká Pasífík Ériá Fíksd Taim", "PYST": "Párágwue Họ́t Sízín Taim", "SAST": "Saút Áfríká Fíksd Taim", "SGT": "Singapọ Taim", "SRT": "Súrínam Taim", "TLT": "Íst Tímọ Taim", "TMST": "Tọkmẹnistan Họ́t Sízin Taim", "TMT": "Tọkmẹnistan Fíksd Taim", "UYST": "Yúrugwue Họ́t Sízín Taim", "UYT": "Yúrugwue Fíksd Taim", "VET": "Vẹnẹzuẹ́la Taim", "WARST": "Wẹ́stán Ajẹntína Họ́t Sízín Taim", "WART": "Wẹ́stán Ajẹntína Fíksd Taim", "WAST": "Wẹ́st Áfríká Họ́t Sízin Taim", "WAT": "Wẹ́st Áfríká Fíksd Taim", "WESZ": "Wẹ́stán Yúrop Họ́t Sízin Taim", "WEZ": "Wẹ́stán Yúrop Fíksd Taim", "WIB": "Wẹ́stán Indonẹ́shia Taim", "WIT": "Ístán Indonẹ́shia Taim", "WITA": "Mídúl Indonẹ́shia Taim", "∅∅∅": "Pẹru Họ́t Sízín Taim"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} an {1}", "{0}, {1}", "{0}, {1}", "{0}, an {1}"}, {"{0} ọ {1}", "{0}, {1}", "{0}, {1}", "{0} ọ {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"H", "%vh", "%vh", ""},
				Long:   &locales.CounterFormat{"Họ́ndrẹ́d-họ́ndrẹ́d-yiẹ́", "%v Họ́ndrẹ́d-yiẹ́", "%v Họ́ndrẹ́d-yiẹ́", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Tẹ́n-tẹ́n-yiẹ", "%v Tẹ́n-yiẹ", "%vTẹ́n-yiẹ", ""},
				Long:   &locales.CounterFormat{"Tẹ́n-tẹ́n-yiẹ", "%v Tẹ́n-yiẹ", "%v Tẹ́n-yiẹ́", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Yiẹ", "%vYiẹ", "%vYiẹ", ""},
				Long:   &locales.CounterFormat{"Yiẹ-dẹm", "%v Yiẹ", "%v Yiẹ", "%v Ích yiẹ"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Mọnt", "%vMọnt", "%vMọnt", ""},
				Long:   &locales.CounterFormat{"Mọnt-dẹm", "%v Mọnt", "%v Mọnt", "%v Ích mọnt"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Wik", "%vWik", "%vWik", ""},
				Long:   &locales.CounterFormat{"Wik-dẹm", "%v Wik", "%v Wik", "%v Ích Wik"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Dè", "%vDè", "%vDè", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Áwa", "%vÁwa", "%vÁwa", ""},
				Long:   &locales.CounterFormat{"Áwa-dẹm", "%v Áwa", "%v Áwa", "%v Ích Áwa"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Mínit", "%vMínit", "%vMínit", ""},
				Long:   &locales.CounterFormat{"Mínit-dẹm", "%v Mínit", "%v Mínit", "%v Ích Mínit"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Sẹ́kọn", "%vSẹ́kọn", "%vSẹ́kọn", ""},
				Long:   &locales.CounterFormat{"Sẹ́kọn-dẹm", "%v Sẹ́kọn", "%v Sẹ́kọn", "%v Ích Sẹ́kọn"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Mílisẹ́kọns", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"Mílisẹ́kọn-dẹm", "%v Mílisẹ́kọn", "%v Mílisẹ́kọn", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Maíkrosẹ́kọns", "%vMaíksẹ́k", "%vMaiksẹk", ""},
				Long:   &locales.CounterFormat{"Maíkrosẹ́kọn-dẹm", "%v Maíkrosẹ́kọn", "%v Maíkrosẹ́kọn", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"Nánosẹ́kọns", "%v Nansẹk", "%v Nansẹk", ""},
				Long:   &locales.CounterFormat{"Nánosẹ́kọn-dẹm", "%v Nánosẹ́kọn", "%v Nánosẹ́kọn", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (pcm *pcm) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(pcm, pcm.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'pcm'
func (pcm *pcm) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(pcm, pcm.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'pcm'
func (pcm *pcm) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(pcm, pcm.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'pcm'
func (pcm *pcm) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(pcm, pcm.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'pcm'
func (pcm *pcm) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(pcm, pcm.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'pcm'
func (pcm *pcm) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(pcm, pcm.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'pcm'
func (pcm *pcm) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(pcm, pcm.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'pcm'
func (pcm *pcm) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(pcm, pcm.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'pcm'
func (pcm *pcm) DateFullLayout() string {
	return pcm.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pcm'
func (pcm *pcm) DateLongLayout() string {
	return pcm.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pcm'
func (pcm *pcm) DateMediumLayout() string {
	return pcm.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pcm'
func (pcm *pcm) DateShortLayout() string {
	return pcm.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pcm'
func (pcm *pcm) TimeFullLayout() string {
	return pcm.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pcm'
func (pcm *pcm) TimeLongLayout() string {
	return pcm.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pcm'
func (pcm *pcm) TimeMediumLayout() string {
	return pcm.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pcm'
func (pcm *pcm) TimeShortLayout() string {
	return pcm.timeShortLayout
}

func (pcm *pcm) ListPatterns() *locales.ListPatterns {
	return pcm.listPatterns
}

func (pcm *pcm) GetDurationSpec() *locales.DurationSpec {
	return pcm.DurationSpec
}

func (pcm *pcm) GetMiscPatterns() *locales.MiscPatterns {
	return &pcm.miscPatterns
}
