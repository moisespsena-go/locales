...
// DateFullLayout returns the full date layout for 'fr_NE'
func (fr *fr_NE) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_NE'
func (fr *fr_NE) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_NE'
func (fr *fr_NE) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_NE'
func (fr *fr_NE) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_NE'
func (fr *fr_NE) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_NE'
func (fr *fr_NE) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_NE'
func (fr *fr_NE) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_NE'
func (fr *fr_NE) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_NE) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_NE) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_NE) GetMiscPatterns() *locales.MiscPatterns {
