...
// DateFullLayout returns the full date layout for 'en_CX'
func (en *en_CX) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_CX'
func (en *en_CX) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_CX'
func (en *en_CX) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_CX'
func (en *en_CX) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_CX'
func (en *en_CX) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_CX'
func (en *en_CX) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_CX'
func (en *en_CX) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_CX'
func (en *en_CX) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_CX) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_CX) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_CX) GetMiscPatterns() *locales.MiscPatterns {
