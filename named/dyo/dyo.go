...
// DateFullLayout returns the full date layout for 'dyo'
func (dyo *dyo) DateFullLayout() string {
	return dyo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'dyo'
func (dyo *dyo) DateLongLayout() string {
	return dyo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'dyo'
func (dyo *dyo) DateMediumLayout() string {
	return dyo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'dyo'
func (dyo *dyo) DateShortLayout() string {
	return dyo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'dyo'
func (dyo *dyo) TimeFullLayout() string {
	return dyo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'dyo'
func (dyo *dyo) TimeLongLayout() string {
	return dyo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'dyo'
func (dyo *dyo) TimeMediumLayout() string {
	return dyo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'dyo'
func (dyo *dyo) TimeShortLayout() string {
	return dyo.timeShortLayout
}

func (dyo *dyo) ListPatterns() *locales.ListPatterns {
	return dyo.listPatterns
}

func (dyo *dyo) GetDurationSpec() *locales.DurationSpec {
	return dyo.DurationSpec
}

func (dyo *dyo) GetMiscPatterns() *locales.MiscPatterns {
