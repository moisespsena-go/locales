...
// DateFullLayout returns the full date layout for 'en_DE'
func (en *en_DE) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_DE'
func (en *en_DE) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_DE'
func (en *en_DE) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_DE'
func (en *en_DE) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_DE'
func (en *en_DE) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_DE'
func (en *en_DE) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_DE'
func (en *en_DE) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_DE'
func (en *en_DE) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_DE) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_DE) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_DE) GetMiscPatterns() *locales.MiscPatterns {
