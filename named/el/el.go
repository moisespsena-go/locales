...
func New() locales.Translator {
	return &el{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 χιλ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 χιλ'.' ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 χιλ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 χιλ'.' ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 χιλ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 χιλ'.' ¤"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 εκ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 εκ'.' ¤"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 εκ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 εκ'.' ¤"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 εκ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 εκ'.' ¤"),
						}},
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 δισ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 δισ'.' ¤"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 δισ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 δισ'.' ¤"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 δισ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 δισ'.' ¤"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 τρισ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 τρισ'.' ¤"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 τρισ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 τρισ'.' ¤"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 τρισ'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 τρισ'.' ¤"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Ιαν", "Φεβ", "Μαρ", "Απρ", "Μαΐ", "Ιουν", "Ιουλ", "Αυγ", "Σεπ", "Οκτ", "Νοε", "Δεκ"},
			MonthsNarrowValue:        []string{"", "Ι", "Φ", "Μ", "Α", "Μ", "Ι", "Ι", "Α", "Σ", "Ο", "Ν", "Δ"},
			MonthsWideValue:          []string{"", "Ιανουαρίου", "Φεβρουαρίου", "Μαρτίου", "Απριλίου", "Μαΐου", "Ιουνίου", "Ιουλίου", "Αυγούστου", "Σεπτεμβρίου", "Οκτωβρίου", "Νοεμβρίου", "Δεκεμβρίου"},
			WeekdaysAbbreviatedValue: []string{"Κυρ", "Δευ", "Τρί", "Τετ", "Πέμ", "Παρ", "Σάβ"},
			WeekdaysNarrowValue:      []string{"Κ", "Δ", "Τ", "Τ", "Π", "Π", "Σ"},
			WeekdaysShortValue:       []string{"Κυ", "Δε", "Τρ", "Τε", "Πέ", "Πα", "Σά"},
			WeekdaysWideValue:        []string{"Κυριακή", "Δευτέρα", "Τρίτη", "Τετάρτη", "Πέμπτη", "Παρασκευή", "Σάββατο"},
			PeriodsAbbreviatedValue:  []string{"π.μ.", "μ.μ."},
			PeriodsNarrowValue:       []string{"πμ", "μμ"},
			PeriodsWideValue:         []string{"π.μ.", "μ.μ."},
			ErasAbbreviatedValue:     []string{"π.Χ.", "μ.Χ."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"προ Χριστού", "μετά Χριστόν"},
			TimezonesValue:           map[string]string{"": "Χειμερινή ώρα Παραγουάης", "ACDT": "Θερινή ώρα Κεντρικής Αυστραλίας", "ACST": "Χειμερινή ώρα Κεντρικής Αυστραλίας", "ACT": "ACT", "ACWDT": "Θερινή ώρα Κεντροδυτικής Αυστραλίας", "ACWST": "Χειμερινή ώρα Κεντροδυτικής Αυστραλίας", "ADT": "Θερινή ώρα Ατλαντικού", "AEDT": "Θερινή ώρα Ανατολικής Αυστραλίας", "AEST": "Χειμερινή ώρα Ανατολικής Αυστραλίας", "AFT": "Ώρα Αφγανιστάν", "AKDT": "Θερινή ώρα Αλάσκας", "AKST": "Χειμερινή ώρα Αλάσκας", "AMST": "Θερινή ώρα Αμαζονίου", "AMT": "Χειμερινή ώρα Αμαζονίου", "ARST": "Θερινή ώρα Αργεντινής", "ART": "Χειμερινή ώρα Αργεντινής", "AST": "Χειμερινή ώρα Ατλαντικού", "AWDT": "Θερινή ώρα Δυτικής Αυστραλίας", "AWST": "Χειμερινή ώρα Δυτικής Αυστραλίας", "BNT": "Ώρα Μπρουνέι Νταρουσαλάμ", "BOT": "Ώρα Βολιβίας", "BRST": "Θερινή ώρα Μπραζίλιας", "BRT": "Χειμερινή ώρα Μπραζίλιας", "BST": "Θερινή ώρα Μπανγκλαντές", "BTT": "Ώρα Μπουτάν", "CAT": "Ώρα Κεντρικής Αφρικής", "CCT": "Ώρα Νήσων Κόκος", "CDT": "Κεντρική θερινή ώρα Βόρειας Αμερικής", "CDT (Kuba)": "Θερινή ώρα Κούβας", "CHADT": "Θερινή ώρα Τσάταμ", "CHAST": "Χειμερινή ώρα Τσάταμ", "CLST": "Θερινή ώρα Χιλής", "CLT": "Χειμερινή ώρα Χιλής", "COST": "Θερινή ώρα Κολομβίας", "COT": "Χειμερινή ώρα Κολομβίας", "CST": "Κεντρική χειμερινή ώρα Βόρειας Αμερικής", "CST (Kuba)": "Χειμερινή ώρα Κούβας", "CXT": "Ώρα Νήσου Χριστουγέννων", "ChST": "Ώρα Τσαμόρο", "EASST": "Θερινή ώρα Νήσου Πάσχα", "EAST": "Χειμερινή ώρα Νήσου Πάσχα", "EAT": "Ώρα Ανατολικής Αφρικής", "ECT": "Ώρα Ισημερινού", "EDT": "Ανατολική θερινή ώρα Βόρειας Αμερικής", "EGDT": "Θερινή ώρα Ανατολικής Γροιλανδίας", "EGST": "Χειμερινή ώρα Ανατολικής Γροιλανδίας", "EST": "Ανατολική χειμερινή ώρα Βόρειας Αμερικής", "FKST": "Θερινή ώρα Νήσων Φόκλαντ", "GALT": "Ώρα Γκαλάπαγκος", "GFT": "Ώρα Γαλλικής Γουιάνας", "GMT": "Μέση ώρα Γκρίνουιτς", "GST": "Ώρα Κόλπου", "GYT": "Ώρα Γουιάνας", "HADT": "Θερινή ώρα Χαβάης-Αλεούτιων Νήσων", "HAST": "Χειμερινή ώρα Χαβάης-Αλεούτιων Νήσων", "HENOMX": "Θερινή ώρα Βορειοδυτικού Μεξικού", "HEOG": "Θερινή ώρα Δυτικής Γροιλανδίας", "HEPMX": "Θερινή ώρα Ειρηνικού Μεξικού", "HKST": "Θερινή ώρα Χονγκ Κονγκ", "HKT": "Χειμερινή ώρα Χονγκ Κονγκ", "HNNOMX": "Χειμερινή ώρα Βορειοδυτικού Μεξικού", "HNOG": "Χειμερινή ώρα Δυτικής Γροιλανδίας", "HNPMX": "Χειμερινή ώρα Ειρηνικού Μεξικού", "ICT": "Ώρα Ινδοκίνας", "IRDT": "Θερινή ώρα Ιράν", "IRST": "Χειμερινή ώρα Ιράν", "IST": "Ώρα Ινδίας", "JDT": "Θερινή ώρα Ιαπωνίας", "JST": "Χειμερινή ώρα Ιαπωνίας", "LHDT": "Θερινή ώρα Λορντ Χάου", "LHST": "Χειμερινή ώρα Λορντ Χάου", "MDT": "Ορεινή θερινή ώρα Βόρειας Αμερικής", "MESZ": "Θερινή ώρα Κεντρικής Ευρώπης", "MEZ": "Χειμερινή ώρα Κεντρικής Ευρώπης", "MST": "Ορεινή χειμερινή ώρα Βόρειας Αμερικής", "MVT": "Ώρα Μαλδίβων", "MYT": "Ώρα Μαλαισίας", "NDT": "Θερινή ώρα Νέας Γης", "NPT": "Ώρα Νεπάλ", "NST": "Χειμερινή ώρα Νέας Γης", "NZDT": "Θερινή ώρα Νέας Ζηλανδίας", "NZST": "Χειμερινή ώρα Νέας Ζηλανδίας", "OESZ": "Θερινή ώρα Ανατολικής Ευρώπης", "OEZ": "Χειμερινή ώρα Ανατολικής Ευρώπης", "PDT": "Θερινή ώρα Ειρηνικού", "PKT": "Θερινή ώρα Πακιστάν", "PMDT": "Θερινή ώρα Σεν Πιερ και Μικελόν", "PMST": "Χειμερινή ώρα Σεν Πιερ και Μικελόν", "PST": "Χειμερινή ώρα Ειρηνικού", "PYST": "Θερινή ώρα Παραγουάης", "SAST": "Χειμερινή ώρα Νότιας Αφρικής", "SGT": "Ώρα Σιγκαπούρης", "SRT": "Ώρα Σουρινάμ", "TLT": "Ώρα Ανατολικού Τιμόρ", "TMST": "Θερινή ώρα Τουρκμενιστάν", "TMT": "Χειμερινή ώρα Τουρκμενιστάν", "UYST": "Θερινή ώρα Ουρουγουάης", "UYT": "Χειμερινή ώρα Ουρουγουάης", "VET": "Ώρα Βενεζουέλας", "WARST": "Θερινή ώρα Δυτικής Αργεντινής", "WART": "Χειμερινή ώρα Δυτικής Αργεντινής", "WAST": "Θερινή ώρα Δυτικής Αφρικής", "WAT": "Χειμερινή ώρα Δυτικής Αφρικής", "WESZ": "Θερινή ώρα Δυτικής Ευρώπης", "WEZ": "Χειμερινή ώρα Δυτικής Ευρώπης", "WIB": "Ώρα Δυτικής Ινδονησίας", "WIT": "Ώρα Ανατολικής Ινδονησίας", "WITA": "Ώρα Κεντρικής Ινδονησίας", "∅∅∅": "Θερινή ώρα Περού"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} και {1}", "{0}, {1}", "{0}, {1}", "{0} και {1}"}, {"{0} ή {1}", "{0}, {1}", "{0}, {1}", "{0} ή {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"αιών.", "%v αιών.", "%v αιών.", ""},
				Long:   &locales.CounterFormat{"αιώνες", "%v αιώνα", "%v αιώνων", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"δεκ.", "%v δεκ.", "%v δεκ.", ""},
				Long:   &locales.CounterFormat{"δεκαετίες", "%v δεκαετίας", "%v δεκαετιών", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"έτ.", "%v έ", "%v έ", "%v/έ"},
				Long:   &locales.CounterFormat{"έτη", "%v έτους", "%v ετών", "%v ανά έτος"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μήνας", "%v μ", "%v μ", "%v/μ"},
				Long:   &locales.CounterFormat{"μήνες", "%v μήνα", "%v μηνών", "%v ανά μήνα"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"εβδ.", "%v ε", "%v ε", "%v/ε"},
				Long:   &locales.CounterFormat{"εβδομάδες", "%v εβδομάδας", "%v εβδομάδων", "%v ανά εβδομάδα"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ημέρα", "%v η", "%v η", "%v/η"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ώρα", "%v ώ", "%v ώ", "%v/ώ"},
				Long:   &locales.CounterFormat{"ώρες", "%v ώρας", "%v ωρών", "%v ανά ώρα"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"λ.", "%v λ", "%v λ", "%v/λ"},
				Long:   &locales.CounterFormat{"λεπτά", "%v λεπτού", "%v λεπτών", "%v ανά λεπτό"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"δευτ.", "%v δ", "%v δ", "%v/δ"},
				Long:   &locales.CounterFormat{"δευτερόλεπτα", "%v δευτερολέπτου", "%v δευτερολέπτων", "%v ανά δευτερόλεπτο"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"χιλ. δευτ.", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"χιλιοστά του δευτερολέπτου", "%v χιλιοστού του δευτερολέπτου", "%v χιλιοστών του δευτερολέπτου", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μικροδεύτερα", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"μικροδευτερόλεπτα", "μικροδευτερόλεπτου", "%v μικροδευτερόλεπτων", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"νανοδεύτερα", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"νανοδευτερόλεπτα", "%v νανοδευτερόλεπτου", "%v νανοδευτερόλεπτων", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (el *el) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(el, el.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'el'
func (el *el) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(el, el.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'el'
func (el *el) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(el, el.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'el'
func (el *el) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(el, el.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'el'
func (el *el) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(el, el.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'el'
func (el *el) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(el, el.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'el'
func (el *el) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(el, el.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'el'
func (el *el) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(el, el.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'el'
func (el *el) DateFullLayout() string {
	return el.dateFullLayout
}

// DateLongLayout returns the long date layout for 'el'
func (el *el) DateLongLayout() string {
	return el.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'el'
func (el *el) DateMediumLayout() string {
	return el.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'el'
func (el *el) DateShortLayout() string {
	return el.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'el'
func (el *el) TimeFullLayout() string {
	return el.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'el'
func (el *el) TimeLongLayout() string {
	return el.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'el'
func (el *el) TimeMediumLayout() string {
	return el.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'el'
func (el *el) TimeShortLayout() string {
	return el.timeShortLayout
}

func (el *el) ListPatterns() *locales.ListPatterns {
	return el.listPatterns
}

func (el *el) GetDurationSpec() *locales.DurationSpec {
	return el.DurationSpec
}

func (el *el) GetMiscPatterns() *locales.MiscPatterns {
	return &el.miscPatterns
}
