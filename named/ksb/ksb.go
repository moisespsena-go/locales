...
// DateFullLayout returns the full date layout for 'ksb'
func (ksb *ksb) DateFullLayout() string {
	return ksb.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ksb'
func (ksb *ksb) DateLongLayout() string {
	return ksb.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ksb'
func (ksb *ksb) DateMediumLayout() string {
	return ksb.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ksb'
func (ksb *ksb) DateShortLayout() string {
	return ksb.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ksb'
func (ksb *ksb) TimeFullLayout() string {
	return ksb.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ksb'
func (ksb *ksb) TimeLongLayout() string {
	return ksb.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ksb'
func (ksb *ksb) TimeMediumLayout() string {
	return ksb.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ksb'
func (ksb *ksb) TimeShortLayout() string {
	return ksb.timeShortLayout
}

func (ksb *ksb) ListPatterns() *locales.ListPatterns {
	return ksb.listPatterns
}

func (ksb *ksb) GetDurationSpec() *locales.DurationSpec {
	return ksb.DurationSpec
}

func (ksb *ksb) GetMiscPatterns() *locales.MiscPatterns {
