...
// DateFullLayout returns the full date layout for 'en_GD'
func (en *en_GD) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_GD'
func (en *en_GD) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_GD'
func (en *en_GD) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_GD'
func (en *en_GD) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_GD'
func (en *en_GD) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_GD'
func (en *en_GD) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_GD'
func (en *en_GD) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_GD'
func (en *en_GD) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_GD) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_GD) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_GD) GetMiscPatterns() *locales.MiscPatterns {
