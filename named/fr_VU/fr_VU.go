...
// DateFullLayout returns the full date layout for 'fr_VU'
func (fr *fr_VU) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_VU'
func (fr *fr_VU) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_VU'
func (fr *fr_VU) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_VU'
func (fr *fr_VU) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_VU'
func (fr *fr_VU) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_VU'
func (fr *fr_VU) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_VU'
func (fr *fr_VU) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_VU'
func (fr *fr_VU) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_VU) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_VU) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_VU) GetMiscPatterns() *locales.MiscPatterns {
