...
func New() locales.Translator {
	return &mi_NZ{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Kohi", "Hui", "Pou", "Pae", "Hara", "Pipi", "Hōngo", "Here", "Mahu", "Nuku", "Rangi", "Haki"},
			MonthsNarrowValue:        []string{"", "K", "H", "P", "P", "H", "P", "H", "H", "M", "N", "R", "H"},
			MonthsWideValue:          []string{"", "Kohitātea", "Huitanguru", "Poutūterangi", "Paengawhāwhā", "Haratua", "Pipiri", "Hōngongoi", "Hereturikōkā", "Mahuru", "Whiringa-ā-nuku", "Whiringa-ā-rangi", "Hakihea"},
			WeekdaysAbbreviatedValue: []string{"Tap", "Hin", "Tū", "Apa", "Par", "Mer", "Hor"},
			WeekdaysNarrowValue:      []string{"T", "H", "T", "A", "P", "M", "H"},
			WeekdaysShortValue:       []string{"Tap", "Hin", "Tū", "Apa", "Par", "Mer", "Hor"},
			WeekdaysWideValue:        []string{"Rātapu", "Rāhina", "Rātū", "Rāapa", "Rāpare", "Rāmere", "Rāhoroi"},
			...
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "Wā Awatea Ranatiki", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "Wā Arowhānui Ranatiki", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "CAT", "CCT": "CCT", "CDT": "Wā Awatea Waenga", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "Wā Arowhānui Waenga", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "EAT", "ECT": "ECT", "EDT": "Wā Awatea Rāwhiti", "EGDT": "EGDT", "EGST": "EGST", "EST": "Wā Arowhānui Rāwhiti", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "Wā Toharite Greenwich", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "Wā Raumati Uropi Waenga", "MEZ": "Wā Arowhānui Uropi Waenga", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "Wā Raumati Uropi Rāwhiti", "OEZ": "Wā Arowhānui Uropi Rāwhiti", "PDT": "Wā Awatea Kiwa", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "Wā Arowhānui Kiwa", "PYST": "PYST", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "Wā Raumati Uropi Uru", "WEZ": "Wā Arowhānui Uropi Uru", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
...
func (mi *mi_NZ) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(mi, mi.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'mi_NZ'
func (mi *mi_NZ) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(mi, mi.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'mi_NZ'
func (mi *mi_NZ) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(mi, mi.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'mi_NZ'
func (mi *mi_NZ) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(mi, mi.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'mi_NZ'
func (mi *mi_NZ) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(mi, mi.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'mi_NZ'
func (mi *mi_NZ) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(mi, mi.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'mi_NZ'
func (mi *mi_NZ) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(mi, mi.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'mi_NZ'
func (mi *mi_NZ) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(mi, mi.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'mi_NZ'
func (mi *mi_NZ) DateFullLayout() string {
	return mi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mi_NZ'
func (mi *mi_NZ) DateLongLayout() string {
	return mi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mi_NZ'
func (mi *mi_NZ) DateMediumLayout() string {
	return mi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mi_NZ'
func (mi *mi_NZ) DateShortLayout() string {
	return mi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mi_NZ'
func (mi *mi_NZ) TimeFullLayout() string {
	return mi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mi_NZ'
func (mi *mi_NZ) TimeLongLayout() string {
	return mi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mi_NZ'
func (mi *mi_NZ) TimeMediumLayout() string {
	return mi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mi_NZ'
func (mi *mi_NZ) TimeShortLayout() string {
	return mi.timeShortLayout
}

func (mi *mi_NZ) ListPatterns() *locales.ListPatterns {
	return mi.listPatterns
}

func (mi *mi_NZ) GetDurationSpec() *locales.DurationSpec {
	return mi.DurationSpec
}

func (mi *mi_NZ) GetMiscPatterns() *locales.MiscPatterns {
	return &mi.miscPatterns
}
