...
// DateFullLayout returns the full date layout for 'en_DK'
func (en *en_DK) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_DK'
func (en *en_DK) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_DK'
func (en *en_DK) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_DK'
func (en *en_DK) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_DK'
func (en *en_DK) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_DK'
func (en *en_DK) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_DK'
func (en *en_DK) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_DK'
func (en *en_DK) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_DK) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_DK) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_DK) GetMiscPatterns() *locales.MiscPatterns {
