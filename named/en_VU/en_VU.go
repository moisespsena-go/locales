...
// DateFullLayout returns the full date layout for 'en_VU'
func (en *en_VU) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_VU'
func (en *en_VU) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_VU'
func (en *en_VU) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_VU'
func (en *en_VU) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_VU'
func (en *en_VU) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_VU'
func (en *en_VU) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_VU'
func (en *en_VU) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_VU'
func (en *en_VU) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_VU) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_VU) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_VU) GetMiscPatterns() *locales.MiscPatterns {
