...
// DateFullLayout returns the full date layout for 'ti_ER'
func (ti *ti_ER) DateFullLayout() string {
	return ti.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ti_ER'
func (ti *ti_ER) DateLongLayout() string {
	return ti.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ti_ER'
func (ti *ti_ER) DateMediumLayout() string {
	return ti.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ti_ER'
func (ti *ti_ER) DateShortLayout() string {
	return ti.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ti_ER'
func (ti *ti_ER) TimeFullLayout() string {
	return ti.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ti_ER'
func (ti *ti_ER) TimeLongLayout() string {
	return ti.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ti_ER'
func (ti *ti_ER) TimeMediumLayout() string {
	return ti.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ti_ER'
func (ti *ti_ER) TimeShortLayout() string {
	return ti.timeShortLayout
}

func (ti *ti_ER) ListPatterns() *locales.ListPatterns {
	return ti.listPatterns
}

func (ti *ti_ER) GetDurationSpec() *locales.DurationSpec {
	return ti.DurationSpec
}

func (ti *ti_ER) GetMiscPatterns() *locales.MiscPatterns {
