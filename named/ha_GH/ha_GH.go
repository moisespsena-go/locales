...
// DateFullLayout returns the full date layout for 'ha_GH'
func (ha *ha_GH) DateFullLayout() string {
	return ha.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ha_GH'
func (ha *ha_GH) DateLongLayout() string {
	return ha.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ha_GH'
func (ha *ha_GH) DateMediumLayout() string {
	return ha.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ha_GH'
func (ha *ha_GH) DateShortLayout() string {
	return ha.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ha_GH'
func (ha *ha_GH) TimeFullLayout() string {
	return ha.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ha_GH'
func (ha *ha_GH) TimeLongLayout() string {
	return ha.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ha_GH'
func (ha *ha_GH) TimeMediumLayout() string {
	return ha.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ha_GH'
func (ha *ha_GH) TimeShortLayout() string {
	return ha.timeShortLayout
}

func (ha *ha_GH) ListPatterns() *locales.ListPatterns {
	return ha.listPatterns
}

func (ha *ha_GH) GetDurationSpec() *locales.DurationSpec {
	return ha.DurationSpec
}

func (ha *ha_GH) GetMiscPatterns() *locales.MiscPatterns {
