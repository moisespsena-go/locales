...
// DateFullLayout returns the full date layout for 'yi'
func (yi *yi) DateFullLayout() string {
	return yi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'yi'
func (yi *yi) DateLongLayout() string {
	return yi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'yi'
func (yi *yi) DateMediumLayout() string {
	return yi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'yi'
func (yi *yi) DateShortLayout() string {
	return yi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'yi'
func (yi *yi) TimeFullLayout() string {
	return yi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'yi'
func (yi *yi) TimeLongLayout() string {
	return yi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'yi'
func (yi *yi) TimeMediumLayout() string {
	return yi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'yi'
func (yi *yi) TimeShortLayout() string {
	return yi.timeShortLayout
}

func (yi *yi) ListPatterns() *locales.ListPatterns {
	return yi.listPatterns
}

func (yi *yi) GetDurationSpec() *locales.DurationSpec {
	return yi.DurationSpec
}

func (yi *yi) GetMiscPatterns() *locales.MiscPatterns {
