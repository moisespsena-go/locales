...
// DateFullLayout returns the full date layout for 'pt_MZ'
func (pt *pt_MZ) DateFullLayout() string {
	return pt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pt_MZ'
func (pt *pt_MZ) DateLongLayout() string {
	return pt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pt_MZ'
func (pt *pt_MZ) DateMediumLayout() string {
	return pt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pt_MZ'
func (pt *pt_MZ) DateShortLayout() string {
	return pt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pt_MZ'
func (pt *pt_MZ) TimeFullLayout() string {
	return pt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pt_MZ'
func (pt *pt_MZ) TimeLongLayout() string {
	return pt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pt_MZ'
func (pt *pt_MZ) TimeMediumLayout() string {
	return pt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pt_MZ'
func (pt *pt_MZ) TimeShortLayout() string {
	return pt.timeShortLayout
}

func (pt *pt_MZ) ListPatterns() *locales.ListPatterns {
	return pt.listPatterns
}

func (pt *pt_MZ) GetDurationSpec() *locales.DurationSpec {
	return pt.DurationSpec
}

func (pt *pt_MZ) GetMiscPatterns() *locales.MiscPatterns {
