...
func (nyn *nyn_UG) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(nyn, nyn.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'nyn_UG'
func (nyn *nyn_UG) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(nyn, nyn.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'nyn_UG'
func (nyn *nyn_UG) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(nyn, nyn.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'nyn_UG'
func (nyn *nyn_UG) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(nyn, nyn.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'nyn_UG'
func (nyn *nyn_UG) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(nyn, nyn.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'nyn_UG'
func (nyn *nyn_UG) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(nyn, nyn.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'nyn_UG'
func (nyn *nyn_UG) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(nyn, nyn.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'nyn_UG'
func (nyn *nyn_UG) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(nyn, nyn.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'nyn_UG'
func (nyn *nyn_UG) DateFullLayout() string {
	return nyn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nyn_UG'
func (nyn *nyn_UG) DateLongLayout() string {
	return nyn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nyn_UG'
func (nyn *nyn_UG) DateMediumLayout() string {
	return nyn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nyn_UG'
func (nyn *nyn_UG) DateShortLayout() string {
	return nyn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nyn_UG'
func (nyn *nyn_UG) TimeFullLayout() string {
	return nyn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nyn_UG'
func (nyn *nyn_UG) TimeLongLayout() string {
	return nyn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nyn_UG'
func (nyn *nyn_UG) TimeMediumLayout() string {
	return nyn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nyn_UG'
func (nyn *nyn_UG) TimeShortLayout() string {
	return nyn.timeShortLayout
}

func (nyn *nyn_UG) ListPatterns() *locales.ListPatterns {
	return nyn.listPatterns
}

func (nyn *nyn_UG) GetDurationSpec() *locales.DurationSpec {
	return nyn.DurationSpec
}

func (nyn *nyn_UG) GetMiscPatterns() *locales.MiscPatterns {
	return &nyn.miscPatterns
}
