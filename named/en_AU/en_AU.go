...
func New() locales.Translator {
	return &en_AU{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mar", "Apr", "May", "June", "July", "Aug", "Sept", "Oct", "Nov", "Dec"},
			...
			WeekdaysNarrowValue:      []string{"Su.", "M.", "Tu.", "W.", "Th.", "F.", "Sa."},
			WeekdaysShortValue:       []string{"Su", "Mon", "Tu", "Wed", "Th", "Fri", "Sat"},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"min.", "%v min.", "%v mins", "%v/min."}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sec.", "%vs.", "%vs.", ""},
				Long:   &locales.CounterFormat{"sec.", "%v sec.", "%v secs", "%v ps."}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
...
// DateFullLayout returns the full date layout for 'en_AU'
func (en *en_AU) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_AU'
func (en *en_AU) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_AU'
func (en *en_AU) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_AU'
func (en *en_AU) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_AU'
func (en *en_AU) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_AU'
func (en *en_AU) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_AU'
func (en *en_AU) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_AU'
func (en *en_AU) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_AU) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_AU) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_AU) GetMiscPatterns() *locales.MiscPatterns {
