...
// DateFullLayout returns the full date layout for 'pa_Guru_IN'
func (pa *pa_Guru_IN) DateFullLayout() string {
	return pa.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pa_Guru_IN'
func (pa *pa_Guru_IN) DateLongLayout() string {
	return pa.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pa_Guru_IN'
func (pa *pa_Guru_IN) DateMediumLayout() string {
	return pa.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pa_Guru_IN'
func (pa *pa_Guru_IN) DateShortLayout() string {
	return pa.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pa_Guru_IN'
func (pa *pa_Guru_IN) TimeFullLayout() string {
	return pa.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pa_Guru_IN'
func (pa *pa_Guru_IN) TimeLongLayout() string {
	return pa.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pa_Guru_IN'
func (pa *pa_Guru_IN) TimeMediumLayout() string {
	return pa.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pa_Guru_IN'
func (pa *pa_Guru_IN) TimeShortLayout() string {
	return pa.timeShortLayout
}

func (pa *pa_Guru_IN) ListPatterns() *locales.ListPatterns {
	return pa.listPatterns
}

func (pa *pa_Guru_IN) GetDurationSpec() *locales.DurationSpec {
	return pa.DurationSpec
}

func (pa *pa_Guru_IN) GetMiscPatterns() *locales.MiscPatterns {
