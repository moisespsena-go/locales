...
// DateFullLayout returns the full date layout for 'ar_IQ'
func (ar *ar_IQ) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_IQ'
func (ar *ar_IQ) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_IQ'
func (ar *ar_IQ) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_IQ'
func (ar *ar_IQ) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_IQ'
func (ar *ar_IQ) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_IQ'
func (ar *ar_IQ) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_IQ'
func (ar *ar_IQ) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_IQ'
func (ar *ar_IQ) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_IQ) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_IQ) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_IQ) GetMiscPatterns() *locales.MiscPatterns {
