...
// DateFullLayout returns the full date layout for 'en_AS'
func (en *en_AS) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_AS'
func (en *en_AS) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_AS'
func (en *en_AS) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_AS'
func (en *en_AS) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_AS'
func (en *en_AS) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_AS'
func (en *en_AS) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_AS'
func (en *en_AS) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_AS'
func (en *en_AS) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_AS) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_AS) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_AS) GetMiscPatterns() *locales.MiscPatterns {
