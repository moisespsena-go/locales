...
// DateFullLayout returns the full date layout for 'sr_Cyrl'
func (sr *sr_Cyrl) DateFullLayout() string {
	return sr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sr_Cyrl'
func (sr *sr_Cyrl) DateLongLayout() string {
	return sr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sr_Cyrl'
func (sr *sr_Cyrl) DateMediumLayout() string {
	return sr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sr_Cyrl'
func (sr *sr_Cyrl) DateShortLayout() string {
	return sr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sr_Cyrl'
func (sr *sr_Cyrl) TimeFullLayout() string {
	return sr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sr_Cyrl'
func (sr *sr_Cyrl) TimeLongLayout() string {
	return sr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sr_Cyrl'
func (sr *sr_Cyrl) TimeMediumLayout() string {
	return sr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sr_Cyrl'
func (sr *sr_Cyrl) TimeShortLayout() string {
	return sr.timeShortLayout
}

func (sr *sr_Cyrl) ListPatterns() *locales.ListPatterns {
	return sr.listPatterns
}

func (sr *sr_Cyrl) GetDurationSpec() *locales.DurationSpec {
	return sr.DurationSpec
}

func (sr *sr_Cyrl) GetMiscPatterns() *locales.MiscPatterns {
