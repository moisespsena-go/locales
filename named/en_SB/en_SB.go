...
// DateFullLayout returns the full date layout for 'en_SB'
func (en *en_SB) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_SB'
func (en *en_SB) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_SB'
func (en *en_SB) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_SB'
func (en *en_SB) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_SB'
func (en *en_SB) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_SB'
func (en *en_SB) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_SB'
func (en *en_SB) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_SB'
func (en *en_SB) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_SB) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_SB) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_SB) GetMiscPatterns() *locales.MiscPatterns {
