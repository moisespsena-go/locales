...
func New() locales.Translator {
	return &mn{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 0 мянга"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 0 мянга"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 00 мянга"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 00 мянга"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000 мянга"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000 мянга"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0 сая"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 сая"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00 сая"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 сая"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000 сая"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000 сая"),
						}},
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0 тэрбум"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 тэрбум"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 00 тэрбум"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 00 тэрбум"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 000 тэрбум"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 000 тэрбум"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 0 их наяд"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 0 их наяд"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 00 их наяд"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 00 их наяд"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 000 их наяд"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 000 их наяд"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "1-р сар", "2-р сар", "3-р сар", "4-р сар", "5-р сар", "6-р сар", "7-р сар", "8-р сар", "9-р сар", "10-р сар", "11-р сар", "12-р сар"},
			MonthsNarrowValue:        []string{"", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII"},
			MonthsWideValue:          []string{"", "нэгдүгээр сар", "хоёрдугаар сар", "гуравдугаар сар", "дөрөвдүгээр сар", "тавдугаар сар", "зургаадугаар сар", "долоодугаар сар", "наймдугаар сар", "есдүгээр сар", "аравдугаар сар", "арван нэгдүгээр сар", "арван хоёрдугаар сар"},
			WeekdaysAbbreviatedValue: []string{"Ня", "Да", "Мя", "Лх", "Пү", "Ба", "Бя"},
			WeekdaysNarrowValue:      []string{"Ня", "Да", "Мя", "Лх", "Пү", "Ба", "Бя"},
			WeekdaysShortValue:       []string{"Ня", "Да", "Мя", "Лх", "Пү", "Ба", "Бя"},
			WeekdaysWideValue:        []string{"ням", "даваа", "мягмар", "лхагва", "пүрэв", "баасан", "бямба"},
			PeriodsAbbreviatedValue:  []string{"ү.ө.", "ү.х."},
			PeriodsNarrowValue:       []string{"ү.ө.", "ү.х."},
			PeriodsWideValue:         []string{"ү.ө.", "ү.х."},
			ErasAbbreviatedValue:     []string{"МЭӨ", "МЭ"},
			ErasNarrowValue:          []string{"МЭӨ", "МЭ"},
			ErasWideValue:            []string{"манай эриний өмнөх", "манай эриний"},
			TimezonesValue:           map[string]string{"": "Парагвайн стандарт цаг", "ACDT": "Төв Австралийн зуны цаг", "ACST": "Төв Австралийн стандарт цаг", "ACT": "ACT", "ACWDT": "Австралийн төв баруун эргийн зуны цаг", "ACWST": "Австралийн төв баруун эргийн стандарт цаг", "ADT": "Атлантын зуны цаг", "AEDT": "Австралийн зүүн эргийн зуны цаг", "AEST": "Австралийн зүүн эргийн стандарт цаг", "AFT": "Афганистаны цаг", "AKDT": "Аляскийн зуны цаг", "AKST": "Аляскийн стандарт цаг", "AMST": "Амазоны зуны цаг", "AMT": "Амазоны стандарт цаг", "ARST": "Аргентины зуны цаг", "ART": "Аргентины стандарт цаг", "AST": "Атлантын стандарт цаг", "AWDT": "Австралийн баруун эргийн зуны цаг", "AWST": "Австралийн баруун эргийн стандарт цаг", "BNT": "Бруней Даруссаламын цаг", "BOT": "Боливийн цаг", "BRST": "Бразилийн зуны цаг", "BRT": "Бразилийн стандарт цаг", "BST": "Бангладешийн зуны цаг", "BTT": "Бутаны цаг", "CAT": "Төв Африкийн цаг", "CCT": "Кокос арлын цаг", "CDT": "Төв зуны цаг", "CDT (Kuba)": "Кубын зуны цаг", "CHADT": "Чатемын зуны цаг", "CHAST": "Чатемын стандарт цаг", "CLST": "Чилийн зуны цаг", "CLT": "Чилийн стандарт цаг", "COST": "Колумбын зуны цаг", "COT": "Колумбын стандарт цаг", "CST": "Төв стандарт цаг", "CST (Kuba)": "Кубын стандарт цаг", "CXT": "Крисмас арлын цаг", "ChST": "Чаморрогийн цаг", "EASST": "Зүүн Исландын зуны цаг", "EAST": "Зүүн Исландын стандарт цаг", "EAT": "Зүүн Африкийн цаг", "ECT": "Эквадорын цаг", "EDT": "Зүүн эргийн зуны цаг", "EGDT": "Зүүн Гренландын зуны цаг", "EGST": "Зүүн Гренландын стандарт цаг", "EST": "Зүүн эргийн стандарт цаг", "FKST": "Фолклендийн арлуудын зуны цаг", "GALT": "Галапагосын цаг", "GFT": "Францын Гвианагийн цаг", "GMT": "Гринвичийн цаг", "GST": "Персийн булангийн цаг", "GYT": "Гайанагийн цаг", "HADT": "Хавай-Алеутын зуны цаг", "HAST": "Хавай-Алеутын стандарт цаг", "HENOMX": "Баруун хойд Мексикийн зуны цаг", "HEOG": "Баруун Гренландын зуны цаг", "HEPMX": "Мексик-Номхон далайн зуны цаг", "HKST": "Хонг Конгийн зуны цаг", "HKT": "Хонг Конгийн стандарт цаг", "HNNOMX": "Баруун хойд Мексикийн стандарт цаг", "HNOG": "Баруун Гренландын стандарт цаг", "HNPMX": "Мексик-Номхон далайн стандарт цаг", "ICT": "Энэтхэг-Хятадын хойгийн цаг", "IRDT": "Ираны зуны цаг", "IRST": "Ираны стандарт цаг", "IST": "Энэтхэгийн цаг", "JDT": "Японы зуны цаг", "JST": "Японы стандарт цаг", "LHDT": "Лорд Хоугийн зуны цаг", "LHST": "Лорд Хоугийн стандарт цаг", "MDT": "Уулын зуны цаг", "MESZ": "Төв Европын зуны цаг", "MEZ": "Төв Европын стандарт цаг", "MST": "Уулын стандарт цаг", "MVT": "Мальдивийн цаг", "MYT": "Малайзын цаг", "NDT": "Нью-Фаундлендын зуны цаг", "NPT": "Балбын цаг", "NST": "Нью-Фаундлендын стандарт цаг", "NZDT": "Шинэ Зеландын зуны цаг", "NZST": "Шинэ Зеландын стандарт цаг", "OESZ": "Зүүн Европын зуны цаг", "OEZ": "Зүүн Европын стандарт цаг", "PDT": "Номхон далайн зуны цаг", "PKT": "Пакистаны зуны цаг", "PMDT": "Сент-Пьер ба Микелоны зуны цаг", "PMST": "Сент-Пьер ба Микелоны стандарт цаг", "PST": "Номхон далайн стандарт цаг", "PYST": "Парагвайн зуны цаг", "SAST": "Өмнөд Африкийн стандарт цаг", "SGT": "Сингапурын цаг", "SRT": "Суринамын цаг", "TLT": "Зүүн Тиморын цаг", "TMST": "Туркменистаны зуны цаг", "TMT": "Туркменистаны стандарт цаг", "UYST": "Уругвайн зуны цаг", "UYT": "Уругвайн стандарт цаг", "VET": "Венесуэлийн цаг", "WARST": "Баруун Аргентины зуны цаг", "WART": "Баруун Аргентины стандарт цаг", "WAST": "Баруун Африкийн зуны цаг", "WAT": "Баруун Африкийн стандарт цаг", "WESZ": "Баруун Европын зуны цаг", "WEZ": "Баруун Европын стандарт цаг", "WIB": "Баруун Индонезийн цаг", "WIT": "Зүүн Индонезийн цаг", "WITA": "Төв Индонезийн цаг", "∅∅∅": "Перугийн зуны цаг"},
		},
		...
		dateFullLayout:   "y 'оны' MMMM'ын' d, EEEE 'гараг'",
		dateLongLayout:   "y 'оны' MMMM'ын' d",
		dateMediumLayout: "y 'оны' MMM'ын' d",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0}, {1}", "{0}, {1}", "{0}, {1}", "{0}, {1}"}, {"{0} эсвэл {1}", "{0}, {1}", "{0}, {1}", "{0}, {1} зэргийн аль нэг"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"зуун", "%v зуун", "%v зуун", ""},
				Long:   &locales.CounterFormat{"зуун", "%v зуун", "%v зуун", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"декад", "%v декад", "%v декад", ""},
				Long:   &locales.CounterFormat{"декад", "%v декад", "%v декад", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"жил", "%vж", "%vж", ""},
				Long:   &locales.CounterFormat{"жил", "%v жил", "%v жил", "%v/жил"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"сар", "%vс", "%vс", ""},
				Long:   &locales.CounterFormat{"сар", "%v сар", "%v сар", "%v/сар"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"д.х", "%v д.х", "%v д.х", ""},
				Long:   &locales.CounterFormat{"долоо хоног", "%v долоо хоног", "%v долоо хоног", "%v/долоо хоног"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"хоног", "%v хоног", "%v хоног", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"цаг", "%v ц", "%v ц", ""},
				Long:   &locales.CounterFormat{"цаг", "%v цаг", "%v цаг", "%v/ц"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мин", "%v мин", "%v мин", ""},
				Long:   &locales.CounterFormat{"минут", "%v минут", "%v минут", "%v/мин"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"сек", "%v сек", "%v сек", ""},
				Long:   &locales.CounterFormat{"секунд", "%v секунд", "%v секунд", "%v/сек"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мсек", "%v мс", "%v мс", ""},
				Long:   &locales.CounterFormat{"миллисекунд", "%v миллисекунд", "%v миллисекунд", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μсек", "%v μсек", "%v μсек", ""},
...
func (mn *mn) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(mn, mn.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'mn'
func (mn *mn) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(mn, mn.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'mn'
func (mn *mn) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(mn, mn.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'mn'
func (mn *mn) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(mn, mn.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'mn'
func (mn *mn) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(mn, mn.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'mn'
func (mn *mn) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(mn, mn.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'mn'
func (mn *mn) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(mn, mn.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'mn'
func (mn *mn) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(mn, mn.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'mn'
func (mn *mn) DateFullLayout() string {
	return mn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mn'
func (mn *mn) DateLongLayout() string {
	return mn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mn'
func (mn *mn) DateMediumLayout() string {
	return mn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mn'
func (mn *mn) DateShortLayout() string {
	return mn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mn'
func (mn *mn) TimeFullLayout() string {
	return mn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mn'
func (mn *mn) TimeLongLayout() string {
	return mn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mn'
func (mn *mn) TimeMediumLayout() string {
	return mn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mn'
func (mn *mn) TimeShortLayout() string {
	return mn.timeShortLayout
}

func (mn *mn) ListPatterns() *locales.ListPatterns {
	return mn.listPatterns
}

func (mn *mn) GetDurationSpec() *locales.DurationSpec {
	return mn.DurationSpec
}

func (mn *mn) GetMiscPatterns() *locales.MiscPatterns {
	return &mn.miscPatterns
}
