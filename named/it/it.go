...
func New() locales.Translator {
	return &it{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "gen", "feb", "mar", "apr", "mag", "giu", "lug", "ago", "set", "ott", "nov", "dic"},
			MonthsNarrowValue:        []string{"", "G", "F", "M", "A", "M", "G", "L", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "gennaio", "febbraio", "marzo", "aprile", "maggio", "giugno", "luglio", "agosto", "settembre", "ottobre", "novembre", "dicembre"},
			WeekdaysAbbreviatedValue: []string{"dom", "lun", "mar", "mer", "gio", "ven", "sab"},
			WeekdaysNarrowValue:      []string{"D", "L", "M", "M", "G", "V", "S"},
			WeekdaysShortValue:       []string{"dom", "lun", "mar", "mer", "gio", "ven", "sab"},
			WeekdaysWideValue:        []string{"domenica", "lunedì", "martedì", "mercoledì", "giovedì", "venerdì", "sabato"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsNarrowValue:       []string{"m.", "p."},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"a.C.", "d.C."},
			ErasNarrowValue:          []string{"aC", "dC"},
			ErasWideValue:            []string{"avanti Cristo", "dopo Cristo"},
			TimezonesValue:           map[string]string{"": "Ora standard del Paraguay", "ACDT": "Ora legale dell’Australia centrale", "ACST": "Ora standard dell’Australia centrale", "ACT": "ACT", "ACWDT": "Ora legale dell’Australia centroccidentale", "ACWST": "Ora standard dell’Australia centroccidentale", "ADT": "Ora legale dell’Atlantico", "AEDT": "Ora legale dell’Australia orientale", "AEST": "Ora standard dell’Australia orientale", "AFT": "Ora dell’Afghanistan", "AKDT": "Ora legale dell’Alaska", "AKST": "Ora standard dell’Alaska", "AMST": "Ora legale dell’Amazzonia", "AMT": "Ora standard dell’Amazzonia", "ARST": "Ora legale dell’Argentina", "ART": "Ora standard dell’Argentina", "AST": "Ora standard dell’Atlantico", "AWDT": "Ora legale dell’Australia occidentale", "AWST": "Ora standard dell’Australia occidentale", "BNT": "Ora del Brunei Darussalam", "BOT": "Ora della Bolivia", "BRST": "Ora legale di Brasilia", "BRT": "Ora standard di Brasilia", "BST": "Ora legale del Bangladesh", "BTT": "Ora del Bhutan", "CAT": "Ora dell’Africa centrale", "CCT": "Ora delle Isole Cocos", "CDT": "Ora legale centrale USA", "CDT (Kuba)": "Ora legale di Cuba", "CHADT": "Ora legale delle Chatham", "CHAST": "Ora standard delle Chatham", "CLST": "Ora legale del Cile", "CLT": "Ora standard del Cile", "COST": "Ora legale della Colombia", "COT": "Ora standard della Colombia", "CST": "Ora standard centrale USA", "CST (Kuba)": "Ora standard di Cuba", "CXT": "Ora dell’Isola Christmas", "ChST": "Ora di Chamorro", "EASST": "Ora legale dell’Isola di Pasqua", "EAST": "Ora standard dell’Isola di Pasqua", "EAT": "Ora dell’Africa orientale", "ECT": "Ora dell’Ecuador", "EDT": "Ora legale orientale USA", "EGDT": "Ora legale della Groenlandia orientale", "EGST": "Ora standard della Groenlandia orientale", "EST": "Ora standard orientale USA", "FKST": "Ora legale delle Isole Falkland", "GALT": "Ora delle Galapagos", "GFT": "Ora della Guiana francese", "GMT": "Ora del meridiano di Greenwich", "GST": "Ora del Golfo", "GYT": "Ora della Guyana", "HADT": "Ora legale delle Isole Hawaii-Aleutine", "HAST": "Ora standard delle Isole Hawaii-Aleutine", "HENOMX": "Ora legale del Messico nord-occidentale", "HEOG": "Ora legale della Groenlandia occidentale", "HEPMX": "Ora legale del Pacifico (Messico)", "HKST": "Ora legale di Hong Kong", "HKT": "Ora standard di Hong Kong", "HNNOMX": "Ora standard del Messico nord-occidentale", "HNOG": "Ora standard della Groenlandia occidentale", "HNPMX": "Ora standard del Pacifico (Messico)", "ICT": "Ora dell’Indocina", "IRDT": "Ora legale dell’Iran", "IRST": "Ora standard dell’Iran", "IST": "Ora standard dell’India", "JDT": "Ora legale del Giappone", "JST": "Ora standard del Giappone", "LHDT": "Ora legale di Lord Howe", "LHST": "Ora standard di Lord Howe", "MDT": "Ora legale Montagne Rocciose USA", "MESZ": "Ora legale dell’Europa centrale", "MEZ": "Ora standard dell’Europa centrale", "MST": "Ora standard Montagne Rocciose USA", "MVT": "Ora delle Maldive", "MYT": "Ora della Malesia", "NDT": "Ora legale di Terranova", "NPT": "Ora del Nepal", "NST": "Ora standard di Terranova", "NZDT": "Ora legale della Nuova Zelanda", "NZST": "Ora standard della Nuova Zelanda", "OESZ": "Ora legale dell’Europa orientale", "OEZ": "Ora standard dell’Europa orientale", "PDT": "Ora legale del Pacifico USA", "PKT": "Ora legale del Pakistan", "PMDT": "Ora legale di Saint-Pierre e Miquelon", "PMST": "Ora standard di Saint-Pierre e Miquelon", "PST": "Ora standard del Pacifico USA", "PYST": "Ora legale del Paraguay", "SAST": "Ora dell’Africa meridionale", "SGT": "Ora di Singapore", "SRT": "Ora del Suriname", "TLT": "Ora di Timor Est", "TMST": "Ora legale del Turkmenistan", "TMT": "Ora standard del Turkmenistan", "UYST": "Ora legale dell’Uruguay", "UYT": "Ora standard dell’Uruguay", "VET": "Ora del Venezuela", "WARST": "Ora legale dell’Argentina occidentale", "WART": "Ora standard dell’Argentina occidentale", "WAST": "Ora legale dell’Africa occidentale", "WAT": "Ora standard dell’Africa occidentale", "WESZ": "Ora legale dell’Europa occidentale", "WEZ": "Ora standard dell’Europa occidentale", "WIB": "Ora dell’Indonesia occidentale", "WIT": "Ora dell’Indonesia orientale", "WITA": "Ora dell’Indonesia centrale", "∅∅∅": "Ora legale del Perù"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} e {1}", "{0}, {1}", "{0}, {1}", "{0} e {1}"}, {"{0} o {1}", "{0}, {1}", "{0}, {1}", "{0} o {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vsec.", "%vsecc.", ""},
				Long:   &locales.CounterFormat{"secoli", "%v secolo", "%v secoli", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vdec.", "%vdec.", ""},
				Long:   &locales.CounterFormat{"decadi", "%v decade", "%v decadi", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"anno", "%vanno", "%vanni", ""},
				Long:   &locales.CounterFormat{"anni", "%v anno", "%v anni", "%v all’anno"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mese", "%v mese", "%v mesi", ""},
				Long:   &locales.CounterFormat{"mesi", "%v mese", "%v mesi", "%v al mese"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sett.", "%vsett.", "%vsett.", "%v/sett."},
				Long:   &locales.CounterFormat{"settimane", "%v settimana", "%v settimane", "%v alla settimana"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"giorno", "%v g", "%vgg", "%v/g"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ora", "%vh", "%vh", ""},
				Long:   &locales.CounterFormat{"ore", "%v ora", "%v ore", "%v all’ora"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%vmin", "%vmin", ""},
				Long:   &locales.CounterFormat{"minuti", "%v minuto", "%v minuti", "%v al minuto"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%vs", "%vs", ""},
				Long:   &locales.CounterFormat{"secondi", "%v secondo", "%v secondi", "%v al secondo"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"millisecondi", "%v millisecondo", "%v millisecondi", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vμs", "%vμs", ""},
				Long:   &locales.CounterFormat{"microsecondi", "%v microsecondo", "%v microsecondi", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vns", "%vns", ""},
				Long:   &locales.CounterFormat{"nanosecondi", "%v nanosecondo", "%v nanosecondi", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"≥%[1]v",
...
func (it *it) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(it, it.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'it'
func (it *it) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(it, it.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'it'
func (it *it) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(it, it.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'it'
func (it *it) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(it, it.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'it'
func (it *it) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(it, it.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'it'
func (it *it) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(it, it.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'it'
func (it *it) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(it, it.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'it'
func (it *it) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(it, it.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'it'
func (it *it) DateFullLayout() string {
	return it.dateFullLayout
}

// DateLongLayout returns the long date layout for 'it'
func (it *it) DateLongLayout() string {
	return it.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'it'
func (it *it) DateMediumLayout() string {
	return it.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'it'
func (it *it) DateShortLayout() string {
	return it.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'it'
func (it *it) TimeFullLayout() string {
	return it.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'it'
func (it *it) TimeLongLayout() string {
	return it.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'it'
func (it *it) TimeMediumLayout() string {
	return it.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'it'
func (it *it) TimeShortLayout() string {
	return it.timeShortLayout
}

func (it *it) ListPatterns() *locales.ListPatterns {
	return it.listPatterns
}

func (it *it) GetDurationSpec() *locales.DurationSpec {
	return it.DurationSpec
}

func (it *it) GetMiscPatterns() *locales.MiscPatterns {
	return &it.miscPatterns
}
