...
// DateFullLayout returns the full date layout for 'sw_TZ'
func (sw *sw_TZ) DateFullLayout() string {
	return sw.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sw_TZ'
func (sw *sw_TZ) DateLongLayout() string {
	return sw.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sw_TZ'
func (sw *sw_TZ) DateMediumLayout() string {
	return sw.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sw_TZ'
func (sw *sw_TZ) DateShortLayout() string {
	return sw.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sw_TZ'
func (sw *sw_TZ) TimeFullLayout() string {
	return sw.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sw_TZ'
func (sw *sw_TZ) TimeLongLayout() string {
	return sw.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sw_TZ'
func (sw *sw_TZ) TimeMediumLayout() string {
	return sw.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sw_TZ'
func (sw *sw_TZ) TimeShortLayout() string {
	return sw.timeShortLayout
}

func (sw *sw_TZ) ListPatterns() *locales.ListPatterns {
	return sw.listPatterns
}

func (sw *sw_TZ) GetDurationSpec() *locales.DurationSpec {
	return sw.DurationSpec
}

func (sw *sw_TZ) GetMiscPatterns() *locales.MiscPatterns {
