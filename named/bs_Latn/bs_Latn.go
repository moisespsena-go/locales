...
// DateFullLayout returns the full date layout for 'bs_Latn'
func (bs *bs_Latn) DateFullLayout() string {
	return bs.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bs_Latn'
func (bs *bs_Latn) DateLongLayout() string {
	return bs.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bs_Latn'
func (bs *bs_Latn) DateMediumLayout() string {
	return bs.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bs_Latn'
func (bs *bs_Latn) DateShortLayout() string {
	return bs.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bs_Latn'
func (bs *bs_Latn) TimeFullLayout() string {
	return bs.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bs_Latn'
func (bs *bs_Latn) TimeLongLayout() string {
	return bs.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bs_Latn'
func (bs *bs_Latn) TimeMediumLayout() string {
	return bs.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bs_Latn'
func (bs *bs_Latn) TimeShortLayout() string {
	return bs.timeShortLayout
}

func (bs *bs_Latn) ListPatterns() *locales.ListPatterns {
	return bs.listPatterns
}

func (bs *bs_Latn) GetDurationSpec() *locales.DurationSpec {
	return bs.DurationSpec
}

func (bs *bs_Latn) GetMiscPatterns() *locales.MiscPatterns {
