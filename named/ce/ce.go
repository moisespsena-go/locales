...
func New() locales.Translator {
	return &ce{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ш.", "%v ш.", "%v ш.", ""},
				Long:   &locales.CounterFormat{"шераш", "%v шо", "%v шо", "%v шарахь"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"бут", "%v б.", "%v б.", ""},
				Long:   &locales.CounterFormat{"беттанаш", "%v бутт", "%v бутт", "%v баттахь"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"кӀир", "%v кӀ.", "%v кӀ.", ""},
				Long:   &locales.CounterFormat{"кӀиранаш", "%v кӀира", "%v кӀира", "%v кӀиранахь"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"д.", "%v д.", "%v д.", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"сахь", "%v сахь.", "%v сахь.", ""},
				Long:   &locales.CounterFormat{"сахьташ", "%v сахьт", "%v сахьт", "%v сахьтехь"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мин", "%v мин", "%v мин", ""},
				Long:   &locales.CounterFormat{"миноташ", "%v минот", "%v минот", "%v минотехь"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"с", "%v с", "%v с", ""},
				Long:   &locales.CounterFormat{"секундаш", "%v секунд", "%v секунд", "%v секундехь"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мс", "%v мс", "%v мс", ""},
				Long:   &locales.CounterFormat{"миллисекундаш", "%v миллисекунд", "%v миллисекунд", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мкс", "%v мкс", "%v мкс", ""},
				Long:   &locales.CounterFormat{"микросекундаш", "%v микросекунд", "%v микросекунд", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"нс", "%v нс", "%v нс", ""},
				Long:   &locales.CounterFormat{"наносекундаш", "%v наносекунд", "%v наносекунд", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"",
			"",
...
// DateFullLayout returns the full date layout for 'ce'
func (ce *ce) DateFullLayout() string {
	return ce.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ce'
func (ce *ce) DateLongLayout() string {
	return ce.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ce'
func (ce *ce) DateMediumLayout() string {
	return ce.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ce'
func (ce *ce) DateShortLayout() string {
	return ce.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ce'
func (ce *ce) TimeFullLayout() string {
	return ce.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ce'
func (ce *ce) TimeLongLayout() string {
	return ce.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ce'
func (ce *ce) TimeMediumLayout() string {
	return ce.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ce'
func (ce *ce) TimeShortLayout() string {
	return ce.timeShortLayout
}

func (ce *ce) ListPatterns() *locales.ListPatterns {
	return ce.listPatterns
}

func (ce *ce) GetDurationSpec() *locales.DurationSpec {
	return ce.DurationSpec
}

func (ce *ce) GetMiscPatterns() *locales.MiscPatterns {
