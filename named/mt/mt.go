...
func New() locales.Translator {
	return &mt{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Fra", "Mar", "Apr", "Mej", "Ġun", "Lul", "Aww", "Set", "Ott", "Nov", "Diċ"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "Ġ", "L", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Jannar", "Frar", "Marzu", "April", "Mejju", "Ġunju", "Lulju", "Awwissu", "Settembru", "Ottubru", "Novembru", "Diċembru"},
			WeekdaysAbbreviatedValue: []string{"Ħad", "Tne", "Tli", "Erb", "Ħam", "Ġim", "Sib"},
			WeekdaysNarrowValue:      []string{"Ħd", "T", "Tl", "Er", "Ħm", "Ġm", "Sb"},
			WeekdaysShortValue:       []string{"Ħad", "Tne", "Tli", "Erb", "Ħam", "Ġim", "Sib"},
			WeekdaysWideValue:        []string{"Il-Ħadd", "It-Tnejn", "It-Tlieta", "L-Erbgħa", "Il-Ħamis", "Il-Ġimgħa", "Is-Sibt"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsNarrowValue:       []string{"am", "pm"},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"QK", "WK"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Qabel Kristu", "Wara Kristu"},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "ADT", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "AST", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "CAT", "CCT": "CCT", "CDT": "CDT", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "CST", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "EAT", "ECT": "ECT", "EDT": "EDT", "EGDT": "EGDT", "EGST": "EGST", "EST": "EST", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "GMT", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "Ħin Ċentrali Ewropew tas-Sajf", "MEZ": "Ħin Ċentrali Ewropew Standard", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "OESZ", "OEZ": "OEZ", "PDT": "PDT", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "PST", "PYST": "PYST", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "WESZ", "WEZ": "WEZ", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		dateFullLayout:   "EEEE, d 'ta'’ MMMM y",
		dateLongLayout:   "d 'ta'’ MMMM y",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} u {1}", "{0}, {1}", "{0}, {1}", "{0}, u {1}"}, []string(nil)}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"millisek", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"millisekondi", "%v millisekonda", "%v millisekondi", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
		miscPatterns: locales.MiscPatterns{
...
func (mt *mt) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(mt, mt.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'mt'
func (mt *mt) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(mt, mt.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'mt'
func (mt *mt) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(mt, mt.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'mt'
func (mt *mt) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(mt, mt.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'mt'
func (mt *mt) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(mt, mt.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'mt'
func (mt *mt) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(mt, mt.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'mt'
func (mt *mt) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(mt, mt.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'mt'
func (mt *mt) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(mt, mt.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'mt'
func (mt *mt) DateFullLayout() string {
	return mt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mt'
func (mt *mt) DateLongLayout() string {
	return mt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mt'
func (mt *mt) DateMediumLayout() string {
	return mt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mt'
func (mt *mt) DateShortLayout() string {
	return mt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mt'
func (mt *mt) TimeFullLayout() string {
	return mt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mt'
func (mt *mt) TimeLongLayout() string {
	return mt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mt'
func (mt *mt) TimeMediumLayout() string {
	return mt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mt'
func (mt *mt) TimeShortLayout() string {
	return mt.timeShortLayout
}

func (mt *mt) ListPatterns() *locales.ListPatterns {
	return mt.listPatterns
}

func (mt *mt) GetDurationSpec() *locales.DurationSpec {
	return mt.DurationSpec
}

func (mt *mt) GetMiscPatterns() *locales.MiscPatterns {
	return &mt.miscPatterns
}
