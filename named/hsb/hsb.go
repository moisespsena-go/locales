...
func New() locales.Translator {
	return &hsb{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jan.", "feb.", "měr.", "apr.", "mej.", "jun.", "jul.", "awg.", "sep.", "okt.", "now.", "dec."},
			MonthsNarrowValue:        []string{"", "j", "f", "m", "a", "m", "j", "j", "a", "s", "o", "n", "d"},
			MonthsWideValue:          []string{"", "januara", "februara", "měrca", "apryla", "meje", "junija", "julija", "awgusta", "septembra", "oktobra", "nowembra", "decembra"},
			WeekdaysAbbreviatedValue: []string{"nje", "pón", "wut", "srj", "štw", "pja", "sob"},
			WeekdaysNarrowValue:      []string{"n", "p", "w", "s", "š", "p", "s"},
			WeekdaysShortValue:       []string{"nj", "pó", "wu", "sr", "št", "pj", "so"},
			WeekdaysWideValue:        []string{"njedźela", "póndźela", "wutora", "srjeda", "štwórtk", "pjatk", "sobota"},
			PeriodsAbbreviatedValue:  []string{"dopołdnja", "popołdnju"},
			PeriodsNarrowValue:       []string{"dop.", "pop."},
			PeriodsWideValue:         []string{"dopołdnja", "popołdnju"},
			ErasAbbreviatedValue:     []string{"př.Chr.n.", "po Chr.n."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"před Chrystowym narodźenjom", "po Chrystowym narodźenju"},
			TimezonesValue:           map[string]string{"": "falklandski standardny čas", "ACDT": "srjedźoawstralski lětni čas", "ACST": "srjedźoawstralski standardny čas", "ACT": "ACT", "ACWDT": "sjedźozapadny awstralski lětni čas", "ACWST": "srjedźozapadny awstralski standardny čas", "ADT": "atlantiski lětni čas", "AEDT": "wuchodoawstralski lětni čas", "AEST": "wuchodoawstralski standardny čas", "AFT": "afghanski čas", "AKDT": "alaskaski lětni čas", "AKST": "alaskaski standardny čas", "AMST": "Amaconaski lětni čas", "AMT": "Amaconaski standardny čas", "ARST": "argentinski lětni čas", "ART": "argentinski standardny čas", "AST": "atlantiski standardny čas", "AWDT": "zapadoawstralski lětni čas", "AWST": "zapadoawstralski standardny čas", "BNT": "bruneiski čas", "BOT": "boliwiski čas", "BRST": "Brasiliski lětni čas", "BRT": "Brasiliski standardny čas", "BST": "bangladešski lětni čas", "BTT": "bhutanski čas", "CAT": "centralnoafriski čas", "CCT": "čas Kokosowych kupow", "CDT": "sewjeroameriski centralny lětni čas", "CDT (Kuba)": "kubaski lětni čas", "CHADT": "chathamski lětni čas", "CHAST": "chathamski standardny čas", "CLST": "chilski lětni čas", "CLT": "chilski standardny čas", "COST": "kolumbiski lětni čas", "COT": "kolumbiski standardny čas", "CST": "sewjeroameriski centralny standardny čas", "CST (Kuba)": "kubaski standardny čas", "CXT": "čas Hodowneje kupy", "ChST": "chamorroski čas", "EASST": "lětni čas Jutrowneje kupy", "EAST": "standardny čas Jutrowneje kupy", "EAT": "wuchodoafriski čas", "ECT": "ekwadorski čas", "EDT": "sewjeroameriski wuchodny lětni čas", "EGDT": "wuchodogrönlandski lětni čas", "EGST": "wuchodogrönlandski standardny čas", "EST": "sewjeroameriski wuchodny standardny čas", "FKST": "falklandski lětni čas", "GALT": "galapagoski čas", "GFT": "francoskoguyanski čas", "GMT": "Greenwichski čas", "GST": "čas Persiskeho golfa", "GYT": "guyanski čas", "HADT": "hawaiisko-aleutski lětni čas", "HAST": "hawaiisko-aleutski standardny čas", "HENOMX": "mexiski sewjerozapadny lětni čas", "HEOG": "zapadogrönlandski lětni čas", "HEPMX": "mexiski pacifiski lětni čas", "HKST": "Hongkongski lětni čas", "HKT": "Hongkongski standardny čas", "HNNOMX": "mexiski sewjerozapadny standardny čas", "HNOG": "zapadogrönlandski standardny čas", "HNPMX": "mexiski pacifiski standardny čas", "ICT": "indochinski čas", "IRDT": "iranski lětni čas", "IRST": "iranski standardny čas", "IST": "indiski čas", "JDT": "japanski lětni čas", "JST": "japanski standardny čas", "LHDT": "lětni čas kupy Lord-Howe", "LHST": "standardny čas kupy Lord-Howe", "MDT": "MDT", "MESZ": "srjedźoeuropski lětni čas", "MEZ": "srjedźoeuropski standardny čas", "MST": "MST", "MVT": "malediwski čas", "MYT": "malajziski čas", "NDT": "nowofundlandski lětni čas", "NPT": "nepalski čas", "NST": "nowofundlandski standardny čas", "NZDT": "nowoseelandski lětni čas", "NZST": "nowoseelandski standardny čas", "OESZ": "wuchodoeuropski lětni čas", "OEZ": "wuchodoeuropski standardny čas", "PDT": "sewjeroameriski pacifiski lětni čas", "PKT": "pakistanski lětni čas", "PMDT": "lětni čas kupow St. Pierre a Miquelon", "PMST": "standardny čas kupow St. Pierre a Miquelon", "PST": "sewjeroameriski pacifiski standardny čas", "PYST": "Paraguayski lětni čas", "SAST": "južnoafriski čas", "SGT": "Singapurski čas", "SRT": "surinamski čas", "TLT": "wuchodnotimorski čas", "TMST": "turkmenski lětni čas", "TMT": "turkmenski standardny čas", "UYST": "uruguayski lětni čas", "UYT": "uruguayski standardny čas", "VET": "venezuelski čas", "WARST": "zapadoargentinski lětni čas", "WART": "zapadoargentinski standardny čas", "WAST": "zapadoafriski lětni čas", "WAT": "zapadoafriski standardny čas", "WESZ": "zapadoeuropski lětni čas", "WEZ": "zapadoeuropski standardny čas", "WIB": "zapadoindoneski čas", "WIT": "wuchodoindoneski", "WITA": "srjedźoindoneski čas", "∅∅∅": "peruski lětni čas"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"lětdź.", "%v lětdź.", "%v lětdź.", ""},
				Long:   &locales.CounterFormat{"lětdźesatki", "%v lětdźesatk", "%v lětdźesatkow", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"měs.", "%v měs.", "%v měs.", ""},
				Long:   &locales.CounterFormat{"měsacy", "%v měsac", "%v měsacow", "%v wob měsac"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"t.", "%v t.", "%v t.", ""},
				Long:   &locales.CounterFormat{"tydźenje", "%v tydźeń", "%v tydźenjow", "%v wob tydźeń"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"hodźiny", "%v hodźina", "%v hodźinow", "%v na hodźinu"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
...
func (hsb *hsb) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(hsb, hsb.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'hsb'
func (hsb *hsb) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(hsb, hsb.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'hsb'
func (hsb *hsb) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(hsb, hsb.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'hsb'
func (hsb *hsb) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(hsb, hsb.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'hsb'
func (hsb *hsb) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(hsb, hsb.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'hsb'
func (hsb *hsb) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(hsb, hsb.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'hsb'
func (hsb *hsb) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(hsb, hsb.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'hsb'
func (hsb *hsb) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(hsb, hsb.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'hsb'
func (hsb *hsb) DateFullLayout() string {
	return hsb.dateFullLayout
}

// DateLongLayout returns the long date layout for 'hsb'
func (hsb *hsb) DateLongLayout() string {
	return hsb.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'hsb'
func (hsb *hsb) DateMediumLayout() string {
	return hsb.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'hsb'
func (hsb *hsb) DateShortLayout() string {
	return hsb.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'hsb'
func (hsb *hsb) TimeFullLayout() string {
	return hsb.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'hsb'
func (hsb *hsb) TimeLongLayout() string {
	return hsb.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'hsb'
func (hsb *hsb) TimeMediumLayout() string {
	return hsb.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'hsb'
func (hsb *hsb) TimeShortLayout() string {
	return hsb.timeShortLayout
}

func (hsb *hsb) ListPatterns() *locales.ListPatterns {
	return hsb.listPatterns
}

func (hsb *hsb) GetDurationSpec() *locales.DurationSpec {
	return hsb.DurationSpec
}

func (hsb *hsb) GetMiscPatterns() *locales.MiscPatterns {
	return &hsb.miscPatterns
}
