...
// DateFullLayout returns the full date layout for 'fy_NL'
func (fy *fy_NL) DateFullLayout() string {
	return fy.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fy_NL'
func (fy *fy_NL) DateLongLayout() string {
	return fy.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fy_NL'
func (fy *fy_NL) DateMediumLayout() string {
	return fy.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fy_NL'
func (fy *fy_NL) DateShortLayout() string {
	return fy.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fy_NL'
func (fy *fy_NL) TimeFullLayout() string {
	return fy.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fy_NL'
func (fy *fy_NL) TimeLongLayout() string {
	return fy.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fy_NL'
func (fy *fy_NL) TimeMediumLayout() string {
	return fy.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fy_NL'
func (fy *fy_NL) TimeShortLayout() string {
	return fy.timeShortLayout
}

func (fy *fy_NL) ListPatterns() *locales.ListPatterns {
	return fy.listPatterns
}

func (fy *fy_NL) GetDurationSpec() *locales.DurationSpec {
	return fy.DurationSpec
}

func (fy *fy_NL) GetMiscPatterns() *locales.MiscPatterns {
