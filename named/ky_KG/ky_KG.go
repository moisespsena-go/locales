...
// DateFullLayout returns the full date layout for 'ky_KG'
func (ky *ky_KG) DateFullLayout() string {
	return ky.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ky_KG'
func (ky *ky_KG) DateLongLayout() string {
	return ky.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ky_KG'
func (ky *ky_KG) DateMediumLayout() string {
	return ky.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ky_KG'
func (ky *ky_KG) DateShortLayout() string {
	return ky.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ky_KG'
func (ky *ky_KG) TimeFullLayout() string {
	return ky.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ky_KG'
func (ky *ky_KG) TimeLongLayout() string {
	return ky.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ky_KG'
func (ky *ky_KG) TimeMediumLayout() string {
	return ky.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ky_KG'
func (ky *ky_KG) TimeShortLayout() string {
	return ky.timeShortLayout
}

func (ky *ky_KG) ListPatterns() *locales.ListPatterns {
	return ky.listPatterns
}

func (ky *ky_KG) GetDurationSpec() *locales.DurationSpec {
	return ky.DurationSpec
}

func (ky *ky_KG) GetMiscPatterns() *locales.MiscPatterns {
