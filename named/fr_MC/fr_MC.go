...
// DateFullLayout returns the full date layout for 'fr_MC'
func (fr *fr_MC) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_MC'
func (fr *fr_MC) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_MC'
func (fr *fr_MC) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_MC'
func (fr *fr_MC) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_MC'
func (fr *fr_MC) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_MC'
func (fr *fr_MC) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_MC'
func (fr *fr_MC) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_MC'
func (fr *fr_MC) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_MC) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_MC) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_MC) GetMiscPatterns() *locales.MiscPatterns {
