...
// DateFullLayout returns the full date layout for 'en_JM'
func (en *en_JM) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_JM'
func (en *en_JM) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_JM'
func (en *en_JM) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_JM'
func (en *en_JM) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_JM'
func (en *en_JM) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_JM'
func (en *en_JM) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_JM'
func (en *en_JM) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_JM'
func (en *en_JM) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_JM) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_JM) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_JM) GetMiscPatterns() *locales.MiscPatterns {
