...
func New() locales.Translator {
	return &mua_CM{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "FLO", "CLA", "CKI", "FMF", "MAD", "MBI", "MLI", "MAM", "FDE", "FMU", "FGW", "FYU"},
			MonthsNarrowValue:        []string{"", "O", "A", "I", "F", "D", "B", "L", "M", "E", "U", "W", "Y"},
			MonthsWideValue:          []string{"", "Fĩi Loo", "Cokcwaklaŋne", "Cokcwaklii", "Fĩi Marfoo", "Madǝǝuutǝbijaŋ", "Mamǝŋgwãafahbii", "Mamǝŋgwãalii", "Madǝmbii", "Fĩi Dǝɓlii", "Fĩi Mundaŋ", "Fĩi Gwahlle", "Fĩi Yuru"},
			WeekdaysAbbreviatedValue: []string{"Cya", "Cla", "Czi", "Cko", "Cka", "Cga", "Cze"},
			WeekdaysNarrowValue:      []string{"Y", "L", "Z", "O", "A", "G", "E"},
			WeekdaysWideValue:        []string{"Com’yakke", "Comlaaɗii", "Comzyiiɗii", "Comkolle", "Comkaldǝɓlii", "Comgaisuu", "Comzyeɓsuu"},
			PeriodsAbbreviatedValue:  []string{"comme", "lilli"},
			PeriodsWideValue:         []string{"comme", "lilli"},
			ErasAbbreviatedValue:     []string{"KK", "PK"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"KǝPel Kristu", "Pel Kristu"},
...
func (mua *mua_CM) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(mua, mua.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'mua_CM'
func (mua *mua_CM) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(mua, mua.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'mua_CM'
func (mua *mua_CM) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(mua, mua.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'mua_CM'
func (mua *mua_CM) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(mua, mua.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'mua_CM'
func (mua *mua_CM) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(mua, mua.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'mua_CM'
func (mua *mua_CM) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(mua, mua.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'mua_CM'
func (mua *mua_CM) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(mua, mua.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'mua_CM'
func (mua *mua_CM) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(mua, mua.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'mua_CM'
func (mua *mua_CM) DateFullLayout() string {
	return mua.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mua_CM'
func (mua *mua_CM) DateLongLayout() string {
	return mua.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mua_CM'
func (mua *mua_CM) DateMediumLayout() string {
	return mua.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mua_CM'
func (mua *mua_CM) DateShortLayout() string {
	return mua.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mua_CM'
func (mua *mua_CM) TimeFullLayout() string {
	return mua.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mua_CM'
func (mua *mua_CM) TimeLongLayout() string {
	return mua.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mua_CM'
func (mua *mua_CM) TimeMediumLayout() string {
	return mua.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mua_CM'
func (mua *mua_CM) TimeShortLayout() string {
	return mua.timeShortLayout
}

func (mua *mua_CM) ListPatterns() *locales.ListPatterns {
	return mua.listPatterns
}

func (mua *mua_CM) GetDurationSpec() *locales.DurationSpec {
	return mua.DurationSpec
}

func (mua *mua_CM) GetMiscPatterns() *locales.MiscPatterns {
	return &mua.miscPatterns
}
