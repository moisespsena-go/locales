...
// DateFullLayout returns the full date layout for 'sw_UG'
func (sw *sw_UG) DateFullLayout() string {
	return sw.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sw_UG'
func (sw *sw_UG) DateLongLayout() string {
	return sw.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sw_UG'
func (sw *sw_UG) DateMediumLayout() string {
	return sw.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sw_UG'
func (sw *sw_UG) DateShortLayout() string {
	return sw.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sw_UG'
func (sw *sw_UG) TimeFullLayout() string {
	return sw.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sw_UG'
func (sw *sw_UG) TimeLongLayout() string {
	return sw.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sw_UG'
func (sw *sw_UG) TimeMediumLayout() string {
	return sw.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sw_UG'
func (sw *sw_UG) TimeShortLayout() string {
	return sw.timeShortLayout
}

func (sw *sw_UG) ListPatterns() *locales.ListPatterns {
	return sw.listPatterns
}

func (sw *sw_UG) GetDurationSpec() *locales.DurationSpec {
	return sw.DurationSpec
}

func (sw *sw_UG) GetMiscPatterns() *locales.MiscPatterns {
