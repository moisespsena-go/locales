...
// DateFullLayout returns the full date layout for 'pt_ST'
func (pt *pt_ST) DateFullLayout() string {
	return pt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pt_ST'
func (pt *pt_ST) DateLongLayout() string {
	return pt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pt_ST'
func (pt *pt_ST) DateMediumLayout() string {
	return pt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pt_ST'
func (pt *pt_ST) DateShortLayout() string {
	return pt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pt_ST'
func (pt *pt_ST) TimeFullLayout() string {
	return pt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pt_ST'
func (pt *pt_ST) TimeLongLayout() string {
	return pt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pt_ST'
func (pt *pt_ST) TimeMediumLayout() string {
	return pt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pt_ST'
func (pt *pt_ST) TimeShortLayout() string {
	return pt.timeShortLayout
}

func (pt *pt_ST) ListPatterns() *locales.ListPatterns {
	return pt.listPatterns
}

func (pt *pt_ST) GetDurationSpec() *locales.DurationSpec {
	return pt.DurationSpec
}

func (pt *pt_ST) GetMiscPatterns() *locales.MiscPatterns {
