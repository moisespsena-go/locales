...
func (jmc *jmc_TZ) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(jmc, jmc.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'jmc_TZ'
func (jmc *jmc_TZ) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(jmc, jmc.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'jmc_TZ'
func (jmc *jmc_TZ) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(jmc, jmc.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'jmc_TZ'
func (jmc *jmc_TZ) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(jmc, jmc.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'jmc_TZ'
func (jmc *jmc_TZ) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(jmc, jmc.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'jmc_TZ'
func (jmc *jmc_TZ) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(jmc, jmc.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'jmc_TZ'
func (jmc *jmc_TZ) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(jmc, jmc.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'jmc_TZ'
func (jmc *jmc_TZ) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(jmc, jmc.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'jmc_TZ'
func (jmc *jmc_TZ) DateFullLayout() string {
	return jmc.dateFullLayout
}

// DateLongLayout returns the long date layout for 'jmc_TZ'
func (jmc *jmc_TZ) DateLongLayout() string {
	return jmc.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'jmc_TZ'
func (jmc *jmc_TZ) DateMediumLayout() string {
	return jmc.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'jmc_TZ'
func (jmc *jmc_TZ) DateShortLayout() string {
	return jmc.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'jmc_TZ'
func (jmc *jmc_TZ) TimeFullLayout() string {
	return jmc.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'jmc_TZ'
func (jmc *jmc_TZ) TimeLongLayout() string {
	return jmc.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'jmc_TZ'
func (jmc *jmc_TZ) TimeMediumLayout() string {
	return jmc.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'jmc_TZ'
func (jmc *jmc_TZ) TimeShortLayout() string {
	return jmc.timeShortLayout
}

func (jmc *jmc_TZ) ListPatterns() *locales.ListPatterns {
	return jmc.listPatterns
}

func (jmc *jmc_TZ) GetDurationSpec() *locales.DurationSpec {
	return jmc.DurationSpec
}

func (jmc *jmc_TZ) GetMiscPatterns() *locales.MiscPatterns {
	return &jmc.miscPatterns
}
