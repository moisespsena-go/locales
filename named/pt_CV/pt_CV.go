...
// DateFullLayout returns the full date layout for 'pt_CV'
func (pt *pt_CV) DateFullLayout() string {
	return pt.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pt_CV'
func (pt *pt_CV) DateLongLayout() string {
	return pt.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pt_CV'
func (pt *pt_CV) DateMediumLayout() string {
	return pt.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pt_CV'
func (pt *pt_CV) DateShortLayout() string {
	return pt.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pt_CV'
func (pt *pt_CV) TimeFullLayout() string {
	return pt.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pt_CV'
func (pt *pt_CV) TimeLongLayout() string {
	return pt.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pt_CV'
func (pt *pt_CV) TimeMediumLayout() string {
	return pt.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pt_CV'
func (pt *pt_CV) TimeShortLayout() string {
	return pt.timeShortLayout
}

func (pt *pt_CV) ListPatterns() *locales.ListPatterns {
	return pt.listPatterns
}

func (pt *pt_CV) GetDurationSpec() *locales.DurationSpec {
	return pt.DurationSpec
}

func (pt *pt_CV) GetMiscPatterns() *locales.MiscPatterns {
