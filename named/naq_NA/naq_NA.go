...
func New() locales.Translator {
	return &naq_NA{
		...
		TimeSpec: &locales.TimeSpec{
			...
			MonthsWideValue:          []string{"", "ǃKhanni", "ǃKhanǀgôab", "ǀKhuuǁkhâb", "ǃHôaǂkhaib", "ǃKhaitsâb", "Gamaǀaeb", "ǂKhoesaob", "Aoǁkhuumûǁkhâb", "Taraǀkhuumûǁkhâb", "ǂNûǁnâiseb", "ǀHooǂgaeb", "Hôasoreǁkhâb"},
			WeekdaysAbbreviatedValue: []string{"Son", "Ma", "De", "Wu", "Do", "Fr", "Sat"},
			WeekdaysNarrowValue:      []string{"S", "M", "E", "W", "D", "F", "A"},
			WeekdaysWideValue:        []string{"Sontaxtsees", "Mantaxtsees", "Denstaxtsees", "Wunstaxtsees", "Dondertaxtsees", "Fraitaxtsees", "Satertaxtsees"},
			PeriodsAbbreviatedValue:  []string{"ǁgoagas", "ǃuias"},
			PeriodsWideValue:         []string{"ǁgoagas", "ǃuias"},
			ErasAbbreviatedValue:     []string{"BC", "AD"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Xristub aiǃâ", "Xristub khaoǃgâ"},
...
func (naq *naq_NA) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(naq, naq.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'naq_NA'
func (naq *naq_NA) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(naq, naq.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'naq_NA'
func (naq *naq_NA) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(naq, naq.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'naq_NA'
func (naq *naq_NA) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(naq, naq.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'naq_NA'
func (naq *naq_NA) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(naq, naq.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'naq_NA'
func (naq *naq_NA) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(naq, naq.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'naq_NA'
func (naq *naq_NA) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(naq, naq.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'naq_NA'
func (naq *naq_NA) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(naq, naq.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'naq_NA'
func (naq *naq_NA) DateFullLayout() string {
	return naq.dateFullLayout
}

// DateLongLayout returns the long date layout for 'naq_NA'
func (naq *naq_NA) DateLongLayout() string {
	return naq.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'naq_NA'
func (naq *naq_NA) DateMediumLayout() string {
	return naq.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'naq_NA'
func (naq *naq_NA) DateShortLayout() string {
	return naq.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'naq_NA'
func (naq *naq_NA) TimeFullLayout() string {
	return naq.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'naq_NA'
func (naq *naq_NA) TimeLongLayout() string {
	return naq.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'naq_NA'
func (naq *naq_NA) TimeMediumLayout() string {
	return naq.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'naq_NA'
func (naq *naq_NA) TimeShortLayout() string {
	return naq.timeShortLayout
}

func (naq *naq_NA) ListPatterns() *locales.ListPatterns {
	return naq.listPatterns
}

func (naq *naq_NA) GetDurationSpec() *locales.DurationSpec {
	return naq.DurationSpec
}

func (naq *naq_NA) GetMiscPatterns() *locales.MiscPatterns {
	return &naq.miscPatterns
}
