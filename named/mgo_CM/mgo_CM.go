...
// DateFullLayout returns the full date layout for 'mgo_CM'
func (mgo *mgo_CM) DateFullLayout() string {
	return mgo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mgo_CM'
func (mgo *mgo_CM) DateLongLayout() string {
	return mgo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mgo_CM'
func (mgo *mgo_CM) DateMediumLayout() string {
	return mgo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mgo_CM'
func (mgo *mgo_CM) DateShortLayout() string {
	return mgo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mgo_CM'
func (mgo *mgo_CM) TimeFullLayout() string {
	return mgo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mgo_CM'
func (mgo *mgo_CM) TimeLongLayout() string {
	return mgo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mgo_CM'
func (mgo *mgo_CM) TimeMediumLayout() string {
	return mgo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mgo_CM'
func (mgo *mgo_CM) TimeShortLayout() string {
	return mgo.timeShortLayout
}

func (mgo *mgo_CM) ListPatterns() *locales.ListPatterns {
	return mgo.listPatterns
}

func (mgo *mgo_CM) GetDurationSpec() *locales.DurationSpec {
	return mgo.DurationSpec
}

func (mgo *mgo_CM) GetMiscPatterns() *locales.MiscPatterns {
