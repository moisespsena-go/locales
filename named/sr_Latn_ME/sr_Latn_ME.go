...
func New() locales.Translator {
	return &sr_Latn_ME{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "mart", "maj", "jun", "jul", "sept"},
			...
			WeekdaysWideValue:        []string{"nedjelja", "ponedeljak", "utorak", "srijeda", "četvrtak", "petak", "subota"},
...
// DateFullLayout returns the full date layout for 'sr_Latn_ME'
func (sr *sr_Latn_ME) DateFullLayout() string {
	return sr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sr_Latn_ME'
func (sr *sr_Latn_ME) DateLongLayout() string {
	return sr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sr_Latn_ME'
func (sr *sr_Latn_ME) DateMediumLayout() string {
	return sr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sr_Latn_ME'
func (sr *sr_Latn_ME) DateShortLayout() string {
	return sr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sr_Latn_ME'
func (sr *sr_Latn_ME) TimeFullLayout() string {
	return sr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sr_Latn_ME'
func (sr *sr_Latn_ME) TimeLongLayout() string {
	return sr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sr_Latn_ME'
func (sr *sr_Latn_ME) TimeMediumLayout() string {
	return sr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sr_Latn_ME'
func (sr *sr_Latn_ME) TimeShortLayout() string {
	return sr.timeShortLayout
}

func (sr *sr_Latn_ME) ListPatterns() *locales.ListPatterns {
	return sr.listPatterns
}

func (sr *sr_Latn_ME) GetDurationSpec() *locales.DurationSpec {
	return sr.DurationSpec
}

func (sr *sr_Latn_ME) GetMiscPatterns() *locales.MiscPatterns {
