...
func New() locales.Translator {
	return &ksf_CM{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ŋ1", "ŋ2", "ŋ3", "ŋ4", "ŋ5", "ŋ6", "ŋ7", "ŋ8", "ŋ9", "ŋ10", "ŋ11", "ŋ12"},
			MonthsWideValue:          []string{"", "ŋwíí a ntɔ́ntɔ", "ŋwíí akǝ bɛ́ɛ", "ŋwíí akǝ ráá", "ŋwíí akǝ nin", "ŋwíí akǝ táan", "ŋwíí akǝ táafɔk", "ŋwíí akǝ táabɛɛ", "ŋwíí akǝ táaraa", "ŋwíí akǝ táanin", "ŋwíí akǝ ntɛk", "ŋwíí akǝ ntɛk di bɔ́k", "ŋwíí akǝ ntɛk di bɛ́ɛ"},
			WeekdaysAbbreviatedValue: []string{"sɔ́n", "lǝn", "maa", "mɛk", "jǝǝ", "júm", "sam"},
			WeekdaysNarrowValue:      []string{"s", "l", "m", "m", "j", "j", "s"},
			WeekdaysWideValue:        []string{"sɔ́ndǝ", "lǝndí", "maadí", "mɛkrɛdí", "jǝǝdí", "júmbá", "samdí"},
			PeriodsAbbreviatedValue:  []string{"sárúwá", "cɛɛ́nko"},
			PeriodsWideValue:         []string{"sárúwá", "cɛɛ́nko"},
			ErasAbbreviatedValue:     []string{"d.Y.", "k.Y."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"di Yɛ́sus aká yálɛ", "cámɛɛn kǝ kǝbɔpka Y"},
...
func (ksf *ksf_CM) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ksf, ksf.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ksf_CM'
func (ksf *ksf_CM) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ksf, ksf.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ksf_CM'
func (ksf *ksf_CM) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ksf, ksf.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ksf_CM'
func (ksf *ksf_CM) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ksf, ksf.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ksf_CM'
func (ksf *ksf_CM) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ksf, ksf.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ksf_CM'
func (ksf *ksf_CM) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ksf, ksf.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ksf_CM'
func (ksf *ksf_CM) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ksf, ksf.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ksf_CM'
func (ksf *ksf_CM) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ksf, ksf.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ksf_CM'
func (ksf *ksf_CM) DateFullLayout() string {
	return ksf.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ksf_CM'
func (ksf *ksf_CM) DateLongLayout() string {
	return ksf.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ksf_CM'
func (ksf *ksf_CM) DateMediumLayout() string {
	return ksf.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ksf_CM'
func (ksf *ksf_CM) DateShortLayout() string {
	return ksf.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ksf_CM'
func (ksf *ksf_CM) TimeFullLayout() string {
	return ksf.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ksf_CM'
func (ksf *ksf_CM) TimeLongLayout() string {
	return ksf.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ksf_CM'
func (ksf *ksf_CM) TimeMediumLayout() string {
	return ksf.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ksf_CM'
func (ksf *ksf_CM) TimeShortLayout() string {
	return ksf.timeShortLayout
}

func (ksf *ksf_CM) ListPatterns() *locales.ListPatterns {
	return ksf.listPatterns
}

func (ksf *ksf_CM) GetDurationSpec() *locales.DurationSpec {
	return ksf.DurationSpec
}

func (ksf *ksf_CM) GetMiscPatterns() *locales.MiscPatterns {
	return &ksf.miscPatterns
}
