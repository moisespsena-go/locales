...
func New() locales.Translator {
	return &se{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ođđj", "guov", "njuk", "cuo", "mies", "geas", "suoi", "borg", "čakč", "golg", "skáb", "juov"},
			...
			WeekdaysAbbreviatedValue: []string{"sotn", "vuos", "maŋ", "gask", "duor", "bear", "láv"},
			WeekdaysNarrowValue:      []string{"S", "V", "M", "G", "D", "B", "L"},
			WeekdaysShortValue:       []string{"sotn", "vuos", "maŋ", "gask", "duor", "bear", "láv"},
			WeekdaysWideValue:        []string{"sotnabeaivi", "vuossárga", "maŋŋebárga", "gaskavahkku", "duorasdat", "bearjadat", "lávvardat"},
			PeriodsAbbreviatedValue:  []string{"i.b.", "e.b."},
			PeriodsNarrowValue:       []string{"i.b.", "e.b."},
			PeriodsWideValue:         []string{"iđitbeaivet", "eahketbeaivet"},
			ErasAbbreviatedValue:     []string{"o.Kr.", "m.Kr."},
			ErasNarrowValue:          []string{"ooá", "oá"},
			ErasWideValue:            []string{"ovdal Kristtusa", "maŋŋel Kristtusa"},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "ADT", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "AST", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "CAT", "CCT": "CCT", "CDT": "CDT", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "CST", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "EAT", "ECT": "ECT", "EDT": "EDT", "EGDT": "EGDT", "EGST": "EGST", "EST": "EST", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "Greenwich gaskka áigi", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "gaska-Eurohpá geassiáigi", "MEZ": "gaska-Eurohpá dábálašáigi", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "nuorti-Eurohpá geassiáigi", "OEZ": "nuorti-Eurohpá dábálašáigi", "PDT": "PDT", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "PST", "PYST": "PYST", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "oarje-Eurohpá geassiáigi", "WEZ": "oarje-Eurohpá dábálašáigi", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"", "%vj", "%vj", "%v/jah"},
				Long:   &locales.CounterFormat{"jahkki", "%v jahki", "%v jahkki", "%v juohke jahki"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vm", "%vm", "%v/mán"},
				Long:   &locales.CounterFormat{"mánotbadji", "%v mánotbadji", "%v mánotbadji", "%v juohke mánotbadji"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vv", "%vv", "%v/v"},
				Long:   &locales.CounterFormat{"váhkku", "%v váhku", "%v váhkku", "%v juohke váhku"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vd", "%vd", "%v/d"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vh", "%vh", "%v/h"},
				Long:   &locales.CounterFormat{"diibmur", "%v diibmu", "%v diibmur", "%v juohke diibmu"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vm", "%vm", "%v/min"},
				Long:   &locales.CounterFormat{"minuhtta", "%v minuhta", "%v minuhtta", "%v juohke minuhta"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vs", "%vs", "%v/s"},
				Long:   &locales.CounterFormat{"sekundda", "%v sekunda", "%v sekundda", "%v juohke sekunda"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"millisekundda", "%v millisekunda", "%v millisekundda", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%vμs", "%vμs", ""},
				Long:   &locales.CounterFormat{"mikrosekundda", "%v mikrosekunda", "%v mikrosekundda", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%vns", "%vns", ""},
				Long:   &locales.CounterFormat{"nanosekundda", "%v nanosekunda", "%v nanosekundda", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"",
			"≥%[1]v",
...
// DateFullLayout returns the full date layout for 'se'
func (se *se) DateFullLayout() string {
	return se.dateFullLayout
}

// DateLongLayout returns the long date layout for 'se'
func (se *se) DateLongLayout() string {
	return se.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'se'
func (se *se) DateMediumLayout() string {
	return se.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'se'
func (se *se) DateShortLayout() string {
	return se.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'se'
func (se *se) TimeFullLayout() string {
	return se.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'se'
func (se *se) TimeLongLayout() string {
	return se.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'se'
func (se *se) TimeMediumLayout() string {
	return se.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'se'
func (se *se) TimeShortLayout() string {
	return se.timeShortLayout
}

func (se *se) ListPatterns() *locales.ListPatterns {
	return se.listPatterns
}

func (se *se) GetDurationSpec() *locales.DurationSpec {
	return se.DurationSpec
}

func (se *se) GetMiscPatterns() *locales.MiscPatterns {
