...
func New() locales.Translator {
	return &tzm_MA{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Yen", "Yeb", "Mar", "Ibr", "May", "Yun", "Yul", "Ɣuc", "Cut", "Kṭu", "Nwa", "Duj"},
			MonthsNarrowValue:        []string{"", "Y", "Y", "M", "I", "M", "Y", "Y", "Ɣ", "C", "K", "N", "D"},
			MonthsWideValue:          []string{"", "Yennayer", "Yebrayer", "Mars", "Ibrir", "Mayyu", "Yunyu", "Yulyuz", "Ɣuct", "Cutanbir", "Kṭuber", "Nwanbir", "Dujanbir"},
			WeekdaysAbbreviatedValue: []string{"Asa", "Ayn", "Asn", "Akr", "Akw", "Asm", "Asḍ"},
			WeekdaysNarrowValue:      []string{"A", "A", "A", "A", "A", "A", "A"},
			WeekdaysWideValue:        []string{"Asamas", "Aynas", "Asinas", "Akras", "Akwas", "Asimwas", "Asiḍyas"},
			PeriodsAbbreviatedValue:  []string{"Zdat azal", "Ḍeffir aza"},
			PeriodsWideValue:         []string{"Zdat azal", "Ḍeffir aza"},
			ErasAbbreviatedValue:     []string{"ZƐ", "ḌƐ"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Zdat Ɛisa (TAƔ)", "Ḍeffir Ɛisa (TAƔ)"},
...
func (tzm *tzm_MA) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(tzm, tzm.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'tzm_MA'
func (tzm *tzm_MA) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(tzm, tzm.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'tzm_MA'
func (tzm *tzm_MA) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(tzm, tzm.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'tzm_MA'
func (tzm *tzm_MA) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(tzm, tzm.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'tzm_MA'
func (tzm *tzm_MA) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(tzm, tzm.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'tzm_MA'
func (tzm *tzm_MA) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(tzm, tzm.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'tzm_MA'
func (tzm *tzm_MA) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(tzm, tzm.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'tzm_MA'
func (tzm *tzm_MA) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(tzm, tzm.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'tzm_MA'
func (tzm *tzm_MA) DateFullLayout() string {
	return tzm.dateFullLayout
}

// DateLongLayout returns the long date layout for 'tzm_MA'
func (tzm *tzm_MA) DateLongLayout() string {
	return tzm.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'tzm_MA'
func (tzm *tzm_MA) DateMediumLayout() string {
	return tzm.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'tzm_MA'
func (tzm *tzm_MA) DateShortLayout() string {
	return tzm.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'tzm_MA'
func (tzm *tzm_MA) TimeFullLayout() string {
	return tzm.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'tzm_MA'
func (tzm *tzm_MA) TimeLongLayout() string {
	return tzm.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'tzm_MA'
func (tzm *tzm_MA) TimeMediumLayout() string {
	return tzm.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'tzm_MA'
func (tzm *tzm_MA) TimeShortLayout() string {
	return tzm.timeShortLayout
}

func (tzm *tzm_MA) ListPatterns() *locales.ListPatterns {
	return tzm.listPatterns
}

func (tzm *tzm_MA) GetDurationSpec() *locales.DurationSpec {
	return tzm.DurationSpec
}

func (tzm *tzm_MA) GetMiscPatterns() *locales.MiscPatterns {
	return &tzm.miscPatterns
}
