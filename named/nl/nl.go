...
func New() locales.Translator {
	return &nl{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jan.", "feb.", "mrt.", "apr.", "mei", "jun.", "jul.", "aug.", "sep.", "okt.", "nov.", "dec."},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "januari", "februari", "maart", "april", "mei", "juni", "juli", "augustus", "september", "oktober", "november", "december"},
			WeekdaysAbbreviatedValue: []string{"zo", "ma", "di", "wo", "do", "vr", "za"},
			WeekdaysNarrowValue:      []string{"Z", "M", "D", "W", "D", "V", "Z"},
			WeekdaysShortValue:       []string{"zo", "ma", "di", "wo", "do", "vr", "za"},
			WeekdaysWideValue:        []string{"zondag", "maandag", "dinsdag", "woensdag", "donderdag", "vrijdag", "zaterdag"},
			...
			TimezonesValue:           map[string]string{"": "Falklandeilandse standaardtijd", "ACDT": "Midden-Australische zomertijd", "ACST": "Acre-zomertijd", "ACT": "Acre-standaardtijd", "ACWDT": "Midden-Australische westelijke zomertijd", "ACWST": "Midden-Australische westelijke standaardtijd", "ADT": "Atlantic-zomertijd", "AEDT": "Oost-Australische zomertijd", "AEST": "Oost-Australische standaardtijd", "AFT": "Afghaanse tijd", "AKDT": "Alaska-zomertijd", "AKST": "Alaska-standaardtijd", "AMST": "Amazone-zomertijd", "AMT": "Amazone-standaardtijd", "ARST": "Argentijnse zomertijd", "ART": "Argentijnse standaardtijd", "AST": "Atlantic-standaardtijd", "AWDT": "West-Australische zomertijd", "AWST": "West-Australische standaardtijd", "BNT": "Bruneise tijd", "BOT": "Boliviaanse tijd", "BRST": "Braziliaanse zomertijd", "BRT": "Braziliaanse standaardtijd", "BST": "Bengalese zomertijd", "BTT": "Bhutaanse tijd", "CAT": "Centraal-Afrikaanse tijd", "CCT": "Cocoseilandse tijd", "CDT": "Central-zomertijd", "CDT (Kuba)": "Cubaanse zomertijd", "CHADT": "Chatham-zomertijd", "CHAST": "Chatham-standaardtijd", "CLST": "Chileense zomertijd", "CLT": "Chileense standaardtijd", "COST": "Colombiaanse zomertijd", "COT": "Colombiaanse standaardtijd", "CST": "Central-standaardtijd", "CST (Kuba)": "Cubaanse standaardtijd", "CXT": "Christmaseilandse tijd", "ChST": "Chamorro-tijd", "EASST": "Paaseilandse zomertijd", "EAST": "Paaseilandse standaardtijd", "EAT": "Oost-Afrikaanse tijd", "ECT": "Ecuadoraanse tijd", "EDT": "Eastern-zomertijd", "EGDT": "Oost-Groenlandse zomertijd", "EGST": "Oost-Groenlandse standaardtijd", "EST": "Eastern-standaardtijd", "FKST": "Falklandeilandse zomertijd", "GALT": "Galapagoseilandse tijd", "GFT": "Frans-Guyaanse tijd", "GMT": "Greenwich Mean Time", "GST": "Golf-standaardtijd", "GYT": "Guyaanse tijd", "HADT": "Hawaii-Aleoetische zomertijd", "HAST": "Hawaii-Aleoetische standaardtijd", "HENOMX": "Noordwest-Mexicaanse zomertijd", "HEOG": "West-Groenlandse zomertijd", "HEPMX": "Mexicaanse Pacific-zomertijd", "HKST": "Hongkongse zomertijd", "HKT": "Hongkongse standaardtijd", "HNNOMX": "Noordwest-Mexicaanse standaardtijd", "HNOG": "West-Groenlandse standaardtijd", "HNPMX": "Mexicaanse Pacific-standaardtijd", "ICT": "Indochinese tijd", "IRDT": "Iraanse zomertijd", "IRST": "Iraanse standaardtijd", "IST": "Indiase tijd", "JDT": "Japanse zomertijd", "JST": "Japanse standaardtijd", "LHDT": "Lord Howe-eilandse zomertijd", "LHST": "Lord Howe-eilandse standaardtijd", "MDT": "Macause zomertijd", "MESZ": "Midden-Europese zomertijd", "MEZ": "Midden-Europese standaardtijd", "MST": "Macause standaardtijd", "MVT": "Maldivische tijd", "MYT": "Maleisische tijd", "NDT": "Newfoundland-zomertijd", "NPT": "Nepalese tijd", "NST": "Newfoundland-standaardtijd", "NZDT": "Nieuw-Zeelandse zomertijd", "NZST": "Nieuw-Zeelandse standaardtijd", "OESZ": "Oost-Europese zomertijd", "OEZ": "Oost-Europese standaardtijd", "PDT": "Pacific-zomertijd", "PKT": "Pakistaanse zomertijd", "PMDT": "Saint Pierre en Miquelon-zomertijd", "PMST": "Saint Pierre en Miquelon-standaardtijd", "PST": "Pacific-standaardtijd", "PYST": "Paraguayaanse zomertijd", "SAST": "Zuid-Afrikaanse tijd", "SGT": "Singaporese standaardtijd", "SRT": "Surinaamse tijd", "TLT": "Oost-Timorese tijd", "TMST": "Turkmeense zomertijd", "TMT": "Turkmeense standaardtijd", "UYST": "Uruguayaanse zomertijd", "UYT": "Uruguayaanse standaardtijd", "VET": "Venezolaanse tijd", "WARST": "West-Argentijnse zomertijd", "WART": "West-Argentijnse standaardtijd", "WAST": "West-Afrikaanse zomertijd", "WAT": "West-Afrikaanse standaardtijd", "WESZ": "West-Europese zomertijd", "WEZ": "West-Europese standaardtijd", "WIB": "West-Indonesische tijd", "WIT": "Oost-Indonesische tijd", "WITA": "Centraal-Indonesische tijd", "∅∅∅": "Peruaanse zomertijd"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"eeuwen", "%v eeuw", "%v eeuwen", ""},
				Long:   &locales.CounterFormat{"eeuwen", "%v eeuw", "%v eeuwen", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v dec.", "%v dec.", ""},
				Long:   &locales.CounterFormat{"decennia", "%v decennium", "%v decennia", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"jr", "%v jr", "%v jr", "%v/jr"},
				Long:   &locales.CounterFormat{"jaar", "%v jaar", "%v jaar", "%v per jaar"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m", "%v m", "%v m", "%v/m"},
				Long:   &locales.CounterFormat{"maanden", "%v maand", "%v maanden", "%v per maand"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"w", "%v w", "%v w", "%v/w"},
				Long:   &locales.CounterFormat{"weken", "%v week", "%v weken", "%v per week"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"d", "%v d", "%v d", "%v/d"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"u", "%v u", "%v u", "%v/u"},
				Long:   &locales.CounterFormat{"uur", "%v uur", "%v uur", "%v per uur"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m", "%v m", "%v m", "%v/m"},
				Long:   &locales.CounterFormat{"minuten", "%v minuut", "%v minuten", "%v per minuut"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%v s", "%v s", "%v/s"},
				Long:   &locales.CounterFormat{"seconden", "%v seconde", "%v seconden", "%v per seconde"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"milliseconden", "%v milliseconde", "%v milliseconden", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"microseconden", "%v microseconde", "%v microseconden", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanoseconden", "%v nanoseconde", "%v nanoseconden", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (nl *nl) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(nl, nl.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'nl'
func (nl *nl) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(nl, nl.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'nl'
func (nl *nl) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(nl, nl.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'nl'
func (nl *nl) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(nl, nl.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'nl'
func (nl *nl) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(nl, nl.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'nl'
func (nl *nl) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(nl, nl.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'nl'
func (nl *nl) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(nl, nl.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'nl'
func (nl *nl) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(nl, nl.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'nl'
func (nl *nl) DateFullLayout() string {
	return nl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nl'
func (nl *nl) DateLongLayout() string {
	return nl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nl'
func (nl *nl) DateMediumLayout() string {
	return nl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nl'
func (nl *nl) DateShortLayout() string {
	return nl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nl'
func (nl *nl) TimeFullLayout() string {
	return nl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nl'
func (nl *nl) TimeLongLayout() string {
	return nl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nl'
func (nl *nl) TimeMediumLayout() string {
	return nl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nl'
func (nl *nl) TimeShortLayout() string {
	return nl.timeShortLayout
}

func (nl *nl) ListPatterns() *locales.ListPatterns {
	return nl.listPatterns
}

func (nl *nl) GetDurationSpec() *locales.DurationSpec {
	return nl.DurationSpec
}

func (nl *nl) GetMiscPatterns() *locales.MiscPatterns {
	return &nl.miscPatterns
}
