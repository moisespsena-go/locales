...
func New() locales.Translator {
	return &lu_CD{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Cio", "Lui", "Lus", "Muu", "Lum", "Luf", "Kab", "Lush", "Lut", "Lun", "Kas", "Cis"},
			MonthsNarrowValue:        []string{"", "C", "L", "L", "M", "L", "L", "K", "L", "L", "L", "K", "C"},
			MonthsWideValue:          []string{"", "Ciongo", "Lùishi", "Lusòlo", "Mùuyà", "Lumùngùlù", "Lufuimi", "Kabàlàshìpù", "Lùshìkà", "Lutongolo", "Lungùdi", "Kaswèkèsè", "Ciswà"},
			WeekdaysAbbreviatedValue: []string{"Lum", "Nko", "Ndy", "Ndg", "Njw", "Ngv", "Lub"},
			WeekdaysNarrowValue:      []string{"L", "N", "N", "N", "N", "N", "L"},
			WeekdaysWideValue:        []string{"Lumingu", "Nkodya", "Ndàayà", "Ndangù", "Njòwa", "Ngòvya", "Lubingu"},
			PeriodsAbbreviatedValue:  []string{"Dinda", "Dilolo"},
			PeriodsWideValue:         []string{"Dinda", "Dilolo"},
			ErasAbbreviatedValue:     []string{"kmp. Y.K.", "kny. Y. K."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Kumpala kwa Yezu Kli", "Kunyima kwa Yezu Kli"},
...
func (lu *lu_CD) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(lu, lu.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'lu_CD'
func (lu *lu_CD) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(lu, lu.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'lu_CD'
func (lu *lu_CD) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(lu, lu.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'lu_CD'
func (lu *lu_CD) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(lu, lu.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'lu_CD'
func (lu *lu_CD) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(lu, lu.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'lu_CD'
func (lu *lu_CD) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(lu, lu.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'lu_CD'
func (lu *lu_CD) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(lu, lu.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'lu_CD'
func (lu *lu_CD) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(lu, lu.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'lu_CD'
func (lu *lu_CD) DateFullLayout() string {
	return lu.dateFullLayout
}

// DateLongLayout returns the long date layout for 'lu_CD'
func (lu *lu_CD) DateLongLayout() string {
	return lu.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'lu_CD'
func (lu *lu_CD) DateMediumLayout() string {
	return lu.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'lu_CD'
func (lu *lu_CD) DateShortLayout() string {
	return lu.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'lu_CD'
func (lu *lu_CD) TimeFullLayout() string {
	return lu.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'lu_CD'
func (lu *lu_CD) TimeLongLayout() string {
	return lu.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'lu_CD'
func (lu *lu_CD) TimeMediumLayout() string {
	return lu.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'lu_CD'
func (lu *lu_CD) TimeShortLayout() string {
	return lu.timeShortLayout
}

func (lu *lu_CD) ListPatterns() *locales.ListPatterns {
	return lu.listPatterns
}

func (lu *lu_CD) GetDurationSpec() *locales.DurationSpec {
	return lu.DurationSpec
}

func (lu *lu_CD) GetMiscPatterns() *locales.MiscPatterns {
	return &lu.miscPatterns
}
