...
// DateFullLayout returns the full date layout for 'en_SD'
func (en *en_SD) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_SD'
func (en *en_SD) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_SD'
func (en *en_SD) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_SD'
func (en *en_SD) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_SD'
func (en *en_SD) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_SD'
func (en *en_SD) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_SD'
func (en *en_SD) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_SD'
func (en *en_SD) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_SD) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_SD) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_SD) GetMiscPatterns() *locales.MiscPatterns {
