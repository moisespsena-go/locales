...
// DateFullLayout returns the full date layout for 'vun'
func (vun *vun) DateFullLayout() string {
	return vun.dateFullLayout
}

// DateLongLayout returns the long date layout for 'vun'
func (vun *vun) DateLongLayout() string {
	return vun.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'vun'
func (vun *vun) DateMediumLayout() string {
	return vun.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'vun'
func (vun *vun) DateShortLayout() string {
	return vun.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'vun'
func (vun *vun) TimeFullLayout() string {
	return vun.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'vun'
func (vun *vun) TimeLongLayout() string {
	return vun.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'vun'
func (vun *vun) TimeMediumLayout() string {
	return vun.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'vun'
func (vun *vun) TimeShortLayout() string {
	return vun.timeShortLayout
}

func (vun *vun) ListPatterns() *locales.ListPatterns {
	return vun.listPatterns
}

func (vun *vun) GetDurationSpec() *locales.DurationSpec {
	return vun.DurationSpec
}

func (vun *vun) GetMiscPatterns() *locales.MiscPatterns {
