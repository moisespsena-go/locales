...
// DateFullLayout returns the full date layout for 'si_LK'
func (si *si_LK) DateFullLayout() string {
	return si.dateFullLayout
}

// DateLongLayout returns the long date layout for 'si_LK'
func (si *si_LK) DateLongLayout() string {
	return si.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'si_LK'
func (si *si_LK) DateMediumLayout() string {
	return si.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'si_LK'
func (si *si_LK) DateShortLayout() string {
	return si.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'si_LK'
func (si *si_LK) TimeFullLayout() string {
	return si.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'si_LK'
func (si *si_LK) TimeLongLayout() string {
	return si.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'si_LK'
func (si *si_LK) TimeMediumLayout() string {
	return si.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'si_LK'
func (si *si_LK) TimeShortLayout() string {
	return si.timeShortLayout
}

func (si *si_LK) ListPatterns() *locales.ListPatterns {
	return si.listPatterns
}

func (si *si_LK) GetDurationSpec() *locales.DurationSpec {
	return si.DurationSpec
}

func (si *si_LK) GetMiscPatterns() *locales.MiscPatterns {
