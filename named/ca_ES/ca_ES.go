...
// DateFullLayout returns the full date layout for 'ca_ES'
func (ca *ca_ES) DateFullLayout() string {
	return ca.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ca_ES'
func (ca *ca_ES) DateLongLayout() string {
	return ca.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ca_ES'
func (ca *ca_ES) DateMediumLayout() string {
	return ca.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ca_ES'
func (ca *ca_ES) DateShortLayout() string {
	return ca.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ca_ES'
func (ca *ca_ES) TimeFullLayout() string {
	return ca.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ca_ES'
func (ca *ca_ES) TimeLongLayout() string {
	return ca.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ca_ES'
func (ca *ca_ES) TimeMediumLayout() string {
	return ca.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ca_ES'
func (ca *ca_ES) TimeShortLayout() string {
	return ca.timeShortLayout
}

func (ca *ca_ES) ListPatterns() *locales.ListPatterns {
	return ca.listPatterns
}

func (ca *ca_ES) GetDurationSpec() *locales.DurationSpec {
	return ca.DurationSpec
}

func (ca *ca_ES) GetMiscPatterns() *locales.MiscPatterns {
