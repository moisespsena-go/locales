...
// DateFullLayout returns the full date layout for 'en_PR'
func (en *en_PR) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_PR'
func (en *en_PR) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_PR'
func (en *en_PR) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_PR'
func (en *en_PR) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_PR'
func (en *en_PR) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_PR'
func (en *en_PR) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_PR'
func (en *en_PR) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_PR'
func (en *en_PR) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_PR) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_PR) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_PR) GetMiscPatterns() *locales.MiscPatterns {
