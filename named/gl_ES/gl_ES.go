...
// DateFullLayout returns the full date layout for 'gl_ES'
func (gl *gl_ES) DateFullLayout() string {
	return gl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'gl_ES'
func (gl *gl_ES) DateLongLayout() string {
	return gl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'gl_ES'
func (gl *gl_ES) DateMediumLayout() string {
	return gl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'gl_ES'
func (gl *gl_ES) DateShortLayout() string {
	return gl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'gl_ES'
func (gl *gl_ES) TimeFullLayout() string {
	return gl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'gl_ES'
func (gl *gl_ES) TimeLongLayout() string {
	return gl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'gl_ES'
func (gl *gl_ES) TimeMediumLayout() string {
	return gl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'gl_ES'
func (gl *gl_ES) TimeShortLayout() string {
	return gl.timeShortLayout
}

func (gl *gl_ES) ListPatterns() *locales.ListPatterns {
	return gl.listPatterns
}

func (gl *gl_ES) GetDurationSpec() *locales.DurationSpec {
	return gl.DurationSpec
}

func (gl *gl_ES) GetMiscPatterns() *locales.MiscPatterns {
