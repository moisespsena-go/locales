...
func New() locales.Translator {
	return &dyo_SN{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Sa", "Fe", "Ma", "Ab", "Me", "Su", "Sú", "Ut", "Se", "Ok", "No", "De"},
			MonthsNarrowValue:        []string{"", "S", "F", "M", "A", "M", "S", "S", "U", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Sanvie", "Fébirie", "Mars", "Aburil", "Mee", "Sueŋ", "Súuyee", "Ut", "Settembar", "Oktobar", "Novembar", "Disambar"},
			WeekdaysAbbreviatedValue: []string{"Dim", "Ten", "Tal", "Ala", "Ara", "Arj", "Sib"},
			WeekdaysNarrowValue:      []string{"D", "T", "T", "A", "A", "A", "S"},
			WeekdaysWideValue:        []string{"Dimas", "Teneŋ", "Talata", "Alarbay", "Aramisay", "Arjuma", "Sibiti"},
			ErasAbbreviatedValue:     []string{"ArY", "AtY"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Ariŋuu Yeesu", "Atooŋe Yeesu"},
...
func (dyo *dyo_SN) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(dyo, dyo.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'dyo_SN'
func (dyo *dyo_SN) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(dyo, dyo.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'dyo_SN'
func (dyo *dyo_SN) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(dyo, dyo.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'dyo_SN'
func (dyo *dyo_SN) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(dyo, dyo.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'dyo_SN'
func (dyo *dyo_SN) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(dyo, dyo.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'dyo_SN'
func (dyo *dyo_SN) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(dyo, dyo.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'dyo_SN'
func (dyo *dyo_SN) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(dyo, dyo.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'dyo_SN'
func (dyo *dyo_SN) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(dyo, dyo.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'dyo_SN'
func (dyo *dyo_SN) DateFullLayout() string {
	return dyo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'dyo_SN'
func (dyo *dyo_SN) DateLongLayout() string {
	return dyo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'dyo_SN'
func (dyo *dyo_SN) DateMediumLayout() string {
	return dyo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'dyo_SN'
func (dyo *dyo_SN) DateShortLayout() string {
	return dyo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'dyo_SN'
func (dyo *dyo_SN) TimeFullLayout() string {
	return dyo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'dyo_SN'
func (dyo *dyo_SN) TimeLongLayout() string {
	return dyo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'dyo_SN'
func (dyo *dyo_SN) TimeMediumLayout() string {
	return dyo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'dyo_SN'
func (dyo *dyo_SN) TimeShortLayout() string {
	return dyo.timeShortLayout
}

func (dyo *dyo_SN) ListPatterns() *locales.ListPatterns {
	return dyo.listPatterns
}

func (dyo *dyo_SN) GetDurationSpec() *locales.DurationSpec {
	return dyo.DurationSpec
}

func (dyo *dyo_SN) GetMiscPatterns() *locales.MiscPatterns {
	return &dyo.miscPatterns
}
