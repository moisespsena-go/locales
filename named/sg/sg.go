...
// DateFullLayout returns the full date layout for 'sg'
func (sg *sg) DateFullLayout() string {
	return sg.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sg'
func (sg *sg) DateLongLayout() string {
	return sg.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sg'
func (sg *sg) DateMediumLayout() string {
	return sg.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sg'
func (sg *sg) DateShortLayout() string {
	return sg.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sg'
func (sg *sg) TimeFullLayout() string {
	return sg.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sg'
func (sg *sg) TimeLongLayout() string {
	return sg.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sg'
func (sg *sg) TimeMediumLayout() string {
	return sg.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sg'
func (sg *sg) TimeShortLayout() string {
	return sg.timeShortLayout
}

func (sg *sg) ListPatterns() *locales.ListPatterns {
	return sg.listPatterns
}

func (sg *sg) GetDurationSpec() *locales.DurationSpec {
	return sg.DurationSpec
}

func (sg *sg) GetMiscPatterns() *locales.MiscPatterns {
