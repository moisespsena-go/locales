...
// DateFullLayout returns the full date layout for 'kde'
func (kde *kde) DateFullLayout() string {
	return kde.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kde'
func (kde *kde) DateLongLayout() string {
	return kde.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kde'
func (kde *kde) DateMediumLayout() string {
	return kde.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kde'
func (kde *kde) DateShortLayout() string {
	return kde.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kde'
func (kde *kde) TimeFullLayout() string {
	return kde.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kde'
func (kde *kde) TimeLongLayout() string {
	return kde.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kde'
func (kde *kde) TimeMediumLayout() string {
	return kde.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kde'
func (kde *kde) TimeShortLayout() string {
	return kde.timeShortLayout
}

func (kde *kde) ListPatterns() *locales.ListPatterns {
	return kde.listPatterns
}

func (kde *kde) GetDurationSpec() *locales.DurationSpec {
	return kde.DurationSpec
}

func (kde *kde) GetMiscPatterns() *locales.MiscPatterns {
