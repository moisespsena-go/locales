...
func New() locales.Translator {
	return &cgg_UG{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "KBZ", "KBR", "KST", "KKN", "KTN", "KMK", "KMS", "KMN", "KMW", "KKM", "KNK", "KNB"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Okwokubanza", "Okwakabiri", "Okwakashatu", "Okwakana", "Okwakataana", "Okwamukaaga", "Okwamushanju", "Okwamunaana", "Okwamwenda", "Okwaikumi", "Okwaikumi na kumwe", "Okwaikumi na ibiri"},
			WeekdaysAbbreviatedValue: []string{"SAN", "ORK", "OKB", "OKS", "OKN", "OKT", "OMK"},
			WeekdaysNarrowValue:      []string{"S", "K", "R", "S", "N", "T", "M"},
			WeekdaysWideValue:        []string{"Sande", "Orwokubanza", "Orwakabiri", "Orwakashatu", "Orwakana", "Orwakataano", "Orwamukaaga"},
			ErasAbbreviatedValue:     []string{"BC", "AD"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Kurisito Atakaijire", "Kurisito Yaijire"},
...
func (cgg *cgg_UG) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(cgg, cgg.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'cgg_UG'
func (cgg *cgg_UG) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(cgg, cgg.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'cgg_UG'
func (cgg *cgg_UG) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(cgg, cgg.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'cgg_UG'
func (cgg *cgg_UG) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(cgg, cgg.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'cgg_UG'
func (cgg *cgg_UG) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(cgg, cgg.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'cgg_UG'
func (cgg *cgg_UG) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(cgg, cgg.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'cgg_UG'
func (cgg *cgg_UG) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(cgg, cgg.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'cgg_UG'
func (cgg *cgg_UG) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(cgg, cgg.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'cgg_UG'
func (cgg *cgg_UG) DateFullLayout() string {
	return cgg.dateFullLayout
}

// DateLongLayout returns the long date layout for 'cgg_UG'
func (cgg *cgg_UG) DateLongLayout() string {
	return cgg.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'cgg_UG'
func (cgg *cgg_UG) DateMediumLayout() string {
	return cgg.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'cgg_UG'
func (cgg *cgg_UG) DateShortLayout() string {
	return cgg.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'cgg_UG'
func (cgg *cgg_UG) TimeFullLayout() string {
	return cgg.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'cgg_UG'
func (cgg *cgg_UG) TimeLongLayout() string {
	return cgg.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'cgg_UG'
func (cgg *cgg_UG) TimeMediumLayout() string {
	return cgg.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'cgg_UG'
func (cgg *cgg_UG) TimeShortLayout() string {
	return cgg.timeShortLayout
}

func (cgg *cgg_UG) ListPatterns() *locales.ListPatterns {
	return cgg.listPatterns
}

func (cgg *cgg_UG) GetDurationSpec() *locales.DurationSpec {
	return cgg.DurationSpec
}

func (cgg *cgg_UG) GetMiscPatterns() *locales.MiscPatterns {
	return &cgg.miscPatterns
}
