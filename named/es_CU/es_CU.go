...
// DateFullLayout returns the full date layout for 'es_CU'
func (es *es_CU) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_CU'
func (es *es_CU) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_CU'
func (es *es_CU) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_CU'
func (es *es_CU) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_CU'
func (es *es_CU) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_CU'
func (es *es_CU) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_CU'
func (es *es_CU) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_CU'
func (es *es_CU) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_CU) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_CU) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_CU) GetMiscPatterns() *locales.MiscPatterns {
