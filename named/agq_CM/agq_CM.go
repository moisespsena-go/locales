...
func New() locales.Translator {
	return &agq_CM{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "nùm", "kɨz", "tɨd", "taa", "see", "nzu", "dum", "fɔe", "dzu", "lɔm", "kaa", "fwo"},
			MonthsNarrowValue:        []string{"", "n", "k", "t", "t", "s", "z", "k", "f", "d", "l", "c", "f"},
			MonthsWideValue:          []string{"", "ndzɔ̀ŋɔ̀nùm", "ndzɔ̀ŋɔ̀kƗ̀zùʔ", "ndzɔ̀ŋɔ̀tƗ̀dʉ̀ghà", "ndzɔ̀ŋɔ̀tǎafʉ̄ghā", "ndzɔ̀ŋèsèe", "ndzɔ̀ŋɔ̀nzùghò", "ndzɔ̀ŋɔ̀dùmlo", "ndzɔ̀ŋɔ̀kwîfɔ̀e", "ndzɔ̀ŋɔ̀tƗ̀fʉ̀ghàdzughù", "ndzɔ̀ŋɔ̀ghǔuwelɔ̀m", "ndzɔ̀ŋɔ̀chwaʔàkaa wo", "ndzɔ̀ŋèfwòo"},
			WeekdaysAbbreviatedValue: []string{"nts", "kpa", "ghɔ", "tɔm", "ume", "ghɨ", "dzk"},
			WeekdaysNarrowValue:      []string{"n", "k", "g", "t", "u", "g", "d"},
			WeekdaysWideValue:        []string{"tsuʔntsɨ", "tsuʔukpà", "tsuʔughɔe", "tsuʔutɔ̀mlò", "tsuʔumè", "tsuʔughɨ̂m", "tsuʔndzɨkɔʔɔ"},
			PeriodsAbbreviatedValue:  []string{"a.g", "a.k"},
			PeriodsWideValue:         []string{"a.g", "a.k"},
			ErasAbbreviatedValue:     []string{"SK", "BK"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Sěe Kɨ̀lesto", "Bǎa Kɨ̀lesto"},
...
func (agq *agq_CM) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(agq, agq.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'agq_CM'
func (agq *agq_CM) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(agq, agq.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'agq_CM'
func (agq *agq_CM) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(agq, agq.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'agq_CM'
func (agq *agq_CM) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(agq, agq.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'agq_CM'
func (agq *agq_CM) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(agq, agq.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'agq_CM'
func (agq *agq_CM) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(agq, agq.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'agq_CM'
func (agq *agq_CM) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(agq, agq.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'agq_CM'
func (agq *agq_CM) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(agq, agq.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'agq_CM'
func (agq *agq_CM) DateFullLayout() string {
	return agq.dateFullLayout
}

// DateLongLayout returns the long date layout for 'agq_CM'
func (agq *agq_CM) DateLongLayout() string {
	return agq.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'agq_CM'
func (agq *agq_CM) DateMediumLayout() string {
	return agq.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'agq_CM'
func (agq *agq_CM) DateShortLayout() string {
	return agq.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'agq_CM'
func (agq *agq_CM) TimeFullLayout() string {
	return agq.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'agq_CM'
func (agq *agq_CM) TimeLongLayout() string {
	return agq.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'agq_CM'
func (agq *agq_CM) TimeMediumLayout() string {
	return agq.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'agq_CM'
func (agq *agq_CM) TimeShortLayout() string {
	return agq.timeShortLayout
}

func (agq *agq_CM) ListPatterns() *locales.ListPatterns {
	return agq.listPatterns
}

func (agq *agq_CM) GetDurationSpec() *locales.DurationSpec {
	return agq.DurationSpec
}

func (agq *agq_CM) GetMiscPatterns() *locales.MiscPatterns {
	return &agq.miscPatterns
}
