...
// DateFullLayout returns the full date layout for 'ru_KG'
func (ru *ru_KG) DateFullLayout() string {
	return ru.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ru_KG'
func (ru *ru_KG) DateLongLayout() string {
	return ru.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ru_KG'
func (ru *ru_KG) DateMediumLayout() string {
	return ru.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ru_KG'
func (ru *ru_KG) DateShortLayout() string {
	return ru.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ru_KG'
func (ru *ru_KG) TimeFullLayout() string {
	return ru.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ru_KG'
func (ru *ru_KG) TimeLongLayout() string {
	return ru.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ru_KG'
func (ru *ru_KG) TimeMediumLayout() string {
	return ru.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ru_KG'
func (ru *ru_KG) TimeShortLayout() string {
	return ru.timeShortLayout
}

func (ru *ru_KG) ListPatterns() *locales.ListPatterns {
	return ru.listPatterns
}

func (ru *ru_KG) GetDurationSpec() *locales.DurationSpec {
	return ru.DurationSpec
}

func (ru *ru_KG) GetMiscPatterns() *locales.MiscPatterns {
