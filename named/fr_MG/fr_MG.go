...
// DateFullLayout returns the full date layout for 'fr_MG'
func (fr *fr_MG) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_MG'
func (fr *fr_MG) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_MG'
func (fr *fr_MG) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_MG'
func (fr *fr_MG) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_MG'
func (fr *fr_MG) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_MG'
func (fr *fr_MG) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_MG'
func (fr *fr_MG) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_MG'
func (fr *fr_MG) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_MG) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_MG) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_MG) GetMiscPatterns() *locales.MiscPatterns {
