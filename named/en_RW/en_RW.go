...
// DateFullLayout returns the full date layout for 'en_RW'
func (en *en_RW) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_RW'
func (en *en_RW) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_RW'
func (en *en_RW) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_RW'
func (en *en_RW) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_RW'
func (en *en_RW) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_RW'
func (en *en_RW) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_RW'
func (en *en_RW) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_RW'
func (en *en_RW) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_RW) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_RW) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_RW) GetMiscPatterns() *locales.MiscPatterns {
