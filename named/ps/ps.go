...
func New() locales.Translator {
	return &ps{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "جنوري", "فبروري", "مارچ", "اپریل", "مۍ", "جون", "جولای", "اګست", "سېپتمبر", "اکتوبر", "نومبر", "دسمبر"},
			MonthsNarrowValue:        []string{"", "ج", "ف", "م", "ا", "م", "ج", "ج", "ا", "س", "ا", "ن", "د"},
			MonthsWideValue:          []string{"", "جنوري", "فبروري", "مارچ", "اپریل", "مۍ", "جون", "جولای", "اګست", "سېپتمبر", "اکتوبر", "نومبر", "دسمبر"},
			WeekdaysAbbreviatedValue: []string{"يونۍ", "دونۍ", "درېنۍ", "څلرنۍ", "پينځنۍ", "جمعه", "اونۍ"},
			WeekdaysNarrowValue:      []string{"S", "M", "T", "W", "T", "F", "S"},
			WeekdaysShortValue:       []string{"يونۍ", "دونۍ", "درېنۍ", "څلرنۍ", "پينځنۍ", "جمعه", "اونۍ"},
			WeekdaysWideValue:        []string{"يونۍ", "دونۍ", "درېنۍ", "څلرنۍ", "پينځنۍ", "جمعه", "اونۍ"},
			PeriodsAbbreviatedValue:  []string{"غ.م.", "غ.و."},
			PeriodsNarrowValue:       []string{"غ.م.", "غ.و."},
			PeriodsWideValue:         []string{"غ.م.", "غ.و."},
			ErasAbbreviatedValue:     []string{"له میلاد وړاندې", "م."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"له میلاد څخه وړاندې", "له میلاد څخه وروسته"},
			TimezonesValue:           map[string]string{"": "د فوکلنډ ټاپو معیاری وخت", "ACDT": "آسترالوي مرکزي د ورځې روښانه وخت", "ACST": "ACST", "ACT": "ACT", "ACWDT": "آسترالوي مرکزي لوېديځ د ورځې روښانه وخت", "ACWST": "آسترالوي مرکزي لوېديځ معياري وخت", "ADT": "اتلانتیک د رڼا ورځې وخت", "AEDT": "آسترالوي ختيځ د ورځې روښانه وخت", "AEST": "آسترالوي ختيځ معياري وخت", "AFT": "افغانستان وخت", "AKDT": "الاسکا د ورځې روښانه وخت", "AKST": "الاسکا معياري وخت", "AMST": "ایمیزون اوړي وخت", "AMT": "ایمیزون معیاری وخت", "ARST": "ارجنټاین اوړي وخت", "ART": "ارجنټاین معیاری وخت", "AST": "اتلانتیک معياري وخت", "AWDT": "آسترالوي لوېديځ د ورځې روښانه وخت", "AWST": "آسترالوي لوېديځ معياري وخت", "BNT": "برونايي دارالسلام وخت", "BOT": "بولیویا وخت", "BRST": "برسلیا اوړي وخت", "BRT": "برسلیا معیاری وخت", "BST": "بنګله ديش اوړي وخت", "BTT": "بهوټان وخت", "CAT": "منځنی افريقا وخت", "CCT": "کوکوز ټاپوګانو وخت", "CDT": "مرکزي د ورځې روښانه وخت", "CDT (Kuba)": "کیوبا د رڼا ورځې وخت", "CHADT": "چاتام د ورځې روښانه وخت", "CHAST": "چاتام معياري وخت", "CLST": "چلی اوړي وخت", "CLT": "چلی معیاری وخت", "COST": "کولمبیا اوړي وخت", "COT": "کولمبیا معیاری وخت", "CST": "مرکزي معياري وخت", "CST (Kuba)": "کیوبا معياري وخت", "CXT": "کريسمس ټاپو وخت", "ChST": "چمارو معياري وخت", "EASST": "ايستر ټاپو اوړي وخت", "EAST": "ايستر ټاپو معياري وخت", "EAT": "ختيځ افريقا وخت", "ECT": "د اکوادور وخت", "EDT": "ختيځ د رڼا ورځې وخت", "EGDT": "د ختیځ ګرینلینډ اوړي وخت", "EGST": "د ختیځ ګرینلینډ معياري وخت", "EST": "ختيځ معياري وخت", "FKST": "د فوکلنډ ټاپو اوړي وخت", "GALT": "ګالپګوس وخت", "GFT": "د فرانسوي ګانا وخت", "GMT": "ګرينويچ معياري وخت", "GST": "خلیج معياري وخت", "GYT": "د ګوانانا وخت", "HADT": "هوایی الیوتین رڼا ورځې وخت", "HAST": "هوایی الیوتین معیاری وخت", "HENOMX": "د شمال لویدیځ مکسیکو رڼا ورځې وخت", "HEOG": "لویدیځ ګرینلینډ اوړي وخت", "HEPMX": "مکسیکن پیسفک رڼا ورځې وخت", "HKST": "هانګ کانګ اوړي وخت", "HKT": "هانګ کانګ معياري وخت", "HNNOMX": "د شمال لویدیځ مکسیکو معیاري وخت", "HNOG": "لویدیځ ګرینلینډ معياري وخت", "HNPMX": "مکسیکن پیسفک معیاری وخت", "ICT": "انډوچاینه وخت", "IRDT": "ايران د ورځې روښانه وخت", "IRST": "ایران معياري وخت", "IST": "هند معیاري وخت", "JDT": "جاپان د ورځې روښانه وخت", "JST": "جاپان معياري وخت", "LHDT": "لارډ هوي د ورځې روښانه وخت", "LHST": "لارډ هوي معياري وخت", "MDT": "MDT", "MESZ": "مرکزي اروپايياوړي وخت", "MEZ": "د مرکزي اروپا معیاري وخت", "MST": "MST", "MVT": "مالديپ وخت", "MYT": "ملائیشیا وخت", "NDT": "نيو فاونډلېنډ د ورځې روښانه وخت", "NPT": "نیپال وخت", "NST": "د نوي فیلډلینډ معیاری وخت", "NZDT": "نيوزي لېنډ د ورځې روښانه وخت", "NZST": "نيوزي لېنډ معياري وخت", "OESZ": "ختيځ اروپايي اوړي وخت", "OEZ": "ختيځ اروپايي معياري وخت", "PDT": "پیسفک د رڼا ورځې وخت", "PKT": "پاکستان اوړي وخت", "PMDT": "سینټ پییرا و ميکلين رڼا ورځې وخت", "PMST": "سینټ پییرا و ميکلين معیاری وخت", "PST": "د پیسفک معياري وخت", "PYST": "پاراګوای اوړي وخت", "SAST": "جنوبي افريقا معياري وخت", "SGT": "سنګاپور معیاري وخت", "SRT": "سورینام وخت", "TLT": "ختيځ تيمور وخت", "TMST": "ترکمنستان اوړي وخت", "TMT": "ترکمنستان معياري وخت", "UYST": "یوروګوای اوړي وخت", "UYT": "یوروګوای معياري وخت", "VET": "وینزویلا وخت", "WARST": "لوېديځ ارجنټاين اوړي وخت", "WART": "لوېديځ ارجنټاين معياري وخت", "WAST": "د افریقا افریقا لویدیځ وخت", "WAT": "لویدیځ افریقایي معیاري وخت", "WESZ": "لوېديځ اروپايي اوړي وخت", "WEZ": "لوېديځ اروپايي معياري وخت", "WIB": "لویدیځ اندونیزیا وخت", "WIT": "اندونیزیا وخت", "WITA": "مرکزي ادونيزيا وخت", "∅∅∅": "پیرو اوړي وخت"},
		},
		...
		dateFullLayout:   "EEEE د y د MMMM d",
		dateLongLayout:   "د y د MMMM d",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} او {1}", "{0}، {1}", "{0}، {1}", "{0}، او {1}"}, {"{0} or {1}", "{0}, {1}", "{0}، {1}", "{0}, یا {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"c", "%v c", "%v c", ""},
				Long:   &locales.CounterFormat{"پېړۍ", "%v پېړۍ", "%v پيړۍ", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"لسيزه", "%v لسيزه", "%v لسيزه", ""},
				Long:   &locales.CounterFormat{"لسيزې", "%v لسيزه", "%v لسيزې", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"yr", "%v y", "%v y", ""},
				Long:   &locales.CounterFormat{"کالونه", "%v کال", "%v کالونه", "%v په هر کال کې"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"مياشت", "%v m", "%v m", ""},
				Long:   &locales.CounterFormat{"مياشتې", "%v مياشت", "%v مياشتې", "%v/m"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"اونۍ", "%v w", "%v w", ""},
				Long:   &locales.CounterFormat{"اونۍ", "اونۍ", "%v اونۍ", "%v په هره اونۍ کې"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ورځ", "%v ورځ", "%vd", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"hr", "%v h", "%v h", ""},
				Long:   &locales.CounterFormat{"ساعتونه", "%v h", "%v h", "%v/h"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%v min", "%vm", ""},
				Long:   &locales.CounterFormat{"mins", "%v min", "%v min", "%v/min"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sec", "%v s", "%v s", ""},
				Long:   &locales.CounterFormat{"ثانيې", "%v s", "%v s", "%v/s"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"ms", "%v ms", "%v ms", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"مايکرو ثانيې", "%v μs", "%v μs", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"نينو ثانيې", "%v ns", "%v ns", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (ps *ps) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ps, ps.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ps'
func (ps *ps) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ps, ps.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ps'
func (ps *ps) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ps, ps.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ps'
func (ps *ps) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ps, ps.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ps'
func (ps *ps) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ps, ps.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ps'
func (ps *ps) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ps, ps.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ps'
func (ps *ps) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ps, ps.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ps'
func (ps *ps) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ps, ps.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ps'
func (ps *ps) DateFullLayout() string {
	return ps.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ps'
func (ps *ps) DateLongLayout() string {
	return ps.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ps'
func (ps *ps) DateMediumLayout() string {
	return ps.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ps'
func (ps *ps) DateShortLayout() string {
	return ps.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ps'
func (ps *ps) TimeFullLayout() string {
	return ps.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ps'
func (ps *ps) TimeLongLayout() string {
	return ps.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ps'
func (ps *ps) TimeMediumLayout() string {
	return ps.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ps'
func (ps *ps) TimeShortLayout() string {
	return ps.timeShortLayout
}

func (ps *ps) ListPatterns() *locales.ListPatterns {
	return ps.listPatterns
}

func (ps *ps) GetDurationSpec() *locales.DurationSpec {
	return ps.DurationSpec
}

func (ps *ps) GetMiscPatterns() *locales.MiscPatterns {
	return &ps.miscPatterns
}
