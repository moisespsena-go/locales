...
// DateFullLayout returns the full date layout for 'en_PN'
func (en *en_PN) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_PN'
func (en *en_PN) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_PN'
func (en *en_PN) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_PN'
func (en *en_PN) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_PN'
func (en *en_PN) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_PN'
func (en *en_PN) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_PN'
func (en *en_PN) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_PN'
func (en *en_PN) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_PN) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_PN) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_PN) GetMiscPatterns() *locales.MiscPatterns {
