...
// DateFullLayout returns the full date layout for 'ar_001'
func (ar *ar_001) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_001'
func (ar *ar_001) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_001'
func (ar *ar_001) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_001'
func (ar *ar_001) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_001'
func (ar *ar_001) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_001'
func (ar *ar_001) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_001'
func (ar *ar_001) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_001'
func (ar *ar_001) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_001) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_001) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_001) GetMiscPatterns() *locales.MiscPatterns {
