...
// DateFullLayout returns the full date layout for 'es_PH'
func (es *es_PH) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_PH'
func (es *es_PH) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_PH'
func (es *es_PH) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_PH'
func (es *es_PH) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_PH'
func (es *es_PH) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_PH'
func (es *es_PH) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_PH'
func (es *es_PH) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_PH'
func (es *es_PH) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_PH) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_PH) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_PH) GetMiscPatterns() *locales.MiscPatterns {
