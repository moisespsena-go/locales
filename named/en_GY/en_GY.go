...
// DateFullLayout returns the full date layout for 'en_GY'
func (en *en_GY) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_GY'
func (en *en_GY) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_GY'
func (en *en_GY) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_GY'
func (en *en_GY) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_GY'
func (en *en_GY) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_GY'
func (en *en_GY) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_GY'
func (en *en_GY) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_GY'
func (en *en_GY) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_GY) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_GY) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_GY) GetMiscPatterns() *locales.MiscPatterns {
