...
// DateFullLayout returns the full date layout for 'bas'
func (bas *bas) DateFullLayout() string {
	return bas.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bas'
func (bas *bas) DateLongLayout() string {
	return bas.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bas'
func (bas *bas) DateMediumLayout() string {
	return bas.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bas'
func (bas *bas) DateShortLayout() string {
	return bas.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bas'
func (bas *bas) TimeFullLayout() string {
	return bas.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bas'
func (bas *bas) TimeLongLayout() string {
	return bas.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bas'
func (bas *bas) TimeMediumLayout() string {
	return bas.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bas'
func (bas *bas) TimeShortLayout() string {
	return bas.timeShortLayout
}

func (bas *bas) ListPatterns() *locales.ListPatterns {
	return bas.listPatterns
}

func (bas *bas) GetDurationSpec() *locales.DurationSpec {
	return bas.DurationSpec
}

func (bas *bas) GetMiscPatterns() *locales.MiscPatterns {
