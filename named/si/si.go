...
func New() locales.Translator {
	return &si{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ද0"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ද0"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ද00"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ද00"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ද000"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ද000"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤මි0"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤මි0"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤මි00"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤මි00"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤මි000"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤මි000"),
						}},
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤බි0"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤බි0"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤බි00"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤බි00"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤බි000"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤බි000"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ට්\u200dරි0"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ට්\u200dරි0"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ට්\u200dරි00"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ට්\u200dරි00"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ට්\u200dරි000"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ට්\u200dරි000"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ".",
			MonthsAbbreviatedValue:   []string{"", "ජන", "පෙබ", "මාර්තු", "අප්\u200dරේල්", "මැයි", "ජූනි", "ජූලි", "අගෝ", "සැප්", "ඔක්", "නොවැ", "දෙසැ"},
			MonthsNarrowValue:        []string{"", "ජ", "පෙ", "මා", "අ", "මැ", "ජූ", "ජූ", "අ", "සැ", "ඔ", "නෙ", "දෙ"},
			MonthsWideValue:          []string{"", "ජනවාරි", "පෙබරවාරි", "මාර්තු", "අප්\u200dරේල්", "මැයි", "ජූනි", "ජූලි", "අගෝස්තු", "සැප්තැම්බර්", "ඔක්තෝබර්", "නොවැම්බර්", "දෙසැම්බර්"},
			WeekdaysAbbreviatedValue: []string{"ඉරිදා", "සඳුදා", "අඟහ", "බදාදා", "බ්\u200dරහස්", "සිකු", "සෙන"},
			WeekdaysNarrowValue:      []string{"ඉ", "ස", "අ", "බ", "බ්\u200dර", "සි", "සෙ"},
			WeekdaysShortValue:       []string{"ඉරි", "සඳු", "අඟ", "බදා", "බ්\u200dරහ", "සිකු", "සෙන"},
			WeekdaysWideValue:        []string{"ඉරිදා", "සඳුදා", "අඟහරුවාදා", "බදාදා", "බ්\u200dරහස්පතින්දා", "සිකුරාදා", "සෙනසුරාදා"},
			PeriodsAbbreviatedValue:  []string{"පෙ.ව.", "ප.ව."},
			PeriodsNarrowValue:       []string{"පෙ", "ප"},
			PeriodsWideValue:         []string{"පෙ.ව.", "ප.ව."},
			ErasAbbreviatedValue:     []string{"ක්\u200dරි.පූ.", "ක්\u200dරි.ව."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"ක්\u200dරිස්තු පූර්ව", "ක්\u200dරිස්තු වර්ෂ"},
			TimezonesValue:           map[string]string{"": "ෆෝක්ලන්ඩ් දූපත් සම්මත වේලාව", "ACDT": "මධ්\u200dයම ඔස්ට්\u200dරේලියානු දහවල් වේලාව", "ACST": "ඕස්ට්\u200dරේලියානු සම්මත වේලාව", "ACT": "ACT", "ACWDT": "මධ්\u200dයම බටහිර ඔස්ට්\u200dරේලියානු දහවල් වේලාව", "ACWST": "මධ්\u200dයම බටහිර ඔස්ට්\u200dරේලියානු සම්මත වේලාව", "ADT": "අත්ලාන්තික් දිවාආලෝක වේලාව", "AEDT": "නැඟෙනහිර ඕස්ට්\u200dරේලියානු දහවල් වේලාව", "AEST": "නැගෙනහිර ඕස්ට්\u200dරේලියානු සම්මත වේලාව", "AFT": "ඇෆ්ගනිස්ථාන වේලාව", "AKDT": "ඇලස්කා දිවාආලෝක වේලාව", "AKST": "ඇලස්කා සම්මත වේලාව", "AMST": "ඇමර්සන් ග්\u200dරීෂ්ම කාලය", "AMT": "ඇමර්සන් සම්මත වේලාව", "ARST": "ආර්ජන්ටිනා ග්\u200dරීෂ්ම කාලය", "ART": "ආර්ජන්ටිනා සම්මත වේලාව", "AST": "අත්ලාන්තික් සම්මත වේලාව", "AWDT": "බටහිර ඔස්ට්\u200dරේලියානු දහවල් වේලාව", "AWST": "බටහිර ඕස්ට්\u200dරේලියානු සම්මත වේලාව", "BNT": "බෘනායි දරුස්සලාම් වේලාව", "BOT": "බොලිවියා වේලාව", "BRST": "බ්\u200dරසීල ග්\u200dරීෂ්ම කාලය", "BRT": "බ්\u200dරසීල සම්මත වේලාව", "BST": "බංගලාදේශ ග්\u200dරීෂ්ම කාලය", "BTT": "භුතාන වේලාව", "CAT": "මධ්\u200dයම අප්\u200dරිකානු වේලාව", "CCT": "කොකෝස් දුපත් වේලාව", "CDT": "උතුරු ඇමරිකානු මධ්\u200dයම දිවාආලෝක වේලාව", "CDT (Kuba)": "කියුබානු දිවාආලෝක වේලාව", "CHADT": "චැතම් දිවා වේලාව", "CHAST": "චැතම් සම්මත වේලාව", "CLST": "චිලී ග්\u200dරීෂ්ම කාලය", "CLT": "චිලී සම්මත වේලාව", "COST": "කොලොම්බියා ග්\u200dරීෂ්ම කාලය", "COT": "කොලොම්බියා සම්මත වේලාව", "CST": "උතුරු ඇමරිකානු මධ්\u200dයම සම්මත වේලාව", "CST (Kuba)": "කියුබානු සම්මත වේලාව", "CXT": "ක්\u200dරිස්මස් දුපත් වේලාව", "ChST": "චමොරෝ වේලාව", "EASST": "ඊස්ටර් දූපත් ග්\u200dරීෂ්ම කාලය", "EAST": "ඊස්ටර් දූපත් සම්මත වේලාව", "EAT": "නැගෙනහිර අප්\u200dරිකානු වේලාව", "ECT": "ඉක්වදෝර් වේලාව", "EDT": "උතුරු ඇමරිකානු නැගෙනහිර දිවාආලෝක වේලාව", "EGDT": "නැගෙනහිර ග්\u200dරීන්ලන්ත ග්\u200dරීෂ්ම කාලය", "EGST": "නැගෙනහිර ග්\u200dරීන්ලන්ත සම්මත වේලාව", "EST": "උතුරු ඇමරිකානු නැගෙනහිර සම්මත වේලාව", "FKST": "ෆෝක්ලන්ඩ් දූපත් ග්\u200dරීෂ්ම කාලය", "GALT": "ගලපගොස් වේලාව", "GFT": "ප්\u200dරංශ ගයනා වේලාව", "GMT": "ග්\u200dරිනිච් මධ්\u200dයම වේලාව", "GST": "ගල්ෆ් වේලාව", "GYT": "ගයනා වේලාව", "HADT": "හවායි-අලෙයුතියාන් දිවාආලෝක වේලාව", "HAST": "හවායි-අලෙයුතියාන් සම්මත වේලාව", "HENOMX": "වයඹ මෙක්සිකෝ දිවාආලෝක වේලාව", "HEOG": "බටහිර ග්\u200dරීන්ලන්ත ග්\u200dරීෂ්ම කාලය", "HEPMX": "මෙක්සිකෝ පැසිෆික් දිවාආලෝක වේලාව", "HKST": "හොංකොං ග්\u200dරීෂ්ම වේලාව", "HKT": "හොංකොං සම්මත වේලාව", "HNNOMX": "වයඹ මෙක්සිකෝ සම්මත වේලාව", "HNOG": "බටහිර ග්\u200dරීන්ලන්ත සම්මත වේලාව", "HNPMX": "මෙක්සිකෝ පැසිෆික් සම්මත වේලාව", "ICT": "ඉන්දුචීන වේලාව", "IRDT": "ඉරාන දිවා කාලය", "IRST": "ඉරාන සම්මත වේලාව", "IST": "ඉන්දියානු වේලාව", "JDT": "ජපාන දහවල් වේලාව", "JST": "ජපාන සම්මත වේලාව", "LHDT": "ලෝර්ඩ් හෝව් දිවා වේලාව", "LHST": "ලෝර්ඩ් හෝව් සම්මත වේලාව", "MDT": "MDT", "MESZ": "මධ්\u200dයම යුරෝපීය ග්\u200dරීෂ්ම වේලාව", "MEZ": "මධ්\u200dයම යුරෝපීය සම්මත වේලාව", "MST": "MST", "MVT": "මාලදිවයින් වේලාව", "MYT": "මැලේසියානු වේලාව", "NDT": "නිව්ෆවුන්ලන්ත දිවාආලෝක වේලාව", "NPT": "නේපාල වේලාව", "NST": "නිව්ෆවුන්ලන්ත සම්මත වේලාව", "NZDT": "නවසීලන්ත දිවා වේලාව", "NZST": "නවසීලන්ත සම්මත වේලාව", "OESZ": "නැගෙනහිර යුරෝපීය ග්\u200dරීෂ්ම වේලාව", "OEZ": "නැගෙනහිර යුරෝපීය සම්මත වේලාව", "PDT": "උතුරු ඇමරිකානු පැසිෆික් දිවාආලෝක වේලාව", "PKT": "පාකිස්ථාන ග්\u200dරීෂ්ම කාලය", "PMDT": "ශාන්ත පියරේ සහ මැකෝලන් දිවාආලෝක වේලාව", "PMST": "ශාන්ත පියරේ සහ මැකෝලන් සම්මත වේලාව", "PST": "උතුරු ඇමරිකානු පැසිෆික් සම්මත වේලාව", "PYST": "පැරගුවේ ග්\u200dරීෂ්ම කාලය", "SAST": "දකුණු අප්\u200dරිකානු වේලාව", "SGT": "සිංගප්පුරු වේලාව", "SRT": "සුරිනාම වේලාව", "TLT": "නැගෙනහිර ටිමෝර් වේලාව", "TMST": "ටර්ක්මෙනිස්තාන ග්\u200dරීෂ්ම වේලාව", "TMT": "ටර්ක්මෙනිස්තාන සම්මත වේලාව", "UYST": "උරුගුවේ ග්\u200dරීෂ්ම කාලය", "UYT": "උරුගුවේ සම්මත වේලාව", "VET": "වෙනිසියුලා වේලාව", "WARST": "බටහිර ආර්ජන්ටිනා ග්\u200dරීෂ්ම කාලය", "WART": "බටහිර ආර්ජන්ටිනා සම්මත වේලාව", "WAST": "බටහිර අප්\u200dරිකානු ග්\u200dරීෂ්ම කාලය", "WAT": "බටහිර අප්\u200dරිකානු සම්මත වේලාව", "WESZ": "බටහිර යුරෝපීය ග්\u200dරීෂ්ම වේලාව", "WEZ": "බටහිර යුරෝපීය සම්මත වේලාව", "WIB": "බටහිර ඉන්දුනීසියානු වේලාව", "WIT": "නැගෙනහිර ඉන්දුනීසියානු වේලාව", "WITA": "මධ්\u200dයම ඉන්දුනීසියානු වේලාව", "∅∅∅": "පේරු ග්\u200dරීෂ්ම කාලය"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} සහ {1}", "{0}, {1}", "{0}, {1}", "{0}, සහ {1}"}, {"{0} හෝ {1}", "{0}, {1}", "{0}, {1}", "{0}, හෝ {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"සි", "සි %v", "සි %v", ""},
				Long:   &locales.CounterFormat{"සියවස", "සියවස් %v", "සියවස් %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"දශක", "දශක %v", "දශක %v", ""},
				Long:   &locales.CounterFormat{"දශක", "දශක %v", "දශක %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"වසර", "ව %v", "ව %v", ""},
				Long:   &locales.CounterFormat{"වසර", "වසර %v", "වසර %v", "වසරට %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"මාස", "මා %v", "මා %v", ""},
				Long:   &locales.CounterFormat{"මාස", "මාස %v", "මාස %v", "මාසයට %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"සති", "ස %v", "ස %v", ""},
				Long:   &locales.CounterFormat{"සති", "සති %v", "සති %v", "සතියට %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"දින", "දි %v", "දි %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"පැය", "පැය %v", "පැය %v", ""},
				Long:   &locales.CounterFormat{"පැය", "පැය %v", "පැය %v", "පැයට %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"මිනි", "මි %v", "මි %v", ""},
				Long:   &locales.CounterFormat{"මිනිත්තු", "මිනිත්තු %v", "මිනිත්තු %v", "මිනිත්තුවට %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"තත්", "ත %v", "ත %v", ""},
				Long:   &locales.CounterFormat{"තත්පර", "තත්පර %v", "තත්පර %v", "තත්පරයට %v"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"මිලිතත්", "මිලිතත් %v", "මිලිතත් %v", ""},
				Long:   &locales.CounterFormat{"මිලිතත්පර", "මිලිතත්පර %v", "මිලිතත්පර %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"මයික්\u200dරොතත්", "මයික්\u200dරොතත් %v", "මයික්\u200dරොතත් %v", ""},
				Long:   &locales.CounterFormat{"මයික්\u200dරොතත්පර", "මයික්\u200dරොතත්පර %v", "මයික්\u200dරොතත්පර %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"නැනෝතත්", "නැත %v", "නැත %v", ""},
				Long:   &locales.CounterFormat{"නැනෝතත්පර", "නැනෝතත්පර %v", "නැනෝතත්පර %v", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (si *si) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(si, si.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'si'
func (si *si) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(si, si.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'si'
func (si *si) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(si, si.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'si'
func (si *si) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(si, si.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'si'
func (si *si) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(si, si.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'si'
func (si *si) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(si, si.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'si'
func (si *si) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(si, si.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'si'
func (si *si) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(si, si.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'si'
func (si *si) DateFullLayout() string {
	return si.dateFullLayout
}

// DateLongLayout returns the long date layout for 'si'
func (si *si) DateLongLayout() string {
	return si.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'si'
func (si *si) DateMediumLayout() string {
	return si.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'si'
func (si *si) DateShortLayout() string {
	return si.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'si'
func (si *si) TimeFullLayout() string {
	return si.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'si'
func (si *si) TimeLongLayout() string {
	return si.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'si'
func (si *si) TimeMediumLayout() string {
	return si.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'si'
func (si *si) TimeShortLayout() string {
	return si.timeShortLayout
}

func (si *si) ListPatterns() *locales.ListPatterns {
	return si.listPatterns
}

func (si *si) GetDurationSpec() *locales.DurationSpec {
	return si.DurationSpec
}

func (si *si) GetMiscPatterns() *locales.MiscPatterns {
	return &si.miscPatterns
}
