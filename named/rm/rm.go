...
func New() locales.Translator {
	return &rm{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "schan.", "favr.", "mars", "avr.", "matg", "zercl.", "fan.", "avust", "sett.", "oct.", "nov.", "dec."},
			MonthsNarrowValue:        []string{"", "S", "F", "M", "A", "M", "Z", "F", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "da schaner", "da favrer", "da mars", "d’avrigl", "da matg", "da zercladur", "da fanadur", "d’avust", "da settember", "d’october", "da november", "da december"},
			WeekdaysAbbreviatedValue: []string{"du", "gli", "ma", "me", "gie", "ve", "so"},
			WeekdaysNarrowValue:      []string{"D", "G", "M", "M", "G", "V", "S"},
			WeekdaysShortValue:       []string{"du", "gli", "ma", "me", "gie", "ve", "so"},
			WeekdaysWideValue:        []string{"dumengia", "glindesdi", "mardi", "mesemna", "gievgia", "venderdi", "sonda"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsNarrowValue:       []string{"AM", "PM"},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"av. Cr.", "s. Cr."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"avant Cristus", "suenter Cristus"},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "Temp da stad atlantic", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "Temp da standard atlantic", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "CAT", "CCT": "CCT", "CDT": "Temp da stad central", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "Temp da standard central", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "EAT", "ECT": "ECT", "EDT": "Temp da stad oriental", "EGDT": "EGDT", "EGST": "EGST", "EST": "Temp da standard oriental", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "Temp Greenwich", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "Temp da stad da muntogna", "MESZ": "Temp da stad da l’Europa Centrala", "MEZ": "Temp da standard da l’Europa Centrala", "MST": "Temp da standard da muntogna", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "Temp da stad da l’Europa Orientala", "OEZ": "Temp da standard da l’Europa Orientala", "PDT": "Temp da stad pacific", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "Temp da standard pacific", "PYST": "PYST", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "Temp da stad da l’Europa dal Vest", "WEZ": "Temp da standard da l’Europa dal Vest", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		dateFullLayout:   "EEEE, 'ils' d MMMM y",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} e {1}", "{0}, {1}", "{0}, {1}", "{0} e {1}"}, {"{0} u {1}", "{0}, {1}", "{0}, {1}", "{0} u {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"onn", "%v onns", "%v onns", ""},
				Long:   &locales.CounterFormat{"onns", "%v onn", "%v onns", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mais", "%v mais", "%v mais", ""},
				Long:   &locales.CounterFormat{"mais", "%v mais", "%v mais", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"emna", "%v emnas", "%v emnas", ""},
				Long:   &locales.CounterFormat{"emnas", "%v emna", "%v emnas", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"di", "%v dis", "%v dis", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ura", "%v uras", "%v uras", ""},
				Long:   &locales.CounterFormat{"uras", "%v ura", "%v uras", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%v mins.", "%v mins.", ""},
				Long:   &locales.CounterFormat{"minutas", "%v minuta", "%v minutas", "%v per minuta"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sec", "%v secs.", "%v secs.", ""},
...
func (rm *rm) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(rm, rm.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'rm'
func (rm *rm) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(rm, rm.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'rm'
func (rm *rm) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(rm, rm.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'rm'
func (rm *rm) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(rm, rm.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'rm'
func (rm *rm) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(rm, rm.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'rm'
func (rm *rm) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(rm, rm.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'rm'
func (rm *rm) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(rm, rm.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'rm'
func (rm *rm) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(rm, rm.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'rm'
func (rm *rm) DateFullLayout() string {
	return rm.dateFullLayout
}

// DateLongLayout returns the long date layout for 'rm'
func (rm *rm) DateLongLayout() string {
	return rm.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'rm'
func (rm *rm) DateMediumLayout() string {
	return rm.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'rm'
func (rm *rm) DateShortLayout() string {
	return rm.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'rm'
func (rm *rm) TimeFullLayout() string {
	return rm.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'rm'
func (rm *rm) TimeLongLayout() string {
	return rm.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'rm'
func (rm *rm) TimeMediumLayout() string {
	return rm.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'rm'
func (rm *rm) TimeShortLayout() string {
	return rm.timeShortLayout
}

func (rm *rm) ListPatterns() *locales.ListPatterns {
	return rm.listPatterns
}

func (rm *rm) GetDurationSpec() *locales.DurationSpec {
	return rm.DurationSpec
}

func (rm *rm) GetMiscPatterns() *locales.MiscPatterns {
	return &rm.miscPatterns
}
