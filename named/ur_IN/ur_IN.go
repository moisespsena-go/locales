...
func New() locales.Translator {
	return &ur_IN{
		...
		TimeSpec: &locales.TimeSpec{
			...
			TimezonesValue:           map[string]string{"": "فاک لینڈ آئلینڈز سٹینڈرڈ ٹائم", "ACDT": "آسٹریلین سنٹرل ڈے لائٹ ٹائم", "ACST": "آسٹریلین سنٹرل اسٹینڈرڈ ٹائم", "ACT": "ACT", "ACWDT": "آسٹریلین سنٹرل ویسٹرن ڈے لائٹ ٹائم", "ACWST": "آسٹریلین سنٹرل ویسٹرن اسٹینڈرڈ ٹائم", "ADT": "اٹلانٹک ڈے لائٹ ٹائم", "AEDT": "آسٹریلین ایسٹرن ڈے لائٹ ٹائم", "AEST": "آسٹریلین ایسٹرن اسٹینڈرڈ ٹائم", "AFT": "افغانستان ٹائم", "AKDT": "الاسکا ڈے لائٹ ٹائم", "AKST": "الاسکا اسٹینڈرڈ ٹائم", "AMST": "ایمیزون سمر ٹائم", "AMT": "ایمیزون سٹینڈرڈ ٹائم", "ARST": "ارجنٹینا کا موسم گرما کا وقت", "ART": "ارجنٹینا کا معیاری وقت", "AST": "اٹلانٹک اسٹینڈرڈ ٹائم", "AWDT": "آسٹریلین ویسٹرن ڈے لائٹ ٹائم", "AWST": "آسٹریلیا ویسٹرن اسٹینڈرڈ ٹائم", "BNT": "برونئی دارالسلام ٹائم", "BOT": "بولیویا ٹائم", "BRST": "برازیلیا سمر ٹائم", "BRT": "برازیلیا سٹینڈرڈ ٹائم", "BST": "بنگلہ دیش سمر ٹائم", "BTT": "بھوٹان ٹائم", "CAT": "وسطی افریقہ ٹائم", "CCT": "کوکوس آئلینڈز ٹائم", "CDT": "سنٹرل ڈے لائٹ ٹائم", "CDT (Kuba)": "کیوبا ڈے لائٹ ٹائم", "CHADT": "چیتھم ڈے لائٹ ٹائم", "CHAST": "چیتھم اسٹینڈرڈ ٹائم", "CLST": "چلی سمر ٹائم", "CLT": "چلی سٹینڈرڈ ٹائم", "COST": "کولمبیا سمر ٹائم", "COT": "کولمبیا سٹینڈرڈ ٹائم", "CST": "سنٹرل اسٹینڈرڈ ٹائم", "CST (Kuba)": "کیوبا اسٹینڈرڈ ٹائم", "CXT": "کرسمس آئلینڈ ٹائم", "ChST": "چامورو سٹینڈرڈ ٹائم", "EASST": "ایسٹر آئلینڈ سمر ٹائم", "EAST": "ایسٹر آئلینڈ سٹینڈرڈ ٹائم", "EAT": "مشرقی افریقہ ٹائم", "ECT": "ایکواڈور ٹائم", "EDT": "ایسٹرن ڈے لائٹ ٹائم", "EGDT": "مشرقی گرین لینڈ کا موسم گرما کا وقت", "EGST": "مشرقی گرین لینڈ اسٹینڈرڈ ٹائم", "EST": "ایسٹرن اسٹینڈرڈ ٹائم", "FKST": "فاک لینڈ آئلینڈز سمر ٹائم", "GALT": "گالاپاگوز ٹائم", "GFT": "فرینچ گیانا ٹائم", "GMT": "گرین وچ مین ٹائم", "GST": "خلیج سٹینڈرڈ ٹائم", "GYT": "گیانا ٹائم", "HADT": "ہوائی الیوٹیئن ڈے لائٹ ٹائم", "HAST": "ہوائی الیوٹیئن اسٹینڈرڈ ٹائم", "HENOMX": "شمال مغربی میکسیکو ڈے لائٹ ٹائم", "HEOG": "مغربی گرین لینڈ کا موسم گرما کا وقت", "HEPMX": "میکسیکن پیسفک ڈے لائٹ ٹائم", "HKST": "ہانگ کانگ سمر ٹائم", "HKT": "ہانگ کانگ سٹینڈرڈ ٹائم", "HNNOMX": "شمال مغربی میکسیکو اسٹینڈرڈ ٹائم", "HNOG": "مغربی گرین لینڈ اسٹینڈرڈ ٹائم", "HNPMX": "میکسیکن پیسفک اسٹینڈرڈ ٹائم", "ICT": "ہند چین ٹائم", "IRDT": "ایران ڈے لائٹ ٹائم", "IRST": "ایران سٹینڈرڈ ٹائم", "IST": "انڈیا سٹینڈرڈ ٹائم", "JDT": "جاپان ڈے لائٹ ٹائم", "JST": "جاپان سٹینڈرڈ ٹائم", "LHDT": "لارڈ ہووے ڈے لائٹ ٹائم", "LHST": "لارڈ ہووے اسٹینڈرڈ ٹائم", "MDT": "MDT", "MESZ": "وسطی یورپ کا موسم گرما کا وقت", "MEZ": "وسطی یورپ کا معیاری وقت", "MST": "MST", "MVT": "مالدیپ ٹائم", "MYT": "ملیشیا ٹائم", "NDT": "نیو فاؤنڈ لینڈ ڈے لائٹ ٹائم", "NPT": "نیپال ٹائم", "NST": "نیو فاؤنڈ لینڈ اسٹینڈرڈ ٹائم", "NZDT": "نیوزی لینڈ ڈے لائٹ ٹائم", "NZST": "نیوزی لینڈ سٹینڈرڈ ٹائم", "OESZ": "مشرقی یورپ کا موسم گرما کا وقت", "OEZ": "مشرقی یورپ کا معیاری وقت", "PDT": "پیسفک ڈے لائٹ ٹائم", "PKT": "پاکستان سمر ٹائم", "PMDT": "سینٹ پیئر اور مکلیئون ڈے لائٹ ٹائم", "PMST": "سینٹ پیئر اور مکلیئون اسٹینڈرڈ ٹائم", "PST": "پیسفک اسٹینڈرڈ ٹائم", "PYST": "پیراگوئے سمر ٹائم", "SAST": "جنوبی افریقہ سٹینڈرڈ ٹائم", "SGT": "سنگاپور سٹینڈرڈ ٹائم", "SRT": "سورینام ٹائم", "TLT": "مشرقی تیمور ٹائم", "TMST": "ترکمانستان سمر ٹائم", "TMT": "ترکمانستان سٹینڈرڈ ٹائم", "UYST": "یوروگوئے سمر ٹائم", "UYT": "یوروگوئے سٹینڈرڈ ٹائم", "VET": "وینزوئیلا ٹائم", "WARST": "مغربی ارجنٹینا سمر ٹائم", "WART": "مغربی ارجنٹینا سٹینڈرڈ ٹائم", "WAST": "مغربی افریقہ سمر ٹائم", "WAT": "مغربی افریقہ سٹینڈرڈ ٹائم", "WESZ": "مغربی یورپ کا موسم گرما کا وقت", "WEZ": "مغربی یورپ کا معیاری وقت", "WIB": "مغربی انڈونیشیا ٹائم", "WIT": "مشرقی انڈونیشیا ٹائم", "WITA": "وسطی انڈونیشیا ٹائم", "∅∅∅": "پیرو سمر ٹائم"},
		},
...
// DateFullLayout returns the full date layout for 'ur_IN'
func (ur *ur_IN) DateFullLayout() string {
	return ur.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ur_IN'
func (ur *ur_IN) DateLongLayout() string {
	return ur.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ur_IN'
func (ur *ur_IN) DateMediumLayout() string {
	return ur.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ur_IN'
func (ur *ur_IN) DateShortLayout() string {
	return ur.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ur_IN'
func (ur *ur_IN) TimeFullLayout() string {
	return ur.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ur_IN'
func (ur *ur_IN) TimeLongLayout() string {
	return ur.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ur_IN'
func (ur *ur_IN) TimeMediumLayout() string {
	return ur.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ur_IN'
func (ur *ur_IN) TimeShortLayout() string {
	return ur.timeShortLayout
}

func (ur *ur_IN) ListPatterns() *locales.ListPatterns {
	return ur.listPatterns
}

func (ur *ur_IN) GetDurationSpec() *locales.DurationSpec {
	return ur.DurationSpec
}

func (ur *ur_IN) GetMiscPatterns() *locales.MiscPatterns {
