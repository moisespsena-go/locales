...
func New() locales.Translator {
	return &fy{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mrt", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Des"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Jannewaris", "Febrewaris", "Maart", "April", "Maaie", "Juny", "July", "Augustus", "Septimber", "Oktober", "Novimber", "Desimber"},
			WeekdaysAbbreviatedValue: []string{"si", "mo", "ti", "wo", "to", "fr", "so"},
			WeekdaysNarrowValue:      []string{"S", "M", "T", "W", "T", "F", "S"},
			WeekdaysShortValue:       []string{"si", "mo", "ti", "wo", "to", "fr", "so"},
			WeekdaysWideValue:        []string{"snein", "moandei", "tiisdei", "woansdei", "tongersdei", "freed", "sneon"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsNarrowValue:       []string{"AM", "PM"},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"f.Kr.", "n.Kr."},
			ErasNarrowValue:          []string{"f.K.", "n.K."},
			ErasWideValue:            []string{"Foar Kristus", "nei Kristus"},
			TimezonesValue:           map[string]string{"": "Paraguayaanske standerttiid", "ACDT": "Midden-Australyske simmertiid", "ACST": "Midden-Australyske standerttiid", "ACT": "Acre-standerttiid", "ACWDT": "Midden-Australyske westelijke simmertiid", "ACWST": "Midden-Australyske westelijke standerttiid", "ADT": "Atlantic-simmertiid", "AEDT": "East-Australyske simmertiid", "AEST": "East-Australyske standerttiid", "AFT": "Afghaanske tiid", "AKDT": "Alaska-simmertiid", "AKST": "Alaska-standerttiid", "AMST": "Amazone-simmertiid", "AMT": "Amazone-standerttiid", "ARST": "Argentynske simmertiid", "ART": "Argentynske standerttiid", "AST": "Atlantic-standerttiid", "AWDT": "West-Australyske simmertiid", "AWST": "West-Australyske standerttiid", "BNT": "Bruneise tiid", "BOT": "Boliviaanske tiid", "BRST": "Brazyljaanske simmertiid", "BRT": "Brazyljaanske standerttiid", "BST": "Bengalese simmertiid", "BTT": "Bhutaanske tiid", "CAT": "Sintraal-Afrikaanske tiid", "CCT": "Kokoseilânske tiid", "CDT": "Central-simmertiid", "CDT (Kuba)": "Kubaanske simmertiid", "CHADT": "Chatham simmertiid", "CHAST": "Chatham standerttiid", "CLST": "Sileenske simmertiid", "CLT": "Sileenske standerttiid", "COST": "Kolombiaanske simmertiid", "COT": "Kolombiaanske standerttiid", "CST": "Central-standerttiid", "CST (Kuba)": "Kubaanske standerttiid", "CXT": "Krysteilânske tiid", "ChST": "Chamorro-tiid", "EASST": "Peaskeeilânske simmertiid", "EAST": "Peaskeeilânske standerttiid", "EAT": "East-Afrikaanske tiid", "ECT": "Ecuadoraanske tiid", "EDT": "Eastern-simmertiid", "EGDT": "East-Groenlânske simmertiid", "EGST": "East-Groenlânske standerttiid", "EST": "Eastern-standerttiid", "FKST": "Falklâneilânske simmertiid", "GALT": "Galapagoseilânske tiid", "GFT": "Frâns-Guyaanske tiid", "GMT": "Greenwich Mean Time", "GST": "Golf standerttiid", "GYT": "Guyaanske tiid", "HADT": "Hawaii-Aleoetyske simmertiid", "HAST": "Hawaii-Aleoetyske standerttiid", "HENOMX": "HENOMX", "HEOG": "West-Groenlânske simmertiid", "HEPMX": "HEPMX", "HKST": "Hongkongse simmertiid", "HKT": "Hongkongse standerttiid", "HNNOMX": "HNNOMX", "HNOG": "West-Groenlânske standerttiid", "HNPMX": "HNPMX", "ICT": "Yndochinese tiid", "IRDT": "Iraanske simmertiid", "IRST": "Iraanske standerttiid", "IST": "Yndiaaske tiid", "JDT": "Japanske simmertiid", "JST": "Japanske standerttiid", "LHDT": "Lord Howe-eilânske simmertiid", "LHST": "Lord Howe-eilânske standerttiid", "MDT": "Mountain-simmertiid", "MESZ": "Midden-Europeeske simmertiid", "MEZ": "Midden-Europeeske standerttiid", "MST": "Mountain-standerttiid", "MVT": "Maldivyske tiid", "MYT": "Maleisyske tiid", "NDT": "Newfoundlânske-simmertiid", "NPT": "Nepalese tiid", "NST": "Newfoundlânske-standerttiid", "NZDT": "Nij-Seelânske simmertiid", "NZST": "Nij-Seelânske standerttiid", "OESZ": "East-Europeeske simmertiid", "OEZ": "East-Europeeske standerttiid", "PDT": "Pasifik-simmertiid", "PKT": "Pakistaanske simmertiid", "PMDT": "Saint Pierre en Miquelon-simmertiid", "PMST": "Saint Pierre en Miquelon-standerttiid", "PST": "Pasifik-standerttiid", "PYST": "Paraguayaanske simmertiid", "SAST": "Sûd-Afrikaanske tiid", "SGT": "Singaporese standerttiid", "SRT": "Surinaamske tiid", "TLT": "East-Timorese tiid", "TMST": "Turkmeense simmertiid", "TMT": "Turkmeense standerttiid", "UYST": "Uruguayaanske simmertiid", "UYT": "Uruguayaanske standerttiid", "VET": "Fenezolaanske tiid", "WARST": "West-Argentynske simmertiid", "WART": "West-Argentynske standerttiid", "WAST": "West-Afrikaanske simmertiid", "WAT": "West-Afrikaanske standerttiid", "WESZ": "West-Europeeske simmertiid", "WEZ": "West-Europeeske standerttiid", "WIB": "West-Yndonezyske tiid", "WIT": "East-Yndonezyske tiid", "WITA": "Sintraal-Yndonezyske tiid", "∅∅∅": "Azoren-simmertiid"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} en {1}", "{0}, {1}", "{0}, {1}", "{0} en {1}"}, []string(nil)}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"", "%v jr", "%v jr", ""},
				Long:   &locales.CounterFormat{"jier", "%v jier", "%v jier", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v m", "%v m", ""},
				Long:   &locales.CounterFormat{"moanneen", "%v moanne", "%v moanneen", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v w", "%v w", ""},
				Long:   &locales.CounterFormat{"wiken", "%v wike", "%v wiken", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v d", "%v d", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v u", "%v u", ""},
				Long:   &locales.CounterFormat{"oere", "%v oere", "%v oere", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v m", "%v m", ""},
				Long:   &locales.CounterFormat{"minuten", "%v minút", "%v minuten", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v s", "%v s", ""},
				Long:   &locales.CounterFormat{"sekonden", "%v sekonde", "%v sekonden", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"millisekonden", "%v millisekonde", "%v millisekonden", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
		miscPatterns: locales.MiscPatterns{
...
func (fy *fy) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(fy, fy.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'fy'
func (fy *fy) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(fy, fy.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'fy'
func (fy *fy) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(fy, fy.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'fy'
func (fy *fy) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(fy, fy.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'fy'
func (fy *fy) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(fy, fy.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'fy'
func (fy *fy) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(fy, fy.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'fy'
func (fy *fy) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(fy, fy.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'fy'
func (fy *fy) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(fy, fy.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'fy'
func (fy *fy) DateFullLayout() string {
	return fy.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fy'
func (fy *fy) DateLongLayout() string {
	return fy.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fy'
func (fy *fy) DateMediumLayout() string {
	return fy.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fy'
func (fy *fy) DateShortLayout() string {
	return fy.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fy'
func (fy *fy) TimeFullLayout() string {
	return fy.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fy'
func (fy *fy) TimeLongLayout() string {
	return fy.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fy'
func (fy *fy) TimeMediumLayout() string {
	return fy.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fy'
func (fy *fy) TimeShortLayout() string {
	return fy.timeShortLayout
}

func (fy *fy) ListPatterns() *locales.ListPatterns {
	return fy.listPatterns
}

func (fy *fy) GetDurationSpec() *locales.DurationSpec {
	return fy.DurationSpec
}

func (fy *fy) GetMiscPatterns() *locales.MiscPatterns {
	return &fy.miscPatterns
}
