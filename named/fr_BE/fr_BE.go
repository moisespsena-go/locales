...
func New() locales.Translator {
	return &fr_BE{
		...
		timeFullLayout:   "H 'h' mm 'min' ss 's' zzzz",
...
// DateFullLayout returns the full date layout for 'fr_BE'
func (fr *fr_BE) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_BE'
func (fr *fr_BE) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_BE'
func (fr *fr_BE) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_BE'
func (fr *fr_BE) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_BE'
func (fr *fr_BE) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_BE'
func (fr *fr_BE) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_BE'
func (fr *fr_BE) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_BE'
func (fr *fr_BE) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_BE) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_BE) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_BE) GetMiscPatterns() *locales.MiscPatterns {
