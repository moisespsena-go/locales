...
// DateFullLayout returns the full date layout for 'en_CC'
func (en *en_CC) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_CC'
func (en *en_CC) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_CC'
func (en *en_CC) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_CC'
func (en *en_CC) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_CC'
func (en *en_CC) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_CC'
func (en *en_CC) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_CC'
func (en *en_CC) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_CC'
func (en *en_CC) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_CC) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_CC) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_CC) GetMiscPatterns() *locales.MiscPatterns {
