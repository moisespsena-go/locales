...
// DateFullLayout returns the full date layout for 'en_KY'
func (en *en_KY) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_KY'
func (en *en_KY) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_KY'
func (en *en_KY) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_KY'
func (en *en_KY) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_KY'
func (en *en_KY) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_KY'
func (en *en_KY) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_KY'
func (en *en_KY) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_KY'
func (en *en_KY) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_KY) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_KY) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_KY) GetMiscPatterns() *locales.MiscPatterns {
