...
// DateFullLayout returns the full date layout for 'dav'
func (dav *dav) DateFullLayout() string {
	return dav.dateFullLayout
}

// DateLongLayout returns the long date layout for 'dav'
func (dav *dav) DateLongLayout() string {
	return dav.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'dav'
func (dav *dav) DateMediumLayout() string {
	return dav.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'dav'
func (dav *dav) DateShortLayout() string {
	return dav.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'dav'
func (dav *dav) TimeFullLayout() string {
	return dav.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'dav'
func (dav *dav) TimeLongLayout() string {
	return dav.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'dav'
func (dav *dav) TimeMediumLayout() string {
	return dav.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'dav'
func (dav *dav) TimeShortLayout() string {
	return dav.timeShortLayout
}

func (dav *dav) ListPatterns() *locales.ListPatterns {
	return dav.listPatterns
}

func (dav *dav) GetDurationSpec() *locales.DurationSpec {
	return dav.DurationSpec
}

func (dav *dav) GetMiscPatterns() *locales.MiscPatterns {
