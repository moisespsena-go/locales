...
// DateFullLayout returns the full date layout for 'en_MO'
func (en *en_MO) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_MO'
func (en *en_MO) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_MO'
func (en *en_MO) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_MO'
func (en *en_MO) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_MO'
func (en *en_MO) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_MO'
func (en *en_MO) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_MO'
func (en *en_MO) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_MO'
func (en *en_MO) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_MO) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_MO) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_MO) GetMiscPatterns() *locales.MiscPatterns {
