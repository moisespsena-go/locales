...
// DateFullLayout returns the full date layout for 'bez'
func (bez *bez) DateFullLayout() string {
	return bez.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bez'
func (bez *bez) DateLongLayout() string {
	return bez.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bez'
func (bez *bez) DateMediumLayout() string {
	return bez.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bez'
func (bez *bez) DateShortLayout() string {
	return bez.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bez'
func (bez *bez) TimeFullLayout() string {
	return bez.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bez'
func (bez *bez) TimeLongLayout() string {
	return bez.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bez'
func (bez *bez) TimeMediumLayout() string {
	return bez.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bez'
func (bez *bez) TimeShortLayout() string {
	return bez.timeShortLayout
}

func (bez *bez) ListPatterns() *locales.ListPatterns {
	return bez.listPatterns
}

func (bez *bez) GetDurationSpec() *locales.DurationSpec {
	return bez.DurationSpec
}

func (bez *bez) GetMiscPatterns() *locales.MiscPatterns {
