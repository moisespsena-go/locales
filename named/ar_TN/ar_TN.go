...
func New() locales.Translator {
	return &ar_TN{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "جانفي", "فيفري", "أفريل", "ماي", "جوان", "جويلية", "أوت"},
			MonthsNarrowValue:        []string{"", "ج", "م", "ج", "ج", "أ", "أ", "ن"},
			MonthsWideValue:          []string{"", "جانفي", "فيفري", "أفريل", "ماي", "جوان", "جويلية", "أوت"},
...
// DateFullLayout returns the full date layout for 'ar_TN'
func (ar *ar_TN) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_TN'
func (ar *ar_TN) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_TN'
func (ar *ar_TN) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_TN'
func (ar *ar_TN) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_TN'
func (ar *ar_TN) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_TN'
func (ar *ar_TN) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_TN'
func (ar *ar_TN) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_TN'
func (ar *ar_TN) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_TN) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_TN) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_TN) GetMiscPatterns() *locales.MiscPatterns {
