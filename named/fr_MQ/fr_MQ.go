...
// DateFullLayout returns the full date layout for 'fr_MQ'
func (fr *fr_MQ) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_MQ'
func (fr *fr_MQ) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_MQ'
func (fr *fr_MQ) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_MQ'
func (fr *fr_MQ) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_MQ'
func (fr *fr_MQ) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_MQ'
func (fr *fr_MQ) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_MQ'
func (fr *fr_MQ) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_MQ'
func (fr *fr_MQ) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_MQ) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_MQ) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_MQ) GetMiscPatterns() *locales.MiscPatterns {
