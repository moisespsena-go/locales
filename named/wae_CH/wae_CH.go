...
// DateFullLayout returns the full date layout for 'wae_CH'
func (wae *wae_CH) DateFullLayout() string {
	return wae.dateFullLayout
}

// DateLongLayout returns the long date layout for 'wae_CH'
func (wae *wae_CH) DateLongLayout() string {
	return wae.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'wae_CH'
func (wae *wae_CH) DateMediumLayout() string {
	return wae.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'wae_CH'
func (wae *wae_CH) DateShortLayout() string {
	return wae.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'wae_CH'
func (wae *wae_CH) TimeFullLayout() string {
	return wae.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'wae_CH'
func (wae *wae_CH) TimeLongLayout() string {
	return wae.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'wae_CH'
func (wae *wae_CH) TimeMediumLayout() string {
	return wae.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'wae_CH'
func (wae *wae_CH) TimeShortLayout() string {
	return wae.timeShortLayout
}

func (wae *wae_CH) ListPatterns() *locales.ListPatterns {
	return wae.listPatterns
}

func (wae *wae_CH) GetDurationSpec() *locales.DurationSpec {
	return wae.DurationSpec
}

func (wae *wae_CH) GetMiscPatterns() *locales.MiscPatterns {
