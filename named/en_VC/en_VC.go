...
// DateFullLayout returns the full date layout for 'en_VC'
func (en *en_VC) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_VC'
func (en *en_VC) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_VC'
func (en *en_VC) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_VC'
func (en *en_VC) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_VC'
func (en *en_VC) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_VC'
func (en *en_VC) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_VC'
func (en *en_VC) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_VC'
func (en *en_VC) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_VC) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_VC) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_VC) GetMiscPatterns() *locales.MiscPatterns {
