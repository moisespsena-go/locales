...
// DateFullLayout returns the full date layout for 'de_DE'
func (de *de_DE) DateFullLayout() string {
	return de.dateFullLayout
}

// DateLongLayout returns the long date layout for 'de_DE'
func (de *de_DE) DateLongLayout() string {
	return de.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'de_DE'
func (de *de_DE) DateMediumLayout() string {
	return de.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'de_DE'
func (de *de_DE) DateShortLayout() string {
	return de.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'de_DE'
func (de *de_DE) TimeFullLayout() string {
	return de.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'de_DE'
func (de *de_DE) TimeLongLayout() string {
	return de.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'de_DE'
func (de *de_DE) TimeMediumLayout() string {
	return de.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'de_DE'
func (de *de_DE) TimeShortLayout() string {
	return de.timeShortLayout
}

func (de *de_DE) ListPatterns() *locales.ListPatterns {
	return de.listPatterns
}

func (de *de_DE) GetDurationSpec() *locales.DurationSpec {
	return de.DurationSpec
}

func (de *de_DE) GetMiscPatterns() *locales.MiscPatterns {
