...
func New() locales.Translator {
	return &fil{
		...
		TimeSpec: &locales.TimeSpec{
			...
			MonthsNarrowValue:        []string{"", "Ene", "Peb", "Mar", "Abr", "May", "Hun", "Hul", "Ago", "Set", "Okt", "Nob", "Dis"},
			MonthsWideValue:          []string{"", "Enero", "Pebrero", "Marso", "Abril", "Mayo", "Hunyo", "Hulyo", "Agosto", "Setyembre", "Oktubre", "Nobyembre", "Disyembre"},
			WeekdaysAbbreviatedValue: []string{"Lin", "Lun", "Mar", "Miy", "Huw", "Biy", "Sab"},
			WeekdaysNarrowValue:      []string{"Lin", "Lun", "Mar", "Miy", "Huw", "Biy", "Sab"},
			WeekdaysShortValue:       []string{"Li", "Lu", "Ma", "Mi", "Hu", "Bi", "Sa"},
			WeekdaysWideValue:        []string{"Linggo", "Lunes", "Martes", "Miyerkules", "Huwebes", "Biyernes", "Sabado"},
			...
			TimezonesValue:           map[string]string{"": "Standard na Oras sa Falkland Islands", "ACDT": "Daylight Time sa Gitnang Australya", "ACST": "ACST", "ACT": "ACT", "ACWDT": "Daylight Time sa Gitnang Kanlurang Australya", "ACWST": "Standard Time ng Gitnang Kanluran ng Australya", "ADT": "Daylight Time sa Atlantiko", "AEDT": "Daylight Time sa Silangang Australya", "AEST": "Standard na Oras sa Silangang Australya", "AFT": "Oras sa Afghanistan", "AKDT": "Daylight Time sa Alaska", "AKST": "Standard na Oras sa Alaska", "AMST": "Oras sa Tag-init ng Amazon", "AMT": "Standard na Oras sa Amazon", "ARST": "Oras sa Tag-init ng Argentina", "ART": "Standard na Oras sa Argentina", "AST": "Standard na Oras sa Atlantiko", "AWDT": "Daylight Time sa Kanlurang Australya", "AWST": "Standard na Oras sa Kanlurang Australya", "BNT": "Oras sa Brunei Darussalam", "BOT": "Oras sa Bolivia", "BRST": "Oras sa Tag-init ng Brasilia", "BRT": "Standard na Oras sa Brasilia", "BST": "Oras sa Tag-init ng Bangladesh", "BTT": "Oras sa Bhutan", "CAT": "Oras sa Gitnang Africa", "CCT": "Oras sa Cocos Islands", "CDT": "Sentral na Daylight Time", "CDT (Kuba)": "Daylight Time sa Cuba", "CHADT": "Daylight Time sa Chatham", "CHAST": "Standard na Oras sa Chatham", "CLST": "Oras sa Tag-init ng Chile", "CLT": "Standard na Oras sa Chile", "COST": "Oras sa Tag-init ng Colombia", "COT": "Standard na Oras sa Colombia", "CST": "Sentral na Standard na Oras", "CST (Kuba)": "Standard na Oras sa Cuba", "CXT": "Oras sa Christmas Island", "ChST": "Standard na Oras sa Chamorro", "EASST": "Oras sa Tag-init ng Easter Island", "EAST": "Standard na Oras sa Easter Island", "EAT": "Oras sa Silangang Africa", "ECT": "Oras sa Ecuador", "EDT": "Eastern Daylight Time", "EGDT": "Oras sa Tag-init ng Silangang Greenland", "EGST": "Standard na Oras sa Silangang Greenland", "EST": "Eastern na Standard na Oras", "FKST": "Oras sa Tag-init ng Falkland Islands", "GALT": "Oras sa Galapagos", "GFT": "Oras sa French Guiana", "GMT": "Greenwich Mean Time", "GST": "Oras sa Gulf", "GYT": "Oras sa Guyana", "HADT": "Oras sa Tag-init ng Hawaii-Aleutian", "HAST": "Standard na Oras sa Hawaii-Aleutian", "HENOMX": "Daylight Time sa Hilagang-kanlurang Mexico", "HEOG": "Oras sa Tag-init ng Kanlurang Greenland", "HEPMX": "Daylight Time sa Pasipiko ng Mexico", "HKST": "Oras sa Tag-init ng Hong Kong", "HKT": "Standard na Oras sa Hong Kong", "HNNOMX": "Standard na Oras sa Hilagang-kanlurang Mexico", "HNOG": "Standard na Oras sa Kanlurang Greenland", "HNPMX": "Standard na Oras sa Pasipiko ng Mexico", "ICT": "Oras sa Indochina", "IRDT": "Daylight Time sa Iran", "IRST": "Standard na Oras sa Iran", "IST": "Standard na Oras sa India", "JDT": "Daylight Time sa Japan", "JST": "Standard na Oras sa Japan", "LHDT": "Daylight Time sa Lorde Howe", "LHST": "Standard na Oras sa Lord Howe", "MDT": "MDT", "MESZ": "Oras sa Tag-init ng Gitnang Europe", "MEZ": "Standard na Oras sa Gitnang Europe", "MST": "MST", "MVT": "Oras sa Maldives", "MYT": "Oras sa Malaysia", "NDT": "Daylight Time sa Newfoundland", "NPT": "Oras sa Nepal", "NST": "Standard na Oras sa Newfoundland", "NZDT": "Daylight Time sa New Zealand", "NZST": "Standard na Oras sa New Zealand", "OESZ": "Oras sa Tag-init ng Silangang Europe", "OEZ": "Standard na Oras sa Silangang Europe", "PDT": "Daylight Time sa Pasipiko", "PKT": "Oras sa Tag-init ng Pakistan", "PMDT": "Daylight Time sa Saint Pierre & Miquelon", "PMST": "Standard na Oras sa Saint Pierre & Miquelon", "PST": "Standard na Oras sa Pasipiko", "PYST": "Oras sa Tag-init ng Paraguay", "SAST": "Oras sa Timog Africa", "SGT": "Standard na Oras sa Singapore", "SRT": "Oras sa Suriname", "TLT": "Oras sa East Timor", "TMST": "Oras sa Tag-init ng Turkmenistan", "TMT": "Standard na Oras sa Turkmenistan", "UYST": "Oras sa Tag-init ng Uruguay", "UYT": "Standard na Oras sa Uruguay", "VET": "Oras sa Venezuela", "WARST": "Oras sa Tag-init ng Kanlurang Argentina", "WART": "Standard na Oras sa Kanlurang Argentina", "WAST": "Oras sa Tag-init ng Kanlurang Africa", "WAT": "Standard na Oras sa Kanlurang Africa", "WESZ": "Oras sa Tag-init ng Kanlurang Europe", "WEZ": "Standard na Oras sa Kanlurang Europe", "WIB": "Oras sa Kanlurang Indonesia", "WIT": "Oras sa Silangang Indonesia", "WITA": "Oras sa Gitnang Indonesia", "∅∅∅": "Oras sa Tag-init ng Peru"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} at {1}", "{0}, {1}", "{0}, {1}", "{0}, at {1}"}, {"{0} o {1}", "{0}, {1}", "{0}, {1}", "{0}, o {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"siglo", "%v siglo", "%v siglo", ""},
				Long:   &locales.CounterFormat{"mga siglo", "%v siglo", "%v siglo", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dec", "%v dec", "%v dec", ""},
				Long:   &locales.CounterFormat{"dekada", "%v dekada", "%v dekada", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"taon", "%vtaon", "%vtaon", "%v/taon"},
				Long:   &locales.CounterFormat{"mga taon", "%v taon", "%v na taon", "%v kada taon"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"buwan", "%vbuwan", "%v buwan", ""},
				Long:   &locales.CounterFormat{"mga buwan", "%v buwan", "%v buwan", "%v kada buwan"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"linggo", "%vlinggo", "%vlinggo", "%v/linggo"},
				Long:   &locales.CounterFormat{"mga linggo", "%v linggo", "%v na linggo", "%v kada linggo"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"araw", "%v araw", "%v na araw", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"oras", "%v oras", "%v oras", ""},
				Long:   &locales.CounterFormat{"mga oras", "%v oras", "%v na oras", "%v kada oras"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min.", "%vm", "%vm", "%v/min"},
				Long:   &locales.CounterFormat{"mga minuto", "%v minuto", "%v na minuto", "%v kada minuto"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"seg.", "%vs", "%vs", "%v/s"},
				Long:   &locales.CounterFormat{"mga segundo", "%v segundo", "%v na segundo", "%v kada segundo"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mseg", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"milisegundo", "%v milisegundo", "%v milisegundo", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μseg", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"mikrosegundo", "%v mikrosegundo", "%v mikrosegundo", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"nanoseg", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosegundo", "%v nanosegundo", "%v nanosegundo", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"",
			"%[1]v+",
...
func (fil *fil) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(fil, fil.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'fil'
func (fil *fil) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(fil, fil.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'fil'
func (fil *fil) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(fil, fil.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'fil'
func (fil *fil) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(fil, fil.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'fil'
func (fil *fil) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(fil, fil.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'fil'
func (fil *fil) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(fil, fil.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'fil'
func (fil *fil) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(fil, fil.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'fil'
func (fil *fil) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(fil, fil.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'fil'
func (fil *fil) DateFullLayout() string {
	return fil.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fil'
func (fil *fil) DateLongLayout() string {
	return fil.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fil'
func (fil *fil) DateMediumLayout() string {
	return fil.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fil'
func (fil *fil) DateShortLayout() string {
	return fil.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fil'
func (fil *fil) TimeFullLayout() string {
	return fil.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fil'
func (fil *fil) TimeLongLayout() string {
	return fil.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fil'
func (fil *fil) TimeMediumLayout() string {
	return fil.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fil'
func (fil *fil) TimeShortLayout() string {
	return fil.timeShortLayout
}

func (fil *fil) ListPatterns() *locales.ListPatterns {
	return fil.listPatterns
}

func (fil *fil) GetDurationSpec() *locales.DurationSpec {
	return fil.DurationSpec
}

func (fil *fil) GetMiscPatterns() *locales.MiscPatterns {
	return &fil.miscPatterns
}
