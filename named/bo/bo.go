...
// DateFullLayout returns the full date layout for 'bo'
func (bo *bo) DateFullLayout() string {
	return bo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bo'
func (bo *bo) DateLongLayout() string {
	return bo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bo'
func (bo *bo) DateMediumLayout() string {
	return bo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bo'
func (bo *bo) DateShortLayout() string {
	return bo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bo'
func (bo *bo) TimeFullLayout() string {
	return bo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bo'
func (bo *bo) TimeLongLayout() string {
	return bo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bo'
func (bo *bo) TimeMediumLayout() string {
	return bo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bo'
func (bo *bo) TimeShortLayout() string {
	return bo.timeShortLayout
}

func (bo *bo) ListPatterns() *locales.ListPatterns {
	return bo.listPatterns
}

func (bo *bo) GetDurationSpec() *locales.DurationSpec {
	return bo.DurationSpec
}

func (bo *bo) GetMiscPatterns() *locales.MiscPatterns {
