...
// New returns a new instance of translator for the 'ff_Adlm_GM' locale
...
func (ff *ff_Adlm_GM) Locale() string {
	return ff.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) PluralsCardinal() []locales.PluralRule {
	return ff.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) PluralsOrdinal() []locales.PluralRule {
	return ff.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) PluralsRange() []locales.PluralRule {
	return ff.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// FmtDateShort returns the short date representation of 't' for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ff, ff.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ff, ff.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ff, ff.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ff, ff.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ff, ff.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ff, ff.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ff, ff.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ff, ff.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff_Adlm_GM'
func (ff *ff_Adlm_GM) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff_Adlm_GM) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff_Adlm_GM) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff_Adlm_GM) GetMiscPatterns() *locales.MiscPatterns {
