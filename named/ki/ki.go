...
// DateFullLayout returns the full date layout for 'ki'
func (ki *ki) DateFullLayout() string {
	return ki.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ki'
func (ki *ki) DateLongLayout() string {
	return ki.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ki'
func (ki *ki) DateMediumLayout() string {
	return ki.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ki'
func (ki *ki) DateShortLayout() string {
	return ki.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ki'
func (ki *ki) TimeFullLayout() string {
	return ki.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ki'
func (ki *ki) TimeLongLayout() string {
	return ki.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ki'
func (ki *ki) TimeMediumLayout() string {
	return ki.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ki'
func (ki *ki) TimeShortLayout() string {
	return ki.timeShortLayout
}

func (ki *ki) ListPatterns() *locales.ListPatterns {
	return ki.listPatterns
}

func (ki *ki) GetDurationSpec() *locales.DurationSpec {
	return ki.DurationSpec
}

func (ki *ki) GetMiscPatterns() *locales.MiscPatterns {
