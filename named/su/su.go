...
// New returns a new instance of translator for the 'su' locale
func New() locales.Translator {
	return &su{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ".",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Péb", "Mar", "Apr", "Méi", "Jun", "Jul", "Ags", "Sép", "Okt", "Nop", "Dés"},
			MonthsNarrowValue:        []string{"", "J", "P", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Januari", "Pébruari", "Maret", "April", "Méi", "Juni", "Juli", "Agustus", "Séptémber", "Oktober", "Nopémber", "Désémber"},
			WeekdaysAbbreviatedValue: []string{"Mng", "Sen", "Sal", "Reb", "Kem", "Jum", "Sap"},
			WeekdaysNarrowValue:      []string{"M", "S", "S", "R", "K", "J", "S"},
			WeekdaysWideValue:        []string{"Minggu", "Senén", "Salasa", "Rebo", "Kemis", "Jumaah", "Saptu"},
			ErasAbbreviatedValue:     []string{"SM", "M"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"", ""},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "Waktu Usum Panas Atlantik", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "Waktu Standar Atlantik", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "CAT", "CCT": "CCT", "CDT": "Waktu Usum Panas Tengah", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "Waktu Usum Panas Kolombia", "COT": "Waktu Standar Kolombia", "CST": "Waktu Standar Tengah", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "EAT", "ECT": "ECT", "EDT": "Waktu Usum Panas Wétan", "EGDT": "EGDT", "EGST": "EGST", "EST": "Waktu Standar Wétan", "FKST": "FKST", "GALT": "Waktu Galapagos", "GFT": "GFT", "GMT": "Waktu Greenwich", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "Waktu Usum Panas Éropa Tengah", "MEZ": "Waktu Standar Éropa Tengah", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "Waktu Usum Panas Éropa Timur", "OEZ": "Waktu Standar Éropa Timur", "PDT": "Waktu Usum Panas Pasifik", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "Waktu Standar Pasifik", "PYST": "PYST", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "Waktu Usum Panas Éropa Barat", "WEZ": "Waktu Standar Éropa Barat", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} sareng {1}", "{0}, {1}", "{0}, {1}", "{0}, sareng {1}"}, []string(nil)}),
...
func (su *su) Locale() string {
	return su.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'su'
func (su *su) PluralsCardinal() []locales.PluralRule {
	return su.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'su'
func (su *su) PluralsOrdinal() []locales.PluralRule {
	return su.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'su'
func (su *su) PluralsRange() []locales.PluralRule {
	return su.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'su'
func (su *su) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleOther
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'su'
func (su *su) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'su'
func (su *su) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// FmtDateShort returns the short date representation of 't' for 'su'
func (su *su) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(su, su.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'su'
func (su *su) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(su, su.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'su'
func (su *su) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(su, su.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'su'
func (su *su) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(su, su.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'su'
func (su *su) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(su, su.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'su'
func (su *su) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(su, su.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'su'
func (su *su) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(su, su.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'su'
func (su *su) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(su, su.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'su'
func (su *su) DateFullLayout() string {
	return su.dateFullLayout
}

// DateLongLayout returns the long date layout for 'su'
func (su *su) DateLongLayout() string {
	return su.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'su'
func (su *su) DateMediumLayout() string {
	return su.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'su'
func (su *su) DateShortLayout() string {
	return su.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'su'
func (su *su) TimeFullLayout() string {
	return su.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'su'
func (su *su) TimeLongLayout() string {
	return su.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'su'
func (su *su) TimeMediumLayout() string {
	return su.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'su'
func (su *su) TimeShortLayout() string {
	return su.timeShortLayout
}

func (su *su) ListPatterns() *locales.ListPatterns {
	return su.listPatterns
}

func (su *su) GetDurationSpec() *locales.DurationSpec {
	return su.DurationSpec
}

func (su *su) GetMiscPatterns() *locales.MiscPatterns {
	return &su.miscPatterns
}
