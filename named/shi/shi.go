...
// DateFullLayout returns the full date layout for 'shi'
func (shi *shi) DateFullLayout() string {
	return shi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'shi'
func (shi *shi) DateLongLayout() string {
	return shi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'shi'
func (shi *shi) DateMediumLayout() string {
	return shi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'shi'
func (shi *shi) DateShortLayout() string {
	return shi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'shi'
func (shi *shi) TimeFullLayout() string {
	return shi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'shi'
func (shi *shi) TimeLongLayout() string {
	return shi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'shi'
func (shi *shi) TimeMediumLayout() string {
	return shi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'shi'
func (shi *shi) TimeShortLayout() string {
	return shi.timeShortLayout
}

func (shi *shi) ListPatterns() *locales.ListPatterns {
	return shi.listPatterns
}

func (shi *shi) GetDurationSpec() *locales.DurationSpec {
	return shi.DurationSpec
}

func (shi *shi) GetMiscPatterns() *locales.MiscPatterns {
