	...
	return &sw{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ elfu0"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ elfu0"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ elfu00;¤elfu -00"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ elfu00;¤elfu -00"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ laki000;¤laki -000"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ laki000;¤laki -000"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 0M;¤-0M"),
						...
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 00M;¤M-00M"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 00M;¤-00M"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 000M;¤Milioni-000"),
						...
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 0B;¤-0B"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 0B;¤-0B"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 00B;¤-00B"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 00B;¤-00B"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 000B;¤-000B"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 000B;¤-000B"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 0T;¤-0T"),
						...
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 00T;¤-00T"),
						...
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 000T;¤-000T"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 000T;¤-000T"),
						}},
					},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"karne", "karne %v", "karne %v", ""},
				Long:   &locales.CounterFormat{"karne", "karne %v", "karne %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"miongo", "mwongo %v", "miongo %v", ""},
				Long:   &locales.CounterFormat{"miongo", "mwongo %v", "miongo %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mwaka", "mwaka %v", "miaka %v", ""},
				Long:   &locales.CounterFormat{"miaka", "mwaka %v", "miaka %v", "%v kwa mwaka"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mwezi", "mwezi %v", "miezi %v", ""},
				Long:   &locales.CounterFormat{"miezi", "mwezi %v", "miezi %v", "%v kwa mwezi"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"wiki", "wiki %v", "wiki %v", ""},
				Long:   &locales.CounterFormat{"wiki", "wiki %v", "wiki %v", "%v kwa wiki"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"siku", "siku %v", "siku %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"saa", "saa %v", "saa %v", ""},
				Long:   &locales.CounterFormat{"saa", "saa %v", "saa %v", "%v kwa saa"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dakika", "dak %v", "dak %v", ""},
				Long:   &locales.CounterFormat{"dakika", "dakika %v", "dakika %v", "%v kwa kila dakika"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sekunde", "sek %v", "sek %v", ""},
				Long:   &locales.CounterFormat{"sekunde", "sekunde %v", "sekunde %v", "%v kwa kila sekunde"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"millisekunde", "ms %v", "ms %v", ""},
				Long:   &locales.CounterFormat{"millisekunde", "millisekunde %v", "millisekunde %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mikrosekunde", "mikrosekunde %v", "mikrosekunde %v", ""},
				Long:   &locales.CounterFormat{"mikrosekunde", "mikrosekunde %v", "mikrosekunde %v", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"nanosekunde", "nanosekunde %v", "nanosekunde %v", ""},
				Long:   &locales.CounterFormat{"nanosekunde", "nanosekunde %v", "nanosekunde %v", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
// DateFullLayout returns the full date layout for 'sw'
func (sw *sw) DateFullLayout() string {
	return sw.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sw'
func (sw *sw) DateLongLayout() string {
	return sw.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sw'
func (sw *sw) DateMediumLayout() string {
	return sw.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sw'
func (sw *sw) DateShortLayout() string {
	return sw.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sw'
func (sw *sw) TimeFullLayout() string {
	return sw.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sw'
func (sw *sw) TimeLongLayout() string {
	return sw.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sw'
func (sw *sw) TimeMediumLayout() string {
	return sw.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sw'
func (sw *sw) TimeShortLayout() string {
	return sw.timeShortLayout
}

func (sw *sw) ListPatterns() *locales.ListPatterns {
	return sw.listPatterns
}

func (sw *sw) GetDurationSpec() *locales.DurationSpec {
	return sw.DurationSpec
}

func (sw *sw) GetMiscPatterns() *locales.MiscPatterns {
