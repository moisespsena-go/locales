...
// DateFullLayout returns the full date layout for 'fr_BL'
func (fr *fr_BL) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_BL'
func (fr *fr_BL) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_BL'
func (fr *fr_BL) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_BL'
func (fr *fr_BL) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_BL'
func (fr *fr_BL) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_BL'
func (fr *fr_BL) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_BL'
func (fr *fr_BL) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_BL'
func (fr *fr_BL) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_BL) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_BL) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_BL) GetMiscPatterns() *locales.MiscPatterns {
