...
func New() locales.Translator {
	return &my_MM{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 0ထောင်"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 0သောင်း"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 0သိန်း"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 0သန်း"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 0ကုဋေ"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 00ကုဋေ"),
						}},
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ ကုဋေ000"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ ကုဋေ0000"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ ကုဋေ0သောင်း"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ ကုဋေ0သိန်း"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ ကုဋေ0သန်း"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 0ကောဋိ"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "ဇန်", "ဖေ", "မတ်", "ဧ", "မေ", "ဇွန်", "ဇူ", "ဩ", "စက်", "အောက်", "နို", "ဒီ"},
			MonthsNarrowValue:        []string{"", "ဇ", "ဖ", "မ", "ဧ", "မ", "ဇ", "ဇ", "ဩ", "စ", "အ", "န", "ဒ"},
			MonthsWideValue:          []string{"", "ဇန်နဝါရီ", "ဖေဖော်ဝါရီ", "မတ်", "ဧပြီ", "မေ", "ဇွန်", "ဇူလိုင်", "ဩဂုတ်", "စက်တင်ဘာ", "အောက်တိုဘာ", "နိုဝင်ဘာ", "ဒီဇင်ဘာ"},
			WeekdaysAbbreviatedValue: []string{"တနင်္ဂနွေ", "တနင်္လာ", "အင်္ဂါ", "ဗုဒ္ဓဟူး", "ကြာသပတေး", "သောကြာ", "စနေ"},
			WeekdaysNarrowValue:      []string{"တ", "တ", "အ", "ဗ", "က", "သ", "စ"},
			WeekdaysShortValue:       []string{"တနင်္ဂနွေ", "တနင်္လာ", "အင်္ဂါ", "ဗုဒ္ဓဟူး", "ကြာသပတေး", "သောကြာ", "စနေ"},
			WeekdaysWideValue:        []string{"တနင်္ဂနွေ", "တနင်္လာ", "အင်္ဂါ", "ဗုဒ္ဓဟူး", "ကြာသပတေး", "သောကြာ", "စနေ"},
			PeriodsAbbreviatedValue:  []string{"နံနက်", "ညနေ"},
			PeriodsNarrowValue:       []string{"နံနက်", "ညနေ"},
			PeriodsWideValue:         []string{"နံနက်", "ညနေ"},
			ErasAbbreviatedValue:     []string{"ဘီစီ", "အဒေီ"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"ခရစ်တော် မပေါ်မီနှစ်", "ခရစ်နှစ်"},
			TimezonesValue:           map[string]string{"": "ပါရာဂွေး စံတော်ချိန်", "ACDT": "ဩစတြေးလျ အလယ်ပိုင်း နွေရာသီ အချိန်", "ACST": "ဩစတြေးလျ အလယ်ပိုင်း စံတော်ချိန်", "ACT": "ACT", "ACWDT": "သြစတြေးလျား အနောက်အလယ်ပိုင်း နွေရာသီ အချိန်", "ACWST": "သြစတြေးလျား အနောက်အလယ်ပိုင်း စံတော်ချိန်", "ADT": "အတ္တလန်တစ် နွေရာသီ စံတော်ချိန်", "AEDT": "အရှေ့ဩစတြေးလျ နွေရာသီ အချိန်", "AEST": "အရှေ့ဩစတြေးလျ စံတော်ချိန်", "AFT": "အာဖဂန်နစ္စတန် အချိန်", "AKDT": "အလာစကာ နွေရာသီ စံတော်ချိန်", "AKST": "အလာစကာ စံတော်ချိန်", "AMST": "အမေဇုံ နွေရာသီအချိန်", "AMT": "အမေဇုံ စံတော်ချိန်", "ARST": "အာဂျင်တီးနား နွေရာသီအချိန်", "ART": "အာဂျင်တီးနား စံတော်ချိန်", "AST": "အတ္တလန်တစ် စံတော်ချိန်", "AWDT": "ဩစတြေးလျ နွေရာသီ အချိန်", "AWST": "အနောက်ဩစတြေးလျ စံတော်ချိန်", "BNT": "ဘရူနိုင်း စံတော်ချိန်", "BOT": "ဘိုလီးဘီးယား အချိန်", "BRST": "ဘရာဇီး နွေရာသီ အချိန်", "BRT": "ဘရာဇီး စံတော်ချိန်", "BST": "ဘင်္ဂလားဒေ့ရှ် နွေရာသီ အချိန်", "BTT": "ဘူတန် အချိန်", "CAT": "အလယ်အာဖရိက အချိန်", "CCT": "ကိုကိုးကျွန်း အချိန်", "CDT": "မြောက်အမေရိက အလယ်ပိုင်း နွေရာသီစံတော်ချိန်", "CDT (Kuba)": "ကျူးဘား နွေရာသီ စံတော်ချိန်", "CHADT": "ချာသမ် နွေရာသီ အချိန်", "CHAST": "ချားသမ်စံတော်ချိန်", "CLST": "ချီလီ နွေရာသီ အချိန်", "CLT": "ချီလီ စံတော်ချိန်", "COST": "ကိုလံဘီယာ နွေရာသီ အချိန်", "COT": "ကိုလံဘီယာ စံတော်ချိန်", "CST": "မြောက်အမေရိက အလယ်ပိုင်းစံတော်ချိန်", "CST (Kuba)": "ကျူးဘား စံတော်ချိန်", "CXT": "ခရစ်စမတ်ကျွန်း အချိန်", "ChST": "ချာမိုရို အချိန်", "EASST": "အီစတာကျွန်း နွေရာသီ အချိန်", "EAST": "အီစတာကျွန်း စံတော်ချိန်", "EAT": "အရှေ့အာဖရိက အချိန်", "ECT": "အီကွေဒေါ အချိန်", "EDT": "မြောက်အမေရိက အရှေ့ပိုင်း နွေရာသီစံတော်ချိန်", "EGDT": "အရှေ့ဂရင်းလန် နွေရာသီ စံတော်ချိန်", "EGST": "အရှေ့ဂရင်းလန်း စံတော်ချိန်", "EST": "မြောက်အမေရိက အရှေ့ပိုင်းစံတော်ချိန်", "FKST": "ဖော့ကလန်ကျွန်းစု နွေရာသီ အချိန်", "GALT": "ဂါလားပါဂိုးစ် အချိန်", "GFT": "ပြင်သစ် ဂီအားနား အချိန်", "GMT": "ဂရင်းနစ် စံတော်ချိန်", "GST": "ပင်လယ်ကွေ့ အချိန်", "GYT": "ဂိုင်ယာနာ အချိန်", "HADT": "ဟာဝိုင်ယီ အယ်လူးရှန်း နွေရာသီ စံတော်ချိန်", "HAST": "ဟာဝိုင်ယီ အယ်လူးရှန်း စံတော်ချိန်", "HENOMX": "အနောက်တောင် မက္ကစီကို နွေရာသီ စံတော်ချိန်", "HEOG": "အနောက် ဂရင်းလန် နွေရာသီ စံတော်ချိန်", "HEPMX": "မက္ကစီကန် ပစိဖိတ် နွေရာသီ စံတော်ချိန်", "HKST": "ဟောင်ကောင် နွေရာသီ အချိန်", "HKT": "ဟောင်ကောင် စံတော်ချိန်", "HNNOMX": "အနောက်တောင် မက္ကဆီကို စံတော်ချိန်", "HNOG": "အနောက် ဂရင်းလန်း စံတော်ချိန်", "HNPMX": "မက္ကဆီကန် ပစိဖိတ် စံတော်ချိန်", "ICT": "အင်ဒိုချိုင်းနား အချိန်", "IRDT": "အီရန် နွေရာသီ အချိန်", "IRST": "အီရန် စံတော်ချိန်", "IST": "အိန္ဒိယ စံတော်ချိန်", "JDT": "ဂျပန် နွေရာသီ အချိန်", "JST": "ဂျပန် စံတော်ချိန်", "LHDT": "လော့ဒ်ဟောင် နွေရာသီ အချိန်", "LHST": "လော့ဒ်ဟောင် စံတော်ချိန်", "MDT": "မြောက်အမေရိက တောင်တန်းဒေသ နွေရာသီစံတော်ချိန်", "MESZ": "ဥရောပအလယ်ပိုင်း နွေရာသီ အချိန်", "MEZ": "ဥရောပအလယ်ပိုင်း စံတော်ချိန်", "MST": "မြောက်အမေရိက တောင်တန်းဒေသစံတော်ချိန်", "MVT": "မော်လဒိုက် အချိန်", "MYT": "မလေးရှား အချိန်", "NDT": "နယူးဖောင်လန် နွေရာသီ စံတော်ချိန်", "NPT": "နီပေါ အချိန်", "NST": "နယူးဖောင်လန် စံတော်ချိန်", "NZDT": "နယူးဇီလန် နွေရာသီ အချိန်", "NZST": "နယူးဇီလန် စံတော်ချိန်", "OESZ": "အရှေ့ဥရောပ နွေရာသီ အချိန်", "OEZ": "အရှေ့ဥရောပ စံတော်ချိန်", "PDT": "မြောက်အမေရိက ပစိဖိတ် နွေရာသီစံတော်ချိန်", "PKT": "ပါကစ္စတန် နွေရာသီ အချိန်", "PMDT": "စိန့်ပီအဲနှင့် မီခွီလွန် နွေရာသီ စံတော်ချိန်", "PMST": "စိန့်ပီအဲနှင့်မီခွီလွန်စံတော်ချိန်", "PST": "မြောက်အမေရိက ပစိဖိတ်စံတော်ချိန်", "PYST": "ပါရာဂွေး နွေရာသီ အချိန်", "SAST": "တောင်အာဖရိက အချိန်", "SGT": "စင်္ကာပူ အချိန်", "SRT": "စူးရီနာမ်အချိန်", "TLT": "အရှေ့တီမော အချိန်", "TMST": "တာ့ခ်မင်နစ္စတန် နွေရာသီ အချိန်", "TMT": "တာ့ခ်မင်နစ္စတန် စံတော်ချိန်", "UYST": "ဥရုဂွေး နွေရာသီ အချိန်", "UYT": "ဥရုဂွေး စံတော်ချိန်", "VET": "ဗင်နီဇွဲလား အချိန်", "WARST": "အနောက် အာဂျင်တီးနား နွေရာသီ အချိန်", "WART": "အနောက် အာဂျင်တီးနား စံတော်ချိန်", "WAST": "အနောက်အာဖရိက နွေရာသီ အချိန်", "WAT": "အနောက်အာဖရိက စံတော်ချိန်", "WESZ": "အနောက်ဥရောပ နွေရာသီ အချိန်", "WEZ": "အနောက်ဥရောပ စံတော်ချိန်", "WIB": "အနောက်ပိုင်း အင်ဒိုနီးရှား အချိန်", "WIT": "အရှေ့ပိုင်း အင်ဒိုနီးရှား အချိန်", "WITA": "အလယ်ပိုင်း အင်ဒိုနီးရှား အချိန်", "∅∅∅": "ပီရူး နွေရာသီ အချိန်"},
		},
		...
		timeFullLayout:   "zzzz HH:mm:ss",
		timeLongLayout:   "z HH:mm:ss",
		timeMediumLayout: "H:mm:ss",
		timeShortLayout:  "H:mm",
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0}နှင့် {1}", "{0} - {1}", "{0} - {1}", "{0}နှင့် {1}"}, {"{0} သို့မဟုတ် {1}", "{0} - {1}", "{0} - {1}", "{0} သို့မဟုတ် {1}"}}),
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v နှင့်အထက်",
			"≤%[1]v",
...
func (my *my_MM) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(my, my.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'my_MM'
func (my *my_MM) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(my, my.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'my_MM'
func (my *my_MM) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(my, my.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'my_MM'
func (my *my_MM) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(my, my.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'my_MM'
func (my *my_MM) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(my, my.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'my_MM'
func (my *my_MM) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(my, my.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'my_MM'
func (my *my_MM) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(my, my.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'my_MM'
func (my *my_MM) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(my, my.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'my_MM'
func (my *my_MM) DateFullLayout() string {
	return my.dateFullLayout
}

// DateLongLayout returns the long date layout for 'my_MM'
func (my *my_MM) DateLongLayout() string {
	return my.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'my_MM'
func (my *my_MM) DateMediumLayout() string {
	return my.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'my_MM'
func (my *my_MM) DateShortLayout() string {
	return my.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'my_MM'
func (my *my_MM) TimeFullLayout() string {
	return my.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'my_MM'
func (my *my_MM) TimeLongLayout() string {
	return my.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'my_MM'
func (my *my_MM) TimeMediumLayout() string {
	return my.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'my_MM'
func (my *my_MM) TimeShortLayout() string {
	return my.timeShortLayout
}

func (my *my_MM) ListPatterns() *locales.ListPatterns {
	return my.listPatterns
}

func (my *my_MM) GetDurationSpec() *locales.DurationSpec {
	return my.DurationSpec
}

func (my *my_MM) GetMiscPatterns() *locales.MiscPatterns {
	return &my.miscPatterns
}
