...
// DateFullLayout returns the full date layout for 'xh'
func (xh *xh) DateFullLayout() string {
	return xh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'xh'
func (xh *xh) DateLongLayout() string {
	return xh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'xh'
func (xh *xh) DateMediumLayout() string {
	return xh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'xh'
func (xh *xh) DateShortLayout() string {
	return xh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'xh'
func (xh *xh) TimeFullLayout() string {
	return xh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'xh'
func (xh *xh) TimeLongLayout() string {
	return xh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'xh'
func (xh *xh) TimeMediumLayout() string {
	return xh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'xh'
func (xh *xh) TimeShortLayout() string {
	return xh.timeShortLayout
}

func (xh *xh) ListPatterns() *locales.ListPatterns {
	return xh.listPatterns
}

func (xh *xh) GetDurationSpec() *locales.DurationSpec {
	return xh.DurationSpec
}

func (xh *xh) GetMiscPatterns() *locales.MiscPatterns {
