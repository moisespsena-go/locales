...
// DateFullLayout returns the full date layout for 'lb_LU'
func (lb *lb_LU) DateFullLayout() string {
	return lb.dateFullLayout
}

// DateLongLayout returns the long date layout for 'lb_LU'
func (lb *lb_LU) DateLongLayout() string {
	return lb.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'lb_LU'
func (lb *lb_LU) DateMediumLayout() string {
	return lb.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'lb_LU'
func (lb *lb_LU) DateShortLayout() string {
	return lb.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'lb_LU'
func (lb *lb_LU) TimeFullLayout() string {
	return lb.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'lb_LU'
func (lb *lb_LU) TimeLongLayout() string {
	return lb.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'lb_LU'
func (lb *lb_LU) TimeMediumLayout() string {
	return lb.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'lb_LU'
func (lb *lb_LU) TimeShortLayout() string {
	return lb.timeShortLayout
}

func (lb *lb_LU) ListPatterns() *locales.ListPatterns {
	return lb.listPatterns
}

func (lb *lb_LU) GetDurationSpec() *locales.DurationSpec {
	return lb.DurationSpec
}

func (lb *lb_LU) GetMiscPatterns() *locales.MiscPatterns {
