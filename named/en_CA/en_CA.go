...
func New() locales.Translator {
	return &en_CA{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Sept"},
			...
			TimezonesValue:           map[string]string{"": "Falkland Islands Standard Time", "ACDT": "Australian Central Daylight Saving Time", "ACST": "", "ACT": "Acre Standard Time", "ACWDT": "Australian Central Western Daylight Saving Time", "ACWST": "", "ADT": "Atlantic Daylight Saving Time", "AEDT": "Australian Eastern Daylight Saving Time", "AEST": "", "AFT": "Afghanistan Time", "AKDT": "Alaska Daylight Saving Time", "AKST": "", "AMST": "Amazon Summer Time", "AMT": "Amazon Standard Time", "ARST": "Argentina Summer Time", "ART": "Argentina Standard Time", "AST": "", "AWDT": "Australian Western Daylight Saving Time", "AWST": "", "BNT": "Brunei Darussalam Time", "BOT": "Bolivia Time", "BRST": "Brasilia Summer Time", "BRT": "Brasilia Standard Time", "BST": "Bangladesh Summer Time", "BTT": "Bhutan Time", "CAT": "Central Africa Time", "CCT": "Cocos Islands Time", "CDT": "Central Daylight Saving Time", "CDT (Kuba)": "Cuba Daylight Saving Time", "CHADT": "Chatham Daylight Saving Time", "CHAST": "", "CLST": "Chile Summer Time", "CLT": "Chile Standard Time", "COST": "Colombia Summer Time", "COT": "Colombia Standard Time", "CST": "", "CST (Kuba)": "", "CXT": "Christmas Island Time", "ChST": "Chamorro Standard Time", "EASST": "Easter Island Summer Time", "EAST": "Easter Island Standard Time", "EAT": "East Africa Time", "ECT": "Ecuador Time", "EDT": "Eastern Daylight Saving Time", "EGDT": "East Greenland Summer Time", "EGST": "East Greenland Standard Time", "EST": "", "FKST": "Falkland Islands Summer Time", "GALT": "Galapagos Time", "GFT": "French Guiana Time", "GMT": "Greenwich Mean Time", "GST": "Gulf Standard Time", "GYT": "Guyana Time", "HADT": "Hawaii-Aleutian Daylight Saving Time", "HAST": "", "HENOMX": "Northwest Mexico Daylight Saving Time", "HEOG": "West Greenland Summer Time", "HEPMX": "Mexican Pacific Daylight Saving Time", "HKST": "Hong Kong Summer Time", "HKT": "Hong Kong Standard Time", "HNNOMX": "", "HNOG": "West Greenland Standard Time", "HNPMX": "", "ICT": "Indochina Time", "IRDT": "Iran Daylight Saving Time", "IRST": "", "IST": "India Standard Time", "JDT": "Japan Daylight Saving Time", "JST": "", "LHDT": "Lord Howe Daylight Saving Time", "LHST": "", "MDT": "Macao Summer Time", "MESZ": "Central European Summer Time", "MEZ": "Central European Standard Time", "MST": "Macao Standard Time", "MVT": "Maldives Time", "MYT": "Malaysia Time", "NDT": "Newfoundland Daylight Saving Time", "NPT": "Nepal Time", "NST": "", "NZDT": "New Zealand Daylight Saving Time", "NZST": "", "OESZ": "Eastern European Summer Time", "OEZ": "Eastern European Standard Time", "PDT": "Pacific Daylight Saving Time", "PKT": "Pakistan Summer Time", "PMDT": "Saint-Pierre-et-Miquelon Daylight Saving Time", "PMST": "Saint-Pierre-et-Miquelon Standard Time", "PST": "", "PYST": "Paraguay Summer Time", "SAST": "South Africa Standard Time", "SGT": "Singapore Standard Time", "SRT": "Suriname Time", "TLT": "East Timor Time", "TMST": "Turkmenistan Summer Time", "TMT": "Turkmenistan Standard Time", "UYST": "Uruguay Summer Time", "UYT": "Uruguay Standard Time", "VET": "Venezuela Time", "WARST": "Western Argentina Summer Time", "WART": "Western Argentina Standard Time", "WAST": "West Africa Summer Time", "WAT": "West Africa Standard Time", "WESZ": "Western European Summer Time", "WEZ": "Western European Standard Time", "WIB": "Western Indonesia Time", "WIT": "Eastern Indonesia Time", "WITA": "Central Indonesia Time", "∅∅∅": "Peru Summer Time"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} and {1}", "", "", "{0} and {1}"}, {"{0} and {1}", "", "", "{0} or {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"", "%v mo", "%v mos", "%v/mo"}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "%vmin", "%vmin", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "%v millisec", "%v millisecs", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "%v μsec", "%v μsecs", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "%v nanosec", "%v nanosecs", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"",
			"%[1]v+",
...
// DateFullLayout returns the full date layout for 'en_CA'
func (en *en_CA) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_CA'
func (en *en_CA) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_CA'
func (en *en_CA) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_CA'
func (en *en_CA) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_CA'
func (en *en_CA) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_CA'
func (en *en_CA) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_CA'
func (en *en_CA) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_CA'
func (en *en_CA) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_CA) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_CA) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_CA) GetMiscPatterns() *locales.MiscPatterns {
