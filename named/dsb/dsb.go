...
func New() locales.Translator {
	return &dsb{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 tys'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 tys'.' ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 tys'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 tys'.' ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 tys'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 tys'.' ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jan.", "feb.", "měr.", "apr.", "maj.", "jun.", "jul.", "awg.", "sep.", "okt.", "now.", "dec."},
			MonthsNarrowValue:        []string{"", "j", "f", "m", "a", "m", "j", "j", "a", "s", "o", "n", "d"},
			MonthsWideValue:          []string{"", "januara", "februara", "měrca", "apryla", "maja", "junija", "julija", "awgusta", "septembra", "oktobra", "nowembra", "decembra"},
			WeekdaysAbbreviatedValue: []string{"nje", "pón", "wał", "srj", "stw", "pět", "sob"},
			WeekdaysNarrowValue:      []string{"n", "p", "w", "s", "s", "p", "s"},
			WeekdaysShortValue:       []string{"nj", "pó", "wa", "sr", "st", "pě", "so"},
			WeekdaysWideValue:        []string{"njeźela", "pónjeźele", "wałtora", "srjoda", "stwórtk", "pětk", "sobota"},
			PeriodsAbbreviatedValue:  []string{"dopołdnja", "wótpołdnja"},
			PeriodsNarrowValue:       []string{"dop.", "wótp."},
			PeriodsWideValue:         []string{"dopołdnja", "wótpołdnja"},
			ErasAbbreviatedValue:     []string{"pś.Chr.n.", "pó Chr.n."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"pśed Kristusowym naroźenim", "pó Kristusowem naroźenju"},
			TimezonesValue:           map[string]string{"": "Falklandski standardny cas", "ACDT": "Srjejźoawstralski lěśojski cas", "ACST": "Srjejźoawstralski standardny cas", "ACT": "ACT", "ACWDT": "Srjejźopódwjacorny awstralski lěśojski cas", "ACWST": "Srjejźopódwjacorny awstralski standardny cas", "ADT": "Atlantiski lěśojski cas", "AEDT": "Pódzajtšnoawstralski lěśojski cas", "AEST": "Pódzajtšnoawstralski standardny cas", "AFT": "Afghaniski cas", "AKDT": "Alaskojski lěśojski cas", "AKST": "Alaskojski standardny cas", "AMST": "Amaconaski lěśojski cas", "AMT": "Amaconaski standardny cas", "ARST": "Argentinski lěśojski cas", "ART": "Argentinski standardny cas", "AST": "Atlantiski standardny cas", "AWDT": "Pódwjacornoawstralski lěśojski cas", "AWST": "Pódwjacornoawstralski standardny cas", "BNT": "Bruneiski cas", "BOT": "Boliwiski cas", "BRST": "Brasília lěśojski cas", "BRT": "Brasília standardny cas", "BST": "Bangladešski lěśojski cas", "BTT": "Bhutański cas", "CAT": "Srjejźoafriski cas", "CCT": "cas Kokosowych kupow", "CDT": "Pódpołnocnoameriski centralny lěśojski cas", "CDT (Kuba)": "Kubański lěśojski cas", "CHADT": "Chathamski lěśojski cas", "CHAST": "Chathamski standardny cas", "CLST": "Chilski lěśojski cas", "CLT": "Chilski standardny cas", "COST": "Kolumbiski lěśojski cas", "COT": "Kolumbiski standardny cas", "CST": "Pódpołnocnoameriski centralny standardny cas", "CST (Kuba)": "Kubański standardny cas", "CXT": "cas Gódownych kupow", "ChST": "Chamorrski cas", "EASST": "lěśojski cas Jatšowneje kupy", "EAST": "standardny cas Jatšowneje kupy", "EAT": "Pódzajtšnoafriski cas", "ECT": "Ekuadorski cas", "EDT": "Pódpołnocnoameriski pódzajtšny lěśojski cas", "EGDT": "Pódzajtšnogrönlandski lěśojski cas", "EGST": "Pódzajtšnogrönlandski standardny cas", "EST": "Pódpołnocnoameriski pódzajtšny standardny cas", "FKST": "Falklandski lěśojski cas", "GALT": "Galapagoski cas", "GFT": "Francojskoguyański cas", "GMT": "Greenwichski cas", "GST": "cas Persiskego golfa", "GYT": "Guyański cas", "HADT": "Hawaiisko-aleutski lěśojski cas", "HAST": "Hawaiisko-aleutski standardny cas", "HENOMX": "Mexiski dłujkowjacorny lěśojski cas", "HEOG": "Pódwjacornogrönlandski lěśojski cas", "HEPMX": "Mexiski pacifiski lěśojski cas", "HKST": "Hongkongski lěśojski cas", "HKT": "Hongkongski standardny cas", "HNNOMX": "Mexiski dłujkowjacorny standardny cas", "HNOG": "Pódwjacornogrönlandski standardny cas", "HNPMX": "Mexiski pacifiski standardny cas", "ICT": "Indochinski cas", "IRDT": "Irański lěśojski cas", "IRST": "Irański standardny cas", "IST": "Indiski cas", "JDT": "Japański lěśojski cas", "JST": "Japański standardny cas", "LHDT": "lěśojski cas kupy Lord-Howe", "LHST": "Standardny cas kupy Lord-Howe", "MDT": "MDT", "MESZ": "Srjejźoeuropski lěśojski cas", "MEZ": "Srjejźoeuropski standardny cas", "MST": "MST", "MVT": "Malediwski cas", "MYT": "Malajziski cas", "NDT": "Nowofundlandski lěśojski cas", "NPT": "Nepalski cas", "NST": "Nowofundlandski standardny cas", "NZDT": "Nowoseelandski lěśojski cas", "NZST": "Nowoseelandski standardny cas", "OESZ": "Pódzajtšnoeuropski lěśojski cas", "OEZ": "Pódzajtšnoeuropski standardny cas", "PDT": "Pódpołnocnoameriski pacifiski lěśojski cas", "PKT": "Pakistański lěśojski cas", "PMDT": "St.-Pierre-a-Miqueloński lěśojski cas", "PMST": "St.-Pierre-a-Miqueloński standardny cas", "PST": "Pódpołnocnoameriski pacifiski standardny cas", "PYST": "Paraguayski lěśojski cas", "SAST": "Pódpołdnjowoafriski cas", "SGT": "Singapurski cas", "SRT": "Surinamski cas", "TLT": "Pódzajtšnotimorski cas", "TMST": "Turkmeniski lěśojski cas", "TMT": "Turkmeniski standardny cas", "UYST": "Uruguayski lěśojski cas", "UYT": "Uruguayski standardny cas", "VET": "Venezuelski cas", "WARST": "Pódwjacornoargentinski lěśojski cas", "WART": "Pódwjacornoargentinski standardny cas", "WAST": "Pódwjacornoafriski lěśojski cas", "WAT": "Pódwjacornoafriski standardny cas", "WESZ": "Pódwjacornoeuropski lěśojski cas", "WEZ": "Pódwjacornoeuropski standardny cas", "WIB": "Pódwjacornoindoneski cas", "WIT": "Pódzajtšnoindoneski", "WITA": "Srjejźoindoneski cas", "∅∅∅": "Peruski lěśojski cas"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} a {1}", "{0}, {1}", "{0}, {1}", "{0} a {1}"}, {"{0} abo {1}", "{0}, {1}", "{0}, {1}", "{0} abo {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"lětst.", "%v lětst.", "%v lětst.", ""},
				Long:   &locales.CounterFormat{"lětstotki", "%v lětstotk", "%v lětstotkow", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"lětź.", "%v lětź.", "%v lětź.", ""},
				Long:   &locales.CounterFormat{"lětźasetki", "%v lětźasetk", "%v lětźasetkow", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"l.", "%v l.", "%v l.", ""},
				Long:   &locales.CounterFormat{"lěta", "%v lěto", "%v lět", "%v wob lěto"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mjas.", "%v mjas.", "%v mjas.", ""},
				Long:   &locales.CounterFormat{"mjasecy", "%v mjasec", "%v mjasecow", "%v wob mjasec"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"tyź.", "%v tyź.", "%v tyź.", ""},
				Long:   &locales.CounterFormat{"tyźenje", "%v tyźeń", "%v tyźenjow", "%v wob tyźeń"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"d", "%v ź", "%v d", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"g", "%v g", "%v g", ""},
				Long:   &locales.CounterFormat{"góźiny", "%v góźina", "%v góźinow", "%v na góźinu"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%v min", "%v min", ""},
				Long:   &locales.CounterFormat{"minuty", "%v minuta", "%v minutow", "%v za minutu"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%v s", "%v s", ""},
				Long:   &locales.CounterFormat{"sekundy", "%v sekunda", "%v sekundow", "%v na sekundu"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"milisekundy", "%v milisekunda", "%v milisekundow", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"mikrosekundy", "%v mikrosekunda", "%v mikrosekundow", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosekundy", "%v nanosekunda", "%v nanosekundow", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"≈%[1]v",
			"%[1]v+",
...
func (dsb *dsb) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(dsb, dsb.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'dsb'
func (dsb *dsb) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(dsb, dsb.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'dsb'
func (dsb *dsb) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(dsb, dsb.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'dsb'
func (dsb *dsb) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(dsb, dsb.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'dsb'
func (dsb *dsb) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(dsb, dsb.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'dsb'
func (dsb *dsb) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(dsb, dsb.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'dsb'
func (dsb *dsb) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(dsb, dsb.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'dsb'
func (dsb *dsb) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(dsb, dsb.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'dsb'
func (dsb *dsb) DateFullLayout() string {
	return dsb.dateFullLayout
}

// DateLongLayout returns the long date layout for 'dsb'
func (dsb *dsb) DateLongLayout() string {
	return dsb.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'dsb'
func (dsb *dsb) DateMediumLayout() string {
	return dsb.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'dsb'
func (dsb *dsb) DateShortLayout() string {
	return dsb.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'dsb'
func (dsb *dsb) TimeFullLayout() string {
	return dsb.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'dsb'
func (dsb *dsb) TimeLongLayout() string {
	return dsb.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'dsb'
func (dsb *dsb) TimeMediumLayout() string {
	return dsb.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'dsb'
func (dsb *dsb) TimeShortLayout() string {
	return dsb.timeShortLayout
}

func (dsb *dsb) ListPatterns() *locales.ListPatterns {
	return dsb.listPatterns
}

func (dsb *dsb) GetDurationSpec() *locales.DurationSpec {
	return dsb.DurationSpec
}

func (dsb *dsb) GetMiscPatterns() *locales.MiscPatterns {
	return &dsb.miscPatterns
}
