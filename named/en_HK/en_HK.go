...
// DateFullLayout returns the full date layout for 'en_HK'
func (en *en_HK) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_HK'
func (en *en_HK) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_HK'
func (en *en_HK) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_HK'
func (en *en_HK) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_HK'
func (en *en_HK) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_HK'
func (en *en_HK) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_HK'
func (en *en_HK) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_HK'
func (en *en_HK) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_HK) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_HK) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_HK) GetMiscPatterns() *locales.MiscPatterns {
