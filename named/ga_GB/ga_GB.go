...
// DateFullLayout returns the full date layout for 'ga_GB'
func (ga *ga_GB) DateFullLayout() string {
	return ga.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ga_GB'
func (ga *ga_GB) DateLongLayout() string {
	return ga.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ga_GB'
func (ga *ga_GB) DateMediumLayout() string {
	return ga.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ga_GB'
func (ga *ga_GB) DateShortLayout() string {
	return ga.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ga_GB'
func (ga *ga_GB) TimeFullLayout() string {
	return ga.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ga_GB'
func (ga *ga_GB) TimeLongLayout() string {
	return ga.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ga_GB'
func (ga *ga_GB) TimeMediumLayout() string {
	return ga.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ga_GB'
func (ga *ga_GB) TimeShortLayout() string {
	return ga.timeShortLayout
}

func (ga *ga_GB) ListPatterns() *locales.ListPatterns {
	return ga.listPatterns
}

func (ga *ga_GB) GetDurationSpec() *locales.DurationSpec {
	return ga.DurationSpec
}

func (ga *ga_GB) GetMiscPatterns() *locales.MiscPatterns {
