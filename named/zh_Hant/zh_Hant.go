...
func New() locales.Translator {
	return &zh_Hant{
		...
		TimeSpec: &locales.TimeSpec{
			...
			WeekdaysAbbreviatedValue: []string{"週日", "週一", "週二", "週三", "週四", "週五", "週六"},
		...
		timeFullLayout:   "Bh:mm:ss [zzzz]",
		timeLongLayout:   "Bh:mm:ss [z]",
		timeMediumLayout: "Bh:mm:ss",
		timeShortLayout:  "Bh:mm",
...
// DateFullLayout returns the full date layout for 'zh_Hant'
func (zh *zh_Hant) DateFullLayout() string {
	return zh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'zh_Hant'
func (zh *zh_Hant) DateLongLayout() string {
	return zh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'zh_Hant'
func (zh *zh_Hant) DateMediumLayout() string {
	return zh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'zh_Hant'
func (zh *zh_Hant) DateShortLayout() string {
	return zh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'zh_Hant'
func (zh *zh_Hant) TimeFullLayout() string {
	return zh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'zh_Hant'
func (zh *zh_Hant) TimeLongLayout() string {
	return zh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'zh_Hant'
func (zh *zh_Hant) TimeMediumLayout() string {
	return zh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'zh_Hant'
func (zh *zh_Hant) TimeShortLayout() string {
	return zh.timeShortLayout
}

func (zh *zh_Hant) ListPatterns() *locales.ListPatterns {
	return zh.listPatterns
}

func (zh *zh_Hant) GetDurationSpec() *locales.DurationSpec {
	return zh.DurationSpec
}

func (zh *zh_Hant) GetMiscPatterns() *locales.MiscPatterns {
