...
func New() locales.Translator {
	return &eu{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						...
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000000 M ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000000 M ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "urt.", "ots.", "mar.", "api.", "mai.", "eka.", "uzt.", "abu.", "ira.", "urr.", "aza.", "abe."},
			MonthsNarrowValue:        []string{"", "U", "O", "M", "A", "M", "E", "U", "A", "I", "U", "A", "A"},
			MonthsWideValue:          []string{"", "urtarrilak", "otsailak", "martxoak", "apirilak", "maiatzak", "ekainak", "uztailak", "abuztuak", "irailak", "urriak", "azaroak", "abenduak"},
			WeekdaysAbbreviatedValue: []string{"ig.", "al.", "ar.", "az.", "og.", "or.", "lr."},
			WeekdaysNarrowValue:      []string{"I", "A", "A", "A", "O", "O", "L"},
			WeekdaysShortValue:       []string{"ig.", "al.", "ar.", "az.", "og.", "or.", "lr."},
			WeekdaysWideValue:        []string{"igandea", "astelehena", "asteartea", "asteazkena", "osteguna", "ostirala", "larunbata"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsNarrowValue:       []string{"g", "a"},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"K.a.", "K.o."},
			ErasNarrowValue:          []string{"a", "o"},
			ErasWideValue:            []string{"K.a.", "Kristo ondoren"},
			TimezonesValue:           map[string]string{"": "Falkland uharteetako ordu estandarra", "ACDT": "Australiako erdialdeko udako ordua", "ACST": "Australiako erdialdeko ordu estandarra", "ACT": "Acreko ordu estandarra", "ACWDT": "Australiako erdi-mendebaldeko udako ordua", "ACWST": "Australiako erdi-mendebaldeko ordu estandarra", "ADT": "Ipar Amerikako Atlantikoko udako ordua", "AEDT": "Australiako ekialdeko udako ordua", "AEST": "Australiako ekialdeko ordu estandarra", "AFT": "Afganistango ordua", "AKDT": "Alaskako udako ordua", "AKST": "Alaskako ordu estandarra", "AMST": "Amazoniako udako ordua", "AMT": "Amazoniako ordu estandarra", "ARST": "Argentinako udako ordua", "ART": "Argentinako ordu estandarra", "AST": "Ipar Amerikako Atlantikoko ordu estandarra", "AWDT": "Australiako mendebaldeko udako ordua", "AWST": "Australiako mendebaldeko ordu estandarra", "BNT": "Brunei Darussalamgo ordua", "BOT": "Boliviako ordua", "BRST": "Brasiliako udako ordua", "BRT": "Brasiliako ordu estandarra", "BST": "Bangladesheko udako ordua", "BTT": "Bhutango ordua", "CAT": "Afrikako erdialdeko ordua", "CCT": "Cocos uharteetako ordua", "CDT": "Ipar Amerikako erdialdeko udako ordua", "CDT (Kuba)": "Kubako udako ordua", "CHADT": "Chathamgo udako ordua", "CHAST": "Chathamgo ordu estandarra", "CLST": "Txileko udako ordua", "CLT": "Txileko ordu estandarra", "COST": "Kolonbiako udako ordua", "COT": "Kolonbiako ordu estandarra", "CST": "Ipar Amerikako erdialdeko ordu estandarra", "CST (Kuba)": "Kubako ordu estandarra", "CXT": "Christmas uharteko ordua", "ChST": "Chamorroko ordu estandarra", "EASST": "Pazko uharteko udako ordua", "EAST": "Pazko uharteko ordu estandarra", "EAT": "Afrikako ekialdeko ordua", "ECT": "Ekuadorreko ordua", "EDT": "Ipar Amerikako ekialdeko udako ordua", "EGDT": "Groenlandiako ekialdeko udako ordua", "EGST": "Groenlandiako ekialdeko ordu estandarra", "EST": "Ipar Amerikako ekialdeko ordu estandarra", "FKST": "Falkland uharteetako udako ordua", "GALT": "Galapagoetako ordua", "GFT": "Guyana Frantseseko ordua", "GMT": "Greenwichko meridianoaren ordua", "GST": "Golkoko ordu estandarra", "GYT": "Guyanako ordua", "HADT": "Hawaii-Aleutiar uharteetako udako ordua", "HAST": "Hawaii-Aleutiar uharteetako ordu estandarra", "HENOMX": "Mexikoko ipar-ekialdeko udako ordua", "HEOG": "Groenlandiako mendebaldeko udako ordua", "HEPMX": "Mexikoko Pazifikoko udako ordua", "HKST": "Hong Kongo udako ordua", "HKT": "Hong Kongo ordu estandarra", "HNNOMX": "Mexikoko ipar-ekialdeko ordu estandarra", "HNOG": "Groenlandiako mendebaldeko ordu estandarra", "HNPMX": "Mexikoko Pazifikoko ordu estandarra", "ICT": "Indotxinako ordua", "IRDT": "Irango udako ordua", "IRST": "Irango ordu estandarra", "IST": "Indiako ordua", "JDT": "Japoniako udako ordua", "JST": "Japoniako ordu estandarra", "LHDT": "Lord Howeko udako ordua", "LHST": "Lord Howeko ordu estandarra", "MDT": "MDT", "MESZ": "Europako erdialdeko udako ordua", "MEZ": "Europako erdialdeko ordu estandarra", "MST": "MST", "MVT": "Maldivetako ordua", "MYT": "Malaysiako ordua", "NDT": "Ternuako udako ordua", "NPT": "Nepalgo ordua", "NST": "Ternuako ordu estandarra", "NZDT": "Zeelanda Berriko udako ordua", "NZST": "Zeelanda Berriko ordu estandarra", "OESZ": "Europako ekialdeko udako ordua", "OEZ": "Europako ekialdeko ordu estandarra", "PDT": "Ipar Amerikako Pazifikoko udako ordua", "PKT": "Pakistango udako ordua", "PMDT": "Saint-Pierre eta Mikeluneko udako ordua", "PMST": "Saint-Pierre eta Mikeluneko ordu estandarra", "PST": "Ipar Amerikako Pazifikoko ordu estandarra", "PYST": "Paraguaiko udako ordua", "SAST": "Afrikako hegoaldeko ordua", "SGT": "Singapurreko ordu estandarra", "SRT": "Surinamgo ordua", "TLT": "Ekialdeko Timorreko ordua", "TMST": "Turkmenistango udako ordua", "TMT": "Turkmenistango ordu estandarra", "UYST": "Uruguaiko udako ordua", "UYT": "Uruguaiko ordu estandarra", "VET": "Venezuelako ordua", "WARST": "Argentina mendebaldeko udako ordua", "WART": "Argentina mendebaldeko ordu estandarra", "WAST": "Afrikako mendebaldeko udako ordua", "WAT": "Afrikako mendebaldeko ordu estandarra", "WESZ": "Europako mendebaldeko udako ordua", "WEZ": "Europako mendebaldeko ordu estandarra", "WIB": "Indonesiako mendebaldeko ordua", "WIT": "Indonesiako ekialdeko ordua", "WITA": "Indonesiako erdialdeko ordua", "∅∅∅": "Peruko udako ordua"},
		},
		...
		dateFullLayout:   "y('e')'ko' MMMM'ren' d('a'), EEEE",
		dateLongLayout:   "y('e')'ko' MMMM'ren' d('a')",
		dateMediumLayout: "y('e')'ko' MMM d('a')",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} eta {1}", "{0}, {1}", "{0}, {1}", "{0} eta {1}"}, {"{0} edo {1}", "{0}, {1}", "{0}, {1}", "{0} edo {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vm.", "%vm.", ""},
				Long:   &locales.CounterFormat{"mendeak", "%v mende", "%v mende", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"hamark.", "%v hamark.", "%v hamark.", ""},
				Long:   &locales.CounterFormat{"hamarkadak", "%v hamarkada", "%v hamarkada", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"urte", "%v u.", "%v u.", ""},
				Long:   &locales.CounterFormat{"urteak", "%v urte", "%v urte", "%v urte bakoitzeko"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"hilabete", "%v hil", "%v hil", ""},
				Long:   &locales.CounterFormat{"hilabeteak", "%v hilabete", "%v hilabete", "%v hilabete bakoitzeko"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"aste", "%v aste", "%v aste", ""},
				Long:   &locales.CounterFormat{"asteak", "%v aste", "%v aste", "%v aste bakoitzeko"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"egun", "%v e.", "%v e.", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ordu", "%v h", "%v h", ""},
				Long:   &locales.CounterFormat{"orduak", "%v ordu", "%v ordu", "%v ordu bakoitzeko"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%v min", "%v min", ""},
				Long:   &locales.CounterFormat{"minutuak", "%v minutu", "%v minutu", "%v minutu bakoitzeko"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%v s", "%v s", ""},
				Long:   &locales.CounterFormat{"segundoak", "%v segundo", "%v segundo", "%v segundo bakoitzeko"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"milisegundoak", "%v milisegundo", "%v milisegundo", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"mikrosegundoak", "%v mikrosegundo", "%v mikrosegundo", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosegundoak", "%v nanosegundo", "%v nanosegundo", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (eu *eu) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(eu, eu.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'eu'
func (eu *eu) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(eu, eu.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'eu'
func (eu *eu) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(eu, eu.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'eu'
func (eu *eu) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(eu, eu.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'eu'
func (eu *eu) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(eu, eu.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'eu'
func (eu *eu) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(eu, eu.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'eu'
func (eu *eu) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(eu, eu.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'eu'
func (eu *eu) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(eu, eu.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'eu'
func (eu *eu) DateFullLayout() string {
	return eu.dateFullLayout
}

// DateLongLayout returns the long date layout for 'eu'
func (eu *eu) DateLongLayout() string {
	return eu.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'eu'
func (eu *eu) DateMediumLayout() string {
	return eu.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'eu'
func (eu *eu) DateShortLayout() string {
	return eu.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'eu'
func (eu *eu) TimeFullLayout() string {
	return eu.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'eu'
func (eu *eu) TimeLongLayout() string {
	return eu.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'eu'
func (eu *eu) TimeMediumLayout() string {
	return eu.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'eu'
func (eu *eu) TimeShortLayout() string {
	return eu.timeShortLayout
}

func (eu *eu) ListPatterns() *locales.ListPatterns {
	return eu.listPatterns
}

func (eu *eu) GetDurationSpec() *locales.DurationSpec {
	return eu.DurationSpec
}

func (eu *eu) GetMiscPatterns() *locales.MiscPatterns {
	return &eu.miscPatterns
}
