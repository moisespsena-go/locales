...
// DateFullLayout returns the full date layout for 'ckb_IQ'
func (ckb *ckb_IQ) DateFullLayout() string {
	return ckb.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ckb_IQ'
func (ckb *ckb_IQ) DateLongLayout() string {
	return ckb.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ckb_IQ'
func (ckb *ckb_IQ) DateMediumLayout() string {
	return ckb.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ckb_IQ'
func (ckb *ckb_IQ) DateShortLayout() string {
	return ckb.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ckb_IQ'
func (ckb *ckb_IQ) TimeFullLayout() string {
	return ckb.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ckb_IQ'
func (ckb *ckb_IQ) TimeLongLayout() string {
	return ckb.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ckb_IQ'
func (ckb *ckb_IQ) TimeMediumLayout() string {
	return ckb.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ckb_IQ'
func (ckb *ckb_IQ) TimeShortLayout() string {
	return ckb.timeShortLayout
}

func (ckb *ckb_IQ) ListPatterns() *locales.ListPatterns {
	return ckb.listPatterns
}

func (ckb *ckb_IQ) GetDurationSpec() *locales.DurationSpec {
	return ckb.DurationSpec
}

func (ckb *ckb_IQ) GetMiscPatterns() *locales.MiscPatterns {
