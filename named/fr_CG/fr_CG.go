...
// DateFullLayout returns the full date layout for 'fr_CG'
func (fr *fr_CG) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_CG'
func (fr *fr_CG) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_CG'
func (fr *fr_CG) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_CG'
func (fr *fr_CG) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_CG'
func (fr *fr_CG) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_CG'
func (fr *fr_CG) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_CG'
func (fr *fr_CG) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_CG'
func (fr *fr_CG) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_CG) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_CG) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_CG) GetMiscPatterns() *locales.MiscPatterns {
