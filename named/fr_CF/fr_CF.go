...
// DateFullLayout returns the full date layout for 'fr_CF'
func (fr *fr_CF) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_CF'
func (fr *fr_CF) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_CF'
func (fr *fr_CF) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_CF'
func (fr *fr_CF) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_CF'
func (fr *fr_CF) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_CF'
func (fr *fr_CF) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_CF'
func (fr *fr_CF) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_CF'
func (fr *fr_CF) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_CF) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_CF) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_CF) GetMiscPatterns() *locales.MiscPatterns {
