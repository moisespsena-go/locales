...
// DateFullLayout returns the full date layout for 'ga_IE'
func (ga *ga_IE) DateFullLayout() string {
	return ga.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ga_IE'
func (ga *ga_IE) DateLongLayout() string {
	return ga.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ga_IE'
func (ga *ga_IE) DateMediumLayout() string {
	return ga.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ga_IE'
func (ga *ga_IE) DateShortLayout() string {
	return ga.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ga_IE'
func (ga *ga_IE) TimeFullLayout() string {
	return ga.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ga_IE'
func (ga *ga_IE) TimeLongLayout() string {
	return ga.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ga_IE'
func (ga *ga_IE) TimeMediumLayout() string {
	return ga.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ga_IE'
func (ga *ga_IE) TimeShortLayout() string {
	return ga.timeShortLayout
}

func (ga *ga_IE) ListPatterns() *locales.ListPatterns {
	return ga.listPatterns
}

func (ga *ga_IE) GetDurationSpec() *locales.DurationSpec {
	return ga.DurationSpec
}

func (ga *ga_IE) GetMiscPatterns() *locales.MiscPatterns {
