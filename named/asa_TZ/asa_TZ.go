...
func New() locales.Translator {
	return &asa_TZ{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mac", "Apr", "Mei", "Jun", "Jul", "Ago", "Sep", "Okt", "Nov", "Dec"},
			...
			WeekdaysAbbreviatedValue: []string{"Jpi", "Jtt", "Jnn", "Jtn", "Alh", "Ijm", "Jmo"},
			...
			PeriodsAbbreviatedValue:  []string{"icheheavo", "ichamthi"},
			PeriodsWideValue:         []string{"icheheavo", "ichamthi"},
			ErasAbbreviatedValue:     []string{"KM", "BM"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Kabla yakwe Yethu", "Baada yakwe Yethu"},
...
func (asa *asa_TZ) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(asa, asa.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'asa_TZ'
func (asa *asa_TZ) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(asa, asa.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'asa_TZ'
func (asa *asa_TZ) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(asa, asa.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'asa_TZ'
func (asa *asa_TZ) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(asa, asa.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'asa_TZ'
func (asa *asa_TZ) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(asa, asa.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'asa_TZ'
func (asa *asa_TZ) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(asa, asa.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'asa_TZ'
func (asa *asa_TZ) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(asa, asa.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'asa_TZ'
func (asa *asa_TZ) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(asa, asa.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'asa_TZ'
func (asa *asa_TZ) DateFullLayout() string {
	return asa.dateFullLayout
}

// DateLongLayout returns the long date layout for 'asa_TZ'
func (asa *asa_TZ) DateLongLayout() string {
	return asa.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'asa_TZ'
func (asa *asa_TZ) DateMediumLayout() string {
	return asa.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'asa_TZ'
func (asa *asa_TZ) DateShortLayout() string {
	return asa.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'asa_TZ'
func (asa *asa_TZ) TimeFullLayout() string {
	return asa.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'asa_TZ'
func (asa *asa_TZ) TimeLongLayout() string {
	return asa.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'asa_TZ'
func (asa *asa_TZ) TimeMediumLayout() string {
	return asa.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'asa_TZ'
func (asa *asa_TZ) TimeShortLayout() string {
	return asa.timeShortLayout
}

func (asa *asa_TZ) ListPatterns() *locales.ListPatterns {
	return asa.listPatterns
}

func (asa *asa_TZ) GetDurationSpec() *locales.DurationSpec {
	return asa.DurationSpec
}

func (asa *asa_TZ) GetMiscPatterns() *locales.MiscPatterns {
	return &asa.miscPatterns
}
