...
// New returns a new instance of translator for the 'sc' locale
	...
	return &sc{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"sèc.", "%vsèc.", "%vsèc.", ""},
				Long:   &locales.CounterFormat{"sèculos", "%v sèculu", "%v sèculos", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vdèc.", "%vdèc.", ""},
				Long:   &locales.CounterFormat{"dècadas", "%v dècada", "%v dècadas", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"annu", "%van.", "%van.", "%v/an."},
				Long:   &locales.CounterFormat{"annos", "%v annu", "%v annos", "%v a s’annu"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mese", "%vme.", "%vme.", "%v/me."},
				Long:   &locales.CounterFormat{"meses", "%v mese", "%v meses", "%v a su mese"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ch.", "%vch.", "%vch.", "%v/ch."},
				Long:   &locales.CounterFormat{"chidas", "%v chida", "%v chidas", "%v a sa chida"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"die", "%vd", "%vd", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ora", "%vo", "%vo", "%v/o"},
				Long:   &locales.CounterFormat{"oras", "%v ora", "%v oras", "%v a s’ora"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%vm", "%vm", "%v/m"},
				Long:   &locales.CounterFormat{"minutos", "%v minutu", "%v minutos", "%v a su minutu"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"seg", "%vs", "%vs", ""},
				Long:   &locales.CounterFormat{"segundos", "%v segundu", "%v segundos", "%v a su segundu"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"millisegundos", "%v millisegundu", "%v millisegundos", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
...
func (sc *sc) Locale() string {
	return sc.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'sc'
func (sc *sc) PluralsCardinal() []locales.PluralRule {
	return sc.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'sc'
func (sc *sc) PluralsOrdinal() []locales.PluralRule {
	return sc.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'sc'
func (sc *sc) PluralsRange() []locales.PluralRule {
	return sc.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'sc'
func (sc *sc) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'sc'
func (sc *sc) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'sc'
func (sc *sc) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
...
// FmtDateShort returns the short date representation of 't' for 'sc'
func (sc *sc) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(sc, sc.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'sc'
func (sc *sc) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(sc, sc.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'sc'
func (sc *sc) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(sc, sc.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'sc'
func (sc *sc) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(sc, sc.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'sc'
func (sc *sc) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(sc, sc.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'sc'
func (sc *sc) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(sc, sc.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'sc'
func (sc *sc) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(sc, sc.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'sc'
func (sc *sc) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(sc, sc.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'sc'
func (sc *sc) DateFullLayout() string {
	return sc.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sc'
func (sc *sc) DateLongLayout() string {
	return sc.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sc'
func (sc *sc) DateMediumLayout() string {
	return sc.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sc'
func (sc *sc) DateShortLayout() string {
	return sc.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sc'
func (sc *sc) TimeFullLayout() string {
	return sc.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sc'
func (sc *sc) TimeLongLayout() string {
	return sc.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sc'
func (sc *sc) TimeMediumLayout() string {
	return sc.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sc'
func (sc *sc) TimeShortLayout() string {
	return sc.timeShortLayout
}

func (sc *sc) ListPatterns() *locales.ListPatterns {
	return sc.listPatterns
}

func (sc *sc) GetDurationSpec() *locales.DurationSpec {
	return sc.DurationSpec
}

func (sc *sc) GetMiscPatterns() *locales.MiscPatterns {
