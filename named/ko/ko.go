...
// DateFullLayout returns the full date layout for 'ko'
func (ko *ko) DateFullLayout() string {
	return ko.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ko'
func (ko *ko) DateLongLayout() string {
	return ko.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ko'
func (ko *ko) DateMediumLayout() string {
	return ko.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ko'
func (ko *ko) DateShortLayout() string {
	return ko.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ko'
func (ko *ko) TimeFullLayout() string {
	return ko.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ko'
func (ko *ko) TimeLongLayout() string {
	return ko.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ko'
func (ko *ko) TimeMediumLayout() string {
	return ko.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ko'
func (ko *ko) TimeShortLayout() string {
	return ko.timeShortLayout
}

func (ko *ko) ListPatterns() *locales.ListPatterns {
	return ko.listPatterns
}

func (ko *ko) GetDurationSpec() *locales.DurationSpec {
	return ko.DurationSpec
}

func (ko *ko) GetMiscPatterns() *locales.MiscPatterns {
