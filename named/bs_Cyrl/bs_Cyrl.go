...
func New() locales.Translator {
	return &bs_Cyrl{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "јан", "феб", "мар", "апр", "мај", "јун", "јул", "ауг", "сеп", "окт", "нов", "дец"},
			MonthsNarrowValue:        []string{"", "ј", "ф", "м", "а", "м", "ј", "ј", "а", "с", "о", "н", "д"},
			MonthsWideValue:          []string{"", "јануар", "фебруар", "март", "април", "мај", "јуни", "јули", "аугуст", "септембар", "октобар", "новембар", "децембар"},
			...
			PeriodsAbbreviatedValue:  []string{"пре подне", "поподне"},
			PeriodsNarrowValue:       []string{"", ""},
			PeriodsWideValue:         []string{"прије подне", "послије подне"},
			ErasAbbreviatedValue:     []string{"п. н. е.", "н. е."},
			ErasNarrowValue:          []string{"п.н.е.", "н.е."},
			ErasWideValue:            []string{"прије нове ере", "нове ере"},
			TimezonesValue:           map[string]string{"": "Фолкландска Острва стандардно вријеме", "ACDT": "Аустралијско централно љетње рачунање времена", "ACST": "Акре летње рачунање времена", "ACT": "Акре стандардно време", "ACWDT": "Аустралијско централно западно љетње рачунање времена", "ACWST": "Аустралијско централно западно стандардно вријеме", "ADT": "Атланско љетње рачунање времена", "AEDT": "Аустралијско источно љетње рачунање времена", "AEST": "Аустралијско источно стандардно вријеме", "AFT": "Авганистан вријеме", "AKDT": "Аљаска љетње вријеме", "AKST": "Аљаска стандардно вријеме", "AMST": "Амазон љетње рачунање времена", "AMT": "Амазон стандардно вријеме", "ARST": "Аргентина љетње рачунање времена", "ART": "Аргентина стандардно вријеме", "AST": "Атланско стандардно вријеме", "AWDT": "Аустралијско западно љетње рачунање времена", "AWST": "Аустралијско западно стандардно вријеме", "BNT": "Брунеј Дарусалам вријеме", "BOT": "Боливија вријеме", "BRST": "Бразилија љетње рачунање времена", "BRT": "Бразилија стандардно вријеме", "BST": "Бангладеш љетње рачунање времена", "BTT": "Бутан вријеме", "CAT": "Централно-афричко вријеме", "CCT": "Кокос (Келинг) Острва вријеме", "CDT": "Централно љетње рачунање времена", "CDT (Kuba)": "Куба љетње рачунање времена", "CHADT": "Чатам љетње рачунање времена", "CHAST": "Чатам стандардно вријеме", "CLST": "Чиле љетње рачунање времена", "CLT": "Чиле стандардно вријеме", "COST": "Колумбија љетње рачунање времена", "COT": "Колумбија стандардно вријеме", "CST": "Централно стандардно вријеме", "CST (Kuba)": "Куба стандардно вријеме", "CXT": "Божићна острва вријеме", "ChST": "Чаморо вријеме", "EASST": "Ускршња острва љетње рачунање времена", "EAST": "Ускршња острва стандардно вријеме", "EAT": "Источно-афричко вријеме", "ECT": "Еквадор вријеме", "EDT": "Источно љетње рачунање времена", "EGDT": "Источни Гренланд љетње рачунање времена", "EGST": "Источни Гренланд стандардно вријеме", "EST": "Источно стандардно вријеме", "FKST": "Фолкландска Острва љетње рачунање времена", "GALT": "Галапагос вријеме", "GFT": "Француска Гвајана вријеме", "GMT": "Гриничко средње вријеме", "GST": "Заливско вријеме", "GYT": "Гвајана вријеме", "HADT": "Хавајско-алеутско љетње рачунање времена", "HAST": "Хавајско-алеутско стандардно вријеме", "HENOMX": "Сјеверномексичко љетње рачунање времена", "HEOG": "Западни Гренланд љетње рачунање времена", "HEPMX": "Мексичко пацифичко љетње рачунање времена", "HKST": "Хонгконшко љетње рачунање времена", "HKT": "Хонг Конг стандардно вријеме", "HNNOMX": "Сјеверномексичко стандардно вријеме", "HNOG": "Западни Гренланд стандардно вријеме", "HNPMX": "Мексичко пацифичко стандардно вријеме", "ICT": "Индокина вријеме", "IRDT": "Иран љетње рачунање времена", "IRST": "Иран стандардно вријеме", "IST": "Индијско стандардно вријеме", "JDT": "Јапанско љетње рачунање времена", "JST": "Јапанско стандардно вријеме", "LHDT": "Лорд Хов љетње рачунање времена", "LHST": "Лорд Хов стандардно вријеме", "MDT": "Макао летње рачунање вемена", "MESZ": "Средњеевропско љетње рачунање времена", "MEZ": "Средњеевропско стандардно вријеме", "MST": "Макао стандардно време", "MVT": "Малдиви вријеме", "MYT": "Малезија вријеме", "NDT": "Њуфаундленд љетње рачунање времена", "NPT": "Непал вријеме", "NST": "Њуфаундленд стандардно вријеме", "NZDT": "Нови Зеланд љетње рачунање времена", "NZST": "Нови Зеланд стандардно вријеме", "OESZ": "Источноевропско љетње рачунање времена", "OEZ": "Источноевропско стандардно вријеме", "PDT": "Пацифичко љетње рачунање времена", "PKT": "Пакистан љетње рачунање времена", "PMDT": "Сен Пјер и Микелон љетње рачунање вемена", "PMST": "Сен Пјер и Микелон стандардно вријеме", "PST": "Пацифичко стандардно вријеме", "PYST": "Парагвај љетње рачунање времена", "SAST": "Јужно-афричко вријеме", "SGT": "Сингапур стандардно вријеме", "SRT": "Суринам вријеме", "TLT": "Тимор-Лесте вријеме", "TMST": "Туркменистан љетње рачунање времена", "TMT": "Туркменистан стандардно вријеме", "UYST": "Уругвај љетње рачунање времена", "UYT": "Уругвај стандардно вријеме", "VET": "Венецуела вријеме", "WARST": "Западна Аргентина љетње рачунање времена", "WART": "Западна Аргентина стандардно вријеме", "WAST": "Западно-афричко љетње рачунање времена", "WAT": "Западно-афричко стандардно вријеме", "WESZ": "Западноевропско љетње рачунање времена", "WEZ": "Западноевропско стандардно вријеме", "WIB": "Западно-индонезијско вријеме", "WIT": "Источно-индонезијско вријеме", "WITA": "Централно-индонезијско вријеме", "∅∅∅": "Азори љетње рачунање времена"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} и {1}", "", "", "{0} и {1}"}, []string(nil)}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"деценије", "%v деценија", "%v деценија", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"година", "%v год", "%v год", "%v годиш."},
				Long:   &locales.CounterFormat{"година", "%v година", "%v година", "%v годишње"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мјесец", "%v мјес.", "%v мјес.", ""},
				Long:   &locales.CounterFormat{"мјесец", "%v мјесец", "%v мјесеци", "%v мјесечно"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"седмица", "%v сед.", "%v сед.", ""},
				Long:   &locales.CounterFormat{"седмице", "%v седмица", "%v седмица", "%v седмично"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"дани", "%v дан", "%v дан", "%v днев."}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%v сат", "%v сати", ""},
				Long:   &locales.CounterFormat{"сати", "%v сат", "%v сати", "%v по сату"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"минут", "%v мин.", "%v мин.", "%v у мин."},
				Long:   &locales.CounterFormat{"минути", "%v минут", "%v минута", "%v у минуту"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"секунде", "%v сек.", "%v сек.", "%v у сек."},
				Long:   &locales.CounterFormat{"секунде", "%v секунда", "%v секунди", "%v у секунди"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мс", "%v мс", "%v мс", ""},
				Long:   &locales.CounterFormat{"милисекунде", "%v милисекунда", "%v милисекунди", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"микросекунде", "%v микросекунда", "%v микросекунди", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"наносекунде", "%v наносекунда", "%v наносекунди", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"≥%[1]v",
...
// DateFullLayout returns the full date layout for 'bs_Cyrl'
func (bs *bs_Cyrl) DateFullLayout() string {
	return bs.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bs_Cyrl'
func (bs *bs_Cyrl) DateLongLayout() string {
	return bs.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bs_Cyrl'
func (bs *bs_Cyrl) DateMediumLayout() string {
	return bs.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bs_Cyrl'
func (bs *bs_Cyrl) DateShortLayout() string {
	return bs.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bs_Cyrl'
func (bs *bs_Cyrl) TimeFullLayout() string {
	return bs.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bs_Cyrl'
func (bs *bs_Cyrl) TimeLongLayout() string {
	return bs.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bs_Cyrl'
func (bs *bs_Cyrl) TimeMediumLayout() string {
	return bs.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bs_Cyrl'
func (bs *bs_Cyrl) TimeShortLayout() string {
	return bs.timeShortLayout
}

func (bs *bs_Cyrl) ListPatterns() *locales.ListPatterns {
	return bs.listPatterns
}

func (bs *bs_Cyrl) GetDurationSpec() *locales.DurationSpec {
	return bs.DurationSpec
}

func (bs *bs_Cyrl) GetMiscPatterns() *locales.MiscPatterns {
