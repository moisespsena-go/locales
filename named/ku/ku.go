...
func New() locales.Translator {
	return &ku{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "rêb", "reş", "ada", "avr", "gul", "pûş", "tîr", "gel", "rez", "kew", "ser", "ber"},
			MonthsNarrowValue:        []string{"", "R", "R", "A", "A", "G", "P", "T", "G", "R", "K", "S", "B"},
			MonthsWideValue:          []string{"", "rêbendanê", "reşemiyê", "adarê", "avrêlê", "gulanê", "pûşperê", "tîrmehê", "gelawêjê", "rezberê", "kewçêrê", "sermawezê", "berfanbarê"},
			WeekdaysAbbreviatedValue: []string{"yş", "dş", "sş", "çş", "pş", "în", "ş"},
			WeekdaysNarrowValue:      []string{"Y", "D", "S", "Ç", "P", "Î", "Ş"},
			WeekdaysShortValue:       []string{"yş", "dş", "sş", "çş", "pş", "în", "ş"},
			WeekdaysWideValue:        []string{"yekşem", "duşem", "sêşem", "çarşem", "pêncşem", "în", "şemî"},
			PeriodsAbbreviatedValue:  []string{"BN", "PN"},
			PeriodsWideValue:         []string{"BN", "PN"},
			ErasAbbreviatedValue:     []string{"BZ", "PZ"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"berî zayînê", "piştî zayînê"},
		...
		timeMediumLayout: "",
		timeShortLayout:  "",
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} û {1}", "{0}, {1}", "{0}, {1}", "{0} û {1}"}, {"{0} an {1}", "{0}, {1}", "{0}, {1}", "{0} an {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"sl", "%vsl", "%vsl", ""},
				Long:   &locales.CounterFormat{"sal", "%v sal", "%v sal", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"meh", "%vm", "%vm", ""},
				Long:   &locales.CounterFormat{"meh", "%v meh", "%v meh", "%v/meh"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vhf", "%vhf", ""},
				Long:   &locales.CounterFormat{"hefte", "%v hefte", "%v hefte", "%v/hefte"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"roj", "%vr", "%vr", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"saet", "%vst", "%vst", ""},
				Long:   &locales.CounterFormat{"saet", "%v saet", "%v saet", "%v/st"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"d", "%vd", "%vd", ""},
				Long:   &locales.CounterFormat{"deqîqe", "%v deqîqe", "%v deqîqe", "%v/d"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%vs", "%vs", ""},
				Long:   &locales.CounterFormat{"sanî", "%v saniye", "%v saniye", "%v/s"}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
...
func (ku *ku) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ku, ku.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ku'
func (ku *ku) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ku, ku.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ku'
func (ku *ku) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ku, ku.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ku'
func (ku *ku) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ku, ku.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ku'
func (ku *ku) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ku, ku.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ku'
func (ku *ku) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ku, ku.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ku'
func (ku *ku) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ku, ku.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ku'
func (ku *ku) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ku, ku.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ku'
func (ku *ku) DateFullLayout() string {
	return ku.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ku'
func (ku *ku) DateLongLayout() string {
	return ku.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ku'
func (ku *ku) DateMediumLayout() string {
	return ku.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ku'
func (ku *ku) DateShortLayout() string {
	return ku.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ku'
func (ku *ku) TimeFullLayout() string {
	return ku.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ku'
func (ku *ku) TimeLongLayout() string {
	return ku.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ku'
func (ku *ku) TimeMediumLayout() string {
	return ku.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ku'
func (ku *ku) TimeShortLayout() string {
	return ku.timeShortLayout
}

func (ku *ku) ListPatterns() *locales.ListPatterns {
	return ku.listPatterns
}

func (ku *ku) GetDurationSpec() *locales.DurationSpec {
	return ku.DurationSpec
}

func (ku *ku) GetMiscPatterns() *locales.MiscPatterns {
	return &ku.miscPatterns
}
