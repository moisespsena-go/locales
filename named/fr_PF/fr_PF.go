...
// DateFullLayout returns the full date layout for 'fr_PF'
func (fr *fr_PF) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_PF'
func (fr *fr_PF) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_PF'
func (fr *fr_PF) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_PF'
func (fr *fr_PF) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_PF'
func (fr *fr_PF) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_PF'
func (fr *fr_PF) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_PF'
func (fr *fr_PF) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_PF'
func (fr *fr_PF) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_PF) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_PF) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_PF) GetMiscPatterns() *locales.MiscPatterns {
