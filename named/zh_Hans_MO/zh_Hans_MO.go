...
// DateFullLayout returns the full date layout for 'zh_Hans_MO'
func (zh *zh_Hans_MO) DateFullLayout() string {
	return zh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'zh_Hans_MO'
func (zh *zh_Hans_MO) DateLongLayout() string {
	return zh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'zh_Hans_MO'
func (zh *zh_Hans_MO) DateMediumLayout() string {
	return zh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'zh_Hans_MO'
func (zh *zh_Hans_MO) DateShortLayout() string {
	return zh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'zh_Hans_MO'
func (zh *zh_Hans_MO) TimeFullLayout() string {
	return zh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'zh_Hans_MO'
func (zh *zh_Hans_MO) TimeLongLayout() string {
	return zh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'zh_Hans_MO'
func (zh *zh_Hans_MO) TimeMediumLayout() string {
	return zh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'zh_Hans_MO'
func (zh *zh_Hans_MO) TimeShortLayout() string {
	return zh.timeShortLayout
}

func (zh *zh_Hans_MO) ListPatterns() *locales.ListPatterns {
	return zh.listPatterns
}

func (zh *zh_Hans_MO) GetDurationSpec() *locales.DurationSpec {
	return zh.DurationSpec
}

func (zh *zh_Hans_MO) GetMiscPatterns() *locales.MiscPatterns {
