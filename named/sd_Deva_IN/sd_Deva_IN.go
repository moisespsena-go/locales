...
// DateFullLayout returns the full date layout for 'sd_Deva_IN'
func (sd *sd_Deva_IN) DateFullLayout() string {
	return sd.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sd_Deva_IN'
func (sd *sd_Deva_IN) DateLongLayout() string {
	return sd.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sd_Deva_IN'
func (sd *sd_Deva_IN) DateMediumLayout() string {
	return sd.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sd_Deva_IN'
func (sd *sd_Deva_IN) DateShortLayout() string {
	return sd.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sd_Deva_IN'
func (sd *sd_Deva_IN) TimeFullLayout() string {
	return sd.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sd_Deva_IN'
func (sd *sd_Deva_IN) TimeLongLayout() string {
	return sd.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sd_Deva_IN'
func (sd *sd_Deva_IN) TimeMediumLayout() string {
	return sd.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sd_Deva_IN'
func (sd *sd_Deva_IN) TimeShortLayout() string {
	return sd.timeShortLayout
}

func (sd *sd_Deva_IN) ListPatterns() *locales.ListPatterns {
	return sd.listPatterns
}

func (sd *sd_Deva_IN) GetDurationSpec() *locales.DurationSpec {
	return sd.DurationSpec
}

func (sd *sd_Deva_IN) GetMiscPatterns() *locales.MiscPatterns {
