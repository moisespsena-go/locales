...
// DateFullLayout returns the full date layout for 'om'
func (om *om) DateFullLayout() string {
	return om.dateFullLayout
}

// DateLongLayout returns the long date layout for 'om'
func (om *om) DateLongLayout() string {
	return om.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'om'
func (om *om) DateMediumLayout() string {
	return om.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'om'
func (om *om) DateShortLayout() string {
	return om.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'om'
func (om *om) TimeFullLayout() string {
	return om.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'om'
func (om *om) TimeLongLayout() string {
	return om.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'om'
func (om *om) TimeMediumLayout() string {
	return om.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'om'
func (om *om) TimeShortLayout() string {
	return om.timeShortLayout
}

func (om *om) ListPatterns() *locales.ListPatterns {
	return om.listPatterns
}

func (om *om) GetDurationSpec() *locales.DurationSpec {
	return om.DurationSpec
}

func (om *om) GetMiscPatterns() *locales.MiscPatterns {
