...
// New returns a new instance of translator for the 'en_MV' locale
func New() locales.Translator {
	return &en_MV{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"},
			WeekdaysAbbreviatedValue: []string{"Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"},
			WeekdaysNarrowValue:      []string{"S", "M", "T", "W", "T", "F", "S"},
			WeekdaysShortValue:       []string{"Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"},
			WeekdaysWideValue:        []string{"Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"},
			...
			ErasNarrowValue:          []string{"B", "A"},
			ErasWideValue:            []string{"Before Christ", "Anno Domini"},
			TimezonesValue:           map[string]string{"": "Falkland Islands Standard Time", "ACDT": "Australian Central Daylight Time", "ACST": "Australian Central Standard Time", "ACT": "Acre Standard Time", "ACWDT": "Australian Central Western Daylight Time", "ACWST": "Australian Central Western Standard Time", "ADT": "Atlantic Daylight Time", "AEDT": "Australian Eastern Daylight Time", "AEST": "Australian Eastern Standard Time", "AFT": "Afghanistan Time", "AKDT": "Alaska Daylight Time", "AKST": "Alaska Standard Time", "AMST": "Amazon Summer Time", "AMT": "Amazon Standard Time", "ARST": "Argentina Summer Time", "ART": "Argentina Standard Time", "AST": "Atlantic Standard Time", "AWDT": "Australian Western Daylight Time", "AWST": "Australian Western Standard Time", "BNT": "Brunei Darussalam Time", "BOT": "Bolivia Time", "BRST": "Brasilia Summer Time", "BRT": "Brasilia Standard Time", "BST": "Bangladesh Summer Time", "BTT": "Bhutan Time", "CAT": "Central Africa Time", "CCT": "Cocos Islands Time", "CDT": "Central Daylight Time", "CDT (Kuba)": "Cuba Daylight Time", "CHADT": "Chatham Daylight Time", "CHAST": "Chatham Standard Time", "CLST": "Chile Summer Time", "CLT": "Chile Standard Time", "COST": "Colombia Summer Time", "COT": "Colombia Standard Time", "CST": "Central Standard Time", "CST (Kuba)": "Cuba Standard Time", "CXT": "Christmas Island Time", "ChST": "Chamorro Standard Time", "EASST": "Easter Island Summer Time", "EAST": "Easter Island Standard Time", "EAT": "East Africa Time", "ECT": "Ecuador Time", "EDT": "Eastern Daylight Time", "EGDT": "East Greenland Summer Time", "EGST": "East Greenland Standard Time", "EST": "Eastern Standard Time", "FKST": "Falkland Islands Summer Time", "GALT": "Galapagos Time", "GFT": "French Guiana Time", "GMT": "Greenwich Mean Time", "GST": "Gulf Standard Time", "GYT": "Guyana Time", "HADT": "Hawaii-Aleutian Daylight Time", "HAST": "Hawaii-Aleutian Standard Time", "HENOMX": "Northwest Mexico Daylight Time", "HEOG": "West Greenland Summer Time", "HEPMX": "Mexican Pacific Daylight Time", "HKST": "Hong Kong Summer Time", "HKT": "Hong Kong Standard Time", "HNNOMX": "Northwest Mexico Standard Time", "HNOG": "West Greenland Standard Time", "HNPMX": "Mexican Pacific Standard Time", "ICT": "Indochina Time", "IRDT": "Iran Daylight Time", "IRST": "Iran Standard Time", "IST": "India Standard Time", "JDT": "Japan Daylight Time", "JST": "Japan Standard Time", "LHDT": "Lord Howe Daylight Time", "LHST": "Lord Howe Standard Time", "MDT": "Macao Summer Time", "MESZ": "Central European Summer Time", "MEZ": "Central European Standard Time", "MST": "Macao Standard Time", "MVT": "Maldives Time", "MYT": "Malaysia Time", "NDT": "Newfoundland Daylight Time", "NPT": "Nepal Time", "NST": "Newfoundland Standard Time", "NZDT": "New Zealand Daylight Time", "NZST": "New Zealand Standard Time", "OESZ": "Eastern European Summer Time", "OEZ": "Eastern European Standard Time", "PDT": "Pacific Daylight Time", "PKT": "Pakistan Summer Time", "PMDT": "St. Pierre & Miquelon Daylight Time", "PMST": "St. Pierre & Miquelon Standard Time", "PST": "Pacific Standard Time", "PYST": "Paraguay Summer Time", "SAST": "South Africa Standard Time", "SGT": "Singapore Standard Time", "SRT": "Suriname Time", "TLT": "East Timor Time", "TMST": "Turkmenistan Summer Time", "TMT": "Turkmenistan Standard Time", "UYST": "Uruguay Summer Time", "UYT": "Uruguay Standard Time", "VET": "Venezuela Time", "WARST": "Western Argentina Summer Time", "WART": "Western Argentina Standard Time", "WAST": "West Africa Summer Time", "WAT": "West Africa Standard Time", "WESZ": "Western European Summer Time", "WEZ": "Western European Standard Time", "WIB": "Western Indonesia Time", "WIT": "Eastern Indonesia Time", "WITA": "Central Indonesia Time", "∅∅∅": "Peru Summer Time"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} and {1}", "{0}, {1}", "{0}, {1}", "{0}, and {1}"}, {"{0} or {1}", "{0}, {1}", "{0}, {1}", "{0}, or {1}"}}),
		miscPatterns: locales.MiscPatterns{
			"",
			"%[1]v+",
			"",
...
func (en *en_MV) Locale() string {
	return en.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'en_MV'
func (en *en_MV) PluralsCardinal() []locales.PluralRule {
	return en.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'en_MV'
func (en *en_MV) PluralsOrdinal() []locales.PluralRule {
	return en.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'en_MV'
func (en *en_MV) PluralsRange() []locales.PluralRule {
	return en.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'en_MV'
func (en *en_MV) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'en_MV'
func (en *en_MV) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'en_MV'
func (en *en_MV) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleOther
}

// FmtDateShort returns the short date representation of 't' for 'en_MV'
func (en *en_MV) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(en, en.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'en_MV'
func (en *en_MV) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(en, en.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'en_MV'
func (en *en_MV) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(en, en.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'en_MV'
func (en *en_MV) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(en, en.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'en_MV'
func (en *en_MV) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(en, en.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'en_MV'
func (en *en_MV) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(en, en.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'en_MV'
func (en *en_MV) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(en, en.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'en_MV'
func (en *en_MV) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(en, en.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'en_MV'
func (en *en_MV) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_MV'
func (en *en_MV) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_MV'
func (en *en_MV) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_MV'
func (en *en_MV) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_MV'
func (en *en_MV) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_MV'
func (en *en_MV) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_MV'
func (en *en_MV) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_MV'
func (en *en_MV) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_MV) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_MV) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_MV) GetMiscPatterns() *locales.MiscPatterns {
	return &en.miscPatterns
}
