...
// DateFullLayout returns the full date layout for 'mi'
func (mi *mi) DateFullLayout() string {
	return mi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mi'
func (mi *mi) DateLongLayout() string {
	return mi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mi'
func (mi *mi) DateMediumLayout() string {
	return mi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mi'
func (mi *mi) DateShortLayout() string {
	return mi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mi'
func (mi *mi) TimeFullLayout() string {
	return mi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mi'
func (mi *mi) TimeLongLayout() string {
	return mi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mi'
func (mi *mi) TimeMediumLayout() string {
	return mi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mi'
func (mi *mi) TimeShortLayout() string {
	return mi.timeShortLayout
}

func (mi *mi) ListPatterns() *locales.ListPatterns {
	return mi.listPatterns
}

func (mi *mi) GetDurationSpec() *locales.DurationSpec {
	return mi.DurationSpec
}

func (mi *mi) GetMiscPatterns() *locales.MiscPatterns {
