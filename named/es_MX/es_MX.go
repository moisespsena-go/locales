	...
	return &es_MX{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"a", "%va", "%va", ""},
				Long:   &locales.CounterFormat{"a", "%v a", "%v a", "%v/a"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m", "%vm", "%vm", ""},
				Long:   &locales.CounterFormat{"meses", "%v m", "%v m", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sem", "%vsem", "%vsem", ""},
				Long:   &locales.CounterFormat{"sem", "%v sem", "%v sem", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"días", "%vd", "%vd", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
...
// DateFullLayout returns the full date layout for 'es_MX'
func (es *es_MX) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_MX'
func (es *es_MX) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_MX'
func (es *es_MX) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_MX'
func (es *es_MX) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_MX'
func (es *es_MX) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_MX'
func (es *es_MX) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_MX'
func (es *es_MX) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_MX'
func (es *es_MX) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_MX) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_MX) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_MX) GetMiscPatterns() *locales.MiscPatterns {
