...
// DateFullLayout returns the full date layout for 'en_UM'
func (en *en_UM) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_UM'
func (en *en_UM) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_UM'
func (en *en_UM) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_UM'
func (en *en_UM) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_UM'
func (en *en_UM) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_UM'
func (en *en_UM) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_UM'
func (en *en_UM) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_UM'
func (en *en_UM) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_UM) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_UM) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_UM) GetMiscPatterns() *locales.MiscPatterns {
