...
// DateFullLayout returns the full date layout for 'gsw_CH'
func (gsw *gsw_CH) DateFullLayout() string {
	return gsw.dateFullLayout
}

// DateLongLayout returns the long date layout for 'gsw_CH'
func (gsw *gsw_CH) DateLongLayout() string {
	return gsw.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'gsw_CH'
func (gsw *gsw_CH) DateMediumLayout() string {
	return gsw.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'gsw_CH'
func (gsw *gsw_CH) DateShortLayout() string {
	return gsw.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'gsw_CH'
func (gsw *gsw_CH) TimeFullLayout() string {
	return gsw.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'gsw_CH'
func (gsw *gsw_CH) TimeLongLayout() string {
	return gsw.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'gsw_CH'
func (gsw *gsw_CH) TimeMediumLayout() string {
	return gsw.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'gsw_CH'
func (gsw *gsw_CH) TimeShortLayout() string {
	return gsw.timeShortLayout
}

func (gsw *gsw_CH) ListPatterns() *locales.ListPatterns {
	return gsw.listPatterns
}

func (gsw *gsw_CH) GetDurationSpec() *locales.DurationSpec {
	return gsw.DurationSpec
}

func (gsw *gsw_CH) GetMiscPatterns() *locales.MiscPatterns {
