...
// DateFullLayout returns the full date layout for 'ca_ES_VALENCIA'
func (ca *ca_ES_VALENCIA) DateFullLayout() string {
	return ca.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ca_ES_VALENCIA'
func (ca *ca_ES_VALENCIA) DateLongLayout() string {
	return ca.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ca_ES_VALENCIA'
func (ca *ca_ES_VALENCIA) DateMediumLayout() string {
	return ca.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ca_ES_VALENCIA'
func (ca *ca_ES_VALENCIA) DateShortLayout() string {
	return ca.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ca_ES_VALENCIA'
func (ca *ca_ES_VALENCIA) TimeFullLayout() string {
	return ca.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ca_ES_VALENCIA'
func (ca *ca_ES_VALENCIA) TimeLongLayout() string {
	return ca.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ca_ES_VALENCIA'
func (ca *ca_ES_VALENCIA) TimeMediumLayout() string {
	return ca.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ca_ES_VALENCIA'
func (ca *ca_ES_VALENCIA) TimeShortLayout() string {
	return ca.timeShortLayout
}

func (ca *ca_ES_VALENCIA) ListPatterns() *locales.ListPatterns {
	return ca.listPatterns
}

func (ca *ca_ES_VALENCIA) GetDurationSpec() *locales.DurationSpec {
	return ca.DurationSpec
}

func (ca *ca_ES_VALENCIA) GetMiscPatterns() *locales.MiscPatterns {
