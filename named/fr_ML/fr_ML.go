...
// DateFullLayout returns the full date layout for 'fr_ML'
func (fr *fr_ML) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_ML'
func (fr *fr_ML) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_ML'
func (fr *fr_ML) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_ML'
func (fr *fr_ML) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_ML'
func (fr *fr_ML) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_ML'
func (fr *fr_ML) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_ML'
func (fr *fr_ML) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_ML'
func (fr *fr_ML) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_ML) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_ML) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_ML) GetMiscPatterns() *locales.MiscPatterns {
