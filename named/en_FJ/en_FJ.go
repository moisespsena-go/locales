...
// DateFullLayout returns the full date layout for 'en_FJ'
func (en *en_FJ) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_FJ'
func (en *en_FJ) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_FJ'
func (en *en_FJ) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_FJ'
func (en *en_FJ) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_FJ'
func (en *en_FJ) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_FJ'
func (en *en_FJ) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_FJ'
func (en *en_FJ) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_FJ'
func (en *en_FJ) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_FJ) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_FJ) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_FJ) GetMiscPatterns() *locales.MiscPatterns {
