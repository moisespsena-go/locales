...
// DateFullLayout returns the full date layout for 'en_MG'
func (en *en_MG) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_MG'
func (en *en_MG) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_MG'
func (en *en_MG) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_MG'
func (en *en_MG) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_MG'
func (en *en_MG) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_MG'
func (en *en_MG) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_MG'
func (en *en_MG) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_MG'
func (en *en_MG) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_MG) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_MG) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_MG) GetMiscPatterns() *locales.MiscPatterns {
