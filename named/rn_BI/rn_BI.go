...
func New() locales.Translator {
	return &rn_BI{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Mut.", "Gas.", "Wer.", "Mat.", "Gic.", "Kam.", "Nya.", "Kan.", "Nze.", "Ukw.", "Ugu.", "Uku."},
			MonthsWideValue:          []string{"", "Nzero", "Ruhuhuma", "Ntwarante", "Ndamukiza", "Rusama", "Ruheshi", "Mukakaro", "Nyandagaro", "Nyakanga", "Gitugutu", "Munyonyo", "Kigarama"},
			WeekdaysAbbreviatedValue: []string{"cu.", "mbe.", "kab.", "gtu.", "kan.", "gnu.", "gnd."},
			WeekdaysWideValue:        []string{"Ku w’indwi", "Ku wa mbere", "Ku wa kabiri", "Ku wa gatatu", "Ku wa kane", "Ku wa gatanu", "Ku wa gatandatu"},
			PeriodsAbbreviatedValue:  []string{"Z.MU.", "Z.MW."},
			PeriodsWideValue:         []string{"Z.MU.", "Z.MW."},
			ErasAbbreviatedValue:     []string{"Mb.Y.", "Ny.Y"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Mbere ya Yezu", "Nyuma ya Yezu"},
...
func (rn *rn_BI) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(rn, rn.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'rn_BI'
func (rn *rn_BI) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(rn, rn.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'rn_BI'
func (rn *rn_BI) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(rn, rn.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'rn_BI'
func (rn *rn_BI) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(rn, rn.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'rn_BI'
func (rn *rn_BI) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(rn, rn.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'rn_BI'
func (rn *rn_BI) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(rn, rn.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'rn_BI'
func (rn *rn_BI) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(rn, rn.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'rn_BI'
func (rn *rn_BI) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(rn, rn.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'rn_BI'
func (rn *rn_BI) DateFullLayout() string {
	return rn.dateFullLayout
}

// DateLongLayout returns the long date layout for 'rn_BI'
func (rn *rn_BI) DateLongLayout() string {
	return rn.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'rn_BI'
func (rn *rn_BI) DateMediumLayout() string {
	return rn.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'rn_BI'
func (rn *rn_BI) DateShortLayout() string {
	return rn.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'rn_BI'
func (rn *rn_BI) TimeFullLayout() string {
	return rn.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'rn_BI'
func (rn *rn_BI) TimeLongLayout() string {
	return rn.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'rn_BI'
func (rn *rn_BI) TimeMediumLayout() string {
	return rn.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'rn_BI'
func (rn *rn_BI) TimeShortLayout() string {
	return rn.timeShortLayout
}

func (rn *rn_BI) ListPatterns() *locales.ListPatterns {
	return rn.listPatterns
}

func (rn *rn_BI) GetDurationSpec() *locales.DurationSpec {
	return rn.DurationSpec
}

func (rn *rn_BI) GetMiscPatterns() *locales.MiscPatterns {
	return &rn.miscPatterns
}
