...
// DateFullLayout returns the full date layout for 'ff'
func (ff *ff) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff'
func (ff *ff) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff'
func (ff *ff) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff'
func (ff *ff) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff'
func (ff *ff) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff'
func (ff *ff) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff'
func (ff *ff) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff'
func (ff *ff) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff) GetMiscPatterns() *locales.MiscPatterns {
