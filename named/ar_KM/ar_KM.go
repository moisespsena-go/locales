...
// DateFullLayout returns the full date layout for 'ar_KM'
func (ar *ar_KM) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_KM'
func (ar *ar_KM) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_KM'
func (ar *ar_KM) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_KM'
func (ar *ar_KM) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_KM'
func (ar *ar_KM) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_KM'
func (ar *ar_KM) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_KM'
func (ar *ar_KM) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_KM'
func (ar *ar_KM) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_KM) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_KM) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_KM) GetMiscPatterns() *locales.MiscPatterns {
