...
// DateFullLayout returns the full date layout for 'en_KI'
func (en *en_KI) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_KI'
func (en *en_KI) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_KI'
func (en *en_KI) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_KI'
func (en *en_KI) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_KI'
func (en *en_KI) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_KI'
func (en *en_KI) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_KI'
func (en *en_KI) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_KI'
func (en *en_KI) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_KI) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_KI) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_KI) GetMiscPatterns() *locales.MiscPatterns {
