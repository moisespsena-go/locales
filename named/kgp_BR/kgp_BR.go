...
func New() locales.Translator {
	return &kgp_BR{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						...
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 0 tri"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 0 tri"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 00 tri"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 00 tri"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤ 000 tri"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤ 000 tri"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "1Ky.", "2Ky.", "3Ky.", "4Ky.", "5Ky.", "6Ky.", "7Ky.", "8Ky.", "9Ky.", "10Ky.", "11Ky.", "12Ky."},
			MonthsNarrowValue:        []string{"", "1K", "2K", "3K", "4K", "5K", "6K", "7K", "8K", "9K", "10K", "11K", "12K"},
			MonthsWideValue:          []string{"", "1-Kysã", "2-Kysã", "3-Kysã", "4-Kysã", "5-Kysã", "6-Kysã", "7-Kysã", "8-Kysã", "9-Kysã", "10-Kysã", "11-Kysã", "12-Kysã"},
			WeekdaysAbbreviatedValue: []string{"num.", "pir.", "rég.", "tẽg.", "vẽn.", "pén.", "sav."},
			WeekdaysNarrowValue:      []string{"N.", "P.", "R.", "T.", "V.", "P.", "S."},
			WeekdaysShortValue:       []string{"N.", "1kh.", "2kh.", "3kh.", "4kh.", "5kh.", "S."},
			WeekdaysWideValue:        []string{"numĩggu", "pir-kurã-há", "régre-kurã-há", "tẽgtũ-kurã-há", "vẽnhkãgra-kurã-há", "pénkar-kurã-há", "savnu"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsNarrowValue:       []string{"AM", "PM"},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"C.j.", "C.kk."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Cristo jo", "Cristo kar kỹ"},
			TimezonesValue:           map[string]string{"": "Ór Pã Mỹrvĩnỹ Goj-vẽso tá", "ACDT": "Rỹ Kã óra Avotyraria Kuju tá", "ACST": "Óra Pã Avotyraria Kuju tá", "ACT": "Óra Pã Akre tá", "ACWDT": "Rỹ Kã óra Avotyraria Kuju-Rãpur tá", "ACWST": "Óra Pã Avotyraria Kuju-Rãpur tá", "ADT": "Rỹ Kã óra Atrỹtiku tá", "AEDT": "Rỹ Kã óra Avotyraria Rãjur tá", "AEST": "Óra Pã Avotyraria Rãjur tá", "AFT": "Afeganĩtã tá óra", "AKDT": "Rỹ Kã óra Aranhka tá", "AKST": "Óra Pã Aranhka tá", "AMST": "Rỹ Kã óra Amỹjonỹ tá", "AMT": "Óra Pã Amỹjonỹ tá", "ARST": "Rỹ Kã óra Arjẽtĩnỹ tá", "ART": "Óra Opã Arjẽtĩnỹ tá", "AST": "Óra Pã Atrỹtiku tá", "AWDT": "Rỹ Kã óra Avotyraria Rãpur tá", "AWST": "Óra Pã Avotyraria Rãpur tá", "BNT": "Óra Mrunẽj Narusarỹ tá", "BOT": "Óra Morivia tá", "BRST": "Rỹ Kã óra Mrasirja tá", "BRT": "Óra Pã Mrasirja tá", "BST": "Rỹ Kã óra Mỹngranési tá", "BTT": "Óra Mutỹv tá", "CAT": "Afrika-Kuju tá óra", "CCT": "Óra Kokonh Goj-vẽso tá", "CDT": "Rỹ Kã óra Kuju tá", "CDT (Kuba)": "Rỹ Kã óra Kuma tá", "CHADT": "Rỹ Kã óra San-hỹm tá", "CHAST": "Óra Pã San-hỹm tá", "CLST": "Rỹ Kã óra Sire tá", "CLT": "Óra Pã Sire tá", "COST": "Rỹ Kã óra Korãmija tá", "COT": "Óra Pã Korãmija tá", "CST": "Óra Pã Kuju tá", "CST (Kuba)": "Óra Pã Kuma tá", "CXT": "Óra Krĩtimỹnh Goj-vẽso tá", "ChST": "Óra Samãho tá", "EASST": "Rỹ Kã óra Panhkuva Goj-vẽso tá", "EAST": "Óra Pã Panhkuva Goj-vẽso tá", "EAT": "Afrika Rãjur tá óra", "ECT": "Óra Ekuvanor tá", "EDT": "Rỹ Kã óra Rãjur tá", "EGDT": "Rỹ Kã óra Groẽrỹnija Rãjur tá", "EGST": "Óra Pã Groẽrỹnija Rãjur tá", "EST": "Óra Pã Rãjur tá", "FKST": "Rỹ Kã óra Mỹrvĩnỹ Goj-vẽso tá", "GALT": "Óra Gara Pago tá", "GFT": "Óra Frỹsa Gijanỹ tá", "GMT": "Óra Mirinjỹnũ Grinũvisi tá", "GST": "Óra Gorfu tá", "GYT": "Óra Gijỹnỹ tá", "HADT": "Rỹ kã óra Hava’i kar Arevta Goj-vẽso tá", "HAST": "Óra Pã Hava’i kar Arevta Goj-vẽso tá", "HENOMX": "Rỹ Kã óra Mẽsiku Nãrti-Rãpur tá", "HEOG": "Rỹ Kã óra Groẽrỹnija Rãpur tá", "HEPMX": "Rỹ Kã óra Mẽsiku Pasifiku tá", "HKST": "Rỹ Kã óra Hãg Kãg tá", "HKT": "Óra Pã Hãg Kãg tá", "HNNOMX": "Óra Pã Mẽsiku Nãrti-Rãpur tá", "HNOG": "Óra Pã Groẽrỹnija Rãpur tá", "HNPMX": "Óra Pã Mẽsiku Pasifiku tá", "ICT": "Óra Ĩnosĩnỹ tá", "IRDT": "Rỹ Kã óra Irỹ tá", "IRST": "Óra Pã Irỹ tá", "IST": "Óra Pã Ĩnija tá", "JDT": "Rỹ Kã óra Japã tá", "JST": "Óra Pã Japã tá", "LHDT": "Rỹ Kã óra Rórni Hove tá", "LHST": "Óra Pã Rórni Hove tá", "MDT": "Rỹ kã óra Mỹkav tá", "MESZ": "Rỹ Kã óra Orópa Kuju tá", "MEZ": "Óra Pã Orópa Kuju tá", "MST": "Óra Pã Mỹkav tá", "MVT": "Óra Goj Vẽso Mỹrniva tá", "MYT": "Óra Mỹraja tá", "NDT": "Rỹ Kã óra Ga Tãg tá", "NPT": "Óra Nẽpar tá", "NST": "Óra Pã Ga Tãg tá", "NZDT": "Rỹ Kã óra Jerỹnija Tãg tá", "NZST": "Óra Pã Jerỹnija Tãg tá", "OESZ": "Rỹ Kã óra Orópa Rãjur tá", "OEZ": "Óra Pã Orópa Rãjur tá", "PDT": "Rỹ Kã óra Rãpur tá", "PKT": "Rỹ Kã óra Pakinhtỹv tá", "PMDT": "Rỹ Kã óra Sỹ Pedro kar Mĩkerỹv tá", "PMST": "Óra Pã Sỹ Pedro kar Mĩkerỹv tá", "PST": "Óra Pã Rãpur tá", "PYST": "Rỹ Kã óra Paraguvaj tá", "SAST": "Sur-Afrika tá óra", "SGT": "Óra Pã Sĩgapura tá", "SRT": "Óra Surinỹmĩ tá", "TLT": "Óra Tĩmãr-Rãjur tá", "TMST": "Rỹ Kã óra Turkomẽnĩnhtỹv tá", "TMT": "Óra Pã Turkomẽnĩnhtỹv tá", "UYST": "Rỹ Kã óra Uruguvaj tá", "UYT": "Óra Pã Uruguvaj tá", "VET": "Óra Venẽjuvéra tá", "WARST": "Rỹ Kã óra Arjẽtĩnỹ Rãpurtá", "WART": "Óra Pã Arjẽtĩnỹ Rãpur tá", "WAST": "Rỹ Kã óra Afrika Rãpur tá", "WAT": "Óra Pã Afrika Rãpur tá", "WESZ": "Rỹ Kã óra Orópa Rãpur tá", "WEZ": "Óra Pã Orópa Rãpur tá", "WIB": "Óra Ĩnonẽja Rãpur tá", "WIT": "Óra Ĩnonẽja Rãjur tá", "WITA": "Óra Ĩnonẽja Kuju tá", "∅∅∅": "Rỹ Kã óra Piru tá"},
		},
		...
		dateFullLayout:   "EEEE, d 'ne' MMMM, y",
		dateLongLayout:   "d 'ne' MMMM, y",
		dateMediumLayout: "d 'ne' MMM, y",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} kar {1}", "{0}, {1}", "{0}, {1}", "{0} kar {1}"}, {"{0} ketũmỹr {1}", "{0}, {1}", "{0}, {1}", "{0} ketũmỹr {1}"}}),
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"+%[1]v",
			"≤%[1]v",
...
func (kgp *kgp_BR) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(kgp, kgp.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'kgp_BR'
func (kgp *kgp_BR) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(kgp, kgp.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'kgp_BR'
func (kgp *kgp_BR) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(kgp, kgp.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'kgp_BR'
func (kgp *kgp_BR) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(kgp, kgp.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'kgp_BR'
func (kgp *kgp_BR) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(kgp, kgp.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'kgp_BR'
func (kgp *kgp_BR) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(kgp, kgp.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'kgp_BR'
func (kgp *kgp_BR) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(kgp, kgp.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'kgp_BR'
func (kgp *kgp_BR) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(kgp, kgp.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'kgp_BR'
func (kgp *kgp_BR) DateFullLayout() string {
	return kgp.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kgp_BR'
func (kgp *kgp_BR) DateLongLayout() string {
	return kgp.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kgp_BR'
func (kgp *kgp_BR) DateMediumLayout() string {
	return kgp.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kgp_BR'
func (kgp *kgp_BR) DateShortLayout() string {
	return kgp.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kgp_BR'
func (kgp *kgp_BR) TimeFullLayout() string {
	return kgp.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kgp_BR'
func (kgp *kgp_BR) TimeLongLayout() string {
	return kgp.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kgp_BR'
func (kgp *kgp_BR) TimeMediumLayout() string {
	return kgp.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kgp_BR'
func (kgp *kgp_BR) TimeShortLayout() string {
	return kgp.timeShortLayout
}

func (kgp *kgp_BR) ListPatterns() *locales.ListPatterns {
	return kgp.listPatterns
}

func (kgp *kgp_BR) GetDurationSpec() *locales.DurationSpec {
	return kgp.DurationSpec
}

func (kgp *kgp_BR) GetMiscPatterns() *locales.MiscPatterns {
	return &kgp.miscPatterns
}
