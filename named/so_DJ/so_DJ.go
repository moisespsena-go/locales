...
// DateFullLayout returns the full date layout for 'so_DJ'
func (so *so_DJ) DateFullLayout() string {
	return so.dateFullLayout
}

// DateLongLayout returns the long date layout for 'so_DJ'
func (so *so_DJ) DateLongLayout() string {
	return so.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'so_DJ'
func (so *so_DJ) DateMediumLayout() string {
	return so.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'so_DJ'
func (so *so_DJ) DateShortLayout() string {
	return so.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'so_DJ'
func (so *so_DJ) TimeFullLayout() string {
	return so.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'so_DJ'
func (so *so_DJ) TimeLongLayout() string {
	return so.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'so_DJ'
func (so *so_DJ) TimeMediumLayout() string {
	return so.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'so_DJ'
func (so *so_DJ) TimeShortLayout() string {
	return so.timeShortLayout
}

func (so *so_DJ) ListPatterns() *locales.ListPatterns {
	return so.listPatterns
}

func (so *so_DJ) GetDurationSpec() *locales.DurationSpec {
	return so.DurationSpec
}

func (so *so_DJ) GetMiscPatterns() *locales.MiscPatterns {
