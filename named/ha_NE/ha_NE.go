...
// DateFullLayout returns the full date layout for 'ha_NE'
func (ha *ha_NE) DateFullLayout() string {
	return ha.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ha_NE'
func (ha *ha_NE) DateLongLayout() string {
	return ha.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ha_NE'
func (ha *ha_NE) DateMediumLayout() string {
	return ha.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ha_NE'
func (ha *ha_NE) DateShortLayout() string {
	return ha.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ha_NE'
func (ha *ha_NE) TimeFullLayout() string {
	return ha.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ha_NE'
func (ha *ha_NE) TimeLongLayout() string {
	return ha.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ha_NE'
func (ha *ha_NE) TimeMediumLayout() string {
	return ha.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ha_NE'
func (ha *ha_NE) TimeShortLayout() string {
	return ha.timeShortLayout
}

func (ha *ha_NE) ListPatterns() *locales.ListPatterns {
	return ha.listPatterns
}

func (ha *ha_NE) GetDurationSpec() *locales.DurationSpec {
	return ha.DurationSpec
}

func (ha *ha_NE) GetMiscPatterns() *locales.MiscPatterns {
