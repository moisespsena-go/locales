...
// DateFullLayout returns the full date layout for 'en_BW'
func (en *en_BW) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_BW'
func (en *en_BW) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_BW'
func (en *en_BW) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_BW'
func (en *en_BW) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_BW'
func (en *en_BW) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_BW'
func (en *en_BW) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_BW'
func (en *en_BW) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_BW'
func (en *en_BW) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_BW) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_BW) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_BW) GetMiscPatterns() *locales.MiscPatterns {
