...
// DateFullLayout returns the full date layout for 'haw_US'
func (haw *haw_US) DateFullLayout() string {
	return haw.dateFullLayout
}

// DateLongLayout returns the long date layout for 'haw_US'
func (haw *haw_US) DateLongLayout() string {
	return haw.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'haw_US'
func (haw *haw_US) DateMediumLayout() string {
	return haw.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'haw_US'
func (haw *haw_US) DateShortLayout() string {
	return haw.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'haw_US'
func (haw *haw_US) TimeFullLayout() string {
	return haw.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'haw_US'
func (haw *haw_US) TimeLongLayout() string {
	return haw.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'haw_US'
func (haw *haw_US) TimeMediumLayout() string {
	return haw.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'haw_US'
func (haw *haw_US) TimeShortLayout() string {
	return haw.timeShortLayout
}

func (haw *haw_US) ListPatterns() *locales.ListPatterns {
	return haw.listPatterns
}

func (haw *haw_US) GetDurationSpec() *locales.DurationSpec {
	return haw.DurationSpec
}

func (haw *haw_US) GetMiscPatterns() *locales.MiscPatterns {
