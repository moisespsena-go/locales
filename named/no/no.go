...
func New() locales.Translator {
	return &no{
		...
		TimeSpec: &locales.TimeSpec{
			...
			MonthsWideValue:          []string{"", "januar", "februar", "mars", "april", "mai", "juni", "juli", "august", "september", "oktober", "november", "desember"},
			...
			ErasWideValue:            []string{"før Kristus", "etter Kristus"},
			TimezonesValue:           map[string]string{"": "normaltid for Falklandsøyene", "ACDT": "sentralaustralsk sommertid", "ACST": "sentralaustralsk normaltid", "ACT": "Acre normaltid", "ACWDT": "vest-sentralaustralsk sommertid", "ACWST": "vest-sentralaustralsk normaltid", "ADT": "sommertid for den nordamerikanske atlanterhavskysten", "AEDT": "østaustralsk sommertid", "AEST": "østaustralsk normaltid", "AFT": "afghansk tid", "AKDT": "alaskisk sommertid", "AKST": "alaskisk normaltid", "AMST": "sommertid for Amazonas", "AMT": "normaltid for Amazonas", "ARST": "argentinsk sommertid", "ART": "argentinsk normaltid", "AST": "normaltid for den nordamerikanske atlanterhavskysten", "AWDT": "vestaustralsk sommertid", "AWST": "vestaustralsk normaltid", "BNT": "tidssone for Brunei Darussalam", "BOT": "boliviansk tid", "BRST": "sommertid for Brasilia", "BRT": "normaltid for Brasilia", "BST": "bangladeshisk sommertid", "BTT": "bhutansk tid", "CAT": "sentralafrikansk tid", "CCT": "tidssone for Kokosøyene", "CDT": "sommertid for det sentrale Nord-Amerika", "CDT (Kuba)": "cubansk sommertid", "CHADT": "sommertid for Chatham", "CHAST": "normaltid for Chatham", "CLST": "chilensk sommertid", "CLT": "chilensk normaltid", "COST": "colombiansk sommertid", "COT": "colombiansk normaltid", "CST": "normaltid for det sentrale Nord-Amerika", "CST (Kuba)": "cubansk normaltid", "CXT": "tidssone for Christmasøya", "ChST": "tidssone for Chamorro", "EASST": "sommertid for Påskeøya", "EAST": "normaltid for Påskeøya", "EAT": "østafrikansk tid", "ECT": "ecuadoriansk tid", "EDT": "sommertid for den nordamerikanske østkysten", "EGDT": "østgrønlandsk sommertid", "EGST": "østgrønlandsk normaltid", "EST": "normaltid for den nordamerikanske østkysten", "FKST": "sommertid for Falklandsøyene", "GALT": "tidssone for Galápagosøyene", "GFT": "tidssone for Fransk Guyana", "GMT": "Greenwich middeltid", "GST": "tidssone for Persiabukta", "GYT": "guyansk tid", "HADT": "sommertid for Hawaii og Aleutene", "HAST": "normaltid for Hawaii og Aleutene", "HENOMX": "sommertid for nordvestlige Mexico", "HEOG": "vestgrønlandsk sommertid", "HEPMX": "sommertid for den meksikanske Stillehavskysten", "HKST": "sommertid for Hongkong", "HKT": "normaltid for Hongkong", "HNNOMX": "normaltid for nordvestlige Mexico", "HNOG": "vestgrønlandsk normaltid", "HNPMX": "normaltid for den meksikanske Stillehavskysten", "ICT": "indokinesisk tid", "IRDT": "iransk sommertid", "IRST": "iransk normaltid", "IST": "indisk tid", "JDT": "japansk sommertid", "JST": "japansk normaltid", "LHDT": "sommertid for Lord Howe-øya", "LHST": "normaltid for Lord Howe-øya", "MDT": "Macau, sommertid", "MESZ": "sentraleuropeisk sommertid", "MEZ": "sentraleuropeisk normaltid", "MST": "Macau, standardtid", "MVT": "maldivisk tid", "MYT": "malaysisk tid", "NDT": "sommertid for Newfoundland", "NPT": "nepalsk tid", "NST": "normaltid for Newfoundland", "NZDT": "newzealandsk sommertid", "NZST": "newzealandsk normaltid", "OESZ": "østeuropeisk sommertid", "OEZ": "østeuropeisk normaltid", "PDT": "sommertid for den nordamerikanske Stillehavskysten", "PKT": "pakistansk sommertid", "PMDT": "sommertid for Saint-Pierre-et-Miquelon", "PMST": "normaltid for Saint-Pierre-et-Miquelon", "PST": "normaltid for den nordamerikanske Stillehavskysten", "PYST": "paraguayansk sommertid", "SAST": "sørafrikansk tid", "SGT": "singaporsk tid", "SRT": "surinamsk tid", "TLT": "østtimoresisk tid", "TMST": "turkmensk sommertid", "TMT": "turkmensk normaltid", "UYST": "uruguayansk sommertid", "UYT": "uruguayansk normaltid", "VET": "venezuelansk tid", "WARST": "vestargentinsk sommertid", "WART": "vestargentinsk normaltid", "WAST": "vestafrikansk sommertid", "WAT": "vestafrikansk normaltid", "WESZ": "vesteuropeisk sommertid", "WEZ": "vesteuropeisk normaltid", "WIB": "vestindonesisk tid", "WIT": "østindonesisk tid", "WITA": "sentralindonesisk tid", "∅∅∅": "peruansk sommertid"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"århundrer", "%v århundres", "%v århundrers", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"tiår", "%v tiår", "%v tiår", ""},
				Long:   &locales.CounterFormat{"tiår", "%v tiårs", "%v tiårs", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"måneder", "%v måneds", "%v måneders", "%v per måned"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"uke", "%vu", "%vu", "%v/u"},
				Long:   &locales.CounterFormat{"uker", "%v ukes", "%v ukers", "%v per uke"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"døgn", "%vd", "%vd", "%v/d"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"time", "%vt", "%vt", "%v/t"},
				Long:   &locales.CounterFormat{"timer", "%v times", "%v timers", "%v per time"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%vm", "%vm", "%v/m"},
				Long:   &locales.CounterFormat{"minutter", "%v minutts", "%v minutters", "%v per minutt"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
...
func (no *no) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(no, no.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'no'
func (no *no) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(no, no.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'no'
func (no *no) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(no, no.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'no'
func (no *no) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(no, no.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'no'
func (no *no) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(no, no.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'no'
func (no *no) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(no, no.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'no'
func (no *no) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(no, no.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'no'
func (no *no) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(no, no.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'no'
func (no *no) DateFullLayout() string {
	return no.dateFullLayout
}

// DateLongLayout returns the long date layout for 'no'
func (no *no) DateLongLayout() string {
	return no.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'no'
func (no *no) DateMediumLayout() string {
	return no.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'no'
func (no *no) DateShortLayout() string {
	return no.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'no'
func (no *no) TimeFullLayout() string {
	return no.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'no'
func (no *no) TimeLongLayout() string {
	return no.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'no'
func (no *no) TimeMediumLayout() string {
	return no.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'no'
func (no *no) TimeShortLayout() string {
	return no.timeShortLayout
}

func (no *no) ListPatterns() *locales.ListPatterns {
	return no.listPatterns
}

func (no *no) GetDurationSpec() *locales.DurationSpec {
	return no.DurationSpec
}

func (no *no) GetMiscPatterns() *locales.MiscPatterns {
	return &no.miscPatterns
}
