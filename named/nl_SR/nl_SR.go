...
// DateFullLayout returns the full date layout for 'nl_SR'
func (nl *nl_SR) DateFullLayout() string {
	return nl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'nl_SR'
func (nl *nl_SR) DateLongLayout() string {
	return nl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'nl_SR'
func (nl *nl_SR) DateMediumLayout() string {
	return nl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'nl_SR'
func (nl *nl_SR) DateShortLayout() string {
	return nl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'nl_SR'
func (nl *nl_SR) TimeFullLayout() string {
	return nl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'nl_SR'
func (nl *nl_SR) TimeLongLayout() string {
	return nl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'nl_SR'
func (nl *nl_SR) TimeMediumLayout() string {
	return nl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'nl_SR'
func (nl *nl_SR) TimeShortLayout() string {
	return nl.timeShortLayout
}

func (nl *nl_SR) ListPatterns() *locales.ListPatterns {
	return nl.listPatterns
}

func (nl *nl_SR) GetDurationSpec() *locales.DurationSpec {
	return nl.DurationSpec
}

func (nl *nl_SR) GetMiscPatterns() *locales.MiscPatterns {
