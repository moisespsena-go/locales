...
func New() locales.Translator {
	return &tr{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						...
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 Mr ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 Mr ¤"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 Mr ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 Mr ¤"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 Mr ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 Mr ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Oca", "Şub", "Mar", "Nis", "May", "Haz", "Tem", "Ağu", "Eyl", "Eki", "Kas", "Ara"},
			MonthsNarrowValue:        []string{"", "O", "Ş", "M", "N", "M", "H", "T", "A", "E", "E", "K", "A"},
			MonthsWideValue:          []string{"", "Ocak", "Şubat", "Mart", "Nisan", "Mayıs", "Haziran", "Temmuz", "Ağustos", "Eylül", "Ekim", "Kasım", "Aralık"},
			WeekdaysAbbreviatedValue: []string{"Paz", "Pzt", "Sal", "Çar", "Per", "Cum", "Cmt"},
			WeekdaysNarrowValue:      []string{"P", "P", "S", "Ç", "P", "C", "C"},
			WeekdaysShortValue:       []string{"Pa", "Pt", "Sa", "Ça", "Pe", "Cu", "Ct"},
			WeekdaysWideValue:        []string{"Pazar", "Pazartesi", "Salı", "Çarşamba", "Perşembe", "Cuma", "Cumartesi"},
			PeriodsAbbreviatedValue:  []string{"ÖÖ", "ÖS"},
			PeriodsNarrowValue:       []string{"öö", "ös"},
			PeriodsWideValue:         []string{"ÖÖ", "ÖS"},
			ErasAbbreviatedValue:     []string{"MÖ", "MS"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Milattan Önce", "Milattan Sonra"},
			TimezonesValue:           map[string]string{"": "Falkland Adaları Standart Saati", "ACDT": "Orta Avustralya Yaz Saati", "ACST": "Acre Yaz Saati", "ACT": "Acre Standart Saati", "ACWDT": "İç Batı Avustralya Yaz Saati", "ACWST": "İç Batı Avustralya Standart Saati", "ADT": "Atlantik Yaz Saati", "AEDT": "Doğu Avustralya Yaz Saati", "AEST": "Doğu Avustralya Standart Saati", "AFT": "Afganistan Saati", "AKDT": "Alaska Yaz Saati", "AKST": "Alaska Standart Saati", "AMST": "Amazon Yaz Saati", "AMT": "Amazon Standart Saati", "ARST": "Arjantin Yaz Saati", "ART": "Arjantin Standart Saati", "AST": "Atlantik Standart Saati", "AWDT": "Batı Avustralya Yaz Saati", "AWST": "Batı Avustralya Standart Saati", "BNT": "Brunei Darü’s-Selam Saati", "BOT": "Bolivya Saati", "BRST": "Brasilia Yaz Saati", "BRT": "Brasilia Standart Saati", "BST": "Bangladeş Yaz Saati", "BTT": "Butan Saati", "CAT": "Orta Afrika Saati", "CCT": "Cocos Adaları Saati", "CDT": "Kuzey Amerika Merkezi Yaz Saati", "CDT (Kuba)": "Küba Yaz Saati", "CHADT": "Chatham Yaz Saati", "CHAST": "Chatham Standart Saati", "CLST": "Şili Yaz Saati", "CLT": "Şili Standart Saati", "COST": "Kolombiya Yaz Saati", "COT": "Kolombiya Standart Saati", "CST": "Kuzey Amerika Merkezi Standart Saati", "CST (Kuba)": "Küba Standart Saati", "CXT": "Christmas Adası Saati", "ChST": "Chamorro Saati", "EASST": "Paskalya Adası Yaz Saati", "EAST": "Paskalya Adası Standart Saati", "EAT": "Doğu Afrika Saati", "ECT": "Ekvador Saati", "EDT": "Kuzey Amerika Doğu Yaz Saati", "EGDT": "Doğu Grönland Yaz Saati", "EGST": "Doğu Grönland Standart Saati", "EST": "Kuzey Amerika Doğu Standart Saati", "FKST": "Falkland Adaları Yaz Saati", "GALT": "Galapagos Saati", "GFT": "Fransız Guyanası Saati", "GMT": "Greenwich Ortalama Saati", "GST": "Körfez Saati", "GYT": "Guyana Saati", "HADT": "Hawaii-Aleut Yaz Saati", "HAST": "Hawaii-Aleut Standart Saati", "HENOMX": "Kuzeybatı Meksika Yaz Saati", "HEOG": "Batı Grönland Yaz Saati", "HEPMX": "Meksika Pasifik Kıyısı Yaz Saati", "HKST": "Hong Kong Yaz Saati", "HKT": "Hong Kong Standart Saati", "HNNOMX": "Kuzeybatı Meksika Standart Saati", "HNOG": "Batı Grönland Standart Saati", "HNPMX": "Meksika Pasifik Kıyısı Standart Saati", "ICT": "Hindiçin Saati", "IRDT": "İran Yaz Saati", "IRST": "İran Standart Saati", "IST": "Hindistan Standart Saati", "JDT": "Japonya Yaz Saati", "JST": "Japonya Standart Saati", "LHDT": "Lord Howe Yaz Saati", "LHST": "Lord Howe Standart Saati", "MDT": "Makao Yaz Saati", "MESZ": "Orta Avrupa Yaz Saati", "MEZ": "Orta Avrupa Standart Saati", "MST": "Makao Standart Saati", "MVT": "Maldivler Saati", "MYT": "Malezya Saati", "NDT": "Newfoundland Yaz Saati", "NPT": "Nepal Saati", "NST": "Newfoundland Standart Saati", "NZDT": "Yeni Zelanda Yaz Saati", "NZST": "Yeni Zelanda Standart Saati", "OESZ": "Doğu Avrupa Yaz Saati", "OEZ": "Doğu Avrupa Standart Saati", "PDT": "Kuzey Amerika Pasifik Yaz Saati", "PKT": "Pakistan Yaz Saati", "PMDT": "Saint Pierre ve Miquelon Yaz Saati", "PMST": "Saint Pierre ve Miquelon Standart Saati", "PST": "Kuzey Amerika Pasifik Standart Saati", "PYST": "Paraguay Yaz Saati", "SAST": "Güney Afrika Standart Saati", "SGT": "Singapur Standart Saati", "SRT": "Surinam Saati", "TLT": "Doğu Timor Saati", "TMST": "Türkmenistan Yaz Saati", "TMT": "Türkmenistan Standart Saati", "UYST": "Uruguay Yaz Saati", "UYT": "Uruguay Standart Saati", "VET": "Venezuela Saati", "WARST": "Batı Arjantin Yaz Saati", "WART": "Batı Arjantin Standart Saati", "WAST": "Batı Afrika Yaz Saati", "WAT": "Batı Afrika Standart Saati", "WESZ": "Batı Avrupa Yaz Saati", "WEZ": "Batı Avrupa Standart Saati", "WIB": "Batı Endonezya Saati", "WIT": "Doğu Endonezya Saati", "WITA": "Orta Endonezya Saati", "∅∅∅": "Azorlar Yaz Saati"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} ve {1}", "{0}, {1}", "{0}, {1}", "{0} ve {1}"}, {"{0} veya {1}", "{0}, {1}", "{0}, {1}", "{0} veya {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"yy", "%v yy", "%v yy", ""},
				Long:   &locales.CounterFormat{"yüzyıl", "%v yüzyıl", "%v yüzyıl", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"on yıl", "%v on yıl", "%v on yıl", ""},
				Long:   &locales.CounterFormat{"on yıl", "%v on yıl", "%v on yıl", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"yıl", "%vy", "%vy", "%v/y"},
				Long:   &locales.CounterFormat{"yıl", "%v yıl", "%v yıl", "%v/yıl"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ay", "%va", "%va", "%v/ay"},
				Long:   &locales.CounterFormat{"ay", "%v ay", "%v ay", "%v/ay"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"hafta", "%vh", "%vh", "%v/hf."},
				Long:   &locales.CounterFormat{"hafta", "%v hafta", "%v hafta", "%v/hafta"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"gün", "%vg", "%vg", "%v/g"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sa", "%v sa", "%vs", "%v/sa"},
				Long:   &locales.CounterFormat{"saat", "%v saat", "%v saat", "%v/saat"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dk", "%vd", "%vd", "%v/dk."},
				Long:   &locales.CounterFormat{"dakika", "%v dakika", "%v dakika", "%v/dakika"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sn", "%vsn", "%vsn", "%v/sn"},
				Long:   &locales.CounterFormat{"saniye", "%v saniye", "%v saniye", "%v/saniye"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"msn", "%vmsn", "%vmsn", ""},
				Long:   &locales.CounterFormat{"milisaniye", "%v milisaniye", "%v milisaniye", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μsn", "%v μsn", "%v μsn", ""},
				Long:   &locales.CounterFormat{"mikrosaniye", "%v mikrosaniye", "%v mikrosaniye", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"nsn", "%v nsn", "%v nsn", ""},
				Long:   &locales.CounterFormat{"nanosaniye", "%v nanosaniye", "%v nanosaniye", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (tr *tr) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(tr, tr.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'tr'
func (tr *tr) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(tr, tr.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'tr'
func (tr *tr) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(tr, tr.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'tr'
func (tr *tr) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(tr, tr.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'tr'
func (tr *tr) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(tr, tr.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'tr'
func (tr *tr) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(tr, tr.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'tr'
func (tr *tr) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(tr, tr.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'tr'
func (tr *tr) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(tr, tr.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'tr'
func (tr *tr) DateFullLayout() string {
	return tr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'tr'
func (tr *tr) DateLongLayout() string {
	return tr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'tr'
func (tr *tr) DateMediumLayout() string {
	return tr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'tr'
func (tr *tr) DateShortLayout() string {
	return tr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'tr'
func (tr *tr) TimeFullLayout() string {
	return tr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'tr'
func (tr *tr) TimeLongLayout() string {
	return tr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'tr'
func (tr *tr) TimeMediumLayout() string {
	return tr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'tr'
func (tr *tr) TimeShortLayout() string {
	return tr.timeShortLayout
}

func (tr *tr) ListPatterns() *locales.ListPatterns {
	return tr.listPatterns
}

func (tr *tr) GetDurationSpec() *locales.DurationSpec {
	return tr.DurationSpec
}

func (tr *tr) GetMiscPatterns() *locales.MiscPatterns {
	return &tr.miscPatterns
}
