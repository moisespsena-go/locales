...
// DateFullLayout returns the full date layout for 'fr_HT'
func (fr *fr_HT) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_HT'
func (fr *fr_HT) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_HT'
func (fr *fr_HT) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_HT'
func (fr *fr_HT) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_HT'
func (fr *fr_HT) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_HT'
func (fr *fr_HT) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_HT'
func (fr *fr_HT) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_HT'
func (fr *fr_HT) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_HT) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_HT) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_HT) GetMiscPatterns() *locales.MiscPatterns {
