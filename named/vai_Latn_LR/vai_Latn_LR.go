...
func New() locales.Translator {
	return &vai_Latn_LR{
		...
		TimeSpec: &locales.TimeSpec{
			...
			MonthsWideValue:        []string{"", "ꖨꖕ ꕪꕴ ꔞꔀꕮꕊ", "ꕒꕡꖝꖕ", "ꕾꖺ", "ꖢꖕ", "ꖑꕱ", "ꖱꘋ", "ꖱꕞꔤ", "ꗛꔕ", "ꕢꕌ", "ꕭꖃ", "ꔞꘋꕔꕿ ꕸꖃꗏ", "ꖨꖕ ꕪꕴ ꗏꖺꕮꕊ"},
			WeekdaysWideValue:      []string{"ꕞꕌꔵ", "ꗳꗡꘉ", "ꕚꕞꕚ", "ꕉꕞꕒ", "ꕉꔤꕆꕢ", "ꕉꔤꕀꕮ", "ꔻꔬꔳ"},
...
// DateFullLayout returns the full date layout for 'vai_Latn_LR'
func (vai *vai_Latn_LR) DateFullLayout() string {
	return vai.dateFullLayout
}

// DateLongLayout returns the long date layout for 'vai_Latn_LR'
func (vai *vai_Latn_LR) DateLongLayout() string {
	return vai.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'vai_Latn_LR'
func (vai *vai_Latn_LR) DateMediumLayout() string {
	return vai.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'vai_Latn_LR'
func (vai *vai_Latn_LR) DateShortLayout() string {
	return vai.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'vai_Latn_LR'
func (vai *vai_Latn_LR) TimeFullLayout() string {
	return vai.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'vai_Latn_LR'
func (vai *vai_Latn_LR) TimeLongLayout() string {
	return vai.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'vai_Latn_LR'
func (vai *vai_Latn_LR) TimeMediumLayout() string {
	return vai.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'vai_Latn_LR'
func (vai *vai_Latn_LR) TimeShortLayout() string {
	return vai.timeShortLayout
}

func (vai *vai_Latn_LR) ListPatterns() *locales.ListPatterns {
	return vai.listPatterns
}

func (vai *vai_Latn_LR) GetDurationSpec() *locales.DurationSpec {
	return vai.DurationSpec
}

func (vai *vai_Latn_LR) GetMiscPatterns() *locales.MiscPatterns {
