...
// DateFullLayout returns the full date layout for 'en_JE'
func (en *en_JE) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_JE'
func (en *en_JE) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_JE'
func (en *en_JE) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_JE'
func (en *en_JE) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_JE'
func (en *en_JE) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_JE'
func (en *en_JE) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_JE'
func (en *en_JE) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_JE'
func (en *en_JE) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_JE) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_JE) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_JE) GetMiscPatterns() *locales.MiscPatterns {
