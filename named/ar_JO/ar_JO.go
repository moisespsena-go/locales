...
// DateFullLayout returns the full date layout for 'ar_JO'
func (ar *ar_JO) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_JO'
func (ar *ar_JO) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_JO'
func (ar *ar_JO) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_JO'
func (ar *ar_JO) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_JO'
func (ar *ar_JO) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_JO'
func (ar *ar_JO) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_JO'
func (ar *ar_JO) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_JO'
func (ar *ar_JO) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_JO) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_JO) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_JO) GetMiscPatterns() *locales.MiscPatterns {
