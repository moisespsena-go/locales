...
func New() locales.Translator {
	return &es_419{
		...
		TimeSpec: &locales.TimeSpec{
			...
			TimezonesValue:           map[string]string{"": "hora estándar de las Islas Malvinas", "ACDT": "hora de verano de Australia central", "ACST": "Hora de verano de Acre", "ACT": "Hora estándar de Acre", "ACWDT": "hora de verano de Australia centroccidental", "ACWST": "hora estándar de Australia centroccidental", "ADT": "hora de verano del Atlántico", "AEDT": "hora de verano de Australia oriental", "AEST": "hora estándar de Australia oriental", "AFT": "hora de Afganistán", "AKDT": "hora de verano de Alaska", "AKST": "hora estándar de Alaska", "AMST": "hora de verano del Amazonas", "AMT": "hora estándar del Amazonas", "ARST": "hora de verano de Argentina", "ART": "hora estándar de Argentina", "AST": "hora estándar del Atlántico", "AWDT": "hora de verano de Australia occidental", "AWST": "hora estándar de Australia occidental", "BNT": "hora de Brunéi", "BOT": "hora de Bolivia", "BRST": "hora de verano de Brasilia", "BRT": "hora estándar de Brasilia", "BST": "hora de verano de Bangladés", "BTT": "hora de Bután", "CAT": "hora de África central", "CCT": "hora de Islas Cocos", "CDT": "hora de verano central", "CDT (Kuba)": "hora de verano de Cuba", "CHADT": "hora de verano de Chatham", "CHAST": "hora estándar de Chatham", "CLST": "hora de verano de Chile", "CLT": "hora estándar de Chile", "COST": "hora de verano de Colombia", "COT": "hora estándar de Colombia", "CST": "hora estándar central", "CST (Kuba)": "hora estándar de Cuba", "CXT": "hora de la Isla de Navidad", "ChST": "hora estándar de Chamorro", "EASST": "hora de verano de la Isla de Pascua", "EAST": "hora estándar de Isla de Pascua", "EAT": "hora de África oriental", "ECT": "hora de Ecuador", "EDT": "hora de verano oriental", "EGDT": "hora de verano de Groenlandia oriental", "EGST": "hora estándar de Groenlandia oriental", "EST": "hora estándar oriental", "FKST": "hora de verano de las Islas Malvinas", "GALT": "hora de Galápagos", "GFT": "hora de la Guayana Francesa", "GMT": "hora del meridiano de Greenwich", "GST": "hora estándar del Golfo", "GYT": "hora de Guyana", "HADT": "hora de verano de Hawái-Aleutianas", "HAST": "hora estándar de Hawái-Aleutianas", "HENOMX": "hora de verano del noroeste de México", "HEOG": "hora de verano de Groenlandia occidental", "HEPMX": "hora de verano del Pacífico de México", "HKST": "hora de verano de Hong Kong", "HKT": "hora estándar de Hong Kong", "HNNOMX": "hora estándar del noroeste de México", "HNOG": "hora estándar de Groenlandia occidental", "HNPMX": "hora estándar del Pacífico de México", "ICT": "hora de Indochina", "IRDT": "hora de verano de Irán", "IRST": "hora estándar de Irán", "IST": "hora de India", "JDT": "hora de verano de Japón", "JST": "hora estándar de Japón", "LHDT": "hora de verano de Lord Howe", "LHST": "hora estándar de Lord Howe", "MDT": "Hora de verano de Macao", "MESZ": "hora de verano de Europa central", "MEZ": "hora estándar de Europa central", "MST": "Hora estándar de Macao", "MVT": "hora de Maldivas", "MYT": "hora de Malasia", "NDT": "hora de verano de Terranova", "NPT": "hora de Nepal", "NST": "hora estándar de Terranova", "NZDT": "hora de verano de Nueva Zelanda", "NZST": "hora estándar de Nueva Zelanda", "OESZ": "hora de verano de Europa del Este", "OEZ": "hora estándar de Europa del Este", "PDT": "hora de verano del Pacífico", "PKT": "hora de verano de Pakistán", "PMDT": "hora de verano de San Pedro y Miquelón", "PMST": "hora estándar de San Pedro y Miquelón", "PST": "hora estándar del Pacífico", "PYST": "hora de verano de Paraguay", "SAST": "hora de Sudáfrica", "SGT": "hora de Singapur", "SRT": "hora de Surinam", "TLT": "hora de Timor Oriental", "TMST": "hora de verano de Turkmenistán", "TMT": "hora estándar de Turkmenistán", "UYST": "hora de verano de Uruguay", "UYT": "hora estándar de Uruguay", "VET": "hora de Venezuela", "WARST": "hora de verano de Argentina occidental", "WART": "hora estándar de Argentina occidental", "WAST": "hora de verano de África occidental", "WAT": "hora estándar de África occidental", "WESZ": "hora de verano de Europa del Oeste", "WEZ": "hora estándar de Europa del Oeste", "WIB": "hora de Indonesia occidental", "WIT": "hora de Indonesia oriental", "WITA": "hora de Indonesia central", "∅∅∅": "hora de verano de Perú"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"a.", "%va.", "%vaa.", ""},
				Long:   &locales.CounterFormat{"aa.", "%v a.", "%v aa.", "%v/a."}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m.", "%vm.", "%vmm.", "%v/m."},
				Long:   &locales.CounterFormat{"mm.", "%v m.", "%v mm.", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sem.", "%vsem.", "%vsems.", "%v/sem."},
				Long:   &locales.CounterFormat{"sems.", "%v sem.", "%v sems.", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"d.", "%vd.", "%vdd.", "%v/d."}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "%vm", "%vm", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
...
// DateFullLayout returns the full date layout for 'es_419'
func (es *es_419) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_419'
func (es *es_419) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_419'
func (es *es_419) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_419'
func (es *es_419) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_419'
func (es *es_419) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_419'
func (es *es_419) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_419'
func (es *es_419) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_419'
func (es *es_419) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_419) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_419) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_419) GetMiscPatterns() *locales.MiscPatterns {
