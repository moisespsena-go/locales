...
func New() locales.Translator {
	return &zh_Hans_SG{
		...
		timeFullLayout:   "zzzz ah:mm:ss",
		timeLongLayout:   "z ah:mm:ss",
...
// DateFullLayout returns the full date layout for 'zh_Hans_SG'
func (zh *zh_Hans_SG) DateFullLayout() string {
	return zh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'zh_Hans_SG'
func (zh *zh_Hans_SG) DateLongLayout() string {
	return zh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'zh_Hans_SG'
func (zh *zh_Hans_SG) DateMediumLayout() string {
	return zh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'zh_Hans_SG'
func (zh *zh_Hans_SG) DateShortLayout() string {
	return zh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'zh_Hans_SG'
func (zh *zh_Hans_SG) TimeFullLayout() string {
	return zh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'zh_Hans_SG'
func (zh *zh_Hans_SG) TimeLongLayout() string {
	return zh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'zh_Hans_SG'
func (zh *zh_Hans_SG) TimeMediumLayout() string {
	return zh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'zh_Hans_SG'
func (zh *zh_Hans_SG) TimeShortLayout() string {
	return zh.timeShortLayout
}

func (zh *zh_Hans_SG) ListPatterns() *locales.ListPatterns {
	return zh.listPatterns
}

func (zh *zh_Hans_SG) GetDurationSpec() *locales.DurationSpec {
	return zh.DurationSpec
}

func (zh *zh_Hans_SG) GetMiscPatterns() *locales.MiscPatterns {
