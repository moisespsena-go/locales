...
// DateFullLayout returns the full date layout for 'uz_Latn'
func (uz *uz_Latn) DateFullLayout() string {
	return uz.dateFullLayout
}

// DateLongLayout returns the long date layout for 'uz_Latn'
func (uz *uz_Latn) DateLongLayout() string {
	return uz.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'uz_Latn'
func (uz *uz_Latn) DateMediumLayout() string {
	return uz.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'uz_Latn'
func (uz *uz_Latn) DateShortLayout() string {
	return uz.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'uz_Latn'
func (uz *uz_Latn) TimeFullLayout() string {
	return uz.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'uz_Latn'
func (uz *uz_Latn) TimeLongLayout() string {
	return uz.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'uz_Latn'
func (uz *uz_Latn) TimeMediumLayout() string {
	return uz.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'uz_Latn'
func (uz *uz_Latn) TimeShortLayout() string {
	return uz.timeShortLayout
}

func (uz *uz_Latn) ListPatterns() *locales.ListPatterns {
	return uz.listPatterns
}

func (uz *uz_Latn) GetDurationSpec() *locales.DurationSpec {
	return uz.DurationSpec
}

func (uz *uz_Latn) GetMiscPatterns() *locales.MiscPatterns {
