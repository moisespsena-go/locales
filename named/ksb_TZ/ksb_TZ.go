...
func New() locales.Translator {
	return &ksb_TZ{
		...
		TimeSpec: &locales.TimeSpec{
			...
			MonthsWideValue:          []string{"", "Januali", "Febluali", "Machi", "Aplili", "Mei", "Juni", "Julai", "Agosti", "Septemba", "Oktoba", "Novemba", "Desemba"},
			WeekdaysAbbreviatedValue: []string{"Jpi", "Jtt", "Jmn", "Jtn", "Alh", "Iju", "Jmo"},
			WeekdaysNarrowValue:      []string{"2", "3", "4", "5", "A", "I", "1"},
			WeekdaysWideValue:        []string{"Jumaapii", "Jumaatatu", "Jumaane", "Jumaatano", "Alhamisi", "Ijumaa", "Jumaamosi"},
			PeriodsAbbreviatedValue:  []string{"makeo", "nyiaghuo"},
			PeriodsWideValue:         []string{"makeo", "nyiaghuo"},
			ErasAbbreviatedValue:     []string{"KK", "BK"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Kabla ya Klisto", "Baada ya Klisto"},
...
func (ksb *ksb_TZ) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ksb, ksb.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ksb_TZ'
func (ksb *ksb_TZ) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ksb, ksb.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ksb_TZ'
func (ksb *ksb_TZ) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ksb, ksb.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ksb_TZ'
func (ksb *ksb_TZ) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ksb, ksb.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ksb_TZ'
func (ksb *ksb_TZ) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ksb, ksb.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ksb_TZ'
func (ksb *ksb_TZ) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ksb, ksb.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ksb_TZ'
func (ksb *ksb_TZ) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ksb, ksb.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ksb_TZ'
func (ksb *ksb_TZ) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ksb, ksb.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ksb_TZ'
func (ksb *ksb_TZ) DateFullLayout() string {
	return ksb.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ksb_TZ'
func (ksb *ksb_TZ) DateLongLayout() string {
	return ksb.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ksb_TZ'
func (ksb *ksb_TZ) DateMediumLayout() string {
	return ksb.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ksb_TZ'
func (ksb *ksb_TZ) DateShortLayout() string {
	return ksb.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ksb_TZ'
func (ksb *ksb_TZ) TimeFullLayout() string {
	return ksb.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ksb_TZ'
func (ksb *ksb_TZ) TimeLongLayout() string {
	return ksb.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ksb_TZ'
func (ksb *ksb_TZ) TimeMediumLayout() string {
	return ksb.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ksb_TZ'
func (ksb *ksb_TZ) TimeShortLayout() string {
	return ksb.timeShortLayout
}

func (ksb *ksb_TZ) ListPatterns() *locales.ListPatterns {
	return ksb.listPatterns
}

func (ksb *ksb_TZ) GetDurationSpec() *locales.DurationSpec {
	return ksb.DurationSpec
}

func (ksb *ksb_TZ) GetMiscPatterns() *locales.MiscPatterns {
	return &ksb.miscPatterns
}
