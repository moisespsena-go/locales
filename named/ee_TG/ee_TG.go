...
// DateFullLayout returns the full date layout for 'ee_TG'
func (ee *ee_TG) DateFullLayout() string {
	return ee.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ee_TG'
func (ee *ee_TG) DateLongLayout() string {
	return ee.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ee_TG'
func (ee *ee_TG) DateMediumLayout() string {
	return ee.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ee_TG'
func (ee *ee_TG) DateShortLayout() string {
	return ee.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ee_TG'
func (ee *ee_TG) TimeFullLayout() string {
	return ee.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ee_TG'
func (ee *ee_TG) TimeLongLayout() string {
	return ee.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ee_TG'
func (ee *ee_TG) TimeMediumLayout() string {
	return ee.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ee_TG'
func (ee *ee_TG) TimeShortLayout() string {
	return ee.timeShortLayout
}

func (ee *ee_TG) ListPatterns() *locales.ListPatterns {
	return ee.listPatterns
}

func (ee *ee_TG) GetDurationSpec() *locales.DurationSpec {
	return ee.DurationSpec
}

func (ee *ee_TG) GetMiscPatterns() *locales.MiscPatterns {
