...
func New() locales.Translator {
	return &id_ID{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 rb"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 rb"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000 rb"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 jt"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 jt"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000 jt"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ".",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mar", "Apr", "Mei", "Jun", "Jul", "Agu", "Sep", "Okt", "Nov", "Des"},
			...
			WeekdaysAbbreviatedValue: []string{"Min", "Sen", "Sel", "Rab", "Kam", "Jum", "Sab"},
			WeekdaysNarrowValue:      []string{"M", "S", "S", "R", "K", "J", "S"},
			WeekdaysShortValue:       []string{"Min", "Sen", "Sel", "Rab", "Kam", "Jum", "Sab"},
			WeekdaysWideValue:        []string{"Minggu", "Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu"},
			...
			ErasNarrowValue:          []string{"SM", "M"},
			ErasWideValue:            []string{"Sebelum Masehi", "Masehi"},
			TimezonesValue:           map[string]string{"": "Waktu Standar Kepulauan Falkland", "ACDT": "Waktu Musim Panas Tengah Australia", "ACST": "Waktu Standar Tengah Australia", "ACT": "Waktu Standar Acre", "ACWDT": "Waktu Musim Panas Barat Tengah Australia", "ACWST": "Waktu Standar Barat Tengah Australia", "ADT": "Waktu Musim Panas Atlantik", "AEDT": "Waktu Musim Panas Timur Australia", "AEST": "Waktu Standar Timur Australia", "AFT": "Waktu Afganistan", "AKDT": "Waktu Musim Panas Alaska", "AKST": "Waktu Standar Alaska", "AMST": "Waktu Musim Panas Amazon", "AMT": "Waktu Standar Amazon", "ARST": "Waktu Musim Panas Argentina", "ART": "Waktu Standar Argentina", "AST": "Waktu Standar Atlantik", "AWDT": "Waktu Musim Panas Barat Australia", "AWST": "Waktu Standar Barat Australia", "BNT": "Waktu Brunei Darussalam", "BOT": "Waktu Bolivia", "BRST": "Waktu Musim Panas Brasil", "BRT": "Waktu Standar Brasil", "BST": "Waktu Musim Panas Bangladesh", "BTT": "Waktu Bhutan", "CAT": "Waktu Afrika Tengah", "CCT": "Waktu Kepulauan Cocos", "CDT": "Waktu Musim Panas Tengah", "CDT (Kuba)": "Waktu Musim Panas Kuba", "CHADT": "Waktu Musim Panas Chatham", "CHAST": "Waktu Standar Chatham", "CLST": "Waktu Musim Panas Cile", "CLT": "Waktu Standar Cile", "COST": "Waktu Musim Panas Kolombia", "COT": "Waktu Standar Kolombia", "CST": "Waktu Standar Tengah", "CST (Kuba)": "Waktu Standar Kuba", "CXT": "Waktu Pulau Natal", "ChST": "Waktu Standar Chamorro", "EASST": "Waktu Musim Panas Pulau Paskah", "EAST": "Waktu Standar Pulau Paskah", "EAT": "Waktu Afrika Timur", "ECT": "Waktu Ekuador", "EDT": "Waktu Musim Panas Timur", "EGDT": "Waktu Musim Panas Greenland Timur", "EGST": "Waktu Standar Greenland Timur", "EST": "Waktu Standar Timur", "FKST": "Waktu Musim Panas Kepulauan Falkland", "GALT": "Waktu Galapagos", "GFT": "Waktu Guyana Prancis", "GMT": "Greenwich Mean Time", "GST": "Waktu Standar Teluk", "GYT": "Waktu Guyana", "HADT": "Waktu Musim Panas Hawaii-Aleutian", "HAST": "Waktu Standar Hawaii-Aleutian", "HENOMX": "Waktu Musim Panas Meksiko Barat Laut", "HEOG": "Waktu Musim Panas Greenland Barat", "HEPMX": "Waktu Musim Panas Pasifik Meksiko", "HKST": "Waktu Musim Panas Hong Kong", "HKT": "Waktu Standar Hong Kong", "HNNOMX": "Waktu Standar Meksiko Barat Laut", "HNOG": "Waktu Standar Greenland Barat", "HNPMX": "Waktu Standar Pasifik Meksiko", "ICT": "Waktu Indochina", "IRDT": "Waktu Musim Panas Iran", "IRST": "Waktu Standar Iran", "IST": "Waktu India", "JDT": "Waktu Musim Panas Jepang", "JST": "Waktu Standar Jepang", "LHDT": "Waktu Musim Panas Lord Howe", "LHST": "Waktu Standar Lord Howe", "MDT": "Waktu Musim Panas Makau", "MESZ": "Waktu Musim Panas Eropa Tengah", "MEZ": "Waktu Standar Eropa Tengah", "MST": "Waktu Standar Makau", "MVT": "Waktu Maladewa", "MYT": "Waktu Malaysia", "NDT": "Waktu Musim Panas Newfoundland", "NPT": "Waktu Nepal", "NST": "Waktu Standar Newfoundland", "NZDT": "Waktu Musim Panas Selandia Baru", "NZST": "Waktu Standar Selandia Baru", "OESZ": "Waktu Musim Panas Eropa Timur", "OEZ": "Waktu Standar Eropa Timur", "PDT": "Waktu Musim Panas Pasifik", "PKT": "Waktu Musim Panas Pakistan", "PMDT": "Waktu Musim Panas Saint Pierre dan Miquelon", "PMST": "Waktu Standar Saint Pierre dan Miquelon", "PST": "Waktu Standar Pasifik", "PYST": "Waktu Musim Panas Paraguay", "SAST": "Waktu Standar Afrika Selatan", "SGT": "Waktu Standar Singapura", "SRT": "Waktu Suriname", "TLT": "Waktu Timor Leste", "TMST": "Waktu Musim Panas Turkmenistan", "TMT": "Waktu Standar Turkmenistan", "UYST": "Waktu Musim Panas Uruguay", "UYT": "Waktu Standar Uruguay", "VET": "Waktu Venezuela", "WARST": "Waktu Musim Panas Argentina Bagian Barat", "WART": "Waktu Standar Argentina Bagian Barat", "WAST": "Waktu Musim Panas Afrika Barat", "WAT": "Waktu Standar Afrika Barat", "WESZ": "Waktu Musim Panas Eropa Barat", "WEZ": "Waktu Standar Eropa Barat", "WIB": "Waktu Indonesia Barat", "WIT": "Waktu Indonesia Timur", "WITA": "Waktu Indonesia Tengah", "∅∅∅": "Waktu Musim Panas Peru"},
		},
...
func (id *id_ID) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(id, id.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'id_ID'
func (id *id_ID) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(id, id.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'id_ID'
func (id *id_ID) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(id, id.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'id_ID'
func (id *id_ID) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(id, id.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'id_ID'
func (id *id_ID) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(id, id.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'id_ID'
func (id *id_ID) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(id, id.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'id_ID'
func (id *id_ID) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(id, id.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'id_ID'
func (id *id_ID) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(id, id.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'id_ID'
func (id *id_ID) DateFullLayout() string {
	return id.dateFullLayout
}

// DateLongLayout returns the long date layout for 'id_ID'
func (id *id_ID) DateLongLayout() string {
	return id.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'id_ID'
func (id *id_ID) DateMediumLayout() string {
	return id.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'id_ID'
func (id *id_ID) DateShortLayout() string {
	return id.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'id_ID'
func (id *id_ID) TimeFullLayout() string {
	return id.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'id_ID'
func (id *id_ID) TimeLongLayout() string {
	return id.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'id_ID'
func (id *id_ID) TimeMediumLayout() string {
	return id.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'id_ID'
func (id *id_ID) TimeShortLayout() string {
	return id.timeShortLayout
}

func (id *id_ID) ListPatterns() *locales.ListPatterns {
	return id.listPatterns
}

func (id *id_ID) GetDurationSpec() *locales.DurationSpec {
	return id.DurationSpec
}

func (id *id_ID) GetMiscPatterns() *locales.MiscPatterns {
	return &id.miscPatterns
}
