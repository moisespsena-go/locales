...
// DateFullLayout returns the full date layout for 'en_FK'
func (en *en_FK) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_FK'
func (en *en_FK) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_FK'
func (en *en_FK) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_FK'
func (en *en_FK) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_FK'
func (en *en_FK) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_FK'
func (en *en_FK) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_FK'
func (en *en_FK) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_FK'
func (en *en_FK) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_FK) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_FK) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_FK) GetMiscPatterns() *locales.MiscPatterns {
