...
// DateFullLayout returns the full date layout for 'it_IT'
func (it *it_IT) DateFullLayout() string {
	return it.dateFullLayout
}

// DateLongLayout returns the long date layout for 'it_IT'
func (it *it_IT) DateLongLayout() string {
	return it.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'it_IT'
func (it *it_IT) DateMediumLayout() string {
	return it.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'it_IT'
func (it *it_IT) DateShortLayout() string {
	return it.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'it_IT'
func (it *it_IT) TimeFullLayout() string {
	return it.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'it_IT'
func (it *it_IT) TimeLongLayout() string {
	return it.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'it_IT'
func (it *it_IT) TimeMediumLayout() string {
	return it.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'it_IT'
func (it *it_IT) TimeShortLayout() string {
	return it.timeShortLayout
}

func (it *it_IT) ListPatterns() *locales.ListPatterns {
	return it.listPatterns
}

func (it *it_IT) GetDurationSpec() *locales.DurationSpec {
	return it.DurationSpec
}

func (it *it_IT) GetMiscPatterns() *locales.MiscPatterns {
