...
func New() locales.Translator {
	return &uz{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "yan", "fev", "mar", "apr", "may", "iyn", "iyl", "avg", "sen", "okt", "noy", "dek"},
			MonthsNarrowValue:        []string{"", "Y", "F", "M", "A", "M", "I", "I", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "yanvar", "fevral", "mart", "aprel", "may", "iyun", "iyul", "avgust", "sentabr", "oktabr", "noyabr", "dekabr"},
			WeekdaysAbbreviatedValue: []string{"Yak", "Dush", "Sesh", "Chor", "Pay", "Jum", "Shan"},
			WeekdaysNarrowValue:      []string{"Y", "D", "S", "C", "P", "J", "S"},
			WeekdaysShortValue:       []string{"Ya", "Du", "Se", "Ch", "Pa", "Ju", "Sh"},
			WeekdaysWideValue:        []string{"yakshanba", "dushanba", "seshanba", "chorshanba", "payshanba", "juma", "shanba"},
			PeriodsAbbreviatedValue:  []string{"TO", "TK"},
			PeriodsNarrowValue:       []string{"TO", "TK"},
			PeriodsWideValue:         []string{"TO", "TK"},
			ErasAbbreviatedValue:     []string{"m.a.", "milodiy"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"miloddan avvalgi", "milodiy"},
			TimezonesValue:           map[string]string{"": "Folklend orollari standart vaqti", "ACDT": "Markaziy Avstraliya yozgi vaqti", "ACST": "Markaziy Avstraliya standart vaqti", "ACT": "ACT", "ACWDT": "Markaziy Avstraliya g‘arbiy yozgi vaqti", "ACWST": "Markaziy Avstraliya g‘arbiy standart vaqti", "ADT": "Atlantika yozgi vaqti", "AEDT": "Sharqiy Avstraliya yozgi vaqti", "AEST": "Sharqiy Avstraliya standart vaqti", "AFT": "Afgʻoniston vaqti", "AKDT": "Alyaska yozgi vaqti", "AKST": "Alyaska standart vaqti", "AMST": "Amazonka yozgi vaqti", "AMT": "Amazonka standart vaqti", "ARST": "Argentina yozgi vaqti", "ART": "Argentina standart vaqti", "AST": "Atlantika standart vaqti", "AWDT": "G‘arbiy Avstraliya yozgi vaqti", "AWST": "G‘arbiy Avstraliya standart vaqti", "BNT": "Bruney-Dorussalom vaqti", "BOT": "Boliviya vaqti", "BRST": "Braziliya yozgi vaqti", "BRT": "Braziliya standart vaqti", "BST": "Bangladesh yozgi vaqti", "BTT": "Butan vaqti", "CAT": "Markaziy Afrika vaqti", "CCT": "Kokos orollari vaqti", "CDT": "Markaziy Amerika yozgi vaqti", "CDT (Kuba)": "Kuba yozgi vaqti", "CHADT": "Chatem yozgi vaqti", "CHAST": "Chatem standart vaqti", "CLST": "Chili yozgi vaqti", "CLT": "Chili standart vaqti", "COST": "Kolumbiya yozgi vaqti", "COT": "Kolumbiya standart vaqti", "CST": "Markaziy Amerika standart vaqti", "CST (Kuba)": "Kuba standart vaqti", "CXT": "Rojdestvo oroli vaqti", "ChST": "Chamorro standart vaqti", "EASST": "Pasxa oroli yozgi vaqti", "EAST": "Pasxa oroli standart vaqti", "EAT": "Sharqiy Afrika vaqti", "ECT": "Ekvador vaqti", "EDT": "Sharqiy Amerika yozgi vaqti", "EGDT": "Sharqiy Grenlandiya yozgi vaqti", "EGST": "Sharqiy Grenlandiya standart vaqti", "EST": "Sharqiy Amerika standart vaqti", "FKST": "Folklend orollari yozgi vaqti", "GALT": "Galapagos vaqti", "GFT": "Fransuz Gvianasi vaqti", "GMT": "Grinvich o‘rtacha vaqti", "GST": "Fors ko‘rfazi standart vaqti", "GYT": "Gayana vaqti", "HADT": "Gavayi-aleut yozgi vaqti", "HAST": "Gavayi-aleut standart vaqti", "HENOMX": "Shimoli-g‘arbiy Meksika yozgi vaqti", "HEOG": "G‘arbiy Grenlandiya yozgi vaqti", "HEPMX": "Meksika Tinch okeani yozgi vaqti", "HKST": "Gonkong yozgi vaqti", "HKT": "Gonkong standart vaqti", "HNNOMX": "Shimoli-g‘arbiy Meksika standart vaqti", "HNOG": "G‘arbiy Grenlandiya standart vaqti", "HNPMX": "Meksika Tinch okeani standart vaqti", "ICT": "Hindixitoy vaqti", "IRDT": "Eron yozgi vaqti", "IRST": "Eron standart vaqti", "IST": "Hindiston standart vaqti", "JDT": "Yaponiya yozgi vaqti", "JST": "Yaponiya standart vaqti", "LHDT": "Lord-Xau yozgi vaqti", "LHST": "Lord-Xau standart vaqti", "MDT": "MDT", "MESZ": "Markaziy Yevropa yozgi vaqti", "MEZ": "Markaziy Yevropa standart vaqti", "MST": "MST", "MVT": "Maldiv orollari vaqti", "MYT": "Malayziya vaqti", "NDT": "Nyufaundlend yozgi vaqti", "NPT": "Nepal vaqti", "NST": "Nyufaundlend standart vaqti", "NZDT": "Yangi Zelandiya yozgi vaqti", "NZST": "Yangi Zelandiya standart vaqti", "OESZ": "Sharqiy Yevropa yozgi vaqti", "OEZ": "Sharqiy Yevropa standart vaqti", "PDT": "Tinch okeani yozgi vaqti", "PKT": "Pokiston yozgi vaqti", "PMDT": "Sen-Pyer va Mikelon yozgi vaqti", "PMST": "Sen-Pyer va Mikelon standart vaqti", "PST": "Tinch okeani standart vaqti", "PYST": "Paragvay yozgi vaqti", "SAST": "Janubiy Afrika standart vaqti", "SGT": "Singapur vaqti", "SRT": "Surinam vaqti", "TLT": "Sharqiy Timor vaqti", "TMST": "Turkmaniston yozgi vaqti", "TMT": "Turkmaniston standart vaqti", "UYST": "Urugvay yozgi vaqti", "UYT": "Urugvay standart vaqti", "VET": "Venesuela vaqti", "WARST": "Gʻarbiy Argentina yozgi vaqti", "WART": "Gʻarbiy Argentina standart vaqti", "WAST": "Gʻarbiy Afrika yozgi vaqti", "WAT": "Gʻarbiy Afrika standart vaqti", "WESZ": "G‘arbiy Yevropa yozgi vaqti", "WEZ": "G‘arbiy Yevropa standart vaqti", "WIB": "Gʻarbiy Indoneziya vaqti", "WIT": "Sharqiy Indoneziya vaqti", "WITA": "Markaziy Indoneziya vaqti", "∅∅∅": "Peru yozgi vaqti"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} va {1}", "{0}, {1}", "{0}, {1}", "{0} va {1}"}, {"{0} yoki {1}", "{0}, {1}", "{0}, {1}", "{0} yoki {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"asr", "%v asr", "%v asr", ""},
				Long:   &locales.CounterFormat{"asr", "%v asr", "%v asr", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dekada", "%v dekada", "%v dekada", ""},
				Long:   &locales.CounterFormat{"dekada", "%v dekada", "%v dekada", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"yil", "%v yil", "%v yil", ""},
				Long:   &locales.CounterFormat{"yil", "%v yil", "%v yil", "%v/yil"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"oy", "%v oy", "%v oy", ""},
				Long:   &locales.CounterFormat{"oy", "%v oy", "%v oy", "%v/oy"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"hafta", "%v hafta", "%v hafta", ""},
				Long:   &locales.CounterFormat{"hafta", "%v hafta", "%v hafta", "%v/hafta"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"kun", "%v kun", "%v kun", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"soat", "%v soat", "%v soat", ""},
				Long:   &locales.CounterFormat{"soat", "%v soat", "%v soat", "%v/soat"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"daq.", "%v daq.", "%v daq.", ""},
				Long:   &locales.CounterFormat{"daqiqa", "%v daqiqa", "%v daqiqa", "%v/daqiqa"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"son.", "%v s", "%v s", ""},
				Long:   &locales.CounterFormat{"soniya", "%v soniya", "%v soniya", "%v/soniya"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mson", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"millisoniya", "%v millisoniya", "%v millisoniya", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mks", "%v mks", "%v mks", ""},
				Long:   &locales.CounterFormat{"mikrosoniya", "%v mikrosoniya", "%v mikrosoniya", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"nanosoniya", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosoniya", "%v nanosoniya", "%v nanosoniya", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"≥%[1]v",
...
// DateFullLayout returns the full date layout for 'uz'
func (uz *uz) DateFullLayout() string {
	return uz.dateFullLayout
}

// DateLongLayout returns the long date layout for 'uz'
func (uz *uz) DateLongLayout() string {
	return uz.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'uz'
func (uz *uz) DateMediumLayout() string {
	return uz.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'uz'
func (uz *uz) DateShortLayout() string {
	return uz.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'uz'
func (uz *uz) TimeFullLayout() string {
	return uz.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'uz'
func (uz *uz) TimeLongLayout() string {
	return uz.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'uz'
func (uz *uz) TimeMediumLayout() string {
	return uz.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'uz'
func (uz *uz) TimeShortLayout() string {
	return uz.timeShortLayout
}

func (uz *uz) ListPatterns() *locales.ListPatterns {
	return uz.listPatterns
}

func (uz *uz) GetDurationSpec() *locales.DurationSpec {
	return uz.DurationSpec
}

func (uz *uz) GetMiscPatterns() *locales.MiscPatterns {
