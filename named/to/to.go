...
func New() locales.Translator {
	return &to{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Sān", "Fēp", "Maʻa", "ʻEpe", "Mē", "Sun", "Siu", "ʻAok", "Sep", "ʻOka", "Nōv", "Tīs"},
			MonthsNarrowValue:        []string{"", "S", "F", "M", "E", "M", "S", "S", "A", "S", "O", "N", "T"},
			MonthsWideValue:          []string{"", "Sānuali", "Fēpueli", "Maʻasi", "ʻEpeleli", "Mē", "Sune", "Siulai", "ʻAokosi", "Sepitema", "ʻOkatopa", "Nōvema", "Tīsema"},
			WeekdaysAbbreviatedValue: []string{"Sāp", "Mōn", "Tūs", "Pul", "Tuʻa", "Fal", "Tok"},
			WeekdaysNarrowValue:      []string{"S", "M", "T", "P", "T", "F", "T"},
			WeekdaysShortValue:       []string{"Sāp", "Mōn", "Tūs", "Pul", "Tuʻa", "Fal", "Tok"},
			WeekdaysWideValue:        []string{"Sāpate", "Mōnite", "Tūsite", "Pulelulu", "Tuʻapulelulu", "Falaite", "Tokonaki"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsNarrowValue:       []string{"AM", "PM"},
			PeriodsWideValue:         []string{"hengihengi", "efiafi"},
			ErasAbbreviatedValue:     []string{"KM", "TS"},
			ErasNarrowValue:          []string{"KM", "TS"},
			ErasWideValue:            []string{"ki muʻa", "taʻu ʻo Sīsū"},
			TimezonesValue:           map[string]string{"": "houa fakapalakuai taimi totonu", "ACDT": "houa fakaʻaositelēlia-loto taimi liliu", "ACST": "houa fakaʻaositelēlia-loto taimi totonu", "ACT": "houa fakaʻakelī taimi totonu", "ACWDT": "houa fakaʻaositelēlia-loto-hihifo taimi liliu", "ACWST": "houa fakaʻaositelēlia-loto-hihifo taimi totonu", "ADT": "houa fakaʻamelika-tokelau ʻatalanitiki taimi liliu", "AEDT": "houa fakaʻaositelēlia-hahake taimi liliu", "AEST": "houa fakaʻaositelēlia-hahake taimi totonu", "AFT": "houa fakaʻafikānisitani", "AKDT": "houa fakaʻalasika taimi liliu", "AKST": "houa fakaʻalasika taimi totonu", "AMST": "houa fakaʻamasōne taimi liliu", "AMT": "houa fakaʻamasōne taimi totonu", "ARST": "houa fakaʻasenitina taimi liliu", "ART": "houa fakaʻasenitina taimi totonu", "AST": "houa fakaʻamelika-tokelau ʻatalanitiki taimi totonu", "AWDT": "houa fakaʻaositelēlia-hihifo taimi liliu", "AWST": "houa fakaʻaositelēlia-hihifo taimi totonu", "BNT": "houa fakapulunei", "BOT": "houa fakapolīvia", "BRST": "houa fakapalāsila taimi liliu", "BRT": "houa fakapalāsila taimi totonu", "BST": "houa fakapāngilātesi taimi liliu", "BTT": "houa fakapūtani", "CAT": "houa fakaʻafelika-loto", "CCT": "houa fakamotukokosi", "CDT": "houa fakaʻamelika-tokelau loto taimi liliu", "CDT (Kuba)": "houa fakakiupa taimi liliu", "CHADT": "houa fakasatihami taimi liliu", "CHAST": "houa fakasatihami taimi totonu", "CLST": "houa fakasili taimi liliu", "CLT": "houa fakasili taimi totonu", "COST": "houa fakakolomipia taimi liliu", "COT": "houa fakakolomipia taimi totonu", "CST": "houa fakaʻamelika-tokelau loto taimi totonu", "CST (Kuba)": "houa fakakiupa taimi totonu", "CXT": "houa fakamotukilisimasi", "ChST": "houa fakakamolo", "EASST": "houa fakalapanui taimi liliu", "EAST": "houa fakalapanui taimi totonu", "EAT": "houa fakaʻafelika-hahake", "ECT": "houa fakaʻekuetoa", "EDT": "houa fakaʻamelika-tokelau hahake taimi liliu", "EGDT": "houa fakafonuamata-hahake taimi liliu", "EGST": "houa fakafonuamata-hahake taimi totonu", "EST": "houa fakaʻamelika-tokelau hahake taimi totonu", "FKST": "houa fakaʻotumotu-fokulani taimi liliu", "GALT": "houa fakakalapakosi", "GFT": "houa fakakuiana-fakafalanisē", "GMT": "houa fakakiliniuisi mālie", "GST": "houa fakakūlifi", "GYT": "houa fakakuiana", "HADT": "houa fakahauaʻi taimi liliu", "HAST": "houa fakahauaʻi taimi totonu", "HENOMX": "houa fakamekisikou-tokelauhihifo taimi liliu", "HEOG": "houa fakafonuamata-hihifo taimi liliu", "HEPMX": "houa fakamekisikou-pasifika taimi liliu", "HKST": "houa fakahongi-kongi taimi liliu", "HKT": "houa fakahongi-kongi taimi totonu", "HNNOMX": "houa fakamekisikou-tokelauhihifo taimi totonu", "HNOG": "houa fakafonuamata-hihifo taimi totonu", "HNPMX": "houa fakamekisikou-pasifika taimi totonu", "ICT": "houa fakaʻinitosiaina", "IRDT": "houa fakaʻilaani taimi liliu", "IRST": "houa fakaʻilaani taimi totonu", "IST": "houa fakaʻinitia", "JDT": "houa fakasiapani taimi liliu", "JST": "houa fakasiapani taimi totonu", "LHDT": "houa fakamotuʻeikihoue taimi liliu", "LHST": "houa fakamotuʻeikihoue taimi totonu", "MDT": "houa fakaʻamelika-tokelau moʻunga taimi liliu", "MESZ": "houa fakaʻeulope-loto taimi liliu", "MEZ": "houa fakaʻeulope-loto taimi totonu", "MST": "houa fakaʻamelika-tokelau moʻunga taimi totonu", "MVT": "houa fakamalativisi", "MYT": "houa fakamaleisia", "NDT": "houa fakafonuaʻilofoʻou taimi liliu", "NPT": "houa fakanepali", "NST": "houa fakafonuaʻilofoʻou taimi totonu", "NZDT": "houa fakanuʻusila taimi liliu", "NZST": "houa fakanuʻusila taimi totonu", "OESZ": "houa fakaʻeulope-hahake taimi liliu", "OEZ": "houa fakaʻeulope-hahake taimi totonu", "PDT": "houa fakaʻamelika-tokelau pasifika taimi liliu", "PKT": "houa fakapākisitani taimi liliu", "PMDT": "houa fakasā-piea-mo-mikeloni taimi liliu", "PMST": "houa fakasā-piea-mo-mikeloni taimi totonu", "PST": "houa fakaʻamelika-tokelau pasifika taimi totonu", "PYST": "houa fakapalakuai taimi liliu", "SAST": "houa fakaʻafelika-tonga", "SGT": "houa fakasingapoa", "SRT": "houa fakasuliname", "TLT": "houa fakatimoa-hahake", "TMST": "houa fakatūkimenisitani taimi liliu", "TMT": "houa fakatūkimenisitani taimi totonu", "UYST": "houa fakaʻulukuai taimi liliu", "UYT": "houa fakaʻulukuai taimi totonu", "VET": "houa fakavenesuela", "WARST": "houa fakaʻasenitina-hihifo taimi liliu", "WART": "houa fakaʻasenitina-hihifo taimi totonu", "WAST": "houa fakaʻafelika-hihifo taimi liliu", "WAT": "houa fakaʻafelika-hihifo taimi totonu", "WESZ": "houa fakaʻeulope-hihifo taimi liliu", "WEZ": "houa fakaʻeulope-hihifo taimi totonu", "WIB": "houa fakaʻinitonisia-hihifo", "WIT": "houa fakaʻinitonisia-hahake", "WITA": "houa fakaʻinitonisia-loto", "∅∅∅": "houa fakapelū taimi liliu"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} mo {1}", "{0} mo {1}", "{0} mo {1}", "{0} mo {1}"}, {"{0} pē {1}", "{0}, {1}", "{0}, {1}", "{0}, pē {1}"}}),
...
func (to *to) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(to, to.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'to'
func (to *to) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(to, to.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'to'
func (to *to) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(to, to.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'to'
func (to *to) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(to, to.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'to'
func (to *to) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(to, to.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'to'
func (to *to) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(to, to.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'to'
func (to *to) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(to, to.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'to'
func (to *to) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(to, to.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'to'
func (to *to) DateFullLayout() string {
	return to.dateFullLayout
}

// DateLongLayout returns the long date layout for 'to'
func (to *to) DateLongLayout() string {
	return to.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'to'
func (to *to) DateMediumLayout() string {
	return to.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'to'
func (to *to) DateShortLayout() string {
	return to.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'to'
func (to *to) TimeFullLayout() string {
	return to.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'to'
func (to *to) TimeLongLayout() string {
	return to.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'to'
func (to *to) TimeMediumLayout() string {
	return to.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'to'
func (to *to) TimeShortLayout() string {
	return to.timeShortLayout
}

func (to *to) ListPatterns() *locales.ListPatterns {
	return to.listPatterns
}

func (to *to) GetDurationSpec() *locales.DurationSpec {
	return to.DurationSpec
}

func (to *to) GetMiscPatterns() *locales.MiscPatterns {
	return &to.miscPatterns
}
