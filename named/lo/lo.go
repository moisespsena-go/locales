...
// DateFullLayout returns the full date layout for 'lo'
func (lo *lo) DateFullLayout() string {
	return lo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'lo'
func (lo *lo) DateLongLayout() string {
	return lo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'lo'
func (lo *lo) DateMediumLayout() string {
	return lo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'lo'
func (lo *lo) DateShortLayout() string {
	return lo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'lo'
func (lo *lo) TimeFullLayout() string {
	return lo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'lo'
func (lo *lo) TimeLongLayout() string {
	return lo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'lo'
func (lo *lo) TimeMediumLayout() string {
	return lo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'lo'
func (lo *lo) TimeShortLayout() string {
	return lo.timeShortLayout
}

func (lo *lo) ListPatterns() *locales.ListPatterns {
	return lo.listPatterns
}

func (lo *lo) GetDurationSpec() *locales.DurationSpec {
	return lo.DurationSpec
}

func (lo *lo) GetMiscPatterns() *locales.MiscPatterns {
