...
// DateFullLayout returns the full date layout for 'dje'
func (dje *dje) DateFullLayout() string {
	return dje.dateFullLayout
}

// DateLongLayout returns the long date layout for 'dje'
func (dje *dje) DateLongLayout() string {
	return dje.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'dje'
func (dje *dje) DateMediumLayout() string {
	return dje.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'dje'
func (dje *dje) DateShortLayout() string {
	return dje.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'dje'
func (dje *dje) TimeFullLayout() string {
	return dje.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'dje'
func (dje *dje) TimeLongLayout() string {
	return dje.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'dje'
func (dje *dje) TimeMediumLayout() string {
	return dje.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'dje'
func (dje *dje) TimeShortLayout() string {
	return dje.timeShortLayout
}

func (dje *dje) ListPatterns() *locales.ListPatterns {
	return dje.listPatterns
}

func (dje *dje) GetDurationSpec() *locales.DurationSpec {
	return dje.DurationSpec
}

func (dje *dje) GetMiscPatterns() *locales.MiscPatterns {
