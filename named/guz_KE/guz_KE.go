...
func New() locales.Translator {
	return &guz_KE{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Can", "Feb", "Mac", "Apr", "Mei", "Jun", "Cul", "Agt", "Sep", "Okt", "Nob", "Dis"},
			MonthsNarrowValue:        []string{"", "C", "F", "M", "A", "M", "J", "C", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Chanuari", "Feburari", "Machi", "Apiriri", "Mei", "Juni", "Chulai", "Agosti", "Septemba", "Okitoba", "Nobemba", "Disemba"},
			WeekdaysAbbreviatedValue: []string{"Cpr", "Ctt", "Cmn", "Cmt", "Ars", "Icm", "Est"},
			WeekdaysNarrowValue:      []string{"C", "C", "C", "C", "A", "I", "E"},
			WeekdaysWideValue:        []string{"Chumapiri", "Chumatato", "Chumaine", "Chumatano", "Aramisi", "Ichuma", "Esabato"},
			PeriodsAbbreviatedValue:  []string{"Ma", "Mo"},
			PeriodsWideValue:         []string{"Mambia", "Mog"},
			ErasAbbreviatedValue:     []string{"YA", "YK"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Yeso ataiborwa", "Yeso kaiboirwe"},
...
func (guz *guz_KE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(guz, guz.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'guz_KE'
func (guz *guz_KE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(guz, guz.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'guz_KE'
func (guz *guz_KE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(guz, guz.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'guz_KE'
func (guz *guz_KE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(guz, guz.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'guz_KE'
func (guz *guz_KE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(guz, guz.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'guz_KE'
func (guz *guz_KE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(guz, guz.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'guz_KE'
func (guz *guz_KE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(guz, guz.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'guz_KE'
func (guz *guz_KE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(guz, guz.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'guz_KE'
func (guz *guz_KE) DateFullLayout() string {
	return guz.dateFullLayout
}

// DateLongLayout returns the long date layout for 'guz_KE'
func (guz *guz_KE) DateLongLayout() string {
	return guz.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'guz_KE'
func (guz *guz_KE) DateMediumLayout() string {
	return guz.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'guz_KE'
func (guz *guz_KE) DateShortLayout() string {
	return guz.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'guz_KE'
func (guz *guz_KE) TimeFullLayout() string {
	return guz.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'guz_KE'
func (guz *guz_KE) TimeLongLayout() string {
	return guz.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'guz_KE'
func (guz *guz_KE) TimeMediumLayout() string {
	return guz.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'guz_KE'
func (guz *guz_KE) TimeShortLayout() string {
	return guz.timeShortLayout
}

func (guz *guz_KE) ListPatterns() *locales.ListPatterns {
	return guz.listPatterns
}

func (guz *guz_KE) GetDurationSpec() *locales.DurationSpec {
	return guz.DurationSpec
}

func (guz *guz_KE) GetMiscPatterns() *locales.MiscPatterns {
	return &guz.miscPatterns
}
