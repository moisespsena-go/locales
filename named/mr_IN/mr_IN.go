...
func New() locales.Translator {
	return &mr_IN{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "जाने", "फेब्रु", "मार्च", "एप्रि", "मे", "जून", "जुलै", "ऑग", "सप्टें", "ऑक्टो", "नोव्हें", "डिसें"},
			MonthsNarrowValue:        []string{"", "जा", "फे", "मा", "ए", "मे", "जू", "जु", "ऑ", "स", "ऑ", "नो", "डि"},
			MonthsWideValue:          []string{"", "जानेवारी", "फेब्रुवारी", "मार्च", "एप्रिल", "मे", "जून", "जुलै", "ऑगस्ट", "सप्टेंबर", "ऑक्टोबर", "नोव्हेंबर", "डिसेंबर"},
			WeekdaysAbbreviatedValue: []string{"रवि", "सोम", "मंगळ", "बुध", "गुरु", "शुक्र", "शनि"},
			WeekdaysNarrowValue:      []string{"र", "सो", "मं", "बु", "गु", "शु", "श"},
			WeekdaysShortValue:       []string{"र", "सो", "मं", "बु", "गु", "शु", "श"},
			WeekdaysWideValue:        []string{"रविवार", "सोमवार", "मंगळवार", "बुधवार", "गुरुवार", "शुक्रवार", "शनिवार"},
			PeriodsAbbreviatedValue:  []string{"", ""},
			PeriodsNarrowValue:       []string{"a", "p"},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"इ. स. पू.", "इ. स."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"ईसवीसनपूर्व", "ईसवीसन"},
			TimezonesValue:           map[string]string{"": "पॅराग्वे प्रमाण वेळ", "ACDT": "ऑस्ट्रेलियन मध्य सूर्यप्रकाश वेळ", "ACST": "ऐकर ग्रीष्म वेळ", "ACT": "एकर प्रमाणवेळ", "ACWDT": "ऑस्ट्रेलियन मध्य-पश्चिम सूर्यप्रकाश वेळ", "ACWST": "ऑस्ट्रेलियन मध्य-पश्चिम प्रमाण वेळ", "ADT": "अटलांटिक सूर्यप्रकाश वेळ", "AEDT": "ऑस्ट्रेलियन पूर्व सूर्यप्रकाश वेळ", "AEST": "ऑस्ट्रेलियन पूर्व प्रमाण वेळ", "AFT": "अफगाणिस्तान वेळ", "AKDT": "अलास्का सूर्यप्रकाश वेळ", "AKST": "अलास्का प्रमाण वेळ", "AMST": "अ\u200dॅमेझॉन उन्हाळी वेळ", "AMT": "अ\u200dॅमेझॉन प्रमाण वेळ", "ARST": "अर्जेंटिना उन्हाळी वेळ", "ART": "अर्जेंटिना प्रमाण वेळ", "AST": "अटलांटिक प्रमाण वेळ", "AWDT": "ऑस्ट्रेलियन पश्चिम सूर्यप्रकाश वेळ", "AWST": "ऑस्ट्रेलियन पश्चिम प्रमाण वेळ", "BNT": "ब्रुनेई दारूसलाम वेळ", "BOT": "बोलिव्हिया वेळ", "BRST": "ब्राझिलिया उन्हाळी वेळ", "BRT": "ब्राझिलिया प्रमाण वेळ", "BST": "बांगलादेश उन्हाळी वेळ", "BTT": "भूतान वेळ", "CAT": "मध्\u200dय आफ्रिका वेळ", "CCT": "कॉकोस बेटे वेळ", "CDT": "केंद्रीय सूर्यप्रकाश वेळ", "CDT (Kuba)": "क्यूबा सूर्यप्रकाश वेळ", "CHADT": "चॅथम सूर्यप्रकाश वेळ", "CHAST": "चॅथम प्रमाण वेळ", "CLST": "चिली उन्हाळी वेळ", "CLT": "चिली प्रमाण वेळ", "COST": "कोलंबिया उन्हाळी वेळ", "COT": "कोलंबिया प्रमाण वेळ", "CST": "केंद्रीय प्रमाण वेळ", "CST (Kuba)": "क्यूबा प्रमाण वेळ", "CXT": "ख्रिसमस बेट वेळ", "ChST": "चामोरो प्रमाण वेळ", "EASST": "इस्टर बेट उन्हाळी वेळ", "EAST": "इस्टर बेट प्रमाण वेळ", "EAT": "पूर्व आफ्रिका वेळ", "ECT": "इक्वेडोर वेळ", "EDT": "पौर्वात्य सूर्यप्रकाश वेळ", "EGDT": "पूर्व ग्रीनलँड उन्हाळी वेळ", "EGST": "पूर्व ग्रीनलँड प्रमाण वेळ", "EST": "पौर्वात्य प्रमाण वेळ", "FKST": "फॉकलंड बेटे उन्हाळी वेळ", "GALT": "गॅलापागोस वेळ", "GFT": "फ्रेंच गयाना वेळ", "GMT": "ग्रीनिच प्रमाण वेळ", "GST": "खाडी प्रमाण वेळ", "GYT": "गयाना वेळ", "HADT": "हवाई-अलूशन सूर्यप्रकाश वेळ", "HAST": "हवाई-अलूशन प्रमाण वेळ", "HENOMX": "वायव्य मेक्सिको सूर्यप्रकाश वेळ", "HEOG": "पश्चिम ग्रीनलँड उन्हाळी वेळ", "HEPMX": "मेक्सिको पॅसिफिक सूर्यप्रकाश वेळ", "HKST": "हाँग काँग उन्हाळी वेळ", "HKT": "हाँग काँग प्रमाण वेळ", "HNNOMX": "वायव्य मेक्सिको प्रमाण वेळ", "HNOG": "पश्चिम ग्रीनलँड प्रमाण वेळ", "HNPMX": "मेक्सिको पॅसिफिक प्रमाण वेळ", "ICT": "इंडोचायना वेळ", "IRDT": "इराण सूर्यप्रकाश वेळ", "IRST": "इराण प्रमाण वेळ", "IST": "भारतीय प्रमाण वेळ", "JDT": "जपान सूर्यप्रकाश वेळ", "JST": "जपान प्रमाण वेळ", "LHDT": "लॉर्ड होवे सूर्यप्रकाश वेळ", "LHST": "लॉर्ड होवे प्रमाण वेळ", "MDT": "मकाऊ ग्रीष्मकालीन वेळ", "MESZ": "मध्\u200dय युरोपियन उन्हाळी वेळ", "MEZ": "मध्\u200dय युरोपियन प्रमाण वेळ", "MST": "मकाऊ प्रमाणवेळ", "MVT": "मालदिव वेळ", "MYT": "मलेशिया वेळ", "NDT": "न्यू फाउंडलंड सूर्यप्रकाश वेळ", "NPT": "नेपाळ वेळ", "NST": "न्यू फाउंडलंड प्रमाण वेळ", "NZDT": "न्यूझीलंड सूर्यप्रकाश वेळ", "NZST": "न्यूझीलंड प्रमाण वेळ", "OESZ": "पूर्व युरोपियन उन्हाळी वेळ", "OEZ": "पूर्व युरोपियन प्रमाण वेळ", "PDT": "पॅसिफिक सूर्यप्रकाश वेळ", "PKT": "पाकिस्तान उन्हाळी वेळ", "PMDT": "सेंट पियरे आणि मिक्वेलोन सूर्यप्रकाश वेळ", "PMST": "सेंट पियरे आणि मिक्वेलोन प्रमाण वेळ", "PST": "पॅसिफिक प्रमाण वेळ", "PYST": "पॅराग्वे उन्हाळी वेळ", "SAST": "दक्षिण आफ्रिका प्रमाण वेळ", "SGT": "सिंगापूर प्रमाण वेळ", "SRT": "सुरिनाम वेळ", "TLT": "पूर्व तिमोर वेळ", "TMST": "तुर्कमेनिस्तान उन्हाळी वेळ", "TMT": "तुर्कमेनिस्तान प्रमाण वेळ", "UYST": "उरुग्वे उन्हाळी वेळ", "UYT": "उरुग्वे प्रमाण वेळ", "VET": "व्हेनेझुएला वेळ", "WARST": "पश्चिमी अर्जेंटिना उन्हाळी वेळ", "WART": "पश्चिमी अर्जेंटिना प्रमाण वेळ", "WAST": "पश्चिम आफ्रिका उन्हाळी वेळ", "WAT": "पश्चिम आफ्रिका प्रमाण वेळ", "WESZ": "पश्चिम युरोपियन उन्हाळी वेळ", "WEZ": "पश्चिम युरोपियन प्रमाण वेळ", "WIB": "पश्चिमी इंडोनेशिया वेळ", "WIT": "पौर्वात्य इंडोनेशिया वेळ", "WITA": "मध्\u200dय इंडोनेशिया वेळ", "∅∅∅": "अ\u200dॅझोरेस उन्हाळी वेळ"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} आणि {1}", "{0}, {1}", "{0}, {1}", "{0} आणि {1}"}, {"{0} किंवा {1}", "{0}, {1}", "{0}, {1}", "{0}, किंवा {1}"}}),
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
			"≤%[1]v",
...
func (mr *mr_IN) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(mr, mr.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'mr_IN'
func (mr *mr_IN) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(mr, mr.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'mr_IN'
func (mr *mr_IN) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(mr, mr.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'mr_IN'
func (mr *mr_IN) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(mr, mr.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'mr_IN'
func (mr *mr_IN) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(mr, mr.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'mr_IN'
func (mr *mr_IN) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(mr, mr.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'mr_IN'
func (mr *mr_IN) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(mr, mr.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'mr_IN'
func (mr *mr_IN) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(mr, mr.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'mr_IN'
func (mr *mr_IN) DateFullLayout() string {
	return mr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mr_IN'
func (mr *mr_IN) DateLongLayout() string {
	return mr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mr_IN'
func (mr *mr_IN) DateMediumLayout() string {
	return mr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mr_IN'
func (mr *mr_IN) DateShortLayout() string {
	return mr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mr_IN'
func (mr *mr_IN) TimeFullLayout() string {
	return mr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mr_IN'
func (mr *mr_IN) TimeLongLayout() string {
	return mr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mr_IN'
func (mr *mr_IN) TimeMediumLayout() string {
	return mr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mr_IN'
func (mr *mr_IN) TimeShortLayout() string {
	return mr.timeShortLayout
}

func (mr *mr_IN) ListPatterns() *locales.ListPatterns {
	return mr.listPatterns
}

func (mr *mr_IN) GetDurationSpec() *locales.DurationSpec {
	return mr.DurationSpec
}

func (mr *mr_IN) GetMiscPatterns() *locales.MiscPatterns {
	return &mr.miscPatterns
}
