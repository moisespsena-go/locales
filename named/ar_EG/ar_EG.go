...
// DateFullLayout returns the full date layout for 'ar_EG'
func (ar *ar_EG) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_EG'
func (ar *ar_EG) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_EG'
func (ar *ar_EG) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_EG'
func (ar *ar_EG) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_EG'
func (ar *ar_EG) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_EG'
func (ar *ar_EG) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_EG'
func (ar *ar_EG) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_EG'
func (ar *ar_EG) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_EG) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_EG) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_EG) GetMiscPatterns() *locales.MiscPatterns {
