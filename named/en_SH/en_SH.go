...
// DateFullLayout returns the full date layout for 'en_SH'
func (en *en_SH) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_SH'
func (en *en_SH) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_SH'
func (en *en_SH) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_SH'
func (en *en_SH) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_SH'
func (en *en_SH) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_SH'
func (en *en_SH) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_SH'
func (en *en_SH) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_SH'
func (en *en_SH) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_SH) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_SH) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_SH) GetMiscPatterns() *locales.MiscPatterns {
