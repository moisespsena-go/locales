...
// DateFullLayout returns the full date layout for 'cs_CZ'
func (cs *cs_CZ) DateFullLayout() string {
	return cs.dateFullLayout
}

// DateLongLayout returns the long date layout for 'cs_CZ'
func (cs *cs_CZ) DateLongLayout() string {
	return cs.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'cs_CZ'
func (cs *cs_CZ) DateMediumLayout() string {
	return cs.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'cs_CZ'
func (cs *cs_CZ) DateShortLayout() string {
	return cs.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'cs_CZ'
func (cs *cs_CZ) TimeFullLayout() string {
	return cs.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'cs_CZ'
func (cs *cs_CZ) TimeLongLayout() string {
	return cs.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'cs_CZ'
func (cs *cs_CZ) TimeMediumLayout() string {
	return cs.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'cs_CZ'
func (cs *cs_CZ) TimeShortLayout() string {
	return cs.timeShortLayout
}

func (cs *cs_CZ) ListPatterns() *locales.ListPatterns {
	return cs.listPatterns
}

func (cs *cs_CZ) GetDurationSpec() *locales.DurationSpec {
	return cs.DurationSpec
}

func (cs *cs_CZ) GetMiscPatterns() *locales.MiscPatterns {
