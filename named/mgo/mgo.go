...
func New() locales.Translator {
	return &mgo{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "mbegtug", "imeg àbùbì", "imeg mbəŋchubi", "iməg ngwə̀t", "iməg fog", "iməg ichiibɔd", "iməg àdùmbə̀ŋ", "iməg ichika", "iməg kud", "iməg tèsiʼe", "iməg zò", "iməg krizmed"},
			MonthsNarrowValue:        []string{"", "M1", "A2", "M3", "N4", "F5", "I6", "A7", "I8", "K9", "10", "11", "12"},
			MonthsWideValue:          []string{"", "iməg mbegtug", "imeg àbùbì", "imeg mbəŋchubi", "iməg ngwə̀t", "iməg fog", "iməg ichiibɔd", "iməg àdùmbə̀ŋ", "iməg ichika", "iməg kud", "iməg tèsiʼe", "iməg zò", "iməg krizmed"},
			WeekdaysAbbreviatedValue: []string{"Aneg 1", "Aneg 2", "Aneg 3", "Aneg 4", "Aneg 5", "Aneg 6", "Aneg 7"},
			WeekdaysNarrowValue:      []string{"A1", "A2", "A3", "A4", "A5", "A6", "A7"},
			WeekdaysShortValue:       []string{"1", "2", "3", "4", "5", "6", "7"},
			WeekdaysWideValue:        []string{"Aneg 1", "Aneg 2", "Aneg 3", "Aneg 4", "Aneg 5", "Aneg 6", "Aneg 7"},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"m", "%v m", "%v m", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"h", "%v h", "%v h", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
...
func (mgo *mgo) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(mgo, mgo.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'mgo'
func (mgo *mgo) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(mgo, mgo.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'mgo'
func (mgo *mgo) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(mgo, mgo.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'mgo'
func (mgo *mgo) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(mgo, mgo.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'mgo'
func (mgo *mgo) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(mgo, mgo.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'mgo'
func (mgo *mgo) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(mgo, mgo.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'mgo'
func (mgo *mgo) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(mgo, mgo.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'mgo'
func (mgo *mgo) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(mgo, mgo.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'mgo'
func (mgo *mgo) DateFullLayout() string {
	return mgo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mgo'
func (mgo *mgo) DateLongLayout() string {
	return mgo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mgo'
func (mgo *mgo) DateMediumLayout() string {
	return mgo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mgo'
func (mgo *mgo) DateShortLayout() string {
	return mgo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mgo'
func (mgo *mgo) TimeFullLayout() string {
	return mgo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mgo'
func (mgo *mgo) TimeLongLayout() string {
	return mgo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mgo'
func (mgo *mgo) TimeMediumLayout() string {
	return mgo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mgo'
func (mgo *mgo) TimeShortLayout() string {
	return mgo.timeShortLayout
}

func (mgo *mgo) ListPatterns() *locales.ListPatterns {
	return mgo.listPatterns
}

func (mgo *mgo) GetDurationSpec() *locales.DurationSpec {
	return mgo.DurationSpec
}

func (mgo *mgo) GetMiscPatterns() *locales.MiscPatterns {
	return &mgo.miscPatterns
}
