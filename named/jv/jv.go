...
func New() locales.Translator {
	return &jv{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0È"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00È"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000È"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0Y"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00Y"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000Y"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Jan", "Feb", "Mar", "Apr", "Mei", "Jun", "Jul", "Agt", "Sep", "Okt", "Nov", "Des"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"},
			WeekdaysAbbreviatedValue: []string{"Ahad", "Sen", "Sel", "Rab", "Kam", "Jum", "Sab"},
			WeekdaysNarrowValue:      []string{"A", "S", "S", "R", "K", "J", "S"},
			WeekdaysShortValue:       []string{"Ahad", "Sen", "Sel", "Rab", "Kam", "Jum", "Sab"},
			WeekdaysWideValue:        []string{"Ahad", "Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu"},
			PeriodsAbbreviatedValue:  []string{"Isuk", "Wengi"},
			PeriodsNarrowValue:       []string{"Isuk", "Wengi"},
			PeriodsWideValue:         []string{"Isuk", "Wengi"},
			ErasAbbreviatedValue:     []string{"SM", "M"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Sakdurunge Masehi", "Masehi"},
			TimezonesValue:           map[string]string{"": "Wektu Standar Paraguay", "ACDT": "Wektu Ketigo Australia Tengah", "ACST": "Wektu Standar Australia Tengah", "ACT": "ACT", "ACWDT": "Wektu Ketigo Australia Tengah sisih Kulon", "ACWST": "Wektu Standar Australia Tengah sisih Kulon", "ADT": "Wektu Ketigo Atlantik", "AEDT": "Wektu Ketigo Australia sisih Wetan", "AEST": "Wektu Standar Australia sisih Wetan", "AFT": "Wektu Afghanistan", "AKDT": "Wektu Ketigo Alaska", "AKST": "Wektu Standar Alaska", "AMST": "Wektu Ketigo Amazon", "AMT": "Wektu Standar Amazon", "ARST": "Wektu Ketigo Argentina", "ART": "Wektu Standar Argentina", "AST": "Wektu Standar Atlantik", "AWDT": "Wektu Ketigo Australia sisih Kulon", "AWST": "Wektu Standar Australia sisih Kulon", "BNT": "Wektu Brunai Darussalam", "BOT": "Wektu Bolivia", "BRST": "Wektu Ketigo Brasilia", "BRT": "Wektu Standar Brasilia", "BST": "Wektu Ketigo Bangladesh", "BTT": "Wektu Bhutan", "CAT": "Wektu Afrika Tengah", "CCT": "Wektu Kepuloan Cocos", "CDT": "Wektu Ketigo Tengah", "CDT (Kuba)": "Wektu Ketigo Kuba", "CHADT": "Wektu Ketigo Chatham", "CHAST": "Wektu Standar Chatham", "CLST": "Wektu Ketigo Chili", "CLT": "Wektu Standar Chili", "COST": "Wektu Ketigo Kolombia", "COT": "Wektu Standar Kolombia", "CST": "Wektu Standar Tengah", "CST (Kuba)": "Wektu Standar Kuba", "CXT": "Wektu Pulo Natal", "ChST": "Wektu Chamorro", "EASST": "Wektu Ketigo Pulo Paskah", "EAST": "Wektu Standar Pulo Paskah", "EAT": "Wektu Afrika Wetan", "ECT": "Wektu Ekuador", "EDT": "Wektu Ketigo sisih Wetah", "EGDT": "Wektu Ketigo Grinland Wetan", "EGST": "Wektu Standar Grinland Wetan", "EST": "Wektu Standar sisih Wetan", "FKST": "Wektu Ketigo Kepuloan Falkland", "GALT": "Wektu Galapagos", "GFT": "Wektu Guiana Prancis", "GMT": "Wektu Rerata Greenwich", "GST": "Wektu Standar Teluk", "GYT": "Wektu Guyana", "HADT": "Wektu Ketigo Hawaii-Aleutian", "HAST": "Wektu Standar Hawaii-Aleutian", "HENOMX": "Wektu Ketigo Meksiko Lor-Kulon", "HEOG": "Wektu Ketigo Grinland Kulon", "HEPMX": "Wektu Ketigo Pasifik Meksiko", "HKST": "Wektu Ketigo Hong Kong", "HKT": "Wektu Standar Hong Kong", "HNNOMX": "Wektu Standar Meksiko Lor-Kulon", "HNOG": "Wektu Standar Grinland Kulon", "HNPMX": "Wektu Standar Pasifik Meksiko", "ICT": "Wektu Indocina", "IRDT": "Wektu Ketigo Iran", "IRST": "Wektu Standar Iran", "IST": "Wektu Standar India", "JDT": "Wektu Ketigo Jepang", "JST": "Wektu Standar Jepang", "LHDT": "Wektu Ketigo Lord Howe", "LHST": "Wektu Standar Lord Howe", "MDT": "Wektu Ketigo Giri", "MESZ": "Wektu Ketigo Eropa Tengah", "MEZ": "Wektu Standar Eropa Tengah", "MST": "Wektu Standar Giri", "MVT": "Wektu Maladewa", "MYT": "Wektu Malaysia", "NDT": "Wektu Ketigo Newfoundland", "NPT": "Wektu Nepal", "NST": "Wektu Standar Newfoundland", "NZDT": "Wektu Ketigo Selandia Anyar", "NZST": "Wektu Standar Selandia Anyar", "OESZ": "Wektu Ketigo Eropa sisih Wetan", "OEZ": "Wektu Standar Eropa sisih Wetan", "PDT": "Wektu Ketigo Pasifik", "PKT": "Wektu Ketigo Pakistan", "PMDT": "Wektu Ketigo Santa Pierre lan Miquelon", "PMST": "Wektu Standar Santa Pierre lan Miquelon", "PST": "Wektu Standar Pasifik", "PYST": "Wektu Ketigo Paraguay", "SAST": "Wektu Standar Afrika Kidul", "SGT": "Wektu Singapura", "SRT": "Wektu Suriname", "TLT": "Wektu Timor Leste", "TMST": "Wektu Ketigo Turkmenistan", "TMT": "Wektu Standar Turkmenistan", "UYST": "Wektu Ketigo Uruguay", "UYT": "Wektu Standar Uruguay", "VET": "Wektu Venezuela", "WARST": "Wektu Ketigo Argentina sisih Kulon", "WART": "Wektu Standar Argentina sisih Kulon", "WAST": "Wektu Ketigo Afrika Kulon", "WAT": "Wektu Standar Afrika Kulon", "WESZ": "Wektu Ketigo Eropa sisih Kulon", "WEZ": "Wektu Standar Eropa sisih Kulon", "WIB": "Wektu Indonesia sisih Kulon", "WIT": "Wektu Indonesia sisih Wetan", "WITA": "Wektu Indonesia Tengah", "∅∅∅": "Wektu Ketigo Peru"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} lan {1}", "{0}, {1}", "{0}, {1}", "{0}, lan {1}"}, {"{0} utowo {1}", "{0}, {1}", "{0}, {1}", "{0}, utowo {1}"}}),
...
func (jv *jv) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(jv, jv.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'jv'
func (jv *jv) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(jv, jv.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'jv'
func (jv *jv) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(jv, jv.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'jv'
func (jv *jv) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(jv, jv.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'jv'
func (jv *jv) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(jv, jv.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'jv'
func (jv *jv) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(jv, jv.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'jv'
func (jv *jv) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(jv, jv.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'jv'
func (jv *jv) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(jv, jv.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'jv'
func (jv *jv) DateFullLayout() string {
	return jv.dateFullLayout
}

// DateLongLayout returns the long date layout for 'jv'
func (jv *jv) DateLongLayout() string {
	return jv.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'jv'
func (jv *jv) DateMediumLayout() string {
	return jv.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'jv'
func (jv *jv) DateShortLayout() string {
	return jv.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'jv'
func (jv *jv) TimeFullLayout() string {
	return jv.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'jv'
func (jv *jv) TimeLongLayout() string {
	return jv.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'jv'
func (jv *jv) TimeMediumLayout() string {
	return jv.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'jv'
func (jv *jv) TimeShortLayout() string {
	return jv.timeShortLayout
}

func (jv *jv) ListPatterns() *locales.ListPatterns {
	return jv.listPatterns
}

func (jv *jv) GetDurationSpec() *locales.DurationSpec {
	return jv.DurationSpec
}

func (jv *jv) GetMiscPatterns() *locales.MiscPatterns {
	return &jv.miscPatterns
}
