...
func New() locales.Translator {
	return &os{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "янв.", "фев.", "мар.", "апр.", "майы", "июны", "июлы", "авг.", "сен.", "окт.", "ноя.", "дек."},
			MonthsNarrowValue:        []string{"", "Я", "Ф", "М", "А", "М", "И", "И", "А", "С", "О", "Н", "Д"},
			MonthsWideValue:          []string{"", "январы", "февралы", "мартъийы", "апрелы", "майы", "июны", "июлы", "августы", "сентябры", "октябры", "ноябры", "декабры"},
			WeekdaysAbbreviatedValue: []string{"хцб", "крс", "дцг", "ӕрт", "цпр", "мрб", "сбт"},
			WeekdaysNarrowValue:      []string{"Х", "К", "Д", "Ӕ", "Ц", "М", "С"},
			WeekdaysWideValue:        []string{"хуыцаубон", "къуырисӕр", "дыццӕг", "ӕртыццӕг", "цыппӕрӕм", "майрӕмбон", "сабат"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsWideValue:         []string{"ӕмбисбоны размӕ", "ӕмбисбоны фӕстӕ"},
			ErasAbbreviatedValue:     []string{"н.д.а.", "н.д."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"", ""},
			TimezonesValue:           map[string]string{"": "", "ACDT": "ACDT", "ACST": "ACST", "ACT": "ACT", "ACWDT": "ACWDT", "ACWST": "ACWST", "ADT": "ADT", "AEDT": "AEDT", "AEST": "AEST", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "AST", "AWDT": "AWDT", "AWST": "AWST", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "CAT", "CCT": "CCT", "CDT": "CDT", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "CST", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "EAT", "ECT": "ECT", "EDT": "EDT", "EGDT": "EGDT", "EGST": "EGST", "EST": "EST", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "Гринвичы рӕстӕмбис рӕстӕг", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "ICT", "IRDT": "IRDT", "IRST": "IRST", "IST": "IST", "JDT": "JDT", "JST": "JST", "LHDT": "LHDT", "LHST": "LHST", "MDT": "MDT", "MESZ": "Астӕуккаг Европӕйаг сӕрдыгон рӕстӕг", "MEZ": "Астӕуккаг Европӕйаг стандартон рӕстӕг", "MST": "MST", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "Скӕсӕн Европӕйаг сӕрдыгон рӕстӕг", "OEZ": "Скӕсӕн Европӕйаг стандартон рӕстӕг", "PDT": "PDT", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "PST", "PYST": "PYST", "SAST": "SAST", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "WAST", "WAT": "WAT", "WESZ": "Ныгъуылӕн Европӕйаг сӕрдыгон рӕстӕг", "WEZ": "Ныгъуылӕн Европӕйаг стандартон рӕстӕг", "WIB": "WIB", "WIT": "WIT", "WITA": "WITA", "∅∅∅": "∅∅∅"},
		},
		...
		dateFullLayout:   "EEEE, d MMMM, y 'аз'",
		dateLongLayout:   "d MMMM, y 'аз'",
		dateMediumLayout: "dd MMM y 'аз'",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} ӕмӕ {1}", "{0}, {1}", "{0}, {1}", "{0} ӕмӕ {1}"}, []string(nil)}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"азы", "%v аз", "%v азы", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"мӕйы", "%v мӕй", "%v мӕйы", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"къуырийы", "%v къуыри", "%v къуырийы", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"боны", "%v бон", "%v боны", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"сахаты", "%v с.", "%v с.", ""},
				Long:   &locales.CounterFormat{"сахаты", "%v сахат", "%v сахаты", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"минуты", "%v мин.", "%v мин.", ""},
				Long:   &locales.CounterFormat{"минуты", "%v минут", "%v минуты", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"секунды", "%v секунд", "%v секунды", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
...
func (os *os) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(os, os.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'os'
func (os *os) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(os, os.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'os'
func (os *os) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(os, os.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'os'
func (os *os) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(os, os.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'os'
func (os *os) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(os, os.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'os'
func (os *os) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(os, os.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'os'
func (os *os) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(os, os.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'os'
func (os *os) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(os, os.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'os'
func (os *os) DateFullLayout() string {
	return os.dateFullLayout
}

// DateLongLayout returns the long date layout for 'os'
func (os *os) DateLongLayout() string {
	return os.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'os'
func (os *os) DateMediumLayout() string {
	return os.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'os'
func (os *os) DateShortLayout() string {
	return os.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'os'
func (os *os) TimeFullLayout() string {
	return os.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'os'
func (os *os) TimeLongLayout() string {
	return os.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'os'
func (os *os) TimeMediumLayout() string {
	return os.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'os'
func (os *os) TimeShortLayout() string {
	return os.timeShortLayout
}

func (os *os) ListPatterns() *locales.ListPatterns {
	return os.listPatterns
}

func (os *os) GetDurationSpec() *locales.DurationSpec {
	return os.DurationSpec
}

func (os *os) GetMiscPatterns() *locales.MiscPatterns {
	return &os.miscPatterns
}
