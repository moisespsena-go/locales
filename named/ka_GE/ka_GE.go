...
// DateFullLayout returns the full date layout for 'ka_GE'
func (ka *ka_GE) DateFullLayout() string {
	return ka.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ka_GE'
func (ka *ka_GE) DateLongLayout() string {
	return ka.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ka_GE'
func (ka *ka_GE) DateMediumLayout() string {
	return ka.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ka_GE'
func (ka *ka_GE) DateShortLayout() string {
	return ka.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ka_GE'
func (ka *ka_GE) TimeFullLayout() string {
	return ka.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ka_GE'
func (ka *ka_GE) TimeLongLayout() string {
	return ka.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ka_GE'
func (ka *ka_GE) TimeMediumLayout() string {
	return ka.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ka_GE'
func (ka *ka_GE) TimeShortLayout() string {
	return ka.timeShortLayout
}

func (ka *ka_GE) ListPatterns() *locales.ListPatterns {
	return ka.listPatterns
}

func (ka *ka_GE) GetDurationSpec() *locales.DurationSpec {
	return ka.DurationSpec
}

func (ka *ka_GE) GetMiscPatterns() *locales.MiscPatterns {
