...
// DateFullLayout returns the full date layout for 'lag'
func (lag *lag) DateFullLayout() string {
	return lag.dateFullLayout
}

// DateLongLayout returns the long date layout for 'lag'
func (lag *lag) DateLongLayout() string {
	return lag.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'lag'
func (lag *lag) DateMediumLayout() string {
	return lag.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'lag'
func (lag *lag) DateShortLayout() string {
	return lag.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'lag'
func (lag *lag) TimeFullLayout() string {
	return lag.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'lag'
func (lag *lag) TimeLongLayout() string {
	return lag.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'lag'
func (lag *lag) TimeMediumLayout() string {
	return lag.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'lag'
func (lag *lag) TimeShortLayout() string {
	return lag.timeShortLayout
}

func (lag *lag) ListPatterns() *locales.ListPatterns {
	return lag.listPatterns
}

func (lag *lag) GetDurationSpec() *locales.DurationSpec {
	return lag.DurationSpec
}

func (lag *lag) GetMiscPatterns() *locales.MiscPatterns {
