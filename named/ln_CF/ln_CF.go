...
// DateFullLayout returns the full date layout for 'ln_CF'
func (ln *ln_CF) DateFullLayout() string {
	return ln.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ln_CF'
func (ln *ln_CF) DateLongLayout() string {
	return ln.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ln_CF'
func (ln *ln_CF) DateMediumLayout() string {
	return ln.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ln_CF'
func (ln *ln_CF) DateShortLayout() string {
	return ln.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ln_CF'
func (ln *ln_CF) TimeFullLayout() string {
	return ln.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ln_CF'
func (ln *ln_CF) TimeLongLayout() string {
	return ln.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ln_CF'
func (ln *ln_CF) TimeMediumLayout() string {
	return ln.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ln_CF'
func (ln *ln_CF) TimeShortLayout() string {
	return ln.timeShortLayout
}

func (ln *ln_CF) ListPatterns() *locales.ListPatterns {
	return ln.listPatterns
}

func (ln *ln_CF) GetDurationSpec() *locales.DurationSpec {
	return ln.DurationSpec
}

func (ln *ln_CF) GetMiscPatterns() *locales.MiscPatterns {
