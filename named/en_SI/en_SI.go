...
// DateFullLayout returns the full date layout for 'en_SI'
func (en *en_SI) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_SI'
func (en *en_SI) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_SI'
func (en *en_SI) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_SI'
func (en *en_SI) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_SI'
func (en *en_SI) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_SI'
func (en *en_SI) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_SI'
func (en *en_SI) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_SI'
func (en *en_SI) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_SI) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_SI) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_SI) GetMiscPatterns() *locales.MiscPatterns {
