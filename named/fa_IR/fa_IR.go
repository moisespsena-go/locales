...
// DateFullLayout returns the full date layout for 'fa_IR'
func (fa *fa_IR) DateFullLayout() string {
	return fa.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fa_IR'
func (fa *fa_IR) DateLongLayout() string {
	return fa.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fa_IR'
func (fa *fa_IR) DateMediumLayout() string {
	return fa.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fa_IR'
func (fa *fa_IR) DateShortLayout() string {
	return fa.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fa_IR'
func (fa *fa_IR) TimeFullLayout() string {
	return fa.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fa_IR'
func (fa *fa_IR) TimeLongLayout() string {
	return fa.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fa_IR'
func (fa *fa_IR) TimeMediumLayout() string {
	return fa.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fa_IR'
func (fa *fa_IR) TimeShortLayout() string {
	return fa.timeShortLayout
}

func (fa *fa_IR) ListPatterns() *locales.ListPatterns {
	return fa.listPatterns
}

func (fa *fa_IR) GetDurationSpec() *locales.DurationSpec {
	return fa.DurationSpec
}

func (fa *fa_IR) GetMiscPatterns() *locales.MiscPatterns {
