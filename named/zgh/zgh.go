...
// DateFullLayout returns the full date layout for 'zgh'
func (zgh *zgh) DateFullLayout() string {
	return zgh.dateFullLayout
}

// DateLongLayout returns the long date layout for 'zgh'
func (zgh *zgh) DateLongLayout() string {
	return zgh.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'zgh'
func (zgh *zgh) DateMediumLayout() string {
	return zgh.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'zgh'
func (zgh *zgh) DateShortLayout() string {
	return zgh.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'zgh'
func (zgh *zgh) TimeFullLayout() string {
	return zgh.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'zgh'
func (zgh *zgh) TimeLongLayout() string {
	return zgh.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'zgh'
func (zgh *zgh) TimeMediumLayout() string {
	return zgh.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'zgh'
func (zgh *zgh) TimeShortLayout() string {
	return zgh.timeShortLayout
}

func (zgh *zgh) ListPatterns() *locales.ListPatterns {
	return zgh.listPatterns
}

func (zgh *zgh) GetDurationSpec() *locales.DurationSpec {
	return zgh.DurationSpec
}

func (zgh *zgh) GetMiscPatterns() *locales.MiscPatterns {
