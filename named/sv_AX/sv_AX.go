...
// DateFullLayout returns the full date layout for 'sv_AX'
func (sv *sv_AX) DateFullLayout() string {
	return sv.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sv_AX'
func (sv *sv_AX) DateLongLayout() string {
	return sv.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sv_AX'
func (sv *sv_AX) DateMediumLayout() string {
	return sv.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sv_AX'
func (sv *sv_AX) DateShortLayout() string {
	return sv.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sv_AX'
func (sv *sv_AX) TimeFullLayout() string {
	return sv.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sv_AX'
func (sv *sv_AX) TimeLongLayout() string {
	return sv.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sv_AX'
func (sv *sv_AX) TimeMediumLayout() string {
	return sv.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sv_AX'
func (sv *sv_AX) TimeShortLayout() string {
	return sv.timeShortLayout
}

func (sv *sv_AX) ListPatterns() *locales.ListPatterns {
	return sv.listPatterns
}

func (sv *sv_AX) GetDurationSpec() *locales.DurationSpec {
	return sv.DurationSpec
}

func (sv *sv_AX) GetMiscPatterns() *locales.MiscPatterns {
