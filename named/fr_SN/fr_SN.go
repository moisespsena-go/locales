...
// DateFullLayout returns the full date layout for 'fr_SN'
func (fr *fr_SN) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_SN'
func (fr *fr_SN) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_SN'
func (fr *fr_SN) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_SN'
func (fr *fr_SN) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_SN'
func (fr *fr_SN) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_SN'
func (fr *fr_SN) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_SN'
func (fr *fr_SN) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_SN'
func (fr *fr_SN) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_SN) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_SN) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_SN) GetMiscPatterns() *locales.MiscPatterns {
