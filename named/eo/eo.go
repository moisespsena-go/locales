...
func New() locales.Translator {
	return &eo{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jan", "feb", "mar", "apr", "maj", "jun", "jul", "aŭg", "sep", "okt", "nov", "dec"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "januaro", "februaro", "marto", "aprilo", "majo", "junio", "julio", "aŭgusto", "septembro", "oktobro", "novembro", "decembro"},
			WeekdaysAbbreviatedValue: []string{"di", "lu", "ma", "me", "ĵa", "ve", "sa"},
			WeekdaysNarrowValue:      []string{"D", "L", "M", "M", "Ĵ", "V", "S"},
			WeekdaysWideValue:        []string{"dimanĉo", "lundo", "mardo", "merkredo", "ĵaŭdo", "vendredo", "sabato"},
			PeriodsAbbreviatedValue:  []string{"atm", "ptm"},
			PeriodsNarrowValue:       []string{"a", "p"},
			PeriodsWideValue:         []string{"atm", "ptm"},
			ErasAbbreviatedValue:     []string{"aK", "pK"},
			ErasNarrowValue:          []string{"aK", "pK"},
			ErasWideValue:            []string{"aK", "pK"},
			TimezonesValue:           map[string]string{"": "", "ACDT": "centra aŭstralia somera tempo", "ACST": "centra aŭstralia norma tempo", "ACT": "ACT", "ACWDT": "centrokcidenta aŭstralia somera tempo", "ACWST": "centrokcidenta aŭstralia norma tempo", "ADT": "atlantika nord-amerika somera tempo", "AEDT": "orienta aŭstralia somera tempo", "AEST": "orienta aŭstralia norma tempo", "AFT": "AFT", "AKDT": "AKDT", "AKST": "AKST", "AMST": "AMST", "AMT": "AMT", "ARST": "ARST", "ART": "ART", "AST": "atlantika nord-amerika norma tempo", "AWDT": "okcidenta aŭstralia somera tempo", "AWST": "okcidenta aŭstralia norma tempo", "BNT": "BNT", "BOT": "BOT", "BRST": "BRST", "BRT": "BRT", "BST": "BST", "BTT": "BTT", "CAT": "centra afrika tempo", "CCT": "CCT", "CDT": "centra nord-amerika somera tempo", "CDT (Kuba)": "CDT (Kuba)", "CHADT": "CHADT", "CHAST": "CHAST", "CLST": "CLST", "CLT": "CLT", "COST": "COST", "COT": "COT", "CST": "centra nord-amerika norma tempo", "CST (Kuba)": "CST (Kuba)", "CXT": "CXT", "ChST": "ChST", "EASST": "EASST", "EAST": "EAST", "EAT": "orienta afrika tempo", "ECT": "ECT", "EDT": "orienta nord-amerika somera tempo", "EGDT": "EGDT", "EGST": "EGST", "EST": "orienta nord-amerika norma tempo", "FKST": "FKST", "GALT": "GALT", "GFT": "GFT", "GMT": "universala tempo kunordigita", "GST": "GST", "GYT": "GYT", "HADT": "HADT", "HAST": "HAST", "HENOMX": "HENOMX", "HEOG": "HEOG", "HEPMX": "HEPMX", "HKST": "HKST", "HKT": "HKT", "HNNOMX": "HNNOMX", "HNOG": "HNOG", "HNPMX": "HNPMX", "ICT": "hindoĉina tempo", "IRDT": "IRDT", "IRST": "IRST", "IST": "barata tempo", "JDT": "japana somera tempo", "JST": "japana norma tempo", "LHDT": "LHDT", "LHST": "LHST", "MDT": "monta nord-amerika somera tempo", "MESZ": "centra eŭropa somera tempo", "MEZ": "centra eŭropa norma tempo", "MST": "monta nord-amerika norma tempo", "MVT": "MVT", "MYT": "MYT", "NDT": "NDT", "NPT": "NPT", "NST": "NST", "NZDT": "NZDT", "NZST": "NZST", "OESZ": "orienta eŭropa somera tempo", "OEZ": "orienta eŭropa norma tempo", "PDT": "pacifika nord-amerika somera tempo", "PKT": "PKT", "PMDT": "PMDT", "PMST": "PMST", "PST": "pacifika nord-amerika norma tempo", "PYST": "PYST", "SAST": "suda afrika tempo", "SGT": "SGT", "SRT": "SRT", "TLT": "TLT", "TMST": "TMST", "TMT": "TMT", "UYST": "UYST", "UYT": "UYT", "VET": "VET", "WARST": "WARST", "WART": "WART", "WAST": "okcidenta afrika somera tempo", "WAT": "okcidenta afrika norma tempo", "WESZ": "okcidenta eŭropa somera tempo", "WEZ": "okcidenta eŭropa norma tempo", "WIB": "okcidenta indonezia tempo", "WIT": "orienta indonezia tempo", "WITA": "centra indonezia tempo", "∅∅∅": "∅∅∅"},
		},
		...
		dateFullLayout:   "EEEE, d-'a' 'de' MMMM y",
		dateLongLayout:   "y-MMMM-dd",
		dateMediumLayout: "y-MMM-dd",
		dateShortLayout:  "yy-MM-dd",
		timeFullLayout:   "H-'a' 'horo' 'kaj' m:ss zzzz",
		timeLongLayout:   "HH:mm:ss z",
		timeMediumLayout: "HH:mm:ss",
		timeShortLayout:  "HH:mm",
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} kaj {1}", "{0}, {1}", "{0}, {1}", "{0} kaj {1}"}, []string(nil)}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"j.", "%vj.", "%vj.", ""},
				Long:   &locales.CounterFormat{"jaroj", "%v jaro", "%v jaroj", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"monato", "%v mon.", "%v mon.", ""},
				Long:   &locales.CounterFormat{"monatoj", "%v monato", "%v monatoj", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"semajnoj", "%v semajno", "%v semajnoj", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"t.", "%vt.", "%vt.", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"h.", "%vh.", "%vh.", "%v/h."},
				Long:   &locales.CounterFormat{"horoj", "%v horo", "%v horoj", "%v por horo"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"m.", "%vm.", "%vm.", ""},
				Long:   &locales.CounterFormat{"minutoj", "%v minuto", "%v minutoj", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s.", "%vs.", "%vs.", "%v/s."},
				Long:   &locales.CounterFormat{"sekundoj", "%v sekundo", "%v sekundoj", "%v por sekundo"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms.", "%vms.", "%vms.", ""},
				Long:   &locales.CounterFormat{"milisekundoj", "%v milisekundo", "%v milisekundoj", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
		miscPatterns: locales.MiscPatterns{
...
func (eo *eo) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(eo, eo.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'eo'
func (eo *eo) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(eo, eo.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'eo'
func (eo *eo) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(eo, eo.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'eo'
func (eo *eo) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(eo, eo.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'eo'
func (eo *eo) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(eo, eo.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'eo'
func (eo *eo) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(eo, eo.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'eo'
func (eo *eo) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(eo, eo.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'eo'
func (eo *eo) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(eo, eo.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'eo'
func (eo *eo) DateFullLayout() string {
	return eo.dateFullLayout
}

// DateLongLayout returns the long date layout for 'eo'
func (eo *eo) DateLongLayout() string {
	return eo.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'eo'
func (eo *eo) DateMediumLayout() string {
	return eo.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'eo'
func (eo *eo) DateShortLayout() string {
	return eo.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'eo'
func (eo *eo) TimeFullLayout() string {
	return eo.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'eo'
func (eo *eo) TimeLongLayout() string {
	return eo.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'eo'
func (eo *eo) TimeMediumLayout() string {
	return eo.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'eo'
func (eo *eo) TimeShortLayout() string {
	return eo.timeShortLayout
}

func (eo *eo) ListPatterns() *locales.ListPatterns {
	return eo.listPatterns
}

func (eo *eo) GetDurationSpec() *locales.DurationSpec {
	return eo.DurationSpec
}

func (eo *eo) GetMiscPatterns() *locales.MiscPatterns {
	return &eo.miscPatterns
}
