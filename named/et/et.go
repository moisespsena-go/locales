...
func New() locales.Translator {
	return &et{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 tuh ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 tuh ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 tuh ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 tuh ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 tuh ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 tuh ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jaan", "veebr", "märts", "apr", "mai", "juuni", "juuli", "aug", "sept", "okt", "nov", "dets"},
			MonthsNarrowValue:        []string{"", "J", "V", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "jaanuar", "veebruar", "märts", "aprill", "mai", "juuni", "juuli", "august", "september", "oktoober", "november", "detsember"},
			WeekdaysAbbreviatedValue: []string{"P", "E", "T", "K", "N", "R", "L"},
			WeekdaysNarrowValue:      []string{"P", "E", "T", "K", "N", "R", "L"},
			WeekdaysShortValue:       []string{"P", "E", "T", "K", "N", "R", "L"},
			WeekdaysWideValue:        []string{"Pühapäev", "Esmaspäev", "Teisipäev", "Kolmapäev", "Neljapäev", "Reede", "Laupäev"},
			PeriodsAbbreviatedValue:  []string{"AM", "PM"},
			PeriodsNarrowValue:       []string{"AM", "PM"},
			PeriodsWideValue:         []string{"AM", "PM"},
			ErasAbbreviatedValue:     []string{"eKr", "pKr"},
			ErasNarrowValue:          []string{"eKr", "pKr"},
			ErasWideValue:            []string{"enne Kristust", "pärast Kristust"},
			TimezonesValue:           map[string]string{"": "Falklandi saarte standardaeg", "ACDT": "Kesk-Austraalia suveaeg", "ACST": "Acre suveaeg", "ACT": "Acre standardaeg", "ACWDT": "Austraalia Kesk-Lääne suveaeg", "ACWST": "Austraalia Kesk-Lääne standardaeg", "ADT": "Atlandi suveaeg", "AEDT": "Ida-Austraalia suveaeg", "AEST": "Ida-Austraalia standardaeg", "AFT": "Afganistani aeg", "AKDT": "Alaska suveaeg", "AKST": "Alaska standardaeg", "AMST": "Amazonase suveaeg", "AMT": "Amazonase standardaeg", "ARST": "Argentina suveaeg", "ART": "Argentina standardaeg", "AST": "Atlandi standardaeg", "AWDT": "Lääne-Austraalia suveaeg", "AWST": "Lääne-Austraalia standardaeg", "BNT": "Brunei aeg", "BOT": "Boliivia aeg", "BRST": "Brasiilia suveaeg", "BRT": "Brasiilia standardaeg", "BST": "Bangladeshi suveaeg", "BTT": "Bhutani aeg", "CAT": "Kesk-Aafrika aeg", "CCT": "Kookossaarte aeg", "CDT": "Kesk-Ameerika suveaeg", "CDT (Kuba)": "Kuuba suveaeg", "CHADT": "Chathami suveaeg", "CHAST": "Chathami standardaeg", "CLST": "Tšiili suveaeg", "CLT": "Tšiili standardaeg", "COST": "Colombia suveaeg", "COT": "Colombia standardaeg", "CST": "Kesk-Ameerika standardaeg", "CST (Kuba)": "Kuuba standardaeg", "CXT": "Jõulusaare aeg", "ChST": "Tšamorro standardaeg", "EASST": "Lihavõttesaare suveaeg", "EAST": "Lihavõttesaare standardaeg", "EAT": "Ida-Aafrika aeg", "ECT": "Ecuadori aeg", "EDT": "Idaranniku suveaeg", "EGDT": "Ida-Gröönimaa suveaeg", "EGST": "Ida-Gröönimaa standardaeg", "EST": "Idaranniku standardaeg", "FKST": "Falklandi saarte suveaeg", "GALT": "Galapagose aeg", "GFT": "Prantsuse Guajaana aeg", "GMT": "Greenwichi aeg", "GST": "Pärsia lahe standardaeg", "GYT": "Guyana aeg", "HADT": "Hawaii-Aleuudi suveaeg", "HAST": "Hawaii-Aleuudi standardaeg", "HENOMX": "Loode-Mehhiko suveaeg", "HEOG": "Lääne-Gröönimaa suveaeg", "HEPMX": "Mehhiko Vaikse ookeani suveaeg", "HKST": "Hongkongi suveaeg", "HKT": "Hongkongi standardaeg", "HNNOMX": "Loode-Mehhiko standardaeg", "HNOG": "Lääne-Gröönimaa standardaeg", "HNPMX": "Mehhiko Vaikse ookeani standardaeg", "ICT": "Indohiina aeg", "IRDT": "Iraani suveaeg", "IRST": "Iraani standardaeg", "IST": "India aeg", "JDT": "Jaapani suveaeg", "JST": "Jaapani standardaeg", "LHDT": "Lord Howe’i suveaeg", "LHST": "Lord Howe’i standardaeg", "MDT": "Macau suveaeg", "MESZ": "Kesk-Euroopa suveaeg", "MEZ": "Kesk-Euroopa standardaeg", "MST": "Macau standardaeg", "MVT": "Maldiivi aeg", "MYT": "Malaisia aeg", "NDT": "Newfoundlandi suveaeg", "NPT": "Nepali aeg", "NST": "Newfoundlandi standardaeg", "NZDT": "Uus-Meremaa suveaeg", "NZST": "Uus-Meremaa standardaeg", "OESZ": "Ida-Euroopa suveaeg", "OEZ": "Ida-Euroopa standardaeg", "PDT": "Vaikse ookeani suveaeg", "PKT": "Pakistani suveaeg", "PMDT": "Saint-Pierre’i ja Miqueloni suveaeg", "PMST": "Saint-Pierre’i ja Miqueloni standardaeg", "PST": "Vaikse ookeani standardaeg", "PYST": "Paraguay suveaeg", "SAST": "Lõuna-Aafrika standardaeg", "SGT": "Singapuri standardaeg", "SRT": "Suriname aeg", "TLT": "Ida-Timori aeg", "TMST": "Türkmenistani suveaeg", "TMT": "Türkmenistani standardaeg", "UYST": "Uruguay suveaeg", "UYT": "Uruguay standardaeg", "VET": "Venezuela aeg", "WARST": "Lääne-Argentina suveaeg", "WART": "Lääne-Argentina standardaeg", "WAST": "Lääne-Aafrika suveaeg", "WAT": "Lääne-Aafrika standardaeg", "WESZ": "Lääne-Euroopa suveaeg", "WEZ": "Lääne-Euroopa standardaeg", "WIB": "Lääne-Indoneesia aeg", "WIT": "Ida-Indoneesia aeg", "WITA": "Kesk-Indoneesia aeg", "∅∅∅": "Assooride suveaeg"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} ja {1}", "{0}, {1}", "{0}, {1}", "{0} ja {1}"}, {"{0} või {1}", "{0}, {1}", "{0}, {1}", "{0} või {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"saj", "%v saj", "%v saj", ""},
				Long:   &locales.CounterFormat{"sajandid", "%v sajand", "%v sajandit", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dek", "%v dek", "%v dek", ""},
				Long:   &locales.CounterFormat{"dekaadid", "%v dekaad", "%v dekaadi", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"a", "%v a", "%v a", ""},
				Long:   &locales.CounterFormat{"aastad", "%v aasta", "%v aastat", "%v aastas"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"kuud", "%v k", "%v k", ""},
				Long:   &locales.CounterFormat{"kuud", "%v kuu", "%v kuud", "%v kuus"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"n", "%v n", "%v n", ""},
				Long:   &locales.CounterFormat{"nädalad", "%v nädal", "%v nädalat", "%v nädalas"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"päev", "%v p", "%v p", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"t", "%v t", "%v t", ""},
				Long:   &locales.CounterFormat{"tunnid", "%v tund", "%v tundi", "%v tunnis"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%v min", "%v min", ""},
				Long:   &locales.CounterFormat{"minutid", "%v minut", "%v minutit", "%v minutis"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"s", "%v s", "%v s", "%v/s"},
				Long:   &locales.CounterFormat{"sekundid", "%v sekund", "%v sekundit", "%v sekundis"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"millisekundid", "%v millisekund", "%v millisekundit", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"mikrosekundid", "%v mikrosekund", "%v mikrosekundit", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosekundid", "%v nanosekund", "%v nanosekundit", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~ %[1]v",
			"≥%[1]v",
...
func (et *et) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(et, et.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'et'
func (et *et) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(et, et.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'et'
func (et *et) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(et, et.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'et'
func (et *et) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(et, et.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'et'
func (et *et) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(et, et.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'et'
func (et *et) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(et, et.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'et'
func (et *et) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(et, et.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'et'
func (et *et) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(et, et.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'et'
func (et *et) DateFullLayout() string {
	return et.dateFullLayout
}

// DateLongLayout returns the long date layout for 'et'
func (et *et) DateLongLayout() string {
	return et.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'et'
func (et *et) DateMediumLayout() string {
	return et.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'et'
func (et *et) DateShortLayout() string {
	return et.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'et'
func (et *et) TimeFullLayout() string {
	return et.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'et'
func (et *et) TimeLongLayout() string {
	return et.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'et'
func (et *et) TimeMediumLayout() string {
	return et.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'et'
func (et *et) TimeShortLayout() string {
	return et.timeShortLayout
}

func (et *et) ListPatterns() *locales.ListPatterns {
	return et.listPatterns
}

func (et *et) GetDurationSpec() *locales.DurationSpec {
	return et.DurationSpec
}

func (et *et) GetMiscPatterns() *locales.MiscPatterns {
	return &et.miscPatterns
}
