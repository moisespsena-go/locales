...
// DateFullLayout returns the full date layout for 'en_MP'
func (en *en_MP) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_MP'
func (en *en_MP) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_MP'
func (en *en_MP) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_MP'
func (en *en_MP) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_MP'
func (en *en_MP) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_MP'
func (en *en_MP) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_MP'
func (en *en_MP) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_MP'
func (en *en_MP) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_MP) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_MP) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_MP) GetMiscPatterns() *locales.MiscPatterns {
