...
func New() locales.Translator {
	return &lag_TZ{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "Fúngatɨ", "Naanɨ", "Keenda", "Ikúmi", "Inyambala", "Idwaata", "Mʉʉnchɨ", "Vɨɨrɨ", "Saatʉ", "Inyi", "Saano", "Sasatʉ"},
			MonthsNarrowValue:        []string{"", "F", "N", "K", "I", "I", "I", "M", "V", "S", "I", "S", "S"},
			MonthsWideValue:          []string{"", "Kʉfúngatɨ", "Kʉnaanɨ", "Kʉkeenda", "Kwiikumi", "Kwiinyambála", "Kwiidwaata", "Kʉmʉʉnchɨ", "Kʉvɨɨrɨ", "Kʉsaatʉ", "Kwiinyi", "Kʉsaano", "Kʉsasatʉ"},
			WeekdaysAbbreviatedValue: []string{"Píili", "Táatu", "Íne", "Táano", "Alh", "Ijm", "Móosi"},
			WeekdaysNarrowValue:      []string{"P", "T", "E", "O", "A", "I", "M"},
			WeekdaysWideValue:        []string{"Jumapíiri", "Jumatátu", "Jumaíne", "Jumatáano", "Alamíisi", "Ijumáa", "Jumamóosi"},
			PeriodsAbbreviatedValue:  []string{"TOO", "MUU"},
			PeriodsWideValue:         []string{"TOO", "MUU"},
			ErasAbbreviatedValue:     []string{"KSA", "KA"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Kɨrɨsitʉ sɨ anavyaal", "Kɨrɨsitʉ akavyaalwe"},
...
func (lag *lag_TZ) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(lag, lag.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'lag_TZ'
func (lag *lag_TZ) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(lag, lag.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'lag_TZ'
func (lag *lag_TZ) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(lag, lag.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'lag_TZ'
func (lag *lag_TZ) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(lag, lag.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'lag_TZ'
func (lag *lag_TZ) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(lag, lag.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'lag_TZ'
func (lag *lag_TZ) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(lag, lag.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'lag_TZ'
func (lag *lag_TZ) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(lag, lag.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'lag_TZ'
func (lag *lag_TZ) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(lag, lag.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'lag_TZ'
func (lag *lag_TZ) DateFullLayout() string {
	return lag.dateFullLayout
}

// DateLongLayout returns the long date layout for 'lag_TZ'
func (lag *lag_TZ) DateLongLayout() string {
	return lag.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'lag_TZ'
func (lag *lag_TZ) DateMediumLayout() string {
	return lag.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'lag_TZ'
func (lag *lag_TZ) DateShortLayout() string {
	return lag.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'lag_TZ'
func (lag *lag_TZ) TimeFullLayout() string {
	return lag.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'lag_TZ'
func (lag *lag_TZ) TimeLongLayout() string {
	return lag.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'lag_TZ'
func (lag *lag_TZ) TimeMediumLayout() string {
	return lag.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'lag_TZ'
func (lag *lag_TZ) TimeShortLayout() string {
	return lag.timeShortLayout
}

func (lag *lag_TZ) ListPatterns() *locales.ListPatterns {
	return lag.listPatterns
}

func (lag *lag_TZ) GetDurationSpec() *locales.DurationSpec {
	return lag.DurationSpec
}

func (lag *lag_TZ) GetMiscPatterns() *locales.MiscPatterns {
	return &lag.miscPatterns
}
