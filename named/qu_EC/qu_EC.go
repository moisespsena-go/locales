...
// DateFullLayout returns the full date layout for 'qu_EC'
func (qu *qu_EC) DateFullLayout() string {
	return qu.dateFullLayout
}

// DateLongLayout returns the long date layout for 'qu_EC'
func (qu *qu_EC) DateLongLayout() string {
	return qu.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'qu_EC'
func (qu *qu_EC) DateMediumLayout() string {
	return qu.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'qu_EC'
func (qu *qu_EC) DateShortLayout() string {
	return qu.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'qu_EC'
func (qu *qu_EC) TimeFullLayout() string {
	return qu.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'qu_EC'
func (qu *qu_EC) TimeLongLayout() string {
	return qu.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'qu_EC'
func (qu *qu_EC) TimeMediumLayout() string {
	return qu.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'qu_EC'
func (qu *qu_EC) TimeShortLayout() string {
	return qu.timeShortLayout
}

func (qu *qu_EC) ListPatterns() *locales.ListPatterns {
	return qu.listPatterns
}

func (qu *qu_EC) GetDurationSpec() *locales.DurationSpec {
	return qu.DurationSpec
}

func (qu *qu_EC) GetMiscPatterns() *locales.MiscPatterns {
