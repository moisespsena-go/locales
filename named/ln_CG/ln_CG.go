...
// DateFullLayout returns the full date layout for 'ln_CG'
func (ln *ln_CG) DateFullLayout() string {
	return ln.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ln_CG'
func (ln *ln_CG) DateLongLayout() string {
	return ln.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ln_CG'
func (ln *ln_CG) DateMediumLayout() string {
	return ln.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ln_CG'
func (ln *ln_CG) DateShortLayout() string {
	return ln.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ln_CG'
func (ln *ln_CG) TimeFullLayout() string {
	return ln.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ln_CG'
func (ln *ln_CG) TimeLongLayout() string {
	return ln.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ln_CG'
func (ln *ln_CG) TimeMediumLayout() string {
	return ln.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ln_CG'
func (ln *ln_CG) TimeShortLayout() string {
	return ln.timeShortLayout
}

func (ln *ln_CG) ListPatterns() *locales.ListPatterns {
	return ln.listPatterns
}

func (ln *ln_CG) GetDurationSpec() *locales.DurationSpec {
	return ln.DurationSpec
}

func (ln *ln_CG) GetMiscPatterns() *locales.MiscPatterns {
