...
// DateFullLayout returns the full date layout for 'dsb_DE'
func (dsb *dsb_DE) DateFullLayout() string {
	return dsb.dateFullLayout
}

// DateLongLayout returns the long date layout for 'dsb_DE'
func (dsb *dsb_DE) DateLongLayout() string {
	return dsb.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'dsb_DE'
func (dsb *dsb_DE) DateMediumLayout() string {
	return dsb.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'dsb_DE'
func (dsb *dsb_DE) DateShortLayout() string {
	return dsb.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'dsb_DE'
func (dsb *dsb_DE) TimeFullLayout() string {
	return dsb.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'dsb_DE'
func (dsb *dsb_DE) TimeLongLayout() string {
	return dsb.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'dsb_DE'
func (dsb *dsb_DE) TimeMediumLayout() string {
	return dsb.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'dsb_DE'
func (dsb *dsb_DE) TimeShortLayout() string {
	return dsb.timeShortLayout
}

func (dsb *dsb_DE) ListPatterns() *locales.ListPatterns {
	return dsb.listPatterns
}

func (dsb *dsb_DE) GetDurationSpec() *locales.DurationSpec {
	return dsb.DurationSpec
}

func (dsb *dsb_DE) GetMiscPatterns() *locales.MiscPatterns {
