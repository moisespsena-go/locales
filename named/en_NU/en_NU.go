...
// DateFullLayout returns the full date layout for 'en_NU'
func (en *en_NU) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_NU'
func (en *en_NU) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_NU'
func (en *en_NU) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_NU'
func (en *en_NU) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_NU'
func (en *en_NU) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_NU'
func (en *en_NU) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_NU'
func (en *en_NU) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_NU'
func (en *en_NU) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_NU) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_NU) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_NU) GetMiscPatterns() *locales.MiscPatterns {
