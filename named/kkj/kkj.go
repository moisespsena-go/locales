...
// DateFullLayout returns the full date layout for 'kkj'
func (kkj *kkj) DateFullLayout() string {
	return kkj.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kkj'
func (kkj *kkj) DateLongLayout() string {
	return kkj.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kkj'
func (kkj *kkj) DateMediumLayout() string {
	return kkj.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kkj'
func (kkj *kkj) DateShortLayout() string {
	return kkj.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kkj'
func (kkj *kkj) TimeFullLayout() string {
	return kkj.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kkj'
func (kkj *kkj) TimeLongLayout() string {
	return kkj.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kkj'
func (kkj *kkj) TimeMediumLayout() string {
	return kkj.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kkj'
func (kkj *kkj) TimeShortLayout() string {
	return kkj.timeShortLayout
}

func (kkj *kkj) ListPatterns() *locales.ListPatterns {
	return kkj.listPatterns
}

func (kkj *kkj) GetDurationSpec() *locales.DurationSpec {
	return kkj.DurationSpec
}

func (kkj *kkj) GetMiscPatterns() *locales.MiscPatterns {
