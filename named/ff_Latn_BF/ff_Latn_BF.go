...
// DateFullLayout returns the full date layout for 'ff_Latn_BF'
func (ff *ff_Latn_BF) DateFullLayout() string {
	return ff.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ff_Latn_BF'
func (ff *ff_Latn_BF) DateLongLayout() string {
	return ff.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ff_Latn_BF'
func (ff *ff_Latn_BF) DateMediumLayout() string {
	return ff.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ff_Latn_BF'
func (ff *ff_Latn_BF) DateShortLayout() string {
	return ff.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ff_Latn_BF'
func (ff *ff_Latn_BF) TimeFullLayout() string {
	return ff.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ff_Latn_BF'
func (ff *ff_Latn_BF) TimeLongLayout() string {
	return ff.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ff_Latn_BF'
func (ff *ff_Latn_BF) TimeMediumLayout() string {
	return ff.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ff_Latn_BF'
func (ff *ff_Latn_BF) TimeShortLayout() string {
	return ff.timeShortLayout
}

func (ff *ff_Latn_BF) ListPatterns() *locales.ListPatterns {
	return ff.listPatterns
}

func (ff *ff_Latn_BF) GetDurationSpec() *locales.DurationSpec {
	return ff.DurationSpec
}

func (ff *ff_Latn_BF) GetMiscPatterns() *locales.MiscPatterns {
