...
// DateFullLayout returns the full date layout for 'pa_Guru'
func (pa *pa_Guru) DateFullLayout() string {
	return pa.dateFullLayout
}

// DateLongLayout returns the long date layout for 'pa_Guru'
func (pa *pa_Guru) DateLongLayout() string {
	return pa.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'pa_Guru'
func (pa *pa_Guru) DateMediumLayout() string {
	return pa.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'pa_Guru'
func (pa *pa_Guru) DateShortLayout() string {
	return pa.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'pa_Guru'
func (pa *pa_Guru) TimeFullLayout() string {
	return pa.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'pa_Guru'
func (pa *pa_Guru) TimeLongLayout() string {
	return pa.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'pa_Guru'
func (pa *pa_Guru) TimeMediumLayout() string {
	return pa.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'pa_Guru'
func (pa *pa_Guru) TimeShortLayout() string {
	return pa.timeShortLayout
}

func (pa *pa_Guru) ListPatterns() *locales.ListPatterns {
	return pa.listPatterns
}

func (pa *pa_Guru) GetDurationSpec() *locales.DurationSpec {
	return pa.DurationSpec
}

func (pa *pa_Guru) GetMiscPatterns() *locales.MiscPatterns {
