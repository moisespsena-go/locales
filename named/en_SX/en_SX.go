...
// DateFullLayout returns the full date layout for 'en_SX'
func (en *en_SX) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_SX'
func (en *en_SX) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_SX'
func (en *en_SX) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_SX'
func (en *en_SX) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_SX'
func (en *en_SX) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_SX'
func (en *en_SX) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_SX'
func (en *en_SX) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_SX'
func (en *en_SX) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_SX) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_SX) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_SX) GetMiscPatterns() *locales.MiscPatterns {
