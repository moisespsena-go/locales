...
func New() locales.Translator {
	return &en_001{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "%v hr", "%v hrs", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "%v min", "%v mins", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"", "%v sec", "%v secs", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
		},
...
// DateFullLayout returns the full date layout for 'en_001'
func (en *en_001) DateFullLayout() string {
	return en.dateFullLayout
}

// DateLongLayout returns the long date layout for 'en_001'
func (en *en_001) DateLongLayout() string {
	return en.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'en_001'
func (en *en_001) DateMediumLayout() string {
	return en.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'en_001'
func (en *en_001) DateShortLayout() string {
	return en.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'en_001'
func (en *en_001) TimeFullLayout() string {
	return en.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'en_001'
func (en *en_001) TimeLongLayout() string {
	return en.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'en_001'
func (en *en_001) TimeMediumLayout() string {
	return en.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'en_001'
func (en *en_001) TimeShortLayout() string {
	return en.timeShortLayout
}

func (en *en_001) ListPatterns() *locales.ListPatterns {
	return en.listPatterns
}

func (en *en_001) GetDurationSpec() *locales.DurationSpec {
	return en.DurationSpec
}

func (en *en_001) GetMiscPatterns() *locales.MiscPatterns {
