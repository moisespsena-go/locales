...
func New() locales.Translator {
	return &mer_KE{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "JAN", "FEB", "MAC", "ĨPU", "MĨĨ", "NJU", "NJR", "AGA", "SPT", "OKT", "NOV", "DEC"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "Ĩ", "M", "N", "N", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "Januarĩ", "Feburuarĩ", "Machi", "Ĩpurũ", "Mĩĩ", "Njuni", "Njuraĩ", "Agasti", "Septemba", "Oktũba", "Novemba", "Dicemba"},
			WeekdaysAbbreviatedValue: []string{"KIU", "MRA", "WAI", "WET", "WEN", "WTN", "JUM"},
			WeekdaysNarrowValue:      []string{"K", "M", "W", "W", "W", "W", "J"},
			WeekdaysWideValue:        []string{"Kiumia", "Muramuko", "Wairi", "Wethatu", "Wena", "Wetano", "Jumamosi"},
			PeriodsAbbreviatedValue:  []string{"RŨ", "ŨG"},
			PeriodsWideValue:         []string{"RŨ", "ŨG"},
			ErasAbbreviatedValue:     []string{"MK", "NK"},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Mbere ya Kristũ", "Nyuma ya Kristũ"},
...
func (mer *mer_KE) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(mer, mer.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'mer_KE'
func (mer *mer_KE) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(mer, mer.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'mer_KE'
func (mer *mer_KE) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(mer, mer.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'mer_KE'
func (mer *mer_KE) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(mer, mer.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'mer_KE'
func (mer *mer_KE) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(mer, mer.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'mer_KE'
func (mer *mer_KE) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(mer, mer.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'mer_KE'
func (mer *mer_KE) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(mer, mer.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'mer_KE'
func (mer *mer_KE) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(mer, mer.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'mer_KE'
func (mer *mer_KE) DateFullLayout() string {
	return mer.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mer_KE'
func (mer *mer_KE) DateLongLayout() string {
	return mer.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mer_KE'
func (mer *mer_KE) DateMediumLayout() string {
	return mer.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mer_KE'
func (mer *mer_KE) DateShortLayout() string {
	return mer.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mer_KE'
func (mer *mer_KE) TimeFullLayout() string {
	return mer.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mer_KE'
func (mer *mer_KE) TimeLongLayout() string {
	return mer.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mer_KE'
func (mer *mer_KE) TimeMediumLayout() string {
	return mer.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mer_KE'
func (mer *mer_KE) TimeShortLayout() string {
	return mer.timeShortLayout
}

func (mer *mer_KE) ListPatterns() *locales.ListPatterns {
	return mer.listPatterns
}

func (mer *mer_KE) GetDurationSpec() *locales.DurationSpec {
	return mer.DurationSpec
}

func (mer *mer_KE) GetMiscPatterns() *locales.MiscPatterns {
	return &mer.miscPatterns
}
