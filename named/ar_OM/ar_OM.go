...
// DateFullLayout returns the full date layout for 'ar_OM'
func (ar *ar_OM) DateFullLayout() string {
	return ar.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ar_OM'
func (ar *ar_OM) DateLongLayout() string {
	return ar.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ar_OM'
func (ar *ar_OM) DateMediumLayout() string {
	return ar.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ar_OM'
func (ar *ar_OM) DateShortLayout() string {
	return ar.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ar_OM'
func (ar *ar_OM) TimeFullLayout() string {
	return ar.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ar_OM'
func (ar *ar_OM) TimeLongLayout() string {
	return ar.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ar_OM'
func (ar *ar_OM) TimeMediumLayout() string {
	return ar.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ar_OM'
func (ar *ar_OM) TimeShortLayout() string {
	return ar.timeShortLayout
}

func (ar *ar_OM) ListPatterns() *locales.ListPatterns {
	return ar.listPatterns
}

func (ar *ar_OM) GetDurationSpec() *locales.DurationSpec {
	return ar.DurationSpec
}

func (ar *ar_OM) GetMiscPatterns() *locales.MiscPatterns {
