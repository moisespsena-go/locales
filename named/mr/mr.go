	...
	return &mr{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"शतके", "%v शतकाशी", "%v शतकांचा", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"द", "%v द", "%v द", ""},
				Long:   &locales.CounterFormat{"दशके", "%v दशकाशी", "%v दशकांचा", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"वर्ष", "%vव", "%vव", "%v/वर्षी"},
				Long:   &locales.CounterFormat{"वर्षे", "%v वर्षाशी", "%v वर्षांचा", "%v दर वर्षी"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"महिना", "%vम", "%vम", "%v/म"},
				Long:   &locales.CounterFormat{"महिने", "%v महिन्याशी", "%v महिन्यांचा", "%v दर महिना"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"आ", "%vआ", "%vआ", "%v/आ"},
				Long:   &locales.CounterFormat{"आठवडे", "%v आठवड्याशी", "%v आठवड्यांचा", "%v दर आठवडा"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"दिवस", "%vदि", "%vदि", "%v/दि"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"तास", "%vता", "%vता", "%v/ता"},
				Long:   &locales.CounterFormat{"तास", "%v तासाशी", "%v तासांचा", "%v प्रति तास"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"मिनिटे", "%vमि", "%vमि", "%v/मिनि"},
				Long:   &locales.CounterFormat{"मिनिटे", "%v मिनिटाशी", "%v मिनिटांचा", "%v दर मिनिट"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"सेकंद", "%vसे", "%vसे", "%v/से"},
				Long:   &locales.CounterFormat{"सेकंद", "%v सेकंदाशी", "%v सेकंदांचा", "%v प्रति सेकंद"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"मिलिसेकंद", "%v मिलिसे", "%v मिलिसे", ""},
				Long:   &locales.CounterFormat{"मिलिसेकंद", "%v मिलिसेकंदात", "%v मिलिसेकंदांत", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"मायक्रोसेकंद", "%v मायक्रोसेकंदात", "%v मायक्रोसेकंदांत", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"नॅसे", "%v नॅसे", "%v नॅसे", ""},
				Long:   &locales.CounterFormat{"नॅनोसेकंद", "%v नॅनोसेकंदात", "%v नॅनोसेकंदांत", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
// DateFullLayout returns the full date layout for 'mr'
func (mr *mr) DateFullLayout() string {
	return mr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'mr'
func (mr *mr) DateLongLayout() string {
	return mr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'mr'
func (mr *mr) DateMediumLayout() string {
	return mr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'mr'
func (mr *mr) DateShortLayout() string {
	return mr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'mr'
func (mr *mr) TimeFullLayout() string {
	return mr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'mr'
func (mr *mr) TimeLongLayout() string {
	return mr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'mr'
func (mr *mr) TimeMediumLayout() string {
	return mr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'mr'
func (mr *mr) TimeShortLayout() string {
	return mr.timeShortLayout
}

func (mr *mr) ListPatterns() *locales.ListPatterns {
	return mr.listPatterns
}

func (mr *mr) GetDurationSpec() *locales.DurationSpec {
	return mr.DurationSpec
}

func (mr *mr) GetMiscPatterns() *locales.MiscPatterns {
