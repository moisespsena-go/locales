...
func New() locales.Translator {
	return &ce_RU{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 эзар ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 эзар ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 эзар ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 эзар ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 эзар ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 эзар ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			...
			WeekdaysAbbreviatedValue: []string{"кӀи", "ор", "ши", "кха", "еа", "пӀе", "шуо"},
			WeekdaysNarrowValue:      []string{"кӀи", "ор", "ши", "кха", "еа", "пӀе", "шуо"},
			WeekdaysShortValue:       []string{"кӀи", "ор", "ши", "кха", "еа", "пӀе", "шуо"},
			WeekdaysWideValue:        []string{"кӀира", "оршот", "шинара", "кхаара", "еара", "пӀераска", "шуот"},
			ErasAbbreviatedValue:     []string{"", ""},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"Ӏийса пайхамар вина де кхачале", "Ӏийса пайхамар вина дийнахь дуьйна"},
			TimezonesValue:           map[string]string{"": "Парагвай, стандартан хан", "ACDT": "Юккъера Австрали, аьхкенан хан", "ACST": "Юккъера Австрали, стандартан хан", "ACT": "ACT", "ACWDT": "Юккъера Австрали, малхбузен аьхкенан хан", "ACWST": "Юккъера Австрали, малхбузен стандартан хан", "ADT": "Атлантикан аьхкенан хан", "AEDT": "Малхбален Австрали, аьхкенан хан", "AEST": "Малхбален Австрали, стандартан хан", "AFT": "ОвхӀан", "AKDT": "Аляска, аьхкенан хан", "AKST": "Аляска, стандартан хан", "AMST": "Амазонка, аьхкенан хан", "AMT": "Амазонка, стандартан хан", "ARST": "Аргентина, аьхкенан хан", "ART": "Аргентина, стандартан хан", "AST": "Атлантикан стандартан хан", "AWDT": "Малхбузен Австрали, аьхкенан хан", "AWST": "Малхбузен Австрали, стандартан хан", "BNT": "Бруней-Даруссалам", "BOT": "Боливи", "BRST": "Бразили, аьхкенан хан", "BRT": "Бразили, стандартан хан", "BST": "Бангладеш, аьхкенан хан", "BTT": "Бутан", "CAT": "Юккъера Африка", "CCT": "Кокосийн, гӀ-наш", "CDT": "Юккъера Америка, аьхкенан хан", "CDT (Kuba)": "Куба, аьхкенан хан", "CHADT": "Чатем, аьхкенан хан", "CHAST": "Чатем, стандартан хан", "CLST": "Чили, аьхкенан хан", "CLT": "Чили, стандартан хан", "COST": "Колумби, аьхкенан хан", "COT": "Колумби, стандартан хан", "CST": "Юккъера Америка, стандартан хан", "CST (Kuba)": "Куба, стандартан хан", "CXT": "Ӏийса пайхамар винчу ден гӀайре", "ChST": "Чаморро", "EASST": "Мархин гӀайре, аьхкенан хан", "EAST": "Мархин гӀайре, стандартан хан", "EAT": "Малхбален Африка", "ECT": "Эквадор", "EDT": "Малхбален Америка, аьхкенан хан", "EGDT": "Малхбален Гренланди, аьхкенан хан", "EGST": "Малхбален Гренланди, стандартан хан", "EST": "Малхбален Америка, стандартан хан", "FKST": "Фолклендан гӀайренаш, аьхкенан хан", "GALT": "Галапагосан гӀайренаш", "GFT": "Французийн Гвиана", "GMT": "Гринвичица юкъара хан", "GST": "ГӀажарийн айма", "GYT": "Гайана", "HADT": "Гавайн-алеутийн аьхкенан хан", "HAST": "Гавайн-алеутийн стандартан хан", "HENOMX": "Къилбаседа Американ Мексикан аьхкенан хан", "HEOG": "Малхбузен Гренланди, аьхкенан хан", "HEPMX": "Тийна океанан Мексикан аьхкенан хан", "HKST": "Гонконг, аьхкенан хан", "HKT": "Гонконг, стандартан хан", "HNNOMX": "Къилбаседа Американ Мексикан стандартан хан", "HNOG": "Малхбузен Гренланди, стандартан хан", "HNPMX": "Тийна океанан Мексикан стандартан хан", "ICT": "Индокитай", "IRDT": "ГӀажарийчоь, аьхкенан хан", "IRST": "ГӀажарийчоь, стандартан хан", "IST": "ХӀинди", "JDT": "Япон, аьхкенан хан", "JST": "Япон, стандартан хан", "LHDT": "Лорд-Хау, аьхкенан хан", "LHST": "Лорд-Хау, стандартан хан", "MDT": "Лаьмнийн аьхкенан хан (АЦШ)", "MESZ": "Юккъера Европа, аьхкенан хан", "MEZ": "Юккъера Европа, стандартан хан", "MST": "Лаьмнийн стандартан хан (АЦШ)", "MVT": "Мальдиваш", "MYT": "Малайзи", "NDT": "Ньюфаундленд, аьхкенан хан", "NPT": "Непал", "NST": "Ньюфаундленд, стандартан хан", "NZDT": "Керла Зеланди, аьхкенан хан", "NZST": "Керла Зеланди, стандартан хан", "OESZ": "Малхбален Европа, аьхкенан хан", "OEZ": "Малхбален Европа, стандартан хан", "PDT": "Тийна океанан аьхкенан хан", "PKT": "Пакистан, аьхкенан хан", "PMDT": "Сен-Пьер а, Микелон а, аьхкенан хан", "PMST": "Сен-Пьер а, Микелон а, стандартан хан", "PST": "Тийна океанан стандартан хан", "PYST": "Парагвай, аьхкенан хан", "SAST": "Къилба Африка", "SGT": "Сингапур", "SRT": "Суринам", "TLT": "Малхбален Тимор", "TMST": "Туркменин аьхкенан хан", "TMT": "Туркменин стандартан хан", "UYST": "Уругвай, аьхкенан хан", "UYT": "Уругвай, стандартан хан", "VET": "Венесуэла", "WARST": "Малхбузен Аргентина, аьхкенан хан", "WART": "Малхбузен Аргентина, стандартан хан", "WAST": "Малхбузен Африка, аьхкенан хан", "WAT": "Малхбузен Африка, стандартан хан", "WESZ": "Малхбузен Европа, аьхкенан хан", "WEZ": "Малхбузен Европа, стандартан хан", "WIB": "Малхбузен Индонези", "WIT": "Малхбален Индонези", "WITA": "Юккъера Индонези", "∅∅∅": "Перу, аьхкенан хан"},
		},
...
func (ce *ce_RU) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(ce, ce.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'ce_RU'
func (ce *ce_RU) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(ce, ce.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'ce_RU'
func (ce *ce_RU) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(ce, ce.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'ce_RU'
func (ce *ce_RU) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(ce, ce.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'ce_RU'
func (ce *ce_RU) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(ce, ce.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ce_RU'
func (ce *ce_RU) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(ce, ce.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'ce_RU'
func (ce *ce_RU) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(ce, ce.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'ce_RU'
func (ce *ce_RU) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(ce, ce.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'ce_RU'
func (ce *ce_RU) DateFullLayout() string {
	return ce.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ce_RU'
func (ce *ce_RU) DateLongLayout() string {
	return ce.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ce_RU'
func (ce *ce_RU) DateMediumLayout() string {
	return ce.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ce_RU'
func (ce *ce_RU) DateShortLayout() string {
	return ce.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ce_RU'
func (ce *ce_RU) TimeFullLayout() string {
	return ce.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ce_RU'
func (ce *ce_RU) TimeLongLayout() string {
	return ce.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ce_RU'
func (ce *ce_RU) TimeMediumLayout() string {
	return ce.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ce_RU'
func (ce *ce_RU) TimeShortLayout() string {
	return ce.timeShortLayout
}

func (ce *ce_RU) ListPatterns() *locales.ListPatterns {
	return ce.listPatterns
}

func (ce *ce_RU) GetDurationSpec() *locales.DurationSpec {
	return ce.DurationSpec
}

func (ce *ce_RU) GetMiscPatterns() *locales.MiscPatterns {
	return &ce.miscPatterns
}
