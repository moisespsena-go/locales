...
// DateFullLayout returns the full date layout for 'ru_RU'
func (ru *ru_RU) DateFullLayout() string {
	return ru.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ru_RU'
func (ru *ru_RU) DateLongLayout() string {
	return ru.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ru_RU'
func (ru *ru_RU) DateMediumLayout() string {
	return ru.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ru_RU'
func (ru *ru_RU) DateShortLayout() string {
	return ru.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ru_RU'
func (ru *ru_RU) TimeFullLayout() string {
	return ru.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ru_RU'
func (ru *ru_RU) TimeLongLayout() string {
	return ru.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ru_RU'
func (ru *ru_RU) TimeMediumLayout() string {
	return ru.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ru_RU'
func (ru *ru_RU) TimeShortLayout() string {
	return ru.timeShortLayout
}

func (ru *ru_RU) ListPatterns() *locales.ListPatterns {
	return ru.listPatterns
}

func (ru *ru_RU) GetDurationSpec() *locales.DurationSpec {
	return ru.DurationSpec
}

func (ru *ru_RU) GetMiscPatterns() *locales.MiscPatterns {
