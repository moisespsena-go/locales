...
// DateFullLayout returns the full date layout for 'shi_Latn_MA'
func (shi *shi_Latn_MA) DateFullLayout() string {
	return shi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'shi_Latn_MA'
func (shi *shi_Latn_MA) DateLongLayout() string {
	return shi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'shi_Latn_MA'
func (shi *shi_Latn_MA) DateMediumLayout() string {
	return shi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'shi_Latn_MA'
func (shi *shi_Latn_MA) DateShortLayout() string {
	return shi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'shi_Latn_MA'
func (shi *shi_Latn_MA) TimeFullLayout() string {
	return shi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'shi_Latn_MA'
func (shi *shi_Latn_MA) TimeLongLayout() string {
	return shi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'shi_Latn_MA'
func (shi *shi_Latn_MA) TimeMediumLayout() string {
	return shi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'shi_Latn_MA'
func (shi *shi_Latn_MA) TimeShortLayout() string {
	return shi.timeShortLayout
}

func (shi *shi_Latn_MA) ListPatterns() *locales.ListPatterns {
	return shi.listPatterns
}

func (shi *shi_Latn_MA) GetDurationSpec() *locales.DurationSpec {
	return shi.DurationSpec
}

func (shi *shi_Latn_MA) GetMiscPatterns() *locales.MiscPatterns {
