...
// DateFullLayout returns the full date layout for 'de_LI'
func (de *de_LI) DateFullLayout() string {
	return de.dateFullLayout
}

// DateLongLayout returns the long date layout for 'de_LI'
func (de *de_LI) DateLongLayout() string {
	return de.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'de_LI'
func (de *de_LI) DateMediumLayout() string {
	return de.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'de_LI'
func (de *de_LI) DateShortLayout() string {
	return de.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'de_LI'
func (de *de_LI) TimeFullLayout() string {
	return de.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'de_LI'
func (de *de_LI) TimeLongLayout() string {
	return de.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'de_LI'
func (de *de_LI) TimeMediumLayout() string {
	return de.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'de_LI'
func (de *de_LI) TimeShortLayout() string {
	return de.timeShortLayout
}

func (de *de_LI) ListPatterns() *locales.ListPatterns {
	return de.listPatterns
}

func (de *de_LI) GetDurationSpec() *locales.DurationSpec {
	return de.DurationSpec
}

func (de *de_LI) GetMiscPatterns() *locales.MiscPatterns {
