...
func New() locales.Translator {
	return &bm_ML{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "zan", "feb", "mar", "awi", "mɛ", "zuw", "zul", "uti", "sɛt", "ɔku", "now", "des"},
			MonthsNarrowValue:        []string{"", "Z", "F", "M", "A", "M", "Z", "Z", "U", "S", "Ɔ", "N", "D"},
			MonthsWideValue:          []string{"", "zanwuye", "feburuye", "marisi", "awirili", "mɛ", "zuwɛn", "zuluye", "uti", "sɛtanburu", "ɔkutɔburu", "nowanburu", "desanburu"},
			WeekdaysAbbreviatedValue: []string{"kar", "ntɛ", "tar", "ara", "ala", "jum", "sib"},
			WeekdaysNarrowValue:      []string{"K", "N", "T", "A", "A", "J", "S"},
			WeekdaysWideValue:        []string{"kari", "ntɛnɛ", "tarata", "araba", "alamisa", "juma", "sibiri"},
			ErasAbbreviatedValue:     []string{"J.-C. ɲɛ", "ni J.-C."},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"jezu krisiti ɲɛ", "jezu krisiti minkɛ"},
...
func (bm *bm_ML) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(bm, bm.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'bm_ML'
func (bm *bm_ML) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(bm, bm.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'bm_ML'
func (bm *bm_ML) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(bm, bm.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'bm_ML'
func (bm *bm_ML) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(bm, bm.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'bm_ML'
func (bm *bm_ML) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(bm, bm.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'bm_ML'
func (bm *bm_ML) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(bm, bm.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'bm_ML'
func (bm *bm_ML) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(bm, bm.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'bm_ML'
func (bm *bm_ML) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(bm, bm.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'bm_ML'
func (bm *bm_ML) DateFullLayout() string {
	return bm.dateFullLayout
}

// DateLongLayout returns the long date layout for 'bm_ML'
func (bm *bm_ML) DateLongLayout() string {
	return bm.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'bm_ML'
func (bm *bm_ML) DateMediumLayout() string {
	return bm.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'bm_ML'
func (bm *bm_ML) DateShortLayout() string {
	return bm.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'bm_ML'
func (bm *bm_ML) TimeFullLayout() string {
	return bm.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'bm_ML'
func (bm *bm_ML) TimeLongLayout() string {
	return bm.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'bm_ML'
func (bm *bm_ML) TimeMediumLayout() string {
	return bm.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'bm_ML'
func (bm *bm_ML) TimeShortLayout() string {
	return bm.timeShortLayout
}

func (bm *bm_ML) ListPatterns() *locales.ListPatterns {
	return bm.listPatterns
}

func (bm *bm_ML) GetDurationSpec() *locales.DurationSpec {
	return bm.DurationSpec
}

func (bm *bm_ML) GetMiscPatterns() *locales.MiscPatterns {
	return &bm.miscPatterns
}
