...
// DateFullLayout returns the full date layout for 'sk_SK'
func (sk *sk_SK) DateFullLayout() string {
	return sk.dateFullLayout
}

// DateLongLayout returns the long date layout for 'sk_SK'
func (sk *sk_SK) DateLongLayout() string {
	return sk.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'sk_SK'
func (sk *sk_SK) DateMediumLayout() string {
	return sk.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'sk_SK'
func (sk *sk_SK) DateShortLayout() string {
	return sk.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'sk_SK'
func (sk *sk_SK) TimeFullLayout() string {
	return sk.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'sk_SK'
func (sk *sk_SK) TimeLongLayout() string {
	return sk.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'sk_SK'
func (sk *sk_SK) TimeMediumLayout() string {
	return sk.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'sk_SK'
func (sk *sk_SK) TimeShortLayout() string {
	return sk.timeShortLayout
}

func (sk *sk_SK) ListPatterns() *locales.ListPatterns {
	return sk.listPatterns
}

func (sk *sk_SK) GetDurationSpec() *locales.DurationSpec {
	return sk.DurationSpec
}

func (sk *sk_SK) GetMiscPatterns() *locales.MiscPatterns {
