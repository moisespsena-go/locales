...
// DateFullLayout returns the full date layout for 'es_ES'
func (es *es_ES) DateFullLayout() string {
	return es.dateFullLayout
}

// DateLongLayout returns the long date layout for 'es_ES'
func (es *es_ES) DateLongLayout() string {
	return es.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'es_ES'
func (es *es_ES) DateMediumLayout() string {
	return es.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'es_ES'
func (es *es_ES) DateShortLayout() string {
	return es.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'es_ES'
func (es *es_ES) TimeFullLayout() string {
	return es.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'es_ES'
func (es *es_ES) TimeLongLayout() string {
	return es.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'es_ES'
func (es *es_ES) TimeMediumLayout() string {
	return es.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'es_ES'
func (es *es_ES) TimeShortLayout() string {
	return es.timeShortLayout
}

func (es *es_ES) ListPatterns() *locales.ListPatterns {
	return es.listPatterns
}

func (es *es_ES) GetDurationSpec() *locales.DurationSpec {
	return es.DurationSpec
}

func (es *es_ES) GetMiscPatterns() *locales.MiscPatterns {
