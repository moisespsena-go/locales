...
// DateFullLayout returns the full date layout for 'gv'
func (gv *gv) DateFullLayout() string {
	return gv.dateFullLayout
}

// DateLongLayout returns the long date layout for 'gv'
func (gv *gv) DateLongLayout() string {
	return gv.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'gv'
func (gv *gv) DateMediumLayout() string {
	return gv.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'gv'
func (gv *gv) DateShortLayout() string {
	return gv.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'gv'
func (gv *gv) TimeFullLayout() string {
	return gv.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'gv'
func (gv *gv) TimeLongLayout() string {
	return gv.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'gv'
func (gv *gv) TimeMediumLayout() string {
	return gv.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'gv'
func (gv *gv) TimeShortLayout() string {
	return gv.timeShortLayout
}

func (gv *gv) ListPatterns() *locales.ListPatterns {
	return gv.listPatterns
}

func (gv *gv) GetDurationSpec() *locales.DurationSpec {
	return gv.DurationSpec
}

func (gv *gv) GetMiscPatterns() *locales.MiscPatterns {
