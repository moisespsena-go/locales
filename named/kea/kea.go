...
// DateFullLayout returns the full date layout for 'kea'
func (kea *kea) DateFullLayout() string {
	return kea.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kea'
func (kea *kea) DateLongLayout() string {
	return kea.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kea'
func (kea *kea) DateMediumLayout() string {
	return kea.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kea'
func (kea *kea) DateShortLayout() string {
	return kea.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kea'
func (kea *kea) TimeFullLayout() string {
	return kea.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kea'
func (kea *kea) TimeLongLayout() string {
	return kea.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kea'
func (kea *kea) TimeMediumLayout() string {
	return kea.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kea'
func (kea *kea) TimeShortLayout() string {
	return kea.timeShortLayout
}

func (kea *kea) ListPatterns() *locales.ListPatterns {
	return kea.listPatterns
}

func (kea *kea) GetDurationSpec() *locales.DurationSpec {
	return kea.DurationSpec
}

func (kea *kea) GetMiscPatterns() *locales.MiscPatterns {
