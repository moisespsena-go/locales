...
func New() locales.Translator {
	return &kl{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0 td"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 td"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00 td"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 td"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000 td"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000 td"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jan", "febr", "mar", "apr", "maj", "jun", "jul", "aug", "sept", "okt", "nov", "dec"},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"},
			MonthsWideValue:          []string{"", "januaarip", "februaarip", "marsip", "apriilip", "maajip", "juunip", "juulip", "aggustip", "septembarip", "oktobarip", "novembarip", "decembarip"},
			WeekdaysAbbreviatedValue: []string{"sap", "ata", "mar", "pin", "sis", "tal", "arf"},
			WeekdaysNarrowValue:      []string{"S", "A", "M", "P", "S", "T", "A"},
			WeekdaysShortValue:       []string{"sap", "ata", "mar", "pin", "sis", "tal", "arf"},
			WeekdaysWideValue:        []string{"sapaat", "ataasinngorneq", "marlunngorneq", "pingasunngorneq", "sisamanngorneq", "tallimanngorneq", "arfininngorneq"},
			PeriodsAbbreviatedValue:  []string{"u.t.", "u.k."},
			PeriodsWideValue:         []string{"ulloqeqqata-tungaa", "ulloqeqqata-kingorna"},
			ErasAbbreviatedValue:     []string{"Kr.in.si.", "Kr.in.king."},
			ErasNarrowValue:          []string{"Kr.s.", "Kr.k."},
			ErasWideValue:            []string{"Kristusip inunngornerata siornagut", "Kristusip inunngornerata kingornagut"},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} aamma {1}", "{0}, {1}", "{0}, {1}", "{0} aamma {1}"}, []string(nil)}),
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"", "%vuk", "%vuk", ""},
				Long:   &locales.CounterFormat{"ukioq", "%v ukioq", "%v ukioq", "%v per ukioq"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vmån", "%vmån", ""},
				Long:   &locales.CounterFormat{"qaammat", "%v qaammat", "%v qaammat", "%v per qaammat"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vu", "%vu", ""},
				Long:   &locales.CounterFormat{"sapaatip-akunnera", "%v sapaatip-akunnera", "%v sapaatip-akunnera", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vd", "%vd", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vh", "%vh", "%v/h"},
				Long:   &locales.CounterFormat{"nalunaaquttap-akunnera", "%v nalunaaquttap-akunnera", "%v nalunaaquttap-akunnera", "%v/h"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vmin", "%vmin", "%v/min"},
				Long:   &locales.CounterFormat{"minutsi", "%v minutsi", "%v minutsi", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vs", "%vs", "%v/s"},
				Long:   &locales.CounterFormat{"sekundi", "%v sekundi", "%v sekundi", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"", "%vms", "%vms", ""},
				Long:   &locales.CounterFormat{"millisekundi", "%v millisekundi", "%v millisekundi", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%vμs", "%vμs", ""},
				Long:   &locales.CounterFormat{"mikrosekundi", "%v mikrosekundi", "%v mikrosekundi", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanosekundi", "%v nanosekundi", "%v nanosekundi", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"",
			"≥%[1]v",
...
func (kl *kl) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(kl, kl.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'kl'
func (kl *kl) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(kl, kl.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'kl'
func (kl *kl) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(kl, kl.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'kl'
func (kl *kl) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(kl, kl.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'kl'
func (kl *kl) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(kl, kl.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'kl'
func (kl *kl) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(kl, kl.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'kl'
func (kl *kl) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(kl, kl.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'kl'
func (kl *kl) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(kl, kl.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'kl'
func (kl *kl) DateFullLayout() string {
	return kl.dateFullLayout
}

// DateLongLayout returns the long date layout for 'kl'
func (kl *kl) DateLongLayout() string {
	return kl.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'kl'
func (kl *kl) DateMediumLayout() string {
	return kl.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'kl'
func (kl *kl) DateShortLayout() string {
	return kl.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'kl'
func (kl *kl) TimeFullLayout() string {
	return kl.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'kl'
func (kl *kl) TimeLongLayout() string {
	return kl.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'kl'
func (kl *kl) TimeMediumLayout() string {
	return kl.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'kl'
func (kl *kl) TimeShortLayout() string {
	return kl.timeShortLayout
}

func (kl *kl) ListPatterns() *locales.ListPatterns {
	return kl.listPatterns
}

func (kl *kl) GetDurationSpec() *locales.DurationSpec {
	return kl.DurationSpec
}

func (kl *kl) GetMiscPatterns() *locales.MiscPatterns {
	return &kl.miscPatterns
}
