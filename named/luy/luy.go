...
// DateFullLayout returns the full date layout for 'luy'
func (luy *luy) DateFullLayout() string {
	return luy.dateFullLayout
}

// DateLongLayout returns the long date layout for 'luy'
func (luy *luy) DateLongLayout() string {
	return luy.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'luy'
func (luy *luy) DateMediumLayout() string {
	return luy.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'luy'
func (luy *luy) DateShortLayout() string {
	return luy.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'luy'
func (luy *luy) TimeFullLayout() string {
	return luy.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'luy'
func (luy *luy) TimeLongLayout() string {
	return luy.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'luy'
func (luy *luy) TimeMediumLayout() string {
	return luy.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'luy'
func (luy *luy) TimeShortLayout() string {
	return luy.timeShortLayout
}

func (luy *luy) ListPatterns() *locales.ListPatterns {
	return luy.listPatterns
}

func (luy *luy) GetDurationSpec() *locales.DurationSpec {
	return luy.DurationSpec
}

func (luy *luy) GetMiscPatterns() *locales.MiscPatterns {
