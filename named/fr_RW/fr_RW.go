...
// DateFullLayout returns the full date layout for 'fr_RW'
func (fr *fr_RW) DateFullLayout() string {
	return fr.dateFullLayout
}

// DateLongLayout returns the long date layout for 'fr_RW'
func (fr *fr_RW) DateLongLayout() string {
	return fr.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'fr_RW'
func (fr *fr_RW) DateMediumLayout() string {
	return fr.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'fr_RW'
func (fr *fr_RW) DateShortLayout() string {
	return fr.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'fr_RW'
func (fr *fr_RW) TimeFullLayout() string {
	return fr.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'fr_RW'
func (fr *fr_RW) TimeLongLayout() string {
	return fr.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'fr_RW'
func (fr *fr_RW) TimeMediumLayout() string {
	return fr.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'fr_RW'
func (fr *fr_RW) TimeShortLayout() string {
	return fr.timeShortLayout
}

func (fr *fr_RW) ListPatterns() *locales.ListPatterns {
	return fr.listPatterns
}

func (fr *fr_RW) GetDurationSpec() *locales.DurationSpec {
	return fr.DurationSpec
}

func (fr *fr_RW) GetMiscPatterns() *locales.MiscPatterns {
