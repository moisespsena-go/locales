...
func New() locales.Translator {
	return &hu{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 E ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 E ¤"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 E ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 E ¤"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 E ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 E ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "jan.", "febr.", "márc.", "ápr.", "máj.", "jún.", "júl.", "aug.", "szept.", "okt.", "nov.", "dec."},
			MonthsNarrowValue:        []string{"", "J", "F", "M", "Á", "M", "J", "J", "A", "Sz", "O", "N", "D"},
			MonthsWideValue:          []string{"", "január", "február", "március", "április", "május", "június", "július", "augusztus", "szeptember", "október", "november", "december"},
			WeekdaysAbbreviatedValue: []string{"V", "H", "K", "Sze", "Cs", "P", "Szo"},
			WeekdaysNarrowValue:      []string{"V", "H", "K", "Sz", "Cs", "P", "Sz"},
			WeekdaysShortValue:       []string{"V", "H", "K", "Sze", "Cs", "P", "Szo"},
			WeekdaysWideValue:        []string{"vasárnap", "hétfő", "kedd", "szerda", "csütörtök", "péntek", "szombat"},
			PeriodsAbbreviatedValue:  []string{"de.", "du."},
			PeriodsNarrowValue:       []string{"de.", "du."},
			PeriodsWideValue:         []string{"de.", "du."},
			ErasAbbreviatedValue:     []string{"i. e.", "i. sz."},
			ErasNarrowValue:          []string{"ie.", "isz."},
			ErasWideValue:            []string{"Krisztus előtt", "időszámításunk szerint"},
			TimezonesValue:           map[string]string{"": "falkland-szigeteki téli idő", "ACDT": "közép-ausztráliai nyári idő", "ACST": "Acre nyári idő", "ACT": "Acre zónaidő", "ACWDT": "közép-nyugat-ausztráliai nyári idő", "ACWST": "közép-nyugat-ausztráliai téli idő", "ADT": "atlanti-óceáni nyári idő", "AEDT": "kelet-ausztráliai nyári idő", "AEST": "kelet-ausztráliai téli idő", "AFT": "afganisztáni idő", "AKDT": "alaszkai nyári idő", "AKST": "alaszkai zónaidő", "AMST": "amazóniai nyári idő", "AMT": "amazóniai téli idő", "ARST": "argentínai nyári idő", "ART": "argentínai téli idő", "AST": "atlanti-óceáni zónaidő", "AWDT": "nyugat-ausztráliai nyári idő", "AWST": "nyugat-ausztráliai téli idő", "BNT": "Brunei Darussalam-i idő", "BOT": "bolíviai téli idő", "BRST": "brazíliai nyári idő", "BRT": "brazíliai téli idő", "BST": "bangladesi nyári idő", "BTT": "butáni idő", "CAT": "közép-afrikai téli idő", "CCT": "kókusz-szigeteki téli idő", "CDT": "középső államokbeli nyári idő", "CDT (Kuba)": "kubai nyári idő", "CHADT": "chathami nyári idő", "CHAST": "chathami téli idő", "CLST": "chilei nyári idő", "CLT": "chilei téli idő", "COST": "kolumbiai nyári idő", "COT": "kolumbiai téli idő", "CST": "középső államokbeli zónaidő", "CST (Kuba)": "kubai téli idő", "CXT": "karácsony-szigeti téli idő", "ChST": "chamorrói téli idő", "EASST": "húsvét-szigeti nyári idő", "EAST": "húsvét-szigeti téli idő", "EAT": "kelet-afrikai téli idő", "ECT": "ecuadori téli idő", "EDT": "keleti államokbeli nyári idő", "EGDT": "kelet-grönlandi nyári idő", "EGST": "kelet-grönlandi téli idő", "EST": "keleti államokbeli zónaidő", "FKST": "falkland-szigeteki nyári idő", "GALT": "galápagosi téli idő", "GFT": "francia-guyanai idő", "GMT": "greenwichi középidő, téli idő", "GST": "öbölbeli téli idő", "GYT": "guyanai téli idő", "HADT": "hawaii-aleuti nyári idő", "HAST": "hawaii-aleuti téli idő", "HENOMX": "északnyugat-mexikói nyári idő", "HEOG": "nyugat-grönlandi nyári idő", "HEPMX": "mexikói csendes-óceáni nyári idő", "HKST": "hongkongi nyári idő", "HKT": "hongkongi téli idő", "HNNOMX": "északnyugat-mexikói zónaidő", "HNOG": "nyugat-grönlandi téli idő", "HNPMX": "mexikói csendes-óceáni zónaidő", "ICT": "indokínai idő", "IRDT": "iráni nyári idő", "IRST": "iráni téli idő", "IST": "indiai téli idő", "JDT": "japán nyári idő", "JST": "japán téli idő", "LHDT": "Lord Howe-szigeti nyári idő", "LHST": "Lord Howe-szigeti téli idő", "MDT": "Macaui nyári idő", "MESZ": "közép-európai nyári idő", "MEZ": "közép-európai téli idő", "MST": "Macaui zónaidő", "MVT": "maldív-szigeteki idő", "MYT": "malajziai idő", "NDT": "új-fundlandi nyári idő", "NPT": "nepáli idő", "NST": "új-fundlandi zónaidő", "NZDT": "új-zélandi nyári idő", "NZST": "új-zélandi téli idő", "OESZ": "kelet-európai nyári idő", "OEZ": "kelet-európai téli idő", "PDT": "csendes-óceáni nyári idő", "PKT": "pakisztáni nyári idő", "PMDT": "Saint-Pierre és Miquelon-i nyári idő", "PMST": "Saint-Pierre és Miquelon-i zónaidő", "PST": "csendes-óceáni zónaidő", "PYST": "paraguayi nyári idő", "SAST": "dél-afrikai téli idő", "SGT": "szingapúri téli idő", "SRT": "szurinámi idő", "TLT": "kelet-timori téli idő", "TMST": "türkmenisztáni nyári idő", "TMT": "türkmenisztáni téli idő", "UYST": "uruguayi nyári idő", "UYT": "uruguayi téli idő", "VET": "venezuelai idő", "WARST": "nyugat-argentínai nyári idő", "WART": "nyugat-argentínai téli idő", "WAST": "nyugat-afrikai nyári idő", "WAT": "nyugat-afrikai téli idő", "WESZ": "nyugat-európai nyári idő", "WEZ": "nyugat-európai téli idő", "WIB": "nyugat-indonéziai téli idő", "WIT": "kelet-indonéziai idő", "WITA": "közép-indonéziai idő", "∅∅∅": "azori nyári idő"},
		},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} és {1}", "{0}, {1}", "{0}, {1}", "{0} és {1}"}, {"{0} vagy {1}", "{0}, {1}", "{0}, {1}", "{0} vagy {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sz.", "%v sz.", "%v sz.", ""},
				Long:   &locales.CounterFormat{"évszázad", "%v évszázaddá", "%v évszázaddá", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dek", "%v dek", "%v dek", ""},
				Long:   &locales.CounterFormat{"évtized", "%v évtizeddé", "%v évtizeddé", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"év", "%v év", "%v év", ""},
				Long:   &locales.CounterFormat{"év", "%v évvé", "%v évvé", "%v/év"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"hónap", "%v h.", "%v h.", ""},
				Long:   &locales.CounterFormat{"hónap", "%v hónappá", "%v hónappá", "%v/hónap"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"hét", "%v hét", "%v hét", ""},
				Long:   &locales.CounterFormat{"hét", "%v hétté", "%v hétté", "%v/hét"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"nap", "%v nap", "%v nap", "%v/nap"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ó", "%v ó", "%v ó", ""},
				Long:   &locales.CounterFormat{"óra", "%v órává", "%v órává", "%v/óra"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"p", "%v p", "%v p", ""},
				Long:   &locales.CounterFormat{"perc", "%v perccé", "%v perccé", "%v/perc"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"mp", "%v mp", "%v mp", "%v/mp"},
				Long:   &locales.CounterFormat{"másodperc", "%v másodperccé", "%v másodperccé", "%v/másodperc"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ms", "%v ms", "%v ms", ""},
				Long:   &locales.CounterFormat{"ezredmásodperc", "%v ezredmásodperccé", "%v ezredmásodperccé", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"μs", "%v μs", "%v μs", ""},
				Long:   &locales.CounterFormat{"mikroszekundum", "%v mikroszekundummá", "%v mikroszekundummá", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"ns", "%v ns", "%v ns", ""},
				Long:   &locales.CounterFormat{"nanoszekundum", "%v nanoszekundummá", "%v nanoszekundummá", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
func (hu *hu) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(hu, hu.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'hu'
func (hu *hu) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(hu, hu.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'hu'
func (hu *hu) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(hu, hu.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'hu'
func (hu *hu) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(hu, hu.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'hu'
func (hu *hu) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(hu, hu.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'hu'
func (hu *hu) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(hu, hu.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'hu'
func (hu *hu) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(hu, hu.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'hu'
func (hu *hu) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(hu, hu.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'hu'
func (hu *hu) DateFullLayout() string {
	return hu.dateFullLayout
}

// DateLongLayout returns the long date layout for 'hu'
func (hu *hu) DateLongLayout() string {
	return hu.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'hu'
func (hu *hu) DateMediumLayout() string {
	return hu.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'hu'
func (hu *hu) DateShortLayout() string {
	return hu.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'hu'
func (hu *hu) TimeFullLayout() string {
	return hu.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'hu'
func (hu *hu) TimeLongLayout() string {
	return hu.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'hu'
func (hu *hu) TimeMediumLayout() string {
	return hu.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'hu'
func (hu *hu) TimeShortLayout() string {
	return hu.timeShortLayout
}

func (hu *hu) ListPatterns() *locales.ListPatterns {
	return hu.listPatterns
}

func (hu *hu) GetDurationSpec() *locales.DurationSpec {
	return hu.DurationSpec
}

func (hu *hu) GetMiscPatterns() *locales.MiscPatterns {
	return &hu.miscPatterns
}
