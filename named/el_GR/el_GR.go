...
// DateFullLayout returns the full date layout for 'el_GR'
func (el *el_GR) DateFullLayout() string {
	return el.dateFullLayout
}

// DateLongLayout returns the long date layout for 'el_GR'
func (el *el_GR) DateLongLayout() string {
	return el.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'el_GR'
func (el *el_GR) DateMediumLayout() string {
	return el.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'el_GR'
func (el *el_GR) DateShortLayout() string {
	return el.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'el_GR'
func (el *el_GR) TimeFullLayout() string {
	return el.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'el_GR'
func (el *el_GR) TimeLongLayout() string {
	return el.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'el_GR'
func (el *el_GR) TimeMediumLayout() string {
	return el.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'el_GR'
func (el *el_GR) TimeShortLayout() string {
	return el.timeShortLayout
}

func (el *el_GR) ListPatterns() *locales.ListPatterns {
	return el.listPatterns
}

func (el *el_GR) GetDurationSpec() *locales.DurationSpec {
	return el.DurationSpec
}

func (el *el_GR) GetMiscPatterns() *locales.MiscPatterns {
