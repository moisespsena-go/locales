...
// DateFullLayout returns the full date layout for 'doi_IN'
func (doi *doi_IN) DateFullLayout() string {
	return doi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'doi_IN'
func (doi *doi_IN) DateLongLayout() string {
	return doi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'doi_IN'
func (doi *doi_IN) DateMediumLayout() string {
	return doi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'doi_IN'
func (doi *doi_IN) DateShortLayout() string {
	return doi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'doi_IN'
func (doi *doi_IN) TimeFullLayout() string {
	return doi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'doi_IN'
func (doi *doi_IN) TimeLongLayout() string {
	return doi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'doi_IN'
func (doi *doi_IN) TimeMediumLayout() string {
	return doi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'doi_IN'
func (doi *doi_IN) TimeShortLayout() string {
	return doi.timeShortLayout
}

func (doi *doi_IN) ListPatterns() *locales.ListPatterns {
	return doi.listPatterns
}

func (doi *doi_IN) GetDurationSpec() *locales.DurationSpec {
	return doi.DurationSpec
}

func (doi *doi_IN) GetMiscPatterns() *locales.MiscPatterns {
