...
// DateFullLayout returns the full date layout for 'agq'
func (agq *agq) DateFullLayout() string {
	return agq.dateFullLayout
}

// DateLongLayout returns the long date layout for 'agq'
func (agq *agq) DateLongLayout() string {
	return agq.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'agq'
func (agq *agq) DateMediumLayout() string {
	return agq.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'agq'
func (agq *agq) DateShortLayout() string {
	return agq.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'agq'
func (agq *agq) TimeFullLayout() string {
	return agq.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'agq'
func (agq *agq) TimeLongLayout() string {
	return agq.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'agq'
func (agq *agq) TimeMediumLayout() string {
	return agq.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'agq'
func (agq *agq) TimeShortLayout() string {
	return agq.timeShortLayout
}

func (agq *agq) ListPatterns() *locales.ListPatterns {
	return agq.listPatterns
}

func (agq *agq) GetDurationSpec() *locales.DurationSpec {
	return agq.DurationSpec
}

func (agq *agq) GetMiscPatterns() *locales.MiscPatterns {
