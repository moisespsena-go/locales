	...
	return &ne{
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Short:  &locales.CounterFormat{"शताब्दी", "%v शताब्दी", "%v शताब्दी", ""},
				Long:   &locales.CounterFormat{"शताब्दी", "%v शताब्दी", "%v शताब्दी", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"दशाब्दी", "%v दशाब्दी", "%v दशाब्दी", ""},
				Long:   &locales.CounterFormat{"दशाब्दी", "%v दशाब्दी", "%v दशाब्दी", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"वर्ष", "%v वर्ष", "%v वर्ष", ""},
				Long:   &locales.CounterFormat{"वर्ष", "%v वर्ष", "%v वर्ष", "%v प्रति वर्ष"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"महिना", "%v महिना", "%v महिना", ""},
				Long:   &locales.CounterFormat{"महिना", "%v महिना", "%v महिना", "%v प्रति महिना"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"हप्ता", "%v हप्ता", "%v हप्ता", ""},
				Long:   &locales.CounterFormat{"हप्ता", "%v हप्ता", "%v हप्ता", "%v प्रति हप्ता"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"दिन", "%v दिन", "%v दिन", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"घण्टा", "%v घण्टा", "%v घण्टा", ""},
				Long:   &locales.CounterFormat{"घण्टा", "%v घण्टा", "%v घण्टा", "%vप्रति घण्टा"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"मिनेट", "%v मिनेट", "%v मिनेट", ""},
				Long:   &locales.CounterFormat{"मिनेट", "%v मिनेट", "%v मिनेट", "%v प्रति मिनेट"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"सेकेन्ड", "%v सेकेन्ड", "%v सेकेन्ड", ""},
				Long:   &locales.CounterFormat{"सेकेन्ड", "%v सेकेन्ड", "%v सेकेन्ड", "%v प्रति सेकेन्ड"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"मिली सेकेन्ड", "%vमि.से.", "%vमि.से.", ""},
				Long:   &locales.CounterFormat{"मिली सेकेन्ड", "%v मिली सेकेन्ड", "%v मिली सेकेन्ड", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"माइक्रोसेकेन्ड", "%v मा.से.", "%v मा.से.", ""},
				Long:   &locales.CounterFormat{"माइक्रोसेकेन्ड", "%v माइक्रोसेकेन्ड", "%v माइक्रोसेकेन्ड", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"न्यानोसेकेन्ड", "%v न.से.", "%v न.से.", ""},
				Long:   &locales.CounterFormat{"न्यानोसेकेन्ड", "%v न्यानोसेकेन्ड", "%v न्यानोसेकेन्ड", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"~%[1]v",
			"%[1]v+",
...
// DateFullLayout returns the full date layout for 'ne'
func (ne *ne) DateFullLayout() string {
	return ne.dateFullLayout
}

// DateLongLayout returns the long date layout for 'ne'
func (ne *ne) DateLongLayout() string {
	return ne.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'ne'
func (ne *ne) DateMediumLayout() string {
	return ne.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'ne'
func (ne *ne) DateShortLayout() string {
	return ne.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'ne'
func (ne *ne) TimeFullLayout() string {
	return ne.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'ne'
func (ne *ne) TimeLongLayout() string {
	return ne.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'ne'
func (ne *ne) TimeMediumLayout() string {
	return ne.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'ne'
func (ne *ne) TimeShortLayout() string {
	return ne.timeShortLayout
}

func (ne *ne) ListPatterns() *locales.ListPatterns {
	return ne.listPatterns
}

func (ne *ne) GetDurationSpec() *locales.DurationSpec {
	return ne.DurationSpec
}

func (ne *ne) GetMiscPatterns() *locales.MiscPatterns {
