...
// DateFullLayout returns the full date layout for 'da_DK'
func (da *da_DK) DateFullLayout() string {
	return da.dateFullLayout
}

// DateLongLayout returns the long date layout for 'da_DK'
func (da *da_DK) DateLongLayout() string {
	return da.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'da_DK'
func (da *da_DK) DateMediumLayout() string {
	return da.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'da_DK'
func (da *da_DK) DateShortLayout() string {
	return da.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'da_DK'
func (da *da_DK) TimeFullLayout() string {
	return da.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'da_DK'
func (da *da_DK) TimeLongLayout() string {
	return da.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'da_DK'
func (da *da_DK) TimeMediumLayout() string {
	return da.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'da_DK'
func (da *da_DK) TimeShortLayout() string {
	return da.timeShortLayout
}

func (da *da_DK) ListPatterns() *locales.ListPatterns {
	return da.listPatterns
}

func (da *da_DK) GetDurationSpec() *locales.DurationSpec {
	return da.DurationSpec
}

func (da *da_DK) GetMiscPatterns() *locales.MiscPatterns {
