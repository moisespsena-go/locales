...
// New returns a new instance of translator for the 'hi_Latn' locale
func New() locales.Translator {
	return &hi_Latn{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						3: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0 hazaar"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 hazaar"),
						}},
						4: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00 hazaar"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 hazaar"),
						}},
						5: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0 laakh"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 laakh"),
						}},
						6: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00 laakh"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 laakh"),
						}},
						7: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0 ka'.'"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 ka'.'"),
						}},
						8: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00 ka'.'"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 ka'.'"),
						}},
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0 a'.'"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 a'.'"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00 a'.'"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 a'.'"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0 kha'.'"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0 kha'.'"),
						}},
						12: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤00 kha'.'"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤00 kha'.'"),
						}},
						13: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤000 kha'.'"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤000 kha'.'"),
						}},
						14: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("¤0000 kha'.'"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("¤0000 kha'.'"),
						}},
					},
		...
		TimeSpec: &locales.TimeSpec{
			...
			WeekdaysAbbreviatedValue: []string{"ravi", "som", "mangal", "budh", "guru", "shukra", "shani"},
			WeekdaysNarrowValue:      []string{"ra", "so", "ma", "bu", "gu", "su", "sa"},
			WeekdaysShortValue:       []string{"र", "सो", "मं", "बु", "गु", "शु", "श"},
			WeekdaysWideValue:        []string{"ravivaar", "somvaar", "mangalvaar", "budhvaar", "guruvaar", "shukravaar", "shanivaar"},
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} aur {1}", "", "", "{0}, aur {1}"}, {"{0} ya {1}", "", "", "{0} ya {1}"}}),
...
func (hi *hi_Latn) Locale() string {
	return hi.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'hi_Latn'
func (hi *hi_Latn) PluralsCardinal() []locales.PluralRule {
	return hi.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'hi_Latn'
func (hi *hi_Latn) PluralsOrdinal() []locales.PluralRule {
	return hi.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'hi_Latn'
func (hi *hi_Latn) PluralsRange() []locales.PluralRule {
...
// DateFullLayout returns the full date layout for 'hi_Latn'
func (hi *hi_Latn) DateFullLayout() string {
	return hi.dateFullLayout
}

// DateLongLayout returns the long date layout for 'hi_Latn'
func (hi *hi_Latn) DateLongLayout() string {
	return hi.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'hi_Latn'
func (hi *hi_Latn) DateMediumLayout() string {
	return hi.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'hi_Latn'
func (hi *hi_Latn) DateShortLayout() string {
	return hi.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'hi_Latn'
func (hi *hi_Latn) TimeFullLayout() string {
	return hi.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'hi_Latn'
func (hi *hi_Latn) TimeLongLayout() string {
	return hi.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'hi_Latn'
func (hi *hi_Latn) TimeMediumLayout() string {
	return hi.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'hi_Latn'
func (hi *hi_Latn) TimeShortLayout() string {
	return hi.timeShortLayout
}

func (hi *hi_Latn) ListPatterns() *locales.ListPatterns {
	return hi.listPatterns
}

func (hi *hi_Latn) GetDurationSpec() *locales.DurationSpec {
	return hi.DurationSpec
}

func (hi *hi_Latn) GetMiscPatterns() *locales.MiscPatterns {
