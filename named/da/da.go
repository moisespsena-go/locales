...
func New() locales.Translator {
	return &da{
				...
				Short: locales.CurrencyAccountingFormatterByExp{
					CurrencyFmt: map[uint8]*locales.CurrencyAccountingFormatterByExpPlural{
						...
						9: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("0 mia'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("0 mia'.' ¤"),
						}},
						10: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("00 mia'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("00 mia'.' ¤"),
						}},
						11: {Rules: map[locales.PluralRule]*locales.NumberFormatProperties{
							locales.PluralRuleOne:   locales.MustParseNumberFormatPatterns("000 mia'.' ¤"),
							locales.PluralRuleOther: locales.MustParseNumberFormatPatterns("000 mia'.' ¤"),
						}},
		...
		TimeSpec: &locales.TimeSpec{
			...
			MonthsWideValue:          []string{"", "januar", "februar", "marts", "april", "maj", "juni", "juli", "august", "september", "oktober", "november", "december"},
			WeekdaysAbbreviatedValue: []string{"søn.", "man.", "tir.", "ons.", "tor.", "fre.", "lør."},
			WeekdaysNarrowValue:      []string{"S", "M", "T", "O", "T", "F", "L"},
			WeekdaysShortValue:       []string{"sø", "ma", "ti", "on", "to", "fr", "lø"},
			WeekdaysWideValue:        []string{"søndag", "mandag", "tirsdag", "onsdag", "torsdag", "fredag", "lørdag"},
			...
			ErasNarrowValue:          []string{"fKr", "eKr"},
			ErasWideValue:            []string{"f.Kr.", "e.Kr."},
			TimezonesValue:           map[string]string{"": "Falklandsøerne-normaltid", "ACDT": "Centralaustralsk sommertid", "ACST": "Acre-sommertid", "ACT": "Acre-normaltid", "ACWDT": "Vestlig centralaustralsk sommertid", "ACWST": "Vestlig centralaustralsk normaltid", "ADT": "Atlantic-sommertid", "AEDT": "Østaustralsk sommertid", "AEST": "Østaustralsk normaltid", "AFT": "Afghansk tid", "AKDT": "Alaska-sommertid", "AKST": "Alaska-normaltid", "AMST": "Amazonas-sommertid", "AMT": "Amazonas-normaltid", "ARST": "Argentinsk sommertid", "ART": "Argentinsk normaltid", "AST": "Atlantic-normaltid", "AWDT": "Vestaustralsk sommertid", "AWST": "Vestaustralsk normaltid", "BNT": "Brunei Darussalam-tid", "BOT": "Boliviansk tid", "BRST": "Brasiliansk sommertid", "BRT": "Brasiliansk normaltid", "BST": "Bangladesh-sommertid", "BTT": "Bhutan-tid", "CAT": "Centralafrikansk tid", "CCT": "Cocosøerne-normaltid", "CDT": "Central-sommertid", "CDT (Kuba)": "Cubansk sommertid", "CHADT": "Chatham-sommertid", "CHAST": "Chatham-normaltid", "CLST": "Chilensk sommertid", "CLT": "Chilensk normaltid", "COST": "Colombiansk sommertid", "COT": "Colombiansk normaltid", "CST": "Central-normaltid", "CST (Kuba)": "Cubansk normaltid", "CXT": "Juleøen-normaltid", "ChST": "Chamorro-tid", "EASST": "Påskeøen-sommertid", "EAST": "Påskeøen-normaltid", "EAT": "Østafrikansk tid", "ECT": "Ecuadoriansk tid", "EDT": "Eastern-sommertid", "EGDT": "Østgrønlandsk sommertid", "EGST": "Østgrønlandsk normaltid", "EST": "Eastern-normaltid", "FKST": "Falklandsøerne-sommertid", "GALT": "Galapagos-tid", "GFT": "Fransk Guyana-tid", "GMT": "GMT", "GST": "Golflandene-normaltid", "GYT": "Guyana-tid", "HADT": "Hawaii-Aleutian-sommertid", "HAST": "Hawaii-Aleutian-normaltid", "HENOMX": "Nordvestmexicansk sommertid", "HEOG": "Vestgrønlandsk sommertid", "HEPMX": "Mexicansk Pacific-sommertid", "HKST": "Hongkong-sommertid", "HKT": "Hongkong-normaltid", "HNNOMX": "Nordvestmexicansk normaltid", "HNOG": "Vestgrønlandsk normaltid", "HNPMX": "Mexicansk Pacific-normaltid", "ICT": "Indokina-tid", "IRDT": "Iransk sommertid", "IRST": "Iransk normaltid", "IST": "Indisk normaltid", "JDT": "Japansk sommertid", "JST": "Japansk normaltid", "LHDT": "Lord Howe-sommertid", "LHST": "Lord Howe-normaltid", "MDT": "Macao-sommertid", "MESZ": "Centraleuropæisk sommertid", "MEZ": "Centraleuropæisk normaltid", "MST": "Macao-normaltid", "MVT": "Maldiverne-tid", "MYT": "Malaysia-tid", "NDT": "Newfoundlandsk sommertid", "NPT": "Nepalesisk tid", "NST": "Newfoundlandsk normaltid", "NZDT": "Newzealandsk sommertid", "NZST": "Newzealandsk normaltid", "OESZ": "Østeuropæisk sommertid", "OEZ": "Østeuropæisk normaltid", "PDT": "Pacific-sommertid", "PKT": "Pakistansk sommertid", "PMDT": "Saint Pierre- og Miquelon-sommertid", "PMST": "Saint Pierre- og Miquelon-normaltid", "PST": "Pacific-normaltid", "PYST": "Paraguayansk sommertid", "SAST": "Sydafrikansk tid", "SGT": "Singapore-tid", "SRT": "Surinam-tid", "TLT": "Østtimor-tid", "TMST": "Turkmensk sommertid", "TMT": "Turkmensk normaltid", "UYST": "Uruguayansk sommertid", "UYT": "Uruguayansk normaltid", "VET": "Venezuelansk tid", "WARST": "Vestargentinsk sommertid", "WART": "Vestargentinsk normaltid", "WAST": "Vestafrikansk sommertid", "WAT": "Vestafrikansk normaltid", "WESZ": "Vesteuropæisk sommertid", "WEZ": "Vesteuropæisk normaltid", "WIB": "Vestindonesisk tid", "WIT": "Østindonesisk tid", "WITA": "Centralindonesisk tid", "∅∅∅": "Azorerne-sommertid"},
		},
		...
		dateFullLayout:   "EEEE 'den' d. MMMM y",
		...
		listPatterns:     locales.NewListPatternsFromSlice([][]string{{"{0} og {1}", "{0}, {1}", "{0}, {1}", "{0} og {1}"}, {"{0} eller {1}", "{0}, {1}", "{0}, {1}", "{0} eller {1}"}}),
		DurationSpec: &locales.DurationSpec{" ",
			"",
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"årh.", "%v årh.", "%v årh.", ""},
				Long:   &locales.CounterFormat{"århundreder", "%v århundredes", "%v århundreders", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"årti", "%v årti", "%v årtier", ""},
				Long:   &locales.CounterFormat{"årtier", "%v årtis", "%v årtiers", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"år", "%v år", "%v år", "%v/år"},
				Long:   &locales.CounterFormat{"år", "%v års", "%v års", "%v om året"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"måned", "%v m", "%v m", "%v/m"},
				Long:   &locales.CounterFormat{"måneder", "%v måneds", "%v måneders", "%v pr. måned"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"uge", "%v u", "%v u", "%v/u"},
				Long:   &locales.CounterFormat{"uger", "%v uges", "%v ugers", "%v pr. uge"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"dag", "%v d", "%v d", "%v/d"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"time", "%v t", "%v t", "%v/t"},
				Long:   &locales.CounterFormat{"timer", "%v times", "%v timers", "%v pr. time"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"min", "%v m", "%v m", "%v/m"},
				Long:   &locales.CounterFormat{"minutter", "%v minuts", "%v minutters", "%v pr. min."}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"sek", "%v s", "%v s", "%v/s"},
				Long:   &locales.CounterFormat{"sekunder", "%v sekunds", "%v sekunders", "%v pr. sekund"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
...
func (da *da) FmtDateShort(t time.Time) string {
	return locales.FormatTimeEra(da, da.dateShortLayout, t, 2)
}

// FmtDateMedium returns the medium date representation of 't' for 'da'
func (da *da) FmtDateMedium(t time.Time) string {
	return locales.FormatTimeEra(da, da.dateMediumLayout, t, 2)
}

// FmtDateLong returns the long date representation of 't' for 'da'
func (da *da) FmtDateLong(t time.Time) string {
	return locales.FormatTimeEra(da, da.dateLongLayout, t, 1)
}

// FmtDateFull returns the full date representation of 't' for 'da'
func (da *da) FmtDateFull(t time.Time) string {
	return locales.FormatTimeEra(da, da.dateFullLayout, t, 0)
}

// FmtTimeShort returns the short time representation of 't' for 'da'
func (da *da) FmtTimeShort(t time.Time) string {
	return locales.FormatTimeEra(da, da.timeShortLayout, t, 2)
}

// FmtTimeMedium returns the medium time representation of 't' for 'da'
func (da *da) FmtTimeMedium(t time.Time) string {
	return locales.FormatTimeEra(da, da.timeMediumLayout, t, 2)
}

// FmtTimeLong returns the long time representation of 't' for 'da'
func (da *da) FmtTimeLong(t time.Time) string {
	return locales.FormatTimeEra(da, da.timeLongLayout, t, 1)
}

// FmtTimeFull returns the full time representation of 't' for 'da'
func (da *da) FmtTimeFull(t time.Time) string {
	return locales.FormatTimeEra(da, da.timeFullLayout, t, 0)
}

// DateFullLayout returns the full date layout for 'da'
func (da *da) DateFullLayout() string {
	return da.dateFullLayout
}

// DateLongLayout returns the long date layout for 'da'
func (da *da) DateLongLayout() string {
	return da.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'da'
func (da *da) DateMediumLayout() string {
	return da.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'da'
func (da *da) DateShortLayout() string {
	return da.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'da'
func (da *da) TimeFullLayout() string {
	return da.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'da'
func (da *da) TimeLongLayout() string {
	return da.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'da'
func (da *da) TimeMediumLayout() string {
	return da.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'da'
func (da *da) TimeShortLayout() string {
	return da.timeShortLayout
}

func (da *da) ListPatterns() *locales.ListPatterns {
	return da.listPatterns
}

func (da *da) GetDurationSpec() *locales.DurationSpec {
	return da.DurationSpec
}

func (da *da) GetMiscPatterns() *locales.MiscPatterns {
	return &da.miscPatterns
}
