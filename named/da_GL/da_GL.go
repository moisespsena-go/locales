...
// DateFullLayout returns the full date layout for 'da_GL'
func (da *da_GL) DateFullLayout() string {
	return da.dateFullLayout
}

// DateLongLayout returns the long date layout for 'da_GL'
func (da *da_GL) DateLongLayout() string {
	return da.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'da_GL'
func (da *da_GL) DateMediumLayout() string {
	return da.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'da_GL'
func (da *da_GL) DateShortLayout() string {
	return da.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'da_GL'
func (da *da_GL) TimeFullLayout() string {
	return da.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'da_GL'
func (da *da_GL) TimeLongLayout() string {
	return da.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'da_GL'
func (da *da_GL) TimeMediumLayout() string {
	return da.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'da_GL'
func (da *da_GL) TimeShortLayout() string {
	return da.timeShortLayout
}

func (da *da_GL) ListPatterns() *locales.ListPatterns {
	return da.listPatterns
}

func (da *da_GL) GetDurationSpec() *locales.DurationSpec {
	return da.DurationSpec
}

func (da *da_GL) GetMiscPatterns() *locales.MiscPatterns {
