...
func New() locales.Translator {
	return &be_TARASK{
		...
		TimeSpec: &locales.TimeSpec{
			Separator:                ":",
			MonthsAbbreviatedValue:   []string{"", "сту", "лют", "сак", "кра", "тра", "чэр", "ліп", "жні", "вер", "кас", "ліс", "сьн"},
			MonthsNarrowValue:        []string{"", "с", "л", "с", "к", "т", "ч", "л", "ж", "в", "к", "л", "с"},
			MonthsWideValue:          []string{"", "студзеня", "лютага", "сакавіка", "красавіка", "траўня", "чэрвеня", "ліпеня", "жніўня", "верасьня", "кастрычніка", "лістапада", "сьнежня"},
			WeekdaysAbbreviatedValue: []string{"няд", "пан", "аўт", "сер", "чац", "пят", "суб"},
			WeekdaysNarrowValue:      []string{"н", "п", "а", "с", "ч", "п", "с"},
			WeekdaysShortValue:       []string{"няд", "пан", "аўт", "сер", "чац", "пят", "суб"},
			WeekdaysWideValue:        []string{"нядзеля", "панядзелак", "аўторак", "серада", "чацьвер", "пятніца", "субота"},
			PeriodsAbbreviatedValue:  []string{"апоўначы", "апоўдні"},
			PeriodsNarrowValue:       []string{"апн", "апд"},
			PeriodsWideValue:         []string{"апоўначы", "апоўдні"},
			ErasAbbreviatedValue:     []string{"", ""},
			ErasNarrowValue:          []string{"", ""},
			ErasWideValue:            []string{"да нараджэньня Хрыстова", "ад нараджэньня Хрыстова"},
			TimezonesValue:           map[string]string{"": "Змоўчны час Парагваю", "ACDT": "Летні час цэнтральнай Аўстраліі", "ACST": "ACST", "ACT": "ACT", "ACWDT": "Летні цэнтральна-заходні час Аўстраліі", "ACWST": "Змоўчны цэнтральна-заходні час Аўстраліі", "ADT": "Атлянтычны летні час", "AEDT": "Летні час усходняй Аўстраліі", "AEST": "Змоўчны час усходняй Аўстраліі", "AFT": "Аўганістанскі час", "AKDT": "Летні час Аляскі", "AKST": "Змоўчны час Аляскі", "AMST": "Амазонскі летні час", "AMT": "Амазонскі змоўчны час", "ARST": "Аргентынскі летні час", "ART": "Аргентынскі змоўчны час", "AST": "Атлянтычны змоўчны час", "AWDT": "Летні час заходняй Аўстраліі", "AWST": "змоўчны час заходняй Аўстраліі", "BNT": "Час Брунэю", "BOT": "Балівійскі час", "BRST": "Бразыльскі летні час", "BRT": "Бразыльскі змоўчны час", "BST": "Летні час Банглядэшу", "BTT": "Час Бутану", "CAT": "Цэнтральнаафрыканскі час", "CCT": "Час Какосавых астравоў", "CDT": "Паўночнаамэрыканскі цэнтральны летні час", "CDT (Kuba)": "Летні час Кубы", "CHADT": "Летні час Чатэму", "CHAST": "Змоўчны час Чатэму", "CLST": "Чылійскі летні час", "CLT": "Чылійскі змоўчны час", "COST": "Калюмбійскі летні час", "COT": "Калюмбійскі змоўчны час", "CST": "Паўночнаамэрыканскі цэнтральны змоўчны час", "CST (Kuba)": "Змоўчны час Кубы", "CXT": "Час вострава Раства", "ChST": "Час Чамора", "EASST": "Летні час вострава Раства", "EAST": "Змоўчны час вострава Раства", "EAT": "Усходнеафрыканскі час", "ECT": "Эквадорскі час", "EDT": "Паўночнаамэрыканскі ўсходні летні час", "EGDT": "Летні час Усходняй Грэнляндыі", "EGST": "Змоўчны час Усходняй Грэнляндыі", "EST": "Паўночнаамэрыканскі ўсходні змоўчны час", "FKST": "Летні час Фолклэндзкіх астравоў", "GALT": "Змоўчны час Галяпагоскіх астравоў", "GFT": "Час Францускай Гвіяны", "GMT": "Час па Грынвічы", "GST": "Час Пэрсыдзкага заліву", "GYT": "Час Гаяны", "HADT": "Гавайска-Алевуцкі летні час", "HAST": "Гавайска-Алэвуцкі змоўчны час", "HENOMX": "Паўночна-заходні Мэксыканскі летні час", "HEOG": "Летні час Заходняй Грэнляндыі", "HEPMX": "Мэксыканскі ціхаакіянскі летні час", "HKST": "Летні час Ганконгу", "HKT": "Змоўчны час Ганконга", "HNNOMX": "Паўночна-заходні Мэксыканскі змоўчны час", "HNOG": "Змоўчны час Заходняй Грэнляндыі", "HNPMX": "Мэксыканскі ціхаакіянскі стандатны час", "ICT": "Індакітайскі час", "IRDT": "Іранскі летні час", "IRST": "Іранскі змоўчны час", "IST": "Час Індыі", "JDT": "Летні час Японіі", "JST": "Змоўчны час Японіі", "LHDT": "Летні час Лорд-Гаў", "LHST": "Змоўчны час Лорд-Гаў", "MDT": "MDT", "MESZ": "Цэнтральнаэўрапейскі летні час", "MEZ": "Цэнтральнаэўрапейскі змоўчны час", "MST": "MST", "MVT": "Час Мальдываў", "MYT": "Час Малайзіі", "NDT": "Ньюфаўндлэндзкі летні час", "NPT": "Нэпальскі час", "NST": "Ньюфаўндлэндзкі змоўчны час", "NZDT": "Летні час Новай Зэляндыі", "NZST": "Змоўчны час Новай Зэляндыі", "OESZ": "Усходнеэўрапейскі летні час", "OEZ": "Усходнеэўрапейскі змоўчны час", "PDT": "Ціхаакіянскі летні час", "PKT": "Пакістанскі летні час", "PMDT": "Змоўчны летні час Сэн-П’еру і Мікелёну", "PMST": "Змоўчны час Сэн-П’еру і Мікелёну", "PST": "Ціхаакіянскі змоўчны час", "PYST": "Летні час Парагваю", "SAST": "Паўднёваафрыканскі час", "SGT": "Сынгапурскі час", "SRT": "Час Сурынаму", "TLT": "Час Усходняга Тымору", "TMST": "Летні час Туркмэністану", "TMT": "Змоўчны час Туркмэністана", "UYST": "Уругвайскі летні час", "UYT": "Уругвайскі змоўчны час", "VET": "Вэнэсуэльскі час", "WARST": "Летні час Заходняй Аргэнтыны", "WART": "Змоўчны час Заходняй Аргэнтыны", "WAST": "Заходнеафрыканскі летні час", "WAT": "Заходнеафрыканскі змоўчны час", "WESZ": "Заходнеэўрапейскі летні час", "WEZ": "Заходнеэўрапейскі змоўчны час", "WIB": "Заходнеінданэзійскі час", "WIT": "Усходнеінданэзійскі час", "WITA": "Цэнтральнаінданэзійскі час", "∅∅∅": "Летні час Азорскіх астравоў"},
		},
		...
		DurationSpec: &locales.DurationSpec{" ",
			...
			locales.DurationSpecPair{
				...
				Long:   &locales.CounterFormat{"стагодьдзі", "%v стагодьдзе", "%v стагодзьдзя", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"дзесяцігодьдзі", "%v дзесяцігодьдзе", "%v дзесяцігодзьдзя", ""}},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"сут.", "%v сут.", "%v сут.", "%v сут."}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"гадз.", "%v гадз.", "%v гадз.", "%v/гадз."}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"хв.", "%v хв.", "%v хв.", "%v/ хв."}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"сэк.", "%v сэк.", "%v сэк.", "%v/сэк."},
				Long:   &locales.CounterFormat{"сэкунды", "%v сэкунда", "%v сэкунды", "%v у сэкунду"}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Long:   &locales.CounterFormat{"мілісэкунды", "%v мілісэкунда", "%v мілісэкунды", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"мкс.", "%v мкс.", "%v мкс.", ""},
				Long:   &locales.CounterFormat{"мікрасэкунды", "%v мікрасэкунда", "%v мікрасэкунды", ""}},
			locales.DurationSpecPair{
				Gender: locales.Masculine,
				Short:  &locales.CounterFormat{"нсэк.", "%v нсэк.", "%v нсэк.", ""},
				Long:   &locales.CounterFormat{"нанасэкунды", "%v нанасэкунда", "%v нанасэкунды", ""}},
		},
		miscPatterns: locales.MiscPatterns{
			"≈%[1]v",
			"%[1]v+",
...
// DateFullLayout returns the full date layout for 'be_TARASK'
func (be *be_TARASK) DateFullLayout() string {
	return be.dateFullLayout
}

// DateLongLayout returns the long date layout for 'be_TARASK'
func (be *be_TARASK) DateLongLayout() string {
	return be.dateLongLayout
}

// DateMediumLayout returns the medium date layout for 'be_TARASK'
func (be *be_TARASK) DateMediumLayout() string {
	return be.dateMediumLayout
}

// DateShortLayout returns the short date layout for 'be_TARASK'
func (be *be_TARASK) DateShortLayout() string {
	return be.dateShortLayout
}

// TimeFullLayout returns the full time layout for 'be_TARASK'
func (be *be_TARASK) TimeFullLayout() string {
	return be.timeFullLayout
}

// TimeLongLayout returns the full long layout for 'be_TARASK'
func (be *be_TARASK) TimeLongLayout() string {
	return be.timeLongLayout
}

// TimeMediumLayout returns the medium time layout for 'be_TARASK'
func (be *be_TARASK) TimeMediumLayout() string {
	return be.timeMediumLayout
}

// TimeShortLayout returns the short time layout for 'be_TARASK'
func (be *be_TARASK) TimeShortLayout() string {
	return be.timeShortLayout
}

func (be *be_TARASK) ListPatterns() *locales.ListPatterns {
	return be.listPatterns
}

func (be *be_TARASK) GetDurationSpec() *locales.DurationSpec {
	return be.DurationSpec
}

func (be *be_TARASK) GetMiscPatterns() *locales.MiscPatterns {
